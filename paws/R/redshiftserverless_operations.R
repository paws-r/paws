...
#'   enhancedVpcRouting, namespaceName, publiclyAccessible, securityGroupIds,
#'   subnetIds, tags, workgroupName)
#'
...
#'   namespaceName, nextToken, startTime)
#'
...
#'   enhancedVpcRouting, publiclyAccessible, securityGroupIds, subnetIds,
#'   workgroupName)
#'
