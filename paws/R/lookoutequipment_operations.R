...
#' @param DatasetSchema &#91;required&#93; A JSON description of the data that is in each time series dataset,
#' including names, column names, and data types.
#' @param ServerSideKmsKeyId Provides the identifier of the AWS KMS customer master key (CMK) used to
...
lookoutequipment_create_dataset <- function(DatasetName, DatasetSchema, ServerSideKmsKeyId = NULL, ClientToken, Tags = NULL) {
  op <- new_operation(
    name = "CreateDataset",
    http_method = "POST",
    http_path = "/",
...
lookoutequipment_create_model <- function(ModelName, DatasetName, DatasetSchema = NULL, LabelsInputConfiguration = NULL, ClientToken, TrainingDataStartTime = NULL, TrainingDataEndTime = NULL, EvaluationDataStartTime = NULL, EvaluationDataEndTime = NULL, RoleArn = NULL, DataPreProcessingConfiguration = NULL, ServerSideKmsKeyId = NULL, Tags = NULL) {
  op <- new_operation(
    name = "CreateModel",
    http_method = "POST",
    http_path = "/",
