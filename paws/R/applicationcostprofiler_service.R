...
.applicationcostprofiler$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "application-cost-profiler.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "application-cost-profiler.{region}.amazonaws.com.cn", global = FALSE), "us-iso-*" = list(endpoint = "application-cost-profiler.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "application-cost-profiler.{region}.sc2s.sgov.gov", global = FALSE)),
