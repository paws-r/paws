...
.mwaa$get_environment_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(Environment = structure(list(AirflowConfigurationOptions = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "map")), AirflowVersion = structure(logical(0), tags = list(type = "string")), Arn = structure(logical(0), tags = list(type = "string")), CreatedAt = structure(logical(0), tags = list(type = "timestamp")), DagS3Path = structure(logical(0), tags = list(type = "string")), EnvironmentClass = structure(logical(0), tags = list(type = "string")), ExecutionRoleArn = structure(logical(0), tags = list(type = "string")), KmsKey = structure(logical(0), tags = list(type = "string")), LastUpdate = structure(list(CreatedAt = structure(logical(0), tags = list(type = "timestamp")), Error = structure(list(ErrorCode = structure(logical(0), tags = list(type = "string")), ErrorMessage = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), Status = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), LoggingConfiguration = structure(list(DagProcessingLogs = structure(list(CloudWatchLogGroupArn = structure(logical(0), tags = list(type = "string")), Enabled = structure(logical(0), tags = list(type = "boolean", box = TRUE)), LogLevel = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), SchedulerLogs = structure(list(CloudWatchLogGroupArn = structure(logical(0), tags = list(type = "string")), Enabled = structure(logical(0), tags = list(type = "boolean", box = TRUE)), LogLevel = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), TaskLogs = structure(list(CloudWatchLogGroupArn = structure(logical(0), tags = list(type = "string")), Enabled = structure(logical(0), tags = list(type = "boolean", box = TRUE)), LogLevel = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), WebserverLogs = structure(list(CloudWatchLogGroupArn = structure(logical(0), tags = list(type = "string")), Enabled = structure(logical(0), tags = list(type = "boolean", box = TRUE)), LogLevel = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), WorkerLogs = structure(list(CloudWatchLogGroupArn = structure(logical(0), tags = list(type = "string")), Enabled = structure(logical(0), tags = list(type = "boolean", box = TRUE)), LogLevel = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure")), MaxWorkers = structure(logical(0), tags = list(type = "integer", box = TRUE)), MinWorkers = structure(logical(0), tags = list(type = "integer", box = TRUE)), Name = structure(logical(0), tags = list(type = "string")), NetworkConfiguration = structure(list(SecurityGroupIds = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "list")), SubnetIds = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "list"))), tags = list(type = "structure")), PluginsS3ObjectVersion = structure(logical(0), tags = list(type = "string")), PluginsS3Path = structure(logical(0), tags = list(type = "string")), RequirementsS3ObjectVersion = structure(logical(0), tags = list(type = "string")), RequirementsS3Path = structure(logical(0), tags = list(type = "string")), ServiceRoleArn = structure(logical(0), tags = list(type = "string")), SourceBucketArn = structure(logical(0), tags = list(type = "string")), Status = structure(logical(0), tags = list(type = "string")), Tags = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "map")), WebserverAccessMode = structure(logical(0), tags = list(type = "string")), WebserverUrl = structure(logical(0), tags = list(type = "string")), WeeklyMaintenanceWindowStart = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
