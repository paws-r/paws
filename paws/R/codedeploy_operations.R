...
#' 
#' Returns an array of one or more instances associated with a deployment. This method works with EC2/On-premises and Lambda compute platforms. The newer [`batch_get_deployment_targets`][codedeploy_batch_get_deployment_targets] works with all compute platforms. The maximum number of instances that can be returned is 25.
#'
#' @usage
...
#'   fileExistsBehavior, deploymentMode, overrideAlarmConfiguration)
#'
...
#' Gets information about a deployment.
#' 
#' The `content` property of the `appSpecContent` object in the returned revision is always null. Use [`get_application_revision`][codedeploy_get_application_revision] and the `sha256` property of the returned `appSpecContent` object to get the content of the deployment’s AppSpec file.
#'
#' @usage
...
#'   outdatedInstancesStrategy, deploymentStyle,
#'   blueGreenDeploymentConfiguration, loadBalancerInfo, ec2TagSet,
#'   ecsServices, onPremisesTagSet, terminationHookEnabled)
#'
