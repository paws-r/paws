...
#'  \link[=glue_get_unfiltered_partition_metadata]{get_unfiltered_partition_metadata} \tab Get unfiltered partition metadata\cr
#'  \link[=glue_get_unfiltered_partitions_metadata]{get_unfiltered_partitions_metadata} \tab Get unfiltered partitions metadata\cr
#'  \link[=glue_get_unfiltered_table_metadata]{get_unfiltered_table_metadata} \tab Get unfiltered table metadata\cr
