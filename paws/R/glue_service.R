...
#'  \link[=glue_delete_connection_type]{delete_connection_type} \tab Deletes a custom connection type in Glue\cr
...
#'  \link[=glue_get_materialized_view_refresh_task_run]{get_materialized_view_refresh_task_run} \tab Get the associated metadata/information for a task run, given a task run ID\cr
...
#'  \link[=glue_list_integration_table_properties]{list_integration_table_properties} \tab Lists the integration table properties in your account\cr
...
#'  \link[=glue_register_connection_type]{register_connection_type} \tab Registers a custom connection type in Glue based on the configuration provided\cr
