...
#'  \link[=iotevents_describe_detector_model_analysis]{describe_detector_model_analysis} \tab Retrieves execution information about a detector model analysis\cr
...
#'  \link[=iotevents_get_detector_model_analysis_results]{get_detector_model_analysis_results} \tab Retrieves one or more analysis results of the detector model\cr
...
#'  \link[=iotevents_start_detector_model_analysis]{start_detector_model_analysis} \tab Performs an analysis of your detector model\cr
