...
.iotevents$metadata <- list(
  ...
  endpoints = list("*" = "iotevents.{region}.amazonaws.com", "cn-*" = "iotevents.{region}.amazonaws.com.cn"),
...
.iotevents$service <- function() {
  new_service(.iotevents$metadata, .iotevents$handlers)
}
