...
.appconfig$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "appconfig.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "appconfig.{region}.amazonaws.com.cn", global = FALSE), "us-iso-*" = list(endpoint = "appconfig.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "appconfig.{region}.sc2s.sgov.gov", global = FALSE)),
