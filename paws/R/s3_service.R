...
#'  \link[=s3_delete_bucket_inventory_configuration]{delete_bucket_inventory_configuration} \tab Deletes an S3 Inventory configuration (identified by the inventory ID) from the bucket\cr
...
#'  \link[=s3_get_bucket_inventory_configuration]{get_bucket_inventory_configuration} \tab Returns an S3 Inventory configuration (identified by the inventory configuration ID) from the bucket\cr
...
#'  \link[=s3_list_bucket_inventory_configurations]{list_bucket_inventory_configurations} \tab Returns a list of S3 Inventory configurations for the bucket\cr
...
#'  \link[=s3_put_bucket_inventory_configuration]{put_bucket_inventory_configuration} \tab This implementation of the PUT action adds an S3 Inventory configuration (identified by the inventory ID) to the bucket\cr
