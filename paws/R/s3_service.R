...
#'  \link[=s3_get_bucket_lifecycle]{get_bucket_lifecycle} \tab Deprecated, see the GetBucketLifecycleConfiguration operation \cr
...
#'  \link[=s3_get_bucket_notification]{get_bucket_notification} \tab Deprecated, see the GetBucketNotificationConfiguration operation \cr
...
#'  \link[=s3_put_bucket_lifecycle]{put_bucket_lifecycle} \tab Deprecated, see the PutBucketLifecycleConfiguration operation \cr
...
#'  \link[=s3_put_bucket_notification]{put_bucket_notification} \tab Deprecated, see the PutBucketNotificationConfiguraiton operation \cr
