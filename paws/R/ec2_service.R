...
#'  \link[=ec2_import_instance]{import_instance} \tab We recommend that you use the ImportImage API\cr
...
.ec2$metadata <- list(
  service_name = "ec2",
  endpoints = list("*" = list(endpoint = "ec2.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "ec2.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "ec2.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "ec2.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "ec2.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "ec2.{region}.csp.hci.ic.gov", global = FALSE)),
  service_id = "EC2",
