...
.route53recoverycontrolconfig$metadata <- list(
  ...
  endpoints = list("aws-global" = list(endpoint = "route53-recovery-control-config.us-west-2.amazonaws.com", global = TRUE), "us-west-2" = list(endpoint = "route53-recovery-control-config.us-west-2.amazonaws.com", global = TRUE), "^(us|eu|ap|sa|ca|me|af|il|mx)\\-\\w+\\-\\d+$" = list(endpoint = "route53-recovery-control-config.{region}.amazonaws.com", global = FALSE), "^cn\\-\\w+\\-\\d+$" = list(endpoint = "route53-recovery-control-config.{region}.amazonaws.com.cn", global = FALSE), "^us\\-gov\\-\\w+\\-\\d+$" = list(endpoint = "route53-recovery-control-config.{region}.amazonaws.com", global = FALSE), "^us\\-iso\\-\\w+\\-\\d+$" = list(endpoint = "route53-recovery-control-config.{region}.c2s.ic.gov", global = FALSE), "^us\\-isob\\-\\w+\\-\\d+$" = list(endpoint = "route53-recovery-control-config.{region}.sc2s.sgov.gov", global = FALSE), "^eu\\-isoe\\-\\w+\\-\\d+$" = list(endpoint = "route53-recovery-control-config.{region}.cloud.adc-e.uk", global = FALSE), "^us\\-isof\\-\\w+\\-\\d+$" = list(endpoint = "route53-recovery-control-config.{region}.csp.hci.ic.gov", global = FALSE)),
