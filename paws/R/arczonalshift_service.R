...
#'  \link[=arczonalshift_list_autoshifts]{list_autoshifts} \tab Returns the active autoshifts for a specified resource\cr
...
#'  \link[=arczonalshift_update_zonal_autoshift_configuration]{update_zonal_autoshift_configuration} \tab You can update the zonal autoshift status for a resource, to enable or disable zonal autoshift\cr
...
.arczonalshift$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "arc-zonal-shift.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "arc-zonal-shift.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "arc-zonal-shift.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "arc-zonal-shift.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "arc-zonal-shift.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "arc-zonal-shift.{region}.csp.hci.ic.gov", global = FALSE)),
