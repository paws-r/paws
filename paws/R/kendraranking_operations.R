...
#' [`rescore`][kendraranking_rescore] API. You set the number of capacity
#' units that you require for Amazon Kendra Intelligent Ranking to rescore
#' or re-rank a search service's results.
#' 
#' For an example of using the
#' [`create_rescore_execution_plan`][kendraranking_create_rescore_execution_plan]
#' API, including using the Python and Java SDKs, see [Semantically ranking
#' a search service's
#' results](https://docs.aws.amazon.com/kendra/latest/dg/search-service-rerank.html).
#'
#' @usage
#' kendraranking_create_rescore_execution_plan(Name, Description,
#'   CapacityUnits, Tags, ClientToken)
#'
...
#'
#' @aliases kendraranking_create_rescore_execution_plan
...
#' Kendra Intelligent Ranking resource used for provisioning the
#' [`rescore`][kendraranking_rescore] API.
#'
#' @usage
...
#'
#' @aliases kendraranking_delete_rescore_execution_plan
...
#' provisioning the [`rescore`][kendraranking_rescore] API.
#'
#' @usage
...
#'
#' @aliases kendraranking_describe_rescore_execution_plan
...
#'
#' @aliases kendraranking_list_rescore_execution_plans
...
#'
#' @aliases kendraranking_list_tags_for_resource
...
#' provisioning the [`rescore`][kendraranking_rescore] API. If the tag
...
#'
#' @aliases kendraranking_tag_resource
...
#' [`rescore`][kendraranking_rescore] operation.
#'
#' @usage
...
#'
#' @aliases kendraranking_untag_resource
...
#' Kendra Intelligent Ranking resource used for provisioning the
#' [`rescore`][kendraranking_rescore] API. You can update the number of
#' capacity units you require for Amazon Kendra Intelligent Ranking to
#' rescore or re-rank a search service's results.
#'
#' @usage
#' kendraranking_update_rescore_execution_plan(Id, Name, Description,
#'   CapacityUnits)
#'
...
#' @section Request syntax:
#' ```
#' svc$update_rescore_execution_plan(
#'   Id = "string",
#'   Name = "string",
#'   Description = "string",
#'   CapacityUnits = list(
...
#'
#' @aliases kendraranking_update_rescore_execution_plan
