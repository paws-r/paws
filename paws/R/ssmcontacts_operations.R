...
ssmcontacts_accept_page <- function(PageId, ContactChannelId = NULL, AcceptType, Note = NULL, AcceptCode) {
  op <- new_operation(
    name = "AcceptPage",
    http_method = "POST",
    http_path = "/",
  ...
  input <- .ssmcontacts$accept_page_input(PageId = PageId, ContactChannelId = ContactChannelId, AcceptType = AcceptType, Note = Note, AcceptCode = AcceptCode)
...
#' @param IdempotencyToken A token ensuring that the action is called only once with the specified
#' details.
#'
#' @return
...
#'
#' @param ContactId &#91;required&#93; The Amazon Resource Name (ARN) of the contact channel.
