...
.directconnect$create_direct_connect_gateway_association_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(directConnectGatewayId = structure(logical(0), tags = list(    type = "string")), virtualGatewayId = structure(logical(0), tags = list(    type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}

.directconnect$create_direct_connect_gateway_association_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(directConnectGatewayAssociation = structure(list(    directConnectGatewayId = structure(logical(0), tags = list(        type = "string")), virtualGatewayId = structure(logical(0), tags = list(        type = "string")), virtualGatewayRegion = structure(logical(0), tags = list(        type = "string")), virtualGatewayOwnerAccount = structure(logical(0), tags = list(        type = "string")), associationState = structure(logical(0), tags = list(        type = "string")), stateChangeError = structure(logical(0), tags = list(        type = "string"))), tags = list(type = "structure"))), tags = list(    type = "structure"))
  return(populate(args, shape))
}
...
.directconnect$describe_direct_connect_gateway_associations_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(directConnectGatewayId = structure(logical(0), tags = list(    type = "string")), virtualGatewayId = structure(logical(0), tags = list(    type = "string")), maxResults = structure(logical(0), tags = list(    type = "integer", box = TRUE)), nextToken = structure(logical(0), tags = list(    type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}

.directconnect$describe_direct_connect_gateway_associations_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(directConnectGatewayAssociations = structure(list(    structure(list(directConnectGatewayId = structure(logical(0), tags = list(        type = "string")), virtualGatewayId = structure(logical(0), tags = list(        type = "string")), virtualGatewayRegion = structure(logical(0), tags = list(        type = "string")), virtualGatewayOwnerAccount = structure(logical(0), tags = list(        type = "string")), associationState = structure(logical(0), tags = list(        type = "string")), stateChangeError = structure(logical(0), tags = list(        type = "string"))), tags = list(type = "structure"))), tags = list(    type = "list")), nextToken = structure(logical(0), tags = list(    type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.directconnect$describe_locations_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(locations = structure(list(structure(list(locationCode = structure(logical(0), tags = list(    type = "string")), locationName = structure(logical(0), tags = list(    type = "string")), region = structure(logical(0), tags = list(    type = "string"))), tags = list(type = "structure"))), tags = list(    type = "list"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
