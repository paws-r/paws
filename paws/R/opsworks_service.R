...
.opsworks$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "opsworks.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "opsworks.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "opsworks.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "opsworks.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "opsworks.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "opsworks.{region}.csp.hci.ic.gov", global = FALSE)),
  service_id = "OpsWorks",
