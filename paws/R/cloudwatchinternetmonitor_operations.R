...
#' more information, see [Using Amazon CloudWatch Internet
...
#' change the percentage of traffic to monitor or the city-networks
#' maximum. For more information, see [Choosing a city-network maximum
#' value](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/IMCityNetworksMaximum.html)
#' in the *Amazon CloudWatch User Guide*.
#'
#' @usage
#' cloudwatchinternetmonitor_create_monitor(MonitorName, Resources,
#'   ClientToken, Tags, MaxCityNetworksToMonitor,
...
#'
#' @aliases cloudwatchinternetmonitor_create_monitor
...
#'
#' @aliases cloudwatchinternetmonitor_delete_monitor
...
#'
#' @aliases cloudwatchinternetmonitor_get_health_event
...
#'
#' @usage
#' cloudwatchinternetmonitor_get_monitor(MonitorName)
#'
#' @param MonitorName &#91;required&#93; The name of the monitor.
#'
#' @return
...
#'
#' @aliases cloudwatchinternetmonitor_get_monitor
...
#'
#' @usage
#' cloudwatchinternetmonitor_get_query_results(MonitorName, QueryId,
...
#'
#' @aliases cloudwatchinternetmonitor_get_query_results
...
#'
#' @aliases cloudwatchinternetmonitor_get_query_status
...
#'   EndTime, NextToken, MaxResults, EventStatus)
#'
#' @param MonitorName &#91;required&#93; The name of the monitor.
...
#'
#' @aliases cloudwatchinternetmonitor_list_health_events
...
#'
#' @usage
#' cloudwatchinternetmonitor_list_monitors(NextToken, MaxResults,
#'   MonitorStatus)
#'
#' @param NextToken The token for the next set of results. You receive this token from a
#' previous call.
...
#'
#' @aliases cloudwatchinternetmonitor_list_monitors
...
#'
#' @aliases cloudwatchinternetmonitor_list_tags_for_resource
...
#'
#' @aliases cloudwatchinternetmonitor_start_query
...
#'
#' @aliases cloudwatchinternetmonitor_stop_query
...
#' CloudWatch Internet Monitor. You can add a maximum of 50 tags in
#' Internet Monitor.
#' 
#' A minimum of one tag is required for this call. It returns an error if
#' you use the [`tag_resource`][cloudwatchinternetmonitor_tag_resource]
#' request with 0 tags.
#'
#' @usage
...
#'
#' @aliases cloudwatchinternetmonitor_tag_resource
...
#'
#' @aliases cloudwatchinternetmonitor_untag_resource
...
#' ASNs), to add or remove resources, or to change the status of the
...
#' information, see [Choosing a city-network maximum
#' value](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/IMCityNetworksMaximum.html)
#' in the *Amazon CloudWatch User Guide*.
#'
#' @usage
...
#'
#' @aliases cloudwatchinternetmonitor_update_monitor
