...
#'
#' @usage
#' customerprofiles_search_recommendations(DomainName, KeyName, KeyValues,
#'   Recommender, CandidateIds, Context, Diversity, Metadata,
#'   MaxRecommendations)
#'
#' @param DomainName &#91;required&#93; The unique name of the domain.
...
#'
#' @aliases customerprofiles_search_recommendations
