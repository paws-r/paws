...
#'  \link[=locationservice_create_tracker]{create_tracker} \tab Creates a tracker resource in your AWS account, which lets you retrieve current and historical location of devices\cr
#'  \link[=locationservice_delete_geofence_collection]{delete_geofence_collection} \tab Deletes a geofence collection from your AWS account\cr
#'  \link[=locationservice_delete_map]{delete_map} \tab Deletes a map resource from your AWS account\cr
#'  \link[=locationservice_delete_place_index]{delete_place_index} \tab Deletes a Place index resource from your AWS account\cr
#'  \link[=locationservice_delete_tracker]{delete_tracker} \tab Deletes a tracker resource from your AWS account\cr
...
#'  \link[=locationservice_list_geofence_collections]{list_geofence_collections} \tab Lists geofence collections in your AWS account\cr
#'  \link[=locationservice_list_geofences]{list_geofences} \tab Lists geofences stored in a given geofence collection\cr
#'  \link[=locationservice_list_maps]{list_maps} \tab Lists map resources in your AWS account\cr
