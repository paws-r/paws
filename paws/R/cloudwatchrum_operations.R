...
#'   metrics to both Evidently and CloudWatch. The valid dimension names
#'   for the additional dimensions for extended metrics are `BrowserName`,
#'   `CountryCode`, `DeviceType`, `FileType`, `OSName`, and `PageId`. For
#'   more information, see [Extended metrics that you can send to
...
#'   prepends `RUM/CustomMetrics/` to the custom namespace that you define,
