...
#' PCA](acm-pca/latest/userguide/PcaLimits.html#PcaLimits-api) in the ACM
#' PCA user guide.
#'
#' @section Example:
#' ```
...
#'  \link[=acmpca_create_certificate_authority_audit_report]{create_certificate_authority_audit_report} \tab Creates an audit report that lists every time that the your CA private key is used \cr
