...
.codeartifact$describe_package_version_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(packageVersion = structure(list(format = structure(logical(0), tags = list(type = "string")), namespace = structure(logical(0), tags = list(type = "string")), packageName = structure(logical(0), tags = list(type = "string")), displayName = structure(logical(0), tags = list(type = "string")), version = structure(logical(0), tags = list(type = "string")), summary = structure(logical(0), tags = list(type = "string")), homePage = structure(logical(0), tags = list(type = "string")), sourceCodeRepository = structure(logical(0), tags = list(type = "string")), publishedTime = structure(logical(0), tags = list(type = "timestamp")), licenses = structure(list(structure(list(name = structure(logical(0), tags = list(type = "string")), url = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), revision = structure(logical(0), tags = list(type = "string")), status = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.codeartifact$list_package_versions_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(defaultDisplayVersion = structure(logical(0), tags = list(type = "string")), format = structure(logical(0), tags = list(type = "string")), namespace = structure(logical(0), tags = list(type = "string")), package = structure(logical(0), tags = list(type = "string")), versions = structure(list(structure(list(version = structure(logical(0), tags = list(type = "string")), revision = structure(logical(0), tags = list(type = "string")), status = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), nextToken = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.codeartifact$list_packages_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(packages = structure(list(structure(list(format = structure(logical(0), tags = list(type = "string")), namespace = structure(logical(0), tags = list(type = "string")), package = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), nextToken = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
