...
#'  \link[=elbv2_delete_shared_trust_store_association]{delete_shared_trust_store_association} \tab Deletes a shared trust store association\cr
...
#'  \link[=elbv2_describe_trust_store_revocations]{describe_trust_store_revocations} \tab Describes the revocation files in use by the specified trust store or revocation files\cr
#'  \link[=elbv2_describe_trust_stores]{describe_trust_stores} \tab Describes all trust stores for the specified account\cr
...
#'  \link[=elbv2_modify_ip_pools]{modify_ip_pools} \tab &#91;Application Load Balancers&#93; Modify the IP pool associated to a load balancer\cr
...
#'  \link[=elbv2_modify_trust_store]{modify_trust_store} \tab Update the ca certificate bundle for the specified trust store\cr
