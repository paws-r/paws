...
#'  \link[=sns_get_data_protection_policy]{get_data_protection_policy} \tab Amazon SNS message data protection is no longer available to new customers\cr
...
#'  \link[=sns_put_data_protection_policy]{put_data_protection_policy} \tab Amazon SNS message data protection is no longer available to new customers\cr
