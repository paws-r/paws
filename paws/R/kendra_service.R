...
#'  \link[=kendra_describe_thesaurus]{describe_thesaurus} \tab Describes an existing Amazon Kendra thesaurus\cr
...
#'  \link[=kendra_list_thesauri]{list_thesauri} \tab Lists the Amazon Kendra thesauri associated with an index\cr
