...
#' service discovery naming for their components. To use App Mesh, you must
#' have a containerized application running on Amazon EC2 instances, hosted
#' in either Amazon ECS, Amazon EKS, or Kubernetes on AWS. For more
...
#' @section Operations:
#' \tabular{ll}{
#'  \link[=appmesh_create_mesh]{create_mesh} \tab Creates a new service mesh \cr
#'  \link[=appmesh_create_route]{create_route} \tab Creates a new route that is associated with a virtual router \cr
#'  \link[=appmesh_create_virtual_node]{create_virtual_node} \tab Creates a new virtual node within a service mesh \cr
#'  \link[=appmesh_create_virtual_router]{create_virtual_router} \tab Creates a new virtual router within a service mesh \cr
...
#'  \link[=appmesh_update_virtual_router]{update_virtual_router} \tab Updates an existing virtual router in a specified service mesh 
#' }
#'
#' @rdname appmesh
#' @export
