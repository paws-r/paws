...
#' [Adding Data to a
#' Stream](https://docs.aws.amazon.com/streams/latest/dev/developing-producers-with-sdk.html)
#' in the *Amazon Kinesis Data Streams Developer Guide*.
#' 
...
#' Records with
#' PutRecords](https://docs.aws.amazon.com/streams/latest/dev/developing-producers-with-sdk.html)
#' in the *Amazon Kinesis Data Streams Developer Guide*.
#' 
