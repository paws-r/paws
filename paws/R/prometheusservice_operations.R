...
#' operation to set the CloudWatch log group to which the logs will be
#' published to.
#'
#' @usage
...
#' Prometheus-compatible sources within an Amazon EKS cluster, and sends
#' them to your Amazon Managed Service for Prometheus workspace. Scrapers
#' are flexible, and can be configured to control what metrics are
...
#'   roleConfiguration, scrapeConfiguration, source, tags)
#'
...
#'   roleConfiguration, scrapeConfiguration, scraperId)
#'
