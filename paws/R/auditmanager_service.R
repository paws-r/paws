...
#'  \link[=auditmanager_batch_import_evidence_to_assessment_control]{batch_import_evidence_to_assessment_control} \tab Uploads one or more pieces of evidence to a control in an Audit Manager assessment\cr
...
#'  \link[=auditmanager_get_account_status]{get_account_status} \tab Returns the registration status of an account in Audit Manager\cr
#'  \link[=auditmanager_get_assessment]{get_assessment} \tab Returns an assessment from Audit Manager\cr
#'  \link[=auditmanager_get_assessment_framework]{get_assessment_framework} \tab Returns a framework from Audit Manager\cr
#'  \link[=auditmanager_get_assessment_report_url]{get_assessment_report_url} \tab Returns the URL of an assessment report in Audit Manager\cr
#'  \link[=auditmanager_get_change_logs]{get_change_logs} \tab Returns a list of changelogs from Audit Manager\cr
#'  \link[=auditmanager_get_control]{get_control} \tab Returns a control from Audit Manager\cr
#'  \link[=auditmanager_get_delegations]{get_delegations} \tab Returns a list of delegations from an audit owner to a delegate\cr
#'  \link[=auditmanager_get_evidence]{get_evidence} \tab Returns evidence from Audit Manager\cr
#'  \link[=auditmanager_get_evidence_by_evidence_folder]{get_evidence_by_evidence_folder} \tab Returns all evidence from a specified evidence folder in Audit Manager\cr
#'  \link[=auditmanager_get_evidence_folder]{get_evidence_folder} \tab Returns an evidence folder from the specified assessment in Audit Manager\cr
#'  \link[=auditmanager_get_evidence_folders_by_assessment]{get_evidence_folders_by_assessment} \tab Returns the evidence folders from a specified assessment in Audit Manager\cr
#'  \link[=auditmanager_get_evidence_folders_by_assessment_control]{get_evidence_folders_by_assessment_control} \tab Returns a list of evidence folders that are associated with a specified control in an Audit Manager assessment\cr
...
#'  \link[=auditmanager_get_organization_admin_account]{get_organization_admin_account} \tab Returns the name of the delegated Amazon Web Services administrator account for the organization\cr
#'  \link[=auditmanager_get_services_in_scope]{get_services_in_scope} \tab Returns a list of all of the Amazon Web Services that you can choose to include in your assessment\cr
#'  \link[=auditmanager_get_settings]{get_settings} \tab Returns the settings for the specified Amazon Web Services account\cr
