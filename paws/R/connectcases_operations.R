...
#' 
#' - Calling [`create_case`][connectcases_create_case] with a deleted field
#'   throws a `ValidationException` denoting which field IDs in the request
#'   have been deleted.
#' 
#' - Calling [`get_case`][connectcases_get_case] with a deleted field ID
#'   returns the deleted field's value if one exists.
#' 
#' - Calling [`update_case`][connectcases_update_case] with a deleted field
#'   ID throws a `ValidationException` if the case does not already contain
#'   a value for the deleted field. Otherwise it succeeds, allowing you to
#'   update or remove (using `emptyValue: {}`) the field's value from the
#'   case.
#' 
#' - [`get_template`][connectcases_get_template] does not return field IDs
#'   for deleted fields.
#' 
#' - [`get_layout`][connectcases_get_layout] does not return field IDs for
#'   deleted fields.
#' 
...
#' 
#' - Calling
#'   [`batch_put_field_options`][connectcases_batch_put_field_options] with
#'   a deleted field ID throw a `ValidationException`.
#' 
#' - Calling
