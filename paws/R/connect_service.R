...
#' @section Operations:
#' \tabular{ll}{
#'  \link[=connect_activate_evaluation_form]{activate_evaluation_form} \tab Activates an evaluation form in the specified Connect Customer instance\cr
#'  \link[=connect_associate_analytics_data_set]{associate_analytics_data_set} \tab Associates the specified dataset for a Connect Customer instance with the target account\cr
#'  \link[=connect_associate_approved_origin]{associate_approved_origin} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_associate_bot]{associate_bot} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_associate_contact_with_user]{associate_contact_with_user} \tab Associates a queued contact with an agent\cr
#'  \link[=connect_associate_default_vocabulary]{associate_default_vocabulary} \tab Associates an existing vocabulary as the default\cr
#'  \link[=connect_associate_email_address_alias]{associate_email_address_alias} \tab Associates an email address alias with an existing email address in an Connect Customer instance\cr
#'  \link[=connect_associate_flow]{associate_flow} \tab Associates a connect resource to a flow\cr
#'  \link[=connect_associate_hours_of_operations]{associate_hours_of_operations} \tab Associates a set of hours of operations with another hours of operation\cr
#'  \link[=connect_associate_instance_storage_config]{associate_instance_storage_config} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_associate_lambda_function]{associate_lambda_function} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_associate_lex_bot]{associate_lex_bot} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_associate_phone_number_contact_flow]{associate_phone_number_contact_flow} \tab Associates a flow with a phone number claimed to your Connect Customer instance\cr
#'  \link[=connect_associate_queue_email_addresses]{associate_queue_email_addresses} \tab Associates a set of email addresses with a queue to enable agents to select different "From" (system) email addresses when replying to inbound email contacts or initiating outbound email contacts\cr
#'  \link[=connect_associate_queue_quick_connects]{associate_queue_quick_connects} \tab Associates a set of quick connects with a queue\cr
...
#'  \link[=connect_associate_security_key]{associate_security_key} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_associate_security_profiles]{associate_security_profiles} \tab Associate security profiles with an Entity in an Amazon Connect instance\cr
...
#'  \link[=connect_associate_workspace]{associate_workspace} \tab Associates a workspace with one or more users or routing profiles, allowing them to access the workspace's configured views and pages\cr
#'  \link[=connect_batch_associate_analytics_data_set]{batch_associate_analytics_data_set} \tab Associates a list of analytics datasets for a given Connect Customer instance to a target account\cr
#'  \link[=connect_batch_create_data_table_value]{batch_create_data_table_value} \tab Creates values for attributes in a data table\cr
#'  \link[=connect_batch_delete_data_table_value]{batch_delete_data_table_value} \tab Deletes multiple values from a data table\cr
#'  \link[=connect_batch_describe_data_table_value]{batch_describe_data_table_value} \tab Retrieves multiple values from a data table without evaluating expressions\cr
#'  \link[=connect_batch_disassociate_analytics_data_set]{batch_disassociate_analytics_data_set} \tab Removes a list of analytics datasets associated with a given Connect Customer instance\cr
...
#'  \link[=connect_batch_put_contact]{batch_put_contact} \tab Only the Connect Customer outbound campaigns service principal is allowed to assume a role in your account and call this API\cr
#'  \link[=connect_batch_update_data_table_value]{batch_update_data_table_value} \tab Updates multiple data table values using all properties from BatchCreateDataTableValue\cr
...
#'  \link[=connect_create_contact_flow_module_alias]{create_contact_flow_module_alias} \tab Creates a named alias that points to a specific version of a contact flow module\cr
#'  \link[=connect_create_contact_flow_module_version]{create_contact_flow_module_version} \tab Creates an immutable snapshot of a contact flow module, preserving its content and settings at a specific point in time for version control and rollback capabilities\cr
#'  \link[=connect_create_contact_flow_version]{create_contact_flow_version} \tab Publishes a new version of the flow provided\cr
#'  \link[=connect_create_data_table]{create_data_table} \tab Creates a new data table with the specified properties\cr
...
#'  \link[=connect_create_predefined_attribute]{create_predefined_attribute} \tab Creates a new predefined attribute for the specified Connect Customer instance\cr
#'  \link[=connect_create_prompt]{create_prompt} \tab Creates a prompt\cr
#'  \link[=connect_create_push_notification_registration]{create_push_notification_registration} \tab Creates registration for a device token and a chat contact to receive real-time push notifications\cr
#'  \link[=connect_create_queue]{create_queue} \tab Creates a new queue for the specified Connect Customer instance\cr
#'  \link[=connect_create_quick_connect]{create_quick_connect} \tab Creates a quick connect for the specified Connect Customer instance\cr
#'  \link[=connect_create_routing_profile]{create_routing_profile} \tab Creates a new routing profile\cr
#'  \link[=connect_create_rule]{create_rule} \tab Creates a rule for the specified Connect Customer instance\cr
#'  \link[=connect_create_security_profile]{create_security_profile} \tab Creates a security profile\cr
#'  \link[=connect_create_task_template]{create_task_template} \tab Creates a new task template in the specified Connect Customer instance\cr
#'  \link[=connect_create_test_case]{create_test_case} \tab Creates a test case with its content and metadata for the specified Amazon Connect instance\cr
#'  \link[=connect_create_traffic_distribution_group]{create_traffic_distribution_group} \tab Creates a traffic distribution group given an Connect Customer instance that has been replicated\cr
#'  \link[=connect_create_use_case]{create_use_case} \tab Creates a use case for an integration association\cr
#'  \link[=connect_create_user]{create_user} \tab Creates a user account for the specified Connect Customer instance\cr
...
#'  \link[=connect_create_vocabulary]{create_vocabulary} \tab Creates a custom vocabulary associated with your Connect Customer instance\cr
#'  \link[=connect_create_workspace]{create_workspace} \tab Creates a workspace that defines the user experience by mapping views to pages\cr
...
#'  \link[=connect_delete_contact_flow_module_alias]{delete_contact_flow_module_alias} \tab Removes an alias reference, breaking the named connection to the underlying module version without affecting the version itself\cr
#'  \link[=connect_delete_contact_flow_module_version]{delete_contact_flow_module_version} \tab Removes a specific version of a contact flow module\cr
...
#'  \link[=connect_delete_data_table]{delete_data_table} \tab Deletes a data table and all associated attributes, versions, audits, and values\cr
...
#'  \link[=connect_delete_push_notification_registration]{delete_push_notification_registration} \tab Deletes registration for a device token and a chat contact\cr
#'  \link[=connect_delete_queue]{delete_queue} \tab Deletes a queue\cr
...
#'  \link[=connect_delete_user]{delete_user} \tab Deletes a user account from the specified Connect Customer instance\cr
...
#'  \link[=connect_delete_workspace]{delete_workspace} \tab Deletes a workspace and removes all associated view and resource assignments\cr
#'  \link[=connect_delete_workspace_media]{delete_workspace_media} \tab Deletes a media asset (such as a logo) from a workspace\cr
#'  \link[=connect_delete_workspace_page]{delete_workspace_page} \tab Removes the association between a view and a page in a workspace\cr
#'  \link[=connect_describe_agent_status]{describe_agent_status} \tab Describes an agent status\cr
#'  \link[=connect_describe_attached_files_configuration]{describe_attached_files_configuration} \tab Describes the attached files configuration for the specified Connect Customer instance and attachment scope\cr
#'  \link[=connect_describe_authentication_profile]{describe_authentication_profile} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_describe_contact]{describe_contact} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_describe_contact_evaluation]{describe_contact_evaluation} \tab Describes a contact evaluation in the specified Connect Customer instance\cr
#'  \link[=connect_describe_contact_flow]{describe_contact_flow} \tab Describes the specified flow\cr
#'  \link[=connect_describe_contact_flow_module]{describe_contact_flow_module} \tab Describes the specified flow module\cr
#'  \link[=connect_describe_contact_flow_module_alias]{describe_contact_flow_module_alias} \tab Retrieves detailed information about a specific alias, including which version it currently points to and its metadata\cr
#'  \link[=connect_describe_data_table]{describe_data_table} \tab Returns all properties for a data table except for attributes and values\cr
...
#'  \link[=connect_describe_prompt]{describe_prompt} \tab Describes the prompt\cr
#'  \link[=connect_describe_queue]{describe_queue} \tab Describes the specified queue\cr
...
#'  \link[=connect_describe_rule]{describe_rule} \tab Describes a rule for the specified Connect Customer instance\cr
#'  \link[=connect_describe_security_profile]{describe_security_profile} \tab Gets basic information about the security profile\cr
#'  \link[=connect_describe_test_case]{describe_test_case} \tab Describes the specified test case and allows you to get the content and metadata of the test case for the specified Amazon Connect instance\cr
...
#'  \link[=connect_describe_user]{describe_user} \tab Describes the specified user\cr
#'  \link[=connect_describe_user_hierarchy_group]{describe_user_hierarchy_group} \tab Describes the specified hierarchy group\cr
#'  \link[=connect_describe_user_hierarchy_structure]{describe_user_hierarchy_structure} \tab Describes the hierarchy structure of the specified Connect Customer instance\cr
#'  \link[=connect_describe_view]{describe_view} \tab Retrieves the view for the specified Connect Customer instance and view identifier\cr
#'  \link[=connect_describe_vocabulary]{describe_vocabulary} \tab Describes the specified vocabulary\cr
#'  \link[=connect_describe_workspace]{describe_workspace} \tab Retrieves details about a workspace, including its configuration and metadata\cr
#'  \link[=connect_disassociate_analytics_data_set]{disassociate_analytics_data_set} \tab Removes the dataset ID associated with a given Connect Customer instance\cr
#'  \link[=connect_disassociate_approved_origin]{disassociate_approved_origin} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_disassociate_bot]{disassociate_bot} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_disassociate_email_address_alias]{disassociate_email_address_alias} \tab Removes the alias association between two email addresses in an Connect Customer instance\cr
#'  \link[=connect_disassociate_flow]{disassociate_flow} \tab Disassociates a connect resource from a flow\cr
#'  \link[=connect_disassociate_hours_of_operations]{disassociate_hours_of_operations} \tab Disassociates a set of hours of operations with another hours of operation\cr
#'  \link[=connect_disassociate_instance_storage_config]{disassociate_instance_storage_config} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_disassociate_lambda_function]{disassociate_lambda_function} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_disassociate_lex_bot]{disassociate_lex_bot} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_disassociate_phone_number_contact_flow]{disassociate_phone_number_contact_flow} \tab Removes the flow association from a phone number claimed to your Connect Customer instance\cr
#'  \link[=connect_disassociate_queue_email_addresses]{disassociate_queue_email_addresses} \tab Removes the association between a set of email addresses and a queue\cr
#'  \link[=connect_disassociate_queue_quick_connects]{disassociate_queue_quick_connects} \tab Disassociates a set of quick connects from a queue\cr
...
#'  \link[=connect_disassociate_security_key]{disassociate_security_key} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_disassociate_security_profiles]{disassociate_security_profiles} \tab Disassociates a security profile attached to a Q in Connect AI Agent Entity in an Amazon Connect instance\cr
...
#'  \link[=connect_disassociate_workspace]{disassociate_workspace} \tab Removes the association between a workspace and one or more users or routing profiles\cr
...
#'  \link[=connect_evaluate_data_table_values]{evaluate_data_table_values} \tab Evaluates values at the time of the request and returns them\cr
...
#'  \link[=connect_get_metric_data_v2]{get_metric_data_v2} \tab Gets metric data from the specified Connect Customer instance\cr
#'  \link[=connect_get_prompt_file]{get_prompt_file} \tab Gets the prompt file\cr
#'  \link[=connect_get_task_template]{get_task_template} \tab Gets details about a specific task template in the specified Connect Customer instance\cr
#'  \link[=connect_get_test_case_execution_summary]{get_test_case_execution_summary} \tab Retrieves an overview of a test execution that includes the status of the execution, start and end time, and observation summary\cr
#'  \link[=connect_get_traffic_distribution]{get_traffic_distribution} \tab Retrieves the current traffic distribution for a given traffic distribution group\cr
#'  \link[=connect_import_phone_number]{import_phone_number} \tab Imports a claimed phone number from an external service, such as Amazon Web Services End User Messaging, into an Connect Customer instance\cr
#'  \link[=connect_import_workspace_media]{import_workspace_media} \tab Imports a media asset (such as a logo) for use in a workspace\cr
#'  \link[=connect_list_agent_statuses]{list_agent_statuses} \tab Lists agent statuses\cr
#'  \link[=connect_list_analytics_data_associations]{list_analytics_data_associations} \tab Lists the association status of requested dataset ID for a given Connect Customer instance\cr
#'  \link[=connect_list_analytics_data_lake_data_sets]{list_analytics_data_lake_data_sets} \tab Lists the data lake datasets available to associate with for a given Connect Customer instance\cr
#'  \link[=connect_list_approved_origins]{list_approved_origins} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_list_associated_contacts]{list_associated_contacts} \tab Provides information about contact tree, a list of associated contacts with a unique identifier\cr
#'  \link[=connect_list_attached_files_configurations]{list_attached_files_configurations} \tab Provides summary information about the attached files configurations for the specified Connect Customer instance\cr
#'  \link[=connect_list_authentication_profiles]{list_authentication_profiles} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_list_bots]{list_bots} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_list_child_hours_of_operations]{list_child_hours_of_operations} \tab Provides information about the child hours of operations for the specified parent hours of operation\cr
#'  \link[=connect_list_contact_evaluations]{list_contact_evaluations} \tab Lists contact evaluations in the specified Connect Customer instance\cr
#'  \link[=connect_list_contact_flow_module_aliases]{list_contact_flow_module_aliases} \tab Lists all aliases associated with a contact flow module, showing their current version mappings and metadata\cr
#'  \link[=connect_list_contact_flow_modules]{list_contact_flow_modules} \tab Provides information about the flow modules for the specified Connect Customer instance\cr
#'  \link[=connect_list_contact_flow_module_versions]{list_contact_flow_module_versions} \tab Retrieves a paginated list of all versions for a specific contact flow module\cr
#'  \link[=connect_list_contact_flows]{list_contact_flows} \tab Provides information about the flows for the specified Connect Customer instance\cr
#'  \link[=connect_list_contact_flow_versions]{list_contact_flow_versions} \tab Returns all the available versions for the specified Connect Customer instance and flow identifier\cr
#'  \link[=connect_list_contact_references]{list_contact_references} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_list_data_table_attributes]{list_data_table_attributes} \tab Returns all attributes for a specified data table\cr
#'  \link[=connect_list_data_table_primary_values]{list_data_table_primary_values} \tab Lists all primary value combinations for a given data table\cr
#'  \link[=connect_list_data_tables]{list_data_tables} \tab Lists all data tables for the specified Amazon Connect instance\cr
#'  \link[=connect_list_data_table_values]{list_data_table_values} \tab Lists values stored in a data table with optional filtering by record IDs or primary attribute values\cr
#'  \link[=connect_list_default_vocabularies]{list_default_vocabularies} \tab Lists the default vocabularies for the specified Connect Customer instance\cr
...
#'  \link[=connect_list_evaluation_form_ai_versions]{list_evaluation_form_ai_versions} \tab Lists the available AI versions for evaluation forms in the specified Connect Customer instance\cr
...
#'  \link[=connect_list_instance_attributes]{list_instance_attributes} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_list_instances]{list_instances} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_list_instance_storage_configs]{list_instance_storage_configs} \tab This API is in preview release for Connect Customer and is subject to change\cr
...
#'  \link[=connect_list_predefined_attributes]{list_predefined_attributes} \tab Lists predefined attributes for the specified Connect Customer instance\cr
#'  \link[=connect_list_prompts]{list_prompts} \tab Provides information about the prompts for the specified Connect Customer instance\cr
#'  \link[=connect_list_queue_email_addresses]{list_queue_email_addresses} \tab Lists all email addresses that are currently associated with a specific queue, providing details about which "From" email addresses agents can select when handling email contacts\cr
#'  \link[=connect_list_queue_quick_connects]{list_queue_quick_connects} \tab Lists the quick connects associated with a queue\cr
#'  \link[=connect_list_queues]{list_queues} \tab Provides information about the queues for the specified Connect Customer instance\cr
#'  \link[=connect_list_quick_connects]{list_quick_connects} \tab Provides information about the quick connects for the specified Connect Customer instance\cr
#'  \link[=connect_list_realtime_contact_analysis_segments_v2]{list_realtime_contact_analysis_segments_v2} \tab Provides a list of analysis segments for a real-time chat analysis session\cr
#'  \link[=connect_list_routing_profile_manual_assignment_queues]{list_routing_profile_manual_assignment_queues} \tab Lists the manual assignment queues associated with a routing profile\cr
#'  \link[=connect_list_routing_profile_queues]{list_routing_profile_queues} \tab Lists the queues associated with a routing profile\cr
...
#'  \link[=connect_list_security_profiles]{list_security_profiles} \tab Provides summary information about the security profiles for the specified Connect Customer instance\cr
#'  \link[=connect_list_tags_for_resource]{list_tags_for_resource} \tab Lists the tags for the specified resource\cr
#'  \link[=connect_list_task_templates]{list_task_templates} \tab Lists task templates for the specified Connect Customer instance\cr
#'  \link[=connect_list_test_case_execution_records]{list_test_case_execution_records} \tab Lists detailed steps of test case execution that includes all observations along with actions taken and data associated in the specified Amazon Connect instance\cr
#'  \link[=connect_list_test_case_executions]{list_test_case_executions} \tab Lists all test case executions and allows filtering by test case id, test case name, start time, end time or status of the execution for the specified Amazon Connect instance\cr
#'  \link[=connect_list_test_cases]{list_test_cases} \tab Lists the test cases present in the specific Amazon Connect instance\cr
...
#'  \link[=connect_list_user_hierarchy_groups]{list_user_hierarchy_groups} \tab Provides summary information about the hierarchy groups for the specified Connect Customer instance\cr
#'  \link[=connect_list_user_notifications]{list_user_notifications} \tab Retrieves a paginated list of notifications for a specific user, including the notification status for that user\cr
#'  \link[=connect_list_user_proficiencies]{list_user_proficiencies} \tab Lists proficiencies associated with a user\cr
#'  \link[=connect_list_users]{list_users} \tab Provides summary information about the users for the specified Connect Customer instance\cr
#'  \link[=connect_list_views]{list_views} \tab Returns views in the given instance\cr
#'  \link[=connect_list_view_versions]{list_view_versions} \tab Returns all the available versions for the specified Connect Customer instance and view identifier\cr
#'  \link[=connect_list_workspace_media]{list_workspace_media} \tab Lists media assets (such as logos) associated with a workspace\cr
#'  \link[=connect_list_workspace_pages]{list_workspace_pages} \tab Lists the page configurations in a workspace, including the views assigned to each page\cr
#'  \link[=connect_list_workspaces]{list_workspaces} \tab Lists the workspaces in an Amazon Connect instance\cr
#'  \link[=connect_monitor_contact]{monitor_contact} \tab Initiates silent monitoring of a contact\cr
#'  \link[=connect_pause_contact]{pause_contact} \tab Allows pausing an ongoing task contact\cr
#'  \link[=connect_put_user_status]{put_user_status} \tab Changes the current status of a user or agent in Connect Customer\cr
#'  \link[=connect_release_phone_number]{release_phone_number} \tab Releases a phone number previously claimed to an Connect Customer instance or traffic distribution group\cr
#'  \link[=connect_replicate_instance]{replicate_instance} \tab Replicates an Connect Customer instance in the specified Amazon Web Services Region and copies configuration information for Connect Customer resources across Amazon Web Services Regions\cr
...
#'  \link[=connect_search_agent_statuses]{search_agent_statuses} \tab Searches AgentStatuses in an Connect Customer instance, with optional filtering\cr
#'  \link[=connect_search_available_phone_numbers]{search_available_phone_numbers} \tab Searches for available phone numbers that you can claim to your Connect Customer instance or traffic distribution group\cr
#'  \link[=connect_search_contact_evaluations]{search_contact_evaluations} \tab Searches contact evaluations in an Connect Customer instance, with optional filtering\cr
#'  \link[=connect_search_contact_flow_modules]{search_contact_flow_modules} \tab Searches the flow modules in an Connect Customer instance, with optional filtering\cr
#'  \link[=connect_search_contact_flows]{search_contact_flows} \tab Searches the flows in an Connect Customer instance, with optional filtering\cr
#'  \link[=connect_search_contacts]{search_contacts} \tab Searches contacts in an Connect Customer instance\cr
#'  \link[=connect_search_data_tables]{search_data_tables} \tab Searches for data tables based on the table's ID, name, and description\cr
#'  \link[=connect_search_email_addresses]{search_email_addresses} \tab Searches email address in an instance, with optional filtering\cr
...
#'  \link[=connect_search_queues]{search_queues} \tab Searches queues in an Connect Customer instance, with optional filtering\cr
...
#'  \link[=connect_search_users]{search_users} \tab Searches users in an Connect Customer instance, with optional filtering\cr
#'  \link[=connect_search_views]{search_views} \tab Searches views based on name, description, or tags\cr
#'  \link[=connect_search_vocabularies]{search_vocabularies} \tab Searches for vocabularies within a specific Connect Customer instance using State, NameStartsWith, and LanguageCode\cr
#'  \link[=connect_search_workspace_associations]{search_workspace_associations} \tab Searches for workspace associations with users or routing profiles based on various criteria\cr
...
#'  \link[=connect_start_screen_sharing]{start_screen_sharing} \tab Starts screen sharing for a contact\cr
#'  \link[=connect_start_task_contact]{start_task_contact} \tab Initiates a flow to start a new task contact\cr
#'  \link[=connect_start_test_case_execution]{start_test_case_execution} \tab Starts executing a published test case\cr
#'  \link[=connect_start_web_rtc_contact]{start_web_rtc_contact} \tab Places an inbound in-app, web, or video call to a contact, and then initiates the flow\cr
#'  \link[=connect_stop_contact]{stop_contact} \tab Ends the specified contact\cr
#'  \link[=connect_stop_contact_media_processing]{stop_contact_media_processing} \tab Stops in-flight message processing for an ongoing chat session\cr
...
#'  \link[=connect_stop_test_case_execution]{stop_test_case_execution} \tab Stops a running test execution\cr
#'  \link[=connect_submit_contact_evaluation]{submit_contact_evaluation} \tab Submits a contact evaluation in the specified Connect Customer instance\cr
#'  \link[=connect_suspend_contact_recording]{suspend_contact_recording} \tab When a contact is being recorded, this API suspends recording whatever is selected in the flow configuration: call (IVR or agent), screen, or both\cr
#'  \link[=connect_tag_contact]{tag_contact} \tab Adds the specified tags to the contact resource\cr
#'  \link[=connect_tag_resource]{tag_resource} \tab Adds the specified tags to the specified resource\cr
#'  \link[=connect_transfer_contact]{transfer_contact} \tab Transfers TASK or EMAIL contacts from one agent or queue to another agent or queue at any point after a contact is created\cr
...
#'  \link[=connect_update_agent_status]{update_agent_status} \tab Updates agent status\cr
#'  \link[=connect_update_attached_files_configuration]{update_attached_files_configuration} \tab Updates the attached files configuration for the specified Connect Customer instance and attachment scope\cr
#'  \link[=connect_update_authentication_profile]{update_authentication_profile} \tab This API is in preview release for Connect Customer and is subject to change\cr
#'  \link[=connect_update_contact]{update_contact} \tab This API is in preview release for Connect Customer and is subject to change\cr
...
#'  \link[=connect_update_contact_evaluation]{update_contact_evaluation} \tab Updates details about a contact evaluation in the specified Connect Customer instance\cr
#'  \link[=connect_update_contact_flow_content]{update_contact_flow_content} \tab Updates the specified flow\cr
#'  \link[=connect_update_contact_flow_metadata]{update_contact_flow_metadata} \tab Updates metadata about specified flow\cr
#'  \link[=connect_update_contact_flow_module_alias]{update_contact_flow_module_alias} \tab Updates a specific Aliases metadata, including the version it’s tied to, it’s name, and description\cr
#'  \link[=connect_update_contact_flow_module_content]{update_contact_flow_module_content} \tab Updates specified flow module for the specified Connect Customer instance\cr
...
#'  \link[=connect_update_phone_number]{update_phone_number} \tab Updates your claimed phone number from its current Connect Customer instance or traffic distribution group to another Connect Customer instance or traffic distribution group in the same Amazon Web Services Region\cr
#'  \link[=connect_update_phone_number_metadata]{update_phone_number_metadata} \tab Updates a phone number’s metadata\cr
#'  \link[=connect_update_predefined_attribute]{update_predefined_attribute} \tab Updates a predefined attribute for the specified Connect Customer instance\cr
#'  \link[=connect_update_prompt]{update_prompt} \tab Updates a prompt\cr
#'  \link[=connect_update_queue_hours_of_operation]{update_queue_hours_of_operation} \tab Updates the hours of operation for the specified queue\cr
#'  \link[=connect_update_queue_max_contacts]{update_queue_max_contacts} \tab Updates the maximum number of contacts allowed in a queue before it is considered full\cr
#'  \link[=connect_update_queue_name]{update_queue_name} \tab Updates the name and description of a queue\cr
#'  \link[=connect_update_queue_outbound_caller_config]{update_queue_outbound_caller_config} \tab Updates the outbound caller ID name, number, and outbound whisper flow for a specified queue\cr
#'  \link[=connect_update_queue_outbound_email_config]{update_queue_outbound_email_config} \tab Updates the outbound email address Id for a specified queue\cr
#'  \link[=connect_update_queue_status]{update_queue_status} \tab Updates the status of the queue\cr
...
#'  \link[=connect_update_rule]{update_rule} \tab Updates a rule for the specified Connect Customer instance\cr
#'  \link[=connect_update_security_profile]{update_security_profile} \tab Updates a security profile\cr
#'  \link[=connect_update_task_template]{update_task_template} \tab Updates details about a specific task template in the specified Connect Customer instance\cr
#'  \link[=connect_update_test_case]{update_test_case} \tab Updates any of the metadata for a test case, such as the name, description, and status or content of an existing test case\cr
...
#'  \link[=connect_update_user_config]{update_user_config} \tab Updates the configuration settings for the specified user, including per-channel auto-accept and after contact work (ACW) timeout settings\cr
...
#'  \link[=connect_update_user_hierarchy_group_name]{update_user_hierarchy_group_name} \tab Updates the name of the user hierarchy group\cr
#'  \link[=connect_update_user_hierarchy_structure]{update_user_hierarchy_structure} \tab Updates the user hierarchy structure: add, remove, and rename user hierarchy levels\cr
...
#'  \link[=connect_update_user_notification_status]{update_user_notification_status} \tab Updates the status of a notification for a specific user, such as marking it as read or hidden\cr
...
#'  \link[=connect_update_user_proficiencies]{update_user_proficiencies} \tab Updates the properties associated with the proficiencies of a user\cr
...
#'  \link[=connect_update_view_content]{update_view_content} \tab Updates the view content of the given view identifier in the specified Connect Customer instance\cr
#'  \link[=connect_update_view_metadata]{update_view_metadata} \tab Updates the view metadata\cr
#'  \link[=connect_update_workspace_metadata]{update_workspace_metadata} \tab Updates the metadata of a workspace, such as its name and description\cr
#'  \link[=connect_update_workspace_page]{update_workspace_page} \tab Updates the configuration of a page in a workspace, including the associated view and input data\cr
#'  \link[=connect_update_workspace_theme]{update_workspace_theme} \tab Updates the theme configuration for a workspace, including colors and styling\cr
#'  \link[=connect_update_workspace_visibility]{update_workspace_visibility} \tab Updates the visibility setting of a workspace, controlling whether it is available to all users, assigned users only, or none
#' }
#'
#' @return
...
.connect$metadata <- list(
  ...
  endpoints = list("^(us|eu|ap|sa|ca|me|af|il|mx)\\-\\w+\\-\\d+$" = list(endpoint = "connect.{region}.amazonaws.com", global = FALSE), "^cn\\-\\w+\\-\\d+$" = list(endpoint = "connect.{region}.amazonaws.com.cn", global = FALSE), "^us\\-gov\\-\\w+\\-\\d+$" = list(endpoint = "connect.{region}.amazonaws.com", global = FALSE), "^us\\-iso\\-\\w+\\-\\d+$" = list(endpoint = "connect.{region}.c2s.ic.gov", global = FALSE), "^us\\-isob\\-\\w+\\-\\d+$" = list(endpoint = "connect.{region}.sc2s.sgov.gov", global = FALSE), "^eu\\-isoe\\-\\w+\\-\\d+$" = list(endpoint = "connect.{region}.cloud.adc-e.uk", global = FALSE), "^us\\-isof\\-\\w+\\-\\d+$" = list(endpoint = "connect.{region}.csp.hci.ic.gov", global = FALSE), "^eusc\\-(de)\\-\\w+\\-\\d+$" = list(endpoint = "connect.{region}.amazonaws.eu", global = FALSE)),
  service_id = "Connect",
