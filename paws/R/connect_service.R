...
#'  \link[=connect_associate_phone_number_contact_flow]{associate_phone_number_contact_flow} \tab Associates a contact flow with a phone number claimed to your Amazon Connect instance\cr
...
#'  \link[=connect_claim_phone_number]{claim_phone_number} \tab Claims an available phone number to your Amazon Connect instance\cr
...
#'  \link[=connect_create_contact_flow]{create_contact_flow} \tab Creates a contact flow for the specified Amazon Connect instance\cr
#'  \link[=connect_create_contact_flow_module]{create_contact_flow_module} \tab Creates a contact flow module for the specified Amazon Connect instance\cr
...
#'  \link[=connect_delete_contact_flow]{delete_contact_flow} \tab Deletes a contact flow for the specified Amazon Connect instance\cr
#'  \link[=connect_delete_contact_flow_module]{delete_contact_flow_module} \tab Deletes the specified contact flow module\cr
...
#'  \link[=connect_describe_contact_flow]{describe_contact_flow} \tab Describes the specified contact flow\cr
#'  \link[=connect_describe_contact_flow_module]{describe_contact_flow_module} \tab Describes the specified contact flow module\cr
...
#'  \link[=connect_describe_phone_number]{describe_phone_number} \tab Gets details and status of a phone number that’s claimed to your Amazon Connect instance\cr
...
#'  \link[=connect_disassociate_phone_number_contact_flow]{disassociate_phone_number_contact_flow} \tab Removes the contact flow association from a phone number claimed to your Amazon Connect instance, if a contact flow association exists\cr
...
#'  \link[=connect_list_contact_flow_modules]{list_contact_flow_modules} \tab Provides information about the contact flow modules for the specified Amazon Connect instance\cr
...
#'  \link[=connect_list_phone_numbers_v2]{list_phone_numbers_v2} \tab Lists phone numbers claimed to your Amazon Connect instance\cr
...
#'  \link[=connect_release_phone_number]{release_phone_number} \tab Releases a phone number previously claimed to an Amazon Connect instance\cr
...
#'  \link[=connect_search_available_phone_numbers]{search_available_phone_numbers} \tab Searches for available phone numbers that you can claim to your Amazon Connect instance\cr
...
#'  \link[=connect_start_outbound_voice_contact]{start_outbound_voice_contact} \tab Places an outbound call to a contact, and then initiates the contact flow\cr
#'  \link[=connect_start_task_contact]{start_task_contact} \tab Initiates a contact flow to start a new task\cr
...
#'  \link[=connect_update_contact_flow_content]{update_contact_flow_content} \tab Updates the specified contact flow\cr
#'  \link[=connect_update_contact_flow_metadata]{update_contact_flow_metadata} \tab Updates metadata about specified contact flow\cr
#'  \link[=connect_update_contact_flow_module_content]{update_contact_flow_module_content} \tab Updates specified contact flow module for the specified Amazon Connect instance\cr
#'  \link[=connect_update_contact_flow_module_metadata]{update_contact_flow_module_metadata} \tab Updates metadata about specified contact flow module\cr
#'  \link[=connect_update_contact_flow_name]{update_contact_flow_name} \tab The name of the contact flow\cr
...
#'  \link[=connect_update_phone_number]{update_phone_number} \tab Updates your claimed phone number from its current Amazon Connect instance to another Amazon Connect instance in the same Region\cr
