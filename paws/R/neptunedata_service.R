...
.neptunedata$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "neptune-db.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "neptune-db.{region}.amazonaws.com.cn", global = FALSE), "us-iso-*" = list(endpoint = "neptune-db.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "neptune-db.{region}.sc2s.sgov.gov", global = FALSE)),
