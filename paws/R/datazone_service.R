...
#'  \link[=datazone_associate_governed_terms]{associate_governed_terms} \tab Associates governed terms with an asset\cr
#'  \link[=datazone_batch_get_attributes_metadata]{batch_get_attributes_metadata} \tab Gets the attribute metadata\cr
#'  \link[=datazone_batch_put_attributes_metadata]{batch_put_attributes_metadata} \tab Writes the attribute metadata\cr
...
#'  \link[=datazone_create_account_pool]{create_account_pool} \tab Creates an account pool\cr
...
#'  \link[=datazone_create_connection]{create_connection} \tab Creates a new connection\cr
...
#'  \link[=datazone_create_environment_blueprint]{create_environment_blueprint} \tab Creates a Amazon DataZone blueprint\cr
...
#'  \link[=datazone_create_rule]{create_rule} \tab Creates a rule in Amazon DataZone\cr
...
#'  \link[=datazone_delete_account_pool]{delete_account_pool} \tab Deletes an account pool\cr
...
#'  \link[=datazone_delete_environment_blueprint]{delete_environment_blueprint} \tab Deletes a blueprint in Amazon DataZone\cr
...
#'  \link[=datazone_delete_form_type]{delete_form_type} \tab Deletes and metadata form type in Amazon DataZone\cr
...
#'  \link[=datazone_delete_lineage_event]{delete_lineage_event} \tab Deletes the specified lineage event\cr
...
#'  \link[=datazone_delete_rule]{delete_rule} \tab Deletes a rule in Amazon DataZone\cr
...
#'  \link[=datazone_disassociate_governed_terms]{disassociate_governed_terms} \tab Disassociates restricted terms from an asset\cr
#'  \link[=datazone_get_account_pool]{get_account_pool} \tab Gets the details of the account pool\cr
...
#'  \link[=datazone_get_connection]{get_connection} \tab Gets a connection\cr
#'  \link[=datazone_get_data_export_configuration]{get_data_export_configuration} \tab Gets data export configuration details\cr
...
#'  \link[=datazone_get_job_run]{get_job_run} \tab The details of the job run\cr
#'  \link[=datazone_get_lineage_event]{get_lineage_event} \tab Describes the lineage event\cr
...
#'  \link[=datazone_list_account_pools]{list_account_pools} \tab Lists existing account pools\cr
#'  \link[=datazone_list_accounts_in_account_pool]{list_accounts_in_account_pool} \tab Lists the accounts in the specified account pool\cr
...
#'  \link[=datazone_list_connections]{list_connections} \tab Lists connections\cr
...
#'  \link[=datazone_list_job_runs]{list_job_runs} \tab Lists job runs\cr
...
#'  \link[=datazone_list_project_profiles]{list_project_profiles} \tab Lists project profiles\cr
#'  \link[=datazone_list_projects]{list_projects} \tab Lists Amazon DataZone projects\cr
#'  \link[=datazone_list_rules]{list_rules} \tab Lists existing rules\cr
...
#'  \link[=datazone_search_listings]{search_listings} \tab Searches listings in Amazon DataZone\cr
...
#'  \link[=datazone_start_notebook_sync]{start_notebook_sync} \tab Starts a notebook sync in Amazon SageMaker Unified Studio\cr
...
#'  \link[=datazone_update_connection]{update_connection} \tab Updates a connection\cr
...
#'  \link[=datazone_update_environment_blueprint]{update_environment_blueprint} \tab Updates an environment blueprint in Amazon DataZone\cr
...
#'  \link[=datazone_update_rule]{update_rule} \tab Updates a rule\cr
...
.datazone$metadata <- list(
  ...
  endpoints = list("^(us|eu|ap|sa|ca|me|af|il|mx)\\-\\w+\\-\\d+$" = list(endpoint = "datazone.{region}.amazonaws.com", global = FALSE), "^cn\\-\\w+\\-\\d+$" = list(endpoint = "datazone.{region}.amazonaws.com.cn", global = FALSE), "^us\\-gov\\-\\w+\\-\\d+$" = list(endpoint = "datazone.{region}.amazonaws.com", global = FALSE), "^us\\-iso\\-\\w+\\-\\d+$" = list(endpoint = "datazone.{region}.c2s.ic.gov", global = FALSE), "^us\\-isob\\-\\w+\\-\\d+$" = list(endpoint = "datazone.{region}.sc2s.sgov.gov", global = FALSE), "^eu\\-isoe\\-\\w+\\-\\d+$" = list(endpoint = "datazone.{region}.cloud.adc-e.uk", global = FALSE), "^us\\-isof\\-\\w+\\-\\d+$" = list(endpoint = "datazone.{region}.csp.hci.ic.gov", global = FALSE), "^eusc\\-(de)\\-\\w+\\-\\d+$" = list(endpoint = "datazone.{region}.amazonaws.eu", global = FALSE)),
  service_id = "DataZone",
