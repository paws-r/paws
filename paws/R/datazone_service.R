...
#'  \link[=datazone_create_listing_change_set]{create_listing_change_set} \tab Create listing change set\cr
...
#'  \link[=datazone_delete_asset]{delete_asset} \tab Delets an asset in Amazon DataZone\cr
...
#'  \link[=datazone_delete_listing]{delete_listing} \tab Delete listing\cr
...
#'  \link[=datazone_get_listing]{get_listing} \tab Get listing\cr
...
.datazone$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "datazone.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "datazone.{region}.amazonaws.com.cn", global = FALSE), "us-iso-*" = list(endpoint = "datazone.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "datazone.{region}.sc2s.sgov.gov", global = FALSE)),
  service_id = "DataZone",
...
.datazone$service <- function(config = list()) {
  handlers <- new_handlers("restjson", "v4")
  new_service(.datazone$metadata, handlers, config)
}
