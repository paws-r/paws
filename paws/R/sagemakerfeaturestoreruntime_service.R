...
.sagemakerfeaturestoreruntime$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "featurestore-runtime.sagemaker.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "featurestore-runtime.sagemaker.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "featurestore-runtime.sagemaker.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "featurestore-runtime.sagemaker.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "featurestore-runtime.sagemaker.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "featurestore-runtime.sagemaker.{region}.csp.hci.ic.gov", global = FALSE)),
