...
#'   SourceArn, FunctionUrlAuthType, InvokedViaFunctionUrl, SourceAccount,
...
#'   KmsKeyArn, Tags, PropagateTags, TelemetryConfig)
#'
...
#'   Enabled, BatchSize, FilterCriteria, KMSKeyArn, MetricsConfig,
#'   LoggingConfig, ScalingConfig, MaximumBatchingWindowInSeconds,
...
#'   Description, Timeout, MemorySize, Publish, PublishTo, VpcConfig,
#'   PackageType, DeadLetterConfig, Environment, KMSKeyArn, TracingConfig,
#'   Tags, Layers, FileSystemConfigs, CodeSigningConfigArn, ImageConfig,
#'   Architectures, EphemeralStorage, SnapStart, LoggingConfig,
#'   TenancyConfig, CapacityProviderConfig, DurableConfig)
#'
#' @param FunctionName &#91;required&#93; The name or ARN of the Lambda function.
#' 
#' **Name formats**
...
#'
#' @usage
#' lambda_delete_resource_policy(ResourceArn, RevisionId)
#'
...
#'
#' @aliases lambda_delete_resource_policy
...
#'
#' @usage
#' lambda_get_durable_execution(DurableExecutionArn, IncludeExecutionData)
#'
#' @param DurableExecutionArn &#91;required&#93; The Amazon Resource Name (ARN) of the durable execution.
...
#'
#' @usage
#' lambda_get_resource_policy(ResourceArn)
#'
...
#'
#' @aliases lambda_get_resource_policy
...
#' 
#' This operation requires permission for the [lambda:InvokeFunction](https://docs.aws.amazon.com/service-authorization/latest/reference/) action. For details on how to set up permissions for cross-account invocations, see [Granting function access to other accounts](https://docs.aws.amazon.com/lambda/latest/dg/access-control-resource-based.html#permissions-resource-xaccountinvoke).
#'
#' @usage
...
#'
#' @usage
#' lambda_invoke_with_response_stream(FunctionName, LogType, ClientContext,
#'   Qualifier, Payload, TenantId, InvocationType)
#'
#' @param FunctionName &#91;required&#93; The name or ARN of the Lambda function.
#' 
#' **Name formats**
...
#'
#' @usage
#' lambda_list_layer_versions(CompatibleArchitecture, CompatibleRuntime,
#'   LayerName, Marker, MaxItems)
#'
...
#'
#' @usage
#' lambda_list_layers(CompatibleArchitecture, CompatibleRuntime, Marker,
#'   MaxItems)
#'
#' @param CompatibleArchitecture The compatible [instruction set architecture](https://docs.aws.amazon.com/lambda/latest/dg/foundation-arch.html).
#' @param CompatibleRuntime A runtime identifier.
...
#'   CompatibleArchitectures, CompatibleRuntimes, LicenseInfo)
#'
#' @param LayerName &#91;required&#93; The name or Amazon Resource Name (ARN) of the layer.
...
#' 
#' This operation replaces any existing policy on the Lambda resource. If you previously added permissions using the [`add_permission`][lambda_add_permission] operation, the new policy overwrites those permissions.
#'
#' @usage
#' lambda_put_resource_policy(ResourceArn, Policy, RevisionId)
#'
...
#'
#' @aliases lambda_put_resource_policy
...
#'   CapacityProviderScalingConfig, PropagateTags, TelemetryConfig)
#'
...
#'   BatchSize, FilterCriteria, KMSKeyArn, MetricsConfig, LoggingConfig,
#'   ScalingConfig, MaximumBatchingWindowInSeconds, ParallelizationFactor,
#'   DestinationConfig, MaximumRecordAgeInSeconds,
#'   BisectBatchOnFunctionError, MaximumRetryAttempts,
#'   TumblingWindowInSeconds, SourceAccessConfigurations,
#'   FunctionResponseTypes, AmazonManagedKafkaEventSourceConfig,
#'   SelfManagedKafkaEventSourceConfig, DocumentDBEventSourceConfig,
#'   ProvisionedPollerConfig)
#'
#' @param UUID &#91;required&#93; The identifier of the event source mapping.
#' @param FunctionName The name or ARN of the Lambda function.
...
#'   S3ObjectVersion, S3ObjectStorageMode, ImageUri, Architectures, Publish,
#'   PublishTo, DryRun, RevisionId, SourceKMSKeyArn)
#'
#' @param FunctionName &#91;required&#93; The name or ARN of the Lambda function.
#' 
#' **Name formats**
