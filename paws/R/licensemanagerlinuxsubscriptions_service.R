...
.licensemanagerlinuxsubscriptions$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "license-manager-linux-subscriptions.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "license-manager-linux-subscriptions.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "license-manager-linux-subscriptions.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "license-manager-linux-subscriptions.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "license-manager-linux-subscriptions.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "license-manager-linux-subscriptions.{region}.csp.hci.ic.gov", global = FALSE)),
