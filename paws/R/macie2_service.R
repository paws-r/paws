...
#'  \link[=macie2_get_findings_publication_configuration]{get_findings_publication_configuration} \tab Retrieves the configuration settings for publishing findings to AWS Security Hub\cr
...
#'  \link[=macie2_put_findings_publication_configuration]{put_findings_publication_configuration} \tab Updates the configuration settings for publishing findings to AWS Security Hub\cr
#'  \link[=macie2_search_resources]{search_resources} \tab Retrieves (queries) statistical data and other information about AWS resources that Amazon Macie monitors and analyzes\cr
...
#'  \link[=macie2_update_member_session]{update_member_session} \tab Enables an Amazon Macie administrator to suspend or re-enable a member account\cr
