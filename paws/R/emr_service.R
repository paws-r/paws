...
#'  \link[=emr_describe_release_label]{describe_release_label} \tab Provides EMR release label details, such as releases available the region where the API request is run, and the available applications for a specific EMR release label\cr
...
#'  \link[=emr_list_release_labels]{list_release_labels} \tab Retrieves release labels of EMR services in the region where the API is called\cr
...
#'  \link[=emr_put_auto_termination_policy]{put_auto_termination_policy} \tab Auto-termination is supported in Amazon EMR versions 5\cr
