...
.codeguruprofiler$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "codeguru-profiler.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "codeguru-profiler.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "codeguru-profiler.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "codeguru-profiler.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "codeguru-profiler.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "codeguru-profiler.{region}.csp.hci.ic.gov", global = FALSE)),
