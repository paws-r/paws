...
.costexplorer$metadata <- list(
  service_name = "ce",
  endpoints = list("aws-global" = list(endpoint = "ce.us-east-1.amazonaws.com", global = TRUE, signing_region = "us-east-1"), "^(us|eu|ap|sa|ca|me|af|il|mx)\\-\\w+\\-\\d+$" = list(endpoint = "ce.us-east-1.amazonaws.com", global = FALSE, signing_region = "us-east-1"), "aws-cn-global" = list(endpoint = "ce.cn-northwest-1.amazonaws.com.cn", global = TRUE, signing_region = "cn-northwest-1"), "^cn\\-\\w+\\-\\d+$" = list(endpoint = "ce.cn-northwest-1.amazonaws.com.cn", global = FALSE, signing_region = "cn-northwest-1"), "^us\\-gov\\-\\w+\\-\\d+$" = list(endpoint = "ce.{region}.amazonaws.com", global = FALSE), "^us\\-iso\\-\\w+\\-\\d+$" = list(endpoint = "ce.{region}.c2s.ic.gov", global = FALSE), "^us\\-isob\\-\\w+\\-\\d+$" = list(endpoint = "ce.{region}.sc2s.sgov.gov", global = FALSE), "^eu\\-isoe\\-\\w+\\-\\d+$" = list(endpoint = "ce.{region}.cloud.adc-e.uk", global = FALSE), "^us\\-isof\\-\\w+\\-\\d+$" = list(endpoint = "ce.{region}.csp.hci.ic.gov", global = FALSE)),
