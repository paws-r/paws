...
.mq$metadata <- list(
  service_name = "mq",
  endpoints = list("*" = list(endpoint = "mq.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "mq.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "mq.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "mq.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "mq.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "mq.{region}.csp.hci.ic.gov", global = FALSE)),
  service_id = "mq",
