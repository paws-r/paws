...
#' in the [`list_users`][identitystore_list_users] and
...
#' [`list_groups`][identitystore_list_groups] APIs. This value is generated
#' by the identity store service and is returned in the API response if the
#' total results are more than the size of one page, and when this token is
