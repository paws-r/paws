...
#' 
#' -   [`calculate_route`][locationservice_calculate_route] is part of a previous Amazon Location Service Routes API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
...
#'
#' @usage
#' locationservice_calculate_route(CalculatorName, DeparturePosition,
#'   DestinationPosition, WaypointPositions, TravelMode, DepartureTime,
#'   DepartNow, DistanceUnit, IncludeLegGeometry, CarModeOptions,
#'   TruckModeOptions, ArrivalTime, OptimizeFor, Key)
#'
...
#' 
#' -   This version of [`calculate_route_matrix`][locationservice_calculate_route_matrix] is part of a previous Amazon Location Service Routes API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
#' -   The version 2 [`calculate_route_matrix`][locationservice_calculate_route_matrix] operation gives better results for matrix routing calculations.
#' 
#' -   If you are using an Amazon Web Services SDK or the Amazon Web Services CLI, note that the Routes API version 2 is found under `geo-routes` or `geo_routes`, not under `location`.
#' 
#' -   Since Grab is not yet fully supported in Routes API version 2, we recommend you continue using API version 1 when using Grab.
...
#' @param ExpireTime The optional timestamp for when the API key resource will expire in ISO 8601 format: `YYYY-MM-DDThh:mm:ss.sssZ`. One of `NoExpiry` or `ExpireTime` must be set.
...
#' 
#' -   [`create_map`][locationservice_create_map] is part of a previous Amazon Location Service Maps API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
...
#' 
#' If your application is tracking or routing assets you use in your business, such as delivery vehicles or employees, you must not use Esri as your geolocation provider. See section 82 of the [Amazon Web Services service terms](https://aws.amazon.com/service-terms/) for more details.
#'
#' @usage
...
#' 
#' -   [`create_place_index`][locationservice_create_place_index] is part of a previous Amazon Location Service Places API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
...
#' 
#' -   [`create_route_calculator`][locationservice_create_route_calculator] is part of a previous Amazon Location Service Routes API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
...
#'
#' @usage
#' locationservice_create_tracker(TrackerName, PricingPlan, KmsKeyId,
#'   PricingPlanDataSource, Description, Tags, PositionFiltering,
...
#' This operation is no longer current and may be deprecated in the future. We recommend upgrading to the Maps API V2 unless you require `Grab` data.
#' 
#' -   [`delete_map`][locationservice_delete_map] is part of a previous Amazon Location Service Maps API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
#' -   The Maps API version 2 has a simplified interface that can be used without creating or managing map resources.
#' 
#' -   If you are using an AWS SDK or the AWS CLI, note that the Maps API version 2 is found under `geo-maps` or `geo_maps`, not under `location`.
...
#' This operation is no longer current and may be deprecated in the future. We recommend you upgrade to the Places API V2 unless you require Grab data.
#' 
#' -   [`delete_place_index`][locationservice_delete_place_index] is part of a previous Amazon Location Service Places API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
#' -   The Places API version 2 has a simplified interface that can be used without creating or managing place index resources.
#' 
#' -   If you are using an Amazon Web Services SDK or the Amazon Web Services CLI, note that the Places API version 2 is found under `geo-places` or `geo_places`, not under `location`.
...
#' This operation is no longer current and may be deprecated in the future. We recommend you upgrade to the Routes API V2 unless you require Grab data.
#' 
#' -   [`delete_route_calculator`][locationservice_delete_route_calculator] is part of a previous Amazon Location Service Routes API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
#' -   The Routes API version 2 has a simplified interface that can be used without creating or managing route calculator resources.
#' 
#' -   If you are using an Amazon Web Services SDK or the Amazon Web Services CLI, note that the Routes API version 2 is found under `geo-routes` or `geo_routes`, not under `location`.
...
#' This operation is no longer current and may be deprecated in the future. We recommend upgrading to the Maps API V2 unless you require `Grab` data.
#' 
#' -   [`describe_map`][locationservice_describe_map] is part of a previous Amazon Location Service Maps API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
#' -   The Maps API version 2 has a simplified interface that can be used without creating or managing map resources.
#' 
#' -   If you are using an AWS SDK or the AWS CLI, note that the Maps API version 2 is found under `geo-maps` or `geo_maps`, not under `location`.
...
#' This operation is no longer current and may be deprecated in the future. We recommend you upgrade to the Places API V2 unless you require Grab data.
#' 
#' -   [`describe_place_index`][locationservice_describe_place_index] is part of a previous Amazon Location Service Places API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
#' -   The Places API version 2 has a simplified interface that can be used without creating or managing place index resources.
#' 
#' -   If you are using an Amazon Web Services SDK or the Amazon Web Services CLI, note that the Places API version 2 is found under `geo-places` or `geo_places`, not under `location`.
...
#' This operation is no longer current and may be deprecated in the future. We recommend you upgrade to the Routes API V2 unless you require Grab data.
#' 
#' -   [`describe_route_calculator`][locationservice_describe_route_calculator] is part of a previous Amazon Location Service Routes API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
#' -   The Routes API version 2 has a simplified interface that can be used without creating or managing route calculator resources.
#' 
#' -   If you are using an Amazon Web Services SDK or the Amazon Web Services CLI, note that the Routes API version 2 is found under `geo-routes` or `geo_routes`, not under `location`.
...
#'
#' @aliases locationservice_forecast_geofence_events
...
#' 
#' -   [`get_map_glyphs`][locationservice_get_map_glyphs] is part of a previous Amazon Location Service Maps API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
...
#' 
#' -   [`get_map_sprites`][locationservice_get_map_sprites] is part of a previous Amazon Location Service Maps API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
...
#'
#' @usage
#' locationservice_get_map_sprites(MapName, FileName, Key)
#'
...
#' 
#' -   [`get_map_style_descriptor`][locationservice_get_map_style_descriptor] is part of a previous Amazon Location Service Maps API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
...
#' 
#' -   [`get_map_tile`][locationservice_get_map_tile] is part of a previous Amazon Location Service Maps API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
...
#'
#' @usage
#' locationservice_get_map_tile(MapName, Z, X, Y, Key)
#'
...
#' 
#' -   This version of [`get_place`][locationservice_get_place] is part of a previous Amazon Location Service Places API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
#' -   Version 2 of the [`get_place`][locationservice_get_place] operation interoperates with the rest of the Places V2 API, while this version does not.
#' 
#' -   If you are using an Amazon Web Services SDK or the Amazon Web Services CLI, note that the Places API version 2 is found under `geo-places` or `geo_places`, not under `location`.
#' 
#' -   Since Grab is not yet fully supported in Places API version 2, we recommend you continue using API version 1 when using Grab.
...
#' 
#' A PlaceId is valid only if all of the following are the same in the original search request and the call to [`get_place`][locationservice_get_place].
#' 
...
#' 
#' If your Place index resource is configured with Grab as your geolocation provider and Storage as Intended use, the GetPlace operation is unavailable. For more information, see [AWS service terms](https://aws.amazon.com/service-terms/).
#'
#' @usage
...
#'
#' @usage
#' locationservice_list_geofences(CollectionName, NextToken, MaxResults)
#'
...
#' This operation is no longer current and may be deprecated in the future. We recommend upgrading to the Maps API V2 unless you require `Grab` data.
#' 
#' -   [`list_maps`][locationservice_list_maps] is part of a previous Amazon Location Service Maps API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
#' -   The Maps API version 2 has a simplified interface that can be used without creating or managing map resources.
#' 
#' -   If you are using an AWS SDK or the AWS CLI, note that the Maps API version 2 is found under `geo-maps` or `geo_maps`, not under `location`.
...
#' This operation is no longer current and may be deprecated in the future. We recommend you upgrade to the Places API V2 unless you require Grab data.
#' 
#' -   [`list_place_indexes`][locationservice_list_place_indexes] is part of a previous Amazon Location Service Places API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
#' -   The Places API version 2 has a simplified interface that can be used without creating or managing place index resources.
#' 
#' -   If you are using an Amazon Web Services SDK or the Amazon Web Services CLI, note that the Places API version 2 is found under `geo-places` or `geo_places`, not under `location`.
...
#' This operation is no longer current and may be deprecated in the future. We recommend you upgrade to the Routes API V2 unless you require Grab data.
#' 
#' -   [`list_route_calculators`][locationservice_list_route_calculators] is part of a previous Amazon Location Service Routes API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
#' -   The Routes API version 2 has a simplified interface that can be used without creating or managing route calculator resources.
#' 
#' -   If you are using an Amazon Web Services SDK or the Amazon Web Services CLI, note that the Routes API version 2 is found under `geo-routes` or `geo_routes`, not under `location`.
...
#' 
#' -   [`search_place_index_for_position`][locationservice_search_place_index_for_position] is part of a previous Amazon Location Service Places API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
...
#'
#' @usage
#' locationservice_search_place_index_for_position(IndexName, Position,
#'   MaxResults, Language, Key)
#'
...
#' 
#' -   [`search_place_index_for_suggestions`][locationservice_search_place_index_for_suggestions] is part of a previous Amazon Location Service Places API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
...
#'
#' @usage
#' locationservice_search_place_index_for_suggestions(IndexName, Text,
#'   BiasPosition, FilterBBox, FilterCountries, MaxResults, Language,
...
#' 
#' -   [`search_place_index_for_text`][locationservice_search_place_index_for_text] is part of a previous Amazon Location Service Places API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
...
#'
#' @usage
#' locationservice_search_place_index_for_text(IndexName, Text,
#'   BiasPosition, FilterBBox, FilterCountries, MaxResults, Language,
#'   FilterCategories, Key)
#'
#' @param IndexName &#91;required&#93; The name of the place index resource you want to use for the search.
...
#' 
#' You can use the [`tag_resource`][locationservice_tag_resource] operation with an Amazon Location Service resource that already has tags. If you specify a new tag key for the resource, this tag is appended to the tags already associated with the resource. If you specify a tag key that's already associated with the resource, the new tag value that you specify replaces the previous value for that tag.
#' 
...
#' @param ExpireTime Updates the timestamp for when the API key resource will expire in ISO 8601 format: `YYYY-MM-DDThh:mm:ss.sssZ`.
...
#' This operation is no longer current and may be deprecated in the future. We recommend upgrading to the Maps API V2 unless you require `Grab` data.
#' 
#' -   [`update_map`][locationservice_update_map] is part of a previous Amazon Location Service Maps API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
#' -   The Maps API version 2 has a simplified interface that can be used without creating or managing map resources.
#' 
#' -   If you are using an AWS SDK or the AWS CLI, note that the Maps API version 2 is found under `geo-maps` or `geo_maps`, not under `location`.
...
#' This operation is no longer current and may be deprecated in the future. We recommend you upgrade to the Places API V2 unless you require Grab data.
#' 
#' -   [`update_place_index`][locationservice_update_place_index] is part of a previous Amazon Location Service Places API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
#' -   The Places API version 2 has a simplified interface that can be used without creating or managing place index resources.
#' 
#' -   If you are using an Amazon Web Services SDK or the Amazon Web Services CLI, note that the Places API version 2 is found under `geo-places` or `geo_places`, not under `location`.
...
#' This operation is no longer current and may be deprecated in the future. We recommend you upgrade to the Routes API V2 unless you require Grab data.
#' 
#' -   [`update_route_calculator`][locationservice_update_route_calculator] is part of a previous Amazon Location Service Routes API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).
#' 
#' -   The Routes API version 2 has a simplified interface that can be used without creating or managing route calculator resources.
#' 
#' -   If you are using an Amazon Web Services SDK or the Amazon Web Services CLI, note that the Routes API version 2 is found under `geo-routes` or `geo_routes`, not under `location`.
...
#'
#' @aliases locationservice_verify_device_position
