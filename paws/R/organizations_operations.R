...
#' ```
#' organizations$accept_handshake(
#'   HandshakeId = "string"
#' )
#' ```
#'
...
#' # invitation.
#' \donttest{organizations$accept_handshake(
...
#' # to an OU:
#' # 
#' \donttest{organizations$attach_policy(
...
#' @section Request syntax:
#' ```
#' organizations$cancel_handshake(
#'   HandshakeId = "string"
#' )
#' ```
#'
...
#' # cancellation:
#' # 
#' \donttest{organizations$cancel_handshake(
#'   HandshakeId = "h-examplehandshakeid111"
#' )}
#'
#' @keywords internal
...
#' # 
#' # 
#' \donttest{organizations$create_account(
...
organizations_create_account <- function(Email, AccountName, RoleName = NULL, IamUserAccessToBilling = NULL) {
  op <- new_operation(
    name = "CreateAccount",
    http_method = "POST",
    http_path = "/",
  ...
  input <- .organizations$create_account_input(Email = Email, AccountName = AccountName, RoleName = RoleName, IamUserAccessToBilling = IamUserAccessToBilling)
...
#' # 
#' # 
#' \donttest{organizations$create_organization()}
#' 
...
#'
#' @param ParentId &#91;required&#93; The unique identifier (ID) of the parent root or OU in which you want to
#' create the new OU.
#' 
...
#' # 
#' # 
#' \donttest{organizations$create_organizational_unit(
#'   Name = "AccountingOU",
...
organizations_create_organizational_unit <- function(ParentId, Name) {
  op <- new_operation(
  ...
  input <- .organizations$create_organizational_unit_input(ParentId = ParentId, Name = Name)
...
organizations_create_policy <- function(Content, Description, Name, Type) {
  op <- new_operation(
    name = "CreatePolicy",
    http_method = "POST",
    http_path = "/",
  ...
  input <- .organizations$create_policy_input(Content = Content, Description = Description, Name = Name, Type = Type)
...
#' @section Request syntax:
#' ```
#' organizations$decline_handshake(
#'   HandshakeId = "string"
#' )
#' ```
#'
...
#' \donttest{organizations$decline_handshake(
#'   HandshakeId = "h-examplehandshakeid111"
#' )}
#'
#' @keywords internal
...
#' # 
#' # 
#' \donttest{organizations$delete_organizational_unit(
...
#' # 
#' # 
#' \donttest{organizations$delete_policy(
#'   PolicyId = "p-examplepolicyid111"
#' )}
#'
#' @keywords internal
...
#' \donttest{organizations$describe_account(
...
#'
#' @param CreateAccountRequestId &#91;required&#93; Specifies the `operationId` that uniquely identifies the request. You
...
#' \donttest{organizations$describe_create_account_status(
...
#' @section Request syntax:
#' ```
#' organizations$describe_handshake(
#'   HandshakeId = "string"
#' )
#' ```
#'
...
#' \donttest{organizations$describe_handshake(
#'   HandshakeId = "h-examplehandshakeid111"
#' )}
#'
#' @keywords internal
...
#' \donttest{organizations$describe_organization()}
#'
#' @keywords internal
#'
...
#' \donttest{organizations$describe_organizational_unit(
#'   OrganizationalUnitId = "ou-examplerootid111-exampleouid111"
#' )}
#'
#' @keywords internal
...
#' # policy:/n/n
#' \donttest{organizations$describe_policy(
#'   PolicyId = "p-examplepolicyid111"
#' )}
#'
#' @keywords internal
...
#' string requires \"p-\" followed by from 8 to 128 lower-case letters or
#' digits.
#' @param TargetId &#91;required&#93; The unique identifier (ID) of the root, OU, or account from which you
...
#' \donttest{organizations$detach_policy(
#'   PolicyId = "p-examplepolicyid111",
#'   TargetId = "ou-examplerootid111-exampleouid111"
#' )}
#'
...
#' \donttest{organizations$disable_policy_type(
#'   PolicyType = "SERVICE_CONTROL_POLICY",
...
#' \donttest{organizations$enable_all_features()}
#'
#' @keywords internal
#'
...
#' \donttest{organizations$enable_policy_type(
#'   PolicyType = "SERVICE_CONTROL_POLICY",
#'   RootId = "r-examplerootid111"
#' )}
#'
...
#' # an organization.
#' \donttest{organizations$invite_account_to_organization(
...
organizations_invite_account_to_organization <- function(Target, Notes = NULL) {
  op <- new_operation(
  ...
  input <- .organizations$invite_account_to_organization_input(Target = Target, Notes = Notes)
...
#' # organization:
#' \donttest{organizations$leave_organization()}
#'
#' @keywords internal
#'
...
#' @section Request syntax:
#' ```
#' organizations$list_aws_service_access_for_organization(
#'   NextToken = "string",
#'   MaxResults = 123
#' )
#' ```
...
#' # an organization:
#' \donttest{organizations$list_accounts()}
#'
#' @keywords internal
#'
...
#' # OU:/n/n
#' \donttest{organizations$list_accounts_for_parent(
...
#' \donttest{organizations$list_children(
...
#' @section Request syntax:
#' ```
#' organizations$list_create_account_status(
#'   States = list(
...
#' \donttest{organizations$list_create_account_status(
#'   States = list(
#'     "SUCCEEDED"
#'   )
#' )}
...
#' that they are deleted and no longer accessible.
#' 
#' Always check the `NextToken` response parameter for a `null` value when
#' calling a `List*` operation. These operations can occasionally return an
#' empty set of results even when there are more results available. The
...
#' @section Request syntax:
#' ```
#' organizations$list_handshakes_for_account(
#'   Filter = list(
...
#' # operation:
#' \donttest{organizations$list_handshakes_for_account()}
#'
#' @keywords internal
#'
...
#' \donttest{organizations$list_handshakes_for_organization()}
#'
#' @keywords internal
#'
...
#' # root:/n/n
#' \donttest{organizations$list_organizational_units_for_parent(
#'   ParentId = "r-examplerootid111"
#' )}
#'
#' @keywords internal
...
#' \donttest{organizations$list_parents(
...
#' # policies (SCPs):/n/n
#' \donttest{organizations$list_policies(
#'   Filter = "SERVICE_CONTROL_POLICY"
#' )}
#'
#' @keywords internal
...
#' @section Request syntax:
#' ```
#' organizations$list_policies_for_target(
#'   TargetId = "string",
#'   Filter = "SERVICE_CONTROL_POLICY",
#'   NextToken = "string",
#'   MaxResults = 123
...
#' \donttest{organizations$list_policies_for_target(
#'   Filter = "SERVICE_CONTROL_POLICY",
...
#' whether they are available in the organization. When you enable all
...
#' \donttest{organizations$list_roots()}
#'
#' @keywords internal
#'
...
#'
#' @param PolicyId &#91;required&#93; The unique identifier (ID) of the policy for which you want to know its
#' attachments.
#' 
#' The [regex pattern](http://wikipedia.org/wiki/regex) for a policy ID
#' string requires \"p-\" followed by from 8 to 128 lower-case letters or
...
#' @section Request syntax:
#' ```
#' organizations$list_targets_for_policy(
#'   PolicyId = "string",
#'   NextToken = "string",
#'   MaxResults = 123
#' )
...
#' \donttest{organizations$list_targets_for_policy(
...
#' # to an OU:/n/n
#' \donttest{organizations$move_account(
...
#' that occurs while the account is not attached to an organization. To
#' remove an account that does not yet have this information, you must sign
...
#' # organization:
#' \donttest{organizations$remove_account_from_organization(
#'   AccountId = "333333333333"
#' )}
#'
#' @keywords internal
...
#' @section Request syntax:
#' ```
#' organizations$update_organizational_unit(
#'   OrganizationalUnitId = "string",
#'   Name = "string"
#' )
#' ```
...
#' # new name:/n/n
#' \donttest{organizations$update_organizational_unit(
#'   Name = "AccountingOU",
#'   OrganizationalUnitId = "ou-examplerootid111-exampleouid111"
#' )}
#'
