...
#'   return a list of stack instances belonging to the stack set, including
#'   the drift status and last drift time checked of each instance.
#' 
#' - Use
#'   [`describe_stack_instance`][cloudformation_describe_stack_instance] to
#'   return detailed information about a specific stack instance, including
#'   its drift status and last drift time checked.
#' 
...
#'   [`list_stack_sets`][cloudformation_list_stack_sets] returns all stack
#'   sets in the management account.
#' 
#' - \[Service-managed permissions\] If you set the `CallAs` parameter to
