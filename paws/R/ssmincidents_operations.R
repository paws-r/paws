...
#'
#' @usage
#' ssmincidents_create_replication_set(clientToken, regions)
#'
...
#'   displayName, engagements, incidentTemplate, name, tags)
#'
...
#'
#' @usage
#' ssmincidents_create_timeline_event(clientToken, eventData, eventTime,
#'   eventType, incidentRecordArn)
#'
#' @param clientToken &#91;required&#93; A token ensuring that the action is called only once with the specified
#' details.
...
#' `Custom Event`.
#' @param incidentRecordArn &#91;required&#93; The Amazon Resource Name (ARN) of the incident record you are adding the
#' event to.
#'
#' @return
#' A list with the following syntax:
...
ssmincidents_create_timeline_event <- function(clientToken, eventData, eventTime, eventType, incidentRecordArn) {
  op <- new_operation(
...
#' @param incidentRecordArn &#91;required&#93; The Amazon Resource Name (ARN) of the incident that the event is part
#' of.
#'
#' @return
#' An empty list.
...
#' @param incidentRecordArn &#91;required&#93; The Amazon Resource Name (ARN) of the incident that the timeline event
#' is part of.
#'
#' @return
#' A list with the following syntax:
...
#'
#' @param filters Filter the list of incident records you are searching through. You can
...
#'   nextToken)
#'
#' @param incidentRecordArn &#91;required&#93; The Amazon Resource Name (ARN) of the incident record that you are
...
#' @param chatChannel The AWS Chatbot chat channel for responders to collaborate in.
#' @param clientToken A token ensuring that the action is called only once with the specified
#' details.
#' @param impact Defines the impact to customers and applications. Providing an impact
...
#' @param clientToken A token ensuring that the action is called only once with the specified
#' details.
#' @param incidentRecordArn &#91;required&#93; The Amazon Resource Name (ARN) of the incident record you are updating
#' related items in.
...
#'   incidentTemplateSummary, incidentTemplateTitle)
#'
...
#' @param clientToken A token ensuring that the action is called only once with the specified
#' details.
#' @param displayName The long format name of the response plan. Can't contain spaces.
#' @param engagements The contacts and escalation plans that Incident Manager engages at the
#' start of the incident.
#' @param incidentTemplateDedupeString Used to create only one incident record for an incident.
...
#' 
#' -   `1` - No impact
#' @param incidentTemplateNotificationTargets The SNS targets that AWS Chatbot uses to notify the chat channels and
...
#' @param incidentTemplateTitle The short format name of the incident. Can't contain spaces.
#'
#' @return
#' An empty list.
#'
...
ssmincidents_update_response_plan <- function(actions = NULL, arn, chatChannel = NULL, clientToken = NULL, displayName = NULL, engagements = NULL, incidentTemplateDedupeString = NULL, incidentTemplateImpact = NULL, incidentTemplateNotificationTargets = NULL, incidentTemplateSummary = NULL, incidentTemplateTitle = NULL) {
  op <- new_operation(
...
#'   eventTime, eventType, incidentRecordArn)
#'
#' @param clientToken &#91;required&#93; A token ensuring that the action is called only once with the specified
#' details.
...
ssmincidents_update_timeline_event <- function(clientToken, eventData = NULL, eventId, eventTime = NULL, eventType = NULL, incidentRecordArn) {
  op <- new_operation(
