...
#'  \link[=wafv2_create_regex_pattern_set]{create_regex_pattern_set} \tab Creates a RegexPatternSet, which you reference in a RegexPatternSetReferenceStatement, to have AWS WAF inspect a web request component for the specified patterns\cr
...
#'  \link[=wafv2_disassociate_web_acl]{disassociate_web_acl} \tab Disassociates a Web ACL from a regional application resource\cr
...
#'  \link[=wafv2_get_rate_based_statement_managed_keys]{get_rate_based_statement_managed_keys} \tab Retrieves the keys that are currently blocked by a rate-based rule\cr
...
#'  \link[=wafv2_get_sampled_requests]{get_sampled_requests} \tab Gets detailed information about a specified number of requests--a sample--that AWS WAF randomly selects from among the first 5,000 requests that your AWS resource received during a time range that you choose\cr
...
#'  \link[=wafv2_tag_resource]{tag_resource} \tab Associates tags with the specified AWS resource\cr
#'  \link[=wafv2_untag_resource]{untag_resource} \tab Disassociates tags from an AWS resource\cr
