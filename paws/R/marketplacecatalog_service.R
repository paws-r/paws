...
#'  \link[=marketplacecatalog_describe_assessment]{describe_assessment} \tab Returns the metadata and detailed results of a single assessment, including the framework that was evaluated, the overall assessment result, and a paginated list of individual control evaluation results\cr
...
#'  \link[=marketplacecatalog_list_assessments]{list_assessments} \tab Returns a paginated list of assessments associated with an entity or change set in AWS Marketplace\cr
