...
#'  \link[=iotanalytics_create_dataset]{create_dataset} \tab Creates a dataset\cr
...
#'  \link[=iotanalytics_delete_dataset]{delete_dataset} \tab Deletes the specified dataset\cr
#'  \link[=iotanalytics_delete_dataset_content]{delete_dataset_content} \tab Deletes the content of the specified dataset\cr
...
#'  \link[=iotanalytics_describe_dataset]{describe_dataset} \tab Retrieves information about a dataset\cr
...
#'  \link[=iotanalytics_get_dataset_content]{get_dataset_content} \tab Retrieves the contents of a data set as presigned URIs\cr
...
#'  \link[=iotanalytics_list_tags_for_resource]{list_tags_for_resource} \tab Lists the tags (metadata) that you have assigned to the resource\cr
...
#' @rdname iotanalytics
#' @export
iotanalytics <- function(config = list()) {
  svc <- .iotanalytics$operations
