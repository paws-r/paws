...
#'
#' @aliases pinpointsmsvoicev2_create_notify_configuration
...
#'
#' @aliases pinpointsmsvoicev2_create_rcs_agent
...
#'
#' @aliases pinpointsmsvoicev2_delete_notify_configuration
...
#' @section Request syntax:
#' ```
#' svc$delete_notify_message_spend_limit_override()
#' ```
#'
#' @keywords internal
#'
...
#'
#' @aliases pinpointsmsvoicev2_delete_notify_message_spend_limit_override
...
#'
#' @aliases pinpointsmsvoicev2_delete_rcs_agent
...
#'   NotifyConfigurationIds, Filters, NextToken, MaxResults)
#'
...
#' @section Request syntax:
#' ```
#' svc$describe_notify_configurations(
...
#'
#' @aliases pinpointsmsvoicev2_describe_notify_configurations
...
#'
#' @aliases pinpointsmsvoicev2_describe_notify_templates
...
#'       PoolId = "string",
#'       RegistrationId = "string",
#'       MessagingLimits = list(
#'         RateLimits = list(
#'           123
#'         ),
#'         DailyMessageCaps = list(
#'           123
#'         )
#'       ),
#'       CreatedTimestamp = as.POSIXct(
...
#'
#' @aliases pinpointsmsvoicev2_describe_rcs_agent_country_launch_status
...
#'
#' @aliases pinpointsmsvoicev2_describe_rcs_agents
...
#'
#' @usage
#' pinpointsmsvoicev2_list_available_phone_numbers(IsoCountryCode,
#'   NumberCapabilities, NumberType, RegistrationId, NumberPreference,
#'   NextToken, MaxResults)
#'
#' @param IsoCountryCode &#91;required&#93; The two-character code, in ISO 3166-1 alpha-2 format, for the country or region in which to search for available phone numbers. This operation currently supports only `US`.
#' @param NumberCapabilities &#91;required&#93; The capabilities to filter by, such as SMS. Only phone numbers that support all of the specified capabilities are returned.
#' @param NumberType &#91;required&#93; The type of phone number to search for.
#' @param RegistrationId The registration associated with the request. A registration is required for regulated number types. You can specify either:
#' 
...
#' @section Request syntax:
#' ```
#' svc$list_available_phone_numbers(
#'   IsoCountryCode = "string",
#'   NumberCapabilities = list(
#'     "SMS"|"VOICE"|"MMS"|"RCS"
#'   ),
...
#' @keywords internal
#'
#' @rdname pinpointsmsvoicev2_list_available_phone_numbers
#'
#' @aliases pinpointsmsvoicev2_list_available_phone_numbers
pinpointsmsvoicev2_list_available_phone_numbers <- function(IsoCountryCode, NumberCapabilities, NumberType, RegistrationId = NULL, NumberPreference = NULL, NextToken = NULL, MaxResults = NULL) {
  op <- new_operation(
...
.pinpointsmsvoicev2$operations$list_available_phone_numbers <- pinpointsmsvoicev2_list_available_phone_numbers
...
#'
#' @aliases pinpointsmsvoicev2_list_notify_countries
...
#'   NumberPreference, InternationalSendingEnabled,
...
#' @param NumberPreference An optional selection preference used to request a specific phone number, such as a number that starts with, ends with, or contains a particular digit pattern. You can specify at most one preference. Number preferences apply only to `TEN_DLC` requests in the `US`.
...
pinpointsmsvoicev2_request_phone_number <- function(IsoCountryCode, MessageType, NumberCapabilities, NumberType, OptOutListName = NULL, PoolId = NULL, RegistrationId = NULL, NumberPreference = NULL, InternationalSendingEnabled = NULL, DeletionProtectionEnabled = NULL, Tags = NULL, ClientToken = NULL) {
  op <- new_operation(
...
#'
#' @aliases pinpointsmsvoicev2_send_notify_text_message
...
#'
#' @aliases pinpointsmsvoicev2_send_notify_voice_message
...
#' @section Request syntax:
#' ```
#' svc$set_notify_message_spend_limit_override(
#'   MonthlyLimit = 123
#' )
#' ```
#'
...
#'
#' @aliases pinpointsmsvoicev2_set_notify_message_spend_limit_override
...
#'
#' @aliases pinpointsmsvoicev2_update_notify_configuration
