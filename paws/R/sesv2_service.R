...
#'  \link[=sesv2_delete_suppressed_destination]{delete_suppressed_destination} \tab Used to delete a suppressed email destination from your suppression list \cr
...
#'  \link[=sesv2_get_suppressed_destination]{get_suppressed_destination} \tab Used to fetch a single suppressed email destination from your suppression list \cr
...
#'  \link[=sesv2_list_suppressed_destinations]{list_suppressed_destinations} \tab Used to fetch a list suppressed email destinations from your suppression list \cr
...
#'  \link[=sesv2_put_account_suppression_attributes]{put_account_suppression_attributes} \tab Change your account's suppression preferences for your account \cr
...
#'  \link[=sesv2_put_configuration_set_suppression_options]{put_configuration_set_suppression_options} \tab Specify your account's suppression preferences for a configuration set \cr
...
#'  \link[=sesv2_put_suppressed_destination]{put_suppressed_destination} \tab Puts (overwrites) an email destination in your suppression list \cr
