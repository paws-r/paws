...
.dynamodb$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "dynamodb.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "dynamodb.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "dynamodb.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "dynamodb.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "dynamodb.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "dynamodb.{region}.csp.hci.ic.gov", global = FALSE)),
  service_id = "DynamoDB",
