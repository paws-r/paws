...
.marketplacecatalog$describe_change_set_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(ChangeSetId = structure(logical(0), tags = list(type = "string")), ChangeSetArn = structure(logical(0), tags = list(type = "string")), ChangeSetName = structure(logical(0), tags = list(type = "string")), StartTime = structure(logical(0), tags = list(type = "string")), EndTime = structure(logical(0), tags = list(type = "string")), Status = structure(logical(0), tags = list(type = "string")), FailureDescription = structure(logical(0), tags = list(type = "string")), ChangeSet = structure(list(structure(list(ChangeType = structure(logical(0), tags = list(type = "string")), Entity = structure(list(Type = structure(logical(0), tags = list(type = "string")), Identifier = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), ErrorDetailList = structure(list(structure(list(ErrorCode = structure(logical(0), tags = list(type = "string")), ErrorMessage = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list"))), tags = list(type = "structure"))), tags = list(type = "list"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
