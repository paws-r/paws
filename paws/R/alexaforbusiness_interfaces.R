...
.alexaforbusiness$register_avs_device_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(ClientId = structure(logical(0), tags = list(type = "string")), UserCode = structure(logical(0), tags = list(type = "string")), ProductId = structure(logical(0), tags = list(type = "string")), DeviceSerialNumber = structure(logical(0), tags = list(type = "string")), AmazonId = structure(logical(0), tags = list(type = "string")), RoomArn = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
