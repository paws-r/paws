...
.importexport$cancel_job_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(JobId = structure(logical(0), tags = list(type = "string")), APIVersion = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
...
.importexport$create_job_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(JobType = structure(logical(0), tags = list(type = "string")), Manifest = structure(logical(0), tags = list(type = "string")), ManifestAddendum = structure(logical(0), tags = list(type = "string")), ValidateOnly = structure(logical(0), tags = list(type = "boolean")), APIVersion = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.importexport$get_shipping_label_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(jobIds = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "list")), name = structure(logical(0), tags = list(type = "string")), company = structure(logical(0), tags = list(type = "string")), phoneNumber = structure(logical(0), tags = list(type = "string")), country = structure(logical(0), tags = list(type = "string")), stateOrProvince = structure(logical(0), tags = list(type = "string")), city = structure(logical(0), tags = list(type = "string")), postalCode = structure(logical(0), tags = list(type = "string")), street1 = structure(logical(0), tags = list(type = "string")), street2 = structure(logical(0), tags = list(type = "string")), street3 = structure(logical(0), tags = list(type = "string")), APIVersion = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.importexport$get_status_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(JobId = structure(logical(0), tags = list(type = "string")), APIVersion = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.importexport$list_jobs_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(MaxJobs = structure(logical(0), tags = list(type = "integer")), Marker = structure(logical(0), tags = list(type = "string")), APIVersion = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.importexport$update_job_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(JobId = structure(logical(0), tags = list(type = "string")), Manifest = structure(logical(0), tags = list(type = "string")), JobType = structure(logical(0), tags = list(type = "string")), ValidateOnly = structure(logical(0), tags = list(type = "boolean")), APIVersion = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
