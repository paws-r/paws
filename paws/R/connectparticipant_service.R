...
.connectparticipant$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "connectparticipant.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "connectparticipant.{region}.amazonaws.com.cn", global = FALSE)),
