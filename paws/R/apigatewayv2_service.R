...
#'  \link[=apigatewayv2_create_portal]{create_portal} \tab Creates a portal\cr
#'  \link[=apigatewayv2_create_portal_product]{create_portal_product} \tab Creates a new portal product\cr
#'  \link[=apigatewayv2_create_product_page]{create_product_page} \tab Creates a new product page for a portal product\cr
#'  \link[=apigatewayv2_create_product_rest_endpoint_page]{create_product_rest_endpoint_page} \tab Creates a product REST endpoint page for a portal product\cr
...
#'  \link[=apigatewayv2_create_routing_rule]{create_routing_rule} \tab Creates a RoutingRule\cr
...
#'  \link[=apigatewayv2_delete_portal]{delete_portal} \tab Deletes a portal\cr
#'  \link[=apigatewayv2_delete_portal_product]{delete_portal_product} \tab Deletes a portal product\cr
#'  \link[=apigatewayv2_delete_portal_product_sharing_policy]{delete_portal_product_sharing_policy} \tab Deletes the sharing policy for a portal product\cr
#'  \link[=apigatewayv2_delete_product_page]{delete_product_page} \tab Deletes a product page of a portal product\cr
#'  \link[=apigatewayv2_delete_product_rest_endpoint_page]{delete_product_rest_endpoint_page} \tab Deletes a product REST endpoint page\cr
...
#'  \link[=apigatewayv2_delete_routing_rule]{delete_routing_rule} \tab Deletes a routing rule\cr
...
#'  \link[=apigatewayv2_disable_portal]{disable_portal} \tab Deletes the publication of a portal portal\cr
...
#'  \link[=apigatewayv2_get_portal]{get_portal} \tab Gets a portal\cr
#'  \link[=apigatewayv2_get_portal_product]{get_portal_product} \tab Gets a portal product\cr
#'  \link[=apigatewayv2_get_portal_product_sharing_policy]{get_portal_product_sharing_policy} \tab Gets the sharing policy for a portal product\cr
#'  \link[=apigatewayv2_get_product_page]{get_product_page} \tab Gets a product page of a portal product\cr
#'  \link[=apigatewayv2_get_product_rest_endpoint_page]{get_product_rest_endpoint_page} \tab Gets a product REST endpoint page\cr
...
#'  \link[=apigatewayv2_get_routing_rule]{get_routing_rule} \tab Gets a routing rule\cr
...
#'  \link[=apigatewayv2_list_portal_products]{list_portal_products} \tab Lists portal products\cr
#'  \link[=apigatewayv2_list_portals]{list_portals} \tab Lists portals\cr
#'  \link[=apigatewayv2_list_product_pages]{list_product_pages} \tab Lists the product pages for a portal product\cr
#'  \link[=apigatewayv2_list_product_rest_endpoint_pages]{list_product_rest_endpoint_pages} \tab Lists the product REST endpoint pages of a portal product\cr
#'  \link[=apigatewayv2_list_routing_rules]{list_routing_rules} \tab Lists routing rules\cr
#'  \link[=apigatewayv2_preview_portal]{preview_portal} \tab Creates a portal preview\cr
#'  \link[=apigatewayv2_publish_portal]{publish_portal} \tab Publishes a portal\cr
#'  \link[=apigatewayv2_put_portal_product_sharing_policy]{put_portal_product_sharing_policy} \tab Updates the sharing policy for a portal product\cr
#'  \link[=apigatewayv2_put_routing_rule]{put_routing_rule} \tab Updates a routing rule\cr
...
#'  \link[=apigatewayv2_update_portal]{update_portal} \tab Updates a portal\cr
#'  \link[=apigatewayv2_update_portal_product]{update_portal_product} \tab Updates the portal product\cr
#'  \link[=apigatewayv2_update_product_page]{update_product_page} \tab Updates a product page of a portal product\cr
#'  \link[=apigatewayv2_update_product_rest_endpoint_page]{update_product_rest_endpoint_page} \tab Updates a product REST endpoint page\cr
