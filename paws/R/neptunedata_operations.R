...
#'     the `initiateDatabaseReset` action to actually perform the fast
#'     reset.
...
#'   userProvidedEdgeIds, edgeOnlyLoad)
#'
...
#' @param edgeOnlyLoad **`edgeOnlyLoad`** - A flag that controls file processing order during
#' bulk loading.
#' 
#' *Allowed values*: `"TRUE"`, `"FALSE"`.
#' 
...
neptunedata_start_loader_job <- function(source, format, s3BucketRegion, iamRoleArn, mode = NULL, failOnError = NULL, parallelism = NULL, parserConfiguration = NULL, updateSingleCardinalityProperties = NULL, queueRequest = NULL, dependencies = NULL, userProvidedEdgeIds = NULL, edgeOnlyLoad = NULL) {
  op <- new_operation(
    name = "StartLoaderJob",
    http_method = "POST",
    http_path = "/loader",
