...
#'  \link[=ssmincidents_delete_resource_policy]{delete_resource_policy} \tab Deletes the resource policy that AWS Resource Access Manager uses to share your Incident Manager resource\cr
...
#'  \link[=ssmincidents_get_incident_record]{get_incident_record} \tab Returns the details of the specified incident record\cr
...
#'  \link[=ssmincidents_list_timeline_events]{list_timeline_events} \tab Lists timeline events of the specified incident record\cr
...
.ssmincidents$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "ssm-incidents.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "ssm-incidents.{region}.amazonaws.com.cn", global = FALSE), "us-iso-*" = list(endpoint = "ssm-incidents.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "ssm-incidents.{region}.sc2s.sgov.gov", global = FALSE)),
