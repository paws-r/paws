...
.iot1clickdevicesservice$finalize_device_claim_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(State = structure(logical(0), tags = list(locationName = "state", type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.iot1clickdevicesservice$initiate_device_claim_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(State = structure(logical(0), tags = list(locationName = "state", type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.iot1clickdevicesservice$unclaim_device_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(State = structure(logical(0), tags = list(locationName = "state", type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.iot1clickdevicesservice$update_device_state_output <- function(...) {
  args <- c(as.list(environment()), list(...))
