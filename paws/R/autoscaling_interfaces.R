...
.autoscaling$put_warm_pool_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(AutoScalingGroupName = structure(logical(0), tags = list(type = "string")), MaxGroupPreparedCapacity = structure(logical(0), tags = list(type = "integer")), MinSize = structure(logical(0), tags = list(type = "integer")), PoolState = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.autoscaling$start_instance_refresh_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(AutoScalingGroupName = structure(logical(0), tags = list(type = "string")), Strategy = structure(logical(0), tags = list(type = "string")), Preferences = structure(list(MinHealthyPercentage = structure(logical(0), tags = list(type = "integer")), InstanceWarmup = structure(logical(0), tags = list(type = "integer")), CheckpointPercentages = structure(list(structure(logical(0), tags = list(type = "integer"))), tags = list(type = "list")), CheckpointDelay = structure(logical(0), tags = list(type = "integer"))), tags = list(type = "structure"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
