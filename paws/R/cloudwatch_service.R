...
#' 
#' Alternatively, you can use one of the [Amazon Web Services SDKs](https://builder.aws.com/build/tools#sdk) to access CloudWatch using an API tailored to your programming language or platform.
#' 
...
#' 
#' [Java Developer Center](https://builder.aws.com/build/tools)
#' 
#' [JavaScript Developer Center](https://builder.aws.com/build/tools)
#' 
#' [Amazon Web Services Mobile Services](https://aws.amazon.com/products/frontend-web-mobile/)
#' 
#' [PHP Developer Center](https://builder.aws.com/build/tools)
#' 
#' [Python Developer Center](https://builder.aws.com/build/tools)
#' 
#' [Ruby Developer Center](https://builder.aws.com/build/tools)
#' 
#' [Windows and .NET Developer Center](https://builder.aws.com/build/tools)
#'
#' @param
#' config
...
#' @section Operations:
#' \tabular{ll}{
#'  \link[=cloudwatch_associate_dataset_kms_key]{associate_dataset_kms_key} \tab Associates an Amazon Web Services Key Management Service (Amazon Web Services KMS) customer managed key with the specified dataset\cr
...
#'  \link[=cloudwatch_disassociate_dataset_kms_key]{disassociate_dataset_kms_key} \tab Removes the customer managed Amazon Web Services Key Management Service (Amazon Web Services KMS) key association from the specified dataset\cr
...
#'  \link[=cloudwatch_get_dataset]{get_dataset} \tab Returns information about the specified dataset\cr
...
#'  \link[=cloudwatch_put_log_alarm]{put_log_alarm} \tab Creates or updates a log alarm\cr
