...
#' Runs one or more SQL statements.
#' 
#' This operation is deprecated. Please use the [`batch_execute_statement`][rdsdataservice_batch_execute_statement] or [`execute_statement`][rdsdataservice_execute_statement] operation.
#'
#' @usage
