...
#' @section Operations:
#' \tabular{ll}{
#'  \link[=accessanalyzer_create_analyzer]{create_analyzer} \tab Creates an analyzer with a zone of trust set to your account \cr
...
#'  \link[=accessanalyzer_get_analyzed_resource]{get_analyzed_resource} \tab Retrieves information about an analyzed resource \cr
...
#'  \link[=accessanalyzer_list_analyzed_resources]{list_analyzed_resources} \tab Retrieves a list of resources that have been analyzed \cr
...
#'  \link[=accessanalyzer_start_resource_scan]{start_resource_scan} \tab Starts a scan of the policies applied to the specified resource \cr
...
#'  \link[=accessanalyzer_update_archive_rule]{update_archive_rule} \tab Updates the specified archive rule \cr
#'  \link[=accessanalyzer_update_findings]{update_findings} \tab Updates findings with the new values provided in the request 
#' }
#'
...
.accessanalyzer$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "accessanalyzer.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "accessanalyzer.{region}.amazonaws.com.cn", global = FALSE)),
