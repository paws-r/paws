...
#'  \link[=accessanalyzer_list_analyzed_resources]{list_analyzed_resources} \tab Retrieves a list of resources of the specified type that have been analyzed by the specified external access analyzer\cr
...
.accessanalyzer$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "access-analyzer.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "access-analyzer.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "access-analyzer.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "access-analyzer.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "access-analyzer.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "access-analyzer.{region}.csp.hci.ic.gov", global = FALSE)),
