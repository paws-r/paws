...
#' a federated user, an AWS service, or an anonymous user. You can also use
#' Access Analyzer to preview and validate public and cross-account access
#' to your resources before deploying permissions changes. This guide
...
#'  \link[=accessanalyzer_create_access_preview]{create_access_preview} \tab Creates an access preview that allows you to preview Access Analyzer findings for your resource before deploying resource permissions\cr
