...
.rekognition$get_content_moderation_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(JobStatus = structure(logical(0), tags = list(    type = "string")), StatusMessage = structure(logical(0), tags = list(    type = "string")), VideoMetadata = structure(list(Codec = structure(logical(0), tags = list(    type = "string")), DurationMillis = structure(logical(0), tags = list(    type = "long")), Format = structure(logical(0), tags = list(    type = "string")), FrameRate = structure(logical(0), tags = list(    type = "float")), FrameHeight = structure(logical(0), tags = list(    type = "long")), FrameWidth = structure(logical(0), tags = list(    type = "long"))), tags = list(type = "structure")), ModerationLabels = structure(list(    structure(list(Timestamp = structure(logical(0), tags = list(        type = "long")), ModerationLabel = structure(list(Confidence = structure(logical(0), tags = list(        type = "float")), Name = structure(logical(0), tags = list(        type = "string")), ParentName = structure(logical(0), tags = list(        type = "string"))), tags = list(type = "structure"))), tags = list(        type = "structure"))), tags = list(type = "list")), NextToken = structure(logical(0), tags = list(    type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
