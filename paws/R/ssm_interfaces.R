...
.ssm$delete_resource_data_sync_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(SyncName = structure(logical(0), tags = list(type = "string"))), tags = list(    type = "structure"))
  return(populate(args, shape))
}
...
.ssm$label_parameter_version_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(InvalidLabels = structure(list(structure(logical(0), tags = list(    type = "string"))), tags = list(type = "list"))), tags = list(    type = "structure"))
  return(populate(args, shape))
}
...
.ssm$list_resource_data_sync_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(ResourceDataSyncItems = structure(list(structure(list(    SyncName = structure(logical(0), tags = list(type = "string")), S3Destination = structure(list(BucketName = structure(logical(0), tags = list(        type = "string")), Prefix = structure(logical(0), tags = list(        type = "string")), SyncFormat = structure(logical(0), tags = list(        type = "string")), Region = structure(logical(0), tags = list(        type = "string")), AWSKMSKeyARN = structure(logical(0), tags = list(        type = "string"))), tags = list(type = "structure")), LastSyncTime = structure(logical(0), tags = list(type = "timestamp")), LastSuccessfulSyncTime = structure(logical(0), tags = list(        type = "timestamp")), LastStatus = structure(logical(0), tags = list(        type = "string")), SyncCreatedTime = structure(logical(0), tags = list(        type = "timestamp")), LastSyncStatusMessage = structure(logical(0), tags = list(        type = "string"))), tags = list(type = "structure"))), tags = list(    type = "list")), NextToken = structure(logical(0), tags = list(    type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.ssm$modify_document_permission_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(Name = structure(logical(0), tags = list(type = "string")), PermissionType = structure(logical(0), tags = list(type = "string")), AccountIdsToAdd = structure(list(structure(logical(0), tags = list(        type = "string"))), tags = list(type = "list")), AccountIdsToRemove = structure(list(        structure(logical(0), tags = list(type = "string"))), tags = list(        type = "list"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.ssm$update_document_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(Content = structure(logical(0), tags = list(type = "string")), Attachments = structure(list(structure(list(Key = structure(logical(0), tags = list(        type = "string")), Values = structure(list(structure(logical(0), tags = list(        type = "string"))), tags = list(type = "list"))), tags = list(        type = "structure"))), tags = list(type = "list")), Name = structure(logical(0), tags = list(        type = "string")), VersionName = structure(logical(0), tags = list(        type = "string")), DocumentVersion = structure(logical(0), tags = list(        type = "string")), DocumentFormat = structure(logical(0), tags = list(        type = "string")), TargetType = structure(logical(0), tags = list(        type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
