...
#' action to determine the next step that Amazon Lex should use in the
#' conversation with the user.
#' @param requestAttributes Request-specific information passed between Amazon Lex and the client
#' application.
#' 
#' The namespace `x-amz-lex:` is reserved for special attributes. Don't
#' create any request attributes with the prefix `x-amz-lex:`.
#' @param responseContentType The message that Amazon Lex returns in the response can be either text
...
#' requests to Amazon Lex at runtime. Amazon Lex then interprets the user
...
#' @param text &#91;required&#93; The text that the user entered. Amazon Lex interprets this text.
...
#' this API to send text and audio requests to Amazon Lex at runtime.
