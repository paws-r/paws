...
#'  \link[=workspaces_create_connect_client_add_in]{create_connect_client_add_in} \tab Creates a client-add-in for Connect Customer within a directory\cr
...
#'  \link[=workspaces_create_workspaces_pool]{create_workspaces_pool} \tab End of support notice: On December 31, 2027, Amazon Web Services will end support for Amazon WorkSpaces Pools\cr
...
#'  \link[=workspaces_delete_connect_client_add_in]{delete_connect_client_add_in} \tab Deletes a client-add-in for Connect Customer that is configured within a directory\cr
...
#'  \link[=workspaces_describe_connect_client_add_ins]{describe_connect_client_add_ins} \tab Retrieves a list of Connect Customer client add-ins that have been created\cr
...
#'  \link[=workspaces_describe_workspaces_pools]{describe_workspaces_pools} \tab End of support notice: On December 31, 2027, Amazon Web Services will end support for Amazon WorkSpaces Pools\cr
#'  \link[=workspaces_describe_workspaces_pool_sessions]{describe_workspaces_pool_sessions} \tab End of support notice: On December 31, 2027, Amazon Web Services will end support for Amazon WorkSpaces Pools\cr
...
#'  \link[=workspaces_start_workspaces_pool]{start_workspaces_pool} \tab End of support notice: On December 31, 2027, Amazon Web Services will end support for Amazon WorkSpaces Pools\cr
#'  \link[=workspaces_stop_workspaces]{stop_workspaces} \tab Stops the specified WorkSpaces\cr
#'  \link[=workspaces_stop_workspaces_pool]{stop_workspaces_pool} \tab End of support notice: On December 31, 2027, Amazon Web Services will end support for Amazon WorkSpaces Pools\cr
#'  \link[=workspaces_terminate_workspaces]{terminate_workspaces} \tab Terminates the specified WorkSpaces\cr
#'  \link[=workspaces_terminate_workspaces_pool]{terminate_workspaces_pool} \tab End of support notice: On December 31, 2027, Amazon Web Services will end support for Amazon WorkSpaces Pools\cr
#'  \link[=workspaces_terminate_workspaces_pool_session]{terminate_workspaces_pool_session} \tab End of support notice: On December 31, 2027, Amazon Web Services will end support for Amazon WorkSpaces Pools\cr
#'  \link[=workspaces_update_connect_client_add_in]{update_connect_client_add_in} \tab Updates a Connect Customer client add-in\cr
...
#'  \link[=workspaces_update_workspaces_pool]{update_workspaces_pool} \tab End of support notice: On December 31, 2027, Amazon Web Services will end support for Amazon WorkSpaces Pools
#' }
#'
#' @return
