...
#'         which EFS is available. To use EFS replication in a Region that
#'         is disabled by default, you must first opt in to the Region. For
#'         more information, see [Managing Amazon Web Services
