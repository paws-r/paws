...
.schemas$create_discoverer_input <- function(...) {
  ...
  shape <- structure(list(Description = structure(logical(0), tags = list(type = "string")), SourceArn = structure(logical(0), tags = list(type = "string")), Tags = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "tags", type = "map"))), tags = list(type = "structure"))
  return(populate(args, shape))
}

.schemas$create_discoverer_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(Description = structure(logical(0), tags = list(type = "string")), DiscovererArn = structure(logical(0), tags = list(type = "string")), DiscovererId = structure(logical(0), tags = list(type = "string")), SourceArn = structure(logical(0), tags = list(type = "string")), State = structure(logical(0), tags = list(type = "string")), Tags = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "tags", type = "map"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.schemas$list_discoverers_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(Discoverers = structure(list(structure(list(DiscovererArn = structure(logical(0), tags = list(type = "string")), DiscovererId = structure(logical(0), tags = list(type = "string")), SourceArn = structure(logical(0), tags = list(type = "string")), State = structure(logical(0), tags = list(type = "string")), Tags = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "tags", type = "map"))), tags = list(type = "structure"))), tags = list(type = "list")), NextToken = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.schemas$update_discoverer_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(Description = structure(logical(0), tags = list(type = "string")), DiscovererId = structure(logical(0), tags = list(location = "uri", locationName = "discovererId", type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
