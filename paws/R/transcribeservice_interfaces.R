...
.transcribeservice$create_vocabulary_input <- function(...) {
  ...
  shape <- structure(list(VocabularyName = structure(logical(0), tags = list(    type = "string")), LanguageCode = structure(logical(0), tags = list(    type = "string")), Phrases = structure(list(structure(logical(0), tags = list(    type = "string"))), tags = list(type = "list"))), tags = list(    type = "structure"))
