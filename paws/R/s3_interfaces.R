...
.s3$put_bucket_cors_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(Bucket = structure(logical(0), tags = list(location = "uri", locationName = "Bucket", type = "string")), CORSConfiguration = structure(list(CORSRules = structure(list(structure(list(AllowedHeaders = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "AllowedHeader", type = "list", flattened = TRUE)), AllowedMethods = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "AllowedMethod", type = "list", flattened = TRUE)), AllowedOrigins = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "AllowedOrigin", type = "list", flattened = TRUE)), ExposeHeaders = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "ExposeHeader", type = "list", flattened = TRUE)), MaxAgeSeconds = structure(logical(0), tags = list(type = "integer"))), tags = list(type = "structure"))), tags = list(locationName = "CORSRule", type = "list", flattened = TRUE))), tags = list(locationName = "CORSConfiguration", type = "structure")), ContentMD5 = structure(logical(0), tags = list(location = "header", locationName = "Content-MD5", type = "string")), ExpectedBucketOwner = structure(logical(0), tags = list(location = "header", locationName = "x-amz-expected-bucket-owner", type = "string"))), tags = list(type = "structure", payload = "CORSConfiguration"))
  return(populate(args, shape))
}
