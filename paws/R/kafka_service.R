...
.kafka$metadata <- list(
  service_name = "kafka",
  endpoints = list("*" = list(endpoint = "kafka.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "kafka.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "kafka.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "kafka.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "kafka.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "kafka.{region}.csp.hci.ic.gov", global = FALSE)),
  service_id = "Kafka",
