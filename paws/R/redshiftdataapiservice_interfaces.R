...
.redshiftdataapiservice$describe_statement_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(ClusterIdentifier = structure(logical(0), tags = list(type = "string")), CreatedAt = structure(logical(0), tags = list(type = "timestamp")), Database = structure(logical(0), tags = list(type = "string")), DbUser = structure(logical(0), tags = list(type = "string")), Duration = structure(logical(0), tags = list(type = "long")), Error = structure(logical(0), tags = list(type = "string")), HasResultSet = structure(logical(0), tags = list(type = "boolean", box = TRUE)), Id = structure(logical(0), tags = list(type = "string")), QueryString = structure(logical(0), tags = list(type = "string")), RedshiftPid = structure(logical(0), tags = list(type = "long")), RedshiftQueryId = structure(logical(0), tags = list(type = "long")), ResultRows = structure(logical(0), tags = list(type = "long")), ResultSize = structure(logical(0), tags = list(type = "long")), SecretArn = structure(logical(0), tags = list(type = "string")), Status = structure(logical(0), tags = list(type = "string")), UpdatedAt = structure(logical(0), tags = list(type = "timestamp"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
