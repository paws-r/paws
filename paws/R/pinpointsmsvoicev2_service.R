...
#'
#' @description
#' Welcome to the *End User Messaging SMS, version 2 API Reference*. This
...
#' User Messaging SMS, version 2 API provides programmatic access to
#' options that are unique to the SMS and voice channels. End User
#' Messaging SMS, version 2 resources such as phone numbers, sender IDs,
#' and opt-out lists can be used by the Amazon Pinpoint API.
#' 
#' If you're new to End User Messaging SMS, it's also helpful to review the
#' [End User Messaging SMS User
...
#' demonstrate how to use End User Messaging SMS features programmatically
#' and how to integrate functionality into mobile apps and other types of
#' applications. The guide also provides key information, such as End User
#' Messaging SMS integration with other Amazon Web Services services, and
#' the quotas that apply to use of the service.
#' 
#' **Regional availability**
#' 
#' The *End User Messaging SMS version 2 API Reference* is available in
...
#'  \link[=pinpointsmsvoicev2_carrier_lookup]{carrier_lookup} \tab Returns information about a destination phone number, including whether the number type and whether it is valid, the carrier, and more\cr
...
#'  \link[=pinpointsmsvoicev2_create_notify_configuration]{create_notify_configuration} \tab Creates a new notify configuration for managed messaging\cr
...
#'  \link[=pinpointsmsvoicev2_create_rcs_agent]{create_rcs_agent} \tab Creates a new RCS agent for sending rich messages through the RCS channel\cr
...
#'  \link[=pinpointsmsvoicev2_delete_notify_configuration]{delete_notify_configuration} \tab Deletes an existing notify configuration\cr
#'  \link[=pinpointsmsvoicev2_delete_notify_message_spend_limit_override]{delete_notify_message_spend_limit_override} \tab Deletes an account-level monthly spending limit override for sending notify messages\cr
...
#'  \link[=pinpointsmsvoicev2_delete_resource_policy]{delete_resource_policy} \tab Deletes the resource-based policy document attached to the End User Messaging SMS resource\cr
...
#'  \link[=pinpointsmsvoicev2_describe_account_limits]{describe_account_limits} \tab Describes the current End User Messaging SMS SMS Voice V2 resource quotas for your account\cr
...
#'  \link[=pinpointsmsvoicev2_describe_notify_configurations]{describe_notify_configurations} \tab Describes the specified notify configurations or all notify configurations in your account\cr
#'  \link[=pinpointsmsvoicev2_describe_notify_templates]{describe_notify_templates} \tab Describes the specified notify templates or all notify templates in your account\cr
...
#'  \link[=pinpointsmsvoicev2_describe_rcs_agent_country_launch_status]{describe_rcs_agent_country_launch_status} \tab Retrieves the per-country launch status of an RCS agent, including carrier-level details for each country\cr
#'  \link[=pinpointsmsvoicev2_describe_rcs_agents]{describe_rcs_agents} \tab Retrieves the specified RCS agents or all RCS agents associated with your Amazon Web Services account\cr
...
#'  \link[=pinpointsmsvoicev2_put_protect_configuration_rule_set_number_override]{put_protect_configuration_rule_set_number_override} \tab Create or update a phone number rule override and associate it with a protect configuration\cr
...
#'  \link[=pinpointsmsvoicev2_put_resource_policy]{put_resource_policy} \tab Attaches a resource-based policy to a End User Messaging SMS resource(phone number, sender Id, phone poll, or opt-out list) that is used for sharing the resource\cr
...
#'  \link[=pinpointsmsvoicev2_update_notify_configuration]{update_notify_configuration} \tab Updates an existing notify configuration\cr
...
#'  \link[=pinpointsmsvoicev2_update_protect_configuration_country_rule_set]{update_protect_configuration_country_rule_set} \tab Update a country rule set to ALLOW, BLOCK, MONITOR, or FILTER messages to be sent to the specified destination counties\cr
#'  \link[=pinpointsmsvoicev2_update_rcs_agent]{update_rcs_agent} \tab Updates the configuration of an existing RCS agent\cr
