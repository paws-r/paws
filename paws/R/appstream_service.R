...
.appstream$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "appstream2.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "appstream2.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "appstream2.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "appstream2.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "appstream2.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "appstream2.{region}.csp.hci.ic.gov", global = FALSE)),
