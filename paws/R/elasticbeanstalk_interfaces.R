...
.elasticbeanstalk$create_configuration_template_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(ApplicationName = structure(logical(0), tags = list(    type = "string")), TemplateName = structure(logical(0), tags = list(    type = "string")), SolutionStackName = structure(logical(0), tags = list(    type = "string")), PlatformArn = structure(logical(0), tags = list(    type = "string")), SourceConfiguration = structure(list(ApplicationName = structure(logical(0), tags = list(    type = "string")), TemplateName = structure(logical(0), tags = list(    type = "string"))), tags = list(type = "structure")), EnvironmentId = structure(logical(0), tags = list(    type = "string")), Description = structure(logical(0), tags = list(    type = "string")), OptionSettings = structure(list(structure(list(    ResourceName = structure(logical(0), tags = list(type = "string")), Namespace = structure(logical(0), tags = list(type = "string")), OptionName = structure(logical(0), tags = list(type = "string")), Value = structure(logical(0), tags = list(type = "string"))), tags = list(    type = "structure"))), tags = list(type = "list"))), tags = list(    type = "structure"))
  return(populate(args, shape))
}
