...
#' 
#' - **DNS Firewall policy** - This policy applies Amazon Route 53 Resolver
...
#' 
#'   - **Palo Alto Networks Cloud NGFW policy** - This policy applies Palo
#'     Alto Networks Cloud Next Generation Firewall (NGFW) protections and
#'     Palo Alto Networks Cloud NGFW rulestacks to your organization's
#'     VPCs.
#' 
...
#'     solution that blocks Zero-Day threats and secures cloud
#'     infrastructures with industry-leading advanced threat prevention,
