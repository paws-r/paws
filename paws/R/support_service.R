...
.support$metadata <- list(
  ...
  endpoints = list("aws-global" = list(endpoint = "support.us-east-1.amazonaws.com", global = TRUE), "us-east-1" = list(endpoint = "support.us-east-1.amazonaws.com", global = TRUE), "^(us|eu|ap|sa|ca|me|af|il|mx)\\-\\w+\\-\\d+$" = list(endpoint = "support.{region}.amazonaws.com", global = FALSE), "aws-cn-global" = list(endpoint = "support.cn-north-1.amazonaws.com.cn", global = TRUE), "cn-north-1" = list(endpoint = "support.cn-north-1.amazonaws.com.cn", global = TRUE), "^cn\\-\\w+\\-\\d+$" = list(endpoint = "support.{region}.amazonaws.com.cn", global = FALSE), "aws-us-gov-global" = list(endpoint = "support.us-gov-west-1.amazonaws.com", global = TRUE), "us-gov-west-1" = list(endpoint = "support.us-gov-west-1.amazonaws.com", global = TRUE), "^us\\-gov\\-\\w+\\-\\d+$" = list(endpoint = "support.{region}.amazonaws.com", global = FALSE), "aws-iso-global" = list(endpoint = "support.us-iso-east-1.c2s.ic.gov", global = TRUE), "us-iso-east-1" = list(endpoint = "support.us-iso-east-1.c2s.ic.gov", global = TRUE), "^us\\-iso\\-\\w+\\-\\d+$" = list(endpoint = "support.{region}.c2s.ic.gov", global = FALSE), "aws-iso-b-global" = list(endpoint = "support.us-isob-east-1.sc2s.sgov.gov", global = TRUE), "us-isob-east-1" = list(endpoint = "support.us-isob-east-1.sc2s.sgov.gov", global = TRUE), "^us\\-isob\\-\\w+\\-\\d+$" = list(endpoint = "support.{region}.sc2s.sgov.gov", global = FALSE), "^eu\\-isoe\\-\\w+\\-\\d+$" = list(endpoint = "support.{region}.cloud.adc-e.uk", global = FALSE), "^us\\-isof\\-\\w+\\-\\d+$" = list(endpoint = "support.{region}.csp.hci.ic.gov", global = FALSE)),
  service_id = "Support",
