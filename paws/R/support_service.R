...
.support$metadata <- list(
  ...
  endpoints = list("aws-global" = list(endpoint = "support.us-east-1.amazonaws.com", global = TRUE, signing_region = "us-east-1"), "^(us|eu|ap|sa|ca|me|af|il|mx)\\-\\w+\\-\\d+$" = list(endpoint = "support.{region}.amazonaws.com", global = FALSE), "aws-cn-global" = list(endpoint = "support.cn-north-1.amazonaws.com.cn", global = TRUE, signing_region = "cn-north-1"), "^cn\\-\\w+\\-\\d+$" = list(endpoint = "support.{region}.amazonaws.com.cn", global = FALSE), "aws-us-gov-global" = list(endpoint = "support.us-gov-west-1.amazonaws.com", global = TRUE, signing_region = "us-gov-west-1"), "^us\\-gov\\-\\w+\\-\\d+$" = list(endpoint = "support.{region}.amazonaws.com", global = FALSE), "aws-iso-global" = list(endpoint = "support.us-iso-east-1.c2s.ic.gov", global = TRUE, signing_region = "us-iso-east-1"), "^us\\-iso\\-\\w+\\-\\d+$" = list(endpoint = "support.{region}.c2s.ic.gov", global = FALSE), "aws-iso-b-global" = list(endpoint = "support.us-isob-east-1.sc2s.sgov.gov", global = TRUE, signing_region = "us-isob-east-1"), "^us\\-isob\\-\\w+\\-\\d+$" = list(endpoint = "support.{region}.sc2s.sgov.gov", global = FALSE), "^eu\\-isoe\\-\\w+\\-\\d+$" = list(endpoint = "support.{region}.cloud.adc-e.uk", global = FALSE), "^us\\-isof\\-\\w+\\-\\d+$" = list(endpoint = "support.{region}.csp.hci.ic.gov", global = FALSE)),
  service_id = "Support",
