...
.health$describe_affected_accounts_for_organization_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(affectedAccounts = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "list")), nextToken = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.health$describe_event_details_for_organization_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(successfulSet = structure(list(structure(list(awsAccountId = structure(logical(0), tags = list(type = "string")), event = structure(list(arn = structure(logical(0), tags = list(type = "string")), service = structure(logical(0), tags = list(type = "string")), eventTypeCode = structure(logical(0), tags = list(type = "string")), eventTypeCategory = structure(logical(0), tags = list(type = "string")), region = structure(logical(0), tags = list(type = "string")), availabilityZone = structure(logical(0), tags = list(type = "string")), startTime = structure(logical(0), tags = list(type = "timestamp")), endTime = structure(logical(0), tags = list(type = "timestamp")), lastUpdatedTime = structure(logical(0), tags = list(type = "timestamp")), statusCode = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), eventDescription = structure(list(latestDescription = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), eventMetadata = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "map"))), tags = list(type = "structure"))), tags = list(type = "list")), failedSet = structure(list(structure(list(awsAccountId = structure(logical(0), tags = list(type = "string")), eventArn = structure(logical(0), tags = list(type = "string")), errorName = structure(logical(0), tags = list(type = "string")), errorMessage = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
