...
#'
#' @aliases bedrock_batch_delete_advanced_prompt_optimization_job
...
#'
#' @aliases bedrock_create_advanced_prompt_optimization_job
...
#' 
#' For more information, see [Tagging resources](https://docs.aws.amazon.com/bedrock/latest/userguide/tagging.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html?trkcampaign=awsomedayonlinehk).
...
#' 
#' The following actions are related to the [`create_custom_model_deployment`][bedrock_create_custom_model_deployment] operation:
#' 
...
#' @param targetModelTags Tags to associate with the target model. For more information, see [Tag resources](https://docs.aws.amazon.com/bedrock/latest/userguide/tagging.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html?trkcampaign=awsomedayonlinehk).
#' @param clientRequestToken A unique, case-sensitive identifier to ensure that the API request completes no more than one time. If this token matches a previous request, Amazon Bedrock ignores the request, but does not return an error. For more information, see [Ensuring idempotency](https://docs.aws.amazon.com/ec2/latest/devguide/ec2-api-idempotency.html).
#'
#' @return
#' A list with the following syntax:
...
#' 
#' For more information, see [Custom models](https://docs.aws.amazon.com/bedrock/latest/userguide/custom-models.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html?trkcampaign=awsomedayonlinehk).
#'
#' @usage
...
#' 
#' For model unit quotas, see [Provisioned Throughput quotas](https://docs.aws.amazon.com/bedrock/latest/userguide/quotas.html#prov-thru-quotas) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html?trkcampaign=awsomedayonlinehk).
#' 
...
#'
#' @description
#' Deletes a custom model that you created earlier. For more information, see [Custom models](https://docs.aws.amazon.com/bedrock/latest/userguide/custom-models.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html?trkcampaign=awsomedayonlinehk).
#'
#' @usage
...
#' 
#' The following actions are related to the [`delete_custom_model_deployment`][bedrock_delete_custom_model_deployment] operation:
#' 
...
#' @section Request syntax:
#' ```
#' svc$get_advanced_prompt_optimization_job(
#'   jobIdentifier = "string"
#' )
#' ```
#'
...
#'
#' @aliases bedrock_get_advanced_prompt_optimization_job
...
#' 
#' The following actions are related to the [`get_custom_model_deployment`][bedrock_get_custom_model_deployment] operation:
#' 
#' -   [`create_custom_model_deployment`][bedrock_create_custom_model_deployment]
#' 
#' -   [`list_custom_model_deployments`][bedrock_list_custom_model_deployments]
...
#'
#' @description
#' Returns details for a Provisioned Throughput. For more information, see [Provisioned Throughput](https://docs.aws.amazon.com/bedrock/latest/userguide/prov-throughput.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html?trkcampaign=awsomedayonlinehk).
#'
#' @usage
...
#' @section Request syntax:
#' ```
#' svc$list_advanced_prompt_optimization_jobs(
#'   maxResults = 123,
#'   nextToken = "string",
#'   sortBy = "CreationTime",
...
#'
#' @aliases bedrock_list_advanced_prompt_optimization_jobs
...
#' 
#' The following actions are related to the [`list_custom_model_deployments`][bedrock_list_custom_model_deployments] operation:
#' 
#' -   [`create_custom_model_deployment`][bedrock_create_custom_model_deployment]
#' 
#' -   [`get_custom_model_deployment`][bedrock_get_custom_model_deployment]
...
#' 
#' You can set the maximum number of results to return in a response in the `maxResults` field. If there are more results than the number you set, the response returns a `nextToken` that you can send in another [`list_guardrails`][bedrock_list_guardrails] request to see the next batch of results.
#'
#' @usage
...
#' List the tags associated with the specified resource.
#' 
#' For more information, see [Tagging resources](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html?trkcampaign=awsomedayonlinehk) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html?trkcampaign=awsomedayonlinehk).
#'
#' @usage
...
#' @section Request syntax:
#' ```
#' svc$stop_advanced_prompt_optimization_job(
#'   jobIdentifier = "string"
#' )
#' ```
#'
...
#'
#' @aliases bedrock_stop_advanced_prompt_optimization_job
...
#'
#' @description
#' Stops an active model customization job. For more information, see [Custom models](https://docs.aws.amazon.com/bedrock/latest/userguide/custom-models.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html?trkcampaign=awsomedayonlinehk).
#'
#' @usage
