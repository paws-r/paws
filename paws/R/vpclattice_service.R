...
#'  \link[=vpclattice_create_resource_configuration]{create_resource_configuration} \tab Creates a resource configuration\cr
#'  \link[=vpclattice_create_resource_gateway]{create_resource_gateway} \tab A resource gateway is a point of ingress into the VPC where a resource resides\cr
...
#'  \link[=vpclattice_create_service_network_resource_association]{create_service_network_resource_association} \tab Associates the specified service network with the specified resource configuration\cr
#'  \link[=vpclattice_create_service_network_service_association]{create_service_network_service_association} \tab Associates the specified service with the specified service network\cr
...
#'  \link[=vpclattice_delete_domain_verification]{delete_domain_verification} \tab Deletes the specified domain verification\cr
#'  \link[=vpclattice_delete_listener]{delete_listener} \tab Deletes the specified listener\cr
#'  \link[=vpclattice_delete_resource_configuration]{delete_resource_configuration} \tab Deletes the specified resource configuration\cr
#'  \link[=vpclattice_delete_resource_endpoint_association]{delete_resource_endpoint_association} \tab Disassociates the resource configuration from the resource VPC endpoint\cr
#'  \link[=vpclattice_delete_resource_gateway]{delete_resource_gateway} \tab Deletes the specified resource gateway\cr
...
#'  \link[=vpclattice_delete_service_network_resource_association]{delete_service_network_resource_association} \tab Deletes the association between a service network and a resource configuration\cr
#'  \link[=vpclattice_delete_service_network_service_association]{delete_service_network_service_association} \tab Deletes the association between a service and a service network\cr
...
#'  \link[=vpclattice_get_domain_verification]{get_domain_verification} \tab Retrieves information about a domain verification\cr
...
#'  \link[=vpclattice_get_resource_configuration]{get_resource_configuration} \tab Retrieves information about the specified resource configuration\cr
#'  \link[=vpclattice_get_resource_gateway]{get_resource_gateway} \tab Retrieves information about the specified resource gateway\cr
#'  \link[=vpclattice_get_resource_policy]{get_resource_policy} \tab Retrieves information about the specified resource policy\cr
#'  \link[=vpclattice_get_rule]{get_rule} \tab Retrieves information about the specified listener rules\cr
...
#'  \link[=vpclattice_get_service_network_resource_association]{get_service_network_resource_association} \tab Retrieves information about the specified association between a service network and a resource configuration\cr
...
#'  \link[=vpclattice_get_service_network_vpc_association]{get_service_network_vpc_association} \tab Retrieves information about the specified association between a service network and a VPC\cr
#'  \link[=vpclattice_get_target_group]{get_target_group} \tab Retrieves information about the specified target group\cr
#'  \link[=vpclattice_list_access_log_subscriptions]{list_access_log_subscriptions} \tab Lists the access log subscriptions for the specified service network or service\cr
#'  \link[=vpclattice_list_domain_verifications]{list_domain_verifications} \tab Lists the domain verifications\cr
#'  \link[=vpclattice_list_listeners]{list_listeners} \tab Lists the listeners for the specified service\cr
#'  \link[=vpclattice_list_resource_configurations]{list_resource_configurations} \tab Lists the resource configurations owned by or shared with this account\cr
#'  \link[=vpclattice_list_resource_endpoint_associations]{list_resource_endpoint_associations} \tab Lists the associations for the specified VPC endpoint\cr
#'  \link[=vpclattice_list_resource_gateways]{list_resource_gateways} \tab Lists the resource gateways that you own or that were shared with you\cr
#'  \link[=vpclattice_list_rules]{list_rules} \tab Lists the rules for the specified listener\cr
#'  \link[=vpclattice_list_service_network_resource_associations]{list_service_network_resource_associations} \tab Lists the associations between a service network and a resource configuration\cr
#'  \link[=vpclattice_list_service_networks]{list_service_networks} \tab Lists the service networks owned by or shared with this account\cr
#'  \link[=vpclattice_list_service_network_service_associations]{list_service_network_service_associations} \tab Lists the associations between a service network and a service\cr
#'  \link[=vpclattice_list_service_network_vpc_associations]{list_service_network_vpc_associations} \tab Lists the associations between a service network and a VPC\cr
#'  \link[=vpclattice_list_service_network_vpc_endpoint_associations]{list_service_network_vpc_endpoint_associations} \tab Lists the associations between a service network and a VPC endpoint\cr
...
#'  \link[=vpclattice_start_domain_verification]{start_domain_verification} \tab Starts the domain verification process for a custom domain name\cr
...
#'  \link[=vpclattice_update_resource_configuration]{update_resource_configuration} \tab Updates the specified resource configuration\cr
#'  \link[=vpclattice_update_resource_gateway]{update_resource_gateway} \tab Updates the specified resource gateway\cr
#'  \link[=vpclattice_update_rule]{update_rule} \tab Updates a specified rule for the listener\cr
...
.vpclattice$metadata <- list(
  ...
  endpoints = list("^(us|eu|ap|sa|ca|me|af|il|mx)\\-\\w+\\-\\d+$" = list(endpoint = "vpc-lattice.{region}.amazonaws.com", global = FALSE), "^cn\\-\\w+\\-\\d+$" = list(endpoint = "vpc-lattice.{region}.amazonaws.com.cn", global = FALSE), "^us\\-gov\\-\\w+\\-\\d+$" = list(endpoint = "vpc-lattice.{region}.amazonaws.com", global = FALSE), "^us\\-iso\\-\\w+\\-\\d+$" = list(endpoint = "vpc-lattice.{region}.c2s.ic.gov", global = FALSE), "^us\\-isob\\-\\w+\\-\\d+$" = list(endpoint = "vpc-lattice.{region}.sc2s.sgov.gov", global = FALSE), "^eu\\-isoe\\-\\w+\\-\\d+$" = list(endpoint = "vpc-lattice.{region}.cloud.adc-e.uk", global = FALSE), "^us\\-isof\\-\\w+\\-\\d+$" = list(endpoint = "vpc-lattice.{region}.csp.hci.ic.gov", global = FALSE), "^eusc\\-(de)\\-\\w+\\-\\d+$" = list(endpoint = "vpc-lattice.{region}.amazonaws.eu", global = FALSE)),
