...
#'  \link[=nimblestudio_get_streaming_session_backup]{get_streaming_session_backup} \tab Gets StreamingSessionBackup resource\cr
...
#'  \link[=nimblestudio_list_streaming_session_backups]{list_streaming_session_backups} \tab Lists the backups of a streaming session in a studio\cr
...
#'  \link[=nimblestudio_list_studios]{list_studios} \tab List studios in your Amazon Web Services accounts in the requested Amazon Web Services Region\cr
...
#'  \link[=nimblestudio_start_studio_sso_configuration_repair]{start_studio_sso_configuration_repair} \tab Repairs the IAM Identity Center configuration for a given studio\cr
...
.nimblestudio$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "nimble.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "nimble.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "nimble.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "nimble.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "nimble.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "nimble.{region}.csp.hci.ic.gov", global = FALSE)),
  service_id = "nimble",
