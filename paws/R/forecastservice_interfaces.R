...
.forecastservice$describe_dataset_import_job_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(DatasetImportJobName = structure(logical(0), tags = list(type = "string")), DatasetImportJobArn = structure(logical(0), tags = list(type = "string")), DatasetArn = structure(logical(0), tags = list(type = "string")), TimestampFormat = structure(logical(0), tags = list(type = "string")), TimeZone = structure(logical(0), tags = list(type = "string")), UseGeolocationForTimeZone = structure(logical(0), tags = list(type = "boolean")), GeolocationFormat = structure(logical(0), tags = list(type = "string")), DataSource = structure(list(S3Config = structure(list(Path = structure(logical(0), tags = list(type = "string")), RoleArn = structure(logical(0), tags = list(type = "string")), KMSKeyArn = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure")), FieldStatistics = structure(list(structure(list(Count = structure(logical(0), tags = list(type = "integer")), CountDistinct = structure(logical(0), tags = list(type = "integer")), CountNull = structure(logical(0), tags = list(type = "integer")), CountNan = structure(logical(0), tags = list(type = "integer")), Min = structure(logical(0), tags = list(type = "string")), Max = structure(logical(0), tags = list(type = "string")), Avg = structure(logical(0), tags = list(type = "double")), Stddev = structure(logical(0), tags = list(type = "double"))), tags = list(type = "structure"))), tags = list(type = "map")), DataSize = structure(logical(0), tags = list(type = "double")), Status = structure(logical(0), tags = list(type = "string")), Message = structure(logical(0), tags = list(type = "string")), CreationTime = structure(logical(0), tags = list(type = "timestamp")), LastModificationTime = structure(logical(0), tags = list(type = "timestamp"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
