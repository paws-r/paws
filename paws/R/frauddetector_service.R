...
#'  \link[=frauddetector_get_kms_encryption_key]{get_kms_encryption_key} \tab Gets the encryption key if a Key Management Service (KMS) customer master key (CMK) has been specified to be used to encrypt content in Amazon Fraud Detector\cr
...
#'  \link[=frauddetector_put_kms_encryption_key]{put_kms_encryption_key} \tab Specifies the Key Management Service (KMS) customer master key (CMK) to be used to encrypt content in Amazon Fraud Detector\cr
...
#'  \link[=frauddetector_update_model]{update_model} \tab Updates a model\cr
