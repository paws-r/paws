...
#'  \link[=backup_create_backup_access_point]{create_backup_access_point} \tab Creates a backup access point for an Amazon S3 recovery point\cr
...
#'  \link[=backup_delete_backup_access_point]{delete_backup_access_point} \tab Deletes a backup access point\cr
...
#'  \link[=backup_describe_backup_access_point]{describe_backup_access_point} \tab Returns metadata about a backup access point, including its status and the details of the underlying Amazon S3 access point\cr
...
#'  \link[=backup_list_backup_access_points]{list_backup_access_points} \tab Returns a list of the backup access points in your account and Region\cr
#'  \link[=backup_list_backup_access_points_by_recovery_point]{list_backup_access_points_by_recovery_point} \tab Returns the backup access points associated with the specified recovery point\cr
#'  \link[=backup_list_backup_access_points_by_resource]{list_backup_access_points_by_resource} \tab Returns the backup access points associated with the specified resource, such as an Amazon S3 bucket\cr
...
#'  \link[=backup_list_backup_job_summaries]{list_backup_job_summaries} \tab This is a request for a summary of backup jobs created or running within the most recent 14 days\cr
...
#'  \link[=backup_list_copy_job_summaries]{list_copy_job_summaries} \tab This request obtains a list of copy jobs created or running within the the most recent 14 days\cr
...
#'  \link[=backup_list_protected_resources]{list_protected_resources} \tab Returns an array of resources with recovery points created by Backup (regardless of the recovery point's status), including the time the resource was saved, an Amazon Resource Name (ARN) of the resource, and a resource type\cr
...
#'  \link[=backup_list_restore_job_summaries]{list_restore_job_summaries} \tab This request obtains a summary of restore jobs created or running within the the most recent 14 days\cr
...
#'  \link[=backup_list_scan_job_summaries]{list_scan_job_summaries} \tab This is a request for a summary of scan jobs created or running within the most recent 14 days\cr
