test_that("make_interfaces", {
  ...
  expected_text <- gsub(
    ...
    .api$foo_input <- function(...) {
      ...
      return(populate(args, .api_shapes[[\"foo_input\"]]))
    }
...
test_that("make_interface with root-level metadata", {
  ...
  expect_equal(actual$text, expected_text)
  expect_equal(actual$key, "foo_input")
  expect_equal(
    actual$shape,
    structure(logical(0), tags = list(type = "string", locationName = "FooShapeInput"))
  )
})
...
test_that("structure with one scalar member", {
  api <- list(
    shapes = list(
      StructureShape = list(
        type = "structure",
        members = list(StringShape = list(shape = "StringShape"))
      ),
      StringShape = list(type = "string")
    )
  )
  ...
  api <- list(
    shapes = list(
      StructureShape = list(
        type = "structure",
        members = list(
          String = list(shape = "StringShape"),
          Double = list(shape = "DoubleShape"),
          Boolean = list(shape = "BooleanShape")
        )
      ),
      StringShape = list(type = "string"),
      DoubleShape = list(type = "double"),
      BooleanShape = list(type = "boolean")
    )
  )
  out <- make_shape(list(shape = "StructureShape"), api = api)
  expect_length(out, 3)
...
test_that("list of scalars", {
  api <- list(
    shapes = list(
      ListShape = list(type = "list", member = list(shape = "StringShape")),
      StringShape = list(type = "string")
    )
  )
...
test_that("list of structures", {
  api <- list(
    shapes = list(
      ListShape = list(type = "list", member = list(shape = "StructureShape")),
      StructureShape = list(
        type = "structure",
        members = list(String = list(shape = "StringShape"))
      ),
      StringShape = list(type = "string")
    )
  )
...
test_that("map of scalars", {
  api <- list(
    shapes = list(
      MapShape = list(
        type = "map",
        key = list(shape = "StringShape"),
        value = list(shape = "StringShape")
      ),
      StringShape = list(type = "string")
    )
  )
...
test_that("location name for lists", {
  api <- list(
    shapes = list(
      StructureShape = list(
        type = "structure",
        members = list(List = list(shape = "ListShape"))
      ),
      ListShape = list(
        type = "list",
        member = list(shape = "StringShape", locationName = "Foo"),
        flattened = TRUE
      ),
      StringShape = list(type = "string")
    )
...
test_that("location name for maps", {
  api <- list(
    shapes = list(
      StructureShape = list(
        type = "structure",
        members = list(Map = list(shape = "MapShape"))
      ),
      MapShape = list(
        type = "map",
        key = list(shape = "StringShape", locationName = "Foo"),
        value = list(shape = "StringShape", locationName = "Bar"),
        flattened = TRUE,
        locationName = "Map"
      ),
      StringShape = list(type = "string")
