...
{
    op <- new_operation(name = "AcceptReservedInstancesExchangeQuote", 
...
accept_vpc_endpoint_connections <- function (DryRun = NULL, ServiceId, 
    VpcEndpointIds) 
{
    op <- new_operation(name = "AcceptVpcEndpointConnections", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "AcceptVpcPeeringConnection", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "AdvertiseByoipCidr", http_method = "POST", 
...
{
    op <- new_operation(name = "AllocateAddress", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "AllocateHosts", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "AssignIpv6Addresses", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{assign_private_ip_addresses(
...
{
    op <- new_operation(name = "AssignPrivateIpAddresses", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "AssociateAddress", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # specified VPC.
#' \donttest{associate_dhcp_options(
...
{
    op <- new_operation(name = "AssociateDhcpOptions", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{associate_iam_instance_profile(
#'   IamInstanceProfile = list(
#'     Name = "admin-role"
#'   ),
...
associate_iam_instance_profile <- function (IamInstanceProfile, 
    InstanceId) 
{
    op <- new_operation(name = "AssociateIamInstanceProfile", 
        http_method = "POST", http_path = "/", paginator = list())
...
associate_route_table <- function (DryRun = NULL, RouteTableId, 
    SubnetId) 
{
    op <- new_operation(name = "AssociateRouteTable", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "AssociateSubnetCidrBlock", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "AssociateVpcCidrBlock", http_method = "POST", 
        http_path = "/", paginator = list())
...
attach_classic_link_vpc <- function (DryRun = NULL, Groups, InstanceId, 
    VpcId) 
{
    op <- new_operation(name = "AttachClassicLinkVpc", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # VPC.
#' \donttest{attach_internet_gateway(
...
attach_internet_gateway <- function (DryRun = NULL, InternetGatewayId, 
    VpcId) 
{
    op <- new_operation(name = "AttachInternetGateway", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # instance.
#' \donttest{attach_network_interface(
#'   DeviceIndex = 1L,
...
{
    op <- new_operation(name = "AttachNetworkInterface", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "AttachVpnGateway", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{authorize_security_group_egress(
#'   GroupId = "sg-1a2b3c4d",
#'   IpPermissions = list(
#'     list(
#'       FromPort = 80L,
...
{
    op <- new_operation(name = "AuthorizeSecurityGroupEgress", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "AuthorizeSecurityGroupIngress", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "BundleInstance", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CancelBundleTask", http_method = "POST", 
        http_path = "/", paginator = list())
...
cancel_capacity_reservation <- function (CapacityReservationId, 
    DryRun = NULL) 
{
    op <- new_operation(name = "CancelCapacityReservation", http_method = "POST", 
        http_path = "/", paginator = list())
...
cancel_conversion_task <- function (ConversionTaskId, DryRun = NULL, 
    ReasonMessage = NULL) 
{
    op <- new_operation(name = "CancelConversionTask", http_method = "POST", 
        http_path = "/", paginator = list())
...
cancel_import_task <- function (CancelReason = NULL, DryRun = NULL, 
    ImportTaskId = NULL) 
{
    op <- new_operation(name = "CancelImportTask", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CancelReservedInstancesListing", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{cancel_spot_fleet_requests(
#'   SpotFleetRequestIds = list(
...
cancel_spot_fleet_requests <- function (DryRun = NULL, SpotFleetRequestIds, 
    TerminateInstances) 
{
    op <- new_operation(name = "CancelSpotFleetRequests", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{cancel_spot_instance_requests(
#'   SpotInstanceRequestIds = list(
#'     "sir-08b93456"
#'   )
#' )}
...
{
    op <- new_operation(name = "CancelSpotInstanceRequests", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{confirm_product_instance(
#'   InstanceId = "i-1234567890abcdef0",
...
confirm_product_instance <- function (InstanceId, ProductCode, 
    DryRun = NULL) 
{
    op <- new_operation(name = "ConfirmProductInstance", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CopyFpgaImage", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateCapacityReservation", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{create_customer_gateway(
#'   BgpAsn = 65534L,
#'   PublicIp = "12.1.2.3",
#'   Type = "ipsec.1"
#' )}
...
create_customer_gateway <- function (BgpAsn, PublicIp, Type, 
    DryRun = NULL) 
{
    op <- new_operation(name = "CreateCustomerGateway", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateDefaultSubnet", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateDefaultVpc", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateDhcpOptions", http_method = "POST", 
        http_path = "/", paginator = list())
...
create_egress_only_internet_gateway <- function (ClientToken = NULL, 
    DryRun = NULL, VpcId) 
{
    op <- new_operation(name = "CreateEgressOnlyInternetGateway", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateFlowLogs", http_method = "POST", 
        http_path = "/", paginator = list())
...
create_fpga_image <- function (DryRun = NULL, InputStorageLocation, 
    ...
    ClientToken = NULL) 
{
    op <- new_operation(name = "CreateFpgaImage", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateImage", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateInstanceExportTask", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{create_internet_gateway()}
#'
#' @export
create_internet_gateway <- function (DryRun = NULL) 
{
    op <- new_operation(name = "CreateInternetGateway", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{create_launch_template(
#'   LaunchTemplateData = list(
...
{
    op <- new_operation(name = "CreateLaunchTemplate", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{create_launch_template_version(
#'   LaunchTemplateData = list(
...
{
    op <- new_operation(name = "CreateLaunchTemplateVersion", 
        http_method = "POST", http_path = "/", paginator = list())
...
create_nat_gateway <- function (AllocationId, ClientToken = NULL, 
    SubnetId) 
{
    op <- new_operation(name = "CreateNatGateway", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateNetworkAcl", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{create_network_acl_entry(
#'   CidrBlock = "0.0.0.0/0",
#'   Egress = FALSE,
...
{
    op <- new_operation(name = "CreateNetworkAclEntry", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{create_network_interface(
...
create_network_interface <- function (Description = NULL, DryRun = NULL, 
    ...
    SubnetId) 
{
    op <- new_operation(name = "CreateNetworkInterface", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateNetworkInterfacePermission", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{create_placement_group(
...
{
    op <- new_operation(name = "CreateReservedInstancesListing", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateRouteTable", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{create_security_group(
...
create_security_group <- function (Description, GroupName, VpcId = NULL, 
    DryRun = NULL) 
{
    op <- new_operation(name = "CreateSecurityGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{create_spot_datafeed_subscription(
#'   Bucket = "my-s3-bucket",
#'   Prefix = "spotdata"
#' )}
#'
...
create_spot_datafeed_subscription <- function (Bucket, DryRun = NULL, 
    Prefix = NULL) 
{
    op <- new_operation(name = "CreateSpotDatafeedSubscription", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateVolume", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateVpc", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateVpcEndpoint", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateVpcEndpointConnectionNotification", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateVpcEndpointServiceConfiguration", 
        http_method = "POST", http_path = "/", paginator = list())
...
create_vpn_connection_route <- function (DestinationCidrBlock, 
    VpnConnectionId) 
{
    op <- new_operation(name = "CreateVpnConnectionRoute", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateVpnGateway", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{delete_customer_gateway(
...
{
    op <- new_operation(name = "DeleteCustomerGateway", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteDhcpOptions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteEgressOnlyInternetGateway", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteFleets", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteFlowLogs", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteFpgaImage", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{delete_internet_gateway(
#'   InternetGatewayId = "igw-c0a643a9"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "DeleteInternetGateway", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{delete_launch_template(
#'   LaunchTemplateId = "lt-0abcd290751193123"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "DeleteLaunchTemplate", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteLaunchTemplateVersions", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteNatGateway", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteNetworkAcl", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # ACL.
#' \donttest{delete_network_acl_entry(
#'   Egress = TRUE,
#'   NetworkAclId = "acl-5fb85d36",
#'   RuleNumber = 100L
#' )}
...
{
    op <- new_operation(name = "DeleteNetworkAclEntry", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{delete_network_interface(
#'   NetworkInterfaceId = "eni-e5aa89a3"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "DeleteNetworkInterface", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteNetworkInterfacePermission", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # 
#' \donttest{delete_placement_group(
#'   GroupName = "my-cluster"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "DeletePlacementGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteRoute", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteRouteTable", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{delete_security_group(
#'   GroupId = "sg-903004f8"
#' )}
#'
#' @export
delete_security_group <- function (GroupId = NULL, GroupName = NULL, 
    DryRun = NULL) 
{
    op <- new_operation(name = "DeleteSecurityGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{delete_spot_datafeed_subscription()}
#'
#' @export
delete_spot_datafeed_subscription <- function (DryRun = NULL) 
{
    op <- new_operation(name = "DeleteSpotDatafeedSubscription", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteSubnet", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteVpc", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteVpcEndpointConnectionNotifications", 
        http_method = "POST", http_path = "/", paginator = list())
...
delete_vpc_endpoint_service_configurations <- function (DryRun = NULL, 
    ServiceIds) 
{
    op <- new_operation(name = "DeleteVpcEndpointServiceConfigurations", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteVpcEndpoints", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteVpnConnection", http_method = "POST", 
        http_path = "/", paginator = list())
...
delete_vpn_connection_route <- function (DestinationCidrBlock, 
    VpnConnectionId) 
{
    op <- new_operation(name = "DeleteVpnConnectionRoute", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteVpnGateway", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeprovisionByoipCidr", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeregisterImage", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeAddresses", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeAggregateIdFormat", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_availability_zones()}
#'
#' @export
...
describe_bundle_tasks <- function (BundleIds = NULL, Filters = NULL, 
    DryRun = NULL) 
{
    op <- new_operation(name = "DescribeBundleTasks", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_byoip_cidrs <- function (DryRun = NULL, MaxResults, 
    NextToken = NULL) 
{
    op <- new_operation(name = "DescribeByoipCidrs", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeCapacityReservations", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeClassicLinkInstances", 
        http_method = "POST", http_path = "/", paginator = list())
...
describe_conversion_tasks <- function (ConversionTaskIds = NULL, 
    DryRun = NULL) 
{
    op <- new_operation(name = "DescribeConversionTasks", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_customer_gateways(
#'   CustomerGatewayIds = list(
#'     "cgw-0e11f167"
#'   )
#' )}
...
{
    op <- new_operation(name = "DescribeCustomerGateways", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_dhcp_options(
#'   DhcpOptionsIds = list(
#'     "dopt-d9070ebb"
#'   )
#' )}
...
describe_dhcp_options <- function (DhcpOptionsIds = NULL, Filters = NULL, 
    DryRun = NULL) 
{
    op <- new_operation(name = "DescribeDhcpOptions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeEgressOnlyInternetGateways", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeElasticGpus", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeFleetHistory", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeFleetInstances", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeFlowLogs", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_fpga_image_attribute <- function (DryRun = NULL, FpgaImageId, 
    Attribute) 
{
    op <- new_operation(name = "DescribeFpgaImageAttribute", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeFpgaImages", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeHostReservationOfferings", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeHostReservations", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_hosts <- function (Filter = NULL, HostIds = NULL, MaxResults = NULL, 
    NextToken = NULL) 
{
    op <- new_operation(name = "DescribeHosts", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_iam_instance_profile_associations(
#'   AssociationIds = list(
...
describe_iam_instance_profile_associations <- function (AssociationIds = NULL, 
    Filters = NULL, MaxResults = NULL, NextToken = NULL) 
{
    op <- new_operation(name = "DescribeIamInstanceProfileAssociations", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeIdFormat", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeIdentityIdFormat", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_image_attribute(
...
{
    op <- new_operation(name = "DescribeImageAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeImportImageTasks", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_import_snapshot_tasks <- function (DryRun = NULL, Filters = NULL, 
    ImportTaskIds = NULL, MaxResults = NULL, NextToken = NULL) 
{
    op <- new_operation(name = "DescribeImportSnapshotTasks", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # 
#' \donttest{describe_instance_attribute(
...
describe_instance_attribute <- function (Attribute, DryRun = NULL, 
    InstanceId) 
{
    op <- new_operation(name = "DescribeInstanceAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeInstanceCreditSpecifications", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{describe_instance_status(
#'   InstanceIds = list(
#'     "i-1234567890abcdef0"
#'   )
#' )}
...
{
    op <- new_operation(name = "DescribeInstanceStatus", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_internet_gateways(
#'   Filters = list(
#'     list(
...
{
    op <- new_operation(name = "DescribeInternetGateways", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_key_pairs <- function (Filters = NULL, KeyNames = NULL, 
    DryRun = NULL) 
{
    op <- new_operation(name = "DescribeKeyPairs", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_launch_template_versions(
...
describe_launch_template_versions <- function (DryRun = NULL, 
    ...
    Filters = NULL) 
{
    op <- new_operation(name = "DescribeLaunchTemplateVersions", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{describe_launch_templates(
#'   LaunchTemplateIds = list(
...
describe_launch_templates <- function (DryRun = NULL, LaunchTemplateIds = NULL, 
    ...
    MaxResults = NULL) 
{
    op <- new_operation(name = "DescribeLaunchTemplates", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_nat_gateways(
#'   Filter = list(
#'     list(
#'       Name = "vpc-id",
#'       Values = list(
...
{
    op <- new_operation(name = "DescribeNatGateways", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_network_acls(
#'   NetworkAclIds = list(
#'     "acl-5fb85d36"
#'   )
#' )}
...
describe_network_acls <- function (Filters = NULL, DryRun = NULL, 
    NetworkAclIds = NULL) 
{
    op <- new_operation(name = "DescribeNetworkAcls", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # interface.
#' \donttest{describe_network_interface_attribute(
...
{
    op <- new_operation(name = "DescribeNetworkInterfaceAttribute", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeNetworkInterfacePermissions", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' @examples
#' # 
#' \donttest{describe_network_interfaces(
#'   NetworkInterfaceIds = list(
#'     "eni-e5aa89a3"
#'   )
#' )}
...
{
    op <- new_operation(name = "DescribeNetworkInterfaces", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_placement_groups <- function (Filters = NULL, DryRun = NULL, 
    GroupNames = NULL) 
{
    op <- new_operation(name = "DescribePlacementGroups", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribePrefixLists", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_principal_id_format <- function (DryRun = NULL, Resources = NULL, 
    MaxResults = NULL, NextToken = NULL) 
{
    op <- new_operation(name = "DescribePrincipalIdFormat", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_public_ipv_4_pools <- function (PoolIds = NULL, NextToken = NULL, 
    MaxResults = NULL) 
{
    op <- new_operation(name = "DescribePublicIpv4Pools", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_regions()}
#'
#' @export
describe_regions <- function (Filters = NULL, RegionNames = NULL, 
    DryRun = NULL) 
{
    op <- new_operation(name = "DescribeRegions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeReservedInstances", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeReservedInstancesListings", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeReservedInstancesModifications", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeReservedInstancesOfferings", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{describe_route_tables(
#'   RouteTableIds = list(
#'     "rtb-1f382e7d"
#'   )
#' )}
...
{
    op <- new_operation(name = "DescribeRouteTables", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_scheduled_instance_availability(
#'   FirstSlotStartTimeRange = list(
...
{
    op <- new_operation(name = "DescribeScheduledInstanceAvailability", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeScheduledInstances", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # security group.
#' \donttest{describe_security_group_references(
#'   GroupId = list(
#'     "sg-903004f8"
#'   )
#' )}
...
describe_security_group_references <- function (DryRun = NULL, 
    GroupId) 
{
    op <- new_operation(name = "DescribeSecurityGroupReferences", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{describe_security_groups(
#'   GroupIds = list(
#'     "sg-903004f8"
#'   )
#' )}
...
{
    op <- new_operation(name = "DescribeSecurityGroups", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_snapshot_attribute(
...
describe_snapshot_attribute <- function (Attribute, SnapshotId, 
    DryRun = NULL) 
{
    op <- new_operation(name = "DescribeSnapshotAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeSpotDatafeedSubscription", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # fleet.
#' \donttest{describe_spot_fleet_instances(
...
{
    op <- new_operation(name = "DescribeSpotFleetInstances", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{describe_spot_fleet_request_history(
#'   SpotFleetRequestId = "sfr-73fbd2ce-aa30-494c-8788-1cee4EXAMPLE",
...
describe_spot_fleet_request_history <- function (DryRun = NULL, 
    ...
    StartTime) 
{
    op <- new_operation(name = "DescribeSpotFleetRequestHistory", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{describe_spot_fleet_requests(
#'   SpotFleetRequestIds = list(
#'     "sfr-73fbd2ce-aa30-494c-8788-1cee4EXAMPLE"
#'   )
#' )}
...
{
    op <- new_operation(name = "DescribeSpotFleetRequests", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_spot_instance_requests(
#'   SpotInstanceRequestIds = list(
#'     "sir-08b93456"
#'   )
#' )}
...
#' \donttest{describe_spot_price_history(
...
{
    op <- new_operation(name = "DescribeSpotPriceHistory", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeStaleSecurityGroups", 
        http_method = "POST", http_path = "/", paginator = list())
...
describe_subnets <- function (Filters = NULL, SubnetIds = NULL, 
    DryRun = NULL) 
{
    op <- new_operation(name = "DescribeSubnets", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_volume_attribute(
...
{
    op <- new_operation(name = "DescribeVolumeAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_volume_status(
#'   VolumeIds = list(
#'     "vol-1234567890abcdef0"
#'   )
#' )}
...
{
    op <- new_operation(name = "DescribeVolumeStatus", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_volumes <- function (Filters = NULL, VolumeIds = NULL, 
    DryRun = NULL, MaxResults = NULL, NextToken = NULL) 
{
    op <- new_operation(name = "DescribeVolumes", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_volumes_modifications <- function (DryRun = NULL, VolumeIds = NULL, 
    Filters = NULL, NextToken = NULL, MaxResults = NULL) 
{
    op <- new_operation(name = "DescribeVolumesModifications", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{describe_vpc_attribute(
...
{
    op <- new_operation(name = "DescribeVpcAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_vpc_classic_link <- function (Filters = NULL, DryRun = NULL, 
    VpcIds = NULL) 
{
    op <- new_operation(name = "DescribeVpcClassicLink", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeVpcClassicLinkDnsSupport", 
        http_method = "POST", http_path = "/", paginator = list())
...
describe_vpc_endpoint_connection_notifications <- function (DryRun = NULL, 
    ...
    NextToken = NULL) 
{
    op <- new_operation(name = "DescribeVpcEndpointConnectionNotifications", 
        http_method = "POST", http_path = "/", paginator = list())
...
describe_vpc_endpoint_connections <- function (DryRun = NULL, 
    Filters = NULL, MaxResults = NULL, NextToken = NULL) 
{
    op <- new_operation(name = "DescribeVpcEndpointConnections", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeVpcEndpointServiceConfigurations", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeVpcEndpointServicePermissions", 
        http_method = "POST", http_path = "/", paginator = list())
...
describe_vpc_endpoint_services <- function (DryRun = NULL, ServiceNames = NULL, 
    Filters = NULL, MaxResults = NULL, NextToken = NULL) 
{
    op <- new_operation(name = "DescribeVpcEndpointServices", 
        http_method = "POST", http_path = "/", paginator = list())
...
describe_vpc_endpoints <- function (DryRun = NULL, VpcEndpointIds = NULL, 
    Filters = NULL, MaxResults = NULL, NextToken = NULL) 
{
    op <- new_operation(name = "DescribeVpcEndpoints", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeVpcs", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_vpn_connections <- function (Filters = NULL, VpnConnectionIds = NULL, 
    DryRun = NULL) 
{
    op <- new_operation(name = "DescribeVpnConnections", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_vpn_gateways <- function (Filters = NULL, VpnGatewayIds = NULL, 
    DryRun = NULL) 
{
    op <- new_operation(name = "DescribeVpnGateways", http_method = "POST", 
        http_path = "/", paginator = list())
...
detach_classic_link_vpc <- function (DryRun = NULL, InstanceId, 
    VpcId) 
{
    op <- new_operation(name = "DetachClassicLinkVpc", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # VPC.
#' \donttest{detach_internet_gateway(
#'   InternetGatewayId = "igw-c0a643a9",
#'   VpcId = "vpc-a01106c2"
#' )}
#'
...
detach_internet_gateway <- function (DryRun = NULL, InternetGatewayId, 
    VpcId) 
{
    op <- new_operation(name = "DetachInternetGateway", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # instance.
#' \donttest{detach_network_interface(
...
detach_network_interface <- function (AttachmentId, DryRun = NULL, 
    Force = NULL) 
{
    op <- new_operation(name = "DetachNetworkInterface", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DetachVpnGateway", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{disable_vgw_route_propagation(
...
{
    op <- new_operation(name = "DisableVgwRoutePropagation", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DisableVpcClassicLink", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DisableVpcClassicLinkDnsSupport", 
        http_method = "POST", http_path = "/", paginator = list())
...
disassociate_address <- function (AssociationId = NULL, PublicIp = NULL, 
    DryRun = NULL) 
{
    op <- new_operation(name = "DisassociateAddress", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # instance.
#' \donttest{disassociate_iam_instance_profile(
...
{
    op <- new_operation(name = "DisassociateIamInstanceProfile", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # subnet.
#' \donttest{disassociate_route_table(
...
{
    op <- new_operation(name = "DisassociateRouteTable", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DisassociateSubnetCidrBlock", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DisassociateVpcCidrBlock", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{enable_vgw_route_propagation(
#'   GatewayId = "vgw-9a4cacf3",
#'   RouteTableId = "rtb-22574640"
#' )}
#'
...
{
    op <- new_operation(name = "EnableVgwRoutePropagation", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "EnableVolumeIO", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "EnableVpcClassicLink", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "EnableVpcClassicLinkDnsSupport", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetConsoleOutput", http_method = "POST", 
        http_path = "/", paginator = list())
...
get_console_screenshot <- function (DryRun = NULL, InstanceId, 
    WakeUp = NULL) 
{
    op <- new_operation(name = "GetConsoleScreenshot", http_method = "POST", 
        http_path = "/", paginator = list())
...
get_host_reservation_purchase_preview <- function (HostIdSet, 
    OfferingId) 
{
    op <- new_operation(name = "GetHostReservationPurchasePreview", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{get_launch_template_data(
...
{
    op <- new_operation(name = "GetLaunchTemplateData", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetPasswordData", http_method = "POST", 
        http_path = "/", paginator = list())
...
get_reserved_instances_exchange_quote <- function (DryRun = NULL, 
    ReservedInstanceIds, TargetConfigurations = NULL) 
{
    op <- new_operation(name = "GetReservedInstancesExchangeQuote", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ImportInstance", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ImportVolume", http_method = "POST", 
        http_path = "/", paginator = list())
...
modify_capacity_reservation <- function (CapacityReservationId, 
    ...
    DryRun = NULL) 
{
    op <- new_operation(name = "ModifyCapacityReservation", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyFleet", http_method = "POST", 
        http_path = "/", paginator = list())
...
modify_fpga_image_attribute <- function (DryRun = NULL, FpgaImageId, 
    ...
    Name = NULL) 
{
    op <- new_operation(name = "ModifyFpgaImageAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyHosts", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyIdFormat", http_method = "POST", 
        http_path = "/", paginator = list())
...
modify_identity_id_format <- function (PrincipalArn, Resource, 
    UseLongIds) 
{
    op <- new_operation(name = "ModifyIdentityIdFormat", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{modify_image_attribute(
#'   ImageId = "ami-5731123e",
#'   LaunchPermission = list(
#'     Add = list(
#'       list(
...
{
    op <- new_operation(name = "ModifyImageAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # instance.
#' \donttest{modify_instance_attribute(
#'   InstanceId = "i-1234567890abcdef0",
#'   InstanceType = list(
#'     Value = "m5.large"
#'   )
...
modify_instance_attribute <- function (SourceDestCheck = NULL, 
    ...
    Value = NULL) 
{
    op <- new_operation(name = "ModifyInstanceAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyInstanceCapacityReservationAttributes", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyInstanceCreditSpecification", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # launch template.
#' \donttest{modify_launch_template(
#'   DefaultVersion = "2",
#'   LaunchTemplateId = "lt-0abcd290751193123"
#' )}
#'
...
{
    op <- new_operation(name = "ModifyLaunchTemplate", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # interface.
#' \donttest{modify_network_interface_attribute(
#'   Attachment = list(
...
{
    op <- new_operation(name = "ModifyNetworkInterfaceAttribute", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyReservedInstances", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{modify_snapshot_attribute(
#'   Attribute = "createVolumePermission",
...
modify_snapshot_attribute <- function (Attribute = NULL, CreateVolumePermission = NULL, 
    ...
    DryRun = NULL) 
{
    op <- new_operation(name = "ModifySnapshotAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # request.
#' \donttest{modify_spot_fleet_request(
#'   SpotFleetRequestId = "sfr-73fbd2ce-aa30-494c-8788-1cee4EXAMPLE",
#'   TargetCapacity = 20L
#' )}
#' 
...
{
    op <- new_operation(name = "ModifySpotFleetRequest", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{modify_subnet_attribute(
#'   MapPublicIpOnLaunch = list(
#'     Value = TRUE
#'   ),
#'   SubnetId = "subnet-1a2b3c4d"
...
{
    op <- new_operation(name = "ModifySubnetAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyVolume", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # output is returned.
#' \donttest{modify_volume_attribute(
#'   AutoEnableIO = list(
#'     Value = TRUE
#'   ),
#'   DryRun = TRUE,
...
modify_volume_attribute <- function (AutoEnableIO = NULL, VolumeId, 
    DryRun = NULL) 
{
    op <- new_operation(name = "ModifyVolumeAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyVpcAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
modify_vpc_endpoint <- function (DryRun = NULL, VpcEndpointId, 
    ...
    PrivateDnsEnabled = NULL) 
{
    op <- new_operation(name = "ModifyVpcEndpoint", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyVpcEndpointConnectionNotification", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyVpcEndpointServiceConfiguration", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyVpcEndpointServicePermissions", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyVpcPeeringConnectionOptions", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyVpcTenancy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "MonitorInstances", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "MoveAddressToVpc", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ProvisionByoipCidr", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PurchaseHostReservation", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PurchaseReservedInstancesOffering", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{purchase_scheduled_instances(
#'   PurchaseRequests = list(
#'     list(
#'       InstanceCount = 1L,
...
{
    op <- new_operation(name = "PurchaseScheduledInstances", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RebootInstances", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RegisterImage", http_method = "POST", 
        http_path = "/", paginator = list())
...
reject_vpc_endpoint_connections <- function (DryRun = NULL, ServiceId, 
    VpcEndpointIds) 
{
    op <- new_operation(name = "RejectVpcEndpointConnections", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RejectVpcPeeringConnection", 
        http_method = "POST", http_path = "/", paginator = list())
...
release_address <- function (AllocationId = NULL, PublicIp = NULL, 
    DryRun = NULL) 
{
    op <- new_operation(name = "ReleaseAddress", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ReleaseHosts", http_method = "POST", 
        http_path = "/", paginator = list())
...
replace_iam_instance_profile_association <- function (IamInstanceProfile, 
    AssociationId) 
{
    op <- new_operation(name = "ReplaceIamInstanceProfileAssociation", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{replace_network_acl_association(
...
replace_network_acl_association <- function (AssociationId, DryRun = NULL, 
    NetworkAclId) 
{
    op <- new_operation(name = "ReplaceNetworkAclAssociation", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{replace_network_acl_entry(
...
replace_network_acl_entry <- function (CidrBlock = NULL, DryRun = NULL, 
    ...
    PortRange = NULL, Protocol, RuleAction, RuleNumber) 
{
    op <- new_operation(name = "ReplaceNetworkAclEntry", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{replace_route_table_association(
#'   AssociationId = "rtbassoc-781d0d1a",
#'   RouteTableId = "rtb-22574640"
#' )}
#'
...
replace_route_table_association <- function (AssociationId, DryRun = NULL, 
    RouteTableId) 
{
    op <- new_operation(name = "ReplaceRouteTableAssociation", 
        http_method = "POST", http_path = "/", paginator = list())
...
report_instance_status <- function (Description = NULL, DryRun = NULL, 
    ...
    Status) 
{
    op <- new_operation(name = "ReportInstanceStatus", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RequestSpotFleet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # Availability Zone.
#' \donttest{request_spot_instances(
#'   InstanceCount = 5L,
#'   LaunchSpecification = list(
#'     IamInstanceProfile = list(
#'       Arn = "arn:aws:iam::123456789012:instance-profile/my-iam-role"
...
{
    op <- new_operation(name = "RequestSpotInstances", http_method = "POST", 
        http_path = "/", paginator = list())
...
reset_fpga_image_attribute <- function (DryRun = NULL, FpgaImageId, 
    Attribute = NULL) 
{
    op <- new_operation(name = "ResetFpgaImageAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{reset_image_attribute(
#'   Attribute = "launchPermission",
#'   ImageId = "ami-5731123e"
#' )}
#'
...
{
    op <- new_operation(name = "ResetImageAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # instance.
#' \donttest{reset_instance_attribute(
#'   Attribute = "sourceDestCheck",
#'   InstanceId = "i-1234567890abcdef0"
#' )}
#'
...
reset_instance_attribute <- function (Attribute, DryRun = NULL, 
    InstanceId) 
{
    op <- new_operation(name = "ResetInstanceAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ResetNetworkInterfaceAttribute", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # ``snap-1234567890abcdef0``. If the command succeeds, no output is
#' # returned.
#' \donttest{reset_snapshot_attribute(
#'   Attribute = "createVolumePermission",
#'   SnapshotId = "snap-1234567890abcdef0"
#' )}
#'
...
reset_snapshot_attribute <- function (Attribute, SnapshotId, 
    DryRun = NULL) 
{
    op <- new_operation(name = "ResetSnapshotAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{restore_address_to_classic(
#'   PublicIp = "198.51.100.0"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "RestoreAddressToClassic", http_method = "POST", 
        http_path = "/", paginator = list())
...
revoke_security_group_egress <- function (DryRun = NULL, GroupId, 
    ...
    ToPort = NULL, SourceSecurityGroupName = NULL, SourceSecurityGroupOwnerId = NULL) 
{
    op <- new_operation(name = "RevokeSecurityGroupEgress", http_method = "POST", 
        http_path = "/", paginator = list())
...
revoke_security_group_ingress <- function (CidrIp = NULL, FromPort = NULL, 
    ...
    ToPort = NULL, DryRun = NULL) 
{
    op <- new_operation(name = "RevokeSecurityGroupIngress", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{run_scheduled_instances(
#'   InstanceCount = 1L,
#'   LaunchSpecification = list(
#'     IamInstanceProfile = list(
#'       Name = "my-iam-role"
...
{
    op <- new_operation(name = "RunScheduledInstances", http_method = "POST", 
        http_path = "/", paginator = list())
...
start_instances <- function (InstanceIds, AdditionalInfo = NULL, 
    DryRun = NULL) 
{
    op <- new_operation(name = "StartInstances", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "TerminateInstances", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UnassignIpv6Addresses", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # specified network interface.
#' \donttest{unassign_private_ip_addresses(
#'   NetworkInterfaceId = "eni-e5aa89a3",
#'   PrivateIpAddresses = list(
#'     "10.0.0.82"
#'   )
...
unassign_private_ip_addresses <- function (NetworkInterfaceId, 
    PrivateIpAddresses) 
{
    op <- new_operation(name = "UnassignPrivateIpAddresses", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UnmonitorInstances", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # rule.
#' \donttest{update_security_group_rule_descriptions_egress(
#'   GroupId = "sg-123abc12",
#'   IpPermissions = list(
#'     list(
#'       FromPort = 80L,
...
{
    op <- new_operation(name = "UpdateSecurityGroupRuleDescriptionsEgress", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # This example updates the description for the specified security group
#' # rule.
#' \donttest{update_security_group_rule_descriptions_ingress(
#'   GroupId = "sg-123abc12",
#'   IpPermissions = list(
#'     list(
#'       FromPort = 22L,
...
update_security_group_rule_descriptions_ingress <- function (DryRun = NULL, 
    GroupId = NULL, GroupName = NULL, IpPermissions) 
{
    op <- new_operation(name = "UpdateSecurityGroupRuleDescriptionsIngress", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "WithdrawByoipCidr", http_method = "POST", 
        http_path = "/", paginator = list())
