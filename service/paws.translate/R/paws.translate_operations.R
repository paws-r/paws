...
{
    op <- new_operation(name = "DeleteTerminology", http_method = "POST", 
...
{
    op <- new_operation(name = "GetTerminology", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ImportTerminology", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListTerminologies", http_method = "POST", 
        http_path = "/", paginator = list())
