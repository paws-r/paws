service <- function () 
{
    cfg <- client_config("sqs", list(`*` = "sqs.{region}.amazonaws.com", 
        `cn-*` = "sqs.{region}.amazonaws.com.cn"))
    client_info <- ClientInfo(service_name = "sqs", service_id = "SQS", 
        api_version = "2012-11-05", signing_name = cfg$signing_name, 
