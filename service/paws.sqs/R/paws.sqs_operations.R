...
#' 
#' Queue URLs and names are case-sensitive.
#' @param ReceiptHandle The receipt handle associated with the message whose visibility timeout is changed. This parameter is returned by the ` ReceiveMessage ReceiveMessage ` action.
...
#' 
#' Queue URLs and names are case-sensitive.
#' @param Label The identification of the permission to remove. This is the label added using the ` AddPermission AddPermission ` action.
#'
#' @examples
#'
#' @export
...
#' 
#' Queue URLs and names are case-sensitive.
#' @param Entries A list of ` SendMessageBatchRequestEntry SendMessageBatchRequestEntry ` items.
#'
#' @examples
#'
#' @export
