...
{
    op <- new_operation(name = "AddPermission", http_method = "POST", 
...
change_message_visibility <- function (QueueUrl, ReceiptHandle, 
    VisibilityTimeout) 
{
    op <- new_operation(name = "ChangeMessageVisibility", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ChangeMessageVisibilityBatch", 
...
{
    op <- new_operation(name = "CreateQueue", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteMessage", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteMessageBatch", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteQueue", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetQueueAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetQueueUrl", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListDeadLetterSourceQueues", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListQueueTags", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListQueues", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PurgeQueue", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ReceiveMessage", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RemovePermission", http_method = "POST", 
        http_path = "/", paginator = list())
...
send_message <- function (QueueUrl, MessageBody, DelaySeconds = NULL, 
    ...
    MessageGroupId = NULL) 
{
    op <- new_operation(name = "SendMessage", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "SendMessageBatch", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "SetQueueAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "TagQueue", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UntagQueue", http_method = "POST", 
        http_path = "/", paginator = list())
