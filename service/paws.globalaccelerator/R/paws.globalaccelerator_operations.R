...
create_accelerator <- function (Name, IpAddressType = NULL, Enabled = NULL, 
    IdempotencyToken) 
{
    op <- new_operation(name = "CreateAccelerator", http_method = "POST", 
...
create_endpoint_group <- function (ListenerArn, EndpointGroupRegion, 
    ...
    IdempotencyToken) 
{
    op <- new_operation(name = "CreateEndpointGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteAccelerator", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteEndpointGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeAccelerator", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeAcceleratorAttributes", 
...
{
    op <- new_operation(name = "DescribeEndpointGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeListener", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListAccelerators", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_endpoint_groups <- function (ListenerArn, MaxResults = NULL, 
    NextToken = NULL) 
{
    op <- new_operation(name = "ListEndpointGroups", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_listeners <- function (AcceleratorArn, MaxResults = NULL, 
    NextToken = NULL) 
{
    op <- new_operation(name = "ListListeners", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateAccelerator", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateAcceleratorAttributes", 
        http_method = "POST", http_path = "/", paginator = list())
...
update_endpoint_group <- function (EndpointGroupArn, EndpointConfigurations = NULL, 
    ...
    ThresholdCount = NULL) 
{
    op <- new_operation(name = "UpdateEndpointGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateListener", http_method = "POST", 
        http_path = "/", paginator = list())
