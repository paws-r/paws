...
{
    op <- Operation(name = "BatchSuspendUser", http_method = "POST", 
...
{
    op <- Operation(name = "BatchUnsuspendUser", http_method = "POST", 
...
{
    op <- Operation(name = "BatchUpdateUser", http_method = "POST", 
...
{
    op <- Operation(name = "DeleteAccount", http_method = "DELETE", 
...
{
    op <- Operation(name = "GetUser", http_method = "GET", http_path = "/console/accounts/{accountId}/users/{userId}", 
        paginator = list())
...
{
    op <- Operation(name = "InviteUsers", http_method = "POST", 
...
list_accounts <- function (Name = NULL, UserEmail = NULL, NextToken = NULL, 
    MaxResults = NULL) 
{
    op <- Operation(name = "ListAccounts", http_method = "GET", 
        http_path = "/console/accounts", paginator = list())
...
{
    op <- Operation(name = "LogoutUser", http_method = "POST", 
...
{
    op <- Operation(name = "ResetPersonalPIN", http_method = "POST", 
...
{
    op <- Operation(name = "UpdateAccount", http_method = "POST", 
        http_path = "/console/accounts/{accountId}", paginator = list())
...
{
    op <- Operation(name = "UpdateAccountSettings", http_method = "PUT", 
        http_path = "/console/accounts/{accountId}/settings", 
        paginator = list())
