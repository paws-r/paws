...
#'
#' @export
search <- function (cursor = NULL, expr = NULL, facet = NULL, 
    filterQuery = NULL, highlight = NULL, partial = NULL, query, 
    queryOptions = NULL, queryParser = NULL, return = NULL, size = NULL, 
    sort = NULL, start = NULL, stats = NULL) 
{
    op <- Operation(name = "Search", http_method = "GET", http_path = "/2013-01-01/search?format=sdk&pretty=true", 
        paginator = list())
    input <- search_input(cursor = cursor, expr = expr, facet = facet, 
        filterQuery = filterQuery, highlight = highlight, partial = partial, 
        query = query, queryOptions = queryOptions, queryParser = queryParser, 
