service <- function () 
{
    cfg <- client_config("appsync", list(`*` = "appsync.{region}.amazonaws.com", 
        `cn-*` = "appsync.{region}.amazonaws.com.cn"))
    client_info <- ClientInfo(service_name = "appsync", service_id = "AppSync", 
        api_version = "2017-07-25", signing_name = "appsync", 
