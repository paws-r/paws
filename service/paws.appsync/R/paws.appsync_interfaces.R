...
create_api_key_input <- function (...) 
{
    ...
    shape <- structure(list(apiId = structure(logical(0), tags = list(location = "uri", 
        ...
        tags = list(type = "string")), expires = structure(logical(0), 
...
create_data_source_input <- function (...) 
{
    ...
    shape <- structure(list(apiId = structure(logical(0), tags = list(location = "uri", 
        ...
        lambdaConfig = structure(list(lambdaFunctionArn = structure(logical(0), 
            tags = list(type = "string"))), tags = list(type = "structure")), 
        elasticsearchConfig = structure(list(endpoint = structure(logical(0), 
            tags = list(type = "string")), awsRegion = structure(logical(0), 
            tags = list(type = "string"))), tags = list(type = "structure")), 
...
create_graphql_api_input <- function (...) 
{
    ...
    shape <- structure(list(name = structure(logical(0), tags = list(type = "string")), 
        logConfig = structure(list(fieldLogLevel = structure(logical(0), 
            tags = list(type = "string", enum = c("NONE", "ERROR", 
                "ALL"))), cloudWatchLogsRoleArn = structure(logical(0), 
            tags = list(type = "string"))), tags = list(type = "structure")), 
        authenticationType = structure(logical(0), tags = list(type = "string", 
            enum = c("API_KEY", "AWS_IAM", "AMAZON_COGNITO_USER_POOLS", 
                "OPENID_CONNECT"))), userPoolConfig = structure(list(userPoolId = structure(logical(0), 
            tags = list(type = "string")), awsRegion = structure(logical(0), 
            tags = list(type = "string")), defaultAction = structure(logical(0), 
            tags = list(type = "string", enum = c("ALLOW", "DENY"))), 
            appIdClientRegex = structure(logical(0), tags = list(type = "string"))), 
            tags = list(type = "structure")), openIDConnectConfig = structure(list(issuer = structure(logical(0), 
            tags = list(type = "string")), clientId = structure(logical(0), 
            tags = list(type = "string")), iatTTL = structure(logical(0), 
            tags = list(type = "long")), authTTL = structure(logical(0), 
            tags = list(type = "long"))), tags = list(type = "structure"))), 
        tags = list(type = "structure"))
    return(populate(args, shape))
}
...
create_graphql_api_output <- function (...) 
{
    ...
    shape <- structure(list(graphqlApi = structure(list(name = structure(logical(0), 
        tags = list(type = "string", pattern = "[_A-Za-z][_0-9A-Za-z]*")), 
        apiId = structure(logical(0), tags = list(type = "string")), 
        authenticationType = structure(logical(0), tags = list(type = "string", 
            enum = c("API_KEY", "AWS_IAM", "AMAZON_COGNITO_USER_POOLS", 
                "OPENID_CONNECT"))), logConfig = structure(list(fieldLogLevel = structure(logical(0), 
            tags = list(type = "string", enum = c("NONE", "ERROR", 
                "ALL"))), cloudWatchLogsRoleArn = structure(logical(0), 
            tags = list(type = "string"))), tags = list(type = "structure")), 
        ...
        uris = structure(list(structure(logical(0), tags = list(type = "string"))), 
...
create_resolver_input <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(apiId = structure(logical(0), tags = list(location = "uri", 
        locationName = "apiId", type = "string")), typeName = structure(logical(0), 
        tags = list(location = "uri", locationName = "typeName", 
...
create_type_input <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(apiId = structure(logical(0), tags = list(location = "uri", 
        locationName = "apiId", type = "string")), definition = structure(logical(0), 
        tags = list(type = "string")), format = structure(logical(0), 
        tags = list(type = "string", enum = c("SDL", "JSON")))), 
        tags = list(type = "structure"))
    return(populate(args, shape))
}
...
create_type_output <- function (...) 
{
    ...
    shape <- structure(list(type = structure(list(name = structure(logical(0), 
        ...
        format = structure(logical(0), tags = list(type = "string", 
            enum = c("SDL", "JSON")))), tags = list(type = "structure"))), 
        tags = list(type = "structure"))
    return(populate(args, shape))
}
...
delete_api_key_input <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(apiId = structure(logical(0), tags = list(location = "uri", 
        locationName = "apiId", type = "string")), id = structure(logical(0), 
...
delete_data_source_input <- function (...) 
{
    ...
    shape <- structure(list(apiId = structure(logical(0), tags = list(location = "uri", 
        locationName = "apiId", type = "string")), name = structure(logical(0), 
        tags = list(location = "uri", locationName = "name", 
            type = "string", pattern = "[_A-Za-z][_0-9A-Za-z]*"))), 
        tags = list(type = "structure"))
    return(populate(args, shape))
}
...
delete_resolver_input <- function (...) 
{
    ...
    shape <- structure(list(apiId = structure(logical(0), tags = list(location = "uri", 
        ...
        tags = list(location = "uri", locationName = "typeName", 
            type = "string", pattern = "[_A-Za-z][_0-9A-Za-z]*")), 
        fieldName = structure(logical(0), tags = list(location = "uri", 
            locationName = "fieldName", type = "string", pattern = "[_A-Za-z][_0-9A-Za-z]*"))), 
        tags = list(type = "structure"))
    return(populate(args, shape))
}
...
get_introspection_schema_input <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(apiId = structure(logical(0), tags = list(location = "uri", 
        locationName = "apiId", type = "string")), format = structure(logical(0), 
        tags = list(location = "querystring", locationName = "format", 
            type = "string", enum = c("SDL", "JSON")))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(schema = structure(logical(0), tags = list(type = "blob"))), 
        tags = list(type = "structure", payload = "schema"))
    return(populate(args, shape))
}
...
get_schema_creation_status_output <- function (...) 
{
    ...
    shape <- structure(list(status = structure(logical(0), tags = list(type = "string", 
        enum = c("PROCESSING", "ACTIVE", "DELETING"))), details = structure(logical(0), 
        tags = list(type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
get_type_input <- function (...) 
{
    ...
    shape <- structure(list(apiId = structure(logical(0), tags = list(location = "uri", 
        ...
        format = structure(logical(0), tags = list(location = "querystring", 
            locationName = "format", type = "string", enum = c("SDL", 
...
list_types_input <- function (...) 
{
    ...
    shape <- structure(list(apiId = structure(logical(0), tags = list(location = "uri", 
        locationName = "apiId", type = "string")), format = structure(logical(0), 
        tags = list(location = "querystring", locationName = "format", 
            type = "string", enum = c("SDL", "JSON"))), nextToken = structure(logical(0), 
        tags = list(location = "querystring", locationName = "nextToken", 
            type = "string", pattern = "[\\\\S]+")), maxResults = structure(logical(0), 
        tags = list(location = "querystring", locationName = "maxResults", 
            type = "integer", max = 25L, min = 0L))), tags = list(type = "structure"))
...
start_schema_creation_output <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(status = structure(logical(0), tags = list(type = "string", 
        enum = c("PROCESSING", "ACTIVE", "DELETING")))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
update_api_key_input <- function (...) 
{
    ...
    shape <- structure(list(apiId = structure(logical(0), tags = list(location = "uri", 
        ...
        tags = list(location = "uri", locationName = "id", type = "string")), 
        description = structure(logical(0), tags = list(type = "string")), 
        expires = structure(logical(0), tags = list(type = "long"))), 
        tags = list(type = "structure"))
    return(populate(args, shape))
}
...
update_graphql_api_input <- function (...) 
{
    ...
    shape <- structure(list(apiId = structure(logical(0), tags = list(location = "uri", 
        locationName = "apiId", type = "string")), name = structure(logical(0), 
        tags = list(type = "string")), logConfig = structure(list(fieldLogLevel = structure(logical(0), 
        tags = list(type = "string", enum = c("NONE", "ERROR", 
            "ALL"))), cloudWatchLogsRoleArn = structure(logical(0), 
        tags = list(type = "string"))), tags = list(type = "structure")), 
        authenticationType = structure(logical(0), tags = list(type = "string", 
