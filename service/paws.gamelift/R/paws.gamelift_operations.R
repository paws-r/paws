...
#' -   StartMatchBackfill
#'
#' @param TicketId Unique identifier for a matchmaking ticket. The ticket must be in status `REQUIRES_ACCEPTANCE`; otherwise this request will fail.
#' @param PlayerIds Unique identifier for a player delivering the response. This parameter can include one or multiple player IDs.
#' @param AcceptanceType Player response to the proposed match.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "AcceptMatch", http_method = "POST", 
...
#'
#' @export
create_alias <- function (Name, RoutingStrategy, Description = NULL) 
{
    op <- Operation(name = "CreateAlias", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_alias_input(Name = Name, RoutingStrategy = RoutingStrategy, 
...
{
    op <- Operation(name = "CreateBuild", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param BuildId Unique identifier for a build to be deployed on the new fleet. The build must have been successfully uploaded to Amazon GameLift and be in a `READY` status. This fleet setting cannot be changed once the fleet is created.
...
#'
#' @export
create_fleet <- function (Name, BuildId, EC2InstanceType, Description = NULL, 
    ServerLaunchPath = NULL, ServerLaunchParameters = NULL, LogPaths = NULL, 
    EC2InboundPermissions = NULL, NewGameSessionProtectionPolicy = NULL, 
    ...
    FleetType = NULL) 
{
    op <- Operation(name = "CreateFleet", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_fleet_input(Name = Name, BuildId = BuildId, 
        EC2InstanceType = EC2InstanceType, Description = Description, 
        ServerLaunchPath = ServerLaunchPath, ServerLaunchParameters = ServerLaunchParameters, 
        LogPaths = LogPaths, EC2InboundPermissions = EC2InboundPermissions, 
...
#'
#' @export
create_game_session <- function (MaximumPlayerSessionCount, FleetId = NULL, 
    AliasId = NULL, Name = NULL, GameProperties = NULL, CreatorId = NULL, 
    GameSessionId = NULL, IdempotencyToken = NULL, GameSessionData = NULL) 
{
    op <- Operation(name = "CreateGameSession", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_game_session_input(MaximumPlayerSessionCount = MaximumPlayerSessionCount, 
        FleetId = FleetId, AliasId = AliasId, Name = Name, GameProperties = GameProperties, 
        CreatorId = CreatorId, GameSessionId = GameSessionId, 
        IdempotencyToken = IdempotencyToken, GameSessionData = GameSessionData)
...
#'
#' @param Name Descriptive label that is associated with game session queue. Queue names must be unique within each region.
...
{
    op <- Operation(name = "CreateGameSessionQueue", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @param Name Unique identifier for a matchmaking configuration. This name is used to identify the configuration associated with a matchmaking request or ticket.
...
#'
#' @export
create_matchmaking_configuration <- function (Name, GameSessionQueueArns, 
    RequestTimeoutSeconds, AcceptanceRequired, RuleSetName, Description = NULL, 
    AcceptanceTimeoutSeconds = NULL, NotificationTarget = NULL, 
    AdditionalPlayerCount = NULL, CustomEventData = NULL, GameProperties = NULL, 
    GameSessionData = NULL) 
{
    op <- Operation(name = "CreateMatchmakingConfiguration", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- create_matchmaking_configuration_input(Name = Name, 
        GameSessionQueueArns = GameSessionQueueArns, RequestTimeoutSeconds = RequestTimeoutSeconds, 
        AcceptanceRequired = AcceptanceRequired, RuleSetName = RuleSetName, 
        Description = Description, AcceptanceTimeoutSeconds = AcceptanceTimeoutSeconds, 
...
#' -   ValidateMatchmakingRuleSet
#'
#' @param Name Unique identifier for a matchmaking rule set. This name is used to identify the rule set associated with a matchmaking configuration.
#' @param RuleSetBody Collection of matchmaking rules, formatted as a JSON string. (Note that comments are not allowed in JSON, but most elements support a description field.)
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "CreateMatchmakingRuleSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'     -   StopGameSessionPlacement
#'
#' @param GameSessionId Unique identifier for the game session to add a player to.
#' @param PlayerId Unique identifier for a player. Player IDs are developer-defined.
...
{
    op <- Operation(name = "CreatePlayerSession", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'     -   StopGameSessionPlacement
#'
#' @param GameSessionId Unique identifier for the game session to add players to.
...
create_player_sessions <- function (GameSessionId, PlayerIds, 
    PlayerDataMap = NULL) 
{
    op <- Operation(name = "CreatePlayerSessions", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @param GameLiftAwsAccountId Unique identifier for the AWS account that you use to manage your Amazon GameLift fleet. You can find your Account ID in the AWS Management Console under account settings.
#' @param PeerVpcId Unique identifier for a VPC with resources to be accessed by your Amazon GameLift fleet. The VPC must be in the same region where your fleet is deployed. To get VPC information, including IDs, use the Virtual Private Cloud service tools, including the VPC Dashboard in the AWS Management Console.
#'
#' @examples
#'
...
create_vpc_peering_authorization <- function (GameLiftAwsAccountId, 
    PeerVpcId) 
{
    op <- Operation(name = "CreateVpcPeeringAuthorization", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' -   DeleteVpcPeeringConnection
#'
#' @param FleetId Unique identifier for a fleet. This tells Amazon GameLift which GameLift VPC to peer with.
#' @param PeerVpcAwsAccountId Unique identifier for the AWS account with the VPC that you want to peer your Amazon GameLift fleet with. You can find your Account ID in the AWS Management Console under account settings.
#' @param PeerVpcId Unique identifier for a VPC with resources to be accessed by your Amazon GameLift fleet. The VPC must be in the same region where your fleet is deployed. To get VPC information, including IDs, use the Virtual Private Cloud service tools, including the VPC Dashboard in the AWS Management Console.
#'
#' @examples
...
#' -   DeleteBuild
#'
#' @param BuildId Unique identifier for a build to delete.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "DeleteBuild", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'     -   StopFleetActions
#'
#' @param FleetId Unique identifier for a fleet to be deleted.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "DeleteGameSessionQueue", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' -   ValidateMatchmakingRuleSet
#'
#' @param Name Unique identifier for a matchmaking configuration
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "DeleteMatchmakingConfiguration", 
        http_method = "POST", http_path = "/", paginator = list())
...
#'     -   StopFleetActions
#'
#' @param Name Descriptive label that is associated with a scaling policy. Policy names do not need to be unique.
#' @param FleetId Unique identifier for a fleet to be deleted.
#'
#' @examples
#'
...
delete_vpc_peering_authorization <- function (GameLiftAwsAccountId, 
    PeerVpcId) 
{
    op <- Operation(name = "DeleteVpcPeeringAuthorization", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' -   DeleteVpcPeeringConnection
#'
#' @param FleetId Unique identifier for a fleet. This value must match the fleet ID referenced in the VPC peering connection record.
#' @param VpcPeeringConnectionId Unique identifier for a VPC peering connection. This value is included in the VpcPeeringConnection object, which can be retrieved by calling DescribeVpcPeeringConnections.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "DescribeAlias", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' -   DeleteBuild
#'
#' @param BuildId Unique identifier for a build to retrieve properties for.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "DescribeBuild", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeEC2InstanceLimits", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_fleet_attributes <- function (FleetIds = NULL, Limit = NULL, 
    NextToken = NULL) 
{
    op <- Operation(name = "DescribeFleetAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_fleet_capacity <- function (FleetIds = NULL, Limit = NULL, 
    NextToken = NULL) 
{
    op <- Operation(name = "DescribeFleetCapacity", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'     -   StopFleetActions
#'
#' @param FleetId Unique identifier for a fleet to get event logs for.
...
{
    op <- Operation(name = "DescribeFleetEvents", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'     -   StopFleetActions
#'
#' @param FleetId Unique identifier for a fleet to retrieve port settings for.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "DescribeFleetPortSettings", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_fleet_utilization <- function (FleetIds = NULL, Limit = NULL, 
    NextToken = NULL) 
{
    op <- Operation(name = "DescribeFleetUtilization", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeGameSessionDetails", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'     -   StopGameSessionPlacement
#'
#' @param PlacementId Unique identifier for a game session placement to retrieve.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "DescribeGameSessionPlacement", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_game_session_queues <- function (Names = NULL, Limit = NULL, 
    NextToken = NULL) 
{
    op <- Operation(name = "DescribeGameSessionQueues", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_game_sessions <- function (FleetId = NULL, GameSessionId = NULL, 
    AliasId = NULL, StatusFilter = NULL, Limit = NULL, NextToken = NULL) 
{
    op <- Operation(name = "DescribeGameSessions", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @param FleetId Unique identifier for a fleet to retrieve instance information for.
...
#' -   StartMatchBackfill
#'
#' @param TicketIds Unique identifier for a matchmaking ticket. You can include up to 10 ID values.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "DescribeMatchmaking", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeMatchmakingConfigurations", 
        http_method = "POST", http_path = "/", paginator = list())
...
describe_matchmaking_rule_sets <- function (Names = NULL, Limit = NULL, 
    NextToken = NULL) 
{
    op <- Operation(name = "DescribeMatchmakingRuleSets", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribePlayerSessions", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'     -   StopFleetActions
#'
#' @param FleetId Unique identifier for a fleet to get the run-time configuration for.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "DescribeRuntimeConfiguration", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'     -   StopFleetActions
#'
#' @param FleetId Unique identifier for a fleet to retrieve scaling policies for.
...
{
    op <- Operation(name = "DescribeVpcPeeringAuthorizations", 
        http_method = "POST", http_path = "/", paginator = list())
...
#'     -   StopGameSessionPlacement
#'
#' @param GameSessionId Unique identifier for the game session to get logs for.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "GetGameSessionLogUrl", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @param FleetId Unique identifier for a fleet that contains the instance you want access to. The fleet can be in any of the following statuses: `ACTIVATING`, `ACTIVE`, or `ERROR`. Fleets with an `ERROR` status may be accessible for a short time before they are deleted.
#' @param InstanceId Unique identifier for an instance you want to get access to. You can access an instance in any status.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "GetInstanceAccess", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'     -   StopFleetActions
#'
#' @param Name Descriptive label that is associated with a scaling policy. Policy names do not need to be unique. A fleet can have only one scaling policy with the same name.
#' @param FleetId Unique identifier for a fleet to apply this policy to. The fleet cannot be in any of the following statuses: ERROR or DELETING.
#' @param MetricName Name of the Amazon GameLift-defined metric that is used to trigger a scaling adjustment. For detailed descriptions of fleet metrics, see [Monitor Amazon GameLift with Amazon CloudWatch](http://docs.aws.amazon.com/gamelift/latest/developerguide/monitoring-cloudwatch.html).
#' 
...
#'
#' @export
put_scaling_policy <- function (Name, FleetId, MetricName, ScalingAdjustment = NULL, 
    ScalingAdjustmentType = NULL, Threshold = NULL, ComparisonOperator = NULL, 
    EvaluationPeriods = NULL, PolicyType = NULL, TargetConfiguration = NULL) 
{
    op <- Operation(name = "PutScalingPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- put_scaling_policy_input(Name = Name, FleetId = FleetId, 
        MetricName = MetricName, ScalingAdjustment = ScalingAdjustment, 
...
#'
#' @param BuildId Unique identifier for a build to get credentials for.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "RequestUploadCredentials", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ResolveAlias", http_method = "POST", 
        http_path = "/", paginator = list())
...
search_game_sessions <- function (FleetId = NULL, AliasId = NULL, 
    ...
    NextToken = NULL) 
{
    op <- Operation(name = "SearchGameSessions", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @param FleetId Unique identifier for a fleet
#' @param Actions List of actions to restart on the fleet.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "StartFleetActions", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'     -   StopGameSessionPlacement
#'
#' @param PlacementId Unique identifier to assign to the new game session placement. This value is developer-defined. The value must be unique across all regions and cannot be reused unless you are resubmitting a canceled or timed-out placement request.
#' @param GameSessionQueueName Name of the queue to use to place the new game session.
#' @param MaximumPlayerSessionCount Maximum number of players that can be connected simultaneously to the game session.
#' @param GameProperties Set of custom properties for a game session, formatted as key:value pairs. These properties are passed to a game server process in the GameSession object with a request to start a new game session (see [Start a Game Session](http://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift-sdk-server-api.html#gamelift-sdk-server-startsession)).
...
start_game_session_placement <- function (PlacementId, GameSessionQueueName, 
    MaximumPlayerSessionCount, GameProperties = NULL, GameSessionName = NULL, 
    PlayerLatencies = NULL, DesiredPlayerSessions = NULL, GameSessionData = NULL) 
{
    op <- Operation(name = "StartGameSessionPlacement", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- start_game_session_placement_input(PlacementId = PlacementId, 
        GameSessionQueueName = GameSessionQueueName, MaximumPlayerSessionCount = MaximumPlayerSessionCount, 
        GameProperties = GameProperties, GameSessionName = GameSessionName, 
        PlayerLatencies = PlayerLatencies, DesiredPlayerSessions = DesiredPlayerSessions, 
        GameSessionData = GameSessionData)
...
#' -   StartMatchBackfill
#'
#' @param ConfigurationName Name of the matchmaker to use for this request. The name of the matchmaker that was used with the original game session is listed in the GameSession object, `MatchmakerData` property. This property contains a matchmaking configuration ARN value, which includes the matchmaker name. (In the ARN value \"arn:aws:gamelift:us-west-2:111122223333:matchmakingconfiguration/MM-4v4\", the matchmaking configuration name is \"MM-4v4\".) Use only the name for this parameter.
#' @param GameSessionArn Amazon Resource Name ([ARN](http://docs.aws.amazon.com/AmazonS3/latest/dev/s3-arn-format.html)) that is assigned to a game session and uniquely identifies it.
...
#'
#' @export
start_match_backfill <- function (ConfigurationName, GameSessionArn, 
    Players, TicketId = NULL) 
{
    op <- Operation(name = "StartMatchBackfill", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- start_match_backfill_input(ConfigurationName = ConfigurationName, 
        GameSessionArn = GameSessionArn, Players = Players, TicketId = TicketId)
...
#' -   StartMatchBackfill
#'
#' @param ConfigurationName Name of the matchmaking configuration to use for this request. Matchmaking configurations must exist in the same region as this request.
...
#'
#' @export
start_matchmaking <- function (ConfigurationName, Players, TicketId = NULL) 
{
    op <- Operation(name = "StartMatchmaking", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- start_matchmaking_input(ConfigurationName = ConfigurationName, 
        Players = Players, TicketId = TicketId)
...
#'
#' @param FleetId Unique identifier for a fleet
#' @param Actions List of actions to suspend on the fleet.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "StopFleetActions", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'     -   StopGameSessionPlacement
#'
#' @param PlacementId Unique identifier for a game session placement to cancel.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "StopGameSessionPlacement", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' -   StartMatchBackfill
#'
#' @param TicketId Unique identifier for a matchmaking ticket.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "StopMatchmaking", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' -   DeleteBuild
#'
#' @param BuildId Unique identifier for a build to update.
...
{
    op <- Operation(name = "UpdateBuild", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'     -   StopFleetActions
#'
#' @param FleetId Unique identifier for a fleet to update attribute metadata for.
#' @param Name Descriptive label that is associated with a fleet. Fleet names do not need to be unique.
#' @param Description Human-readable description of a fleet.
...
update_fleet_attributes <- function (FleetId, Name = NULL, Description = NULL, 
    ...
    MetricGroups = NULL) 
{
    op <- Operation(name = "UpdateFleetAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'     -   StopFleetActions
#'
#' @param FleetId Unique identifier for a fleet to update capacity for.
...
{
    op <- Operation(name = "UpdateFleetCapacity", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'     -   StopFleetActions
#'
#' @param FleetId Unique identifier for a fleet to update port settings for.
...
{
    op <- Operation(name = "UpdateFleetPortSettings", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'     -   StopGameSessionPlacement
#'
#' @param GameSessionId Unique identifier for the game session to update.
#' @param MaximumPlayerSessionCount Maximum number of players that can be connected simultaneously to the game session.
#' @param Name Descriptive label that is associated with a game session. Session names do not need to be unique.
...
{
    op <- Operation(name = "UpdateGameSession", http_method = "POST", 
        http_path = "/", paginator = list())
...
update_game_session_queue <- function (Name, TimeoutInSeconds = NULL, 
    PlayerLatencyPolicies = NULL, Destinations = NULL) 
{
    op <- Operation(name = "UpdateGameSessionQueue", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' -   ValidateMatchmakingRuleSet
#'
#' @param Name Unique identifier for a matchmaking configuration to update.
...
{
    op <- Operation(name = "UpdateMatchmakingConfiguration", 
        http_method = "POST", http_path = "/", paginator = list())
...
#'     -   StopFleetActions
#'
#' @param FleetId Unique identifier for a fleet to update run-time configuration for.
...
{
    op <- Operation(name = "UpdateRuntimeConfiguration", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' -   ValidateMatchmakingRuleSet
#'
#' @param RuleSetBody Collection of matchmaking rules to validate, formatted as a JSON string.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "ValidateMatchmakingRuleSet", http_method = "POST", 
        http_path = "/", paginator = list())
