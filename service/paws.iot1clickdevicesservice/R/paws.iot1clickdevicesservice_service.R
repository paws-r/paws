service <- function () 
{
    cfg <- client_config("devices.iot1click", list(`*` = "devices.iot1click.{region}.amazonaws.com", 
        `cn-*` = "devices.iot1click.{region}.amazonaws.com.cn"))
    client_info <- ClientInfo(service_name = "devices.iot1click", 
        service_id = "IoT 1Click Devices Service", api_version = "2018-05-14", 
