...
#' @param type &#91;required&#93; &#91;Required&#93; The authorizer type. Valid values are `TOKEN` for a Lambda function using a single authorization token submitted in a custom header, `REQUEST` for a Lambda function using incoming request parameters, and `COGNITO_USER_POOLS` for using an Amazon Cognito user pool.
...
#'
#' @export
create_base_path_mapping <- function (domainName, basePath = NULL, 
    restApiId, stage = NULL) 
{
    op <- new_operation(name = "CreateBasePathMapping", http_method = "POST", 
...
#'
#' @param restApiId &#91;required&#93; &#91;Required&#93; The string identifier of the associated RestApi.
#' @param location &#91;required&#93; &#91;Required&#93; The location of the targeted API entity of the to-be-created documentation part.
#' @param properties &#91;required&#93; &#91;Required&#93; The new documentation content map of the targeted API entity. Enclosed key-value pairs are API-specific, but only OpenAPI-compliant key-value pairs can be exported and, hence, published.
#'
#' @export
create_documentation_part <- function (restApiId, location, properties) 
{
    op <- new_operation(name = "CreateDocumentationPart", http_method = "POST", 
...
{
    op <- new_operation(name = "CreateDocumentationVersion", 
        http_method = "POST", http_path = "/restapis/{restapi_id}/documentation/versions", 
        paginator = list())
...
#' ```
#'
#' @param restApiId &#91;required&#93; &#91;Required&#93; The RestApi identifier under which the Model will be created.
#' @param name &#91;required&#93; &#91;Required&#93; The name of the model. Must be alphanumeric.
#' @param description The description of the model.
#' @param schema The schema for the model. For `application/json` models, this should be [JSON schema draft 4](https://tools.ietf.org/html/draft-zyp-json-schema-04) model.
#' @param contentType &#91;required&#93; &#91;Required&#93; The content-type for the model.
#'
#' @export
create_model <- function (restApiId, name, description = NULL, 
    schema = NULL, contentType) 
{
    ...
    input <- create_model_input(restApiId = restApiId, name = name, 
        description = description, schema = schema, contentType = contentType)
...
{
    op <- new_operation(name = "CreateRequestValidator", http_method = "POST", 
...
{
    op <- new_operation(name = "CreateRestApi", http_method = "POST", 
...
#' @param deploymentId &#91;required&#93; &#91;Required&#93; The identifier of the Deployment resource for the Stage resource.
...
{
    op <- new_operation(name = "CreateUsagePlan", http_method = "POST", 
...
#' ```
#'
#' @param usagePlanId &#91;required&#93; &#91;Required&#93; The Id of the UsagePlan resource representing the usage plan containing the to-be-created UsagePlanKey resource representing a plan customer.
#' @param keyId &#91;required&#93; &#91;Required&#93; The identifier of a UsagePlanKey resource for a plan customer.
...
{
    op <- new_operation(name = "CreateUsagePlanKey", http_method = "POST", 
...
#' @param targetArns &#91;required&#93; &#91;Required&#93; The ARNs of network load balancers of the VPC targeted by the VPC link. The network load balancers must be owned by the same AWS account of the API owner.
#'
#' @export
create_vpc_link <- function (name, description = NULL, targetArns) 
{
    op <- new_operation(name = "CreateVpcLink", http_method = "POST", 
        http_path = "/vpclinks", paginator = list())
    input <- create_vpc_link_input(name = name, description = description, 
...
#' @param basePath &#91;required&#93; &#91;Required&#93; The base path name of the BasePathMapping resource to delete.
#'
#' @export
delete_base_path_mapping <- function (domainName, basePath) 
{
    op <- new_operation(name = "DeleteBasePathMapping", http_method = "DELETE", 
...
#' ```
#'
#' @param clientCertificateId &#91;required&#93; &#91;Required&#93; The identifier of the ClientCertificate resource to be deleted.
#'
#' @export
delete_client_certificate <- function (clientCertificateId) 
{
    op <- new_operation(name = "DeleteClientCertificate", http_method = "DELETE", 
...
{
    op <- new_operation(name = "DeleteDocumentationPart", http_method = "DELETE", 
...
#'
#' @param restApiId &#91;required&#93; &#91;Required&#93; The string identifier of the associated RestApi.
#' @param documentationVersion &#91;required&#93; &#91;Required&#93; The version identifier of a to-be-deleted documentation snapshot.
#'
#' @export
delete_documentation_version <- function (restApiId, documentationVersion) 
{
    op <- new_operation(name = "DeleteDocumentationVersion", 
        http_method = "DELETE", http_path = "/restapis/{restapi_id}/documentation/versions/{doc_version}", 
        paginator = list())
...
{
    op <- new_operation(name = "DeleteGatewayResponse", http_method = "DELETE", 
...
#'
#' @param restApiId &#91;required&#93; &#91;Required&#93; The string identifier of the associated RestApi.
#' @param resourceId &#91;required&#93; &#91;Required&#93; Specifies a delete integration request\'s resource identifier.
...
#'
#' @param restApiId &#91;required&#93; &#91;Required&#93; The string identifier of the associated RestApi.
#' @param resourceId &#91;required&#93; &#91;Required&#93; Specifies a delete integration response request\'s resource identifier.
#' @param httpMethod &#91;required&#93; &#91;Required&#93; Specifies a delete integration response request\'s HTTP method.
#' @param statusCode &#91;required&#93; &#91;Required&#93; Specifies a delete integration response request\'s status code.
#'
#' @export
...
{
    op <- new_operation(name = "DeleteMethod", http_method = "DELETE", 
...
delete_method_response <- function (restApiId, resourceId, httpMethod, 
    statusCode) 
{
    op <- new_operation(name = "DeleteMethodResponse", http_method = "DELETE", 
...
{
    op <- new_operation(name = "DeleteRequestValidator", http_method = "DELETE", 
...
{
    op <- new_operation(name = "DeleteResource", http_method = "DELETE", 
...
{
    op <- new_operation(name = "DeleteRestApi", http_method = "DELETE", 
...
{
    op <- new_operation(name = "DeleteUsagePlan", http_method = "DELETE", 
...
#' ```
#'
#' @param usagePlanId &#91;required&#93; &#91;Required&#93; The Id of the UsagePlan resource representing the usage plan containing the to-be-deleted UsagePlanKey resource representing a plan customer.
...
{
    op <- new_operation(name = "DeleteUsagePlanKey", http_method = "DELETE", 
...
#' ```
#'
#' @param vpcLinkId &#91;required&#93; &#91;Required&#93; The identifier of the VpcLink. It is used in an Integration to reference this VpcLink.
#'
#' @export
delete_vpc_link <- function (vpcLinkId) 
{
    op <- new_operation(name = "DeleteVpcLink", http_method = "DELETE", 
...
{
    op <- new_operation(name = "FlushStageAuthorizersCache", 
        http_method = "DELETE", http_path = "/restapis/{restapi_id}/stages/{stage_name}/cache/authorizers", 
        paginator = list())
...
{
    op <- new_operation(name = "FlushStageCache", http_method = "DELETE", 
...
{
    op <- new_operation(name = "GenerateClientCertificate", http_method = "POST", 
...
{
    op <- new_operation(name = "GetApiKey", http_method = "GET", 
        http_path = "/apikeys/{api_Key}", paginator = list())
...
{
    op <- new_operation(name = "GetApiKeys", http_method = "GET", 
        http_path = "/apikeys", paginator = list())
...
#' ```
#'
#' @param domainName &#91;required&#93; &#91;Required&#93; The domain name of the BasePathMapping resource to be described.
#' @param basePath &#91;required&#93; &#91;Required&#93; The base path name that callers of the API must provide as part of the URL after the domain name. This value must be unique for all of the mappings across a single API. Leave this blank if you do not want callers to specify any base path name after the domain name.
#'
#' @export
get_base_path_mapping <- function (domainName, basePath) 
{
    op <- new_operation(name = "GetBasePathMapping", http_method = "GET", 
        http_path = "/domainnames/{domain_name}/basepathmappings/{base_path}", 
        paginator = list())
...
get_base_path_mappings <- function (domainName, position = NULL, 
    limit = NULL) 
{
    op <- new_operation(name = "GetBasePathMappings", http_method = "GET", 
        http_path = "/domainnames/{domain_name}/basepathmappings", 
        paginator = list())
...
#' ```
#'
#' @param clientCertificateId &#91;required&#93; &#91;Required&#93; The identifier of the ClientCertificate resource to be described.
#'
#' @export
get_client_certificate <- function (clientCertificateId) 
{
    op <- new_operation(name = "GetClientCertificate", http_method = "GET", 
        http_path = "/clientcertificates/{clientcertificate_id}", 
        paginator = list())
...
{
    op <- new_operation(name = "GetClientCertificates", http_method = "GET", 
        http_path = "/clientcertificates", paginator = list())
...
#'
#' @param restApiId &#91;required&#93; &#91;Required&#93; The string identifier of the associated RestApi.
#' @param deploymentId &#91;required&#93; &#91;Required&#93; The identifier of the Deployment resource to get information about.
...
{
    op <- new_operation(name = "GetDocumentationPart", http_method = "GET", 
        http_path = "/restapis/{restapi_id}/documentation/parts/{part_id}", 
        paginator = list())
...
get_documentation_parts <- function (restApiId, type = NULL, 
    ...
    locationStatus = NULL) 
{
    op <- new_operation(name = "GetDocumentationParts", http_method = "GET", 
        http_path = "/restapis/{restapi_id}/documentation/parts", 
        paginator = list())
...
#'
#' @param restApiId &#91;required&#93; &#91;Required&#93; The string identifier of the associated RestApi.
#' @param documentationVersion &#91;required&#93; &#91;Required&#93; The version identifier of the to-be-retrieved documentation snapshot.
#'
#' @export
get_documentation_version <- function (restApiId, documentationVersion) 
{
    op <- new_operation(name = "GetDocumentationVersion", http_method = "GET", 
...
get_documentation_versions <- function (restApiId, position = NULL, 
    limit = NULL) 
{
    op <- new_operation(name = "GetDocumentationVersions", http_method = "GET", 
...
#' @param exportType &#91;required&#93; &#91;Required&#93; The type of export. Acceptable values are \'oas30\' for OpenAPI 3.0.x and \'swagger\' for Swagger/OpenAPI 2.0.
...
{
    op <- new_operation(name = "GetGatewayResponse", http_method = "GET", 
        http_path = "/restapis/{restapi_id}/gatewayresponses/{response_type}", 
        paginator = list())
...
get_gateway_responses <- function (restApiId, position = NULL, 
    limit = NULL) 
{
    op <- new_operation(name = "GetGatewayResponses", http_method = "GET", 
...
#'
#' @param restApiId &#91;required&#93; &#91;Required&#93; The string identifier of the associated RestApi.
#' @param resourceId &#91;required&#93; &#91;Required&#93; Specifies a get integration response request\'s resource identifier.
...
{
    op <- new_operation(name = "GetMethod", http_method = "GET", 
        http_path = "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}", 
        paginator = list())
...
get_method_response <- function (restApiId, resourceId, httpMethod, 
    statusCode) 
{
    op <- new_operation(name = "GetMethodResponse", http_method = "GET", 
        http_path = "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}/responses/{status_code}", 
        paginator = list())
...
{
    op <- new_operation(name = "GetRequestValidator", http_method = "GET", 
        http_path = "/restapis/{restapi_id}/requestvalidators/{requestvalidator_id}", 
        paginator = list())
...
get_request_validators <- function (restApiId, position = NULL, 
    limit = NULL) 
{
    op <- new_operation(name = "GetRequestValidators", http_method = "GET", 
        http_path = "/restapis/{restapi_id}/requestvalidators", 
        paginator = list())
...
{
    op <- new_operation(name = "GetResource", http_method = "GET", 
        http_path = "/restapis/{restapi_id}/resources/{resource_id}", 
        paginator = list())
...
{
    op <- new_operation(name = "GetRestApi", http_method = "GET", 
        http_path = "/restapis/{restapi_id}", paginator = list())
...
{
    op <- new_operation(name = "GetRestApis", http_method = "GET", 
        http_path = "/restapis", paginator = list())
...
#' @param sdkType &#91;required&#93; &#91;Required&#93; The language for the generated SDK. Currently `java`, `javascript`, `android`, `objectivec` (for iOS), `swift` (for iOS), and `ruby` are supported.
...
{
    op <- new_operation(name = "GetSdk", http_method = "GET", 
...
{
    op <- new_operation(name = "GetSdkType", http_method = "GET", 
...
{
    op <- new_operation(name = "GetSdkTypes", http_method = "GET", 
...
#' ```
#'
#' @param resourceArn &#91;required&#93; &#91;Required&#93; The ARN of a resource that can be tagged. The resource ARN must be URL-encoded. At present, Stage is the only taggable resource.
...
#'
#' @export
get_usage <- function (usagePlanId, keyId = NULL, startDate, 
    endDate, position = NULL, limit = NULL) 
{
    op <- new_operation(name = "GetUsage", http_method = "GET", 
        http_path = "/usageplans/{usageplanId}/usage", paginator = list())
    input <- get_usage_input(usagePlanId = usagePlanId, keyId = keyId, 
        startDate = startDate, endDate = endDate, position = position, 
        limit = limit)
...
{
    op <- new_operation(name = "GetUsagePlan", http_method = "GET", 
        http_path = "/usageplans/{usageplanId}", paginator = list())
...
#' ```
#'
#' @param usagePlanId &#91;required&#93; &#91;Required&#93; The Id of the UsagePlan resource representing the usage plan containing the to-be-retrieved UsagePlanKey resource representing a plan customer.
#' @param keyId &#91;required&#93; &#91;Required&#93; The key Id of the to-be-retrieved UsagePlanKey resource representing a plan customer.
#'
#' @export
get_usage_plan_key <- function (usagePlanId, keyId) 
{
    op <- new_operation(name = "GetUsagePlanKey", http_method = "GET", 
        http_path = "/usageplans/{usageplanId}/keys/{keyId}", 
        paginator = list())
...
{
    op <- new_operation(name = "GetUsagePlanKeys", http_method = "GET", 
        http_path = "/usageplans/{usageplanId}/keys", paginator = list())
...
{
    op <- new_operation(name = "GetUsagePlans", http_method = "GET", 
        http_path = "/usageplans", paginator = list())
...
{
    op <- new_operation(name = "GetVpcLink", http_method = "GET", 
        http_path = "/vpclinks/{vpclink_id}", paginator = list())
...
{
    op <- new_operation(name = "GetVpcLinks", http_method = "GET", 
        http_path = "/vpclinks", paginator = list())
...
#' ```
#'
#' @param body &#91;required&#93; The payload of the POST request to import API keys. For the payload format, see [API Key File Format](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-key-file-format.html).
...
{
    op <- new_operation(name = "ImportApiKeys", http_method = "POST", 
...
#' @param body &#91;required&#93; &#91;Required&#93; Raw byte array representing the to-be-imported documentation parts. To import from an OpenAPI file, this is a JSON object.
#'
#' @export
import_documentation_parts <- function (restApiId, mode = NULL, 
    failOnWarnings = NULL, body) 
{
    op <- new_operation(name = "ImportDocumentationParts", http_method = "PUT", 
        http_path = "/restapis/{restapi_id}/documentation/parts", 
        paginator = list())
    input <- import_documentation_parts_input(restApiId = restApiId, 
        mode = mode, failOnWarnings = failOnWarnings, body = body)
...
#' @param body &#91;required&#93; &#91;Required&#93; The POST request body containing external API definitions. Currently, only OpenAPI definition JSON/YAML files are supported. The maximum size of the API definition file is 2MB.
#'
#' @export
import_rest_api <- function (failOnWarnings = NULL, parameters = NULL, 
    body) 
{
    op <- new_operation(name = "ImportRestApi", http_method = "POST", 
        http_path = "/restapis?mode=import", paginator = list())
    input <- import_rest_api_input(failOnWarnings = failOnWarnings, 
...
{
    op <- new_operation(name = "PutGatewayResponse", http_method = "PUT", 
        http_path = "/restapis/{restapi_id}/gatewayresponses/{response_type}", 
        paginator = list())
...
#' @param connectionId The ([`id`](https://docs.aws.amazon.com/apigateway/api-reference/resource/vpc-link/#id)) of the VpcLink used for the integration when `connectionType=VPC_LINK` and undefined, otherwise.
...
{
    op <- new_operation(name = "PutIntegration", http_method = "PUT", 
        http_path = "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}/integration", 
        paginator = list())
...
#'
#' @param restApiId &#91;required&#93; &#91;Required&#93; The string identifier of the associated RestApi.
#' @param resourceId &#91;required&#93; &#91;Required&#93; Specifies a put integration response request\'s resource identifier.
#' @param httpMethod &#91;required&#93; &#91;Required&#93; Specifies a put integration response request\'s HTTP method.
#' @param statusCode &#91;required&#93; &#91;Required&#93; Specifies the status code that is used to map the integration response to an existing MethodResponse.
...
{
    op <- new_operation(name = "PutIntegrationResponse", http_method = "PUT", 
        http_path = "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}/integration/responses/{status_code}", 
        paginator = list())
...
#' @param httpMethod &#91;required&#93; &#91;Required&#93; Specifies the method request\'s HTTP method type.
#' @param authorizationType &#91;required&#93; &#91;Required&#93; The method\'s authorization type. Valid values are `NONE` for open access, `AWS_IAM` for using AWS IAM permissions, `CUSTOM` for using a custom authorizer, or `COGNITO_USER_POOLS` for using a Cognito user pool.
...
#' @param operationName A human-friendly operation identifier for the method. For example, you can assign the `operationName` of `ListPets` for the `GET /pets` method in [PetStore](https://petstore-demo-endpoint.execute-api.com/petstore/pets) example.
...
{
    op <- new_operation(name = "PutMethod", http_method = "PUT", 
        http_path = "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}", 
        paginator = list())
...
{
    op <- new_operation(name = "PutMethodResponse", http_method = "PUT", 
        http_path = "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}/responses/{status_code}", 
        paginator = list())
...
#' @param body &#91;required&#93; &#91;Required&#93; The PUT request body containing external API definitions. Currently, only OpenAPI definition JSON/YAML files are supported. The maximum size of the API definition file is 2MB.
#'
#' @export
put_rest_api <- function (restApiId, mode = NULL, failOnWarnings = NULL, 
    parameters = NULL, body) 
{
    op <- new_operation(name = "PutRestApi", http_method = "PUT", 
        http_path = "/restapis/{restapi_id}", paginator = list())
    input <- put_rest_api_input(restApiId = restApiId, mode = mode, 
        failOnWarnings = failOnWarnings, parameters = parameters, 
        body = body)
...
#'
#' @param resourceArn &#91;required&#93; &#91;Required&#93; The ARN of a resource that can be tagged. The resource ARN must be URL-encoded. At present, Stage is the only taggable resource.
#' @param tags &#91;required&#93; &#91;Required&#93; The key-value map of strings. The valid character set is &#91;a-zA-Z+-=.\_:/&#93;. The tag key can be up to 128 characters and must not start with `aws:`. The tag value can be up to 256 characters.
#'
#' @export
...
{
    op <- new_operation(name = "TestInvokeMethod", http_method = "POST", 
        http_path = "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}", 
        paginator = list())
...
{
    op <- new_operation(name = "UpdateAccount", http_method = "PATCH", 
        http_path = "/account", paginator = list())
...
{
    op <- new_operation(name = "UpdateApiKey", http_method = "PATCH", 
        http_path = "/apikeys/{api_Key}", paginator = list())
...
{
    op <- new_operation(name = "UpdateBasePathMapping", http_method = "PATCH", 
        http_path = "/domainnames/{domain_name}/basepathmappings/{base_path}", 
        paginator = list())
...
#' ```
#'
#' @param clientCertificateId &#91;required&#93; &#91;Required&#93; The identifier of the ClientCertificate resource to be updated.
#' @param patchOperations A list of update operations to be applied to the specified resource and in the order specified in this list.
#'
#' @export
update_client_certificate <- function (clientCertificateId, patchOperations = NULL) 
{
    op <- new_operation(name = "UpdateClientCertificate", http_method = "PATCH", 
        http_path = "/clientcertificates/{clientcertificate_id}", 
        paginator = list())
...
{
    op <- new_operation(name = "UpdateDocumentationPart", http_method = "PATCH", 
        http_path = "/restapis/{restapi_id}/documentation/parts/{part_id}", 
        paginator = list())
...
#'
#' @param restApiId &#91;required&#93; &#91;Required&#93; The string identifier of the associated RestApi..
#' @param documentationVersion &#91;required&#93; &#91;Required&#93; The version identifier of the to-be-updated documentation version.
#' @param patchOperations A list of update operations to be applied to the specified resource and in the order specified in this list.
#'
#' @export
update_documentation_version <- function (restApiId, documentationVersion, 
    patchOperations = NULL) 
{
    op <- new_operation(name = "UpdateDocumentationVersion", 
        http_method = "PATCH", http_path = "/restapis/{restapi_id}/documentation/versions/{doc_version}", 
        paginator = list())
...
update_gateway_response <- function (restApiId, responseType, 
    patchOperations = NULL) 
{
    op <- new_operation(name = "UpdateGatewayResponse", http_method = "PATCH", 
        http_path = "/restapis/{restapi_id}/gatewayresponses/{response_type}", 
        paginator = list())
...
#'
#' @param restApiId &#91;required&#93; &#91;Required&#93; The string identifier of the associated RestApi.
#' @param resourceId &#91;required&#93; &#91;Required&#93; Represents an update integration request\'s resource identifier.
...
#'
#' @param restApiId &#91;required&#93; &#91;Required&#93; The string identifier of the associated RestApi.
#' @param resourceId &#91;required&#93; &#91;Required&#93; Specifies an update integration response request\'s resource identifier.
#' @param httpMethod &#91;required&#93; &#91;Required&#93; Specifies an update integration response request\'s HTTP method.
#' @param statusCode &#91;required&#93; &#91;Required&#93; Specifies an update integration response request\'s status code.
#' @param patchOperations A list of update operations to be applied to the specified resource and in the order specified in this list.
#'
#' @export
...
update_method <- function (restApiId, resourceId, httpMethod, 
    patchOperations = NULL) 
{
    op <- new_operation(name = "UpdateMethod", http_method = "PATCH", 
        http_path = "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}", 
        paginator = list())
...
{
    op <- new_operation(name = "UpdateMethodResponse", http_method = "PATCH", 
        http_path = "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}/responses/{status_code}", 
        paginator = list())
...
update_request_validator <- function (restApiId, requestValidatorId, 
    patchOperations = NULL) 
{
    op <- new_operation(name = "UpdateRequestValidator", http_method = "PATCH", 
        http_path = "/restapis/{restapi_id}/requestvalidators/{requestvalidator_id}", 
        paginator = list())
...
{
    op <- new_operation(name = "UpdateResource", http_method = "PATCH", 
        http_path = "/restapis/{restapi_id}/resources/{resource_id}", 
        paginator = list())
...
{
    op <- new_operation(name = "UpdateRestApi", http_method = "PATCH", 
        http_path = "/restapis/{restapi_id}", paginator = list())
...
#'
#' @param usagePlanId &#91;required&#93; &#91;Required&#93; The Id of the usage plan associated with the usage data.
#' @param keyId &#91;required&#93; &#91;Required&#93; The identifier of the API key associated with the usage plan in which a temporary extension is granted to the remaining quota.
#' @param patchOperations A list of update operations to be applied to the specified resource and in the order specified in this list.
#'
#' @export
update_usage <- function (usagePlanId, keyId, patchOperations = NULL) 
{
    op <- new_operation(name = "UpdateUsage", http_method = "PATCH", 
...
{
    op <- new_operation(name = "UpdateUsagePlan", http_method = "PATCH", 
        http_path = "/usageplans/{usageplanId}", paginator = list())
...
{
    op <- new_operation(name = "UpdateVpcLink", http_method = "PATCH", 
        http_path = "/vpclinks/{vpclink_id}", paginator = list())
