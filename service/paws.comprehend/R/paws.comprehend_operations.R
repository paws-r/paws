...
create_document_classifier <- function (DocumentClassifierName, 
    ...
    LanguageCode) 
{
    op <- Operation(name = "CreateDocumentClassifier", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "CreateEntityRecognizer", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteDocumentClassifier", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteEntityRecognizer", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeDocumentClassificationJob", 
...
{
    op <- Operation(name = "DescribeDocumentClassifier", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeEntityRecognizer", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListDocumentClassificationJobs", 
        http_method = "POST", http_path = "/", paginator = list())
...
list_document_classifiers <- function (Filter = NULL, NextToken = NULL, 
    MaxResults = NULL) 
{
    op <- Operation(name = "ListDocumentClassifiers", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_entity_recognizers <- function (Filter = NULL, NextToken = NULL, 
    MaxResults = NULL) 
{
    op <- Operation(name = "ListEntityRecognizers", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "StartDocumentClassificationJob", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- Operation(name = "StopTrainingDocumentClassifier", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- Operation(name = "StopTrainingEntityRecognizer", http_method = "POST", 
        http_path = "/", paginator = list())
