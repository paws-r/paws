...
accept_qualification_request <- function (QualificationRequestId, 
    IntegerValue = NULL) 
{
    op <- new_operation(name = "AcceptQualificationRequest", 
...
{
    op <- new_operation(name = "ApproveAssignment", http_method = "POST", 
...
{
    op <- new_operation(name = "AssociateQualificationWithWorker", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateAdditionalAssignmentsForHIT", 
        http_method = "POST", http_path = "/", paginator = list())
...
#'
#' @export
create_hit <- function (MaxAssignments = NULL, AutoApprovalDelayInSeconds = NULL, 
    LifetimeInSeconds, AssignmentDurationInSeconds, Reward, Title, 
    Keywords = NULL, Description, Question = NULL, RequesterAnnotation = NULL, 
...
{
    op <- new_operation(name = "CreateHIT", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_hit_input(MaxAssignments = MaxAssignments, 
        AutoApprovalDelayInSeconds = AutoApprovalDelayInSeconds, 
        LifetimeInSeconds = LifetimeInSeconds, AssignmentDurationInSeconds = AssignmentDurationInSeconds, 
        Reward = Reward, Title = Title, Keywords = Keywords, 
        Description = Description, Question = Question, RequesterAnnotation = RequesterAnnotation, 
...
#'
#' @export
create_hit_type <- function (AutoApprovalDelayInSeconds = NULL, 
    AssignmentDurationInSeconds, Reward, Title, Keywords = NULL, 
    Description, QualificationRequirements = NULL) 
{
    op <- new_operation(name = "CreateHITType", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_hit_type_input(AutoApprovalDelayInSeconds = AutoApprovalDelayInSeconds, 
        AssignmentDurationInSeconds = AssignmentDurationInSeconds, 
        Reward = Reward, Title = Title, Keywords = Keywords, 
        Description = Description, QualificationRequirements = QualificationRequirements)
...
#'
#' @export
create_hit_with_hit_type <- function (HITTypeId, MaxAssignments = NULL, 
    LifetimeInSeconds, Question = NULL, RequesterAnnotation = NULL, 
    UniqueRequestToken = NULL, AssignmentReviewPolicy = NULL, 
    HITReviewPolicy = NULL, HITLayoutId = NULL, HITLayoutParameters = NULL) 
{
    op <- new_operation(name = "CreateHITWithHITType", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_hit_with_hit_type_input(HITTypeId = HITTypeId, 
        MaxAssignments = MaxAssignments, LifetimeInSeconds = LifetimeInSeconds, 
...
#'
#' @export
create_qualification_type <- function (Name, Keywords = NULL, 
    Description, QualificationTypeStatus, RetryDelayInSeconds = NULL, 
    Test = NULL, AnswerKey = NULL, TestDurationInSeconds = NULL, 
    AutoGranted = NULL, AutoGrantedValue = NULL) 
{
    op <- new_operation(name = "CreateQualificationType", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_qualification_type_input(Name = Name, Keywords = Keywords, 
...
{
    op <- new_operation(name = "CreateWorkerBlock", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteHIT", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteQualificationType", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteWorkerBlock", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DisassociateQualificationFromWorker", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetAccountBalance", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetAssignment", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetFileUploadURL", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetHIT", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetQualificationScore", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetQualificationType", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListAssignmentsForHIT", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListBonusPayments", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListHITs", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_hi_ts_for_qualification_type <- function (QualificationTypeId, 
    NextToken = NULL, MaxResults = NULL) 
{
    op <- new_operation(name = "ListHITsForQualificationType", 
        http_method = "POST", http_path = "/", paginator = list())
...
list_qualification_requests <- function (QualificationTypeId = NULL, 
    NextToken = NULL, MaxResults = NULL) 
{
    op <- new_operation(name = "ListQualificationRequests", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
list_qualification_types <- function (Query = NULL, MustBeRequestable, 
    MustBeOwnedByCaller = NULL, NextToken = NULL, MaxResults = NULL) 
{
    op <- new_operation(name = "ListQualificationTypes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_qualification_types_input(Query = Query, MustBeRequestable = MustBeRequestable, 
        MustBeOwnedByCaller = MustBeOwnedByCaller, NextToken = NextToken, 
...
list_review_policy_results_for_hit <- function (HITId, PolicyLevels = NULL, 
    ...
    MaxResults = NULL) 
{
    op <- new_operation(name = "ListReviewPolicyResultsForHIT", 
        http_method = "POST", http_path = "/", paginator = list())
...
list_reviewable_hi_ts <- function (HITTypeId = NULL, Status = NULL, 
    NextToken = NULL, MaxResults = NULL) 
{
    op <- new_operation(name = "ListReviewableHITs", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListWorkerBlocks", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListWorkersWithQualificationType", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "NotifyWorkers", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RejectAssignment", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param QualificationRequestId &#91;required&#93; The ID of the Qualification request, as returned by the `ListQualificationRequests` operation.
...
reject_qualification_request <- function (QualificationRequestId, 
    Reason = NULL) 
{
    op <- new_operation(name = "RejectQualificationRequest", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "SendBonus", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "SendTestEventNotification", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'   HITId = "string",
#'   ExpireAt = as.POSIXct("2015-01-01")
#' )
#' ```
#'
...
{
    op <- new_operation(name = "UpdateExpirationForHIT", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateHITReviewStatus", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateHITTypeOfHIT", http_method = "POST", 
        http_path = "/", paginator = list())
...
update_notification_settings <- function (HITTypeId, Notification = NULL, 
    Active = NULL) 
{
    op <- new_operation(name = "UpdateNotificationSettings", 
        http_method = "POST", http_path = "/", paginator = list())
...
update_qualification_type <- function (QualificationTypeId, Description = NULL, 
    ...
    AutoGranted = NULL, AutoGrantedValue = NULL) 
{
    op <- new_operation(name = "UpdateQualificationType", http_method = "POST", 
        http_path = "/", paginator = list())
