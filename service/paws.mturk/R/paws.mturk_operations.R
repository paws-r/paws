...
#'
#' @param QualificationRequestId The ID of the Qualification request, as returned by the `GetQualificationRequests` operation.
...
#'
#' @export
accept_qualification_request <- function (QualificationRequestId, 
    IntegerValue = NULL) 
{
    op <- Operation(name = "AcceptQualificationRequest", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- accept_qualification_request_input(QualificationRequestId = QualificationRequestId, 
        IntegerValue = IntegerValue)
    output <- accept_qualification_request_output()
    svc <- service()
...
#'
#' @param AssignmentId The ID of the assignment. The assignment must correspond to a HIT created by the Requester.
...
#'
#' @export
approve_assignment <- function (AssignmentId, RequesterFeedback = NULL, 
    OverrideRejection = NULL) 
{
    op <- Operation(name = "ApproveAssignment", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- approve_assignment_input(AssignmentId = AssignmentId, 
        RequesterFeedback = RequesterFeedback, OverrideRejection = OverrideRejection)
    output <- approve_assignment_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param QualificationTypeId The ID of the Qualification type to use for the assigned Qualification.
#' @param WorkerId The ID of the Worker to whom the Qualification is being assigned. Worker IDs are included with submitted HIT assignments and Qualification requests.
...
#'
#' @export
associate_qualification_with_worker <- function (QualificationTypeId, 
    WorkerId, IntegerValue = NULL, SendNotification = NULL) 
{
    op <- Operation(name = "AssociateQualificationWithWorker", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- associate_qualification_with_worker_input(QualificationTypeId = QualificationTypeId, 
        WorkerId = WorkerId, IntegerValue = IntegerValue, SendNotification = SendNotification)
    output <- associate_qualification_with_worker_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param HITId The ID of the HIT to extend.
...
#'
#' @export
create_additional_assignments_for_hit <- function (HITId, NumberOfAdditionalAssignments, 
    UniqueRequestToken = NULL) 
{
    op <- Operation(name = "CreateAdditionalAssignmentsForHIT", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- create_additional_assignments_for_hit_input(HITId = HITId, 
        NumberOfAdditionalAssignments = NumberOfAdditionalAssignments, 
        UniqueRequestToken = UniqueRequestToken)
    output <- create_additional_assignments_for_hit_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param LifetimeInSeconds An amount of time, in seconds, after which the HIT is no longer available for users to accept. After the lifetime of the HIT elapses, the HIT no longer appears in HIT searches, even if not all of the assignments for the HIT have been accepted.
#' @param AssignmentDurationInSeconds The amount of time, in seconds, that a Worker has to complete the HIT after accepting it. If a Worker does not complete the assignment within the specified duration, the assignment is considered abandoned. If the HIT is still active (that is, its lifetime has not elapsed), the assignment becomes available for other users to find and accept.
#' @param Reward The amount of money the Requester will pay a Worker for successfully completing the HIT.
...
#'
#' @export
create_hit <- function (LifetimeInSeconds, AssignmentDurationInSeconds, 
    Reward, Title, Description, MaxAssignments = NULL, AutoApprovalDelayInSeconds = NULL, 
    Keywords = NULL, Question = NULL, RequesterAnnotation = NULL, 
    QualificationRequirements = NULL, UniqueRequestToken = NULL, 
    AssignmentReviewPolicy = NULL, HITReviewPolicy = NULL, HITLayoutId = NULL, 
    HITLayoutParameters = NULL) 
{
    op <- Operation(name = "CreateHIT", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_hit_input(LifetimeInSeconds = LifetimeInSeconds, 
        AssignmentDurationInSeconds = AssignmentDurationInSeconds, 
        Reward = Reward, Title = Title, Description = Description, 
        MaxAssignments = MaxAssignments, AutoApprovalDelayInSeconds = AutoApprovalDelayInSeconds, 
        Keywords = Keywords, Question = Question, RequesterAnnotation = RequesterAnnotation, 
        QualificationRequirements = QualificationRequirements, 
        UniqueRequestToken = UniqueRequestToken, AssignmentReviewPolicy = AssignmentReviewPolicy, 
        HITReviewPolicy = HITReviewPolicy, HITLayoutId = HITLayoutId, 
        HITLayoutParameters = HITLayoutParameters)
    output <- create_hit_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
create_hit_type <- function (AssignmentDurationInSeconds, Reward, 
    Title, Description, AutoApprovalDelayInSeconds = NULL, Keywords = NULL, 
    QualificationRequirements = NULL) 
{
    op <- Operation(name = "CreateHITType", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_hit_type_input(AssignmentDurationInSeconds = AssignmentDurationInSeconds, 
        Reward = Reward, Title = Title, Description = Description, 
        AutoApprovalDelayInSeconds = AutoApprovalDelayInSeconds, 
        Keywords = Keywords, QualificationRequirements = QualificationRequirements)
    output <- create_hit_type_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' If a HIT is created with 10 or more maximum assignments, there is an additional fee. For more information, see [Amazon Mechanical Turk Pricing](https://requester.mturk.com/pricing).
#'
#' @param HITTypeId The HIT type ID you want to create this HIT with.
#' @param LifetimeInSeconds An amount of time, in seconds, after which the HIT is no longer available for users to accept. After the lifetime of the HIT elapses, the HIT no longer appears in HIT searches, even if not all of the assignments for the HIT have been accepted.
#' @param MaxAssignments The number of times the HIT can be accepted and completed before the HIT becomes unavailable.
#' @param Question The data the person completing the HIT uses to produce the results.
#' 
...
#'
#' @export
create_hit_with_hit_type <- function (HITTypeId, LifetimeInSeconds, 
    MaxAssignments = NULL, Question = NULL, RequesterAnnotation = NULL, 
    UniqueRequestToken = NULL, AssignmentReviewPolicy = NULL, 
    HITReviewPolicy = NULL, HITLayoutId = NULL, HITLayoutParameters = NULL) 
{
    op <- Operation(name = "CreateHITWithHITType", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_hit_with_hit_type_input(HITTypeId = HITTypeId, 
        LifetimeInSeconds = LifetimeInSeconds, MaxAssignments = MaxAssignments, 
        Question = Question, RequesterAnnotation = RequesterAnnotation, 
        UniqueRequestToken = UniqueRequestToken, AssignmentReviewPolicy = AssignmentReviewPolicy, 
        HITReviewPolicy = HITReviewPolicy, HITLayoutId = HITLayoutId, 
        HITLayoutParameters = HITLayoutParameters)
    output <- create_hit_with_hit_type_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' The `CreateQualificationType` operation creates a new Qualification type, which is represented by a `QualificationType` data structure.
#'
#' @param Name The name you give to the Qualification type. The type name is used to represent the Qualification to Workers, and to find the type using a Qualification type search. It must be unique across all of your Qualification types.
#' @param Description A long description for the Qualification type. On the Amazon Mechanical Turk website, the long description is displayed when a Worker examines a Qualification type.
#' @param QualificationTypeStatus The initial status of the Qualification type.
#' 
...
#'
#' @export
create_qualification_type <- function (Name, Description, QualificationTypeStatus, 
    Keywords = NULL, RetryDelayInSeconds = NULL, Test = NULL, 
    AnswerKey = NULL, TestDurationInSeconds = NULL, AutoGranted = NULL, 
    AutoGrantedValue = NULL) 
{
    op <- Operation(name = "CreateQualificationType", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_qualification_type_input(Name = Name, Description = Description, 
        QualificationTypeStatus = QualificationTypeStatus, Keywords = Keywords, 
        RetryDelayInSeconds = RetryDelayInSeconds, Test = Test, 
        AnswerKey = AnswerKey, TestDurationInSeconds = TestDurationInSeconds, 
        AutoGranted = AutoGranted, AutoGrantedValue = AutoGrantedValue)
    output <- create_qualification_type_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param WorkerId The ID of the Worker to block.
#' @param Reason A message explaining the reason for blocking the Worker. This parameter enables you to keep track of your Workers. The Worker does not see this message.
#'
#' @examples
#'
#' @export
create_worker_block <- function (WorkerId, Reason) 
{
    op <- Operation(name = "CreateWorkerBlock", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_worker_block_input(WorkerId = WorkerId, Reason = Reason)
    output <- create_worker_block_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param HITId The ID of the HIT to be deleted.
#'
#' @examples
#'
#' @export
delete_hit <- function (HITId) 
{
    op <- Operation(name = "DeleteHIT", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- delete_hit_input(HITId = HITId)
    output <- delete_hit_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param QualificationTypeId The ID of the QualificationType to dispose.
#'
#' @examples
#'
#' @export
delete_qualification_type <- function (QualificationTypeId) 
{
    op <- Operation(name = "DeleteQualificationType", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- delete_qualification_type_input(QualificationTypeId = QualificationTypeId)
    output <- delete_qualification_type_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param WorkerId The ID of the Worker to unblock.
#' @param Reason A message that explains the reason for unblocking the Worker. The Worker does not see this message.
#'
#' @examples
#'
#' @export
delete_worker_block <- function (WorkerId, Reason = NULL) 
{
    op <- Operation(name = "DeleteWorkerBlock", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- delete_worker_block_input(WorkerId = WorkerId, Reason = Reason)
    output <- delete_worker_block_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param WorkerId The ID of the Worker who possesses the Qualification to be revoked.
#' @param QualificationTypeId The ID of the Qualification type of the Qualification to be revoked.
...
#'
#' @export
disassociate_qualification_from_worker <- function (WorkerId, 
    QualificationTypeId, Reason = NULL) 
{
    op <- Operation(name = "DisassociateQualificationFromWorker", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- disassociate_qualification_from_worker_input(WorkerId = WorkerId, 
        QualificationTypeId = QualificationTypeId, Reason = Reason)
    output <- disassociate_qualification_from_worker_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
{
    op <- Operation(name = "GetAccountBalance", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- get_account_balance_input()
    output <- get_account_balance_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
{
    op <- Operation(name = "GetAssignment", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- get_assignment_input(AssignmentId = AssignmentId)
    output <- get_assignment_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param AssignmentId The ID of the assignment that contains the question with a FileUploadAnswer.
#' @param QuestionIdentifier The identifier of the question with a FileUploadAnswer, as specified in the QuestionForm of the HIT.
#'
#' @examples
#'
#' @export
get_file_upload_url <- function (AssignmentId, QuestionIdentifier) 
{
    op <- Operation(name = "GetFileUploadURL", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- get_file_upload_url_input(AssignmentId = AssignmentId, 
        QuestionIdentifier = QuestionIdentifier)
    output <- get_file_upload_url_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' The `GetHIT` operation retrieves the details of the specified HIT.
#'
#' @param HITId The ID of the HIT to be retrieved.
#'
#' @examples
#'
#' @export
get_hit <- function (HITId) 
{
    op <- Operation(name = "GetHIT", http_method = "POST", http_path = "/", 
        paginator = list())
    input <- get_hit_input(HITId = HITId)
    output <- get_hit_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' @param WorkerId The ID of the Worker whose Qualification is being updated.
#'
#' @examples
#'
#' @export
get_qualification_score <- function (QualificationTypeId, WorkerId) 
{
    op <- Operation(name = "GetQualificationScore", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- get_qualification_score_input(QualificationTypeId = QualificationTypeId, 
        WorkerId = WorkerId)
    output <- get_qualification_score_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_qualification_type <- function (QualificationTypeId) 
{
    op <- Operation(name = "GetQualificationType", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- get_qualification_type_input(QualificationTypeId = QualificationTypeId)
    output <- get_qualification_type_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_assignments_for_hit <- function (HITId, NextToken = NULL, 
    MaxResults = NULL, AssignmentStatuses = NULL) 
{
    op <- Operation(name = "ListAssignmentsForHIT", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_assignments_for_hit_input(HITId = HITId, NextToken = NextToken, 
        MaxResults = MaxResults, AssignmentStatuses = AssignmentStatuses)
    output <- list_assignments_for_hit_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_bonus_payments <- function (HITId = NULL, AssignmentId = NULL, 
    NextToken = NULL, MaxResults = NULL) 
{
    op <- Operation(name = "ListBonusPayments", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_bonus_payments_input(HITId = HITId, AssignmentId = AssignmentId, 
        NextToken = NextToken, MaxResults = MaxResults)
    output <- list_bonus_payments_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_hi_ts <- function (NextToken = NULL, MaxResults = NULL) 
{
    op <- Operation(name = "ListHITs", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_hi_ts_input(NextToken = NextToken, MaxResults = MaxResults)
    output <- list_hi_ts_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param QualificationTypeId The ID of the Qualification type to use when querying HITs.
#' @param NextToken Pagination Token
...
#'
#' @export
list_hi_ts_for_qualification_type <- function (QualificationTypeId, 
    NextToken = NULL, MaxResults = NULL) 
{
    op <- Operation(name = "ListHITsForQualificationType", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_hi_ts_for_qualification_type_input(QualificationTypeId = QualificationTypeId, 
        NextToken = NextToken, MaxResults = MaxResults)
    output <- list_hi_ts_for_qualification_type_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_qualification_requests <- function (QualificationTypeId = NULL, 
    NextToken = NULL, MaxResults = NULL) 
{
    op <- Operation(name = "ListQualificationRequests", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_qualification_requests_input(QualificationTypeId = QualificationTypeId, 
        NextToken = NextToken, MaxResults = MaxResults)
    output <- list_qualification_requests_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_qualification_types <- function (MustBeRequestable, Query = NULL, 
    MustBeOwnedByCaller = NULL, NextToken = NULL, MaxResults = NULL) 
{
    op <- Operation(name = "ListQualificationTypes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_qualification_types_input(MustBeRequestable = MustBeRequestable, 
        Query = Query, MustBeOwnedByCaller = MustBeOwnedByCaller, 
        NextToken = NextToken, MaxResults = MaxResults)
    output <- list_qualification_types_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param HITId The unique identifier of the HIT to retrieve review results for.
...
#'
#' @export
list_review_policy_results_for_hit <- function (HITId, PolicyLevels = NULL, 
    RetrieveActions = NULL, RetrieveResults = NULL, NextToken = NULL, 
    MaxResults = NULL) 
{
    op <- Operation(name = "ListReviewPolicyResultsForHIT", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_review_policy_results_for_hit_input(HITId = HITId, 
        PolicyLevels = PolicyLevels, RetrieveActions = RetrieveActions, 
        RetrieveResults = RetrieveResults, NextToken = NextToken, 
        MaxResults = MaxResults)
    output <- list_review_policy_results_for_hit_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_reviewable_hi_ts <- function (HITTypeId = NULL, Status = NULL, 
    NextToken = NULL, MaxResults = NULL) 
{
    op <- Operation(name = "ListReviewableHITs", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_reviewable_hi_ts_input(HITTypeId = HITTypeId, 
        Status = Status, NextToken = NextToken, MaxResults = MaxResults)
    output <- list_reviewable_hi_ts_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_worker_blocks <- function (NextToken = NULL, MaxResults = NULL) 
{
    op <- Operation(name = "ListWorkerBlocks", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_worker_blocks_input(NextToken = NextToken, 
        MaxResults = MaxResults)
    output <- list_worker_blocks_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_workers_with_qualification_type <- function (QualificationTypeId, 
    Status = NULL, NextToken = NULL, MaxResults = NULL) 
{
    op <- Operation(name = "ListWorkersWithQualificationType", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- list_workers_with_qualification_type_input(QualificationTypeId = QualificationTypeId, 
        Status = Status, NextToken = NextToken, MaxResults = MaxResults)
    output <- list_workers_with_qualification_type_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' @param MessageText The text of the email message to send. Can include up to 4,096 characters
#' @param WorkerIds A list of Worker IDs you wish to notify. You can notify upto 100 Workers at a time.
#'
#' @examples
#'
#' @export
notify_workers <- function (Subject, MessageText, WorkerIds) 
{
    op <- Operation(name = "NotifyWorkers", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- notify_workers_input(Subject = Subject, MessageText = MessageText, 
        WorkerIds = WorkerIds)
    output <- notify_workers_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
reject_assignment <- function (AssignmentId, RequesterFeedback) 
{
    op <- Operation(name = "RejectAssignment", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- reject_assignment_input(AssignmentId = AssignmentId, 
        RequesterFeedback = RequesterFeedback)
    output <- reject_assignment_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param QualificationRequestId The ID of the Qualification request, as returned by the `ListQualificationRequests` operation.
#' @param Reason A text message explaining why the request was rejected, to be shown to the Worker who made the request.
#'
#' @examples
#'
#' @export
reject_qualification_request <- function (QualificationRequestId, 
    Reason = NULL) 
{
    op <- Operation(name = "RejectQualificationRequest", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- reject_qualification_request_input(QualificationRequestId = QualificationRequestId, 
        Reason = Reason)
    output <- reject_qualification_request_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param WorkerId The ID of the Worker being paid the bonus.
#' @param BonusAmount The Bonus amount is a US Dollar amount specified using a string (for example, \"5\" represents \$5.00 USD and \"101.42\" represents \$101.42 USD). Do not include currency symbols or currency codes.
#' @param AssignmentId The ID of the assignment for which this bonus is paid.
...
#'
#' @export
send_bonus <- function (WorkerId, BonusAmount, AssignmentId, 
    Reason, UniqueRequestToken = NULL) 
{
    op <- Operation(name = "SendBonus", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- send_bonus_input(WorkerId = WorkerId, BonusAmount = BonusAmount, 
        AssignmentId = AssignmentId, Reason = Reason, UniqueRequestToken = UniqueRequestToken)
    output <- send_bonus_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' @param TestEventType The event to simulate to test the notification specification. This event is included in the test message even if the notification specification does not include the event type. The notification specification does not filter out the test event.
#'
#' @examples
#'
#' @export
send_test_event_notification <- function (Notification, TestEventType) 
{
    op <- Operation(name = "SendTestEventNotification", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- send_test_event_notification_input(Notification = Notification, 
        TestEventType = TestEventType)
    output <- send_test_event_notification_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param HITId The HIT to update.
#' @param ExpireAt The date and time at which you want the HIT to expire
#'
#' @examples
#'
#' @export
update_expiration_for_hit <- function (HITId, ExpireAt) 
{
    op <- Operation(name = "UpdateExpirationForHIT", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_expiration_for_hit_input(HITId = HITId, ExpireAt = ExpireAt)
    output <- update_expiration_for_hit_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
update_hit_review_status <- function (HITId, Revert = NULL) 
{
    op <- Operation(name = "UpdateHITReviewStatus", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_hit_review_status_input(HITId = HITId, Revert = Revert)
    output <- update_hit_review_status_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param HITId The HIT to update.
#' @param HITTypeId The ID of the new HIT type.
#'
#' @examples
#'
#' @export
update_hit_type_of_hit <- function (HITId, HITTypeId) 
{
    op <- Operation(name = "UpdateHITTypeOfHIT", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_hit_type_of_hit_input(HITId = HITId, HITTypeId = HITTypeId)
    output <- update_hit_type_of_hit_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param HITTypeId The ID of the HIT type whose notification specification is being updated.
...
#'
#' @export
update_notification_settings <- function (HITTypeId, Notification = NULL, 
    Active = NULL) 
{
    op <- Operation(name = "UpdateNotificationSettings", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_notification_settings_input(HITTypeId = HITTypeId, 
        Notification = Notification, Active = Active)
    output <- update_notification_settings_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
update_qualification_type <- function (QualificationTypeId, Description = NULL, 
    QualificationTypeStatus = NULL, Test = NULL, AnswerKey = NULL, 
    TestDurationInSeconds = NULL, RetryDelayInSeconds = NULL, 
    AutoGranted = NULL, AutoGrantedValue = NULL) 
{
    op <- Operation(name = "UpdateQualificationType", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_qualification_type_input(QualificationTypeId = QualificationTypeId, 
        Description = Description, QualificationTypeStatus = QualificationTypeStatus, 
        Test = Test, AnswerKey = AnswerKey, TestDurationInSeconds = TestDurationInSeconds, 
        RetryDelayInSeconds = RetryDelayInSeconds, AutoGranted = AutoGranted, 
        AutoGrantedValue = AutoGrantedValue)
    output <- update_qualification_type_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
