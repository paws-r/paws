...
#'
#' @export
create_batch_prediction <- function (BatchPredictionId, BatchPredictionName = NULL, 
    MLModelId, BatchPredictionDataSourceId, OutputUri) 
{
    op <- new_operation(name = "CreateBatchPrediction", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_batch_prediction_input(BatchPredictionId = BatchPredictionId, 
        BatchPredictionName = BatchPredictionName, MLModelId = MLModelId, 
...
#'
#' @export
create_data_source_from_rds <- function (DataSourceId, DataSourceName = NULL, 
    RDSData, RoleARN, ComputeStatistics = NULL) 
{
    op <- new_operation(name = "CreateDataSourceFromRDS", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_data_source_from_rds_input(DataSourceId = DataSourceId, 
        DataSourceName = DataSourceName, RDSData = RDSData, RoleARN = RoleARN, 
...
#'
#' @export
create_data_source_from_redshift <- function (DataSourceId, DataSourceName = NULL, 
    DataSpec, RoleARN, ComputeStatistics = NULL) 
{
    op <- new_operation(name = "CreateDataSourceFromRedshift", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- create_data_source_from_redshift_input(DataSourceId = DataSourceId, 
        DataSourceName = DataSourceName, DataSpec = DataSpec, 
        RoleARN = RoleARN, ComputeStatistics = ComputeStatistics)
...
#'
#' @export
create_data_source_from_s3 <- function (DataSourceId, DataSourceName = NULL, 
    DataSpec, ComputeStatistics = NULL) 
{
    op <- new_operation(name = "CreateDataSourceFromS3", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
create_evaluation <- function (EvaluationId, EvaluationName = NULL, 
    MLModelId, EvaluationDataSourceId) 
{
    op <- new_operation(name = "CreateEvaluation", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_evaluation_input(EvaluationId = EvaluationId, 
        EvaluationName = EvaluationName, MLModelId = MLModelId, 
...
#'
#' @export
create_ml_model <- function (MLModelId, MLModelName = NULL, MLModelType, 
    Parameters = NULL, TrainingDataSourceId, Recipe = NULL, RecipeUri = NULL) 
{
    op <- new_operation(name = "CreateMLModel", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_ml_model_input(MLModelId = MLModelId, MLModelName = MLModelName, 
        MLModelType = MLModelType, Parameters = Parameters, TrainingDataSourceId = TrainingDataSourceId, 
        Recipe = Recipe, RecipeUri = RecipeUri)
...
{
    op <- new_operation(name = "CreateRealtimeEndpoint", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteBatchPrediction", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteDataSource", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteEvaluation", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteMLModel", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteRealtimeEndpoint", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeBatchPredictions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeDataSources", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_evaluations <- function (FilterVariable = NULL, EQ = NULL, 
    ...
    SortOrder = NULL, NextToken = NULL, Limit = NULL) 
{
    op <- new_operation(name = "DescribeEvaluations", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_ml_models <- function (FilterVariable = NULL, EQ = NULL, 
    ...
    SortOrder = NULL, NextToken = NULL, Limit = NULL) 
{
    op <- new_operation(name = "DescribeMLModels", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetBatchPrediction", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetDataSource", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetEvaluation", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetMLModel", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "Predict", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateBatchPrediction", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateEvaluation", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateMLModel", http_method = "POST", 
        http_path = "/", paginator = list())
