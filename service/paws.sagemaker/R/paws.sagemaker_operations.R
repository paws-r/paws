...
{
    op <- Operation(name = "CreateAlgorithm", http_method = "POST", 
...
{
    op <- Operation(name = "CreateCodeRepository", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "CreateCompilationJob", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "CreateLabelingJob", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "CreateModelPackage", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param AcceleratorTypes A list of Elastic Inference (EI) instance types to associate with this notebook instance. Currently, only one instance type can be associated with a notebook intance. For more information, see [Using Elastic Inference in Amazon SageMaker](http://docs.aws.amazon.com/sagemaker/latest/dg/ei.html).
...
create_training_job <- function (TrainingJobName, HyperParameters = NULL, 
    ...
    Tags = NULL, EnableNetworkIsolation = NULL) 
{
...
{
    op <- Operation(name = "CreateWorkteam", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteAlgorithm", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteCodeRepository", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteModelPackage", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteWorkteam", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeAlgorithm", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeCodeRepository", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeCompilationJob", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeLabelingJob", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeModelPackage", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeSubscribedWorkteam", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeWorkteam", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetSearchSuggestions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListAlgorithms", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListCodeRepositories", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_compilation_jobs <- function (NextToken = NULL, MaxResults = NULL, 
    ...
    SortBy = NULL, SortOrder = NULL) 
{
    op <- Operation(name = "ListCompilationJobs", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListLabelingJobs", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListLabelingJobsForWorkteam", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_model_packages <- function (CreationTimeAfter = NULL, CreationTimeBefore = NULL, 
    ...
    SortBy = NULL, SortOrder = NULL) 
{
    op <- Operation(name = "ListModelPackages", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_subscribed_workteams <- function (NameContains = NULL, NextToken = NULL, 
    MaxResults = NULL) 
{
    op <- Operation(name = "ListSubscribedWorkteams", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListWorkteams", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "RenderUiTemplate", http_method = "POST", 
        http_path = "/", paginator = list())
...
search <- function (Resource, SearchExpression = NULL, SortBy = NULL, 
    SortOrder = NULL, NextToken = NULL, MaxResults = NULL) 
{
    op <- Operation(name = "Search", http_method = "POST", http_path = "/", 
        paginator = list())
...
{
    op <- Operation(name = "StopCompilationJob", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "StopLabelingJob", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateCodeRepository", http_method = "POST", 
        http_path = "/", paginator = list())
...
update_workteam <- function (WorkteamName, MemberDefinitions = NULL, 
    Description = NULL) 
{
    op <- Operation(name = "UpdateWorkteam", http_method = "POST", 
        http_path = "/", paginator = list())
