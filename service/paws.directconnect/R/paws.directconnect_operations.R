...
#' ```
#'
#' @param bandwidth &#91;required&#93; The bandwidth of the connection, in Mbps. The possible values are 50Mbps, 100Mbps, 200Mbps, 300Mbps, 400Mbps, and 500Mbps.
#' @param connectionName &#91;required&#93; The name of the provisioned connection.
#' @param ownerAccount &#91;required&#93; The ID of the AWS account of the customer for whom the connection will be provisioned.
#' @param interconnectId &#91;required&#93; The ID of the interconnect on which the connection will be provisioned. For example, dxcon-456abc78.
...
{
    op <- new_operation(name = "AllocateConnectionOnInterconnect", 
...
#' @param bandwidth &#91;required&#93; The bandwidth of the hosted connection, in Mbps. The possible values are 50Mbps, 100Mbps, 200Mbps, 300Mbps, 400Mbps, and 500Mbps.
...
{
    op <- new_operation(name = "AllocateHostedConnection", http_method = "POST", 
...
{
    op <- new_operation(name = "AllocatePrivateVirtualInterface", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "AllocatePublicVirtualInterface", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' @param lagId &#91;required&#93; The ID of the LAG with which to associate the connection. For example, dxlag-abc123.
#'
#' @export
associate_connection_with_lag <- function (connectionId, lagId) 
{
    op <- new_operation(name = "AssociateConnectionWithLag", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "AssociateHostedConnection", http_method = "POST", 
        http_path = "/", paginator = list())
...
associate_virtual_interface <- function (virtualInterfaceId, 
    connectionId) 
{
    op <- new_operation(name = "AssociateVirtualInterface", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ConfirmConnection", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ConfirmPrivateVirtualInterface", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ConfirmPublicVirtualInterface", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateBGPPeer", http_method = "POST", 
        http_path = "/", paginator = list())
...
create_direct_connect_gateway <- function (directConnectGatewayName, 
    amazonSideAsn = NULL) 
{
    op <- new_operation(name = "CreateDirectConnectGateway", 
        http_method = "POST", http_path = "/", paginator = list())
...
create_direct_connect_gateway_association <- function (directConnectGatewayId, 
    virtualGatewayId) 
{
    op <- new_operation(name = "CreateDirectConnectGatewayAssociation", 
        http_method = "POST", http_path = "/", paginator = list())
...
create_interconnect <- function (interconnectName, bandwidth, 
    location, lagId = NULL) 
{
    op <- new_operation(name = "CreateInterconnect", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param numberOfConnections &#91;required&#93; The number of physical connections initially provisioned and bundled by the LAG.
#' @param location &#91;required&#93; The location for the LAG.
#' @param connectionsBandwidth &#91;required&#93; The bandwidth of the individual physical connections bundled by the LAG. The possible values are 1Gbps and 10Gbps.
...
{
    op <- new_operation(name = "CreateLag", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreatePrivateVirtualInterface", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreatePublicVirtualInterface", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteDirectConnectGateway", 
        http_method = "POST", http_path = "/", paginator = list())
...
delete_direct_connect_gateway_association <- function (directConnectGatewayId, 
    virtualGatewayId) 
{
    op <- new_operation(name = "DeleteDirectConnectGatewayAssociation", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteInterconnect", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteLag", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteVirtualInterface", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_connection_loa <- function (connectionId, providerName = NULL, 
    loaContentType = NULL) 
{
    op <- new_operation(name = "DescribeConnectionLoa", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeConnectionsOnInterconnect", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeDirectConnectGatewayAssociations", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeDirectConnectGatewayAttachments", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeDirectConnectGateways", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeHostedConnections", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_interconnect_loa <- function (interconnectId, providerName = NULL, 
    loaContentType = NULL) 
{
    op <- new_operation(name = "DescribeInterconnectLoa", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeInterconnects", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeLags", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_loa <- function (connectionId, providerName = NULL, 
    loaContentType = NULL) 
{
    op <- new_operation(name = "DescribeLoa", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeLocations", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeVirtualGateways", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeVirtualInterfaces", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DisassociateConnectionFromLag", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateLag", http_method = "POST", 
        http_path = "/", paginator = list())
...
update_virtual_interface_attributes <- function (virtualInterfaceId, 
    mtu = NULL) 
{
    op <- new_operation(name = "UpdateVirtualInterfaceAttributes", 
        http_method = "POST", http_path = "/", paginator = list())
