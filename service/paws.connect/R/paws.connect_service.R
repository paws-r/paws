service <- function () 
{
    cfg <- client_config("connect", list(`*` = "connect.{region}.amazonaws.com", 
        `cn-*` = "connect.{region}.amazonaws.com.cn"))
    client_info <- ClientInfo(service_name = "connect", service_id = "Connect", 
        api_version = "2017-08-08", signing_name = "connect", 
