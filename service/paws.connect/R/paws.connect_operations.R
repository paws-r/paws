...
{
    op <- new_operation(name = "CreateUser", http_method = "PUT", 
...
describe_user_hierarchy_group <- function (HierarchyGroupId, 
    InstanceId) 
{
    op <- new_operation(name = "DescribeUserHierarchyGroup", 
        http_method = "GET", http_path = "/user-hierarchy-groups/{InstanceId}/{HierarchyGroupId}", 
        paginator = list())
...
{
    op <- new_operation(name = "DescribeUserHierarchyStructure", 
...
{
    op <- new_operation(name = "GetCurrentMetricData", http_method = "POST", 
...
{
    op <- new_operation(name = "GetFederationToken", http_method = "GET", 
...
list_routing_profiles <- function (InstanceId, NextToken = NULL, 
    MaxResults = NULL) 
{
    op <- new_operation(name = "ListRoutingProfiles", http_method = "GET", 
...
list_user_hierarchy_groups <- function (InstanceId, NextToken = NULL, 
    MaxResults = NULL) 
{
    op <- new_operation(name = "ListUserHierarchyGroups", http_method = "GET", 
...
{
    op <- new_operation(name = "StartOutboundVoiceContact", http_method = "PUT", 
...
{
    op <- new_operation(name = "StopContact", http_method = "POST", 
...
update_contact_attributes <- function (InitialContactId, InstanceId, 
    Attributes) 
{
    op <- new_operation(name = "UpdateContactAttributes", http_method = "POST", 
...
update_user_hierarchy <- function (HierarchyGroupId = NULL, UserId, 
    InstanceId) 
{
    op <- new_operation(name = "UpdateUserHierarchy", http_method = "POST", 
...
update_user_identity_info <- function (IdentityInfo, UserId, 
    InstanceId) 
{
    op <- new_operation(name = "UpdateUserIdentityInfo", http_method = "POST", 
...
{
    op <- new_operation(name = "UpdateUserPhoneConfig", http_method = "POST", 
...
update_user_routing_profile <- function (RoutingProfileId, UserId, 
    InstanceId) 
{
    op <- new_operation(name = "UpdateUserRoutingProfile", http_method = "POST", 
...
update_user_security_profiles <- function (SecurityProfileIds, 
    UserId, InstanceId) 
{
    op <- new_operation(name = "UpdateUserSecurityProfiles", 
        http_method = "POST", http_path = "/users/{InstanceId}/{UserId}/security-profiles", 
        paginator = list())
