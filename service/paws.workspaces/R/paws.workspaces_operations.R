...
{
    op <- Operation(name = "DeleteWorkspaceImage", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeAccountModifications", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeClientProperties", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_workspace_images <- function (ImageIds = NULL, NextToken = NULL, 
    MaxResults = NULL) 
{
    op <- Operation(name = "DescribeWorkspaceImages", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ImportWorkspaceImage", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListAvailableManagementCidrRanges", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ModifyAccount", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
modify_client_properties <- function (ResourceId, ClientProperties = NULL) 
{
    op <- Operation(name = "ModifyClientProperties", http_method = "POST", 
        http_path = "/", paginator = list())
