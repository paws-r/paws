...
{
    op <- new_operation(name = "GetGroupQuery", http_method = "GET", 
...
{
    op <- new_operation(name = "GetTags", http_method = "GET", 
        http_path = "/resources/{Arn}/tags", paginator = list())
...
{
    op <- new_operation(name = "ListGroupResources", http_method = "POST", 
...
search_resources <- function (ResourceQuery, MaxResults = NULL, 
    NextToken = NULL) 
{
    op <- new_operation(name = "SearchResources", http_method = "POST", 
...
{
    op <- new_operation(name = "Tag", http_method = "PUT", http_path = "/resources/{Arn}/tags", 
        paginator = list())
...
{
    op <- new_operation(name = "Untag", http_method = "PATCH", 
        http_path = "/resources/{Arn}/tags", paginator = list())
...
{
    op <- new_operation(name = "UpdateGroupQuery", http_method = "PUT", 
        http_path = "/groups/{GroupName}/query", paginator = list())
