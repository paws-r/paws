...
#' @param LayerIds &#91;required&#93; The layer ID, which must correspond to a custom layer. You cannot assign a registered instance to a built-in layer.
#'
#' @export
assign_instance <- function (InstanceId, LayerIds) 
{
    op <- new_operation(name = "AssignInstance", http_method = "POST", 
...
{
    op <- new_operation(name = "AssignVolume", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "AssociateElasticIp", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param LayerId &#91;required&#93; The ID of the layer to which the Elastic Load Balancing instance is to be attached.
#'
#' @export
attach_elastic_load_balancer <- function (ElasticLoadBalancerName, 
    LayerId) 
{
    op <- new_operation(name = "AttachElasticLoadBalancer", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
clone_stack <- function (SourceStackId, Name = NULL, Region = NULL, 
    VpcId = NULL, Attributes = NULL, ServiceRoleArn, DefaultInstanceProfileArn = NULL, 
...
{
    op <- new_operation(name = "CloneStack", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- clone_stack_input(SourceStackId = SourceStackId, 
        Name = Name, Region = Region, VpcId = VpcId, Attributes = Attributes, 
...
#' @param Type &#91;required&#93; The app type. Each supported type is associated with a particular layer. For example, PHP applications are associated with a PHP layer. AWS OpsWorks Stacks deploys an application to those instances that are members of the corresponding layer. If your app isn\'t one of the standard types, or you prefer to implement your own Deploy recipes, specify `other`.
...
#'
#' @export
create_app <- function (StackId, Shortname = NULL, Name, Description = NULL, 
    DataSources = NULL, Type, AppSource = NULL, Domains = NULL, 
    EnableSsl = NULL, SslConfiguration = NULL, Attributes = NULL, 
    Environment = NULL) 
{
    op <- new_operation(name = "CreateApp", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_app_input(StackId = StackId, Shortname = Shortname, 
        Name = Name, Description = Description, DataSources = DataSources, 
        Type = Type, AppSource = AppSource, Domains = Domains, 
...
#' @param Command &#91;required&#93; A `DeploymentCommand` object that specifies the deployment command and any associated arguments.
...
#'
#' @export
create_deployment <- function (StackId, AppId = NULL, InstanceIds = NULL, 
    LayerIds = NULL, Command, Comment = NULL, CustomJson = NULL) 
{
    op <- new_operation(name = "CreateDeployment", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_deployment_input(StackId = StackId, AppId = AppId, 
        InstanceIds = InstanceIds, LayerIds = LayerIds, Command = Command, 
...
{
    op <- new_operation(name = "CreateInstance", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param Type &#91;required&#93; The layer type. A stack cannot have more than one built-in layer of the same type. It can have any number of custom layers. Built-in layers are not available in Chef 12 stacks.
...
{
    op <- new_operation(name = "CreateLayer", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param Region &#91;required&#93; The stack\'s AWS region, such as `ap-south-1`. For more information about Amazon regions, see [Regions and Endpoints](http://docs.aws.amazon.com/general/latest/gr/rande.html).
#' 
...
#' For more information about how to use AWS OpsWorks Stacks with a VPC, see [Running a Stack in a VPC](http://docs.aws.amazon.com/opsworks/latest/userguide/workingstacks-vpc.html). For more information about default VPC and EC2-Classic, see [Supported Platforms](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-supported-platforms.html).
#' @param Attributes One or more user-defined key-value pairs to be added to the stack attributes.
#' @param ServiceRoleArn &#91;required&#93; The stack\'s AWS Identity and Access Management (IAM) role, which allows AWS OpsWorks Stacks to work with AWS resources on your behalf. You must set this parameter to the Amazon Resource Name (ARN) for an existing IAM role. For more information about IAM ARNs, see [Using Identifiers](http://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html).
#' @param DefaultInstanceProfileArn &#91;required&#93; The Amazon Resource Name (ARN) of an IAM profile that is the default profile for all of the stack\'s EC2 instances. For more information about IAM ARNs, see [Using Identifiers](http://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html).
...
#'
#' @export
create_stack <- function (Name, Region, VpcId = NULL, Attributes = NULL, 
    ServiceRoleArn, DefaultInstanceProfileArn, DefaultOs = NULL, 
    HostnameTheme = NULL, DefaultAvailabilityZone = NULL, DefaultSubnetId = NULL, 
    CustomJson = NULL, ConfigurationManager = NULL, ChefConfiguration = NULL, 
    UseCustomCookbooks = NULL, UseOpsworksSecurityGroups = NULL, 
    CustomCookbooksSource = NULL, DefaultSshKeyName = NULL, DefaultRootDeviceType = NULL, 
    AgentVersion = NULL) 
{
    op <- new_operation(name = "CreateStack", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_stack_input(Name = Name, Region = Region, 
        VpcId = VpcId, Attributes = Attributes, ServiceRoleArn = ServiceRoleArn, 
...
{
    op <- new_operation(name = "DeleteLayer", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeregisterEcsCluster", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeregisterElasticIp", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeregisterRdsDbInstance", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param VolumeId &#91;required&#93; The AWS OpsWorks Stacks volume ID, which is the GUID that AWS OpsWorks Stacks assigned to the instance when you registered the volume with the stack, not the Amazon EC2 volume ID.
#'
#' @export
deregister_volume <- function (VolumeId) 
{
    op <- new_operation(name = "DeregisterVolume", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeAgentVersions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeApps", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_commands <- function (DeploymentId = NULL, InstanceId = NULL, 
    CommandIds = NULL) 
{
    op <- new_operation(name = "DescribeCommands", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_deployments <- function (StackId = NULL, AppId = NULL, 
    DeploymentIds = NULL) 
{
    op <- new_operation(name = "DescribeDeployments", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeEcsClusters", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_elastic_ips <- function (InstanceId = NULL, StackId = NULL, 
    Ips = NULL) 
{
    op <- new_operation(name = "DescribeElasticIps", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_elastic_load_balancers <- function (StackId = NULL, 
    LayerIds = NULL) 
{
    op <- new_operation(name = "DescribeElasticLoadBalancers", 
...
{
    op <- new_operation(name = "DescribeLayers", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeLoadBasedAutoScaling", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeMyUserProfile", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeOperatingSystems", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribePermissions", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_raid_arrays <- function (InstanceId = NULL, StackId = NULL, 
    RaidArrayIds = NULL) 
{
    op <- new_operation(name = "DescribeRaidArrays", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param StackId &#91;required&#93; The ID of the stack with which the instances are registered. The operation returns descriptions of all registered Amazon RDS instances.
...
{
    op <- new_operation(name = "DescribeRdsDbInstances", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeServiceErrors", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeStackProvisioningParameters", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeStackSummary", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeTimeBasedAutoScaling", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeUserProfiles", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @param ElasticLoadBalancerName &#91;required&#93; The Elastic Load Balancing instance\'s name.
#' @param LayerId &#91;required&#93; The ID of the layer that the Elastic Load Balancing instance is attached to.
#'
#' @export
detach_elastic_load_balancer <- function (ElasticLoadBalancerName, 
    LayerId) 
{
    op <- new_operation(name = "DetachElasticLoadBalancer", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DisassociateElasticIp", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetHostnameSuggestion", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GrantAccess", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RegisterEcsCluster", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RegisterElasticIp", http_method = "POST", 
        http_path = "/", paginator = list())
...
register_rds_db_instance <- function (StackId, RdsDbInstanceArn, 
    DbUser, DbPassword) 
{
    op <- new_operation(name = "RegisterRdsDbInstance", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
register_volume <- function (Ec2VolumeId = NULL, StackId) 
{
    op <- new_operation(name = "RegisterVolume", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- register_volume_input(Ec2VolumeId = Ec2VolumeId, 
        StackId = StackId)
...
{
    op <- new_operation(name = "SetLoadBasedAutoScaling", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "SetPermission", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "SetTimeBasedAutoScaling", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StartStack", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StopStack", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @param ResourceArn &#91;required&#93; The stack or layer\'s Amazon Resource Number (ARN).
#' @param Tags &#91;required&#93; A map that contains tag keys and tag values that are attached to a stack or layer.
#' 
...
{
    op <- new_operation(name = "UnassignInstance", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UnassignVolume", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateElasticIp", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateInstance", http_method = "POST", 
        http_path = "/", paginator = list())
...
update_layer <- function (LayerId, Name = NULL, Shortname = NULL, 
    ...
    UseEbsOptimizedInstances = NULL, LifecycleEventConfiguration = NULL) 
{
    op <- new_operation(name = "UpdateLayer", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateMyUserProfile", http_method = "POST", 
        http_path = "/", paginator = list())
...
update_rds_db_instance <- function (RdsDbInstanceArn, DbUser = NULL, 
    DbPassword = NULL) 
{
    op <- new_operation(name = "UpdateRdsDbInstance", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateVolume", http_method = "POST", 
        http_path = "/", paginator = list())
