...
associate_resolver_endpoint_ip_address <- function (ResolverEndpointId, 
    IpAddress) 
{
    op <- new_operation(name = "AssociateResolverEndpointIpAddress", 
...
associate_resolver_rule <- function (ResolverRuleId, Name = NULL, 
    VPCId) 
{
    op <- new_operation(name = "AssociateResolverRule", http_method = "POST", 
...
{
    op <- new_operation(name = "CreateResolverEndpoint", http_method = "POST", 
        http_path = "/", paginator = list())
...
create_resolver_rule <- function (CreatorRequestId, Name = NULL, 
    ...
    Tags = NULL) 
{
    op <- new_operation(name = "CreateResolverRule", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteResolverEndpoint", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteResolverRule", http_method = "POST", 
        http_path = "/", paginator = list())
...
disassociate_resolver_endpoint_ip_address <- function (ResolverEndpointId, 
    IpAddress) 
{
    op <- new_operation(name = "DisassociateResolverEndpointIpAddress", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DisassociateResolverRule", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetResolverEndpoint", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetResolverRule", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetResolverRuleAssociation", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetResolverRulePolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListResolverEndpointIpAddresses", 
        http_method = "POST", http_path = "/", paginator = list())
...
list_resolver_endpoints <- function (MaxResults = NULL, NextToken = NULL, 
    Filters = NULL) 
{
    op <- new_operation(name = "ListResolverEndpoints", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListResolverRuleAssociations", 
        http_method = "POST", http_path = "/", paginator = list())
...
list_resolver_rules <- function (MaxResults = NULL, NextToken = NULL, 
    Filters = NULL) 
{
    op <- new_operation(name = "ListResolverRules", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PutResolverRulePolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateResolverEndpoint", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateResolverRule", http_method = "POST", 
        http_path = "/", paginator = list())
