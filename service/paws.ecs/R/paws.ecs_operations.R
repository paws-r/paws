...
#' @param launchType The launch type on which to run your service. For more information, see [Amazon ECS Launch Types](http://docs.aws.amazon.com/AmazonECS/latest/developerguide/launch_types.html) in the *Amazon Elastic Container Service Developer Guide*.
...
#' @param enableECSManagedTags Specifies whether to enable Amazon ECS managed tags for the tasks within the service. For more information, see [Tagging Your Amazon ECS Resources](http://docs.aws.amazon.com/AmazonECS/latest/developerguide/Using_Tags.html) in the *Amazon Elastic Container Service Developer Guide*.
...
{
    op <- Operation(name = "DeleteAccountSetting", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_account_settings <- function (name = NULL, value = NULL, 
    ...
    maxResults = NULL) 
{
    op <- Operation(name = "ListAccountSettings", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "PutAccountSetting", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param launchType The launch type on which to run your task. For more information, see [Amazon ECS Launch Types](http://docs.aws.amazon.com/AmazonECS/latest/developerguide/launch_types.html) in the *Amazon Elastic Container Service Developer Guide*.
...
#' @param enableECSManagedTags Specifies whether to enable Amazon ECS managed tags for the task. For more information, see [Tagging Your Amazon ECS Resources](http://docs.aws.amazon.com/AmazonECS/latest/developerguide/Using_Tags.html) in the *Amazon Elastic Container Service Developer Guide*.
