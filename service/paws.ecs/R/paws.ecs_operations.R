...
#'
#' @export
create_service <- function (serviceName, taskDefinition, cluster = NULL, 
    ...
    schedulingStrategy = NULL) 
{
    op <- Operation(name = "CreateService", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_service_input(serviceName = serviceName, 
        taskDefinition = taskDefinition, cluster = cluster, loadBalancers = loadBalancers, 
...
#' Deletes one or more custom attributes from an Amazon ECS resource.
#'
#' @param attributes The attributes to delete from your resource. You can specify up to 10 attributes per request. For custom attributes, specify the attribute name and target ID, but do not specify the value. If you specify the target ID using the short form, you must also specify the target type.
...
#'
#' @export
delete_attributes <- function (attributes, cluster = NULL) 
{
    op <- Operation(name = "DeleteAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- delete_attributes_input(attributes = attributes, 
        cluster = cluster)
...
#'
#' @export
delete_service <- function (service, cluster = NULL, force = NULL) 
{
    op <- Operation(name = "DeleteService", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- delete_service_input(service = service, cluster = cluster, 
        force = force)
...
#'
#' @param containerInstance The container instance ID or full ARN of the container instance to deregister. The ARN contains the `arn:aws:ecs` namespace, followed by the Region of the container instance, the AWS account ID of the container instance owner, the `container-instance` namespace, and then the container instance ID. For example, `arn:aws:ecs:region:aws_account_id:container-instance/container_instance_ID region:aws_account_id:container-instance/container_instance_ID `.
...
#'
#' @export
deregister_container_instance <- function (containerInstance, 
    cluster = NULL, force = NULL) 
{
    op <- Operation(name = "DeregisterContainerInstance", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- deregister_container_instance_input(containerInstance = containerInstance, 
...
#'
#' @param taskDefinition The `family` and `revision` (`family:revision`) or full Amazon Resource Name (ARN) of the task definition to deregister. You must specify a `revision`.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "DeregisterTaskDefinition", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @param containerInstances A list of up to 100 container instance IDs or full Amazon Resource Name (ARN) entries.
...
#'
#' @export
describe_container_instances <- function (containerInstances, 
    cluster = NULL) 
{
    op <- Operation(name = "DescribeContainerInstances", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_container_instances_input(containerInstances = containerInstances, 
        cluster = cluster)
...
#' Describes the specified services running in your cluster.
#'
#' @param services A list of services to describe. You may specify up to 10 services to describe in a single operation.
...
#'
#' @export
describe_services <- function (services, cluster = NULL) 
{
    op <- Operation(name = "DescribeServices", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_services_input(services = services, cluster = cluster)
...
#'
#' @param taskDefinition The `family` for the latest `ACTIVE` revision, `family` and `revision` (`family:revision`) for a specific revision in the family, or full Amazon Resource Name (ARN) of the task definition to describe.
#'
#' @examples
...
{
    op <- Operation(name = "DescribeTaskDefinition", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
describe_tasks <- function (tasks, cluster = NULL) 
{
    op <- Operation(name = "DescribeTasks", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_tasks_input(tasks = tasks, cluster = cluster)
...
discover_poll_endpoint <- function (containerInstance = NULL, 
    cluster = NULL) 
{
    op <- Operation(name = "DiscoverPollEndpoint", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @param targetType The type of the target with which to list attributes.
...
#'
#' @export
list_attributes <- function (targetType, cluster = NULL, attributeName = NULL, 
    attributeValue = NULL, nextToken = NULL, maxResults = NULL) 
{
    op <- Operation(name = "ListAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_attributes_input(targetType = targetType, cluster = cluster, 
...
{
    op <- Operation(name = "ListContainerInstances", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListTaskDefinitionFamilies", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListTaskDefinitions", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @param attributes The attributes to apply to your resource. You can specify up to 10 custom attributes per resource. You can specify up to 10 attributes in a single call.
...
#'
#' @export
put_attributes <- function (attributes, cluster = NULL) 
{
    op <- Operation(name = "PutAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- put_attributes_input(attributes = attributes, cluster = cluster)
...
{
    op <- Operation(name = "RegisterContainerInstance", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @param family You must specify a `family` for a task definition, which allows you to track multiple versions of the same task definition. The `family` is used as a name for your task definition. Up to 255 letters (uppercase and lowercase), numbers, hyphens, and underscores are allowed.
...
#'
#' @export
register_task_definition <- function (family, containerDefinitions, 
    taskRoleArn = NULL, executionRoleArn = NULL, networkMode = NULL, 
    volumes = NULL, placementConstraints = NULL, requiresCompatibilities = NULL, 
    cpu = NULL, memory = NULL) 
{
    op <- Operation(name = "RegisterTaskDefinition", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- register_task_definition_input(family = family, 
        containerDefinitions = containerDefinitions, taskRoleArn = taskRoleArn, 
        executionRoleArn = executionRoleArn, networkMode = networkMode, 
...
#'
#' @param taskDefinition The `family` and `revision` (`family:revision`) or full ARN of the task definition to run. If a `revision` is not specified, the latest `ACTIVE` revision is used.
...
#'
#' @export
run_task <- function (taskDefinition, cluster = NULL, overrides = NULL, 
...
{
    op <- Operation(name = "RunTask", http_method = "POST", http_path = "/", 
        paginator = list())
    input <- run_task_input(taskDefinition = taskDefinition, 
        cluster = cluster, overrides = overrides, count = count, 
        startedBy = startedBy, group = group, placementConstraints = placementConstraints, 
...
#'
#' @param taskDefinition The `family` and `revision` (`family:revision`) or full ARN of the task definition to start. If a `revision` is not specified, the latest `ACTIVE` revision is used.
#' @param containerInstances The container instance IDs or full ARN entries for the container instances on which you would like to place your task. You can specify up to 10 container instances.
...
#'
#' @export
start_task <- function (taskDefinition, containerInstances, cluster = NULL, 
    overrides = NULL, startedBy = NULL, group = NULL, networkConfiguration = NULL) 
{
    op <- Operation(name = "StartTask", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- start_task_input(taskDefinition = taskDefinition, 
        containerInstances = containerInstances, cluster = cluster, 
        overrides = overrides, startedBy = startedBy, group = group, 
...
#'
#' @param task The task ID or full ARN entry of the task to stop.
...
#'
#' @export
stop_task <- function (task, cluster = NULL, reason = NULL) 
{
    op <- Operation(name = "StopTask", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- stop_task_input(task = task, cluster = cluster, 
        reason = reason)
...
{
    op <- Operation(name = "SubmitContainerStateChange", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "SubmitTaskStateChange", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @param containerInstance The container instance ID or full ARN entries for the container instance on which you would like to update the Amazon ECS container agent.
...
#'
#' @export
update_container_agent <- function (containerInstance, cluster = NULL) 
{
    op <- Operation(name = "UpdateContainerAgent", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_container_agent_input(containerInstance = containerInstance, 
        cluster = cluster)
...
#'
#' @param containerInstances A list of container instance IDs or full ARN entries.
#' @param status The container instance state with which to update the container instance.
...
#'
#' @export
update_container_instances_state <- function (containerInstances, 
    status, cluster = NULL) 
{
    op <- Operation(name = "UpdateContainerInstancesState", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_container_instances_state_input(containerInstances = containerInstances, 
...
#'
#' @export
update_service <- function (service, cluster = NULL, desiredCount = NULL, 
    ...
    platformVersion = NULL, forceNewDeployment = NULL, healthCheckGracePeriodSeconds = NULL) 
{
    op <- Operation(name = "UpdateService", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_service_input(service = service, cluster = cluster, 
