service <- function () 
{
    cfg <- client_config("mq", list(`*` = "mq.{region}.amazonaws.com", 
        `cn-*` = "mq.{region}.amazonaws.com.cn"))
    client_info <- ClientInfo(service_name = "mq", service_id = "mq", 
        api_version = "2017-11-27", signing_name = "mq", signing_region = cfg$signing_region, 
