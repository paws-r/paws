...
{
    op <- new_operation(name = "AssociateDRTLogBucket", http_method = "POST", 
...
{
    op <- new_operation(name = "AssociateDRTRole", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateProtection", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateSubscription", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteProtection", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteSubscription", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeAttack", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeDRTAccess", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeEmergencyContactSettings", 
...
{
    op <- new_operation(name = "DescribeSubscription", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DisassociateDRTLogBucket", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DisassociateDRTRole", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetSubscriptionState", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListAttacks", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListProtections", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateEmergencyContactSettings", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateSubscription", http_method = "POST", 
        http_path = "/", paginator = list())
