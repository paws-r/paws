...
#'
#' @export
post_content <- function (botName, botAlias, userId, contentType, 
    inputStream, sessionAttributes = NULL, requestAttributes = NULL, 
    accept = NULL) 
{
    op <- Operation(name = "PostContent", http_method = "POST", 
        http_path = "/bot/{botName}/alias/{botAlias}/user/{userId}/content", 
        paginator = list())
    input <- post_content_input(botName = botName, botAlias = botAlias, 
        userId = userId, contentType = contentType, inputStream = inputStream, 
        sessionAttributes = sessionAttributes, requestAttributes = requestAttributes, 
        accept = accept)
    output <- post_content_output()
    svc <- service()
...
#'
#' @export
post_text <- function (botName, botAlias, userId, inputText, 
    sessionAttributes = NULL, requestAttributes = NULL) 
{
    op <- Operation(name = "PostText", http_method = "POST", 
        http_path = "/bot/{botName}/alias/{botAlias}/user/{userId}/text", 
        paginator = list())
    input <- post_text_input(botName = botName, botAlias = botAlias, 
        userId = userId, inputText = inputText, sessionAttributes = sessionAttributes, 
        requestAttributes = requestAttributes)
    output <- post_text_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
