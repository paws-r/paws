...
{
    op <- new_operation(name = "AddInstanceFleet", http_method = "POST", 
...
{
    op <- new_operation(name = "AddInstanceGroups", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param JobFlowId &#91;required&#93; A string that uniquely identifies the job flow. This identifier is returned by RunJobFlow and can also be obtained from ListClusters.
#' @param Steps &#91;required&#93; A list of StepConfig to be executed by the job flow.
#'
#' @export
add_job_flow_steps <- function (JobFlowId, Steps) 
{
    op <- new_operation(name = "AddJobFlowSteps", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param ResourceId &#91;required&#93; The Amazon EMR resource identifier to which tags will be added. This value must be a cluster identifier.
#' @param Tags &#91;required&#93; A list of tags to associate with a cluster and propagate to EC2 instances. Tags are user-defined key/value pairs that consist of a required key string with a maximum of 128 characters, and an optional value string with a maximum of 256 characters.
#'
#' @export
...
{
    op <- new_operation(name = "CancelSteps", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param SecurityConfiguration &#91;required&#93; The security configuration details in JSON format. For JSON parameters and examples, see [Use Security Configurations to Set Up Cluster Security](http://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-security-configurations.html) in the *Amazon EMR Management Guide*.
#'
#' @export
...
#' ```
#' describe_job_flows(
#'   CreatedAfter = as.POSIXct("2015-01-01"),
#'   CreatedBefore = as.POSIXct("2015-01-01"),
#'   JobFlowIds = list(
#'     "string"
#'   ),
#'   JobFlowStates = list(
...
{
    op <- new_operation(name = "DescribeJobFlows", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeSecurityConfiguration", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeStep", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListBootstrapActions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListInstanceFleets", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListInstanceGroups", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListSecurityConfigurations", 
        http_method = "POST", http_path = "/", paginator = list())
...
list_steps <- function (ClusterId, StepStates = NULL, StepIds = NULL, 
    Marker = NULL) 
{
    op <- new_operation(name = "ListSteps", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyInstanceFleet", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyInstanceGroups", http_method = "POST", 
        http_path = "/", paginator = list())
...
put_auto_scaling_policy <- function (ClusterId, InstanceGroupId, 
    AutoScalingPolicy) 
{
    op <- new_operation(name = "PutAutoScalingPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RemoveAutoScalingPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param ResourceId &#91;required&#93; The Amazon EMR resource identifier from which tags will be removed. This value must be a cluster identifier.
...
#'
#' @export
run_job_flow <- function (Name, LogUri = NULL, AdditionalInfo = NULL, 
    AmiVersion = NULL, ReleaseLabel = NULL, Instances, Steps = NULL, 
    BootstrapActions = NULL, SupportedProducts = NULL, NewSupportedProducts = NULL, 
    Applications = NULL, Configurations = NULL, VisibleToAllUsers = NULL, 
    JobFlowRole = NULL, ServiceRole = NULL, Tags = NULL, SecurityConfiguration = NULL, 
...
{
    op <- new_operation(name = "RunJobFlow", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- run_job_flow_input(Name = Name, LogUri = LogUri, 
        AdditionalInfo = AdditionalInfo, AmiVersion = AmiVersion, 
        ...
        JobFlowRole = JobFlowRole, ServiceRole = ServiceRole, 
        Tags = Tags, SecurityConfiguration = SecurityConfiguration, 
...
#' ```
#'
#' @param JobFlowIds &#91;required&#93; A list of strings that uniquely identify the clusters to protect. This identifier is returned by RunJobFlow and can also be obtained from DescribeJobFlows .
...
{
    op <- new_operation(name = "SetTerminationProtection", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param VisibleToAllUsers &#91;required&#93; Whether the specified clusters are visible to all IAM users of the AWS account associated with the cluster. If this value is set to True, all IAM users of that AWS account can view and, if they have the proper IAM policy permissions set, manage the clusters. If it is set to False, only the IAM user that created a cluster can view and manage it.
#'
#' @export
set_visible_to_all_users <- function (JobFlowIds, VisibleToAllUsers) 
{
    op <- new_operation(name = "SetVisibleToAllUsers", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "TerminateJobFlows", http_method = "POST", 
        http_path = "/", paginator = list())
