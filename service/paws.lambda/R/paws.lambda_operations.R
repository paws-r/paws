...
{
    op <- new_operation(name = "CreateEventSourceMapping", http_method = "POST", 
...
{
    op <- new_operation(name = "DeleteAlias", http_method = "DELETE", 
...
#' \donttest{delete_event_source_mapping(
...
{
    op <- new_operation(name = "DeleteEventSourceMapping", http_method = "DELETE", 
...
{
    op <- new_operation(name = "DeleteFunctionConcurrency", http_method = "DELETE", 
...
{
    op <- new_operation(name = "GetAlias", http_method = "GET", 
        http_path = "/2015-03-31/functions/{FunctionName}/aliases/{Name}", 
        paginator = list())
...
#' \donttest{get_event_source_mapping(
...
{
    op <- new_operation(name = "GetEventSourceMapping", http_method = "GET", 
        http_path = "/2015-03-31/event-source-mappings/{UUID}", 
        paginator = list())
...
#' @examples
#' # This operation retrieves a Lambda function's event source mapping
#' \donttest{get_function_configuration(
#'   FunctionName = "myFunction",
#'   Qualifier = "1"
#' )}
#'
...
{
    op <- new_operation(name = "GetFunctionConfiguration", http_method = "GET", 
...
{
    op <- new_operation(name = "Invoke", http_method = "POST", 
...
{
    op <- new_operation(name = "InvokeAsync", http_method = "POST", 
...
{
    op <- new_operation(name = "ListAliases", http_method = "GET", 
        http_path = "/2015-03-31/functions/{FunctionName}/aliases", 
        paginator = list())
...
{
    op <- new_operation(name = "ListEventSourceMappings", http_method = "GET", 
        http_path = "/2015-03-31/event-source-mappings/", paginator = list())
...
list_versions_by_function <- function (FunctionName, Marker = NULL, 
    MaxItems = NULL) 
{
    op <- new_operation(name = "ListVersionsByFunction", http_method = "GET", 
...
{
    op <- new_operation(name = "PublishVersion", http_method = "POST", 
        http_path = "/2015-03-31/functions/{FunctionName}/versions", 
        paginator = list())
...
{
    op <- new_operation(name = "PutFunctionConcurrency", http_method = "PUT", 
        http_path = "/2017-10-31/functions/{FunctionName}/concurrency", 
        paginator = list())
...
remove_permission <- function (FunctionName, StatementId, Qualifier = NULL, 
    RevisionId = NULL) 
{
    op <- new_operation(name = "RemovePermission", http_method = "DELETE", 
...
{
    op <- new_operation(name = "UpdateAlias", http_method = "PUT", 
        http_path = "/2015-03-31/functions/{FunctionName}/aliases/{Name}", 
        paginator = list())
...
#' \donttest{update_event_source_mapping(
#'   BatchSize = 123L,
#'   Enabled = TRUE,
#'   FunctionName = "myFunction",
#'   UUID = "1234xCy789012"
...
{
    op <- new_operation(name = "UpdateEventSourceMapping", http_method = "PUT", 
        http_path = "/2015-03-31/event-source-mappings/{UUID}", 
        paginator = list())
...
{
    op <- new_operation(name = "UpdateFunctionCode", http_method = "PUT", 
