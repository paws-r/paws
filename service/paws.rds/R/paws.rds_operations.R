...
#' @param RoleArn The Amazon Resource Name (ARN) of the IAM role to associate with the Aurora DB cluster, for example `arn:aws:iam::123456789012:role/AuroraAccessRole`.
#'
#' @examples
#'
#' @export
...
#'
#' @export
authorize_db_security_group_ingress <- function (DBSecurityGroupName, 
    CIDRIP = NULL, EC2SecurityGroupName = NULL, EC2SecurityGroupId = NULL, 
    EC2SecurityGroupOwnerId = NULL) 
{
    op <- Operation(name = "AuthorizeDBSecurityGroupIngress", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- authorize_db_security_group_ingress_input(DBSecurityGroupName = DBSecurityGroupName, 
        CIDRIP = CIDRIP, EC2SecurityGroupName = EC2SecurityGroupName, 
        EC2SecurityGroupId = EC2SecurityGroupId, EC2SecurityGroupOwnerId = EC2SecurityGroupOwnerId)
    output <- authorize_db_security_group_ingress_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' Backtracks a DB cluster to a specific time, without creating a new DB cluster.
#' 
#' For more information on backtracking, see [Backtracking an Aurora DB Cluster](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Managing.Backtrack.html) in the *Amazon Aurora User Guide.*
#'
...
#' 
#' Example: `my-cluster1`
#' @param BacktrackTo The timestamp of the time to backtrack the DB cluster to, specified in ISO 8601 format. For more information about ISO 8601, see the [ISO8601 Wikipedia page.](http://en.wikipedia.org/wiki/ISO_8601)
#' 
...
#'
#' @export
backtrack_db_cluster <- function (DBClusterIdentifier, BacktrackTo, 
    Force = NULL, UseEarliestTimeOnPointInTimeUnavailable = NULL) 
{
    op <- Operation(name = "BacktrackDBCluster", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- backtrack_db_cluster_input(DBClusterIdentifier = DBClusterIdentifier, 
        BacktrackTo = BacktrackTo, Force = Force, UseEarliestTimeOnPointInTimeUnavailable = UseEarliestTimeOnPointInTimeUnavailable)
    output <- backtrack_db_cluster_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' 
#' For more information on copying encrypted DB cluster snapshots from one AWS Region to another, see [Copying a Snapshot](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_CopySnapshot.html) in the *Amazon Aurora User Guide.*
#' 
...
#' 
#' -   If the source snapshot is in a different AWS Region than the copy, specify a valid DB cluster snapshot ARN. For more information, go to [Copying Snapshots Across AWS Regions](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_CopySnapshot.html#USER_CopySnapshot.AcrossRegions) in the *Amazon Aurora User Guide.*
#' 
...
copy_db_cluster_snapshot <- function (SourceDBClusterSnapshotIdentifier, 
    ...
    CopyTags = NULL, Tags = NULL, SourceRegion = NULL) 
{
    ...
    input <- copy_db_cluster_snapshot_input(SourceDBClusterSnapshotIdentifier = SourceDBClusterSnapshotIdentifier, 
        ...
        Tags = Tags, SourceRegion = SourceRegion)
...
#'
#' @export
copy_db_snapshot <- function (SourceDBSnapshotIdentifier, TargetDBSnapshotIdentifier, 
    KmsKeyId = NULL, Tags = NULL, CopyTags = NULL, PreSignedUrl = NULL, 
    OptionGroupName = NULL, SourceRegion = NULL) 
{
    op <- Operation(name = "CopyDBSnapshot", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- copy_db_snapshot_input(SourceDBSnapshotIdentifier = SourceDBSnapshotIdentifier, 
        TargetDBSnapshotIdentifier = TargetDBSnapshotIdentifier, 
        KmsKeyId = KmsKeyId, Tags = Tags, CopyTags = CopyTags, 
        PreSignedUrl = PreSignedUrl, OptionGroupName = OptionGroupName, 
        SourceRegion = SourceRegion)
    output <- copy_db_snapshot_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' Copies the specified option group.
#'
#' @param SourceOptionGroupIdentifier The identifier or ARN for the source option group. For information about creating an ARN, see [Constructing an ARN for Amazon RDS](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Tagging.ARN.html#USER_Tagging.ARN.Constructing) in the *Amazon RDS User Guide*.
#' 
#' Constraints:
#' 
...
#'
#' @export
copy_option_group <- function (SourceOptionGroupIdentifier, TargetOptionGroupIdentifier, 
    TargetOptionGroupDescription, Tags = NULL) 
{
    op <- Operation(name = "CopyOptionGroup", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- copy_option_group_input(SourceOptionGroupIdentifier = SourceOptionGroupIdentifier, 
        TargetOptionGroupIdentifier = TargetOptionGroupIdentifier, 
        TargetOptionGroupDescription = TargetOptionGroupDescription, 
        Tags = Tags)
    output <- copy_option_group_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' @param AvailabilityZones A list of EC2 Availability Zones that instances in the DB cluster can be created in. For information on AWS Regions and Availability Zones, see [Choosing the Regions and Availability Zones](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Concepts.RegionsAndAvailabilityZones.html) in the *Amazon Aurora User Guide*.
...
#' 
#' The default is a 30-minute window selected at random from an 8-hour block of time for each AWS Region. To see the time blocks available, see [Adjusting the Preferred DB Cluster Maintenance Window](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_UpgradeDBInstance.Maintenance.html#AdjustingTheMaintenanceWindow.Aurora) in the *Amazon Aurora User Guide.*
#' 
#' Constraints:
#' 
...
#'
#' Creates a snapshot of a DB cluster. For more information on Amazon Aurora, see [What Is Amazon Aurora?](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/CHAP_AuroraOverview.html) in the *Amazon Aurora User Guide.*
#'
...
#' @param AvailabilityZone The EC2 Availability Zone that the DB instance is created in. For information on AWS Regions and Availability Zones, see [Regions and Availability Zones](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.RegionsAndAvailabilityZones.html).
#' 
...
#' @param PreferredMaintenanceWindow The time range each week during which system maintenance can occur, in Universal Coordinated Time (UTC). For more information, see [Amazon RDS Maintenance Window](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.Maintenance.html#Concepts.DBMaintenance).
#' 
#' Format: `ddd:hh24:mi-ddd:hh24:mi`
#' 
...
#' @param MonitoringRoleArn The ARN for the IAM role that permits RDS to send enhanced monitoring metrics to Amazon CloudWatch Logs. For example, `arn:aws:iam:123456789012:role/emaccess`. For information on creating a monitoring role, go to [Setting Up and Enabling Enhanced Monitoring](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Monitoring.OS.html#USER_Monitoring.OS.Enabling) in the *Amazon RDS User Guide*.
#' 
...
#' 
#' Valid Values: 0 - 15
#' @param Timezone The time zone of the DB instance. The time zone parameter is currently supported only by [Microsoft SQL Server](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_SQLServer.html#SQLServer.Concepts.General.TimeZone).
#' @param EnableIAMDatabaseAuthentication True to enable mapping of AWS Identity and Access Management (IAM) accounts to database accounts, and otherwise false.
#' 
...
#'
#' Creates a new DB instance that acts as a Read Replica for an existing source DB instance. You can create a Read Replica for a DB instance running MySQL, MariaDB, or PostgreSQL. For more information, see [Working with PostgreSQL, MySQL, and MariaDB Read Replicas](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ReadRepl.html) in the *Amazon RDS User Guide*.
#' 
...
#' 
#' Valid Values: `0, 1, 5, 10, 15, 30, 60`
#' @param MonitoringRoleArn The ARN for the IAM role that permits RDS to send enhanced monitoring metrics to Amazon CloudWatch Logs. For example, `arn:aws:iam:123456789012:role/emaccess`. For information on creating a monitoring role, go to [To create an IAM role for Amazon RDS Enhanced Monitoring](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Monitoring.html#USER_Monitoring.OS.IAMRole) in the *Amazon RDS User Guide*.
#' 
#' If `MonitoringInterval` is set to a value other than 0, then you must supply a `MonitoringRoleArn` value.
...
#' 
#' For more information, see [Using Amazon Performance Insights](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PerfInsights.html) in the *Amazon RDS User Guide*.
#' @param PerformanceInsightsKMSKeyId The AWS KMS key identifier for encryption of Performance Insights data. The KMS key ID is the Amazon Resource Name (ARN), KMS key identifier, or the KMS key alias for the KMS encryption key.
#' @param PerformanceInsightsRetentionPeriod The amount of time, in days, to retain Performance Insights data. Valid values are 7 or 731 (2 years).
#' @param EnableCloudwatchLogsExports The list of logs that the new DB instance is to export to CloudWatch Logs. The values in the list depend on the DB engine being used. For more information, see [Publishing Database Logs to Amazon CloudWatch Logs](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_LogAccess.html#USER_LogAccess.Procedural.UploadtoCloudWatch) in the *Amazon RDS User Guide*.
#' @param ProcessorFeatures The number of CPU cores and the number of threads per core for the DB instance class of the DB instance.
...
#'
#' @export
create_db_instance_read_replica <- function (DBInstanceIdentifier, 
...
{
    op <- Operation(name = "CreateDBInstanceReadReplica", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_db_instance_read_replica_input(DBInstanceIdentifier = DBInstanceIdentifier, 
        ...
        DeletionProtection = DeletionProtection, SourceRegion = SourceRegion)
    output <- create_db_instance_read_replica_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
create_db_security_group <- function (DBSecurityGroupName, DBSecurityGroupDescription, 
    Tags = NULL) 
{
    op <- Operation(name = "CreateDBSecurityGroup", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_db_security_group_input(DBSecurityGroupName = DBSecurityGroupName, 
        DBSecurityGroupDescription = DBSecurityGroupDescription, 
        Tags = Tags)
    output <- create_db_security_group_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' @param DBInstanceIdentifier The identifier of the DB instance that you want to create the snapshot of.
#' 
#' Constraints:
#' 
...
#'
#' @export
create_db_snapshot <- function (DBSnapshotIdentifier, DBInstanceIdentifier, 
    Tags = NULL) 
{
    op <- Operation(name = "CreateDBSnapshot", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_db_snapshot_input(DBSnapshotIdentifier = DBSnapshotIdentifier, 
        DBInstanceIdentifier = DBInstanceIdentifier, Tags = Tags)
    output <- create_db_snapshot_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' @param EventCategories A list of event categories for a SourceType that you want to subscribe to. You can see a list of the categories for a given SourceType in the [Events](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Events.html) topic in the *Amazon RDS User Guide* or by using the **DescribeEventCategories** action.
...
#'
#' @export
create_option_group <- function (OptionGroupName, EngineName, 
    MajorEngineVersion, OptionGroupDescription, Tags = NULL) 
{
    op <- Operation(name = "CreateOptionGroup", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_option_group_input(OptionGroupName = OptionGroupName, 
        EngineName = EngineName, MajorEngineVersion = MajorEngineVersion, 
        OptionGroupDescription = OptionGroupDescription, Tags = Tags)
    output <- create_option_group_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
delete_db_security_group <- function (DBSecurityGroupName) 
{
    op <- Operation(name = "DeleteDBSecurityGroup", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- delete_db_security_group_input(DBSecurityGroupName = DBSecurityGroupName)
    output <- delete_db_security_group_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
delete_db_snapshot <- function (DBSnapshotIdentifier) 
{
    op <- Operation(name = "DeleteDBSnapshot", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- delete_db_snapshot_input(DBSnapshotIdentifier = DBSnapshotIdentifier)
    output <- delete_db_snapshot_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
delete_option_group <- function (OptionGroupName) 
{
    op <- Operation(name = "DeleteOptionGroup", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- delete_option_group_input(OptionGroupName = OptionGroupName)
    output <- delete_option_group_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
describe_certificates <- function (CertificateIdentifier = NULL, 
    Filters = NULL, MaxRecords = NULL, Marker = NULL) 
{
    op <- Operation(name = "DescribeCertificates", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_certificates_input(CertificateIdentifier = CertificateIdentifier, 
...
#'
#' @export
describe_db_cluster_backtracks <- function (DBClusterIdentifier, 
    BacktrackIdentifier = NULL, Filters = NULL, MaxRecords = NULL, 
    Marker = NULL) 
{
    op <- Operation(name = "DescribeDBClusterBacktracks", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_db_cluster_backtracks_input(DBClusterIdentifier = DBClusterIdentifier, 
...
#'
#' @export
describe_db_log_files <- function (DBInstanceIdentifier, FilenameContains = NULL, 
    FileLastWritten = NULL, FileSize = NULL, Filters = NULL, 
    MaxRecords = NULL, Marker = NULL) 
{
    op <- Operation(name = "DescribeDBLogFiles", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_db_log_files_input(DBInstanceIdentifier = DBInstanceIdentifier, 
        FilenameContains = FilenameContains, FileLastWritten = FileLastWritten, 
        FileSize = FileSize, Filters = Filters, MaxRecords = MaxRecords, 
        Marker = Marker)
    output <- describe_db_log_files_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
describe_db_security_groups <- function (DBSecurityGroupName = NULL, 
    Filters = NULL, MaxRecords = NULL, Marker = NULL) 
{
    op <- Operation(name = "DescribeDBSecurityGroups", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_db_security_groups_input(DBSecurityGroupName = DBSecurityGroupName, 
        Filters = Filters, MaxRecords = MaxRecords, Marker = Marker)
    output <- describe_db_security_groups_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
describe_db_snapshot_attributes <- function (DBSnapshotIdentifier) 
{
    op <- Operation(name = "DescribeDBSnapshotAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_db_snapshot_attributes_input(DBSnapshotIdentifier = DBSnapshotIdentifier)
    output <- describe_db_snapshot_attributes_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
{
    op <- Operation(name = "DescribeDBSnapshots", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' Describes all available options.
#'
#' @param EngineName A required parameter. Options available for the given engine name are described.
...
#'
#' @export
describe_option_group_options <- function (EngineName, MajorEngineVersion = NULL, 
    Filters = NULL, MaxRecords = NULL, Marker = NULL) 
{
    op <- Operation(name = "DescribeOptionGroupOptions", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_option_group_options_input(EngineName = EngineName, 
        MajorEngineVersion = MajorEngineVersion, Filters = Filters, 
        MaxRecords = MaxRecords, Marker = Marker)
    output <- describe_option_group_options_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
describe_option_groups <- function (OptionGroupName = NULL, Filters = NULL, 
    Marker = NULL, MaxRecords = NULL, EngineName = NULL, MajorEngineVersion = NULL) 
{
    op <- Operation(name = "DescribeOptionGroups", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_option_groups_input(OptionGroupName = OptionGroupName, 
        Filters = Filters, Marker = Marker, MaxRecords = MaxRecords, 
        EngineName = EngineName, MajorEngineVersion = MajorEngineVersion)
    output <- describe_option_groups_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
describe_reserved_db_instances <- function (ReservedDBInstanceId = NULL, 
    ReservedDBInstancesOfferingId = NULL, DBInstanceClass = NULL, 
    Duration = NULL, ProductDescription = NULL, OfferingType = NULL, 
    MultiAZ = NULL, Filters = NULL, MaxRecords = NULL, Marker = NULL) 
{
    op <- Operation(name = "DescribeReservedDBInstances", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_reserved_db_instances_input(ReservedDBInstanceId = ReservedDBInstanceId, 
        ...
        Marker = Marker)
    output <- describe_reserved_db_instances_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
describe_reserved_db_instances_offerings <- function (ReservedDBInstancesOfferingId = NULL, 
    DBInstanceClass = NULL, Duration = NULL, ProductDescription = NULL, 
    OfferingType = NULL, MultiAZ = NULL, Filters = NULL, MaxRecords = NULL, 
    Marker = NULL) 
{
    op <- Operation(name = "DescribeReservedDBInstancesOfferings", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- describe_reserved_db_instances_offerings_input(ReservedDBInstancesOfferingId = ReservedDBInstancesOfferingId, 
        DBInstanceClass = DBInstanceClass, Duration = Duration, 
        ProductDescription = ProductDescription, OfferingType = OfferingType, 
        MultiAZ = MultiAZ, Filters = Filters, MaxRecords = MaxRecords, 
        Marker = Marker)
    output <- describe_reserved_db_instances_offerings_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
describe_source_regions <- function (RegionName = NULL, MaxRecords = NULL, 
    Marker = NULL, Filters = NULL) 
{
    op <- Operation(name = "DescribeSourceRegions", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_source_regions_input(RegionName = RegionName, 
        MaxRecords = MaxRecords, Marker = Marker, Filters = Filters)
    output <- describe_source_regions_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
download_db_log_file_portion <- function (DBInstanceIdentifier, 
    LogFileName, Marker = NULL, NumberOfLines = NULL) 
{
    op <- Operation(name = "DownloadDBLogFilePortion", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- download_db_log_file_portion_input(DBInstanceIdentifier = DBInstanceIdentifier, 
        LogFileName = LogFileName, Marker = Marker, NumberOfLines = NumberOfLines)
    output <- download_db_log_file_portion_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' Lists all tags on an Amazon RDS resource.
#' 
#' For an overview on tagging an Amazon RDS resource, see [Tagging Amazon RDS Resources](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Overview.Tagging.html) in the *Amazon RDS User Guide*.
#'
...
#' 
#' If you call `ModifyCurrentDBClusterCapacity` with the default `TimeoutAction`, connections that prevent Aurora Serverless from finding a scaling point might be dropped. For more information about scaling points, see [Autoscaling for Aurora Serverless](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-serverless.how-it-works.html#aurora-serverless.how-it-works.auto-scaling) in the *Amazon Aurora User Guide*.
#'
...
#'
#' @export
modify_current_db_cluster_capacity <- function (DBClusterIdentifier, 
    Capacity = NULL, SecondsBeforeTimeout = NULL, TimeoutAction = NULL) 
{
    op <- Operation(name = "ModifyCurrentDBClusterCapacity", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- modify_current_db_cluster_capacity_input(DBClusterIdentifier = DBClusterIdentifier, 
        Capacity = Capacity, SecondsBeforeTimeout = SecondsBeforeTimeout, 
        TimeoutAction = TimeoutAction)
    output <- modify_current_db_cluster_capacity_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' @param DBSubnetGroupName The new DB subnet group for the DB instance. You can use this parameter to move your DB instance to a different VPC. If your DB instance is not in a VPC, you can also use this parameter to move your DB instance into a VPC. For more information, see [Updating the VPC for a DB Instance](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_VPC.WorkingWithRDSInstanceinaVPC.html#USER_VPC.Non-VPC2VPC) in the *Amazon RDS User Guide.*
#' 
...
modify_db_instance <- function (DBInstanceIdentifier, AllocatedStorage = NULL, 
    ...
    EnablePerformanceInsights = NULL, PerformanceInsightsKMSKeyId = NULL, 
    PerformanceInsightsRetentionPeriod = NULL, CloudwatchLogsExportConfiguration = NULL, 
    ProcessorFeatures = NULL, UseDefaultProcessorFeatures = NULL, 
    DeletionProtection = NULL) 
{
...
#' 
#' You can specify this parameter when you upgrade an Oracle DB snapshot. The same option group considerations apply when upgrading a DB snapshot as when upgrading a DB instance. For more information, see [Option Group Considerations](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.Oracle.html#USER_UpgradeDBInstance.Oracle.OGPG.OG) in the *Amazon RDS User Guide.*
#'
#' @examples
#'
#' @export
modify_db_snapshot <- function (DBSnapshotIdentifier, EngineVersion = NULL, 
    OptionGroupName = NULL) 
{
    op <- Operation(name = "ModifyDBSnapshot", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- modify_db_snapshot_input(DBSnapshotIdentifier = DBSnapshotIdentifier, 
        EngineVersion = EngineVersion, OptionGroupName = OptionGroupName)
    output <- modify_db_snapshot_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
modify_db_snapshot_attribute <- function (DBSnapshotIdentifier, 
    AttributeName, ValuesToAdd = NULL, ValuesToRemove = NULL) 
{
    op <- Operation(name = "ModifyDBSnapshotAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- modify_db_snapshot_attribute_input(DBSnapshotIdentifier = DBSnapshotIdentifier, 
        AttributeName = AttributeName, ValuesToAdd = ValuesToAdd, 
        ValuesToRemove = ValuesToRemove)
    output <- modify_db_snapshot_attribute_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
modify_option_group <- function (OptionGroupName, OptionsToInclude = NULL, 
    OptionsToRemove = NULL, ApplyImmediately = NULL) 
{
    op <- Operation(name = "ModifyOptionGroup", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- modify_option_group_input(OptionGroupName = OptionGroupName, 
        OptionsToInclude = OptionsToInclude, OptionsToRemove = OptionsToRemove, 
        ApplyImmediately = ApplyImmediately)
    output <- modify_option_group_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
promote_read_replica <- function (DBInstanceIdentifier, BackupRetentionPeriod = NULL, 
    PreferredBackupWindow = NULL) 
{
    op <- Operation(name = "PromoteReadReplica", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- promote_read_replica_input(DBInstanceIdentifier = DBInstanceIdentifier, 
        BackupRetentionPeriod = BackupRetentionPeriod, PreferredBackupWindow = PreferredBackupWindow)
    output <- promote_read_replica_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
purchase_reserved_db_instances_offering <- function (ReservedDBInstancesOfferingId, 
    ReservedDBInstanceId = NULL, DBInstanceCount = NULL, Tags = NULL) 
{
    op <- Operation(name = "PurchaseReservedDBInstancesOffering", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- purchase_reserved_db_instances_offering_input(ReservedDBInstancesOfferingId = ReservedDBInstancesOfferingId, 
        ReservedDBInstanceId = ReservedDBInstanceId, DBInstanceCount = DBInstanceCount, 
        Tags = Tags)
    output <- purchase_reserved_db_instances_offering_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' 
#' For more information about rebooting, see [Rebooting a DB Instance](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_RebootInstance.html) in the *Amazon RDS User Guide.*
#'
#' @param DBInstanceIdentifier The DB instance identifier. This parameter is stored as a lowercase string.
#' 
#' Constraints:
...
#' @param RoleArn The Amazon Resource Name (ARN) of the IAM role to disassociate from the Aurora DB cluster, for example `arn:aws:iam::123456789012:role/AuroraAccessRole`.
#'
#' @examples
#'
#' @export
...
#' Removes a source identifier from an existing RDS event notification subscription.
#'
#' @param SubscriptionName The name of the RDS event notification subscription you want to remove a source identifier from.
...
#' For an overview on tagging an Amazon RDS resource, see [Tagging Amazon RDS Resources](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Overview.Tagging.html) in the *Amazon RDS User Guide.*
#'
#' @param ResourceName The Amazon RDS resource that the tags are removed from. This value is an Amazon Resource Name (ARN). For information about creating an ARN, see [Constructing an ARN for Amazon RDS](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Tagging.ARN.html#USER_Tagging.ARN.Constructing) in the *Amazon RDS User Guide.*
...
#'
#' @param DBClusterIdentifier The name of the DB cluster to create from the source data in the Amazon S3 bucket. This parameter is isn\'t case-sensitive.
#' 
#' Constraints:
#' 
#' -   Must contain from 1 to 63 letters, numbers, or hyphens.
...
#' 
#' Example: `my-cluster1`
#' @param Engine The name of the database engine to be used for the restored DB cluster.
#' 
...
#' 
#' Example: `5.6.22`
#' @param S3BucketName The name of the Amazon S3 bucket that contains the data used to create the Amazon Aurora DB cluster.
#' @param S3IngestionRoleArn The Amazon Resource Name (ARN) of the AWS Identity and Access Management (IAM) role that authorizes Amazon RDS to access the Amazon S3 bucket on your behalf.
...
#' @param PreferredBackupWindow The daily time range during which automated backups are created if automated backups are enabled using the `BackupRetentionPeriod` parameter.
#' 
#' The default is a 30-minute window selected at random from an 8-hour block of time for each AWS Region. To see the time blocks available, see [Adjusting the Preferred Maintenance Window](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_UpgradeDBInstance.Maintenance.html#AdjustingTheMaintenanceWindow.Aurora) in the *Amazon Aurora User Guide.*
#' 
#' Constraints:
#' 
#' -   Must be in the format `hh24:mi-hh24:mi`.
...
#'
#' @export
restore_db_cluster_from_s3 <- function (DBClusterIdentifier, 
    Engine, MasterUsername, MasterUserPassword, SourceEngine, 
    SourceEngineVersion, S3BucketName, S3IngestionRoleArn, AvailabilityZones = NULL, 
    BackupRetentionPeriod = NULL, CharacterSetName = NULL, DatabaseName = NULL, 
    DBClusterParameterGroupName = NULL, VpcSecurityGroupIds = NULL, 
    DBSubnetGroupName = NULL, EngineVersion = NULL, Port = NULL, 
    OptionGroupName = NULL, PreferredBackupWindow = NULL, PreferredMaintenanceWindow = NULL, 
    Tags = NULL, StorageEncrypted = NULL, KmsKeyId = NULL, EnableIAMDatabaseAuthentication = NULL, 
    S3Prefix = NULL, BacktrackWindow = NULL, EnableCloudwatchLogsExports = NULL, 
    DeletionProtection = NULL) 
{
    op <- Operation(name = "RestoreDBClusterFromS3", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- restore_db_cluster_from_s3_input(DBClusterIdentifier = DBClusterIdentifier, 
        Engine = Engine, MasterUsername = MasterUsername, MasterUserPassword = MasterUserPassword, 
        SourceEngine = SourceEngine, SourceEngineVersion = SourceEngineVersion, 
        S3BucketName = S3BucketName, S3IngestionRoleArn = S3IngestionRoleArn, 
        AvailabilityZones = AvailabilityZones, BackupRetentionPeriod = BackupRetentionPeriod, 
        CharacterSetName = CharacterSetName, DatabaseName = DatabaseName, 
        DBClusterParameterGroupName = DBClusterParameterGroupName, 
        VpcSecurityGroupIds = VpcSecurityGroupIds, DBSubnetGroupName = DBSubnetGroupName, 
        EngineVersion = EngineVersion, Port = Port, OptionGroupName = OptionGroupName, 
        PreferredBackupWindow = PreferredBackupWindow, PreferredMaintenanceWindow = PreferredMaintenanceWindow, 
        Tags = Tags, StorageEncrypted = StorageEncrypted, KmsKeyId = KmsKeyId, 
        EnableIAMDatabaseAuthentication = EnableIAMDatabaseAuthentication, 
        S3Prefix = S3Prefix, BacktrackWindow = BacktrackWindow, 
        EnableCloudwatchLogsExports = EnableCloudwatchLogsExports, 
        DeletionProtection = DeletionProtection)
    output <- restore_db_cluster_from_s3_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' 
#' -   If specified, this value must be set to a number from 0 to 259,200 (72 hours).
#' @param EnableCloudwatchLogsExports The list of logs that the restored DB cluster is to export to Amazon CloudWatch Logs. The values in the list depend on the DB engine being used. For more information, see [Publishing Database Logs to Amazon CloudWatch Logs](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_LogAccess.html#USER_LogAccess.Procedural.UploadtoCloudWatch) in the *Amazon Aurora User Guide*.
#' @param EngineMode The DB engine mode of the DB cluster, either `provisioned`, `serverless`, or `parallelquery`.
#' @param ScalingConfiguration For DB clusters in `serverless` DB engine mode, the scaling properties of the DB cluster.
...
restore_db_cluster_from_snapshot <- function (DBClusterIdentifier, 
    ...
    BacktrackWindow = NULL, EnableCloudwatchLogsExports = NULL, 
    EngineMode = NULL, ScalingConfiguration = NULL, DBClusterParameterGroupName = NULL, 
    DeletionProtection = NULL) 
{
...
restore_db_cluster_to_point_in_time <- function (DBClusterIdentifier, 
    ...
    KmsKeyId = NULL, EnableIAMDatabaseAuthentication = NULL, 
    BacktrackWindow = NULL, EnableCloudwatchLogsExports = NULL, 
    DBClusterParameterGroupName = NULL, DeletionProtection = NULL) 
{
...
#' 
#' The provisioned IOPS value must follow the requirements for your database engine. For more information, see [Amazon RDS Provisioned IOPS Storage to Improve Performance](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_Storage.html#USER_PIOPS) in the *Amazon RDS User Guide.*
#' 
...
#' 
#' Default: `false`
#' @param EnableCloudwatchLogsExports The list of logs that the restored DB instance is to export to CloudWatch Logs. The values in the list depend on the DB engine being used. For more information, see [Publishing Database Logs to Amazon CloudWatch Logs](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_LogAccess.html#USER_LogAccess.Procedural.UploadtoCloudWatch) in the *Amazon Aurora User Guide*.
#' @param ProcessorFeatures The number of CPU cores and the number of threads per core for the DB instance class of the DB instance.
#' @param UseDefaultProcessorFeatures A value that specifies that the DB instance class of the DB instance uses its default processor features.
#' @param DBParameterGroupName The name of the DB parameter group to associate with this DB instance. If this argument is omitted, the default DBParameterGroup for the specified engine is used.
#' 
...
#'
#' @export
restore_db_instance_from_db_snapshot <- function (DBInstanceIdentifier, 
    ...
    DeletionProtection = NULL) 
{
    op <- Operation(name = "RestoreDBInstanceFromDBSnapshot", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- restore_db_instance_from_db_snapshot_input(DBInstanceIdentifier = DBInstanceIdentifier, 
        DBSnapshotIdentifier = DBSnapshotIdentifier, DBInstanceClass = DBInstanceClass, 
        Port = Port, AvailabilityZone = AvailabilityZone, DBSubnetGroupName = DBSubnetGroupName, 
    ...
    output <- restore_db_instance_from_db_snapshot_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' Amazon Relational Database Service (Amazon RDS) supports importing MySQL databases by using backup files. You can create a backup of your on-premises database, store it on Amazon Simple Storage Service (Amazon S3), and then restore the backup file onto a new Amazon RDS DB instance running MySQL. For more information, see [Importing Data into an Amazon RDS MySQL DB Instance](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/MySQL.Procedural.Importing.html) in the *Amazon RDS User Guide.*
#'
#' @param DBInstanceIdentifier The DB instance identifier. This parameter is stored as a lowercase string.
#' 
#' Constraints:
...
#' 
#' Valid Values: `mysql`
#' @param SourceEngine The name of the engine of your source database.
#' 
#' Valid Values: `mysql`
#' @param SourceEngineVersion The engine version of your source database.
#' 
#' Valid Values: `5.6`
#' @param S3BucketName The name of your Amazon S3 bucket that contains your database backup file.
#' @param S3IngestionRoleArn An AWS Identity and Access Management (IAM) role to allow Amazon RDS to access your Amazon S3 bucket.
...
#' @param AvailabilityZone The Availability Zone that the DB instance is created in. For information about AWS Regions and Availability Zones, see [Regions and Availability Zones](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.RegionsAndAvailabilityZones.html) in the *Amazon RDS User Guide.*
#' 
#' Default: A random, system-chosen Availability Zone in the endpoint\'s AWS Region.
#' 
#' Example: `us-east-1d`
...
#' Constraint: The AvailabilityZone parameter can\'t be specified if the MultiAZ parameter is set to `true`. The specified Availability Zone must be in the same AWS Region as the current endpoint.
#' @param DBSubnetGroupName A DB subnet group to associate with this DB instance.
#' @param PreferredMaintenanceWindow The time range each week during which system maintenance can occur, in Universal Coordinated Time (UTC). For more information, see [Amazon RDS Maintenance Window](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.Maintenance.html#Concepts.DBMaintenance) in the *Amazon RDS User Guide.*
#' 
#' Constraints:
#' 
...
#' @param Iops The amount of Provisioned IOPS (input/output operations per second) to allocate initially for the DB instance. For information about valid Iops values, see see [Amazon RDS Provisioned IOPS Storage to Improve Performance](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_Storage.html#USER_PIOPS) in the *Amazon RDS User Guide.*
...
#' @param PubliclyAccessible Specifies the accessibility options for the DB instance. A value of true specifies an Internet-facing instance with a publicly resolvable DNS name, which resolves to a public IP address. A value of false specifies an internal instance with a DNS name that resolves to a private IP address. For more information, see CreateDBInstance.
#' @param Tags A list of tags to associate with this DB instance. For more information, see [Tagging Amazon RDS Resources](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Tagging.html) in the *Amazon RDS User Guide.*
#' @param StorageType Specifies the storage type to be associated with the DB instance.
#' 
#' Valid values: `standard` \| `gp2` \| `io1`
#' 
...
#' 
#' Default: `0`
#' @param MonitoringRoleArn The ARN for the IAM role that permits RDS to send enhanced monitoring metrics to Amazon CloudWatch Logs. For example, `arn:aws:iam:123456789012:role/emaccess`. For information on creating a monitoring role, see [Setting Up and Enabling Enhanced Monitoring](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Monitoring.OS.html#USER_Monitoring.OS.Enabling) in the *Amazon RDS User Guide.*
#' 
#' If `MonitoringInterval` is set to a value other than 0, then you must supply a `MonitoringRoleArn` value.
#' @param EnableIAMDatabaseAuthentication True to enable mapping of AWS Identity and Access Management (IAM) accounts to database accounts, and otherwise false.
#' 
...
#' @param PerformanceInsightsRetentionPeriod The amount of time, in days, to retain Performance Insights data. Valid values are 7 or 731 (2 years).
#' @param EnableCloudwatchLogsExports The list of logs that the restored DB instance is to export to CloudWatch Logs. The values in the list depend on the DB engine being used. For more information, see [Publishing Database Logs to Amazon CloudWatch Logs](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_LogAccess.html#USER_LogAccess.Procedural.UploadtoCloudWatch) in the *Amazon RDS User Guide*.
#' @param ProcessorFeatures The number of CPU cores and the number of threads per core for the DB instance class of the DB instance.
#' @param UseDefaultProcessorFeatures A value that specifies that the DB instance class of the DB instance uses its default processor features.
#' @param DeletionProtection Indicates if the DB instance should have deletion protection enabled. The database can\'t be deleted when this value is set to true. The default is false. For more information, see [Deleting a DB Instance](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_DeleteInstance.html).
#'
...
#'
#' @export
restore_db_instance_from_s3 <- function (DBInstanceIdentifier, 
    DBInstanceClass, Engine, SourceEngine, SourceEngineVersion, 
    S3BucketName, S3IngestionRoleArn, DBName = NULL, AllocatedStorage = NULL, 
    MasterUsername = NULL, MasterUserPassword = NULL, DBSecurityGroups = NULL, 
    VpcSecurityGroupIds = NULL, AvailabilityZone = NULL, DBSubnetGroupName = NULL, 
    PreferredMaintenanceWindow = NULL, DBParameterGroupName = NULL, 
    BackupRetentionPeriod = NULL, PreferredBackupWindow = NULL, 
    Port = NULL, MultiAZ = NULL, EngineVersion = NULL, AutoMinorVersionUpgrade = NULL, 
    LicenseModel = NULL, Iops = NULL, OptionGroupName = NULL, 
    PubliclyAccessible = NULL, Tags = NULL, StorageType = NULL, 
    StorageEncrypted = NULL, KmsKeyId = NULL, CopyTagsToSnapshot = NULL, 
    MonitoringInterval = NULL, MonitoringRoleArn = NULL, EnableIAMDatabaseAuthentication = NULL, 
    S3Prefix = NULL, EnablePerformanceInsights = NULL, PerformanceInsightsKMSKeyId = NULL, 
    PerformanceInsightsRetentionPeriod = NULL, EnableCloudwatchLogsExports = NULL, 
    ProcessorFeatures = NULL, UseDefaultProcessorFeatures = NULL, 
    DeletionProtection = NULL) 
{
    op <- Operation(name = "RestoreDBInstanceFromS3", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- restore_db_instance_from_s3_input(DBInstanceIdentifier = DBInstanceIdentifier, 
        DBInstanceClass = DBInstanceClass, Engine = Engine, SourceEngine = SourceEngine, 
        SourceEngineVersion = SourceEngineVersion, S3BucketName = S3BucketName, 
        S3IngestionRoleArn = S3IngestionRoleArn, DBName = DBName, 
        AllocatedStorage = AllocatedStorage, MasterUsername = MasterUsername, 
        MasterUserPassword = MasterUserPassword, DBSecurityGroups = DBSecurityGroups, 
        VpcSecurityGroupIds = VpcSecurityGroupIds, AvailabilityZone = AvailabilityZone, 
        DBSubnetGroupName = DBSubnetGroupName, PreferredMaintenanceWindow = PreferredMaintenanceWindow, 
        ...
        StorageType = StorageType, StorageEncrypted = StorageEncrypted, 
        KmsKeyId = KmsKeyId, CopyTagsToSnapshot = CopyTagsToSnapshot, 
        MonitoringInterval = MonitoringInterval, MonitoringRoleArn = MonitoringRoleArn, 
        EnableIAMDatabaseAuthentication = EnableIAMDatabaseAuthentication, 
        S3Prefix = S3Prefix, EnablePerformanceInsights = EnablePerformanceInsights, 
        PerformanceInsightsKMSKeyId = PerformanceInsightsKMSKeyId, 
        PerformanceInsightsRetentionPeriod = PerformanceInsightsRetentionPeriod, 
        EnableCloudwatchLogsExports = EnableCloudwatchLogsExports, 
        ProcessorFeatures = ProcessorFeatures, UseDefaultProcessorFeatures = UseDefaultProcessorFeatures, 
        DeletionProtection = DeletionProtection)
    output <- restore_db_instance_from_s3_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
{
    op <- Operation(name = "RestoreDBInstanceToPointInTime", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- restore_db_instance_to_point_in_time_input(SourceDBInstanceIdentifier = SourceDBInstanceIdentifier, 
        TargetDBInstanceIdentifier = TargetDBInstanceIdentifier, 
        RestoreTime = RestoreTime, UseLatestRestorableTime = UseLatestRestorableTime, 
        DBInstanceClass = DBInstanceClass, Port = Port, AvailabilityZone = AvailabilityZone, 
        DBSubnetGroupName = DBSubnetGroupName, MultiAZ = MultiAZ, 
        PubliclyAccessible = PubliclyAccessible, AutoMinorVersionUpgrade = AutoMinorVersionUpgrade, 
...
#'
#' @export
revoke_db_security_group_ingress <- function (DBSecurityGroupName, 
    CIDRIP = NULL, EC2SecurityGroupName = NULL, EC2SecurityGroupId = NULL, 
    EC2SecurityGroupOwnerId = NULL) 
{
    op <- Operation(name = "RevokeDBSecurityGroupIngress", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- revoke_db_security_group_ingress_input(DBSecurityGroupName = DBSecurityGroupName, 
        CIDRIP = CIDRIP, EC2SecurityGroupName = EC2SecurityGroupName, 
        EC2SecurityGroupId = EC2SecurityGroupId, EC2SecurityGroupOwnerId = EC2SecurityGroupOwnerId)
    output <- revoke_db_security_group_ingress_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' Starts an Amazon Aurora DB cluster that was stopped using the AWS console, the stop-db-cluster AWS CLI command, or the StopDBCluster action.
#' 
#' For more information, see [Stopping and Starting an Aurora Cluster](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-cluster-stop-start.html) in the *Amazon Aurora User Guide.*
#'
#' @param DBClusterIdentifier The DB cluster identifier of the Amazon Aurora DB cluster to be started. This parameter is stored as a lowercase string.
#'
#' @examples
#'
#' @export
start_db_cluster <- function (DBClusterIdentifier) 
{
    op <- Operation(name = "StartDBCluster", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- start_db_cluster_input(DBClusterIdentifier = DBClusterIdentifier)
    output <- start_db_cluster_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
start_db_instance <- function (DBInstanceIdentifier) 
{
    op <- Operation(name = "StartDBInstance", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- start_db_instance_input(DBInstanceIdentifier = DBInstanceIdentifier)
    output <- start_db_instance_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' For more information, see [Stopping and Starting an Aurora Cluster](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-cluster-stop-start.html) in the *Amazon Aurora User Guide.*
#'
#' @param DBClusterIdentifier The DB cluster identifier of the Amazon Aurora DB cluster to be stopped. This parameter is stored as a lowercase string.
#'
#' @examples
#'
#' @export
stop_db_cluster <- function (DBClusterIdentifier) 
{
    op <- Operation(name = "StopDBCluster", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- stop_db_cluster_input(DBClusterIdentifier = DBClusterIdentifier)
    output <- stop_db_cluster_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' 
#' For more information, see [Stopping an Amazon RDS DB Instance Temporarily](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_StopInstance.html) in the *Amazon RDS User Guide.*
#' 
...
#'
#' @export
stop_db_instance <- function (DBInstanceIdentifier, DBSnapshotIdentifier = NULL) 
{
    op <- Operation(name = "StopDBInstance", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- stop_db_instance_input(DBInstanceIdentifier = DBInstanceIdentifier, 
        DBSnapshotIdentifier = DBSnapshotIdentifier)
    output <- stop_db_instance_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
