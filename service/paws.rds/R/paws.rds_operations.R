...
{
    op <- new_operation(name = "AuthorizeDBSecurityGroupIngress", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "BacktrackDBCluster", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CopyDBSnapshot", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CopyOptionGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
create_db_security_group <- function (DBSecurityGroupName, DBSecurityGroupDescription, 
    Tags = NULL) 
{
    op <- new_operation(name = "CreateDBSecurityGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
create_db_snapshot <- function (DBSnapshotIdentifier, DBInstanceIdentifier, 
    Tags = NULL) 
{
    op <- new_operation(name = "CreateDBSnapshot", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateOptionGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteDBSecurityGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteDBSnapshot", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteOptionGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_db_cluster_backtracks <- function (DBClusterIdentifier, 
    ...
    Marker = NULL) 
{
    op <- new_operation(name = "DescribeDBClusterBacktracks", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeDBLogFiles", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_db_security_groups <- function (DBSecurityGroupName = NULL, 
    Filters = NULL, MaxRecords = NULL, Marker = NULL) 
{
    op <- new_operation(name = "DescribeDBSecurityGroups", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeDBSnapshotAttributes", 
        http_method = "POST", http_path = "/", paginator = list())
...
describe_option_group_options <- function (EngineName, MajorEngineVersion = NULL, 
    Filters = NULL, MaxRecords = NULL, Marker = NULL) 
{
    op <- new_operation(name = "DescribeOptionGroupOptions", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeOptionGroups", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeReservedDBInstances", 
        http_method = "POST", http_path = "/", paginator = list())
...
describe_reserved_db_instances_offerings <- function (ReservedDBInstancesOfferingId = NULL, 
    ...
    Marker = NULL) 
{
    op <- new_operation(name = "DescribeReservedDBInstancesOfferings", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeSourceRegions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DownloadDBLogFilePortion", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyCurrentDBClusterCapacity", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyDBSnapshot", http_method = "POST", 
        http_path = "/", paginator = list())
...
modify_db_snapshot_attribute <- function (DBSnapshotIdentifier, 
    AttributeName, ValuesToAdd = NULL, ValuesToRemove = NULL) 
{
    op <- new_operation(name = "ModifyDBSnapshotAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyOptionGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PromoteReadReplica", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PurchaseReservedDBInstancesOffering", 
        http_method = "POST", http_path = "/", paginator = list())
...
restore_db_cluster_from_s3 <- function (AvailabilityZones = NULL, 
    ...
    DeletionProtection = NULL) 
{
    op <- new_operation(name = "RestoreDBClusterFromS3", http_method = "POST", 
        http_path = "/", paginator = list())
...
restore_db_instance_from_s3 <- function (DBName = NULL, DBInstanceIdentifier, 
    ...
    DeletionProtection = NULL) 
{
    op <- new_operation(name = "RestoreDBInstanceFromS3", http_method = "POST", 
        http_path = "/", paginator = list())
...
revoke_db_security_group_ingress <- function (DBSecurityGroupName, 
    ...
    EC2SecurityGroupOwnerId = NULL) 
{
    op <- new_operation(name = "RevokeDBSecurityGroupIngress", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StartDBCluster", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StartDBInstance", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StopDBCluster", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StopDBInstance", http_method = "POST", 
        http_path = "/", paginator = list())
