...
#'   DBClusterIdentifier = "string",
#'   BacktrackTo = as.POSIXct("2015-01-01"),
#'   Force = TRUE|FALSE,
...
#' 
#' Example: `my-cluster1`
#' @param BacktrackTo &#91;required&#93; The timestamp of the time to backtrack the DB cluster to, specified in ISO 8601 format. For more information about ISO 8601, see the [ISO8601 Wikipedia page.](http://en.wikipedia.org/wiki/ISO_8601)
#' 
...
#' )
#'
#' @param SourceOptionGroupIdentifier &#91;required&#93; The identifier or ARN for the source option group. For information about creating an ARN, see [Constructing an ARN for Amazon RDS](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Tagging.ARN.html#USER_Tagging.ARN.Constructing) in the *Amazon RDS User Guide*.
#' 
#' Constraints:
#' 
...
{
    op <- Operation(name = "CreateDBClusterEndpoint", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param SourceDBInstanceIdentifier &#91;required&#93; The identifier of the DB instance that will act as the source for the Read Replica. Each DB instance can have up to five Read Replicas.
#' 
#' Constraints:
#' 
...
{
    op <- Operation(name = "CreateGlobalCluster", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param EngineName &#91;required&#93; Specifies the name of the engine that this option group should be associated with.
...
{
    op <- Operation(name = "DeleteDBClusterEndpoint", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteDBInstanceAutomatedBackup", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteGlobalCluster", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_db_cluster_endpoints <- function (DBClusterIdentifier = NULL, 
    ...
    Marker = NULL) 
{
    op <- Operation(name = "DescribeDBClusterEndpoints", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_db_instance_automated_backups <- function (DbiResourceId = NULL, 
    ...
    Marker = NULL) 
{
    op <- Operation(name = "DescribeDBInstanceAutomatedBackups", 
        http_method = "POST", http_path = "/", paginator = list())
...
describe_global_clusters <- function (GlobalClusterIdentifier = NULL, 
    Filters = NULL, MaxRecords = NULL, Marker = NULL) 
{
    op <- Operation(name = "DescribeGlobalClusters", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' )
#'
#' @param EngineName &#91;required&#93; A required parameter. Options available for the given engine name are described.
...
{
    op <- Operation(name = "ModifyDBClusterEndpoint", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ModifyGlobalCluster", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "RemoveFromGlobalCluster", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param DBClusterIdentifier &#91;required&#93; The name of the DB cluster to create from the source data in the Amazon S3 bucket. This parameter is isn\'t case-sensitive.
#' 
#' Constraints:
#' 
#' -   Must contain from 1 to 63 letters, numbers, or hyphens.
...
#' 
#' -   Can\'t be a reserved word for the chosen database engine.
#' @param MasterUserPassword &#91;required&#93; The password for the master database user. This password can contain any printable ASCII character except \"/\", \"\"\", or \"@\".
#' 
#' Constraints: Must contain from 8 to 41 characters.
...
#' @param S3IngestionRoleArn &#91;required&#93; The Amazon Resource Name (ARN) of the AWS Identity and Access Management (IAM) role that authorizes Amazon RDS to access the Amazon S3 bucket on your behalf.
#' @param BacktrackWindow The target backtrack window, in seconds. To disable backtracking, set this value to 0.
#' 
#' Default: 0
#' 
...
#'
#' @export
restore_db_cluster_from_s3 <- function (AvailabilityZones = NULL, 
    ...
    EngineVersion = NULL, Port = NULL, MasterUsername, MasterUserPassword, 
    OptionGroupName = NULL, PreferredBackupWindow = NULL, PreferredMaintenanceWindow = NULL, 
    Tags = NULL, StorageEncrypted = NULL, KmsKeyId = NULL, EnableIAMDatabaseAuthentication = NULL, 
    SourceEngine, SourceEngineVersion, S3BucketName, S3Prefix = NULL, 
    S3IngestionRoleArn, BacktrackWindow = NULL, EnableCloudwatchLogsExports = NULL, 
    DeletionProtection = NULL) 
{
    op <- Operation(name = "RestoreDBClusterFromS3", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- restore_db_cluster_from_s3_input(AvailabilityZones = AvailabilityZones, 
        BackupRetentionPeriod = BackupRetentionPeriod, CharacterSetName = CharacterSetName, 
        DatabaseName = DatabaseName, DBClusterIdentifier = DBClusterIdentifier, 
        DBClusterParameterGroupName = DBClusterParameterGroupName, 
        VpcSecurityGroupIds = VpcSecurityGroupIds, DBSubnetGroupName = DBSubnetGroupName, 
        ...
        S3BucketName = S3BucketName, S3Prefix = S3Prefix, S3IngestionRoleArn = S3IngestionRoleArn, 
        BacktrackWindow = BacktrackWindow, EnableCloudwatchLogsExports = EnableCloudwatchLogsExports, 
        DeletionProtection = DeletionProtection)
...
#' )
#'
#' @param DBInstanceIdentifier &#91;required&#93; Name of the DB instance to create from the DB snapshot. This parameter isn\'t case-sensitive.
#' 
#' Constraints:
#' 
...
#' @param S3IngestionRoleArn &#91;required&#93; An AWS Identity and Access Management (IAM) role to allow Amazon RDS to access your Amazon S3 bucket.
#' @param EnablePerformanceInsights True to enable Performance Insights for the DB instance, and otherwise false.
#' 
#' For more information, see [Using Amazon Performance Insights](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PerfInsights.html) in the *Amazon Relational Database Service User Guide*.
...
#'
#' @export
restore_db_instance_from_s3 <- function (DBName = NULL, DBInstanceIdentifier, 
    AllocatedStorage = NULL, DBInstanceClass, Engine, MasterUsername = NULL, 
    MasterUserPassword = NULL, DBSecurityGroups = NULL, VpcSecurityGroupIds = NULL, 
    AvailabilityZone = NULL, DBSubnetGroupName = NULL, PreferredMaintenanceWindow = NULL, 
    DBParameterGroupName = NULL, BackupRetentionPeriod = NULL, 
    ...
    EngineVersion = NULL, AutoMinorVersionUpgrade = NULL, LicenseModel = NULL, 
    Iops = NULL, OptionGroupName = NULL, PubliclyAccessible = NULL, 
    Tags = NULL, StorageType = NULL, StorageEncrypted = NULL, 
    KmsKeyId = NULL, CopyTagsToSnapshot = NULL, MonitoringInterval = NULL, 
    MonitoringRoleArn = NULL, EnableIAMDatabaseAuthentication = NULL, 
    SourceEngine, SourceEngineVersion, S3BucketName, S3Prefix = NULL, 
    S3IngestionRoleArn, EnablePerformanceInsights = NULL, PerformanceInsightsKMSKeyId = NULL, 
    ...
    DeletionProtection = NULL) 
{
    op <- Operation(name = "RestoreDBInstanceFromS3", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- restore_db_instance_from_s3_input(DBName = DBName, 
        DBInstanceIdentifier = DBInstanceIdentifier, AllocatedStorage = AllocatedStorage, 
        DBInstanceClass = DBInstanceClass, Engine = Engine, MasterUsername = MasterUsername, 
