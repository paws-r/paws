...
{
    op <- new_operation(name = "CancelJob", http_method = "DELETE", 
...
#' ```
#'
#' @param Name &#91;required&#93; The name of the pipeline. We recommend that the name be unique within the AWS account, but uniqueness is not enforced.
#' 
#' Constraints: Maximum 40 characters.
#' @param InputBucket &#91;required&#93; The Amazon S3 bucket in which you saved the media files that you want to transcode.
...
#' @param Role &#91;required&#93; The IAM Amazon Resource Name (ARN) for the role that you want Elastic Transcoder to use to create the pipeline.
...
#'
#' @export
create_pipeline <- function (Name, InputBucket, OutputBucket = NULL, 
    Role, AwsKmsKeyArn = NULL, Notifications = NULL, ContentConfig = NULL, 
    ThumbnailConfig = NULL) 
{
    ...
    input <- create_pipeline_input(Name = Name, InputBucket = InputBucket, 
        OutputBucket = OutputBucket, Role = Role, AwsKmsKeyArn = AwsKmsKeyArn, 
...
#' ```
#'
#' @param Name &#91;required&#93; The name of the preset. We recommend that the name be unique within the AWS account, but uniqueness is not enforced.
#' @param Description A description of the preset.
#' @param Container &#91;required&#93; The container type for the output file. Valid values include `flac`, `flv`, `fmp4`, `gif`, `mp3`, `mp4`, `mpg`, `mxf`, `oga`, `ogg`, `ts`, and `webm`.
...
#'
#' @export
create_preset <- function (Name, Description = NULL, Container, 
    Video = NULL, Audio = NULL, Thumbnails = NULL) 
{
    op <- new_operation(name = "CreatePreset", http_method = "POST", 
        http_path = "/2012-09-25/presets", paginator = list())
    input <- create_preset_input(Name = Name, Description = Description, 
...
#' ```
#'
#' @param Id &#91;required&#93; The identifier of the preset for which you want to get detailed information.
#'
#' @export
delete_preset <- function (Id) 
{
    op <- new_operation(name = "DeletePreset", http_method = "DELETE", 
...
list_jobs_by_pipeline <- function (PipelineId, Ascending = NULL, 
    PageToken = NULL) 
{
    op <- new_operation(name = "ListJobsByPipeline", http_method = "GET", 
...
#' ```
#'
#' @param Status &#91;required&#93; To get information about all of the jobs associated with the current AWS account that have a given status, specify the following status: `Submitted`, `Progressing`, `Complete`, `Canceled`, or `Error`.
#' @param Ascending To list jobs in chronological order by the date and time that they were submitted, enter `true`. To list jobs in reverse chronological order, enter `false`.
#' @param PageToken When Elastic Transcoder returns more than one page of results, use `pageToken` in subsequent `GET` requests to get each successive page of results.
#'
#' @export
...
{
    op <- new_operation(name = "ListJobsByStatus", http_method = "GET", 
...
{
    op <- new_operation(name = "ListPresets", http_method = "GET", 
        http_path = "/2012-09-25/presets", paginator = list())
...
#' ```
#'
#' @param Id &#91;required&#93; The identifier of the job for which you want to get detailed information.
#'
#' @export
read_job <- function (Id) 
{
    op <- new_operation(name = "ReadJob", http_method = "GET", 
        http_path = "/2012-09-25/jobs/{Id}", paginator = list())
...
{
    op <- new_operation(name = "ReadPipeline", http_method = "GET", 
        http_path = "/2012-09-25/pipelines/{Id}", paginator = list())
...
{
    op <- new_operation(name = "ReadPreset", http_method = "GET", 
        http_path = "/2012-09-25/presets/{Id}", paginator = list())
...
#' ```
#'
#' @param Role &#91;required&#93; The IAM Amazon Resource Name (ARN) for the role that you want Elastic Transcoder to test.
#' @param InputBucket &#91;required&#93; The Amazon S3 bucket that contains media files to be transcoded. The action attempts to read from this bucket.
#' @param OutputBucket &#91;required&#93; The Amazon S3 bucket that Elastic Transcoder writes transcoded media files to. The action attempts to read from this bucket.
#' @param Topics &#91;required&#93; The ARNs of one or more Amazon Simple Notification Service (Amazon SNS) topics that you want the action to send a test notification to.
#'
#' @export
test_role <- function (Role, InputBucket, OutputBucket, Topics) 
{
    op <- new_operation(name = "TestRole", http_method = "POST", 
...
#' ```
#'
#' @param Id &#91;required&#93; The identifier of the pipeline for which you want to change notification settings.
#' @param Notifications &#91;required&#93; The topic ARN for the Amazon Simple Notification Service (Amazon SNS) topic that you want to notify to report job status.
#' 
#' To receive notifications, you must also subscribe to the new topic in the Amazon SNS console.
#' 
#' -   **Progressing**: The topic ARN for the Amazon Simple Notification Service (Amazon SNS) topic that you want to notify when Elastic Transcoder has started to process jobs that are added to this pipeline. This is the ARN that Amazon SNS returned when you created the topic.
...
{
    op <- new_operation(name = "UpdatePipelineNotifications", 
        http_method = "POST", http_path = "/2012-09-25/pipelines/{Id}/notifications", 
        paginator = list())
...
{
    op <- new_operation(name = "UpdatePipelineStatus", http_method = "POST", 
