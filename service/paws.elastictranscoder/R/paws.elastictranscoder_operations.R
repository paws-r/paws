...
cancel_job <- function (Id) 
{
    op <- Operation(name = "CancelJob", http_method = "DELETE", 
        http_path = "/2012-09-25/jobs/{Id}", paginator = list())
...
#'
#' @export
create_job <- function (PipelineId, Input = NULL, Inputs = NULL, 
    Output = NULL, Outputs = NULL, OutputKeyPrefix = NULL, Playlists = NULL, 
    UserMetadata = NULL) 
{
    op <- Operation(name = "CreateJob", http_method = "POST", 
        http_path = "/2012-09-25/jobs", paginator = list())
    input <- create_job_input(PipelineId = PipelineId, Input = Input, 
        Inputs = Inputs, Output = Output, Outputs = Outputs, 
        OutputKeyPrefix = OutputKeyPrefix, Playlists = Playlists, 
...
#'
#' @export
create_pipeline <- function (Name, InputBucket, Role, OutputBucket = NULL, 
    AwsKmsKeyArn = NULL, Notifications = NULL, ContentConfig = NULL, 
    ThumbnailConfig = NULL) 
{
    op <- Operation(name = "CreatePipeline", http_method = "POST", 
        http_path = "/2012-09-25/pipelines", paginator = list())
    input <- create_pipeline_input(Name = Name, InputBucket = InputBucket, 
        Role = Role, OutputBucket = OutputBucket, AwsKmsKeyArn = AwsKmsKeyArn, 
...
#'
#' @export
create_preset <- function (Name, Container, Description = NULL, 
    Video = NULL, Audio = NULL, Thumbnails = NULL) 
{
    op <- Operation(name = "CreatePreset", http_method = "POST", 
        http_path = "/2012-09-25/presets", paginator = list())
    input <- create_preset_input(Name = Name, Container = Container, 
        Description = Description, Video = Video, Audio = Audio, 
...
#'
#' @export
delete_pipeline <- function (Id) 
{
    op <- Operation(name = "DeletePipeline", http_method = "DELETE", 
        http_path = "/2012-09-25/pipelines/{Id}", paginator = list())
    input <- delete_pipeline_input(Id = Id)
...
#'
#' @export
delete_preset <- function (Id) 
{
    op <- Operation(name = "DeletePreset", http_method = "DELETE", 
        http_path = "/2012-09-25/presets/{Id}", paginator = list())
    input <- delete_preset_input(Id = Id)
...
#'
#' @export
list_jobs_by_pipeline <- function (PipelineId, Ascending = NULL, 
    PageToken = NULL) 
{
    op <- Operation(name = "ListJobsByPipeline", http_method = "GET", 
        http_path = "/2012-09-25/jobsByPipeline/{PipelineId}", 
        paginator = list())
    input <- list_jobs_by_pipeline_input(PipelineId = PipelineId, 
        Ascending = Ascending, PageToken = PageToken)
    output <- list_jobs_by_pipeline_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_jobs_by_status <- function (Status, Ascending = NULL, PageToken = NULL) 
{
    op <- Operation(name = "ListJobsByStatus", http_method = "GET", 
        http_path = "/2012-09-25/jobsByStatus/{Status}", paginator = list())
    input <- list_jobs_by_status_input(Status = Status, Ascending = Ascending, 
        PageToken = PageToken)
    output <- list_jobs_by_status_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_pipelines <- function (Ascending = NULL, PageToken = NULL) 
{
    op <- Operation(name = "ListPipelines", http_method = "GET", 
        http_path = "/2012-09-25/pipelines", paginator = list())
    input <- list_pipelines_input(Ascending = Ascending, PageToken = PageToken)
...
#'
#' @export
list_presets <- function (Ascending = NULL, PageToken = NULL) 
{
    op <- Operation(name = "ListPresets", http_method = "GET", 
        http_path = "/2012-09-25/presets", paginator = list())
    input <- list_presets_input(Ascending = Ascending, PageToken = PageToken)
...
{
    op <- Operation(name = "ReadJob", http_method = "GET", http_path = "/2012-09-25/jobs/{Id}", 
        paginator = list())
    input <- read_job_input(Id = Id)
...
#'
#' @export
read_pipeline <- function (Id) 
{
    op <- Operation(name = "ReadPipeline", http_method = "GET", 
        http_path = "/2012-09-25/pipelines/{Id}", paginator = list())
    input <- read_pipeline_input(Id = Id)
    output <- read_pipeline_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
read_preset <- function (Id) 
{
    op <- Operation(name = "ReadPreset", http_method = "GET", 
        http_path = "/2012-09-25/presets/{Id}", paginator = list())
    input <- read_preset_input(Id = Id)
    output <- read_preset_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
test_role <- function (Role, InputBucket, OutputBucket, Topics) 
{
    op <- Operation(name = "TestRole", http_method = "POST", 
        http_path = "/2012-09-25/roleTests", paginator = list())
    input <- test_role_input(Role = Role, InputBucket = InputBucket, 
        OutputBucket = OutputBucket, Topics = Topics)
    output <- test_role_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
update_pipeline <- function (Id, Name = NULL, InputBucket = NULL, 
    Role = NULL, AwsKmsKeyArn = NULL, Notifications = NULL, ContentConfig = NULL, 
    ThumbnailConfig = NULL) 
{
    op <- Operation(name = "UpdatePipeline", http_method = "PUT", 
        http_path = "/2012-09-25/pipelines/{Id}", paginator = list())
    input <- update_pipeline_input(Id = Id, Name = Name, InputBucket = InputBucket, 
        Role = Role, AwsKmsKeyArn = AwsKmsKeyArn, Notifications = Notifications, 
        ContentConfig = ContentConfig, ThumbnailConfig = ThumbnailConfig)
...
#'
#' @export
update_pipeline_notifications <- function (Id, Notifications) 
{
    op <- Operation(name = "UpdatePipelineNotifications", http_method = "POST", 
        http_path = "/2012-09-25/pipelines/{Id}/notifications", 
        paginator = list())
    input <- update_pipeline_notifications_input(Id = Id, Notifications = Notifications)
    output <- update_pipeline_notifications_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
update_pipeline_status <- function (Id, Status) 
{
    op <- Operation(name = "UpdatePipelineStatus", http_method = "POST", 
        http_path = "/2012-09-25/pipelines/{Id}/status", paginator = list())
    input <- update_pipeline_status_input(Id = Id, Status = Status)
    output <- update_pipeline_status_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
