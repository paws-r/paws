...
create_project_input <- function (...) 
{
    ...
    shape <- structure(list(name = structure(logical(0), tags = list(location = "querystring", 
        locationName = "name", type = "string")), region = structure(logical(0), 
        tags = list(location = "querystring", locationName = "region", 
            type = "string")), contents = structure(logical(0), 
        tags = list(type = "blob")), snapshotId = structure(logical(0), 
        tags = list(location = "querystring", locationName = "snapshotId", 
...
create_project_output <- function (...) 
{
    ...
    shape <- structure(list(details = structure(list(name = structure(logical(0), 
        tags = list(type = "string")), projectId = structure(logical(0), 
        tags = list(type = "string")), region = structure(logical(0), 
        tags = list(type = "string")), state = structure(logical(0), 
        tags = list(type = "string", enum = c("NORMAL", "SYNCING", 
            "IMPORTING"))), createdDate = structure(logical(0), 
        tags = list(type = "timestamp")), lastUpdatedDate = structure(logical(0), 
        tags = list(type = "timestamp")), consoleUrl = structure(logical(0), 
        tags = list(type = "string")), resources = structure(list(structure(list(type = structure(logical(0), 
        tags = list(type = "string")), name = structure(logical(0), 
        tags = list(type = "string")), arn = structure(logical(0), 
        tags = list(type = "string")), feature = structure(logical(0), 
...
delete_project_input <- function (...) 
{
    ...
    shape <- structure(list(projectId = structure(logical(0), 
        tags = list(location = "uri", locationName = "projectId", 
            type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
delete_project_output <- function (...) 
{
    ...
    shape <- structure(list(deletedResources = structure(list(structure(list(type = structure(logical(0), 
        ...
        tags = list(type = "string"))), tags = list(type = "map"))), 
        tags = list(type = "structure"))), tags = list(type = "list")), 
        orphanedResources = structure(list(structure(list(type = structure(logical(0), 
            tags = list(type = "string")), name = structure(logical(0), 
            tags = list(type = "string")), arn = structure(logical(0), 
            tags = list(type = "string")), feature = structure(logical(0), 
            tags = list(type = "string")), attributes = structure(list(structure(logical(0), 
...
describe_bundle_input <- function (...) 
{
    ...
    shape <- structure(list(bundleId = structure(logical(0), 
        tags = list(location = "uri", locationName = "bundleId", 
            type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
describe_bundle_output <- function (...) 
{
    ...
    shape <- structure(list(details = structure(list(bundleId = structure(logical(0), 
        ...
        tags = list(type = "string")), iconUrl = structure(logical(0), 
        tags = list(type = "string")), availablePlatforms = structure(list(structure(logical(0), 
        tags = list(type = "string", enum = c("OSX", "WINDOWS", 
            "LINUX", "OBJC", "SWIFT", "ANDROID", "JAVASCRIPT")))), 
...
describe_project_input <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(projectId = structure(logical(0), 
        tags = list(location = "querystring", locationName = "projectId", 
            type = "string")), syncFromResources = structure(logical(0), 
        tags = list(location = "querystring", locationName = "syncFromResources", 
...
export_bundle_input <- function (...) 
{
    ...
    shape <- structure(list(bundleId = structure(logical(0), 
        tags = list(location = "uri", locationName = "bundleId", 
            type = "string")), projectId = structure(logical(0), 
        tags = list(location = "querystring", locationName = "projectId", 
            type = "string")), platform = structure(logical(0), 
        tags = list(location = "querystring", locationName = "platform", 
            type = "string", enum = c("OSX", "WINDOWS", "LINUX", 
                "OBJC", "SWIFT", "ANDROID", "JAVASCRIPT")))), 
        tags = list(type = "structure"))
    return(populate(args, shape))
}
...
export_project_output <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(downloadUrl = structure(logical(0), 
        tags = list(type = "string")), shareUrl = structure(logical(0), 
...
update_project_input <- function (...) 
{
    ...
    shape <- structure(list(contents = structure(logical(0), 
        tags = list(type = "blob")), projectId = structure(logical(0), 
        tags = list(location = "querystring", locationName = "projectId", 
            type = "string"))), tags = list(type = "structure", 
        payload = "contents"))
    return(populate(args, shape))
