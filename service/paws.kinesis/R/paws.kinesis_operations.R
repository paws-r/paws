...
{
    op <- new_operation(name = "AddTagsToStream", http_method = "POST", 
...
#' ```
#'
#' @param StreamName &#91;required&#93; A name to identify the stream. The stream name is scoped to the AWS account used by the application that creates the stream. It is also scoped by AWS Region. That is, two streams in two different AWS accounts can have the same name. Two streams in the same AWS account but in two different Regions can also have the same name.
#' @param ShardCount &#91;required&#93; The number of shards that the stream will use. The throughput of the stream is a function of the number of shards; more shards are required for greater provisioned throughput.
#' 
#' DefaultShardLimit;
#'
#' @export
...
{
    op <- new_operation(name = "DecreaseStreamRetentionPeriod", 
...
deregister_stream_consumer <- function (StreamARN = NULL, ConsumerName = NULL, 
    ConsumerARN = NULL) 
{
    op <- new_operation(name = "DeregisterStreamConsumer", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_stream_consumer <- function (StreamARN = NULL, ConsumerName = NULL, 
    ConsumerARN = NULL) 
{
    op <- new_operation(name = "DescribeStreamConsumer", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeStreamSummary", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param StreamName &#91;required&#93; The name of the Kinesis data stream for which to disable enhanced monitoring.
...
{
    op <- new_operation(name = "DisableEnhancedMonitoring", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "EnableEnhancedMonitoring", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetRecords", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetShardIterator", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "IncreaseStreamRetentionPeriod", 
        http_method = "POST", http_path = "/", paginator = list())
...
#'   ExclusiveStartShardId = "string",
#'   MaxResults = 123,
#'   StreamCreationTimestamp = as.POSIXct("2015-01-01")
#' )
#' ```
#'
...
{
    op <- new_operation(name = "ListShards", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param StreamARN &#91;required&#93; The ARN of the Kinesis data stream for which you want to list the registered consumers. For more information, see [Amazon Resource Names (ARNs) and AWS Service Namespaces](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kinesis-streams).
...
{
    op <- new_operation(name = "ListStreamConsumers", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "MergeShards", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param Data &#91;required&#93; The data blob to put into the record, which is base64-encoded when the blob is serialized. When the data blob (the payload before base64-encoding) is added to the partition key size, the total size must not exceed the maximum record size (1 MB).
...
{
    op <- new_operation(name = "PutRecords", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param StreamARN &#91;required&#93; The ARN of the Kinesis data stream that you want to register the consumer with. For more info, see [Amazon Resource Names (ARNs) and AWS Service Namespaces](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kinesis-streams).
...
{
    op <- new_operation(name = "RegisterStreamConsumer", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RemoveTagsFromStream", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "SplitShard", http_method = "POST", 
        http_path = "/", paginator = list())
...
start_stream_encryption <- function (StreamName, EncryptionType, 
    KeyId) 
{
    op <- new_operation(name = "StartStreamEncryption", http_method = "POST", 
        http_path = "/", paginator = list())
...
stop_stream_encryption <- function (StreamName, EncryptionType, 
    KeyId) 
{
    op <- new_operation(name = "StopStreamEncryption", http_method = "POST", 
        http_path = "/", paginator = list())
...
update_shard_count <- function (StreamName, TargetShardCount, 
    ScalingType) 
{
    op <- new_operation(name = "UpdateShardCount", http_method = "POST", 
        http_path = "/", paginator = list())
