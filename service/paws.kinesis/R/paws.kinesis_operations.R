...
#'
#' @export
add_tags_to_stream <- function (StreamName, Tags) 
{
    op <- Operation(name = "AddTagsToStream", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- add_tags_to_stream_input(StreamName = StreamName, 
        Tags = Tags)
    output <- add_tags_to_stream_output()
    svc <- service()
...
#'
#' @export
create_stream <- function (StreamName, ShardCount) 
{
    op <- Operation(name = "CreateStream", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_stream_input(StreamName = StreamName, ShardCount = ShardCount)
...
#'
#' @export
decrease_stream_retention_period <- function (StreamName, RetentionPeriodHours) 
{
    op <- Operation(name = "DecreaseStreamRetentionPeriod", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- decrease_stream_retention_period_input(StreamName = StreamName, 
        RetentionPeriodHours = RetentionPeriodHours)
    output <- decrease_stream_retention_period_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
delete_stream <- function (StreamName, EnforceConsumerDeletion = NULL) 
{
    op <- Operation(name = "DeleteStream", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- delete_stream_input(StreamName = StreamName, EnforceConsumerDeletion = EnforceConsumerDeletion)
...
#'
#' @param StreamARN The ARN of the Kinesis data stream that the consumer is registered with. For more information, see [Amazon Resource Names (ARNs) and AWS Service Namespaces](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kinesis-streams).
...
#'
#' @export
deregister_stream_consumer <- function (StreamARN = NULL, ConsumerName = NULL, 
    ConsumerARN = NULL) 
{
    op <- Operation(name = "DeregisterStreamConsumer", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- deregister_stream_consumer_input(StreamARN = StreamARN, 
        ConsumerName = ConsumerName, ConsumerARN = ConsumerARN)
    output <- deregister_stream_consumer_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
describe_stream <- function (StreamName, Limit = NULL, ExclusiveStartShardId = NULL) 
{
    op <- Operation(name = "DescribeStream", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_stream_input(StreamName = StreamName, Limit = Limit, 
...
#'
#' @export
describe_stream_consumer <- function (StreamARN = NULL, ConsumerName = NULL, 
    ConsumerARN = NULL) 
{
    op <- Operation(name = "DescribeStreamConsumer", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_stream_consumer_input(StreamARN = StreamARN, 
        ConsumerName = ConsumerName, ConsumerARN = ConsumerARN)
    output <- describe_stream_consumer_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
describe_stream_summary <- function (StreamName) 
{
    op <- Operation(name = "DescribeStreamSummary", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_stream_summary_input(StreamName = StreamName)
    output <- describe_stream_summary_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
disable_enhanced_monitoring <- function (StreamName, ShardLevelMetrics) 
{
    op <- Operation(name = "DisableEnhancedMonitoring", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- disable_enhanced_monitoring_input(StreamName = StreamName, 
        ShardLevelMetrics = ShardLevelMetrics)
    output <- disable_enhanced_monitoring_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
enable_enhanced_monitoring <- function (StreamName, ShardLevelMetrics) 
{
    op <- Operation(name = "EnableEnhancedMonitoring", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- enable_enhanced_monitoring_input(StreamName = StreamName, 
        ShardLevelMetrics = ShardLevelMetrics)
    output <- enable_enhanced_monitoring_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' @param StartingSequenceNumber The sequence number of the data record in the shard from which to start reading. Used with shard iterator type AT\_SEQUENCE\_NUMBER and AFTER\_SEQUENCE\_NUMBER.
...
#'
#' @export
get_shard_iterator <- function (StreamName, ShardId, ShardIteratorType, 
    StartingSequenceNumber = NULL, Timestamp = NULL) 
{
    op <- Operation(name = "GetShardIterator", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- get_shard_iterator_input(StreamName = StreamName, 
...
#'
#' @export
increase_stream_retention_period <- function (StreamName, RetentionPeriodHours) 
{
    op <- Operation(name = "IncreaseStreamRetentionPeriod", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- increase_stream_retention_period_input(StreamName = StreamName, 
        RetentionPeriodHours = RetentionPeriodHours)
    output <- increase_stream_retention_period_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_shards <- function (StreamName = NULL, NextToken = NULL, 
    ExclusiveStartShardId = NULL, MaxResults = NULL, StreamCreationTimestamp = NULL) 
{
    op <- Operation(name = "ListShards", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_shards_input(StreamName = StreamName, NextToken = NextToken, 
        ExclusiveStartShardId = ExclusiveStartShardId, MaxResults = MaxResults, 
        StreamCreationTimestamp = StreamCreationTimestamp)
    output <- list_shards_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' This operation has a limit of 10 transactions per second per account.
#'
#' @param StreamARN The ARN of the Kinesis data stream for which you want to list the registered consumers. For more information, see [Amazon Resource Names (ARNs) and AWS Service Namespaces](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kinesis-streams).
...
#'
#' @export
list_stream_consumers <- function (StreamARN, NextToken = NULL, 
    MaxResults = NULL, StreamCreationTimestamp = NULL) 
{
    op <- Operation(name = "ListStreamConsumers", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_stream_consumers_input(StreamARN = StreamARN, 
        NextToken = NextToken, MaxResults = MaxResults, StreamCreationTimestamp = StreamCreationTimestamp)
    output <- list_stream_consumers_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_streams <- function (Limit = NULL, ExclusiveStartStreamName = NULL) 
{
    op <- Operation(name = "ListStreams", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_streams_input(Limit = Limit, ExclusiveStartStreamName = ExclusiveStartStreamName)
...
#'
#' @export
list_tags_for_stream <- function (StreamName, ExclusiveStartTagKey = NULL, 
    Limit = NULL) 
{
    op <- Operation(name = "ListTagsForStream", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_tags_for_stream_input(StreamName = StreamName, 
...
#'
#' @export
merge_shards <- function (StreamName, ShardToMerge, AdjacentShardToMerge) 
{
    op <- Operation(name = "MergeShards", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- merge_shards_input(StreamName = StreamName, ShardToMerge = ShardToMerge, 
        AdjacentShardToMerge = AdjacentShardToMerge)
    output <- merge_shards_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
put_record <- function (StreamName, Data, PartitionKey, ExplicitHashKey = NULL, 
    SequenceNumberForOrdering = NULL) 
{
    op <- Operation(name = "PutRecord", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- put_record_input(StreamName = StreamName, Data = Data, 
        PartitionKey = PartitionKey, ExplicitHashKey = ExplicitHashKey, 
...
#'
#' @export
put_records <- function (Records, StreamName) 
{
    op <- Operation(name = "PutRecords", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- put_records_input(Records = Records, StreamName = StreamName)
    output <- put_records_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' This operation has a limit of five transactions per second per account.
#'
#' @param StreamARN The ARN of the Kinesis data stream that you want to register the consumer with. For more info, see [Amazon Resource Names (ARNs) and AWS Service Namespaces](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kinesis-streams).
...
#'
#' @export
register_stream_consumer <- function (StreamARN, ConsumerName) 
{
    op <- Operation(name = "RegisterStreamConsumer", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- register_stream_consumer_input(StreamARN = StreamARN, 
        ConsumerName = ConsumerName)
    output <- register_stream_consumer_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
remove_tags_from_stream <- function (StreamName, TagKeys) 
{
    op <- Operation(name = "RemoveTagsFromStream", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- remove_tags_from_stream_input(StreamName = StreamName, 
        TagKeys = TagKeys)
    output <- remove_tags_from_stream_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
split_shard <- function (StreamName, ShardToSplit, NewStartingHashKey) 
{
    op <- Operation(name = "SplitShard", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- split_shard_input(StreamName = StreamName, ShardToSplit = ShardToSplit, 
        NewStartingHashKey = NewStartingHashKey)
    output <- split_shard_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
start_stream_encryption <- function (StreamName, EncryptionType, 
    KeyId) 
{
    op <- Operation(name = "StartStreamEncryption", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- start_stream_encryption_input(StreamName = StreamName, 
        EncryptionType = EncryptionType, KeyId = KeyId)
    output <- start_stream_encryption_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
stop_stream_encryption <- function (StreamName, EncryptionType, 
    KeyId) 
{
    op <- Operation(name = "StopStreamEncryption", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- stop_stream_encryption_input(StreamName = StreamName, 
        EncryptionType = EncryptionType, KeyId = KeyId)
    output <- stop_stream_encryption_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
update_shard_count <- function (StreamName, TargetShardCount, 
    ScalingType) 
{
    op <- Operation(name = "UpdateShardCount", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_shard_count_input(StreamName = StreamName, 
        TargetShardCount = TargetShardCount, ScalingType = ScalingType)
    output <- update_shard_count_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
