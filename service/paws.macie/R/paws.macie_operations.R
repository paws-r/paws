...
{
    op <- new_operation(name = "AssociateMemberAccount", http_method = "POST", 
...
{
    op <- new_operation(name = "AssociateS3Resources", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DisassociateMemberAccount", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DisassociateS3Resources", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_s3_resources <- function (memberAccountId = NULL, nextToken = NULL, 
    maxResults = NULL) 
{
    op <- new_operation(name = "ListS3Resources", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateS3Resources", http_method = "POST", 
        http_path = "/", paginator = list())
