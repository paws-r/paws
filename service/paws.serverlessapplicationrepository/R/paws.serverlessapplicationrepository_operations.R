...
{
    op <- Operation(name = "CreateCloudFormationTemplate", http_method = "POST", 
...
{
    op <- Operation(name = "GetCloudFormationTemplate", http_method = "GET", 
...
{
    op <- Operation(name = "ListApplicationDependencies", http_method = "GET", 
