...
#'
#' @export
create_stream <- function (DeviceName = NULL, StreamName, MediaType = NULL, 
    KmsKeyId = NULL, DataRetentionInHours = NULL) 
{
    ...
    input <- create_stream_input(DeviceName = DeviceName, StreamName = StreamName, 
...
{
    op <- new_operation(name = "DeleteStream", http_method = "POST", 
...
{
    op <- new_operation(name = "DescribeStream", http_method = "POST", 
...
#'
#' @export
get_data_endpoint <- function (StreamName = NULL, StreamARN = NULL, 
    APIName) 
{
    op <- new_operation(name = "GetDataEndpoint", http_method = "POST", 
        http_path = "/getDataEndpoint", paginator = list())
    input <- get_data_endpoint_input(StreamName = StreamName, 
        StreamARN = StreamARN, APIName = APIName)
...
{
    op <- new_operation(name = "ListStreams", http_method = "POST", 
...
list_tags_for_stream <- function (NextToken = NULL, StreamARN = NULL, 
    StreamName = NULL) 
{
    op <- new_operation(name = "ListTagsForStream", http_method = "POST", 
...
#' @param Tags &#91;required&#93; A list of tags to associate with the specified stream. Each tag is a key-value pair (the value is optional).
#'
#' @export
tag_stream <- function (StreamARN = NULL, StreamName = NULL, 
    Tags) 
{
    op <- new_operation(name = "TagStream", http_method = "POST", 
        http_path = "/tagStream", paginator = list())
    input <- tag_stream_input(StreamARN = StreamARN, StreamName = StreamName, 
        Tags = Tags)
...
#'
#' @export
untag_stream <- function (StreamARN = NULL, StreamName = NULL, 
    TagKeyList) 
{
    op <- new_operation(name = "UntagStream", http_method = "POST", 
        http_path = "/untagStream", paginator = list())
    input <- untag_stream_input(StreamARN = StreamARN, StreamName = StreamName, 
...
#' @param CurrentVersion &#91;required&#93; The version of the stream whose retention period you want to change. To get the version, call either the `DescribeStream` or the `ListStreams` API.
#' @param Operation &#91;required&#93; Indicates whether you want to increase or decrease the retention period.
#' @param DataRetentionChangeInHours &#91;required&#93; The retention period, in hours. The value you specify replaces the current value.
#'
#' @export
update_data_retention <- function (StreamName = NULL, StreamARN = NULL, 
    CurrentVersion, Operation, DataRetentionChangeInHours) 
{
    op <- new_operation(name = "UpdateDataRetention", http_method = "POST", 
        http_path = "/updateDataRetention", paginator = list())
    input <- update_data_retention_input(StreamName = StreamName, 
        StreamARN = StreamARN, CurrentVersion = CurrentVersion, 
...
#'
#' @export
update_stream <- function (StreamName = NULL, StreamARN = NULL, 
    CurrentVersion, DeviceName = NULL, MediaType = NULL) 
{
    op <- new_operation(name = "UpdateStream", http_method = "POST", 
        http_path = "/updateStream", paginator = list())
    input <- update_stream_input(StreamName = StreamName, StreamARN = StreamARN, 
        CurrentVersion = CurrentVersion, DeviceName = DeviceName, 
        MediaType = MediaType)
