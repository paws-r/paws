...
#' @param TargetReservedNodeOfferingId &#91;required&#93; The unique identifier of the DC2 Reserved Node offering to be used for the exchange. You can obtain the value for the parameter by calling GetReservedNodeExchangeOfferings
#'
#' @examples
#'
#' @export
...
#' @param AccountWithRestoreAccess &#91;required&#93; The identifier of the AWS customer account authorized to restore the specified snapshot.
#' 
...
#'
#' @export
authorize_snapshot_access <- function (SnapshotIdentifier, SnapshotClusterIdentifier = NULL, 
...
{
    op <- Operation(name = "BatchDeleteClusterSnapshots", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "BatchModifyClusterSnapshots", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "CancelResize", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' 
#' Default: `multi-node`
#' @param NodeType &#91;required&#93; The node type to be provisioned for the cluster. For information about node types, go to [Working with Clusters](http://docs.aws.amazon.com/redshift/latest/mgmt/working-with-clusters.html#how-many-nodes) in the *Amazon Redshift Cluster Management Guide*.
#' 
#' Valid Values: `ds2.xlarge` \| `ds2.8xlarge` \| `ds2.xlarge` \| `ds2.8xlarge` \| `dc1.large` \| `dc1.8xlarge` \| `dc2.large` \| `dc2.8xlarge`
#' @param MasterUsername &#91;required&#93; The user name associated with the master user account for the cluster that is being created.
#' 
#' Constraints:
#' 
...
#' @param MasterUserPassword &#91;required&#93; The password associated with the master user account for the cluster that is being created.
#' 
#' Constraints:
#' 
...
create_cluster <- function (DBName = NULL, ClusterIdentifier, 
    ClusterType = NULL, NodeType, MasterUsername, MasterUserPassword, 
    ...
    IamRoles = NULL, MaintenanceTrackName = NULL, SnapshotScheduleIdentifier = NULL) 
{
    op <- Operation(name = "CreateCluster", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_cluster_input(DBName = DBName, ClusterIdentifier = ClusterIdentifier, 
        ClusterType = ClusterType, NodeType = NodeType, MasterUsername = MasterUsername, 
        MasterUserPassword = MasterUserPassword, ClusterSecurityGroups = ClusterSecurityGroups, 
...
#' )
#'
#' @param SnapshotIdentifier &#91;required&#93; A unique identifier for the snapshot that you are requesting. This identifier must be unique for all snapshots within the AWS account.
#' 
#' Constraints:
#' 
#' -   Cannot be null, empty, or blank
...
#' )
#'
#' @param SnapshotCopyGrantName &#91;required&#93; The name of the snapshot copy grant. This name must be unique in the region for the AWS account.
#' 
#' Constraints:
#' 
#' -   Must contain from 1 to 63 alphanumeric characters or hyphens.
...
{
    op <- Operation(name = "CreateSnapshotSchedule", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' )
#'
#' @param ResourceName &#91;required&#93; The Amazon Resource Name (ARN) to which you want to add the tag or tags. For example, `arn:aws:redshift:us-east-1:123456789:cluster:t1`.
...
#' )
#'
#' @param ResourceName &#91;required&#93; The Amazon Resource Name (ARN) from which you want to remove the tag or tags. For example, `arn:aws:redshift:us-east-1:123456789:cluster:t1`.
...
{
    op <- Operation(name = "DescribeSnapshotSchedules", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeStorage", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' 
#' -   Cannot be a reserved word. A list of reserved words can be found in [Reserved Words](http://docs.aws.amazon.com/redshift/latest/dg/r_pg_keywords.html) in the Amazon Redshift Database Developer Guide.
#' @param ClusterIdentifier &#91;required&#93; The unique identifier of the cluster that contains the database for which your are requesting credentials. This parameter is case sensitive.
...
#'
#' @export
get_cluster_credentials <- function (DbUser, DbName = NULL, ClusterIdentifier, 
    DurationSeconds = NULL, AutoCreate = NULL, DbGroups = NULL) 
{
    op <- Operation(name = "GetClusterCredentials", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- get_cluster_credentials_input(DbUser = DbUser, DbName = DbName, 
        ClusterIdentifier = ClusterIdentifier, DurationSeconds = DurationSeconds, 
        AutoCreate = AutoCreate, DbGroups = DbGroups)
...
#' 
#' Example: `examplecluster`
#' @param RevisionTarget &#91;required&#93; The identifier of the database revision. You can retrieve this value from the response to the DescribeClusterDbRevisions request.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "ModifyClusterMaintenance", http_method = "POST", 
        http_path = "/", paginator = list())
...
modify_cluster_snapshot <- function (SnapshotIdentifier, ManualSnapshotRetentionPeriod = NULL, 
    Force = NULL) 
{
    op <- Operation(name = "ModifyClusterSnapshot", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ModifyClusterSnapshotSchedule", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ModifySnapshotSchedule", http_method = "POST", 
        http_path = "/", paginator = list())
...
resize_cluster <- function (ClusterIdentifier, ClusterType = NULL, 
    NodeType = NULL, NumberOfNodes, Classic = NULL) 
{
...
#' 
#' -   Must be unique for all clusters within an AWS account.
#' @param SnapshotIdentifier &#91;required&#93; The name of the snapshot from which to create the new cluster. This parameter isn\'t case sensitive.
#' 
#' Example: `my-snapshot-id`
...
restore_table_from_cluster_snapshot <- function (ClusterIdentifier, 
    SnapshotIdentifier, SourceDatabaseName, SourceSchemaName = NULL, 
    SourceTableName, TargetDatabaseName = NULL, TargetSchemaName = NULL, 
    NewTableName) 
{
    ...
    input <- restore_table_from_cluster_snapshot_input(ClusterIdentifier = ClusterIdentifier, 
        ...
        TargetDatabaseName = TargetDatabaseName, TargetSchemaName = TargetSchemaName, 
...
#' @param SnapshotClusterIdentifier The identifier of the cluster the snapshot was created from. This parameter is required if your IAM user has a policy containing a snapshot resource element that specifies anything other than \* for the cluster name.
#' @param AccountWithRestoreAccess &#91;required&#93; The identifier of the AWS customer account that can no longer restore the specified snapshot.
#'
#' @examples
#'
#' @export
revoke_snapshot_access <- function (SnapshotIdentifier, SnapshotClusterIdentifier = NULL, 
    AccountWithRestoreAccess) 
{
