...
create_backup <- function (FileSystemId, ClientRequestToken = NULL, 
    Tags = NULL) 
{
    op <- Operation(name = "CreateBackup", http_method = "POST", 
...
{
    op <- Operation(name = "CreateFileSystemFromBackup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteFileSystem", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_file_systems <- function (FileSystemIds = NULL, MaxResults = NULL, 
    NextToken = NULL) 
{
    op <- Operation(name = "DescribeFileSystems", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateFileSystem", http_method = "POST", 
        http_path = "/", paginator = list())
