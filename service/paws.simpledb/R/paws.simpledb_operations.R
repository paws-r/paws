...
{
    op <- new_operation(name = "BatchDeleteAttributes", http_method = "POST", 
...
{
    op <- new_operation(name = "BatchPutAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DomainMetadata", http_method = "POST", 
        http_path = "/", paginator = list())
...
get_attributes <- function (DomainName, ItemName, AttributeNames = NULL, 
    ConsistentRead = NULL) 
{
    op <- new_operation(name = "GetAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "Select", http_method = "POST", 
        http_path = "/", paginator = list())
