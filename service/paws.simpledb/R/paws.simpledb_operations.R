...
#'
#' @export
batch_delete_attributes <- function (DomainName, Items) 
{
    op <- Operation(name = "BatchDeleteAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- batch_delete_attributes_input(DomainName = DomainName, 
        Items = Items)
    output <- batch_delete_attributes_output()
    svc <- service()
...
#'
#' @export
batch_put_attributes <- function (DomainName, Items) 
{
    op <- Operation(name = "BatchPutAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- batch_put_attributes_input(DomainName = DomainName, 
        Items = Items)
    output <- batch_put_attributes_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
delete_attributes <- function (DomainName, ItemName, Attributes = NULL, 
    Expected = NULL) 
{
    op <- Operation(name = "DeleteAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- delete_attributes_input(DomainName = DomainName, 
...
#'
#' @export
domain_metadata <- function (DomainName) 
{
    op <- Operation(name = "DomainMetadata", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- domain_metadata_input(DomainName = DomainName)
    output <- domain_metadata_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_attributes <- function (DomainName, ItemName, AttributeNames = NULL, 
    ConsistentRead = NULL) 
{
    op <- Operation(name = "GetAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- get_attributes_input(DomainName = DomainName, ItemName = ItemName, 
        AttributeNames = AttributeNames, ConsistentRead = ConsistentRead)
    output <- get_attributes_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_domains <- function (MaxNumberOfDomains = NULL, NextToken = NULL) 
{
    op <- Operation(name = "ListDomains", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_domains_input(MaxNumberOfDomains = MaxNumberOfDomains, 
        NextToken = NextToken)
...
#'
#' @export
put_attributes <- function (DomainName, ItemName, Attributes, 
    Expected = NULL) 
{
    op <- Operation(name = "PutAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- put_attributes_input(DomainName = DomainName, ItemName = ItemName, 
        Attributes = Attributes, Expected = Expected)
...
#'
#' @export
select <- function (SelectExpression, NextToken = NULL, ConsistentRead = NULL) 
{
    op <- Operation(name = "Select", http_method = "POST", http_path = "/", 
        paginator = list())
    input <- select_input(SelectExpression = SelectExpression, 
        NextToken = NextToken, ConsistentRead = ConsistentRead)
