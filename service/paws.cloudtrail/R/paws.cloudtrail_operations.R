...
{
    op <- Operation(name = "CreateTrail", http_method = "POST", 
...
#'
#' @param Name Specifies the name or the CloudTrail ARN of the trail to be deleted. The format of a trail ARN is: `arn:aws:cloudtrail:us-east-2:123456789012:trail/MyTrail`
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "DeleteTrail", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeTrails", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetEventSelectors", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetTrailStatus", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_public_keys <- function (StartTime = NULL, EndTime = NULL, 
    NextToken = NULL) 
{
    op <- Operation(name = "ListPublicKeys", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "LookupEvents", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "PutEventSelectors", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "StartLogging", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "StopLogging", http_method = "POST", 
        http_path = "/", paginator = list())
...
update_trail <- function (Name, S3BucketName = NULL, S3KeyPrefix = NULL, 
    ...
    CloudWatchLogsRoleArn = NULL, KmsKeyId = NULL) 
{
    op <- Operation(name = "UpdateTrail", http_method = "POST", 
        http_path = "/", paginator = list())
