...
{
    op <- new_operation(name = "AddApplicationCloudWatchLoggingOption", 
...
add_application_input <- function (ApplicationName, CurrentApplicationVersionId, 
    Input) 
{
    op <- new_operation(name = "AddApplicationInput", http_method = "POST", 
...
{
    op <- new_operation(name = "AddApplicationInputProcessingConfiguration", 
        http_method = "POST", http_path = "/", paginator = list())
...
add_application_output <- function (ApplicationName, CurrentApplicationVersionId, 
    Output) 
{
    op <- new_operation(name = "AddApplicationOutput", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "AddApplicationReferenceDataSource", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateApplicationSnapshot", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteApplicationCloudWatchLoggingOption", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteApplicationInputProcessingConfiguration", 
        http_method = "POST", http_path = "/", paginator = list())
...
delete_application_output <- function (ApplicationName, CurrentApplicationVersionId, 
    OutputId) 
{
    op <- new_operation(name = "DeleteApplicationOutput", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteApplicationReferenceDataSource", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteApplicationSnapshot", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeApplication", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeApplicationSnapshot", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DiscoverInputSchema", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_application_snapshots <- function (ApplicationName, Limit = NULL, 
    NextToken = NULL) 
{
    op <- new_operation(name = "ListApplicationSnapshots", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StartApplication", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StopApplication", http_method = "POST", 
        http_path = "/", paginator = list())
