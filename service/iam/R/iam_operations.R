...
#' # server.example.com:
#' \donttest{iam$add_client_id_to_open_id_connect_provider(
...
#' profile](http://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DisassociateIamInstanceProfile.html)
#' and then [associate the instance
#' profile](http://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_AssociateIamInstanceProfile.html),
...
#' \donttest{iam$add_role_to_instance_profile(
...
#' # Admins:
#' \donttest{iam$add_user_to_group(
#'   GroupName = "Admins",
#'   UserName = "Bob"
#' )}
#'
...
#' \donttest{iam$attach_group_policy(
#'   GroupName = "Finance",
...
#' \donttest{iam$attach_role_policy(
#'   PolicyArn = "arn:aws:iam::aws:policy/ReadOnlyAccess",
...
#' \donttest{iam$attach_user_policy(
...
#' \donttest{iam$create_access_key(
#'   UserName = "Bob"
#' )}
#'
#' @keywords internal
...
#' ID](http://docs.aws.amazon.com/IAM/latest/UserGuide/AccountAlias.html)
#' in the *IAM User Guide*.
#'
#' @usage
...
#' # account.
#' \donttest{iam$create_account_alias(
...
#' # instance.
#' \donttest{iam$create_instance_profile(
#'   InstanceProfileName = "Webserver"
#' )}
#'
#' @keywords internal
...
#' \donttest{iam$create_login_profile(
...
#' Provider](http://docs.aws.amazon.com/IAM/latest/UserGuide/identity-providers-oidc-obtain-thumbprint.html)
#' in the *IAM User Guide*.
#'
#' @section Request syntax:
#' ```
...
#' \donttest{iam$create_open_id_connect_provider(
#'   ClientIDList = list(
#'     "my-application-id"
#'   ),
#'   ThumbprintList = list(
...
#' Identities](http://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html)
#' in the *IAM User Guide*.
#' 
...
#' Roles](http://docs.aws.amazon.com/IAM/latest/UserGuide/using-service-linked-roles.html)
#' in the *IAM User Guide*.
#' 
...
#' in the *IAM User Guide* and look for the services that have **Yes** in
...
#' @section Request syntax:
#' ```
#' iam$create_service_specific_credential(
#'   UserName = "string",
#'   ServiceName = "string"
#' )
#' ```
...
#' \donttest{iam$delete_access_key(
...
#' # account:
#' \donttest{iam$delete_account_alias(
...
#' # account:
#' \donttest{iam$delete_account_password_policy()}
#'
#' @keywords internal
#'
...
#' # group named Admins:
#' \donttest{iam$delete_group_policy(
#'   GroupName = "Admins",
...
#' \donttest{iam$delete_instance_profile(
...
#' \donttest{iam$delete_login_profile(
#'   UserName = "Bob"
#' )}
#'
#' @keywords internal
...
#' \donttest{iam$delete_role_policy(
#'   PolicyName = "ExamplePolicy",
#'   RoleName = "Test-Role"
#' )}
#'
...
#' \donttest{iam$delete_signing_certificate(
...
#' \donttest{iam$delete_user_policy(
#'   PolicyName = "ExamplePolicy",
#'   UserName = "Juan"
#' )}
#'
...
#' \donttest{iam$delete_virtual_mfa_device(
...
#' Generates a request for a report that includes details about when an IAM
#' resource (user, group, role, or policy) was last used in an attempt to
#' access AWS services. Recent activity usually appears within four hours.
#' IAM reports activity for the last 365 days, or less if your region began
#' supporting this feature within the last year. For more information, see
#' [Regions Where Data Is
#' Tracked](http://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#access-advisor_tracking-period).
#' 
...
#' CloudTrail](http://docs.aws.amazon.com/IAM/latest/UserGuide/cloudtrail-integration.html)
#' in the *IAM User Guide*.
#' 
...
#' Activity](http://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html)
#' in the *IAM User Guide*.
#'
#' @usage
...
#' # ExamplePolicy1
#' \donttest{iam$generate_service_last_accessed_details(
...
#' # current AWS account.
#' \donttest{iam$get_account_password_policy()}
#'
#' @keywords internal
#'
...
#' \donttest{iam$get_account_summary()}
#'
#' @keywords internal
#'
...
#' @section Request syntax:
#' ```
#' iam$get_context_keys_for_custom_policy(
...
#' @section Request syntax:
#' ```
#' iam$get_context_keys_for_principal_policy(
...
#' # ExampleInstanceProfile.
#' \donttest{iam$get_instance_profile(
#'   InstanceProfileName = "ExampleInstanceProfile"
#' )}
#'
#' @keywords internal
...
#' # user named Anika.
#' \donttest{iam$get_login_profile(
#'   UserName = "Anika"
#' )}
#'
#' @keywords internal
...
#' After you generate a user, group, role, or policy report using the
#' `GenerateServiceLastAccessedDetails` operation, you can use the `JobId`
#' parameter in `GetServiceLastAccessedDetails`. This operation retrieves
#' the status of your report job and a list of AWS services that the
...
#' that includes the number of entities that have attempted to access the
#' service and the date and time of the last attempt. It also returns the
...
#' \donttest{iam$get_service_last_accessed_details(
...
#' Services](http://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_actions-resources-contextkeys.html)
...
#' service namespaces, see [AWS Service
...
#' @section Request syntax:
#' ```
#' iam$get_service_last_accessed_details_with_entities(
#'   JobId = "string",
...
#' \donttest{iam$get_service_last_accessed_details_with_entities(
#'   JobId = "examplef-1305-c245-eba4-71fe298bcda7",
...
#' @section Request syntax:
#' ```
#' iam$get_service_linked_role_deletion_status(
...
#' \donttest{iam$list_account_aliases()}
#'
#' @keywords internal
#'
...
#' \donttest{iam$list_group_policies(
#'   GroupName = "Admins"
#' )}
#'
#' @keywords internal
...
#' # belongs to.
#' \donttest{iam$list_groups_for_user(
#'   UserName = "Bob"
#' )}
#'
#' @keywords internal
...
#' @section Request syntax:
#' ```
#' iam$list_policies_granting_service_access(
#'   Marker = "string",
#'   Arn = "string",
...
#' # access IAM or EC2.
#' \donttest{iam$list_policies_granting_service_access(
...
#' @param Marker Use this parameter only when paginating results and only after you
#' receive a response indicating that the results are truncated. Set it to
#' the value of the `Marker` element in the response to indicate where the
...
#' @section Request syntax:
#' ```
#' iam$list_service_specific_credentials(
#'   UserName = "string",
#'   ServiceName = "string"
#' )
#' ```
...
#' # named Bob.
#' \donttest{iam$list_signing_certificates(
#'   UserName = "Bob"
#' )}
#'
#' @keywords internal
...
#' \donttest{iam$list_virtual_mfa_devices()}
#'
#' @keywords internal
#'
...
#' Evaluation
#' Logic](http://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_evaluation-logic.html)
#' in the IAM User Guide.
#'
#' @usage
...
#' \donttest{iam$remove_role_from_instance_profile(
#'   InstanceProfileName = "ExampleInstanceProfile",
#'   RoleName = "Test-Role"
#' )}
#'
...
#' # named Admins.
#' \donttest{iam$remove_user_from_group(
#'   GroupName = "Admins",
#'   UserName = "Bob"
#' )}
#'
...
#' such as an S3 bucket or object. If `ResourceOwner` is specified, it is
#' also used as the account owner of any `ResourcePolicy` included in the
...
#' of the identity provided in `CallerArn`. This parameter is required only
...
#'     Tags](http://docs.aws.amazon.com/IAM/latest/UserGuide/access_tags.html)
#'     in the *IAM User Guide*.
#' 
...
#' \donttest{iam$update_access_key(
...
#' # password:
#' \donttest{iam$update_account_password_policy(
...
#' # Test-Role:
#' \donttest{iam$update_assume_role_policy(
#'   PolicyDocument = "{\"Version\":\"2012-10-17\",\"Statement\":[{\"Effect\":\"Allow\",...",
...
#' # named Bob.
#' \donttest{iam$update_login_profile(
...
#' \donttest{iam$update_signing_certificate(
#'   CertificateId = "TA7SMP42TDN5Z26OBPJE7EXAMPLE",
#'   Status = "Inactive",
#'   UserName = "Bob"
#' )}
...
#' \donttest{iam$upload_server_certificate(
...
#' # named Bob.
#' \donttest{iam$upload_signing_certificate(
