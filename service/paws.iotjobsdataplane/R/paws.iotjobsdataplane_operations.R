...
{
    op <- new_operation(name = "GetPendingJobExecutions", http_method = "GET", 
...
{
    op <- new_operation(name = "StartNextPendingJobExecution", 
        http_method = "PUT", http_path = "/things/{thingName}/jobs/$next", 
        paginator = list())
...
{
    op <- new_operation(name = "UpdateJobExecution", http_method = "POST", 
        http_path = "/things/{thingName}/jobs/{jobId}", paginator = list())
