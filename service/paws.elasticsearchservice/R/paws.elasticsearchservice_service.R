service <- function () 
{
    cfg <- client_config("es", list(`*` = "es.{region}.amazonaws.com", 
        `cn-*` = "es.{region}.amazonaws.com.cn"))
    client_info <- ClientInfo(service_name = "es", service_id = "Elasticsearch Service", 
        api_version = "2015-01-01", signing_name = cfg$signing_name, 
