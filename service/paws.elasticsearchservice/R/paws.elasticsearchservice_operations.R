...
add_tags <- function (ARN, TagList) 
{
    op <- new_operation(name = "AddTags", http_method = "POST", 
        http_path = "/2015-01-01/tags", paginator = list())
...
{
    op <- new_operation(name = "CancelElasticsearchServiceSoftwareUpdate", 
...
{
    op <- new_operation(name = "CreateElasticsearchDomain", http_method = "POST", 
...
{
    op <- new_operation(name = "DeleteElasticsearchDomain", http_method = "DELETE", 
...
{
    op <- new_operation(name = "DeleteElasticsearchServiceRole", 
...
{
    op <- new_operation(name = "DescribeElasticsearchDomain", 
        http_method = "GET", http_path = "/2015-01-01/es/domain/{DomainName}", 
        paginator = list())
...
{
    op <- new_operation(name = "DescribeElasticsearchDomainConfig", 
...
{
    op <- new_operation(name = "DescribeElasticsearchDomains", 
        http_method = "POST", http_path = "/2015-01-01/es/domain-info", 
        paginator = list())
...
{
    op <- new_operation(name = "DescribeElasticsearchInstanceTypeLimits", 
...
{
    op <- new_operation(name = "DescribeReservedElasticsearchInstanceOfferings", 
...
describe_reserved_elasticsearch_instances <- function (ReservedElasticsearchInstanceId = NULL, 
    MaxResults = NULL, NextToken = NULL) 
{
    op <- new_operation(name = "DescribeReservedElasticsearchInstances", 
...
{
    op <- new_operation(name = "GetCompatibleElasticsearchVersions", 
...
get_upgrade_history <- function (DomainName, MaxResults = NULL, 
    NextToken = NULL) 
{
    op <- new_operation(name = "GetUpgradeHistory", http_method = "GET", 
...
{
    op <- new_operation(name = "GetUpgradeStatus", http_method = "GET", 
...
{
    op <- new_operation(name = "ListDomainNames", http_method = "GET", 
...
{
    op <- new_operation(name = "ListElasticsearchInstanceTypes", 
...
{
    op <- new_operation(name = "ListElasticsearchVersions", http_method = "GET", 
...
{
    op <- new_operation(name = "PurchaseReservedElasticsearchInstanceOffering", 
...
{
    op <- new_operation(name = "StartElasticsearchServiceSoftwareUpdate", 
...
{
    op <- new_operation(name = "UpdateElasticsearchDomainConfig", 
...
{
    op <- new_operation(name = "UpgradeElasticsearchDomain", 
        http_method = "POST", http_path = "/2015-01-01/es/upgradeDomain", 
        paginator = list())
