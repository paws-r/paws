...
{
    op <- new_operation(name = "BatchDeleteBuilds", http_method = "POST", 
...
{
    op <- new_operation(name = "BatchGetBuilds", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "BatchGetProjects", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateWebhook", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "InvalidateProjectCache", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_builds_for_project <- function (projectName, sortOrder = NULL, 
    nextToken = NULL) 
{
    op <- new_operation(name = "ListBuildsForProject", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListCuratedEnvironmentImages", 
...
{
    op <- new_operation(name = "StopBuild", http_method = "POST", 
        http_path = "/", paginator = list())
...
update_webhook <- function (projectName, branchFilter = NULL, 
    rotateSecret = NULL) 
{
    op <- new_operation(name = "UpdateWebhook", http_method = "POST", 
        http_path = "/", paginator = list())
