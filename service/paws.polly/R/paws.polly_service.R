service <- function () 
{
    cfg <- client_config("polly", list(`*` = "polly.{region}.amazonaws.com", 
        `cn-*` = "polly.{region}.amazonaws.com.cn"))
    client_info <- ClientInfo(service_name = "polly", service_id = "Polly", 
        api_version = "2016-06-10", signing_name = cfg$signing_name, 
