...
{
    op <- new_operation(name = "BulkPublish", http_method = "POST", 
...
{
    op <- new_operation(name = "DescribeIdentityPoolUsage", http_method = "GET", 
...
{
    op <- new_operation(name = "DescribeIdentityUsage", http_method = "GET", 
...
{
    op <- new_operation(name = "GetBulkPublishDetails", http_method = "POST", 
...
{
    op <- new_operation(name = "GetCognitoEvents", http_method = "GET", 
...
{
    op <- new_operation(name = "GetIdentityPoolConfiguration", 
        http_method = "GET", http_path = "/identitypools/{IdentityPoolId}/configuration", 
        paginator = list())
...
#'
#' @export
list_datasets <- function (IdentityPoolId, IdentityId, NextToken = NULL, 
    MaxResults = NULL) 
{
    op <- new_operation(name = "ListDatasets", http_method = "GET", 
        http_path = "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets", 
        paginator = list())
    input <- list_datasets_input(IdentityPoolId = IdentityPoolId, 
        IdentityId = IdentityId, NextToken = NextToken, MaxResults = MaxResults)
...
{
    op <- new_operation(name = "ListIdentityPoolUsage", http_method = "GET", 
...
{
    op <- new_operation(name = "ListRecords", http_method = "GET", 
...
register_device <- function (IdentityPoolId, IdentityId, Platform, 
    Token) 
{
    op <- new_operation(name = "RegisterDevice", http_method = "POST", 
...
{
    op <- new_operation(name = "SetCognitoEvents", http_method = "POST", 
        http_path = "/identitypools/{IdentityPoolId}/events", 
        paginator = list())
...
{
    op <- new_operation(name = "SetIdentityPoolConfiguration", 
        http_method = "POST", http_path = "/identitypools/{IdentityPoolId}/configuration", 
        paginator = list())
...
{
    op <- new_operation(name = "SubscribeToDataset", http_method = "POST", 
...
unsubscribe_from_dataset <- function (IdentityPoolId, IdentityId, 
    DatasetName, DeviceId) 
{
    op <- new_operation(name = "UnsubscribeFromDataset", http_method = "DELETE", 
        http_path = "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}/subscriptions/{DeviceId}", 
        paginator = list())
...
#'       Value = "string",
#'       SyncCount = 123,
#'       DeviceLastModifiedDate = as.POSIXct("2015-01-01")
#'     )
#'   ),
#'   SyncSessionToken = "string",
...
update_records <- function (IdentityPoolId, IdentityId, DatasetName, 
    DeviceId = NULL, RecordPatches = NULL, SyncSessionToken, 
    ClientContext = NULL) 
{
    op <- new_operation(name = "UpdateRecords", http_method = "POST", 
        http_path = "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}", 
        paginator = list())
    input <- update_records_input(IdentityPoolId = IdentityPoolId, 
        IdentityId = IdentityId, DatasetName = DatasetName, DeviceId = DeviceId, 
        RecordPatches = RecordPatches, SyncSessionToken = SyncSessionToken, 
