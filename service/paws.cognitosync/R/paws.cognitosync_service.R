service <- function () 
{
    cfg <- client_config("cognito-sync", list(`*` = "cognito-sync.{region}.amazonaws.com", 
        `cn-*` = "cognito-sync.{region}.amazonaws.com.cn"))
    client_info <- ClientInfo(service_name = "cognito-sync", 
        service_id = "Cognito Sync", api_version = "2014-06-30", 
