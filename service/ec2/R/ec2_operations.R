...
#' in the *Amazon Elastic Compute Cloud User Guide*.
#' @param InstanceType &#91;required&#93; Specify the instance type for which to configure your Dedicated Hosts.
...
ec2_allocate_hosts <- function(AutoPlacement = NULL, AvailabilityZone, ClientToken = NULL, InstanceType, Quantity, TagSpecifications = NULL) {
  op <- new_operation(
    name = "AllocateHosts",
    http_method = "POST",
    http_path = "/",
  ...
  input <- .ec2$allocate_hosts_input(AutoPlacement = AutoPlacement, AvailabilityZone = AvailabilityZone, ClientToken = ClientToken, InstanceType = InstanceType, Quantity = Quantity, TagSpecifications = TagSpecifications)
...
#' @section Request syntax:
#' ```
#' ec2$apply_security_groups_to_client_vpn_target_network(
...
#' \donttest{ec2$assign_private_ip_addresses(
...
#' \donttest{ec2$associate_address(
...
ec2_associate_client_vpn_target_network <- function(ClientVpnEndpointId, SubnetId, DryRun = NULL) {
  op <- new_operation(
  ...
  input <- .ec2$associate_client_vpn_target_network_input(ClientVpnEndpointId = ClientVpnEndpointId, SubnetId = SubnetId, DryRun = DryRun)
...
#' Sets](https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_DHCP_Options.html)
...
#' # specified VPC.
#' \donttest{ec2$associate_dhcp_options(
...
#' \donttest{ec2$associate_iam_instance_profile(
#'   IamInstanceProfile = list(
#'     Name = "admin-role"
#'   ),
...
#' Tables](https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_Route_Tables.html)
#' in the *Amazon Virtual Private Cloud User Guide*.
#'
#' @usage
...
#' # subnet.
#' \donttest{ec2$associate_route_table(
...
#' Sizing](https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_Subnets.html#VPC_Sizing)
#' in the *Amazon Virtual Private Cloud User Guide*.
#'
#' @usage
...
#' Guide](https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/).
#'
#' @usage
...
#' # VPC.
#' \donttest{ec2$attach_internet_gateway(
...
#' # instance.
#' \donttest{ec2$attach_network_interface(
#'   DeviceIndex = 1L,
...
ec2_authorize_client_vpn_ingress <- function(ClientVpnEndpointId, TargetNetworkCidr, AccessGroupId = NULL, AuthorizeAllGroups = NULL, Description = NULL, DryRun = NULL) {
  op <- new_operation(
  ...
  input <- .ec2$authorize_client_vpn_ingress_input(ClientVpnEndpointId = ClientVpnEndpointId, TargetNetworkCidr = TargetNetworkCidr, AccessGroupId = AccessGroupId, AuthorizeAllGroups = AuthorizeAllGroups, Description = Description, DryRun = DryRun)
...
#' &#91;EC2-VPC only&#93; Adds one or more egress rules to a security group
#' for use with a VPC
#'
...
#' to one or more destination security groups for the same VPC. This action
...
#' Limits](https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_Appendix_Limits.html).
#' 
...
#' @param IpPermissions One or more sets of IP permissions. You can\'t specify a destination
...
#' \donttest{ec2$authorize_security_group_egress(
#'   GroupId = "sg-1a2b3c4d",
#'   IpPermissions = list(
#'     list(
#'       FromPort = 80L,
...
#' or more other security groups (called the *source groups*) permission to
...
#'
#' @param CidrIp The CIDR IPv4 address range. You can\'t specify this parameter when
#' specifying a source security group.
#' @param FromPort The start of port range for the TCP and UDP protocols, or an ICMP/ICMPv6
...
#' request.
#' @param IpPermissions One or more sets of IP permissions. Can be used to specify multiple
...
#' protocol number other than `tcp`, `udp`, `icmp`, or `58` (ICMPv6),
#' traffic on all ports is allowed, regardless of any ports you specify.
#' For `tcp`, `udp`, and `icmp`, you must specify a port range. For
...
#' @param ToPort The end of port range for the TCP and UDP protocols, or an ICMP/ICMPv6
#' code number. For the ICMP/ICMPv6 code number, use `-1` to specify all
#' codes. If you specify all ICMP/ICMPv6 types, you must specify all codes.
#' @param DryRun Checks whether you have the required permissions for the action, without
#' actually making the request, and provides an error response. If you have
#' the required permissions, the error response is `DryRunOperation`.
#' Otherwise, it is `UnauthorizedOperation`.
...
#' \donttest{ec2$authorize_security_group_ingress(
#'   GroupId = "sg-903004f8",
#'   IpPermissions = list(
#'     list(
#'       FromPort = 22L,
...
#' @section Request syntax:
#' ```
#' ec2$cancel_reserved_instances_listing(
...
#' \donttest{ec2$cancel_spot_fleet_requests(
#'   SpotFleetRequestIds = list(
...
#' \donttest{ec2$cancel_spot_instance_requests(
#'   SpotInstanceRequestIds = list(
#'     "sir-08b93456"
#'   )
#' )}
...
#' \donttest{ec2$confirm_product_instance(
#'   InstanceId = "i-1234567890abcdef0",
...
#' @param Encrypted Specifies whether the destination snapshot should be encrypted. You can
...
ec2_create_client_vpn_route <- function(ClientVpnEndpointId, DestinationCidrBlock, TargetVpcSubnetId, Description = NULL, DryRun = NULL) {
  op <- new_operation(
  ...
  input <- .ec2$create_client_vpn_route_input(ClientVpnEndpointId = ClientVpnEndpointId, DestinationCidrBlock = DestinationCidrBlock, TargetVpcSubnetId = TargetVpcSubnetId, Description = Description, DryRun = DryRun)
...
#' \donttest{ec2$create_customer_gateway(
#'   BgpAsn = 65534L,
#'   PublicIp = "12.1.2.3",
#'   Type = "ipsec.1"
#' )}
...
#' [Creating a Default
#' Subnet](https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/default-vpc.html#create-default-subnet)
#' in the *Amazon Virtual Private Cloud User Guide*.
#'
#' @usage
...
#' Subnets](https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/default-vpc.html)
...
#' \donttest{ec2$create_dhcp_options(
#'   DhcpConfigurations = list(
#'     list(
...
#' @param TargetCapacitySpecification &#91;required&#93; The `TotalTargetCapacity`, `OnDemandTargetCapacity`,
...
#' Records](https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/flow-logs.html#flow-log-records)
#' in the *Amazon Virtual Private Cloud User Guide*.
#' 
...
#' You can securely deploy an AFI on one or more FPGA-accelerated
...
#'   Name, NoReboot)
#'
#' @param BlockDeviceMappings Information about one or more block device mappings. This parameter
...
#' @section Request syntax:
#' ```
#' ec2$create_instance_export_task(
#'   Description = "string",
#'   ExportToS3Task = list(
#'     ContainerFormat = "ova",
...
#' \donttest{ec2$create_internet_gateway()}
#'
#' @keywords internal
#'
...
#' \donttest{ec2$create_launch_template(
#'   LaunchTemplateData = list(
...
#' \donttest{ec2$create_launch_template_version(
#'   LaunchTemplateData = list(
...
#' Gateways](https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/vpc-nat-gateway.html)
#' in the *Amazon Virtual Private Cloud User Guide*.
#'
#' @usage
...
#' \donttest{ec2$create_nat_gateway(
...
#' \donttest{ec2$create_network_acl(
#'   VpcId = "vpc-a01106c2"
#' )}
#'
#' @keywords internal
...
#' \donttest{ec2$create_network_acl_entry(
#'   CidrBlock = "0.0.0.0/0",
#'   Egress = FALSE,
...
#' \donttest{ec2$create_network_interface(
...
ec2_create_network_interface <- function(Description = NULL, DryRun = NULL, Groups = NULL, Ipv6AddressCount = NULL, Ipv6Addresses = NULL, PrivateIpAddress = NULL, PrivateIpAddresses = NULL, SecondaryPrivateIpAddressCount = NULL, SubnetId) {
  op <- new_operation(
...
#' @section Request syntax:
#' ```
#' ec2$create_network_interface_permission(
#'   NetworkInterfaceId = "string",
#'   AwsAccountId = "string",
#'   AwsService = "string",
...
#' \donttest{ec2$create_placement_group(
...
#' @section Request syntax:
#' ```
#' ec2$create_reserved_instances_listing(
#'   ClientToken = "string",
#'   InstanceCount = 123,
#'   PriceSchedules = list(
#'     list(
...
#' \donttest{ec2$create_route_table(
#'   VpcId = "vpc-a01106c2"
#' )}
#'
#' @keywords internal
...
#' \donttest{ec2$create_security_group(
...
#' \donttest{ec2$create_spot_datafeed_subscription(
#'   Bucket = "my-s3-bucket",
#'   Prefix = "spotdata"
#' )}
#'
...
#'
#' @param AvailabilityZone &#91;required&#93; The Availability Zone in which to create the volume. Use
...
#' Endpoints](https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/vpc-endpoints.html)
#' in the *Amazon Virtual Private Cloud User Guide*.
#' 
...
#' Endpoint
#' Services](https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/endpoint-service.html)
#' in the *Amazon Virtual Private Cloud User Guide*.
#'
#' @usage
...
#' information, see the
#' [limitations](https://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide/vpc-peering-basics.html#vpc-peering-limitations)
...
#' \donttest{ec2$delete_customer_gateway(
...
#' \donttest{ec2$delete_dhcp_options(
#'   DhcpOptionsId = "dopt-d9070ebb"
#' )}
#'
#' @keywords internal
...
#' \donttest{ec2$delete_internet_gateway(
#'   InternetGatewayId = "igw-c0a643a9"
#' )}
#'
#' @keywords internal
...
#' \donttest{ec2$delete_launch_template(
#'   LaunchTemplateId = "lt-0abcd290751193123"
#' )}
#'
#' @keywords internal
...
#' \donttest{ec2$delete_launch_template_versions(
#'   LaunchTemplateId = "lt-0abcd290751193123",
#'   Versions = list(
#'     "1"
#'   )
...
#' \donttest{ec2$delete_nat_gateway(
...
#' \donttest{ec2$delete_network_acl(
#'   NetworkAclId = "acl-5fb85d36"
#' )}
#'
#' @keywords internal
...
#' # ACL.
#' \donttest{ec2$delete_network_acl_entry(
#'   Egress = TRUE,
#'   NetworkAclId = "acl-5fb85d36",
#'   RuleNumber = 100L
#' )}
...
#' \donttest{ec2$delete_network_interface(
#'   NetworkInterfaceId = "eni-e5aa89a3"
#' )}
#'
#' @keywords internal
...
#' @section Request syntax:
#' ```
#' ec2$delete_network_interface_permission(
...
#' # 
#' \donttest{ec2$delete_placement_group(
#'   GroupName = "my-cluster"
#' )}
#'
#' @keywords internal
...
#' \donttest{ec2$delete_route_table(
#'   RouteTableId = "rtb-22574640"
#' )}
#'
#' @keywords internal
...
#' \donttest{ec2$delete_security_group(
#'   GroupId = "sg-903004f8"
#' )}
#'
#' @keywords internal
...
#' \donttest{ec2$delete_spot_datafeed_subscription()}
#'
#' @keywords internal
#'
...
#' Constraints: Up to 1000 resource IDs. We recommend breaking up this
#' request into smaller batches.
#' @param Tags One or more tags to delete. Specify a tag key and an optional tag value
...
#' @section Request syntax:
#' ```
#' ec2$delete_vpc_endpoint_connection_notifications(
#'   DryRun = TRUE|FALSE,
...
#' @section Request syntax:
#' ```
#' ec2$delete_vpn_connection_route(
#'   DestinationCidrBlock = "string",
#'   VpnConnectionId = "string"
#' )
#' ```
...
#' # account.
#' \donttest{ec2$describe_account_attributes(
#'   AttributeNames = list(
#'     "supported-platforms"
#'   )
#' )}
...
#' \donttest{ec2$describe_addresses()}
#' 
...
#' \donttest{ec2$describe_availability_zones()}
#'
#' @keywords internal
#'
...
#' @section Request syntax:
#' ```
#' ec2$describe_capacity_reservations(
...
#' @section Request syntax:
#' ```
#' ec2$describe_classic_link_instances(
#'   Filters = list(
#'     list(
#'       Name = "string",
#'       Values = list(
...
#' @section Request syntax:
#' ```
#' ec2$describe_client_vpn_authorization_rules(
#'   ClientVpnEndpointId = "string",
#'   DryRun = TRUE|FALSE,
#'   NextToken = "string",
#'   Filters = list(
...
#' @section Request syntax:
#' ```
#' ec2$describe_client_vpn_target_networks(
#'   ClientVpnEndpointId = "string",
#'   AssociationIds = list(
#'     "string"
#'   ),
...
#' \donttest{ec2$describe_customer_gateways(
#'   CustomerGatewayIds = list(
#'     "cgw-0e11f167"
#'   )
#' )}
...
#'
#' @usage
#' ec2_describe_dhcp_options(DhcpOptionsIds, Filters, DryRun)
#'
...
#' \donttest{ec2$describe_dhcp_options(
#'   DhcpOptionsIds = list(
#'     "dopt-d9070ebb"
#'   )
#' )}
...
ec2_describe_dhcp_options <- function(DhcpOptionsIds = NULL, Filters = NULL, DryRun = NULL) {
  op <- new_operation(
  ...
  input <- .ec2$describe_dhcp_options_input(DhcpOptionsIds = DhcpOptionsIds, Filters = Filters, DryRun = DryRun)
...
#' @section Request syntax:
#' ```
#' ec2$describe_fpga_image_attribute(
#'   DryRun = TRUE|FALSE,
#'   FpgaImageId = "string",
...
#' @section Request syntax:
#' ```
#' ec2$describe_host_reservation_offerings(
#'   Filter = list(
#'     list(
#'       Name = "string",
#'       Values = list(
...
#' \donttest{ec2$describe_iam_instance_profile_associations(
#'   AssociationIds = list(
...
#' @section Request syntax:
#' ```
#' ec2$describe_identity_id_format(
#'   PrincipalArn = "string",
#'   Resource = "string"
#' )
#' ```
...
#' \donttest{ec2$describe_image_attribute(
...
#' @section Request syntax:
#' ```
#' ec2$describe_import_image_tasks(
#'   DryRun = TRUE|FALSE,
#'   Filters = list(
#'     list(
#'       Name = "string",
...
#' @section Request syntax:
#' ```
#' ec2$describe_import_snapshot_tasks(
#'   DryRun = TRUE|FALSE,
#'   Filters = list(
#'     list(
#'       Name = "string",
...
#' # 
#' \donttest{ec2$describe_instance_attribute(
...
#' @section Request syntax:
#' ```
#' ec2$describe_instance_credit_specifications(
#'   DryRun = TRUE|FALSE,
#'   Filters = list(
#'     list(
#'       Name = "string",
...
#' \donttest{ec2$describe_instance_status(
#'   InstanceIds = list(
#'     "i-1234567890abcdef0"
#'   )
#' )}
...
#' \donttest{ec2$describe_instances(
#'   InstanceIds = list(
#'     "i-1234567890abcdef0"
#'   )
#' )}
...
#' \donttest{ec2$describe_internet_gateways(
#'   Filters = list(
#'     list(
...
#' \donttest{ec2$describe_key_pairs(
#'   KeyNames = list(
#'     "my-key-pair"
#'   )
#' )}
...
#' \donttest{ec2$describe_launch_template_versions(
...
#' \donttest{ec2$describe_launch_templates(
#'   LaunchTemplateIds = list(
...
#' \donttest{ec2$describe_moving_addresses()}
#'
#' @keywords internal
#'
...
#' \donttest{ec2$describe_nat_gateways(
#'   Filter = list(
#'     list(
#'       Name = "vpc-id",
#'       Values = list(
...
#' \donttest{ec2$describe_network_acls(
#'   NetworkAclIds = list(
#'     "acl-5fb85d36"
#'   )
#' )}
...
#' # interface.
#' \donttest{ec2$describe_network_interface_attribute(
...
#' @section Request syntax:
#' ```
#' ec2$describe_network_interface_permissions(
...
#' @examples
#' # 
#' \donttest{ec2$describe_network_interfaces(
#'   NetworkInterfaceIds = list(
#'     "eni-e5aa89a3"
#'   )
#' )}
...
#' @section Request syntax:
#' ```
#' ec2$describe_principal_id_format(
#'   DryRun = TRUE|FALSE,
#'   Resources = list(
#'     "string"
#'   ),
...
#' @section Request syntax:
#' ```
#' ec2$describe_public_ipv_4_pools(
#'   PoolIds = list(
#'     "string"
#'   ),
#'   NextToken = "string",
...
#' @section Request syntax:
#' ```
#' ec2$describe_reserved_instances_listings(
#'   Filters = list(
#'     list(
#'       Name = "string",
#'       Values = list(
...
#' \donttest{ec2$describe_route_tables(
#'   RouteTableIds = list(
#'     "rtb-1f382e7d"
#'   )
#' )}
...
#' @section Request syntax:
#' ```
#' ec2$describe_scheduled_instance_availability(
#'   DryRun = TRUE|FALSE,
#'   Filters = list(
#'     list(
#'       Name = "string",
...
#' \donttest{ec2$describe_scheduled_instance_availability(
#'   FirstSlotStartTimeRange = list(
...
#' @section Request syntax:
#' ```
#' ec2$describe_scheduled_instances(
#'   DryRun = TRUE|FALSE,
#'   Filters = list(
#'     list(
#'       Name = "string",
...
#' \donttest{ec2$describe_scheduled_instances(
#'   ScheduledInstanceIds = list(
...
#' &#91;EC2-VPC only&#93; Describes the VPCs on the other side of a VPC
...
#' @section Request syntax:
#' ```
#' ec2$describe_security_group_references(
#'   DryRun = TRUE|FALSE,
#'   GroupId = list(
#'     "string"
#'   )
...
#' # security group.
#' \donttest{ec2$describe_security_group_references(
#'   GroupId = list(
#'     "sg-903004f8"
#'   )
#' )}
...
#' \donttest{ec2$describe_security_groups(
#'   GroupIds = list(
#'     "sg-903004f8"
#'   )
#' )}
...
#' \donttest{ec2$describe_snapshot_attribute(
...
#' @param OwnerIds Describes the snapshots owned by one or more owners.
...
#' \donttest{ec2$describe_snapshots(
#'   SnapshotIds = list(
#'     "snap-1234567890abcdef0"
#'   )
#' )}
...
#' # AWS account.
#' \donttest{ec2$describe_spot_datafeed_subscription()}
#'
#' @keywords internal
#'
...
#' # fleet.
#' \donttest{ec2$describe_spot_fleet_instances(
...
#' @section Request syntax:
#' ```
#' ec2$describe_spot_fleet_request_history(
#'   DryRun = TRUE|FALSE,
...
#' \donttest{ec2$describe_spot_fleet_request_history(
#'   SpotFleetRequestId = "sfr-73fbd2ce-aa30-494c-8788-1cee4EXAMPLE",
...
#' \donttest{ec2$describe_spot_fleet_requests(
#'   SpotFleetRequestIds = list(
#'     "sfr-73fbd2ce-aa30-494c-8788-1cee4EXAMPLE"
#'   )
#' )}
...
#' \donttest{ec2$describe_spot_instance_requests(
#'   SpotInstanceRequestIds = list(
#'     "sir-08b93456"
#'   )
#' )}
...
#' \donttest{ec2$describe_spot_price_history(
...
#' &#91;EC2-VPC only&#93; Describes the stale security group rules for
...
#' @section Request syntax:
#' ```
#' ec2$describe_stale_security_groups(
#'   DryRun = TRUE|FALSE,
#'   MaxResults = 123,
#'   NextToken = "string",
#'   VpcId = "string"
...
#'
#' @usage
#' ec2_describe_subnets(Filters, SubnetIds, DryRun)
#'
#' @param Filters One or more filters.
#' 
...
ec2_describe_subnets <- function(Filters = NULL, SubnetIds = NULL, DryRun = NULL) {
  op <- new_operation(
  ...
  input <- .ec2$describe_subnets_input(Filters = Filters, SubnetIds = SubnetIds, DryRun = DryRun)
...
#' \donttest{ec2$describe_volume_attribute(
...
#' \donttest{ec2$describe_volume_status(
#'   VolumeIds = list(
#'     "vol-1234567890abcdef0"
#'   )
#' )}
...
#' the required permissions, the error response is `DryRunOperation`.
#' Otherwise, it is `UnauthorizedOperation`.
#' @param VolumeIds One or more volume IDs for which in-progress modifications will be
#' described.
#' @param Filters One or more filters. Supported filters: `volume-id`,
...
#' \donttest{ec2$describe_vpc_attribute(
...
#' @section Request syntax:
#' ```
#' ec2$describe_vpc_endpoint_service_permissions(
#'   DryRun = TRUE|FALSE,
#'   ServiceId = "string",
#'   Filters = list(
#'     list(
...
#' # VPC.
#' \donttest{ec2$detach_internet_gateway(
#'   InternetGatewayId = "igw-c0a643a9",
#'   VpcId = "vpc-a01106c2"
#' )}
#'
...
#' # instance.
#' \donttest{ec2$detach_network_interface(
...
#' @section Request syntax:
#' ```
#' ec2$disable_vgw_route_propagation(
#'   GatewayId = "string",
#'   RouteTableId = "string"
#' )
#' ```
...
#' \donttest{ec2$disable_vgw_route_propagation(
...
#' @section Request syntax:
#' ```
#' ec2$disable_vpc_classic_link_dns_support(
#'   VpcId = "string"
#' )
#' ```
#'
...
#' # VPC.
#' \donttest{ec2$disassociate_address(
...
#' # instance.
#' \donttest{ec2$disassociate_iam_instance_profile(
...
#' # subnet.
#' \donttest{ec2$disassociate_route_table(
...
#' @section Request syntax:
#' ```
#' ec2$disassociate_subnet_cidr_block(
#'   AssociationId = "string"
#' )
#' ```
#'
...
#' \donttest{ec2$enable_vgw_route_propagation(
#'   GatewayId = "vgw-9a4cacf3",
#'   RouteTableId = "rtb-22574640"
#' )}
#'
...
#' @section Request syntax:
#' ```
#' ec2$enable_vpc_classic_link_dns_support(
#'   VpcId = "string"
#' )
#' ```
#'
...
#' @section Request syntax:
#' ```
#' ec2$export_client_vpn_client_certificate_revocation_list(
#'   ClientVpnEndpointId = "string",
#'   DryRun = TRUE|FALSE
#' )
#' ```
...
#' @section Request syntax:
#' ```
#' ec2$export_transit_gateway_routes(
#'   TransitGatewayRouteTableId = "string",
#'   Filters = list(
#'     list(
#'       Name = "string",
...
#' \donttest{ec2$get_console_output(
#'   InstanceId = "i-1234567890abcdef0"
#' )}
#'
#' @keywords internal
...
#' @section Request syntax:
#' ```
#' ec2$get_host_reservation_purchase_preview(
#'   HostIdSet = list(
#'     "string"
#'   ),
#'   OfferingId = "string"
...
#' \donttest{ec2$get_launch_template_data(
...
#' @section Request syntax:
#' ```
#' ec2$get_reserved_instances_exchange_quote(
#'   DryRun = TRUE|FALSE,
#'   ReservedInstanceIds = list(
#'     "string"
#'   ),
...
#' @section Request syntax:
#' ```
#' ec2$get_transit_gateway_attachment_propagations(
#'   TransitGatewayAttachmentId = "string",
#'   Filters = list(
#'     list(
#'       Name = "string",
...
#' @section Request syntax:
#' ```
#' ec2$modify_client_vpn_endpoint(
#'   ClientVpnEndpointId = "string",
#'   ServerCertificateArn = "string",
#'   ConnectionLogOptions = list(
#'     Enabled = TRUE|FALSE,
...
#' @param UserIds One or more AWS account IDs. This parameter is valid only when modifying
#' the `loadPermission` attribute.
#' @param UserGroups One or more user groups. This parameter is valid only when modifying the
#' `loadPermission` attribute.
#' @param ProductCodes One or more product codes. After you add a product code to an AFI, it
...
#' @section Request syntax:
#' ```
#' ec2$modify_fpga_image_attribute(
#'   DryRun = TRUE|FALSE,
#'   FpgaImageId = "string",
#'   Attribute = "description"|"name"|"loadPermission"|"productCodes",
...
ec2_modify_hosts <- function(AutoPlacement, HostIds) {
  op <- new_operation(
    name = "ModifyHosts",
    http_method = "POST",
    http_path = "/",
  ...
  input <- .ec2$modify_hosts_input(AutoPlacement = AutoPlacement, HostIds = HostIds)
...
#' @param ProductCodes One or more DevPay product codes. After you add a product code to an
#' AMI, it can\'t be removed.
#' @param UserGroups One or more user groups. This parameter can be used only when the
#' `Attribute` parameter is `launchPermission`.
#' @param UserIds One or more AWS account IDs. This parameter can be used only when the
#' `Attribute` parameter is `launchPermission`.
...
#' \donttest{ec2$modify_image_attribute(
#'   ImageId = "ami-5731123e",
#'   LaunchPermission = list(
#'     Add = list(
#'       list(
...
#' # instance.
#' \donttest{ec2$modify_instance_attribute(
#'   InstanceId = "i-1234567890abcdef0",
#'   InstanceType = list(
#'     Value = "m5.large"
#'   )
...
#' @section Request syntax:
#' ```
#' ec2$modify_instance_capacity_reservation_attributes(
#'   InstanceId = "string",
#'   CapacityReservationSpecification = list(
#'     CapacityReservationPreference = "open"|"none",
#'     CapacityReservationTarget = list(
...
#' @section Request syntax:
#' ```
#' ec2$modify_instance_event_start_time(
#'   DryRun = TRUE|FALSE,
#'   InstanceId = "string",
...
#' # launch template.
#' \donttest{ec2$modify_launch_template(
#'   DefaultVersion = "2",
#'   LaunchTemplateId = "lt-0abcd290751193123"
#' )}
#'
...
#' # interface.
#' \donttest{ec2$modify_network_interface_attribute(
#'   Attachment = list(
...
#' \donttest{ec2$modify_snapshot_attribute(
#'   Attribute = "createVolumePermission",
...
#' # request.
#' \donttest{ec2$modify_spot_fleet_request(
#'   SpotFleetRequestId = "sfr-73fbd2ce-aa30-494c-8788-1cee4EXAMPLE",
#'   TargetCapacity = 20L
#' )}
#' 
...
ec2_modify_spot_fleet_request <- function(ExcessCapacityTerminationPolicy = NULL, SpotFleetRequestId, TargetCapacity = NULL) {
  op <- new_operation(
  ...
  input <- .ec2$modify_spot_fleet_request_input(ExcessCapacityTerminationPolicy = ExcessCapacityTerminationPolicy, SpotFleetRequestId = SpotFleetRequestId, TargetCapacity = TargetCapacity)
...
#' @param MapPublicIpOnLaunch Specify `true` to indicate that network interfaces created in the
#' specified subnet should be assigned a public IPv4 address. This includes
...
#' \donttest{ec2$modify_subnet_attribute(
#'   MapPublicIpOnLaunch = list(
#'     Value = TRUE
#'   ),
#'   SubnetId = "subnet-1a2b3c4d"
...
#' can also track the status of a modification using the
...
#' # output is returned.
#' \donttest{ec2$modify_volume_attribute(
#'   AutoEnableIO = list(
#'     Value = TRUE
#'   ),
#'   DryRun = TRUE,
...
#' # does not.
#' \donttest{ec2$modify_vpc_attribute(
#'   EnableDnsSupport = list(
#'     Value = FALSE
#'   ),
#'   VpcId = "vpc-a01106c2"
...
#' @section Request syntax:
#' ```
#' ec2$modify_vpc_endpoint_connection_notification(
#'   DryRun = TRUE|FALSE,
#'   ConnectionNotificationId = "string",
#'   ConnectionNotificationArn = "string",
#'   ConnectionEvents = list(
...
#' service](https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/endpoint-service.html).
...
#' # platform.
#' \donttest{ec2$move_address_to_vpc(
...
#' Elastic IP address from your address pool, use AllocateAddress with
...
#'   DryRun)
#'
#' @param Cidr &#91;required&#93; The public IPv4 address range, in CIDR notation. The most specific
...
ec2_provision_byoip_cidr <- function(Cidr, CidrAuthorizationContext = NULL, Description = NULL, DryRun = NULL) {
  op <- new_operation(
  ...
  input <- .ec2$provision_byoip_cidr_input(Cidr = Cidr, CidrAuthorizationContext = CidrAuthorizationContext, Description = Description, DryRun = DryRun)
...
ec2_purchase_host_reservation <- function(ClientToken = NULL, CurrencyCode = NULL, HostIdSet, LimitPrice = NULL, OfferingId) {
  op <- new_operation(
  ...
  input <- .ec2$purchase_host_reservation_input(ClientToken = ClientToken, CurrencyCode = CurrencyCode, HostIdSet = HostIdSet, LimitPrice = LimitPrice, OfferingId = OfferingId)
...
#' \donttest{ec2$purchase_scheduled_instances(
#'   PurchaseRequests = list(
#'     list(
#'       InstanceCount = 1L,
...
ec2_register_image <- function(ImageLocation = NULL, Architecture = NULL, BlockDeviceMappings = NULL, Description = NULL, DryRun = NULL, EnaSupport = NULL, KernelId = NULL, Name, BillingProducts = NULL, RamdiskId = NULL, RootDeviceName = NULL, SriovNetSupport = NULL, VirtualizationType = NULL) {
  op <- new_operation(
    name = "RegisterImage",
    http_method = "POST",
    http_path = "/",
  ...
  input <- .ec2$register_image_input(ImageLocation = ImageLocation, Architecture = Architecture, BlockDeviceMappings = BlockDeviceMappings, Description = Description, DryRun = DryRun, EnaSupport = EnaSupport, KernelId = KernelId, Name = Name, BillingProducts = BillingProducts, RamdiskId = RamdiskId, RootDeviceName = RootDeviceName, SriovNetSupport = SriovNetSupport, VirtualizationType = VirtualizationType)
...
#' \donttest{ec2$replace_network_acl_association(
...
#' \donttest{ec2$replace_network_acl_entry(
...
#' \donttest{ec2$replace_route_table_association(
#'   AssociationId = "rtbassoc-781d0d1a",
#'   RouteTableId = "rtb-22574640"
#' )}
#'
...
#' @param ReasonCodes &#91;required&#93; One or more reason codes that describe the health state of your
#' instance.
#' 
...
#' \donttest{ec2$request_spot_fleet(
#'   SpotFleetRequestConfig = list(
...
#' @param LaunchSpecification The launch specification.
#' @param SpotPrice The maximum price per hour that you are willing to pay for a Spot
...
#' # Availability Zone.
#' \donttest{ec2$request_spot_instances(
#'   InstanceCount = 5L,
#'   LaunchSpecification = list(
#'     IamInstanceProfile = list(
#'       Arn = "arn:aws:iam::123456789012:instance-profile/my-iam-role"
...
ec2_request_spot_instances <- function(AvailabilityZoneGroup = NULL, BlockDurationMinutes = NULL, ClientToken = NULL, DryRun = NULL, InstanceCount = NULL, LaunchGroup = NULL, LaunchSpecification = NULL, SpotPrice = NULL, Type = NULL, ValidFrom = NULL, ValidUntil = NULL, InstanceInterruptionBehavior = NULL) {
  op <- new_operation(
...
#' @section Request syntax:
#' ```
#' ec2$reset_fpga_image_attribute(
#'   DryRun = TRUE|FALSE,
#'   FpgaImageId = "string",
...
#' \donttest{ec2$reset_image_attribute(
#'   Attribute = "launchPermission",
#'   ImageId = "ami-5731123e"
#' )}
#'
...
#' # instance.
#' \donttest{ec2$reset_instance_attribute(
#'   Attribute = "sourceDestCheck",
#'   InstanceId = "i-1234567890abcdef0"
#' )}
#'
...
#' @section Request syntax:
#' ```
#' ec2$reset_network_interface_attribute(
#'   DryRun = TRUE|FALSE,
#'   NetworkInterfaceId = "string",
...
#' # ``snap-1234567890abcdef0``. If the command succeeds, no output is
#' # returned.
#' \donttest{ec2$reset_snapshot_attribute(
#'   Attribute = "createVolumePermission",
#'   SnapshotId = "snap-1234567890abcdef0"
#' )}
#'
...
#' @section Request syntax:
#' ```
#' ec2$restore_address_to_classic(
#'   DryRun = TRUE|FALSE,
#'   PublicIp = "string"
#' )
#' ```
...
#' # EC2-Classic platform.
#' \donttest{ec2$restore_address_to_classic(
#'   PublicIp = "198.51.100.0"
#' )}
#'
#' @keywords internal
...
ec2_revoke_security_group_egress <- function(DryRun = NULL, GroupId, IpPermissions = NULL, CidrIp = NULL, FromPort = NULL, IpProtocol = NULL, ToPort = NULL, SourceSecurityGroupName = NULL, SourceSecurityGroupOwnerId = NULL) {
  op <- new_operation(
  ...
  input <- .ec2$revoke_security_group_egress_input(DryRun = DryRun, GroupId = GroupId, IpPermissions = IpPermissions, CidrIp = CidrIp, FromPort = FromPort, IpProtocol = IpProtocol, ToPort = ToPort, SourceSecurityGroupName = SourceSecurityGroupName, SourceSecurityGroupOwnerId = SourceSecurityGroupOwnerId)
...
#' specify either the security group ID or the security group name in the
#' request.
#' @param IpPermissions One or more sets of IP permissions. You can\'t specify a source security
...
#' @param SourceSecurityGroupOwnerId \[EC2-Classic\] The AWS account ID of the source security group, if the
...
ec2_revoke_security_group_ingress <- function(CidrIp = NULL, FromPort = NULL, GroupId = NULL, GroupName = NULL, IpPermissions = NULL, IpProtocol = NULL, SourceSecurityGroupName = NULL, SourceSecurityGroupOwnerId = NULL, ToPort = NULL, DryRun = NULL) {
  op <- new_operation(
  ...
  input <- .ec2$revoke_security_group_ingress_input(CidrIp = CidrIp, FromPort = FromPort, GroupId = GroupId, GroupName = GroupName, IpPermissions = IpPermissions, IpProtocol = IpProtocol, SourceSecurityGroupName = SourceSecurityGroupName, SourceSecurityGroupOwnerId = SourceSecurityGroupOwnerId, ToPort = ToPort, DryRun = DryRun)
...
#'
#' @param BlockDeviceMappings One or more block device mapping entries. You can\'t specify both a
...
#' encryption status.
#' @param ImageId The ID of the AMI, which you can get by calling DescribeImages. An AMI
...
#' 
#' Default: `m1.small`
#' @param Ipv6AddressCount \[EC2-VPC\] A number of IPv6 addresses to associate with the primary
...
#' same request.
#' @param Ipv6Addresses \[EC2-VPC\] Specify one or more IPv6 addresses from the range of the
...
#' [PV-GRUB](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/UserProvidedkernels.html)
#' in the *Amazon Elastic Compute Cloud User Guide*.
#' @param KeyName The name of the key pair. You can create a key pair using CreateKeyPair
#' or ImportKeyPair.
#' 
...
#' You cannot specify this option and the network interfaces option in the
#' same request.
#' @param UserData The user data to make available to the instance. For more information,
#' see [Running Commands on Your Linux Instance at
...
#' this attribute to `false` after launch, use ModifyInstanceAttribute.
...
#' `stop`.
#' @param CreditSpecification The credit option for CPU usage of the instance. Valid values are
...
#' \donttest{ec2$run_scheduled_instances(
#'   InstanceCount = 1L,
#'   LaunchSpecification = list(
#'     IamInstanceProfile = list(
#'       Name = "my-iam-role"
...
#' \donttest{ec2$terminate_instances(
#'   InstanceIds = list(
#'     "i-1234567890abcdef0"
#'   )
#' )}
...
#'
#' @usage
#' ec2_unassign_ipv_6_addresses(Ipv6Addresses, NetworkInterfaceId)
#'
...
ec2_unassign_ipv_6_addresses <- function(Ipv6Addresses, NetworkInterfaceId) {
  op <- new_operation(
  ...
  input <- .ec2$unassign_ipv_6_addresses_input(Ipv6Addresses = Ipv6Addresses, NetworkInterfaceId = NetworkInterfaceId)
...
#' # specified network interface.
#' \donttest{ec2$unassign_private_ip_addresses(
#'   NetworkInterfaceId = "eni-e5aa89a3",
#'   PrivateIpAddresses = list(
#'     "10.0.0.82"
#'   )
...
ec2_unassign_private_ip_addresses <- function(NetworkInterfaceId, PrivateIpAddresses) {
  op <- new_operation(
  ...
  input <- .ec2$unassign_private_ip_addresses_input(NetworkInterfaceId = NetworkInterfaceId, PrivateIpAddresses = PrivateIpAddresses)
...
#' # rule.
#' \donttest{ec2$update_security_group_rule_descriptions_egress(
#'   GroupId = "sg-123abc12",
#'   IpPermissions = list(
#'     list(
#'       FromPort = 80L,
...
ec2_update_security_group_rule_descriptions_egress <- function(DryRun = NULL, GroupId = NULL, GroupName = NULL, IpPermissions) {
  op <- new_operation(
  ...
  input <- .ec2$update_security_group_rule_descriptions_egress_input(DryRun = DryRun, GroupId = GroupId, GroupName = GroupName, IpPermissions = IpPermissions)
...
#' # This example updates the description for the specified security group
#' # rule.
#' \donttest{ec2$update_security_group_rule_descriptions_ingress(
#'   GroupId = "sg-123abc12",
#'   IpPermissions = list(
#'     list(
#'       FromPort = 22L,
...
ec2_update_security_group_rule_descriptions_ingress <- function(DryRun = NULL, GroupId = NULL, GroupName = NULL, IpPermissions) {
  op <- new_operation(
  ...
  input <- .ec2$update_security_group_rule_descriptions_ingress_input(DryRun = DryRun, GroupId = GroupId, GroupName = GroupName, IpPermissions = IpPermissions)
