...
#' @param kmsKeyId &#91;required&#93; The Amazon Resource Name (ARN) of the CMK to use when encrypting log data. For more information, see [Amazon Resource Names - AWS Key Management Service (AWS KMS)](http://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kms).
#'
#' @export
associate_kms_key <- function (logGroupName, kmsKeyId) 
{
    op <- new_operation(name = "AssociateKmsKey", http_method = "POST", 
...
{
    op <- new_operation(name = "CancelExportTask", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
create_export_task <- function (taskName = NULL, logGroupName, 
    logStreamNamePrefix = NULL, from, to, destination, destinationPrefix = NULL) 
{
    op <- new_operation(name = "CreateExportTask", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_export_task_input(taskName = taskName, logGroupName = logGroupName, 
        logStreamNamePrefix = logStreamNamePrefix, from = from, 
        to = to, destination = destination, destinationPrefix = destinationPrefix)
...
create_log_group <- function (logGroupName, kmsKeyId = NULL, 
    tags = NULL) 
{
    op <- new_operation(name = "CreateLogGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateLogStream", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteDestination", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteLogGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteLogStream", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteMetricFilter", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteRetentionPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteSubscriptionFilter", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeDestinations", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_log_groups <- function (logGroupNamePrefix = NULL, nextToken = NULL, 
    limit = NULL) 
{
    op <- new_operation(name = "DescribeLogGroups", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeLogStreams", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeMetricFilters", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeResourcePolicies", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_subscription_filters <- function (logGroupName, filterNamePrefix = NULL, 
    nextToken = NULL, limit = NULL) 
{
    op <- new_operation(name = "DescribeSubscriptionFilters", 
...
{
    op <- new_operation(name = "DisassociateKmsKey", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "FilterLogEvents", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetLogEvents", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListTagsLogGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PutDestination", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param accessPolicy &#91;required&#93; An IAM policy document that authorizes cross-account users to deliver their log events to the associated destination.
#'
#' @export
put_destination_policy <- function (destinationName, accessPolicy) 
{
    op <- new_operation(name = "PutDestinationPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
put_log_events <- function (logGroupName, logStreamName, logEvents, 
    sequenceToken = NULL) 
{
    op <- new_operation(name = "PutLogEvents", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PutMetricFilter", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PutRetentionPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PutSubscriptionFilter", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "TagLogGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "TestMetricFilter", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UntagLogGroup", http_method = "POST", 
        http_path = "/", paginator = list())
