...
{
    op <- Operation(name = "DescribeQueries", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetLogGroupFields", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetLogRecord", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param startTime &#91;required&#93; The time to start the query. Specified as epoch time, the number of seconds since January 1, 1970, 00:00:00 UTC.
#' @param endTime &#91;required&#93; The time to end this query, if it is still running. Specified as epoch time, the number of seconds since January 1, 1970, 00:00:00 UTC.
...
start_query <- function (logGroupName, startTime, endTime, queryString, 
    limit = NULL) 
{
    op <- Operation(name = "StartQuery", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "StopQuery", http_method = "POST", 
        http_path = "/", paginator = list())
