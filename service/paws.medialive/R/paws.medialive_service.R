service <- function () 
{
    cfg <- client_config("medialive", list(`*` = "medialive.{region}.amazonaws.com", 
        `cn-*` = "medialive.{region}.amazonaws.com.cn"))
    client_info <- ClientInfo(service_name = "medialive", service_id = "MediaLive", 
        api_version = "2017-10-14", signing_name = "medialive", 
