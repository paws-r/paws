...
#' ```
#'
#' @param ResourceArn &#91;required&#93; The Amazon Resource Name (ARN) of the AWS DMS resource the tag is to be added to. AWS DMS resources include a replication instance, endpoint, and a replication task.
...
#' @param SnsTopicArn &#91;required&#93; The Amazon Resource Name (ARN) of the Amazon SNS topic created for event notification. The ARN is created by Amazon SNS when you create a topic and subscribe to it.
...
#' ```
#'
#' @param ReplicationInstanceIdentifier &#91;required&#93; The replication instance identifier. This parameter is stored as a lowercase string.
#' 
#' Constraints:
#' 
...
#' @param ReplicationInstanceClass &#91;required&#93; The compute and memory capacity of the replication instance as specified by the replication instance class.
#' 
...
#' @examples
#' # Creates the replication instance using the specified parameters.
#' \donttest{create_replication_instance(
...
create_replication_instance <- function (ReplicationInstanceIdentifier, 
    AllocatedStorage = NULL, ReplicationInstanceClass, VpcSecurityGroupIds = NULL, 
    ...
    PubliclyAccessible = NULL) 
{
    ...
    input <- create_replication_instance_input(ReplicationInstanceIdentifier = ReplicationInstanceIdentifier, 
        AllocatedStorage = AllocatedStorage, ReplicationInstanceClass = ReplicationInstanceClass, 
...
#' ```
#'
#' @param ReplicationSubnetGroupIdentifier &#91;required&#93; The name for the replication subnet group. This value is stored as a lowercase string.
#' 
...
#' # VPC.
#' \donttest{create_replication_subnet_group(
...
{
    op <- new_operation(name = "CreateReplicationSubnetGroup", 
...
#'   CdcStartTime = as.POSIXct("2015-01-01"),
...
#' 
#' -   Cannot end with a hyphen or contain two consecutive hyphens.
#' @param SourceEndpointArn &#91;required&#93; The Amazon Resource Name (ARN) string that uniquely identifies the endpoint.
#' @param TargetEndpointArn &#91;required&#93; The Amazon Resource Name (ARN) string that uniquely identifies the endpoint.
...
#' @examples
#' # Creates a replication task using the specified parameters.
#' \donttest{create_replication_task(
...
create_replication_task <- function (ReplicationTaskIdentifier, 
    ...
    Tags = NULL) 
{
    op <- new_operation(name = "CreateReplicationTask", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param EndpointArn &#91;required&#93; The Amazon Resource Name (ARN) string that uniquely identifies the endpoint.
#'
#' @examples
#' # Deletes the specified endpoint. All tasks associated with the endpoint
#' # must be deleted before you can delete the endpoint.
#' # 
#' \donttest{delete_endpoint(
...
#' ```
#'
#' @param ReplicationInstanceArn &#91;required&#93; The Amazon Resource Name (ARN) of the replication instance to be deleted.
#'
#' @examples
...
#' # 
#' # 
#' \donttest{delete_replication_instance(
#'   ReplicationInstanceArn = "arn:aws:dms:us-east-1:123456789012:rep:6UTDJGBOUS3VI3SUWA66XFJCJQ"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "DeleteReplicationInstance", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{delete_replication_subnet_group(
#'   ReplicationSubnetGroupIdentifier = "us-west-2ab-vpc-215ds366"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "DeleteReplicationSubnetGroup", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' @examples
#' # Deletes the specified replication task.
#' \donttest{delete_replication_task(
...
{
    op <- new_operation(name = "DeleteReplicationTask", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_account_attributes()}
#'
#' @export
...
#' @examples
#' # Provides a description of the certificate.
#' \donttest{describe_certificates(
#'   Filters = list(
#'     list(
#'       Name = "string",
#'       Values = list(
...
describe_certificates <- function (Filters = NULL, MaxRecords = NULL, 
    Marker = NULL) 
{
    op <- new_operation(name = "DescribeCertificates", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_connections <- function (Filters = NULL, MaxRecords = NULL, 
    Marker = NULL) 
{
    op <- new_operation(name = "DescribeConnections", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @examples
#' # Returns information about the type of endpoints available.
#' \donttest{describe_endpoint_types(
#'   Filters = list(
#'     list(
#'       Name = "string",
#'       Values = list(
...
describe_endpoint_types <- function (Filters = NULL, MaxRecords = NULL, 
    Marker = NULL) 
{
    op <- new_operation(name = "DescribeEndpointTypes", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_endpoints <- function (Filters = NULL, MaxRecords = NULL, 
    Marker = NULL) 
{
    op <- new_operation(name = "DescribeEndpoints", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_orderable_replication_instances(
#'   Marker = "",
#'   MaxRecords = 123L
#' )}
#'
...
describe_orderable_replication_instances <- function (MaxRecords = NULL, 
    Marker = NULL) 
{
    op <- new_operation(name = "DescribeOrderableReplicationInstances", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{describe_refresh_schemas_status(
#'   EndpointArn = ""
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "DescribeRefreshSchemasStatus", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeReplicationInstanceTaskLogs", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' @examples
#' # Returns the status of the refresh-schemas operation.
#' \donttest{describe_replication_instances(
#'   Filters = list(
#'     list(
#'       Name = "string",
#'       Values = list(
...
describe_replication_instances <- function (Filters = NULL, MaxRecords = NULL, 
    Marker = NULL) 
{
    op <- new_operation(name = "DescribeReplicationInstances", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' @examples
#' # Returns information about the replication subnet groups.
#' \donttest{describe_replication_subnet_groups(
#'   Filters = list(
#'     list(
#'       Name = "string",
#'       Values = list(
...
describe_replication_subnet_groups <- function (Filters = NULL, 
    MaxRecords = NULL, Marker = NULL) 
{
    op <- new_operation(name = "DescribeReplicationSubnetGroups", 
        http_method = "POST", http_path = "/", paginator = list())
...
describe_replication_task_assessment_results <- function (ReplicationTaskArn = NULL, 
    MaxRecords = NULL, Marker = NULL) 
{
    op <- new_operation(name = "DescribeReplicationTaskAssessmentResults", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # current region.
#' \donttest{describe_replication_tasks(
#'   Filters = list(
#'     list(
#'       Name = "string",
#'       Values = list(
...
describe_replication_tasks <- function (Filters = NULL, MaxRecords = NULL, 
    Marker = NULL) 
{
    op <- new_operation(name = "DescribeReplicationTasks", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_schemas <- function (EndpointArn, MaxRecords = NULL, 
    Marker = NULL) 
{
    op <- new_operation(name = "DescribeSchemas", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_table_statistics(
#'   Marker = "",
#'   MaxRecords = 123L,
#'   ReplicationTaskArn = ""
#' )}
...
{
    op <- new_operation(name = "DescribeTableStatistics", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param CertificateIdentifier &#91;required&#93; The customer-assigned name of the certificate. Valid characters are A-z and 0-9.
...
#' ```
#'
#' @param ResourceArn &#91;required&#93; The Amazon Resource Name (ARN) string that uniquely identifies the AWS DMS resource.
#'
#' @examples
#' # Lists all tags for an AWS DMS resource.
...
#' \donttest{modify_replication_instance(
#'   AllocatedStorage = 123L,
...
{
    op <- new_operation(name = "ModifyReplicationInstance", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @examples
#' # Modifies the settings for the specified replication subnet group.
#' \donttest{modify_replication_subnet_group(
...
modify_replication_subnet_group <- function (ReplicationSubnetGroupIdentifier, 
    ReplicationSubnetGroupDescription = NULL, SubnetIds) 
{
    op <- new_operation(name = "ModifyReplicationSubnetGroup", 
        http_method = "POST", http_path = "/", paginator = list())
...
modify_replication_task <- function (ReplicationTaskArn, ReplicationTaskIdentifier = NULL, 
    ...
    CdcStartTime = NULL, CdcStartPosition = NULL, CdcStopPosition = NULL) 
{
    op <- new_operation(name = "ModifyReplicationTask", http_method = "POST", 
        http_path = "/", paginator = list())
...
reboot_replication_instance <- function (ReplicationInstanceArn, 
    ForceFailover = NULL) 
{
    op <- new_operation(name = "RebootReplicationInstance", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RefreshSchemas", http_method = "POST", 
        http_path = "/", paginator = list())
...
reload_tables <- function (ReplicationTaskArn, TablesToReload, 
    ReloadOption = NULL) 
{
    op <- new_operation(name = "ReloadTables", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param ResourceArn &#91;required&#93; \>The Amazon Resource Name (ARN) of the AWS DMS resource the tag is to be removed from.
...
#' @examples
#' # Starts the replication task.
#' \donttest{start_replication_task(
...
start_replication_task <- function (ReplicationTaskArn, StartReplicationTaskType, 
    CdcStartTime = NULL, CdcStartPosition = NULL, CdcStopPosition = NULL) 
{
    op <- new_operation(name = "StartReplicationTask", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StartReplicationTaskAssessment", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' @examples
#' # Stops the replication task.
#' \donttest{stop_replication_task(
...
{
    op <- new_operation(name = "StopReplicationTask", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "TestConnection", http_method = "POST", 
        http_path = "/", paginator = list())
