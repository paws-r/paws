...
{
    op <- new_operation(name = "CheckDomainAvailability", http_method = "POST", 
...
{
    op <- new_operation(name = "CheckDomainTransferability", 
...
{
    op <- new_operation(name = "DeleteTagsForDomain", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DisableDomainAutoRenew", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DisableDomainTransferLock", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "EnableDomainAutoRenew", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "EnableDomainTransferLock", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetContactReachabilityStatus", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetDomainDetail", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param DomainName &#91;required&#93; A domain name that you want to use as the basis for a list of possible domain names. The domain name must contain a top-level domain (TLD), such as .com, that Amazon Route 53 supports. For a list of TLDs, see [Domains that You Can Register with Amazon Route 53](http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/registrar-tld-list.html) in the *Amazon Route 53 Developer Guide*.
#' @param SuggestionCount &#91;required&#93; The number of suggested domain names that you want Amazon Route 53 to return.
#' @param OnlyAvailable &#91;required&#93; If `OnlyAvailable` is `true`, Amazon Route 53 returns only domain names that are available. If `OnlyAvailable` is `false`, Amazon Route 53 returns domain names without checking whether they\'re available to be registered. To determine whether the domain is available, you can call `checkDomainAvailability` for each suggestion.
#'
#' @export
get_domain_suggestions <- function (DomainName, SuggestionCount, 
    OnlyAvailable) 
{
    op <- new_operation(name = "GetDomainSuggestions", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param OperationId &#91;required&#93; The identifier for the operation for which you want to get the status. Amazon Route 53 returned the identifier in the response to the original request.
#'
#' @export
get_operation_detail <- function (OperationId) 
{
    op <- new_operation(name = "GetOperationDetail", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#' list_operations(
#'   SubmittedSince = as.POSIXct("2015-01-01"),
#'   Marker = "string",
#'   MaxItems = 123
#' )
#' ```
...
{
    op <- new_operation(name = "ListTagsForDomain", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
register_domain <- function (DomainName, IdnLangCode = NULL, 
    DurationInYears, AutoRenew = NULL, AdminContact, RegistrantContact, 
    TechContact, PrivacyProtectAdminContact = NULL, PrivacyProtectRegistrantContact = NULL, 
    PrivacyProtectTechContact = NULL) 
{
    op <- new_operation(name = "RegisterDomain", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- register_domain_input(DomainName = DomainName, IdnLangCode = IdnLangCode, 
        DurationInYears = DurationInYears, AutoRenew = AutoRenew, 
...
#'
#' @export
renew_domain <- function (DomainName, DurationInYears = NULL, 
    CurrentExpiryYear) 
{
    op <- new_operation(name = "RenewDomain", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- renew_domain_input(DomainName = DomainName, DurationInYears = DurationInYears, 
...
{
    op <- new_operation(name = "ResendContactReachabilityEmail", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RetrieveDomainAuthCode", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' Constraints: The domain name can contain only the letters a through z, the numbers 0 through 9, and hyphen (-). Internationalized Domain Names are not supported.
#' @param IdnLangCode Reserved for future use.
#' @param DurationInYears &#91;required&#93; The number of years that you want to register the domain for. Domains are registered for a minimum of one year. The maximum period depends on the top-level domain.
#' 
#' Default: 1
...
#'
#' @export
transfer_domain <- function (DomainName, IdnLangCode = NULL, 
    DurationInYears, Nameservers = NULL, AuthCode = NULL, AutoRenew = NULL, 
    AdminContact, RegistrantContact, TechContact, PrivacyProtectAdminContact = NULL, 
    PrivacyProtectRegistrantContact = NULL, PrivacyProtectTechContact = NULL) 
{
    op <- new_operation(name = "TransferDomain", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- transfer_domain_input(DomainName = DomainName, IdnLangCode = IdnLangCode, 
        DurationInYears = DurationInYears, Nameservers = Nameservers, 
        AuthCode = AuthCode, AutoRenew = AutoRenew, AdminContact = AdminContact, 
...
{
    op <- new_operation(name = "UpdateDomainContact", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateDomainContactPrivacy", 
        http_method = "POST", http_path = "/", paginator = list())
...
#'
#' @export
update_domain_nameservers <- function (DomainName, FIAuthKey = NULL, 
    Nameservers) 
{
    op <- new_operation(name = "UpdateDomainNameservers", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_domain_nameservers_input(DomainName = DomainName, 
        FIAuthKey = FIAuthKey, Nameservers = Nameservers)
...
{
    op <- new_operation(name = "UpdateTagsForDomain", http_method = "POST", 
        http_path = "/", paginator = list())
...
view_billing <- function (Start = NULL, End = NULL, Marker = NULL, 
    MaxItems = NULL) 
{
    op <- new_operation(name = "ViewBilling", http_method = "POST", 
        http_path = "/", paginator = list())
