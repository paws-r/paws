service <- function () 
{
    cfg <- client_config("cloudsearch", list(`*` = "cloudsearch.{region}.amazonaws.com", 
        `cn-*` = "cloudsearch.{region}.amazonaws.com.cn"))
    client_info <- ClientInfo(service_name = "cloudsearch", service_id = "CloudSearch", 
        api_version = "2013-01-01", signing_name = cfg$signing_name, 
