...
#' @param InputId The ID of the input configuration to add the input processing configuration to. You can get a list of the input IDs for an application using the DescribeApplication operation.
...
#' @param CurrentApplicationVersionId Version of the application to which you want to add the output configuration. You can use the DescribeApplication operation to get the current application version. If the version specified is not the current version, the `ConcurrentModificationException` is returned.
...
#' @param CloudWatchLoggingOptions Use this parameter to configure a CloudWatch log stream to monitor application configuration errors. For more information, see [Working with Amazon CloudWatch Logs](http://docs.aws.amazon.com/kinesisanalytics/latest/dev/cloudwatch-logs.html).
    ...
    ApplicationCode = NULL) 
{
    ...
    input <- create_application_input(ApplicationName = ApplicationName, 
        ApplicationDescription = ApplicationDescription, Inputs = Inputs, 
        Outputs = Outputs, CloudWatchLoggingOptions = CloudWatchLoggingOptions, 
...
#' @param ApplicationName The Kinesis Analytics application name.
#' @param CurrentApplicationVersionId The version ID of the Kinesis Analytics application.
#' @param CloudWatchLoggingOptionId The `CloudWatchLoggingOptionId` of the CloudWatch logging option to delete. You can get the `CloudWatchLoggingOptionId` by using the DescribeApplication operation.
#'
#' @examples
#'
#' @export
...
#' @param ApplicationName The Kinesis Analytics application name.
#' @param CurrentApplicationVersionId The version ID of the Kinesis Analytics application.
#' @param InputId The ID of the input configuration from which to delete the input processing configuration. You can get a list of the input IDs for an application by using the DescribeApplication operation.
#'
#' @examples
#'
#' @export
...
#'
#' @export
describe_application <- function (ApplicationName) 
{
...
#'
#' @export
discover_input_schema <- function (ResourceARN = NULL, RoleARN = NULL, 
    ...
    InputProcessingConfiguration = NULL) 
{
    ...
    input <- discover_input_schema_input(ResourceARN = ResourceARN, 
        RoleARN = RoleARN, InputStartingPositionConfiguration = InputStartingPositionConfiguration, 
...
#'
#' @export
list_applications <- function (Limit = NULL, ExclusiveStartApplicationName = NULL) 
{
    op <- Operation(name = "ListApplications", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_applications_input(Limit = Limit, ExclusiveStartApplicationName = ExclusiveStartApplicationName)
...
#'
#' @export
start_application <- function (ApplicationName, InputConfigurations) 
{
