...
{
    op <- new_operation(name = "CreateActivity", http_method = "POST", 
...
{
    op <- new_operation(name = "CreateStateMachine", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteActivity", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteStateMachine", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeActivity", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeExecution", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeStateMachine", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeStateMachineForExecution", 
...
#' ```
#'
#' @param activityArn &#91;required&#93; The Amazon Resource Name (ARN) of the activity to retrieve tasks from (assigned when you create the task using CreateActivity.)
...
{
    op <- new_operation(name = "GetActivityTask", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetExecutionHistory", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListActivities", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListExecutions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListStateMachines", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "SendTaskFailure", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param taskToken &#91;required&#93; The token that represents this task. Task tokens are generated by the service when the tasks are assigned to a worker (see GetActivityTaskOutput\$taskToken).
#'
#' @export
send_task_heartbeat <- function (taskToken) 
{
    op <- new_operation(name = "SendTaskHeartbeat", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "SendTaskSuccess", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StartExecution", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StopExecution", http_method = "POST", 
        http_path = "/", paginator = list())
...
update_state_machine <- function (stateMachineArn, definition = NULL, 
    roleArn = NULL) 
{
    op <- new_operation(name = "UpdateStateMachine", http_method = "POST", 
        http_path = "/", paginator = list())
