...
{
    op <- Operation(name = "CreateConnectorDefinition", http_method = "POST", 
...
{
    op <- Operation(name = "CreateConnectorDefinitionVersion", 
...
{
    op <- Operation(name = "DeleteConnectorDefinition", http_method = "DELETE", 
...
{
    op <- Operation(name = "GetBulkDeploymentStatus", http_method = "GET", 
...
{
    op <- Operation(name = "GetConnectorDefinition", http_method = "GET", 
        http_path = "/greengrass/definition/connectors/{ConnectorDefinitionId}", 
        paginator = list())
...
{
    op <- Operation(name = "GetConnectorDefinitionVersion", http_method = "GET", 
...
{
    op <- Operation(name = "ListBulkDeploymentDetailedReports", 
...
{
    op <- Operation(name = "ListBulkDeployments", http_method = "GET", 
...
list_connector_definition_versions <- function (ConnectorDefinitionId, 
    MaxResults = NULL, NextToken = NULL) 
{
    op <- Operation(name = "ListConnectorDefinitionVersions", 
...
{
    op <- Operation(name = "ListConnectorDefinitions", http_method = "GET", 
        http_path = "/greengrass/definition/connectors", paginator = list())
...
start_bulk_deployment <- function (AmznClientToken = NULL, ExecutionRoleArn = NULL, 
    InputFileUri = NULL) 
{
    op <- Operation(name = "StartBulkDeployment", http_method = "POST", 
        http_path = "/greengrass/bulk/deployments", paginator = list())
...
{
    op <- Operation(name = "StopBulkDeployment", http_method = "PUT", 
...
update_connector_definition <- function (ConnectorDefinitionId, 
    Name = NULL) 
{
    op <- Operation(name = "UpdateConnectorDefinition", http_method = "PUT", 
        http_path = "/greengrass/definition/connectors/{ConnectorDefinitionId}", 
        paginator = list())
