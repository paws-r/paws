...
associate_role_to_group_input <- function (...) 
{
    ...
    shape <- structure(list(GroupId = structure(logical(0), tags = list(location = "uri", 
        locationName = "GroupId", type = "string")), RoleArn = structure(logical(0), 
...
create_core_definition_input <- function (...) 
{
    ...
    shape <- structure(list(AmznClientToken = structure(logical(0), 
        ...
        tags = list(type = "string")), SyncShadow = structure(logical(0), 
        tags = list(type = "boolean")), ThingArn = structure(logical(0), 
        tags = list(type = "string"))), tags = list(type = "structure"))), 
...
create_core_definition_version_input <- function (...) 
{
    ...
    shape <- structure(list(AmznClientToken = structure(logical(0), 
        ...
        tags = list(location = "uri", locationName = "CoreDefinitionId", 
...
create_deployment_input <- function (...) 
{
    ...
    shape <- structure(list(AmznClientToken = structure(logical(0), 
        ...
        tags = list(type = "string")), DeploymentType = structure(logical(0), 
        tags = list(type = "string", enum = c("NewDeployment", 
            "Redeployment", "ResetDeployment", "ForceResetDeployment"))), 
        GroupId = structure(logical(0), tags = list(location = "uri", 
            locationName = "GroupId", type = "string")), GroupVersionId = structure(logical(0), 
            tags = list(type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
create_device_definition_version_input <- function (...) 
{
    ...
    shape <- structure(list(AmznClientToken = structure(logical(0), 
        ...
        tags = list(location = "uri", locationName = "DeviceDefinitionId", 
...
create_function_definition_input <- function (...) 
{
    ...
    shape <- structure(list(AmznClientToken = structure(logical(0), 
        ...
        Environment = structure(list(AccessSysfs = structure(logical(0), 
            ...
            Variables = structure(list(structure(logical(0), 
                tags = list(type = "string"))), tags = list(type = "map"))), 
            tags = list(type = "structure")), ExecArgs = structure(logical(0), 
            tags = list(type = "string")), Executable = structure(logical(0), 
            tags = list(type = "string")), MemorySize = structure(logical(0), 
            tags = list(type = "integer")), Pinned = structure(logical(0), 
...
create_group_input <- function (...) 
{
    ...
    shape <- structure(list(AmznClientToken = structure(logical(0), 
        ...
        tags = list(type = "string")), ResourceDefinitionVersionArn = structure(logical(0), 
        tags = list(type = "string")), SubscriptionDefinitionVersionArn = structure(logical(0), 
        tags = list(type = "string"))), tags = list(type = "structure")), 
        Name = structure(logical(0), tags = list(type = "string"))), 
        tags = list(type = "structure"))
    return(populate(args, shape))
...
create_group_certificate_authority_input <- function (...) 
{
    ...
    shape <- structure(list(AmznClientToken = structure(logical(0), 
        ...
        tags = list(location = "uri", locationName = "GroupId", 
...
create_logger_definition_input <- function (...) 
{
    ...
    shape <- structure(list(AmznClientToken = structure(logical(0), 
        ...
        tags = list(type = "string", enum = c("GreengrassSystem", 
            "Lambda"))), Id = structure(logical(0), tags = list(type = "string")), 
        Level = structure(logical(0), tags = list(type = "string", 
            enum = c("DEBUG", "INFO", "WARN", "ERROR", "FATAL"))), 
        Space = structure(logical(0), tags = list(type = "integer")), 
        Type = structure(logical(0), tags = list(type = "string", 
            enum = c("FileSystem", "AWSCloudWatch")))), tags = list(type = "structure"))), 
        tags = list(type = "list"))), tags = list(type = "structure")), 
        Name = structure(logical(0), tags = list(type = "string"))), 
        tags = list(type = "structure"))
    return(populate(args, shape))
...
create_logger_definition_version_input <- function (...) 
{
    ...
    shape <- structure(list(AmznClientToken = structure(logical(0), 
        ...
        tags = list(location = "uri", locationName = "LoggerDefinitionId", 
...
create_resource_definition_input <- function (...) 
{
    ...
    shape <- structure(list(AmznClientToken = structure(logical(0), 
        ...
        tags = list(type = "string")), ResourceDataContainer = structure(list(LocalDeviceResourceData = structure(list(GroupOwnerSetting = structure(list(AutoAddGroupOwner = structure(logical(0), 
        tags = list(type = "boolean")), GroupOwner = structure(logical(0), 
        tags = list(type = "string"))), tags = list(type = "structure")), 
        SourcePath = structure(logical(0), tags = list(type = "string"))), 
        tags = list(type = "structure")), LocalVolumeResourceData = structure(list(DestinationPath = structure(logical(0), 
        tags = list(type = "string")), GroupOwnerSetting = structure(list(AutoAddGroupOwner = structure(logical(0), 
        tags = list(type = "boolean")), GroupOwner = structure(logical(0), 
        tags = list(type = "string"))), tags = list(type = "structure")), 
        SourcePath = structure(logical(0), tags = list(type = "string"))), 
        tags = list(type = "structure")), S3MachineLearningModelResourceData = structure(list(DestinationPath = structure(logical(0), 
        tags = list(type = "string")), S3Uri = structure(logical(0), 
        tags = list(type = "string"))), tags = list(type = "structure")), 
...
create_resource_definition_version_input <- function (...) 
{
    ...
    shape <- structure(list(AmznClientToken = structure(logical(0), 
        ...
        tags = list(location = "uri", locationName = "ResourceDefinitionId", 
...
create_software_update_job_input <- function (...) 
{
    ...
    shape <- structure(list(AmznClientToken = structure(logical(0), 
        ...
        tags = list(type = "string")), SoftwareToUpdate = structure(logical(0), 
        tags = list(type = "string", enum = c("core", "ota_agent"))), 
        UpdateAgentLogLevel = structure(logical(0), tags = list(type = "string", 
            enum = c("NONE", "TRACE", "DEBUG", "VERBOSE", "INFO", 
                "WARN", "ERROR", "FATAL"))), UpdateTargets = structure(list(structure(logical(0), 
            tags = list(type = "string"))), tags = list(type = "list")), 
        UpdateTargetsArchitecture = structure(logical(0), tags = list(type = "string", 
            enum = c("armv7l", "x86_64", "aarch64"))), UpdateTargetsOperatingSystem = structure(logical(0), 
            tags = list(type = "string", enum = c("ubuntu", "raspbian", 
                "amazon_linux")))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
create_software_update_job_output <- function (...) 
{
    ...
    shape <- structure(list(IotJobArn = structure(logical(0), 
        tags = list(type = "string")), IotJobId = structure(logical(0), 
        tags = list(type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
create_subscription_definition_version_input <- function (...) 
{
    ...
    shape <- structure(list(AmznClientToken = structure(logical(0), 
        ...
        tags = list(location = "uri", locationName = "SubscriptionDefinitionId", 
...
delete_group_input <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(GroupId = structure(logical(0), tags = list(location = "uri", 
        locationName = "GroupId", type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
get_bulk_deployment_status_input <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(BulkDeploymentId = structure(logical(0), 
        tags = list(location = "uri", locationName = "BulkDeploymentId", 
            type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}

get_bulk_deployment_status_output <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(BulkDeploymentMetrics = structure(list(InvalidInputRecords = structure(logical(0), 
        tags = list(type = "integer")), RecordsProcessed = structure(logical(0), 
        tags = list(type = "integer")), RetryAttempts = structure(logical(0), 
        tags = list(type = "integer"))), tags = list(type = "structure")), 
        BulkDeploymentStatus = structure(logical(0), tags = list(type = "string", 
            enum = c("Initializing", "Running", "Completed", 
                "Stopping", "Stopped", "Failed"))), CreatedAt = structure(logical(0), 
            tags = list(type = "string")), ErrorDetails = structure(list(structure(list(DetailedErrorCode = structure(logical(0), 
            tags = list(type = "string")), DetailedErrorMessage = structure(logical(0), 
            tags = list(type = "string"))), tags = list(type = "structure"))), 
...
get_connectivity_info_output <- function (...) 
{
    ...
    shape <- structure(list(ConnectivityInfo = structure(list(structure(list(HostAddress = structure(logical(0), 
        ...
        tags = list(type = "string")), PortNumber = structure(logical(0), 
        tags = list(type = "integer"))), tags = list(type = "structure"))), 
...
get_core_definition_version_input <- function (...) 
{
    ...
    shape <- structure(list(CoreDefinitionId = structure(logical(0), 
        ...
        tags = list(location = "uri", locationName = "CoreDefinitionVersionId", 
            type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
get_core_definition_version_output <- function (...) 
{
    ...
    shape <- structure(list(Arn = structure(logical(0), tags = list(type = "string")), 
        CreationTimestamp = structure(logical(0), tags = list(type = "string")), 
        Definition = structure(list(Cores = structure(list(structure(list(CertificateArn = structure(logical(0), 
            tags = list(type = "string")), Id = structure(logical(0), 
            tags = list(type = "string")), SyncShadow = structure(logical(0), 
            tags = list(type = "boolean")), ThingArn = structure(logical(0), 
            tags = list(type = "string"))), tags = list(type = "structure"))), 
...
get_deployment_status_output <- function (...) 
{
    ...
    shape <- structure(list(DeploymentStatus = structure(logical(0), 
        ...
        tags = list(type = "string", enum = c("NewDeployment", 
            "Redeployment", "ResetDeployment", "ForceResetDeployment"))), 
        ErrorDetails = structure(list(structure(list(DetailedErrorCode = structure(logical(0), 
            tags = list(type = "string")), DetailedErrorMessage = structure(logical(0), 
            tags = list(type = "string"))), tags = list(type = "structure"))), 
            tags = list(type = "list")), ErrorMessage = structure(logical(0), 
            tags = list(type = "string")), UpdatedAt = structure(logical(0), 
            tags = list(type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
get_device_definition_version_input <- function (...) 
{
    ...
    shape <- structure(list(DeviceDefinitionId = structure(logical(0), 
        ...
        tags = list(location = "uri", locationName = "DeviceDefinitionVersionId", 
...
get_device_definition_version_output <- function (...) 
{
    ...
    shape <- structure(list(Arn = structure(logical(0), tags = list(type = "string")), 
        CreationTimestamp = structure(logical(0), tags = list(type = "string")), 
        Definition = structure(list(Devices = structure(list(structure(list(CertificateArn = structure(logical(0), 
            tags = list(type = "string")), Id = structure(logical(0), 
            tags = list(type = "string")), SyncShadow = structure(logical(0), 
            tags = list(type = "boolean")), ThingArn = structure(logical(0), 
            tags = list(type = "string"))), tags = list(type = "structure"))), 
...
get_function_definition_version_input <- function (...) 
{
    ...
    shape <- structure(list(FunctionDefinitionId = structure(logical(0), 
        ...
        tags = list(location = "uri", locationName = "FunctionDefinitionVersionId", 
            type = "string")), NextToken = structure(logical(0), 
        tags = list(location = "querystring", locationName = "NextToken", 
            type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
...
get_group_certificate_authority_input <- function (...) 
{
    ...
    shape <- structure(list(CertificateAuthorityId = structure(logical(0), 
        tags = list(location = "uri", locationName = "CertificateAuthorityId", 
            type = "string")), GroupId = structure(logical(0), 
        tags = list(location = "uri", locationName = "GroupId", 
            type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
...
get_group_certificate_authority_output <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(GroupCertificateAuthorityArn = structure(logical(0), 
        tags = list(type = "string")), GroupCertificateAuthorityId = structure(logical(0), 
...
get_group_certificate_configuration_output <- function (...) 
{
    ...
    shape <- structure(list(CertificateAuthorityExpiryInMilliseconds = structure(logical(0), 
        tags = list(type = "string")), CertificateExpiryInMilliseconds = structure(logical(0), 
        tags = list(type = "string")), GroupId = structure(logical(0), 
        tags = list(type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
get_group_version_input <- function (...) 
{
    ...
    shape <- structure(list(GroupId = structure(logical(0), tags = list(location = "uri", 
        locationName = "GroupId", type = "string")), GroupVersionId = structure(logical(0), 
        tags = list(location = "uri", locationName = "GroupVersionId", 
            type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
get_logger_definition_version_input <- function (...) 
{
    ...
    shape <- structure(list(LoggerDefinitionId = structure(logical(0), 
        ...
        tags = list(location = "uri", locationName = "LoggerDefinitionVersionId", 
            type = "string")), NextToken = structure(logical(0), 
        tags = list(location = "querystring", locationName = "NextToken", 
            type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
...
get_logger_definition_version_output <- function (...) 
{
    ...
    shape <- structure(list(Arn = structure(logical(0), tags = list(type = "string")), 
        CreationTimestamp = structure(logical(0), tags = list(type = "string")), 
        Definition = structure(list(Loggers = structure(list(structure(list(Component = structure(logical(0), 
            tags = list(type = "string", enum = c("GreengrassSystem", 
                "Lambda"))), Id = structure(logical(0), tags = list(type = "string")), 
            Level = structure(logical(0), tags = list(type = "string", 
                enum = c("DEBUG", "INFO", "WARN", "ERROR", "FATAL"))), 
...
get_resource_definition_version_input <- function (...) 
{
    ...
    shape <- structure(list(ResourceDefinitionId = structure(logical(0), 
        ...
        tags = list(location = "uri", locationName = "ResourceDefinitionVersionId", 
            type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
get_resource_definition_version_output <- function (...) 
{
    ...
    shape <- structure(list(Arn = structure(logical(0), tags = list(type = "string")), 
        CreationTimestamp = structure(logical(0), tags = list(type = "string")), 
        Definition = structure(list(Resources = structure(list(structure(list(Id = structure(logical(0), 
            tags = list(type = "string")), Name = structure(logical(0), 
            tags = list(type = "string")), ResourceDataContainer = structure(list(LocalDeviceResourceData = structure(list(GroupOwnerSetting = structure(list(AutoAddGroupOwner = structure(logical(0), 
            tags = list(type = "boolean")), GroupOwner = structure(logical(0), 
            tags = list(type = "string"))), tags = list(type = "structure")), 
...
get_subscription_definition_version_input <- function (...) 
{
    ...
    shape <- structure(list(NextToken = structure(logical(0), 
        ...
        tags = list(location = "uri", locationName = "SubscriptionDefinitionVersionId", 
            type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
get_subscription_definition_version_output <- function (...) 
{
    ...
    shape <- structure(list(Arn = structure(logical(0), tags = list(type = "string")), 
        CreationTimestamp = structure(logical(0), tags = list(type = "string")), 
        Definition = structure(list(Subscriptions = structure(list(structure(list(Id = structure(logical(0), 
            tags = list(type = "string")), Source = structure(logical(0), 
            tags = list(type = "string")), Subject = structure(logical(0), 
            tags = list(type = "string")), Target = structure(logical(0), 
            tags = list(type = "string"))), tags = list(type = "structure"))), 
...
list_bulk_deployment_detailed_reports_input <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(BulkDeploymentId = structure(logical(0), 
        tags = list(location = "uri", locationName = "BulkDeploymentId", 
...
list_bulk_deployment_detailed_reports_output <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(Deployments = structure(list(structure(list(CreatedAt = structure(logical(0), 
        tags = list(type = "string")), DeploymentArn = structure(logical(0), 
        tags = list(type = "string")), DeploymentId = structure(logical(0), 
        tags = list(type = "string")), DeploymentStatus = structure(logical(0), 
        tags = list(type = "string")), DeploymentType = structure(logical(0), 
        tags = list(type = "string", enum = c("NewDeployment", 
            "Redeployment", "ResetDeployment", "ForceResetDeployment"))), 
        ErrorDetails = structure(list(structure(list(DetailedErrorCode = structure(logical(0), 
...
list_bulk_deployments_input <- function (...) 
{
    args <- c(as.list(environment()), list(...))
...
list_bulk_deployments_output <- function (...) 
{
    args <- c(as.list(environment()), list(...))
...
list_deployments_input <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(GroupId = structure(logical(0), tags = list(location = "uri", 
        locationName = "GroupId", type = "string")), MaxResults = structure(logical(0), 
        tags = list(location = "querystring", locationName = "MaxResults", 
            type = "string")), NextToken = structure(logical(0), 
        tags = list(location = "querystring", locationName = "NextToken", 
            type = "string"))), tags = list(type = "structure"))
...
reset_deployments_input <- function (...) 
{
    ...
    shape <- structure(list(AmznClientToken = structure(logical(0), 
        tags = list(location = "header", locationName = "X-Amzn-Client-Token", 
            type = "string")), Force = structure(logical(0), 
        tags = list(type = "boolean")), GroupId = structure(logical(0), 
        tags = list(location = "uri", locationName = "GroupId", 
            type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
start_bulk_deployment_input <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(AmznClientToken = structure(logical(0), 
        tags = list(location = "header", locationName = "X-Amzn-Client-Token", 
            type = "string")), ExecutionRoleArn = structure(logical(0), 
        tags = list(type = "string")), InputFileUri = structure(logical(0), 
        tags = list(type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}

start_bulk_deployment_output <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(BulkDeploymentArn = structure(logical(0), 
        tags = list(type = "string")), BulkDeploymentId = structure(logical(0), 
        tags = list(type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}

stop_bulk_deployment_input <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(BulkDeploymentId = structure(logical(0), 
        tags = list(location = "uri", locationName = "BulkDeploymentId", 
...
stop_bulk_deployment_output <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(), tags = list(type = "structure"))
    return(populate(args, shape))
...
update_connectivity_info_input <- function (...) 
{
    ...
    shape <- structure(list(ConnectivityInfo = structure(list(structure(list(HostAddress = structure(logical(0), 
        ...
        tags = list(type = "string")), PortNumber = structure(logical(0), 
        tags = list(type = "integer"))), tags = list(type = "structure"))), 
        tags = list(type = "list")), ThingName = structure(logical(0), 
        tags = list(location = "uri", locationName = "ThingName", 
            type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
update_group_input <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(GroupId = structure(logical(0), tags = list(location = "uri", 
        locationName = "GroupId", type = "string")), Name = structure(logical(0), 
        tags = list(type = "string"))), tags = list(type = "structure"))
    return(populate(args, shape))
}
...
update_resource_definition_input <- function (...) 
{
    ...
    shape <- structure(list(Name = structure(logical(0), tags = list(type = "string")), 
        ResourceDefinitionId = structure(logical(0), tags = list(location = "uri", 
            locationName = "ResourceDefinitionId", type = "string"))), 
        tags = list(type = "structure"))
    return(populate(args, shape))
}
...
update_subscription_definition_input <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(Name = structure(logical(0), tags = list(type = "string")), 
        SubscriptionDefinitionId = structure(logical(0), tags = list(location = "uri", 
            locationName = "SubscriptionDefinitionId", type = "string"))), 
        tags = list(type = "structure"))
    return(populate(args, shape))
}
