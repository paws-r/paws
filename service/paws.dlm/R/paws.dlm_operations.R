...
create_lifecycle_policy <- function (ExecutionRoleArn, Description, 
    State, PolicyDetails) 
{
    op <- new_operation(name = "CreateLifecyclePolicy", http_method = "POST", 
...
{
    op <- new_operation(name = "DeleteLifecyclePolicy", http_method = "DELETE", 
...
{
    op <- new_operation(name = "GetLifecyclePolicies", http_method = "GET", 
        http_path = "/policies", paginator = list())
...
{
    op <- new_operation(name = "GetLifecyclePolicy", http_method = "GET", 
        http_path = "/policies/{policyId}/", paginator = list())
...
{
    op <- new_operation(name = "UpdateLifecyclePolicy", http_method = "PATCH", 
        http_path = "/policies/{policyId}", paginator = list())
