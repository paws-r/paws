...
{
    op <- new_operation(name = "DeleteAlarms", http_method = "POST", 
...
{
    op <- new_operation(name = "DeleteDashboards", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeAlarmHistory", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_alarms <- function (AlarmNames = NULL, AlarmNamePrefix = NULL, 
    ...
    NextToken = NULL) 
{
    op <- new_operation(name = "DescribeAlarms", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeAlarmsForMetric", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DisableAlarmActions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "EnableAlarmActions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetDashboard", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetMetricData", http_method = "POST", 
        http_path = "/", paginator = list())
...
get_metric_statistics <- function (Namespace, MetricName, Dimensions = NULL, 
    ...
    Unit = NULL) 
{
    op <- new_operation(name = "GetMetricStatistics", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetMetricWidgetImage", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListDashboards", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListMetrics", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PutDashboard", http_method = "POST", 
        http_path = "/", paginator = list())
...
put_metric_alarm <- function (AlarmName, AlarmDescription = NULL, 
    ...
    Metrics = NULL) 
{
    op <- new_operation(name = "PutMetricAlarm", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PutMetricData", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "SetAlarmState", http_method = "POST", 
        http_path = "/", paginator = list())
