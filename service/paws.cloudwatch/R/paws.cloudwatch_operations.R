...
#'
#' @param MetricDataQueries The metric queries to be returned. A single `GetMetricData` call can include as many as 100 `MetricDataQuery` structures. Each of these structures can specify either a metric to retrieve, or a math expression to perform on retrieved data.
...
#'
#' @export
get_metric_statistics <- function (Namespace, MetricName, StartTime, 
    EndTime, Period, Dimensions = NULL, Statistics = NULL, ExtendedStatistics = NULL, 
    Unit = NULL) 
{
    ...
    input <- get_metric_statistics_input(Namespace = Namespace, 
        ...
        Period = Period, Dimensions = Dimensions, Statistics = Statistics, 
...
#'
#' @param AlarmName The name for the alarm. This name must be unique within the AWS account.
#' @param MetricName The name for the metric associated with the alarm.
#' @param Namespace The namespace for the metric associated with the alarm.
...
#'
#' @export
put_metric_alarm <- function (AlarmName, MetricName, Namespace, 
    Period, EvaluationPeriods, Threshold, ComparisonOperator, 
    AlarmDescription = NULL, ActionsEnabled = NULL, OKActions = NULL, 
    AlarmActions = NULL, InsufficientDataActions = NULL, Statistic = NULL, 
    ExtendedStatistic = NULL, Dimensions = NULL, Unit = NULL, 
    DatapointsToAlarm = NULL, TreatMissingData = NULL, EvaluateLowSampleCountPercentile = NULL) 
{
    op <- Operation(name = "PutMetricAlarm", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- put_metric_alarm_input(AlarmName = AlarmName, MetricName = MetricName, 
        Namespace = Namespace, Period = Period, EvaluationPeriods = EvaluationPeriods, 
        Threshold = Threshold, ComparisonOperator = ComparisonOperator, 
        AlarmDescription = AlarmDescription, ActionsEnabled = ActionsEnabled, 
        OKActions = OKActions, AlarmActions = AlarmActions, InsufficientDataActions = InsufficientDataActions, 
        Statistic = Statistic, ExtendedStatistic = ExtendedStatistic, 
        Dimensions = Dimensions, Unit = Unit, DatapointsToAlarm = DatapointsToAlarm, 
        TreatMissingData = TreatMissingData, EvaluateLowSampleCountPercentile = EvaluateLowSampleCountPercentile)
