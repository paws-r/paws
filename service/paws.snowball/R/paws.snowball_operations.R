...
#' ```
#'
#' @param ClusterId &#91;required&#93; The 39-character ID for the cluster that you want to cancel, for example `CID123e4567-e89b-12d3-a456-426655440000`.
#'
#' @examples
#' # This operation cancels a cluster job. You can only cancel a cluster job
#' # while it's in the AwaitingQuorum status.
#' \donttest{cancel_cluster(
...
{
    op <- new_operation(name = "CancelCluster", http_method = "POST", 
...
#' ```
#'
#' @param JobId &#91;required&#93; The 39-character job ID for the job that you want to cancel, for example `JID123e4567-e89b-12d3-a456-426655440000`.
#'
#' @examples
...
{
    op <- new_operation(name = "CreateAddress", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param JobType &#91;required&#93; The type of job for this cluster. Currently, the only job type supported for clusters is `LOCAL_USE`.
#' @param Resources &#91;required&#93; The resources associated with the cluster job. These resources include Amazon S3 buckets and optional AWS Lambda functions written in the Python language.
...
#'
#' @export
create_cluster <- function (JobType, Resources, Description = NULL, 
    AddressId, KmsKeyARN = NULL, RoleARN, SnowballType = NULL, 
    ShippingOption, Notification = NULL, ForwardingAddressId = NULL) 
{
    ...
    input <- create_cluster_input(JobType = JobType, Resources = Resources, 
        ...
        RoleARN = RoleARN, SnowballType = SnowballType, ShippingOption = ShippingOption, 
...
{
    op <- new_operation(name = "DescribeAddress", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeCluster", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param JobId &#91;required&#93; The automatically generated ID for a job, for example `JID123e4567-e89b-12d3-a456-426655440000`.
#'
#' @examples
...
{
    op <- new_operation(name = "DescribeJob", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param JobId &#91;required&#93; The ID for a job that you want to get the manifest file for, for example `JID123e4567-e89b-12d3-a456-426655440000`.
#'
#' @examples
...
{
    op <- new_operation(name = "GetJobManifest", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param JobId &#91;required&#93; The ID for the job that you want to get the `UnlockCode` value for, for example `JID123e4567-e89b-12d3-a456-426655440000`.
#'
#' @examples
...
{
    op <- new_operation(name = "GetJobUnlockCode", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{get_snowball_usage()}
#'
#' @export
get_snowball_usage <- function () 
{
    op <- new_operation(name = "GetSnowballUsage", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param ClusterId &#91;required&#93; The 39-character ID for the cluster that you want to list, for example `CID123e4567-e89b-12d3-a456-426655440000`.
...
list_cluster_jobs <- function (ClusterId, MaxResults = NULL, 
    NextToken = NULL) 
{
    op <- new_operation(name = "ListClusterJobs", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListCompatibleImages", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param ClusterId &#91;required&#93; The cluster ID of the cluster that you want to update, for example `CID123e4567-e89b-12d3-a456-426655440000`.
...
{
    op <- new_operation(name = "UpdateCluster", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param JobId &#91;required&#93; The job ID of the job that you want to update, for example `JID123e4567-e89b-12d3-a456-426655440000`.
