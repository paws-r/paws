...
#' @param ReplicationFactor &#91;required&#93; The number of nodes in the DAX cluster. A replication factor of 1 will create a single-node cluster, without any read replicas. For additional fault tolerance, you can create a multiple node cluster with one or more read replicas. To do this, set *ReplicationFactor* to 2 or more.
#' 
...
#'
#' @export
create_cluster <- function (ClusterName, NodeType, Description = NULL, 
    ReplicationFactor, AvailabilityZones = NULL, SubnetGroupName = NULL, 
    SecurityGroupIds = NULL, PreferredMaintenanceWindow = NULL, 
    NotificationTopicArn = NULL, IamRoleArn, ParameterGroupName = NULL, 
    Tags = NULL, SSESpecification = NULL) 
{
    op <- new_operation(name = "CreateCluster", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_cluster_input(ClusterName = ClusterName, 
        NodeType = NodeType, Description = Description, ReplicationFactor = ReplicationFactor, 
        AvailabilityZones = AvailabilityZones, SubnetGroupName = SubnetGroupName, 
        SecurityGroupIds = SecurityGroupIds, PreferredMaintenanceWindow = PreferredMaintenanceWindow, 
        NotificationTopicArn = NotificationTopicArn, IamRoleArn = IamRoleArn, 
        ParameterGroupName = ParameterGroupName, Tags = Tags, 
...
{
    op <- new_operation(name = "CreateParameterGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
create_subnet_group <- function (SubnetGroupName, Description = NULL, 
    SubnetIds) 
{
    op <- new_operation(name = "CreateSubnetGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DecreaseReplicationFactor", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteParameterGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteSubnetGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeDefaultParameters", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeParameterGroups", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_subnet_groups <- function (SubnetGroupNames = NULL, 
    MaxResults = NULL, NextToken = NULL) 
{
    op <- new_operation(name = "DescribeSubnetGroups", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "IncreaseReplicationFactor", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RebootNode", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateParameterGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
update_subnet_group <- function (SubnetGroupName, Description = NULL, 
    SubnetIds = NULL) 
{
    op <- new_operation(name = "UpdateSubnetGroup", http_method = "POST", 
        http_path = "/", paginator = list())
