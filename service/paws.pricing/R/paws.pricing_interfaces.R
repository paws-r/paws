...
describe_services_input <- function (...) 
{
    ...
    shape <- structure(list(ServiceCode = structure(logical(0), 
        tags = list(type = "string")), FormatVersion = structure(logical(0), 
...
describe_services_output <- function (...) 
{
    ...
    shape <- structure(list(Services = structure(list(structure(list(ServiceCode = structure(logical(0), 
        ...
        FormatVersion = structure(logical(0), tags = list(type = "string")), 
...
get_products_input <- function (...) 
{
    args <- c(as.list(environment()), list(...))
    shape <- structure(list(ServiceCode = structure(logical(0), 
        tags = list(type = "string")), Filters = structure(list(structure(list(Type = structure(logical(0), 
        tags = list(type = "string", enum = "TERM_MATCH")), Field = structure(logical(0), 
        tags = list(type = "string")), Value = structure(logical(0), 
        tags = list(type = "string"))), tags = list(type = "structure"))), 
        tags = list(type = "list")), FormatVersion = structure(logical(0), 
        tags = list(type = "string")), NextToken = structure(logical(0), 
        tags = list(type = "string")), MaxResults = structure(logical(0), 
        tags = list(box = TRUE, type = "integer", max = 100L, 
            min = 1L))), tags = list(type = "structure"))
...
get_products_output <- function (...) 
{
    ...
    shape <- structure(list(FormatVersion = structure(logical(0), 
        tags = list(type = "string")), PriceList = structure(list(structure(logical(0), 
        tags = list(jsonvalue = TRUE, type = "string"))), tags = list(type = "list")), 
        NextToken = structure(logical(0), tags = list(type = "string"))), 
        tags = list(type = "structure"))
    return(populate(args, shape))
}
