...
#' @param ResourceArn &#91;required&#93; The ARN (Amazon Resource Name) of the resource to be protected, either an application load balancer or Amazon API Gateway stage.
#' 
...
#' 
#' -   For an Amazon API Gateway stage: `arn:aws:apigateway:region::/restapis/api-id/stages/stage-name region::/restapis/api-id/stages/stage-name `
#'
#' @export
associate_web_acl <- function (WebACLId, ResourceArn) 
{
    op <- new_operation(name = "AssociateWebACL", http_method = "POST", 
...
{
    op <- new_operation(name = "CreateByteMatchSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateGeoMatchSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param MetricName &#91;required&#93; A friendly name or description for the metrics for this `RateBasedRule`. The name can contain only alphanumeric characters (A-Z, a-z, 0-9); the name can\'t contain whitespace. You can\'t change the name of the metric after you create the `RateBasedRule`.
...
#' @param ChangeToken &#91;required&#93; The `ChangeToken` that you used to submit the `CreateRateBasedRule` request. You can also use this value to query the status of the request. For more information, see GetChangeTokenStatus.
#'
#' @export
create_rate_based_rule <- function (Name, MetricName, RateKey, 
    RateLimit, ChangeToken) 
{
    op <- new_operation(name = "CreateRateBasedRule", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateRegexMatchSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateRegexPatternSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param MetricName &#91;required&#93; A friendly name or description for the metrics for this `RuleGroup`. The name can contain only alphanumeric characters (A-Z, a-z, 0-9); the name can\'t contain whitespace. You can\'t change the name of the metric after you create the `RuleGroup`.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
#'
#' @export
create_rule_group <- function (Name, MetricName, ChangeToken) 
{
    op <- new_operation(name = "CreateRuleGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{create_size_constraint_set(
#'   ChangeToken = "abcd12f2-46da-4fdb-b8d5-fbd4c466928f",
...
{
    op <- new_operation(name = "CreateSizeConstraintSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{create_sql_injection_match_set(
#'   ChangeToken = "abcd12f2-46da-4fdb-b8d5-fbd4c466928f",
...
{
    op <- new_operation(name = "CreateSqlInjectionMatchSet", 
...
create_web_acl <- function (Name, MetricName, DefaultAction, 
    ChangeToken) 
{
    op <- new_operation(name = "CreateWebACL", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateXssMatchSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param ByteMatchSetId &#91;required&#93; The `ByteMatchSetId` of the ByteMatchSet that you want to delete. `ByteMatchSetId` is returned by CreateByteMatchSet and by ListByteMatchSets.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
#'
#' @examples
#' # The following example deletes a byte match set with the ID
#' # exampleIDs3t-46da-4fdb-b8d5-abc321j569j5.
#' \donttest{delete_byte_match_set(
...
{
    op <- new_operation(name = "DeleteByteMatchSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param GeoMatchSetId &#91;required&#93; The `GeoMatchSetID` of the GeoMatchSet that you want to delete. `GeoMatchSetId` is returned by CreateGeoMatchSet and by ListGeoMatchSets.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
#'
#' @export
delete_geo_match_set <- function (GeoMatchSetId, ChangeToken) 
{
    op <- new_operation(name = "DeleteGeoMatchSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param IPSetId &#91;required&#93; The `IPSetId` of the IPSet that you want to delete. `IPSetId` is returned by CreateIPSet and by ListIPSets.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
#'
#' @examples
#' # The following example deletes an IP match set  with the ID
#' # example1ds3t-46da-4fdb-b8d5-abc321j569j5.
#' \donttest{delete_ip_set(
#'   ChangeToken = "abcd12f2-46da-4fdb-b8d5-fbd4c466928f",
...
{
    op <- new_operation(name = "DeleteIPSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteLoggingConfiguration", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeletePermissionPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param RuleId &#91;required&#93; The `RuleId` of the RateBasedRule that you want to delete. `RuleId` is returned by CreateRateBasedRule and by ListRateBasedRules.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
#'
#' @export
delete_rate_based_rule <- function (RuleId, ChangeToken) 
{
    op <- new_operation(name = "DeleteRateBasedRule", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param RegexMatchSetId &#91;required&#93; The `RegexMatchSetId` of the RegexMatchSet that you want to delete. `RegexMatchSetId` is returned by CreateRegexMatchSet and by ListRegexMatchSets.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
#'
#' @export
delete_regex_match_set <- function (RegexMatchSetId, ChangeToken) 
{
    op <- new_operation(name = "DeleteRegexMatchSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param RegexPatternSetId &#91;required&#93; The `RegexPatternSetId` of the RegexPatternSet that you want to delete. `RegexPatternSetId` is returned by CreateRegexPatternSet and by ListRegexPatternSets.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
#'
#' @export
delete_regex_pattern_set <- function (RegexPatternSetId, ChangeToken) 
{
    op <- new_operation(name = "DeleteRegexPatternSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param RuleId &#91;required&#93; The `RuleId` of the Rule that you want to delete. `RuleId` is returned by CreateRule and by ListRules.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
#'
#' @examples
...
#' ```
#'
#' @param RuleGroupId &#91;required&#93; The `RuleGroupId` of the RuleGroup that you want to delete. `RuleGroupId` is returned by CreateRuleGroup and by ListRuleGroups.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
#'
#' @export
delete_rule_group <- function (RuleGroupId, ChangeToken) 
{
    op <- new_operation(name = "DeleteRuleGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param SizeConstraintSetId &#91;required&#93; The `SizeConstraintSetId` of the SizeConstraintSet that you want to delete. `SizeConstraintSetId` is returned by CreateSizeConstraintSet and by ListSizeConstraintSets.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
#'
#' @examples
#' # The following example deletes a size constraint set  with the ID
#' # example1ds3t-46da-4fdb-b8d5-abc321j569j5.
#' \donttest{delete_size_constraint_set(
#'   ChangeToken = "abcd12f2-46da-4fdb-b8d5-fbd4c466928f",
...
delete_size_constraint_set <- function (SizeConstraintSetId, 
    ChangeToken) 
{
    op <- new_operation(name = "DeleteSizeConstraintSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param SqlInjectionMatchSetId &#91;required&#93; The `SqlInjectionMatchSetId` of the SqlInjectionMatchSet that you want to delete. `SqlInjectionMatchSetId` is returned by CreateSqlInjectionMatchSet and by ListSqlInjectionMatchSets.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
#'
#' @examples
#' # The following example deletes a SQL injection match set  with the ID
#' # example1ds3t-46da-4fdb-b8d5-abc321j569j5.
#' \donttest{delete_sql_injection_match_set(
#'   ChangeToken = "abcd12f2-46da-4fdb-b8d5-fbd4c466928f",
...
delete_sql_injection_match_set <- function (SqlInjectionMatchSetId, 
    ChangeToken) 
{
    op <- new_operation(name = "DeleteSqlInjectionMatchSet", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' ```
#'
#' @param WebACLId &#91;required&#93; The `WebACLId` of the WebACL that you want to delete. `WebACLId` is returned by CreateWebACL and by ListWebACLs.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
#'
#' @examples
#' # The following example deletes a web ACL with the ID
#' # example-46da-4444-5555-example.
#' \donttest{delete_web_acl(
#'   ChangeToken = "abcd12f2-46da-4fdb-b8d5-fbd4c466928f",
...
{
    op <- new_operation(name = "DeleteWebACL", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param XssMatchSetId &#91;required&#93; The `XssMatchSetId` of the XssMatchSet that you want to delete. `XssMatchSetId` is returned by CreateXssMatchSet and by ListXssMatchSets.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
#'
#' @examples
#' # The following example deletes an XSS match set with the ID
#' # example1ds3t-46da-4fdb-b8d5-abc321j569j5.
#' \donttest{delete_xss_match_set(
#'   ChangeToken = "abcd12f2-46da-4fdb-b8d5-fbd4c466928f",
...
{
    op <- new_operation(name = "DeleteXssMatchSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param ResourceArn &#91;required&#93; The ARN (Amazon Resource Name) of the resource from which the web ACL is being removed, either an application load balancer or Amazon API Gateway stage.
#' 
#' The ARN should be in one of the following formats:
#' 
#' -   For an Application Load Balancer: `arn:aws:elasticloadbalancing:region:account-id:loadbalancer/app/load-balancer-name/load-balancer-id region:account-id:loadbalancer/app/load-balancer-name/load-balancer-id `
...
{
    op <- new_operation(name = "DisassociateWebACL", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param ByteMatchSetId &#91;required&#93; The `ByteMatchSetId` of the ByteMatchSet that you want to get. `ByteMatchSetId` is returned by CreateByteMatchSet and by ListByteMatchSets.
#'
#' @examples
...
{
    op <- new_operation(name = "GetByteMatchSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # or delete operation.
#' \donttest{get_change_token()}
#'
#' @export
get_change_token <- function () 
{
    op <- new_operation(name = "GetChangeToken", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param ChangeToken &#91;required&#93; The change token for which you want to get the status. This change token was previously returned in the `GetChangeToken` response.
#'
#' @examples
#' # The following example returns the status of a change token with the ID
#' # abcd12f2-46da-4fdb-b8d5-fbd4c466928f.
#' \donttest{get_change_token_status(
#'   ChangeToken = "abcd12f2-46da-4fdb-b8d5-fbd4c466928f"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "GetChangeTokenStatus", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param GeoMatchSetId &#91;required&#93; The `GeoMatchSetId` of the GeoMatchSet that you want to get. `GeoMatchSetId` is returned by CreateGeoMatchSet and by ListGeoMatchSets.
#'
#' @export
get_geo_match_set <- function (GeoMatchSetId) 
{
    op <- new_operation(name = "GetGeoMatchSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param IPSetId &#91;required&#93; The `IPSetId` of the IPSet that you want to get. `IPSetId` is returned by CreateIPSet and by ListIPSets.
#'
#' @examples
...
{
    op <- new_operation(name = "GetIPSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetLoggingConfiguration", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetPermissionPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param RuleId &#91;required&#93; The `RuleId` of the RateBasedRule that you want to get. `RuleId` is returned by CreateRateBasedRule and by ListRateBasedRules.
#'
#' @export
get_rate_based_rule <- function (RuleId) 
{
    op <- new_operation(name = "GetRateBasedRule", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param RuleId &#91;required&#93; The `RuleId` of the RateBasedRule for which you want to get a list of `ManagedKeys`. `RuleId` is returned by CreateRateBasedRule and by ListRateBasedRules.
...
{
    op <- new_operation(name = "GetRateBasedRuleManagedKeys", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' ```
#'
#' @param RegexMatchSetId &#91;required&#93; The `RegexMatchSetId` of the RegexMatchSet that you want to get. `RegexMatchSetId` is returned by CreateRegexMatchSet and by ListRegexMatchSets.
#'
#' @export
get_regex_match_set <- function (RegexMatchSetId) 
{
    op <- new_operation(name = "GetRegexMatchSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param RegexPatternSetId &#91;required&#93; The `RegexPatternSetId` of the RegexPatternSet that you want to get. `RegexPatternSetId` is returned by CreateRegexPatternSet and by ListRegexPatternSets.
#'
#' @export
get_regex_pattern_set <- function (RegexPatternSetId) 
{
    op <- new_operation(name = "GetRegexPatternSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param RuleId &#91;required&#93; The `RuleId` of the Rule that you want to get. `RuleId` is returned by CreateRule and by ListRules.
#'
#' @examples
...
{
    op <- new_operation(name = "GetRule", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param RuleGroupId &#91;required&#93; The `RuleGroupId` of the RuleGroup that you want to get. `RuleGroupId` is returned by CreateRuleGroup and by ListRuleGroups.
#'
#' @export
get_rule_group <- function (RuleGroupId) 
{
    op <- new_operation(name = "GetRuleGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param WebAclId &#91;required&#93; The `WebACLId` of the `WebACL` for which you want `GetSampledRequests` to return a sample of requests.
...
#' @param TimeWindow &#91;required&#93; The start date and time and the end date and time of the range for which you want `GetSampledRequests` to return a sample of requests. Specify the date and time in the following format: `"2016-09-27T14:50Z"`. You can specify any time range in the previous three hours.
#' @param MaxItems &#91;required&#93; The number of requests that you want AWS WAF to return from among the first 5,000 requests that your AWS resource received during the time range. If your resource received fewer requests than the value of `MaxItems`, `GetSampledRequests` returns information about all of them.
#'
#' @examples
...
get_sampled_requests <- function (WebAclId, RuleId, TimeWindow, 
    MaxItems) 
{
    op <- new_operation(name = "GetSampledRequests", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param SizeConstraintSetId &#91;required&#93; The `SizeConstraintSetId` of the SizeConstraintSet that you want to get. `SizeConstraintSetId` is returned by CreateSizeConstraintSet and by ListSizeConstraintSets.
#'
#' @examples
...
#' \donttest{get_size_constraint_set(
#'   SizeConstraintSetId = "example1ds3t-46da-4fdb-b8d5-abc321j569j5"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "GetSizeConstraintSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param SqlInjectionMatchSetId &#91;required&#93; The `SqlInjectionMatchSetId` of the SqlInjectionMatchSet that you want to get. `SqlInjectionMatchSetId` is returned by CreateSqlInjectionMatchSet and by ListSqlInjectionMatchSets.
#'
#' @examples
#' # The following example returns the details of a SQL injection match set
#' # with the ID example1ds3t-46da-4fdb-b8d5-abc321j569j5.
#' \donttest{get_sql_injection_match_set(
#'   SqlInjectionMatchSetId = "example1ds3t-46da-4fdb-b8d5-abc321j569j5"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "GetSqlInjectionMatchSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param WebACLId &#91;required&#93; The `WebACLId` of the WebACL that you want to get. `WebACLId` is returned by CreateWebACL and by ListWebACLs.
#'
#' @examples
#' # The following example returns the details of a web ACL with the ID
#' # createwebacl-1472061481310.
#' \donttest{get_web_acl(
#'   WebACLId = "createwebacl-1472061481310"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "GetWebACL", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param ResourceArn &#91;required&#93; The ARN (Amazon Resource Name) of the resource for which to get the web ACL, either an application load balancer or Amazon API Gateway stage.
#' 
#' The ARN should be in one of the following formats:
#' 
#' -   For an Application Load Balancer: `arn:aws:elasticloadbalancing:region:account-id:loadbalancer/app/load-balancer-name/load-balancer-id region:account-id:loadbalancer/app/load-balancer-name/load-balancer-id `
...
{
    op <- new_operation(name = "GetWebACLForResource", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param XssMatchSetId &#91;required&#93; The `XssMatchSetId` of the XssMatchSet that you want to get. `XssMatchSetId` is returned by CreateXssMatchSet and by ListXssMatchSets.
#'
#' @examples
#' # The following example returns the details of an XSS match set with the
#' # ID example1ds3t-46da-4fdb-b8d5-abc321j569j5.
#' \donttest{get_xss_match_set(
#'   XssMatchSetId = "example1ds3t-46da-4fdb-b8d5-abc321j569j5"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "GetXssMatchSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListActivatedRulesInRuleGroup", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListByteMatchSets", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListGeoMatchSets", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListIPSets", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListLoggingConfigurations", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListRateBasedRules", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListRegexMatchSets", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListRegexPatternSets", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param WebACLId &#91;required&#93; The unique identifier (ID) of the web ACL for which to list the associated resources.
#' @param ResourceType The type of resource to list, either an application load balancer or Amazon API Gateway.
#'
#' @export
list_resources_for_web_acl <- function (WebACLId, ResourceType = NULL) 
{
    op <- new_operation(name = "ListResourcesForWebACL", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListRuleGroups", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListRules", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # sets.
#' \donttest{list_size_constraint_sets(
#'   Limit = 100L
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "ListSizeConstraintSets", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # sets.
#' \donttest{list_sql_injection_match_sets(
#'   Limit = 100L
#' )}
#'
#' @export
list_sql_injection_match_sets <- function (NextMarker = NULL, 
    Limit = NULL) 
{
    op <- new_operation(name = "ListSqlInjectionMatchSets", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListSubscribedRuleGroups", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListWebACLs", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListXssMatchSets", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PutLoggingConfiguration", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PutPermissionPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param ByteMatchSetId &#91;required&#93; The `ByteMatchSetId` of the ByteMatchSet that you want to update. `ByteMatchSetId` is returned by CreateByteMatchSet and by ListByteMatchSets.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
...
update_byte_match_set <- function (ByteMatchSetId, ChangeToken, 
    Updates) 
{
    op <- new_operation(name = "UpdateByteMatchSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param GeoMatchSetId &#91;required&#93; The `GeoMatchSetId` of the GeoMatchSet that you want to update. `GeoMatchSetId` is returned by CreateGeoMatchSet and by ListGeoMatchSets.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
...
update_geo_match_set <- function (GeoMatchSetId, ChangeToken, 
    Updates) 
{
    op <- new_operation(name = "UpdateGeoMatchSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param IPSetId &#91;required&#93; The `IPSetId` of the IPSet that you want to update. `IPSetId` is returned by CreateIPSet and by ListIPSets.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
...
#' ```
#'
#' @param RuleId &#91;required&#93; The `RuleId` of the `RateBasedRule` that you want to update. `RuleId` is returned by `CreateRateBasedRule` and by ListRateBasedRules.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
...
update_rate_based_rule <- function (RuleId, ChangeToken, Updates, 
    RateLimit) 
{
    op <- new_operation(name = "UpdateRateBasedRule", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param RegexMatchSetId &#91;required&#93; The `RegexMatchSetId` of the RegexMatchSet that you want to update. `RegexMatchSetId` is returned by CreateRegexMatchSet and by ListRegexMatchSets.
...
update_regex_match_set <- function (RegexMatchSetId, Updates, 
    ChangeToken) 
{
    op <- new_operation(name = "UpdateRegexMatchSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param RegexPatternSetId &#91;required&#93; The `RegexPatternSetId` of the RegexPatternSet that you want to update. `RegexPatternSetId` is returned by CreateRegexPatternSet and by ListRegexPatternSets.
...
update_regex_pattern_set <- function (RegexPatternSetId, Updates, 
    ChangeToken) 
{
    op <- new_operation(name = "UpdateRegexPatternSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param RuleId &#91;required&#93; The `RuleId` of the `Rule` that you want to update. `RuleId` is returned by `CreateRule` and by ListRules.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
...
{
    op <- new_operation(name = "UpdateRule", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param RuleGroupId &#91;required&#93; The `RuleGroupId` of the RuleGroup that you want to update. `RuleGroupId` is returned by CreateRuleGroup and by ListRuleGroups.
...
{
    op <- new_operation(name = "UpdateRuleGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param SizeConstraintSetId &#91;required&#93; The `SizeConstraintSetId` of the SizeConstraintSet that you want to update. `SizeConstraintSetId` is returned by CreateSizeConstraintSet and by ListSizeConstraintSets.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
...
#' # example1ds3t-46da-4fdb-b8d5-abc321j569j5.
#' \donttest{update_size_constraint_set(
#'   ChangeToken = "abcd12f2-46da-4fdb-b8d5-fbd4c466928f",
#'   SizeConstraintSetId = "example1ds3t-46da-4fdb-b8d5-abc321j569j5",
#'   Updates = list(
#'     list(
...
update_size_constraint_set <- function (SizeConstraintSetId, 
    ChangeToken, Updates) 
{
    op <- new_operation(name = "UpdateSizeConstraintSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param SqlInjectionMatchSetId &#91;required&#93; The `SqlInjectionMatchSetId` of the `SqlInjectionMatchSet` that you want to update. `SqlInjectionMatchSetId` is returned by CreateSqlInjectionMatchSet and by ListSqlInjectionMatchSets.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
...
#' # example1ds3t-46da-4fdb-b8d5-abc321j569j5.
#' \donttest{update_sql_injection_match_set(
#'   ChangeToken = "abcd12f2-46da-4fdb-b8d5-fbd4c466928f",
#'   SqlInjectionMatchSetId = "example1ds3t-46da-4fdb-b8d5-abc321j569j5",
#'   Updates = list(
#'     list(
...
update_sql_injection_match_set <- function (SqlInjectionMatchSetId, 
    ChangeToken, Updates) 
{
    op <- new_operation(name = "UpdateSqlInjectionMatchSet", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' ```
#'
#' @param WebACLId &#91;required&#93; The `WebACLId` of the WebACL that you want to update. `WebACLId` is returned by CreateWebACL and by ListWebACLs.
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to GetChangeToken.
...
update_web_acl <- function (WebACLId, ChangeToken, Updates = NULL, 
    DefaultAction = NULL) 
{
    op <- new_operation(name = "UpdateWebACL", http_method = "POST", 
        http_path = "/", paginator = list())
...
update_xss_match_set <- function (XssMatchSetId, ChangeToken, 
    Updates) 
{
    op <- new_operation(name = "UpdateXssMatchSet", http_method = "POST", 
        http_path = "/", paginator = list())
