...
{
    op <- Operation(name = "AssociateNode", http_method = "POST", 
...
#' @param InstanceType The Amazon EC2 instance type to use. For example, `m4.large`. Recommended instance types include `t2.medium` and greater, `m4.*`, or `c4.xlarge` and greater.
...
#'
#' @export
create_server <- function (ServerName, InstanceProfileArn, InstanceType, 
    ServiceRoleArn, AssociatePublicIpAddress = NULL, DisableAutomatedBackup = NULL, 
    Engine = NULL, EngineModel = NULL, EngineVersion = NULL, 
    EngineAttributes = NULL, BackupRetentionCount = NULL, KeyPair = NULL, 
    PreferredMaintenanceWindow = NULL, PreferredBackupWindow = NULL, 
    SecurityGroupIds = NULL, SubnetIds = NULL, BackupId = NULL) 
{
    op <- Operation(name = "CreateServer", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_server_input(ServerName = ServerName, InstanceProfileArn = InstanceProfileArn, 
        ...
        KeyPair = KeyPair, PreferredMaintenanceWindow = PreferredMaintenanceWindow, 
        PreferredBackupWindow = PreferredBackupWindow, SecurityGroupIds = SecurityGroupIds, 
        SubnetIds = SubnetIds, BackupId = BackupId)
...
describe_node_association_status <- function (NodeAssociationStatusToken, 
    ServerName) 
{
    op <- Operation(name = "DescribeNodeAssociationStatus", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_servers <- function (ServerName = NULL, NextToken = NULL, 
    MaxResults = NULL) 
{
    op <- Operation(name = "DescribeServers", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DisassociateNode", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @param ExportAttributeName The name of the export attribute. Currently supported export attribute is \"Userdata\" which exports a userdata script filled out with parameters provided in the `InputAttributes` list.
#' @param ServerName The name of the Server to which the attribute is being exported from
...
{
    op <- Operation(name = "ExportServerEngineAttribute", http_method = "POST", 
        http_path = "/", paginator = list())
...
restore_server <- function (BackupId, ServerName, InstanceType = NULL, 
    KeyPair = NULL) 
{
    op <- Operation(name = "RestoreServer", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "StartMaintenance", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
update_server <- function (ServerName, DisableAutomatedBackup = NULL, 
    BackupRetentionCount = NULL, PreferredMaintenanceWindow = NULL, 
    PreferredBackupWindow = NULL) 
{
    op <- Operation(name = "UpdateServer", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_server_input(ServerName = ServerName, DisableAutomatedBackup = DisableAutomatedBackup, 
        BackupRetentionCount = BackupRetentionCount, PreferredMaintenanceWindow = PreferredMaintenanceWindow, 
...
update_server_engine_attributes <- function (ServerName, AttributeName, 
    AttributeValue = NULL) 
{
    op <- Operation(name = "UpdateServerEngineAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
