...
{
    op <- Operation(name = "GenerateServiceLastAccessedDetails", 
        http_method = "POST", http_path = "/", paginator = list())
...
get_service_last_accessed_details <- function (JobId, MaxItems = NULL, 
    Marker = NULL) 
{
    op <- Operation(name = "GetServiceLastAccessedDetails", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetServiceLastAccessedDetailsWithEntities", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListPoliciesGrantingServiceAccess", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListRoleTags", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListUserTags", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "TagRole", http_method = "POST", http_path = "/", 
        paginator = list())
...
{
    op <- Operation(name = "TagUser", http_method = "POST", http_path = "/", 
        paginator = list())
...
{
    op <- Operation(name = "UntagRole", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UntagUser", http_method = "POST", 
        http_path = "/", paginator = list())
