...
add_client_id_to_open_id_connect_provider <- function (OpenIDConnectProviderArn, 
    ClientID) 
{
    op <- Operation(name = "AddClientIDToOpenIDConnectProvider", 
...
add_role_to_instance_profile <- function (InstanceProfileName, 
    RoleName) 
{
    op <- Operation(name = "AddRoleToInstanceProfile", http_method = "POST", 
...
{
    op <- Operation(name = "AddUserToGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "AttachGroupPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "AttachRolePolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "AttachUserPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "CreateAccessKey", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "CreateAccountAlias", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
create_group <- function (GroupName, Path = NULL) 
{
    op <- Operation(name = "CreateGroup", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_group_input(GroupName = GroupName, Path = Path)
...
{
    op <- Operation(name = "CreateLoginProfile", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' Creates an IAM entity to describe an identity provider (IdP) that supports [OpenID Connect (OIDC)](http://openid
#'
...
#'
#' @export
create_open_id_connect_provider <- function (Url, ThumbprintList, 
    ClientIDList = NULL) 
{
    op <- Operation(name = "CreateOpenIDConnectProvider", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_open_id_connect_provider_input(Url = Url, 
        ThumbprintList = ThumbprintList, ClientIDList = ClientIDList)
...
#'
#' @export
create_policy <- function (PolicyName, PolicyDocument, Path = NULL, 
    Description = NULL) 
{
...
#'
#' @export
create_role <- function (RoleName, AssumeRolePolicyDocument, 
    Path = NULL, Description = NULL, MaxSessionDuration = NULL, 
    PermissionsBoundary = NULL) 
{
    op <- Operation(name = "CreateRole", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_role_input(RoleName = RoleName, AssumeRolePolicyDocument = AssumeRolePolicyDocument, 
        Path = Path, Description = Description, MaxSessionDuration = MaxSessionDuration, 
...
{
    op <- Operation(name = "CreateSAMLProvider", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @param AWSServiceName The AWS service to which this role is attached. You use a string similar to a URL but without the http:// in front. For example: `elasticbeanstalk.amazonaws.com`
...
create_service_linked_role <- function (AWSServiceName, Description = NULL, 
    CustomSuffix = NULL) 
{
    op <- Operation(name = "CreateServiceLinkedRole", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "CreateServiceSpecificCredential", 
        http_method = "POST", http_path = "/", paginator = list())
...
#'
#' @export
create_user <- function (UserName, Path = NULL, PermissionsBoundary = NULL) 
{
    op <- Operation(name = "CreateUser", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_user_input(UserName = UserName, Path = Path, 
        PermissionsBoundary = PermissionsBoundary)
...
#'
#' @export
create_virtual_mfa_device <- function (VirtualMFADeviceName, 
    Path = NULL) 
{
    op <- Operation(name = "CreateVirtualMFADevice", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_virtual_mfa_device_input(VirtualMFADeviceName = VirtualMFADeviceName, 
        Path = Path)
...
{
    op <- Operation(name = "DeactivateMFADevice", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
delete_access_key <- function (AccessKeyId, UserName = NULL) 
{
    op <- Operation(name = "DeleteAccessKey", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- delete_access_key_input(AccessKeyId = AccessKeyId, 
        UserName = UserName)
...
{
    op <- Operation(name = "DeleteAccountAlias", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteAccountPasswordPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteGroupPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteLoginProfile", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteOpenIDConnectProvider", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeletePolicyVersion", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteRole", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteRolePermissionsBoundary", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteRolePolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteSAMLProvider", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteServerCertificate", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteServiceLinkedRole", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
delete_service_specific_credential <- function (ServiceSpecificCredentialId, 
    UserName = NULL) 
{
    op <- Operation(name = "DeleteServiceSpecificCredential", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- delete_service_specific_credential_input(ServiceSpecificCredentialId = ServiceSpecificCredentialId, 
        UserName = UserName)
...
#'
#' @export
delete_signing_certificate <- function (CertificateId, UserName = NULL) 
{
    op <- Operation(name = "DeleteSigningCertificate", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- delete_signing_certificate_input(CertificateId = CertificateId, 
        UserName = UserName)
...
{
    op <- Operation(name = "DeleteUserPermissionsBoundary", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteUserPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteVirtualMFADevice", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DetachGroupPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DetachRolePolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DetachUserPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
enable_mfa_device <- function (UserName, SerialNumber, AuthenticationCode1, 
    AuthenticationCode2) 
{
    op <- Operation(name = "EnableMFADevice", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GenerateCredentialReport", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetAccessKeyLastUsed", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetAccountAuthorizationDetails", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetAccountPasswordPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetAccountSummary", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetContextKeysForCustomPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetContextKeysForPrincipalPolicy", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetCredentialReport", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetGroupPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetLoginProfile", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetOpenIDConnectProvider", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetPolicyVersion", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetRole", http_method = "POST", http_path = "/", 
        paginator = list())
...
{
    op <- Operation(name = "GetRolePolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetSAMLProvider", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetSSHPublicKey", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetServerCertificate", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetServiceLinkedRoleDeletionStatus", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- Operation(name = "GetUserPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_access_keys <- function (UserName = NULL, Marker = NULL, 
    MaxItems = NULL) 
{
    op <- Operation(name = "ListAccessKeys", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListAccountAliases", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListAttachedGroupPolicies", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_attached_role_policies <- function (RoleName, PathPrefix = NULL, 
    Marker = NULL, MaxItems = NULL) 
{
    op <- Operation(name = "ListAttachedRolePolicies", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_attached_user_policies <- function (UserName, PathPrefix = NULL, 
    Marker = NULL, MaxItems = NULL) 
{
    op <- Operation(name = "ListAttachedUserPolicies", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' 
#' To list only permissions policies, setÂ `PolicyUsageFilter`Â toÂ `PermissionsPolicy`. To list only the policies used to set permissions boundaries, setÂ the value toÂ `PermissionsBoundary`.
#' 
...
list_entities_for_policy <- function (PolicyArn, EntityFilter = NULL, 
    ...
    MaxItems = NULL) 
{
    op <- Operation(name = "ListEntitiesForPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListGroupPolicies", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListGroupsForUser", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_instance_profiles_for_role <- function (RoleName, Marker = NULL, 
    MaxItems = NULL) 
{
    op <- Operation(name = "ListInstanceProfilesForRole", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_mfa_devices <- function (UserName = NULL, Marker = NULL, 
    MaxItems = NULL) 
{
    op <- Operation(name = "ListMFADevices", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListOpenIDConnectProviders", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListPolicyVersions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListRolePolicies", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListRoles", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListSAMLProviders", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_ssh_public_keys <- function (UserName = NULL, Marker = NULL, 
    MaxItems = NULL) 
{
    op <- Operation(name = "ListSSHPublicKeys", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_server_certificates <- function (PathPrefix = NULL, Marker = NULL, 
    MaxItems = NULL) 
{
    op <- Operation(name = "ListServerCertificates", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_service_specific_credentials <- function (UserName = NULL, 
    ServiceName = NULL) 
{
    op <- Operation(name = "ListServiceSpecificCredentials", 
        http_method = "POST", http_path = "/", paginator = list())
...
list_signing_certificates <- function (UserName = NULL, Marker = NULL, 
    MaxItems = NULL) 
{
    op <- Operation(name = "ListSigningCertificates", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListUserPolicies", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_virtual_mfa_devices <- function (AssignmentStatus = NULL, 
    Marker = NULL, MaxItems = NULL) 
{
    op <- Operation(name = "ListVirtualMFADevices", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "PutGroupPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "PutRolePermissionsBoundary", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "PutRolePolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "PutUserPermissionsBoundary", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "PutUserPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
remove_client_id_from_open_id_connect_provider <- function (OpenIDConnectProviderArn, 
    ClientID) 
{
    op <- Operation(name = "RemoveClientIDFromOpenIDConnectProvider", 
        http_method = "POST", http_path = "/", paginator = list())
...
remove_role_from_instance_profile <- function (InstanceProfileName, 
    RoleName) 
{
    op <- Operation(name = "RemoveRoleFromInstanceProfile", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "RemoveUserFromGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
reset_service_specific_credential <- function (ServiceSpecificCredentialId, 
    UserName = NULL) 
{
    op <- Operation(name = "ResetServiceSpecificCredential", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- reset_service_specific_credential_input(ServiceSpecificCredentialId = ServiceSpecificCredentialId, 
        UserName = UserName)
...
resync_mfa_device <- function (UserName, SerialNumber, AuthenticationCode1, 
    AuthenticationCode2) 
{
    op <- Operation(name = "ResyncMFADevice", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "SetDefaultPolicyVersion", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' 
#' -   The special characters tab (\\u0009), line feed (\\u000A), and carriage return (\\u000D)
#' @param ActionNames A list of names of API operations to evaluate in the simulation. Each operation is evaluated against each resource. Each operation must include the service identifier, such as `iam:CreateUser`.
...
simulate_custom_policy <- function (PolicyInputList, ActionNames, 
    ...
    MaxItems = NULL, Marker = NULL) 
{
    op <- Operation(name = "SimulateCustomPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
simulate_principal_policy <- function (PolicySourceArn, ActionNames, 
    PolicyInputList = NULL, ResourceArns = NULL, ResourcePolicy = NULL, 
    ResourceOwner = NULL, CallerArn = NULL, ContextEntries = NULL, 
    ResourceHandlingOption = NULL, MaxItems = NULL, Marker = NULL) 
{
    op <- Operation(name = "SimulatePrincipalPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
update_access_key <- function (AccessKeyId, Status, UserName = NULL) 
{
    op <- Operation(name = "UpdateAccessKey", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_access_key_input(AccessKeyId = AccessKeyId, 
...
{
    op <- Operation(name = "UpdateAccountPasswordPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateAssumeRolePolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateLoginProfile", http_method = "POST", 
        http_path = "/", paginator = list())
...
update_open_id_connect_provider_thumbprint <- function (OpenIDConnectProviderArn, 
    ThumbprintList) 
{
    op <- Operation(name = "UpdateOpenIDConnectProviderThumbprint", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateRole", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateRoleDescription", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateSAMLProvider", http_method = "POST", 
        http_path = "/", paginator = list())
...
update_ssh_public_key <- function (UserName, SSHPublicKeyId, 
    Status) 
{
    op <- Operation(name = "UpdateSSHPublicKey", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateServerCertificate", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
update_service_specific_credential <- function (ServiceSpecificCredentialId, 
    Status, UserName = NULL) 
{
    op <- Operation(name = "UpdateServiceSpecificCredential", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- update_service_specific_credential_input(ServiceSpecificCredentialId = ServiceSpecificCredentialId, 
        Status = Status, UserName = UserName)
...
#'
#' @export
update_signing_certificate <- function (CertificateId, Status, 
    UserName = NULL) 
{
    op <- Operation(name = "UpdateSigningCertificate", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_signing_certificate_input(CertificateId = CertificateId, 
        Status = Status, UserName = UserName)
...
#' 
#' This parameter allows (per its [regex pattern](http://wikipedia.org/wiki/regex)) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: \_+=,.@-
#' @param SSHPublicKeyBody The SSH public key. The public key must be encoded in ssh-rsa format or PEM format. The miminum bit-length of the public key is 2048 bits. For example, you can generate a 2048-bit key, and the resulting PEM file is 1679 bytes long.
#' 
#' The [regex pattern](http://wikipedia.org/wiki/regex) used to validate this parameter is a string of characters consisting of the following:
#' 
#' -   Any printable ASCII character ranging from the space character (\\u0020) through the end of the ASCII character range
...
{
    op <- Operation(name = "UploadSSHPublicKey", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
upload_server_certificate <- function (ServerCertificateName, 
    CertificateBody, PrivateKey, Path = NULL, CertificateChain = NULL) 
{
    op <- Operation(name = "UploadServerCertificate", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- upload_server_certificate_input(ServerCertificateName = ServerCertificateName, 
        CertificateBody = CertificateBody, PrivateKey = PrivateKey, 
        Path = Path, CertificateChain = CertificateChain)
...
#'
#' @export
upload_signing_certificate <- function (CertificateBody, UserName = NULL) 
{
    op <- Operation(name = "UploadSigningCertificate", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- upload_signing_certificate_input(CertificateBody = CertificateBody, 
        UserName = UserName)
