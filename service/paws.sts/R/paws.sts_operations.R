...
assume_role <- function (RoleArn, RoleSessionName, Policy = NULL, 
    ...
    TokenCode = NULL) 
{
    op <- new_operation(name = "AssumeRole", http_method = "POST", 
...
{
    op <- new_operation(name = "AssumeRoleWithSAML", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @examples
#' # 
#' \donttest{assume_role_with_web_identity(
#'   DurationSeconds = 3600L,
...
{
    op <- new_operation(name = "AssumeRoleWithWebIdentity", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @examples
#' # 
#' \donttest{decode_authorization_message(
...
{
    op <- new_operation(name = "DecodeAuthorizationMessage", 
...
{
    op <- new_operation(name = "GetCallerIdentity", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetFederationToken", http_method = "POST", 
        http_path = "/", paginator = list())
...
get_session_token <- function (DurationSeconds = NULL, SerialNumber = NULL, 
    TokenCode = NULL) 
{
    op <- new_operation(name = "GetSessionToken", http_method = "POST", 
        http_path = "/", paginator = list())
