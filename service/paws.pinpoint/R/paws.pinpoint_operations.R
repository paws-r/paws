...
{
    op <- Operation(name = "DeleteVoiceChannel", http_method = "DELETE", 
...
{
    op <- Operation(name = "GetVoiceChannel", http_method = "GET", 
        http_path = "/v1/apps/{application-id}/channels/voice", 
        paginator = list())
...
{
    op <- Operation(name = "UpdateVoiceChannel", http_method = "PUT", 
        http_path = "/v1/apps/{application-id}/channels/voice", 
        paginator = list())
