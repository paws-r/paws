...
#' @param AWSAccountId &#91;required&#93; The AWS account IDs of the users (principals) who will be given access to the specified actions. The users must have AWS accounts, but do not need to be signed up for this service.
...
{
    op <- new_operation(name = "CheckIfPhoneNumberIsOptedOut", 
...
{
    op <- new_operation(name = "ConfirmSubscription", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param Platform &#91;required&#93; The following platforms are supported: ADM (Amazon Device Messaging), APNS (Apple Push Notification Service), APNS\_SANDBOX, and GCM (Google Cloud Messaging).
#' @param Attributes &#91;required&#93; For a list of attributes, see [SetPlatformApplicationAttributes](http://docs.aws.amazon.com/sns/latest/api/API_SetPlatformApplicationAttributes.html)
#'
#' @export
create_platform_application <- function (Name, Platform, Attributes) 
{
    op <- new_operation(name = "CreatePlatformApplication", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param Token &#91;required&#93; Unique identifier created by the notification service for an app on a device. The specific name for Token will vary, depending on which notification service is being used. For example, when using APNS as the notification service, you need the device token. Alternatively, when using GCM or ADM, the device token equivalent is called the registration ID.
...
{
    op <- new_operation(name = "CreatePlatformEndpoint", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateTopic", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeletePlatformApplication", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteTopic", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetEndpointAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetPlatformApplicationAttributes", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetSMSAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetSubscriptionAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetTopicAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_endpoints_by_platform_application <- function (PlatformApplicationArn, 
    NextToken = NULL) 
{
    op <- new_operation(name = "ListEndpointsByPlatformApplication", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListPhoneNumbersOptedOut", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListPlatformApplications", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListSubscriptions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListSubscriptionsByTopic", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListTopics", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "OptInPhoneNumber", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
publish <- function (TopicArn = NULL, TargetArn = NULL, PhoneNumber = NULL, 
    Message, Subject = NULL, MessageStructure = NULL, MessageAttributes = NULL) 
{
    op <- new_operation(name = "Publish", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- publish_input(TopicArn = TopicArn, TargetArn = TargetArn, 
        PhoneNumber = PhoneNumber, Message = Message, Subject = Subject, 
...
{
    op <- new_operation(name = "SetEndpointAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
...
set_platform_application_attributes <- function (PlatformApplicationArn, 
    Attributes) 
{
    op <- new_operation(name = "SetPlatformApplicationAttributes", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' ```
#'
#' @param attributes &#91;required&#93; The default settings for sending SMS messages from your account. You can set values for the following attribute names:
#' 
...
{
    op <- new_operation(name = "SetSMSAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param AttributeName &#91;required&#93; The name of the attribute you want to set. Only a subset of the subscriptions attributes are mutable.
#' 
...
set_subscription_attributes <- function (SubscriptionArn, AttributeName, 
    AttributeValue = NULL) 
{
    op <- new_operation(name = "SetSubscriptionAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param AttributeName &#91;required&#93; The name of the attribute you want to set. Only a subset of the topic\'s attributes are mutable.
#' 
...
{
    op <- new_operation(name = "SetTopicAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "Subscribe", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "Unsubscribe", http_method = "POST", 
        http_path = "/", paginator = list())
