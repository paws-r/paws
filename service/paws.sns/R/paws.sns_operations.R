...
#' @param AWSAccountId The AWS account IDs of the users (principals) who will be given access to the specified actions. The users must have AWS accounts, but do not need to be signed up for this service.
#' @param ActionName The action you want to allow for the specified principal(s).
#' 
...
#'
#' @export
add_permission <- function (TopicArn, Label, AWSAccountId, ActionName) 
{
    op <- Operation(name = "AddPermission", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- add_permission_input(TopicArn = TopicArn, Label = Label, 
        AWSAccountId = AWSAccountId, ActionName = ActionName)
...
#'
#' @export
check_if_phone_number_is_opted_out <- function (phoneNumber) 
{
    op <- Operation(name = "CheckIfPhoneNumberIsOptedOut", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- check_if_phone_number_is_opted_out_input(phoneNumber = phoneNumber)
    output <- check_if_phone_number_is_opted_out_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
confirm_subscription <- function (TopicArn, Token, AuthenticateOnUnsubscribe = NULL) 
{
    op <- Operation(name = "ConfirmSubscription", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- confirm_subscription_input(TopicArn = TopicArn, 
        Token = Token, AuthenticateOnUnsubscribe = AuthenticateOnUnsubscribe)
    output <- confirm_subscription_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' @param Platform The following platforms are supported: ADM (Amazon Device Messaging), APNS (Apple Push Notification Service), APNS\_SANDBOX, and GCM (Google Cloud Messaging).
#' @param Attributes For a list of attributes, see [SetPlatformApplicationAttributes](http://docs.aws.amazon.com/sns/latest/api/API_SetPlatformApplicationAttributes.html)
#'
#' @examples
#'
#' @export
create_platform_application <- function (Name, Platform, Attributes) 
{
    op <- Operation(name = "CreatePlatformApplication", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_platform_application_input(Name = Name, Platform = Platform, 
        Attributes = Attributes)
    output <- create_platform_application_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' @param Attributes For a list of attributes, see [SetEndpointAttributes](http://docs.aws.amazon.com/sns/latest/api/API_SetEndpointAttributes.html).
#'
#' @examples
#'
#' @export
create_platform_endpoint <- function (PlatformApplicationArn, 
    Token, CustomUserData = NULL, Attributes = NULL) 
{
    op <- Operation(name = "CreatePlatformEndpoint", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_platform_endpoint_input(PlatformApplicationArn = PlatformApplicationArn, 
        Token = Token, CustomUserData = CustomUserData, Attributes = Attributes)
    output <- create_platform_endpoint_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
{
    op <- Operation(name = "CreateTopic", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_topic_input(Name = Name)
    output <- create_topic_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
delete_platform_application <- function (PlatformApplicationArn) 
{
    op <- Operation(name = "DeletePlatformApplication", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- delete_platform_application_input(PlatformApplicationArn = PlatformApplicationArn)
    output <- delete_platform_application_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
delete_topic <- function (TopicArn) 
{
    op <- Operation(name = "DeleteTopic", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- delete_topic_input(TopicArn = TopicArn)
    output <- delete_topic_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_endpoint_attributes <- function (EndpointArn) 
{
    op <- Operation(name = "GetEndpointAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- get_endpoint_attributes_input(EndpointArn = EndpointArn)
    output <- get_endpoint_attributes_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_platform_application_attributes <- function (PlatformApplicationArn) 
{
    op <- Operation(name = "GetPlatformApplicationAttributes", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- get_platform_application_attributes_input(PlatformApplicationArn = PlatformApplicationArn)
    output <- get_platform_application_attributes_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_sms_attributes <- function (attributes = NULL) 
{
    op <- Operation(name = "GetSMSAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- get_sms_attributes_input(attributes = attributes)
    output <- get_sms_attributes_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_subscription_attributes <- function (SubscriptionArn) 
{
    op <- Operation(name = "GetSubscriptionAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- get_subscription_attributes_input(SubscriptionArn = SubscriptionArn)
    output <- get_subscription_attributes_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_topic_attributes <- function (TopicArn) 
{
    op <- Operation(name = "GetTopicAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- get_topic_attributes_input(TopicArn = TopicArn)
    output <- get_topic_attributes_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_endpoints_by_platform_application <- function (PlatformApplicationArn, 
    NextToken = NULL) 
{
    op <- Operation(name = "ListEndpointsByPlatformApplication", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- list_endpoints_by_platform_application_input(PlatformApplicationArn = PlatformApplicationArn, 
        NextToken = NextToken)
    output <- list_endpoints_by_platform_application_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_phone_numbers_opted_out <- function (nextToken = NULL) 
{
    op <- Operation(name = "ListPhoneNumbersOptedOut", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_phone_numbers_opted_out_input(nextToken = nextToken)
    output <- list_phone_numbers_opted_out_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_platform_applications <- function (NextToken = NULL) 
{
    op <- Operation(name = "ListPlatformApplications", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_platform_applications_input(NextToken = NextToken)
    output <- list_platform_applications_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_subscriptions <- function (NextToken = NULL) 
{
    op <- Operation(name = "ListSubscriptions", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_subscriptions_input(NextToken = NextToken)
    output <- list_subscriptions_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_subscriptions_by_topic <- function (TopicArn, NextToken = NULL) 
{
    op <- Operation(name = "ListSubscriptionsByTopic", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_subscriptions_by_topic_input(TopicArn = TopicArn, 
        NextToken = NextToken)
    output <- list_subscriptions_by_topic_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_topics <- function (NextToken = NULL) 
{
    op <- Operation(name = "ListTopics", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_topics_input(NextToken = NextToken)
    output <- list_topics_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
opt_in_phone_number <- function (phoneNumber) 
{
    op <- Operation(name = "OptInPhoneNumber", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- opt_in_phone_number_input(phoneNumber = phoneNumber)
    output <- opt_in_phone_number_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
publish <- function (Message, TopicArn = NULL, TargetArn = NULL, 
    PhoneNumber = NULL, Subject = NULL, MessageStructure = NULL, 
    MessageAttributes = NULL) 
{
    op <- Operation(name = "Publish", http_method = "POST", http_path = "/", 
        paginator = list())
    input <- publish_input(Message = Message, TopicArn = TopicArn, 
        TargetArn = TargetArn, PhoneNumber = PhoneNumber, Subject = Subject, 
        MessageStructure = MessageStructure, MessageAttributes = MessageAttributes)
...
#'
#' @export
remove_permission <- function (TopicArn, Label) 
{
    op <- Operation(name = "RemovePermission", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- remove_permission_input(TopicArn = TopicArn, Label = Label)
...
#'
#' @export
set_endpoint_attributes <- function (EndpointArn, Attributes) 
{
    op <- Operation(name = "SetEndpointAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- set_endpoint_attributes_input(EndpointArn = EndpointArn, 
        Attributes = Attributes)
    output <- set_endpoint_attributes_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' 
#' -   `PlatformCredential` \-- The credential received from the notification service. For APNS/APNS\_SANDBOX, PlatformCredential is private key. For GCM, PlatformCredential is \"API key\". For ADM, PlatformCredential is \"client secret\".
#' 
#' -   `PlatformPrincipal` \-- The principal received from the notification service. For APNS/APNS\_SANDBOX, PlatformPrincipal is SSL certificate. For GCM, PlatformPrincipal is not applicable. For ADM, PlatformPrincipal is \"client id\".
#' 
...
#'
#' @export
set_platform_application_attributes <- function (PlatformApplicationArn, 
    Attributes) 
{
    op <- Operation(name = "SetPlatformApplicationAttributes", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- set_platform_application_attributes_input(PlatformApplicationArn = PlatformApplicationArn, 
        Attributes = Attributes)
    output <- set_platform_application_attributes_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
set_sms_attributes <- function (attributes) 
{
    op <- Operation(name = "SetSMSAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- set_sms_attributes_input(attributes = attributes)
    output <- set_sms_attributes_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
set_subscription_attributes <- function (SubscriptionArn, AttributeName, 
    AttributeValue = NULL) 
{
    op <- Operation(name = "SetSubscriptionAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- set_subscription_attributes_input(SubscriptionArn = SubscriptionArn, 
        AttributeName = AttributeName, AttributeValue = AttributeValue)
    output <- set_subscription_attributes_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
set_topic_attributes <- function (TopicArn, AttributeName, AttributeValue = NULL) 
{
    op <- Operation(name = "SetTopicAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- set_topic_attributes_input(TopicArn = TopicArn, 
        AttributeName = AttributeName, AttributeValue = AttributeValue)
    output <- set_topic_attributes_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' @param Attributes Assigns attributes to the subscription as a map of key-value pairs. You can assign any attribute that is supported by the `SetSubscriptionAttributes` action.
...
#'
#' @export
subscribe <- function (TopicArn, Protocol, Endpoint = NULL, Attributes = NULL, 
    ReturnSubscriptionArn = NULL) 
{
    op <- Operation(name = "Subscribe", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- subscribe_input(TopicArn = TopicArn, Protocol = Protocol, 
        Endpoint = Endpoint, Attributes = Attributes, ReturnSubscriptionArn = ReturnSubscriptionArn)
...
{
    op <- Operation(name = "Unsubscribe", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- unsubscribe_input(SubscriptionArn = SubscriptionArn)
    output <- unsubscribe_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
