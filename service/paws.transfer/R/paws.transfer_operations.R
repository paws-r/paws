...
{
    op <- new_operation(name = "DescribeServer", http_method = "POST", 
        http_path = "/", paginator = list())
...
import_ssh_public_key <- function (ServerId, SshPublicKeyBody, 
    UserName) 
{
    op <- new_operation(name = "ImportSshPublicKey", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListServers", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StartServer", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StopServer", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "TestIdentityProvider", http_method = "POST", 
        http_path = "/", paginator = list())
