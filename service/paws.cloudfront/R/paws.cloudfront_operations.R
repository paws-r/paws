...
{
    op <- Operation(name = "CreateCloudFrontOriginAccessIdentity", 
...
{
    op <- Operation(name = "CreateDistribution", http_method = "POST", 
...
{
    op <- Operation(name = "CreateDistributionWithTags", http_method = "POST", 
        http_path = "/2018-11-05/distribution?WithTags", paginator = list())
...
{
    op <- Operation(name = "CreateFieldLevelEncryptionConfig", 
...
{
    op <- Operation(name = "CreateFieldLevelEncryptionProfile", 
...
{
    op <- Operation(name = "CreateInvalidation", http_method = "POST", 
...
{
    op <- Operation(name = "CreatePublicKey", http_method = "POST", 
...
{
    op <- Operation(name = "CreateStreamingDistribution", http_method = "POST", 
        http_path = "/2018-11-05/streaming-distribution", paginator = list())
...
{
    op <- Operation(name = "CreateStreamingDistributionWithTags", 
...
{
    op <- Operation(name = "DeleteCloudFrontOriginAccessIdentity", 
...
{
    op <- Operation(name = "DeleteDistribution", http_method = "DELETE", 
...
{
    op <- Operation(name = "DeleteFieldLevelEncryptionConfig", 
...
{
    op <- Operation(name = "DeleteFieldLevelEncryptionProfile", 
...
{
    op <- Operation(name = "DeletePublicKey", http_method = "DELETE", 
...
{
    op <- Operation(name = "DeleteStreamingDistribution", http_method = "DELETE", 
...
{
    op <- Operation(name = "GetCloudFrontOriginAccessIdentity", 
...
{
    op <- Operation(name = "GetCloudFrontOriginAccessIdentityConfig", 
...
{
    op <- Operation(name = "GetDistribution", http_method = "GET", 
        http_path = "/2018-11-05/distribution/{Id}", paginator = list())
...
{
    op <- Operation(name = "GetDistributionConfig", http_method = "GET", 
...
{
    op <- Operation(name = "GetFieldLevelEncryption", http_method = "GET", 
...
{
    op <- Operation(name = "GetFieldLevelEncryptionConfig", http_method = "GET", 
...
{
    op <- Operation(name = "GetFieldLevelEncryptionProfile", 
...
{
    op <- Operation(name = "GetFieldLevelEncryptionProfileConfig", 
...
{
    op <- Operation(name = "GetInvalidation", http_method = "GET", 
...
{
    op <- Operation(name = "GetPublicKey", http_method = "GET", 
        http_path = "/2018-11-05/public-key/{Id}", paginator = list())
...
{
    op <- Operation(name = "GetPublicKeyConfig", http_method = "GET", 
...
{
    op <- Operation(name = "GetStreamingDistribution", http_method = "GET", 
        http_path = "/2018-11-05/streaming-distribution/{Id}", 
        paginator = list())
...
{
    op <- Operation(name = "GetStreamingDistributionConfig", 
...
list_cloud_front_origin_access_identities <- function (Marker = NULL, 
    MaxItems = NULL) 
{
    op <- Operation(name = "ListCloudFrontOriginAccessIdentities", 
...
{
    op <- Operation(name = "ListDistributions", http_method = "GET", 
        http_path = "/2018-11-05/distribution", paginator = list())
...
{
    op <- Operation(name = "ListDistributionsByWebACLId", http_method = "GET", 
...
list_field_level_encryption_configs <- function (Marker = NULL, 
    MaxItems = NULL) 
{
    op <- Operation(name = "ListFieldLevelEncryptionConfigs", 
...
list_field_level_encryption_profiles <- function (Marker = NULL, 
    MaxItems = NULL) 
{
    op <- Operation(name = "ListFieldLevelEncryptionProfiles", 
...
list_invalidations <- function (DistributionId, Marker = NULL, 
    MaxItems = NULL) 
{
    op <- Operation(name = "ListInvalidations", http_method = "GET", 
        http_path = "/2018-11-05/distribution/{DistributionId}/invalidation", 
        paginator = list())
...
{
    op <- Operation(name = "ListPublicKeys", http_method = "GET", 
        http_path = "/2018-11-05/public-key", paginator = list())
...
{
    op <- Operation(name = "ListStreamingDistributions", http_method = "GET", 
        http_path = "/2018-11-05/streaming-distribution", paginator = list())
...
update_cloud_front_origin_access_identity <- function (CloudFrontOriginAccessIdentityConfig, 
    Id, IfMatch = NULL) 
{
    op <- Operation(name = "UpdateCloudFrontOriginAccessIdentity", 
...
{
    op <- Operation(name = "UpdateDistribution", http_method = "PUT", 
        http_path = "/2018-11-05/distribution/{Id}/config", paginator = list())
...
update_field_level_encryption_config <- function (FieldLevelEncryptionConfig, 
    Id, IfMatch = NULL) 
{
    op <- Operation(name = "UpdateFieldLevelEncryptionConfig", 
...
update_field_level_encryption_profile <- function (FieldLevelEncryptionProfileConfig, 
    Id, IfMatch = NULL) 
{
    op <- Operation(name = "UpdateFieldLevelEncryptionProfile", 
...
{
    op <- Operation(name = "UpdatePublicKey", http_method = "PUT", 
        http_path = "/2018-11-05/public-key/{Id}/config", paginator = list())
...
update_streaming_distribution <- function (StreamingDistributionConfig, 
    Id, IfMatch = NULL) 
{
    op <- Operation(name = "UpdateStreamingDistribution", http_method = "PUT", 
