...
{
    op <- new_operation(name = "BatchGetResourceConfig", http_method = "POST", 
...
delete_aggregation_authorization <- function (AuthorizedAccountId, 
    AuthorizedAwsRegion) 
{
    op <- new_operation(name = "DeleteAggregationAuthorization", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteConfigRule", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteConfigurationAggregator", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' ```
#'
#' @param ConfigurationRecorderName &#91;required&#93; The name of the configuration recorder to be deleted. You can retrieve the name of your configuration recorder by using the `DescribeConfigurationRecorders` action.
#'
#' @export
delete_configuration_recorder <- function (ConfigurationRecorderName) 
{
    op <- new_operation(name = "DeleteConfigurationRecorder", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteDeliveryChannel", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param ConfigRuleName &#91;required&#93; The name of the AWS Config rule for which you want to delete the evaluation results.
#'
#' @export
delete_evaluation_results <- function (ConfigRuleName) 
{
    op <- new_operation(name = "DeleteEvaluationResults", http_method = "POST", 
        http_path = "/", paginator = list())
...
delete_pending_aggregation_request <- function (RequesterAccountId, 
    RequesterAwsRegion) 
{
    op <- new_operation(name = "DeletePendingAggregationRequest", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteRetentionConfiguration", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeliverConfigSnapshot", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeAggregateComplianceByConfigRules", 
        http_method = "POST", http_path = "/", paginator = list())
...
describe_aggregation_authorizations <- function (Limit = NULL, 
    NextToken = NULL) 
{
    op <- new_operation(name = "DescribeAggregationAuthorizations", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeComplianceByConfigRule", 
        http_method = "POST", http_path = "/", paginator = list())
...
describe_compliance_by_resource <- function (ResourceType = NULL, 
    ...
    NextToken = NULL) 
{
    op <- new_operation(name = "DescribeComplianceByResource", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeConfigRuleEvaluationStatus", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeConfigRules", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeConfigurationAggregatorSourcesStatus", 
        http_method = "POST", http_path = "/", paginator = list())
...
describe_configuration_aggregators <- function (ConfigurationAggregatorNames = NULL, 
    NextToken = NULL, Limit = NULL) 
{
    op <- new_operation(name = "DescribeConfigurationAggregators", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeConfigurationRecorderStatus", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeDeliveryChannelStatus", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeDeliveryChannels", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_pending_aggregation_requests <- function (Limit = NULL, 
    NextToken = NULL) 
{
    op <- new_operation(name = "DescribePendingAggregationRequests", 
        http_method = "POST", http_path = "/", paginator = list())
...
describe_retention_configurations <- function (RetentionConfigurationNames = NULL, 
    NextToken = NULL) 
{
    op <- new_operation(name = "DescribeRetentionConfigurations", 
        http_method = "POST", http_path = "/", paginator = list())
...
#'
#' @param ConfigurationAggregatorName &#91;required&#93; The name of the configuration aggregator.
#' @param ConfigRuleName &#91;required&#93; The name of the AWS Config rule for which you want compliance information.
...
{
    op <- new_operation(name = "GetAggregateComplianceDetailsByConfigRule", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetAggregateConfigRuleComplianceSummary", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetComplianceDetailsByConfigRule", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetComplianceDetailsByResource", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetComplianceSummaryByConfigRule", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetComplianceSummaryByResourceType", 
        http_method = "POST", http_path = "/", paginator = list())
...
get_discovered_resource_counts <- function (resourceTypes = NULL, 
    limit = NULL, nextToken = NULL) 
{
    op <- new_operation(name = "GetDiscoveredResourceCounts", 
        http_method = "POST", http_path = "/", paginator = list())
...
#'   resourceType = "AWS::EC2::CustomerGateway"|"AWS::EC2::EIP"|"AWS::EC2::Host"|"AWS::EC2::Instance"|"AWS::EC2::InternetGateway"|"AWS::EC2::NetworkAcl"|"AWS::EC2::NetworkInterface"|"AWS::EC2::RouteTable"|"AWS::EC2::SecurityGroup"|"AWS::EC2::Subnet"|"AWS::CloudTrail::Trail"|"AWS::EC2::Volume"|"AWS::EC2::VPC"|"AWS::EC2::VPNConnection"|"AWS::EC2::VPNGateway"|"AWS::IAM::Group"|"AWS::IAM::Policy"|"AWS::IAM::Role"|"AWS::IAM::User"|"AWS::ACM::Certificate"|"AWS::RDS::DBInstance"|"AWS::RDS::DBSubnetGroup"|"AWS::RDS::DBSecurityGroup"|"AWS::RDS::DBSnapshot"|"AWS::RDS::EventSubscription"|"AWS::ElasticLoadBalancingV2::LoadBalancer"|"AWS::S3::Bucket"|"AWS::SSM::ManagedInstanceInventory"|"AWS::Redshift::Cluster"|"AWS::Redshift::ClusterSnapshot"|"AWS::Redshift::ClusterParameterGroup"|"AWS::Redshift::ClusterSecurityGroup"|"AWS::Redshift::ClusterSubnetGroup"|"AWS::Redshift::EventSubscription"|"AWS::CloudWatch::Alarm"|"AWS::CloudFormation::Stack"|"AWS::DynamoDB::Table"|"AWS::AutoScaling::AutoScalingGroup"|"AWS::AutoScaling::LaunchConfiguration"|"AWS::AutoScaling::ScalingPolicy"|"AWS::AutoScaling::ScheduledAction"|"AWS::CodeBuild::Project"|"AWS::WAF::RateBasedRule"|"AWS::WAF::Rule"|"AWS::WAF::WebACL"|"AWS::WAFRegional::RateBasedRule"|"AWS::WAFRegional::Rule"|"AWS::WAFRegional::WebACL"|"AWS::CloudFront::Distribution"|"AWS::CloudFront::StreamingDistribution"|"AWS::WAF::RuleGroup"|"AWS::WAFRegional::RuleGroup"|"AWS::Lambda::Function"|"AWS::ElasticBeanstalk::Application"|"AWS::ElasticBeanstalk::ApplicationVersion"|"AWS::ElasticBeanstalk::Environment"|"AWS::ElasticLoadBalancing::LoadBalancer"|"AWS::XRay::EncryptionConfig"|"AWS::SSM::AssociationCompliance"|"AWS::SSM::PatchCompliance"|"AWS::Shield::Protection"|"AWS::ShieldRegional::Protection"|"AWS::Config::ResourceCompliance"|"AWS::CodePipeline::Pipeline",
#'   resourceId = "string",
#'   laterTime = as.POSIXct("2015-01-01"),
#'   earlierTime = as.POSIXct("2015-01-01"),
...
get_resource_config_history <- function (resourceType, resourceId, 
    ...
    limit = NULL, nextToken = NULL) 
{
    op <- new_operation(name = "GetResourceConfigHistory", http_method = "POST", 
        http_path = "/", paginator = list())
...
put_aggregation_authorization <- function (AuthorizedAccountId, 
    AuthorizedAwsRegion) 
{
    op <- new_operation(name = "PutAggregationAuthorization", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PutConfigRule", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PutConfigurationAggregator", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' ```
#'
#' @param ConfigurationRecorder &#91;required&#93; The configuration recorder object that records each configuration change made to the resources.
#'
#' @export
put_configuration_recorder <- function (ConfigurationRecorder) 
{
    op <- new_operation(name = "PutConfigurationRecorder", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param DeliveryChannel &#91;required&#93; The configuration delivery channel object that delivers the configuration information to an Amazon S3 bucket and to an Amazon SNS topic.
#'
#' @export
put_delivery_channel <- function (DeliveryChannel) 
{
    op <- new_operation(name = "PutDeliveryChannel", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'       ComplianceType = "COMPLIANT"|"NON_COMPLIANT"|"NOT_APPLICABLE"|"INSUFFICIENT_DATA",
#'       Annotation = "string",
#'       OrderingTimestamp = as.POSIXct("2015-01-01")
#'     )
#'   ),
#'   ResultToken = "string",
#'   TestMode = TRUE|FALSE
...
#' @param ResultToken &#91;required&#93; An encrypted token that associates an evaluation with an AWS Config rule. Identifies the rule and the event that triggered the evaluation.
...
#'
#' @export
put_evaluations <- function (Evaluations = NULL, ResultToken, 
    TestMode = NULL) 
{
    op <- new_operation(name = "PutEvaluations", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- put_evaluations_input(Evaluations = Evaluations, 
        ResultToken = ResultToken, TestMode = TestMode)
...
{
    op <- new_operation(name = "PutRetentionConfiguration", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StartConfigRulesEvaluation", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' ```
#'
#' @param ConfigurationRecorderName &#91;required&#93; The name of the recorder object that records each configuration change made to the resources.
#'
#' @export
start_configuration_recorder <- function (ConfigurationRecorderName) 
{
    op <- new_operation(name = "StartConfigurationRecorder", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StopConfigurationRecorder", http_method = "POST", 
        http_path = "/", paginator = list())
