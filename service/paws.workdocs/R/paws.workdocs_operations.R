...
{
    op <- new_operation(name = "AbortDocumentVersionUpload", 
        http_method = "DELETE", http_path = "/api/v1/documents/{DocumentId}/versions/{VersionId}", 
        paginator = list())
...
{
    op <- new_operation(name = "ActivateUser", http_method = "POST", 
...
{
    op <- new_operation(name = "AddResourcePermissions", http_method = "POST", 
...
{
    op <- new_operation(name = "CreateComment", http_method = "POST", 
...
{
    op <- new_operation(name = "CreateCustomMetadata", http_method = "PUT", 
...
create_folder <- function (AuthenticationToken = NULL, Name = NULL, 
    ParentFolderId) 
{
    op <- new_operation(name = "CreateFolder", http_method = "POST", 
...
{
    op <- new_operation(name = "CreateLabels", http_method = "PUT", 
...
{
    op <- new_operation(name = "CreateNotificationSubscription", 
...
{
    op <- new_operation(name = "DeactivateUser", http_method = "DELETE", 
        http_path = "/api/v1/users/{UserId}/activation", paginator = list())
...
delete_comment <- function (AuthenticationToken = NULL, DocumentId, 
    VersionId, CommentId) 
{
    op <- new_operation(name = "DeleteComment", http_method = "DELETE", 
...
{
    op <- new_operation(name = "DeleteCustomMetadata", http_method = "DELETE", 
        http_path = "/api/v1/resources/{ResourceId}/customMetadata", 
        paginator = list())
...
{
    op <- new_operation(name = "DeleteDocument", http_method = "DELETE", 
...
{
    op <- new_operation(name = "DeleteFolder", http_method = "DELETE", 
...
delete_folder_contents <- function (AuthenticationToken = NULL, 
    FolderId) 
{
    op <- new_operation(name = "DeleteFolderContents", http_method = "DELETE", 
...
{
    op <- new_operation(name = "DeleteLabels", http_method = "DELETE", 
        http_path = "/api/v1/resources/{ResourceId}/labels", 
        paginator = list())
...
delete_notification_subscription <- function (SubscriptionId, 
    OrganizationId) 
{
    op <- new_operation(name = "DeleteNotificationSubscription", 
...
{
    op <- new_operation(name = "DescribeComments", http_method = "GET", 
...
describe_document_versions <- function (AuthenticationToken = NULL, 
    ...
    Fields = NULL) 
{
    op <- new_operation(name = "DescribeDocumentVersions", http_method = "GET", 
...
{
    op <- new_operation(name = "DescribeFolderContents", http_method = "GET", 
        http_path = "/api/v1/folders/{FolderId}/contents", paginator = list())
...
{
    op <- new_operation(name = "DescribeGroups", http_method = "GET", 
...
{
    op <- new_operation(name = "DescribeNotificationSubscriptions", 
...
{
    op <- new_operation(name = "DescribeResourcePermissions", 
        http_method = "GET", http_path = "/api/v1/resources/{ResourceId}/permissions", 
        paginator = list())
...
describe_root_folders <- function (AuthenticationToken, Limit = NULL, 
    Marker = NULL) 
{
    op <- new_operation(name = "DescribeRootFolders", http_method = "GET", 
...
{
    op <- new_operation(name = "DescribeUsers", http_method = "GET", 
        http_path = "/api/v1/users", paginator = list())
...
{
    op <- new_operation(name = "GetCurrentUser", http_method = "GET", 
...
{
    op <- new_operation(name = "GetDocument", http_method = "GET", 
        http_path = "/api/v1/documents/{DocumentId}", paginator = list())
...
{
    op <- new_operation(name = "GetDocumentPath", http_method = "GET", 
...
{
    op <- new_operation(name = "GetDocumentVersion", http_method = "GET", 
...
get_folder <- function (AuthenticationToken = NULL, FolderId, 
    IncludeCustomMetadata = NULL) 
{
    op <- new_operation(name = "GetFolder", http_method = "GET", 
        http_path = "/api/v1/folders/{FolderId}", paginator = list())
...
get_folder_path <- function (AuthenticationToken = NULL, FolderId, 
    Limit = NULL, Fields = NULL, Marker = NULL) 
{
    op <- new_operation(name = "GetFolderPath", http_method = "GET", 
...
{
    op <- new_operation(name = "InitiateDocumentVersionUpload", 
        http_method = "POST", http_path = "/api/v1/documents", 
        paginator = list())
...
remove_all_resource_permissions <- function (AuthenticationToken = NULL, 
    ResourceId) 
{
    op <- new_operation(name = "RemoveAllResourcePermissions", 
        http_method = "DELETE", http_path = "/api/v1/resources/{ResourceId}/permissions", 
        paginator = list())
...
{
    op <- new_operation(name = "RemoveResourcePermission", http_method = "DELETE", 
...
{
    op <- new_operation(name = "UpdateDocument", http_method = "PATCH", 
        http_path = "/api/v1/documents/{DocumentId}", paginator = list())
...
{
    op <- new_operation(name = "UpdateDocumentVersion", http_method = "PATCH", 
        http_path = "/api/v1/documents/{DocumentId}/versions/{VersionId}", 
        paginator = list())
...
update_folder <- function (AuthenticationToken = NULL, FolderId, 
    Name = NULL, ParentFolderId = NULL, ResourceState = NULL) 
{
    op <- new_operation(name = "UpdateFolder", http_method = "PATCH", 
        http_path = "/api/v1/folders/{FolderId}", paginator = list())
...
{
    op <- new_operation(name = "UpdateUser", http_method = "PATCH", 
        http_path = "/api/v1/users/{UserId}", paginator = list())
