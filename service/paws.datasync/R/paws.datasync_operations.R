...
{
    op <- Operation(name = "CancelTaskExecution", http_method = "POST", 
...
{
    op <- Operation(name = "CreateAgent", http_method = "POST", 
        http_path = "/", paginator = list())
...
create_location_efs <- function (Subdirectory, EfsFilesystemArn, 
    Ec2Config, Tags = NULL) 
{
    op <- Operation(name = "CreateLocationEfs", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "CreateLocationNfs", http_method = "POST", 
        http_path = "/", paginator = list())
...
create_location_s3 <- function (Subdirectory, S3BucketArn, S3Config, 
    Tags = NULL) 
{
    op <- Operation(name = "CreateLocationS3", http_method = "POST", 
        http_path = "/", paginator = list())
...
create_task <- function (SourceLocationArn, DestinationLocationArn, 
    ...
    Tags = NULL) 
{
    op <- Operation(name = "CreateTask", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteAgent", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteLocation", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteTask", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeAgent", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeLocationEfs", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeLocationNfs", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeLocationS3", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeTask", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeTaskExecution", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListAgents", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListLocations", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_task_executions <- function (TaskArn = NULL, MaxResults = NULL, 
    NextToken = NULL) 
{
    op <- Operation(name = "ListTaskExecutions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListTasks", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "StartTaskExecution", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateAgent", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateTask", http_method = "POST", 
        http_path = "/", paginator = list())
