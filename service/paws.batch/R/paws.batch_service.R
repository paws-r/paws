service <- function () 
{
    cfg <- client_config("batch", list(`*` = "batch.{region}.amazonaws.com", 
        `cn-*` = "batch.{region}.amazonaws.com.cn"))
    client_info <- ClientInfo(service_name = "batch", service_id = "Batch", 
        api_version = "2016-08-10", signing_name = cfg$signing_name, 
