...
{
    op <- new_operation(name = "GetResources", http_method = "POST", 
...
{
    op <- new_operation(name = "GetTagKeys", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @param PaginationToken A string that indicates that additional data is available. Leave this value empty for your initial request. If the response includes a PaginationToken, use that string for this value to request an additional page of data.
#' @param Key &#91;required&#93; The key for which you want to list all existing values in the specified region for the AWS account.
#'
#' @export
get_tag_values <- function (PaginationToken = NULL, Key) 
{
    op <- new_operation(name = "GetTagValues", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- get_tag_values_input(PaginationToken = PaginationToken, 
        Key = Key)
...
#' ```
#'
#' @param ResourceARNList &#91;required&#93; A list of ARNs. An ARN (Amazon Resource Name) uniquely identifies a resource. You can specify a minimum of 1 and a maximum of 20 ARNs (resources) to tag. An ARN can be set to a maximum of 1600 characters. For more information, see [Amazon Resource Names (ARNs) and AWS Service Namespaces](http://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) in the *AWS General Reference*.
#' @param Tags &#91;required&#93; The tags that you want to add to the specified resources. A tag consists of a key and a value that you define.
#'
#' @export
tag_resources <- function (ResourceARNList, Tags) 
{
    op <- new_operation(name = "TagResources", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param ResourceARNList &#91;required&#93; A list of ARNs. An ARN (Amazon Resource Name) uniquely identifies a resource. You can specify a minimum of 1 and a maximum of 20 ARNs (resources) to untag. An ARN can be set to a maximum of 1600 characters. For more information, see [Amazon Resource Names (ARNs) and AWS Service Namespaces](http://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) in the *AWS General Reference*.
#' @param TagKeys &#91;required&#93; A list of the tag keys that you want to remove from the specified resources.
#'
#' @export
untag_resources <- function (ResourceARNList, TagKeys) 
{
    op <- new_operation(name = "UntagResources", http_method = "POST", 
        http_path = "/", paginator = list())
