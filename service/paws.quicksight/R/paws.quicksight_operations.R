...
create_group_membership <- function (MemberName, GroupName, AwsAccountId, 
    Namespace) 
{
    op <- Operation(name = "CreateGroupMembership", http_method = "PUT", 
...
delete_group_membership <- function (MemberName, GroupName, AwsAccountId, 
    Namespace) 
{
    op <- Operation(name = "DeleteGroupMembership", http_method = "DELETE", 
        http_path = "/accounts/{AwsAccountId}/namespaces/{Namespace}/groups/{GroupName}/members/{MemberName}", 
        paginator = list())
...
{
    op <- Operation(name = "DescribeGroup", http_method = "GET", 
        http_path = "/accounts/{AwsAccountId}/namespaces/{Namespace}/groups/{GroupName}", 
        paginator = list())
...
get_dashboard_embed_url <- function (AwsAccountId, DashboardId, 
    ...
    ResetDisabled = NULL) 
{
    op <- Operation(name = "GetDashboardEmbedUrl", http_method = "GET", 
...
{
    op <- Operation(name = "ListGroupMemberships", http_method = "GET", 
...
{
    op <- Operation(name = "ListUserGroups", http_method = "GET", 
...
{
    op <- Operation(name = "RegisterUser", http_method = "POST", 
        http_path = "/accounts/{AwsAccountId}/namespaces/{Namespace}/users", 
        paginator = list())
