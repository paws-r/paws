...
#'     oldestDate = as.POSIXct("2015-01-01"),
#'     latestDate = as.POSIXct("2015-01-01")
#'   ),
...
{
    op <- new_operation(name = "CountClosedWorkflowExecutions", 
...
{
    op <- new_operation(name = "CountOpenWorkflowExecutions", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CountPendingActivityTasks", http_method = "POST", 
...
{
    op <- new_operation(name = "CountPendingDecisionTasks", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeprecateActivityType", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeprecateDomain", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeprecateWorkflowType", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeActivityType", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeDomain", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeWorkflowExecution", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeWorkflowType", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetWorkflowExecutionHistory", 
        http_method = "POST", http_path = "/", paginator = list())
...
#'
#' @export
list_activity_types <- function (domain, name = NULL, registrationStatus, 
    nextPageToken = NULL, maximumPageSize = NULL, reverseOrder = NULL) 
{
    op <- new_operation(name = "ListActivityTypes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_activity_types_input(domain = domain, name = name, 
        registrationStatus = registrationStatus, nextPageToken = nextPageToken, 
        maximumPageSize = maximumPageSize, reverseOrder = reverseOrder)
...
{
    op <- new_operation(name = "ListClosedWorkflowExecutions", 
        http_method = "POST", http_path = "/", paginator = list())
...
#'
#' @export
list_domains <- function (nextPageToken = NULL, registrationStatus, 
    maximumPageSize = NULL, reverseOrder = NULL) 
{
    op <- new_operation(name = "ListDomains", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_domains_input(nextPageToken = nextPageToken, 
        registrationStatus = registrationStatus, maximumPageSize = maximumPageSize, 
...
{
    op <- new_operation(name = "ListOpenWorkflowExecutions", 
        http_method = "POST", http_path = "/", paginator = list())
...
#'
#' @export
list_workflow_types <- function (domain, name = NULL, registrationStatus, 
    nextPageToken = NULL, maximumPageSize = NULL, reverseOrder = NULL) 
{
    op <- new_operation(name = "ListWorkflowTypes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_workflow_types_input(domain = domain, name = name, 
        registrationStatus = registrationStatus, nextPageToken = nextPageToken, 
        maximumPageSize = maximumPageSize, reverseOrder = reverseOrder)
...
{
    op <- new_operation(name = "PollForActivityTask", http_method = "POST", 
        http_path = "/", paginator = list())
...
poll_for_decision_task <- function (domain, taskList, identity = NULL, 
    nextPageToken = NULL, maximumPageSize = NULL, reverseOrder = NULL) 
{
    op <- new_operation(name = "PollForDecisionTask", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RecordActivityTaskHeartbeat", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' Registers a new _activity type_ along with its configuration settings in the specified domain
#'
...
{
    op <- new_operation(name = "RegisterActivityType", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
register_domain <- function (name, description = NULL, workflowExecutionRetentionPeriodInDays) 
{
    op <- new_operation(name = "RegisterDomain", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- register_domain_input(name = name, description = description, 
...
#' Registers a new _workflow type_ and its configuration settings in the specified domain
#'
...
{
    op <- new_operation(name = "RegisterWorkflowType", http_method = "POST", 
        http_path = "/", paginator = list())
...
request_cancel_workflow_execution <- function (domain, workflowId, 
    runId = NULL) 
{
    op <- new_operation(name = "RequestCancelWorkflowExecution", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RespondActivityTaskCanceled", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RespondActivityTaskCompleted", 
        http_method = "POST", http_path = "/", paginator = list())
...
respond_activity_task_failed <- function (taskToken, reason = NULL, 
    details = NULL) 
{
    op <- new_operation(name = "RespondActivityTaskFailed", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RespondDecisionTaskCompleted", 
        http_method = "POST", http_path = "/", paginator = list())
...
#'
#' @export
signal_workflow_execution <- function (domain, workflowId, runId = NULL, 
    signalName, input = NULL) 
{
    op <- new_operation(name = "SignalWorkflowExecution", http_method = "POST", 
        http_path = "/", paginator = list())
...
start_workflow_execution <- function (domain, workflowId, workflowType, 
    ...
    lambdaRole = NULL) 
{
    op <- new_operation(name = "StartWorkflowExecution", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "TerminateWorkflowExecution", 
        http_method = "POST", http_path = "/", paginator = list())
