...
#'
#' @export
count_closed_workflow_executions <- function (domain, startTimeFilter = NULL, 
    closeTimeFilter = NULL, executionFilter = NULL, typeFilter = NULL, 
    tagFilter = NULL, closeStatusFilter = NULL) 
{
    op <- Operation(name = "CountClosedWorkflowExecutions", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- count_closed_workflow_executions_input(domain = domain, 
        startTimeFilter = startTimeFilter, closeTimeFilter = closeTimeFilter, 
        executionFilter = executionFilter, typeFilter = typeFilter, 
        tagFilter = tagFilter, closeStatusFilter = closeStatusFilter)
    output <- count_closed_workflow_executions_output()
    svc <- service()
...
#'
#' @export
count_open_workflow_executions <- function (domain, startTimeFilter, 
    typeFilter = NULL, tagFilter = NULL, executionFilter = NULL) 
{
    op <- Operation(name = "CountOpenWorkflowExecutions", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- count_open_workflow_executions_input(domain = domain, 
        startTimeFilter = startTimeFilter, typeFilter = typeFilter, 
        tagFilter = tagFilter, executionFilter = executionFilter)
    output <- count_open_workflow_executions_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
count_pending_activity_tasks <- function (domain, taskList) 
{
    op <- Operation(name = "CountPendingActivityTasks", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- count_pending_activity_tasks_input(domain = domain, 
        taskList = taskList)
    output <- count_pending_activity_tasks_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
count_pending_decision_tasks <- function (domain, taskList) 
{
    op <- Operation(name = "CountPendingDecisionTasks", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- count_pending_decision_tasks_input(domain = domain, 
        taskList = taskList)
    output <- count_pending_decision_tasks_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
deprecate_activity_type <- function (domain, activityType) 
{
    op <- Operation(name = "DeprecateActivityType", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- deprecate_activity_type_input(domain = domain, activityType = activityType)
    output <- deprecate_activity_type_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
deprecate_domain <- function (name) 
{
    op <- Operation(name = "DeprecateDomain", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- deprecate_domain_input(name = name)
    output <- deprecate_domain_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
deprecate_workflow_type <- function (domain, workflowType) 
{
    op <- Operation(name = "DeprecateWorkflowType", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- deprecate_workflow_type_input(domain = domain, workflowType = workflowType)
    output <- deprecate_workflow_type_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
describe_activity_type <- function (domain, activityType) 
{
    op <- Operation(name = "DescribeActivityType", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_activity_type_input(domain = domain, activityType = activityType)
    output <- describe_activity_type_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
describe_domain <- function (name) 
{
    op <- Operation(name = "DescribeDomain", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_domain_input(name = name)
    output <- describe_domain_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
describe_workflow_execution <- function (domain, execution) 
{
    op <- Operation(name = "DescribeWorkflowExecution", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_workflow_execution_input(domain = domain, 
        execution = execution)
    output <- describe_workflow_execution_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
describe_workflow_type <- function (domain, workflowType) 
{
    op <- Operation(name = "DescribeWorkflowType", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_workflow_type_input(domain = domain, workflowType = workflowType)
    output <- describe_workflow_type_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_workflow_execution_history <- function (domain, execution, 
    nextPageToken = NULL, maximumPageSize = NULL, reverseOrder = NULL) 
{
    op <- Operation(name = "GetWorkflowExecutionHistory", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- get_workflow_execution_history_input(domain = domain, 
        execution = execution, nextPageToken = nextPageToken, 
        maximumPageSize = maximumPageSize, reverseOrder = reverseOrder)
    output <- get_workflow_execution_history_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_activity_types <- function (domain, registrationStatus, 
    name = NULL, nextPageToken = NULL, maximumPageSize = NULL, 
    reverseOrder = NULL) 
{
    op <- Operation(name = "ListActivityTypes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_activity_types_input(domain = domain, registrationStatus = registrationStatus, 
        name = name, nextPageToken = nextPageToken, maximumPageSize = maximumPageSize, 
        reverseOrder = reverseOrder)
    output <- list_activity_types_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_closed_workflow_executions <- function (domain, startTimeFilter = NULL, 
    closeTimeFilter = NULL, executionFilter = NULL, closeStatusFilter = NULL, 
    typeFilter = NULL, tagFilter = NULL, nextPageToken = NULL, 
    maximumPageSize = NULL, reverseOrder = NULL) 
{
    op <- Operation(name = "ListClosedWorkflowExecutions", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_closed_workflow_executions_input(domain = domain, 
        startTimeFilter = startTimeFilter, closeTimeFilter = closeTimeFilter, 
        executionFilter = executionFilter, closeStatusFilter = closeStatusFilter, 
        typeFilter = typeFilter, tagFilter = tagFilter, nextPageToken = nextPageToken, 
        maximumPageSize = maximumPageSize, reverseOrder = reverseOrder)
    output <- list_closed_workflow_executions_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_domains <- function (registrationStatus, nextPageToken = NULL, 
    maximumPageSize = NULL, reverseOrder = NULL) 
{
    op <- Operation(name = "ListDomains", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_domains_input(registrationStatus = registrationStatus, 
...
#'
#' @export
list_open_workflow_executions <- function (domain, startTimeFilter, 
    typeFilter = NULL, tagFilter = NULL, nextPageToken = NULL, 
    maximumPageSize = NULL, reverseOrder = NULL, executionFilter = NULL) 
{
    op <- Operation(name = "ListOpenWorkflowExecutions", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_open_workflow_executions_input(domain = domain, 
        startTimeFilter = startTimeFilter, typeFilter = typeFilter, 
        tagFilter = tagFilter, nextPageToken = nextPageToken, 
        maximumPageSize = maximumPageSize, reverseOrder = reverseOrder, 
        executionFilter = executionFilter)
    output <- list_open_workflow_executions_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_workflow_types <- function (domain, registrationStatus, 
    name = NULL, nextPageToken = NULL, maximumPageSize = NULL, 
    reverseOrder = NULL) 
{
    op <- Operation(name = "ListWorkflowTypes", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_workflow_types_input(domain = domain, registrationStatus = registrationStatus, 
        name = name, nextPageToken = nextPageToken, maximumPageSize = maximumPageSize, 
        reverseOrder = reverseOrder)
    output <- list_workflow_types_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
poll_for_activity_task <- function (domain, taskList, identity = NULL) 
{
    op <- Operation(name = "PollForActivityTask", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- poll_for_activity_task_input(domain = domain, taskList = taskList, 
        identity = identity)
    output <- poll_for_activity_task_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
poll_for_decision_task <- function (domain, taskList, identity = NULL, 
    nextPageToken = NULL, maximumPageSize = NULL, reverseOrder = NULL) 
{
    op <- Operation(name = "PollForDecisionTask", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- poll_for_decision_task_input(domain = domain, taskList = taskList, 
        identity = identity, nextPageToken = nextPageToken, maximumPageSize = maximumPageSize, 
        reverseOrder = reverseOrder)
    output <- poll_for_decision_task_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
record_activity_task_heartbeat <- function (taskToken, details = NULL) 
{
    op <- Operation(name = "RecordActivityTaskHeartbeat", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- record_activity_task_heartbeat_input(taskToken = taskToken, 
        details = details)
    output <- record_activity_task_heartbeat_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
register_activity_type <- function (domain, name, version, description = NULL, 
    defaultTaskStartToCloseTimeout = NULL, defaultTaskHeartbeatTimeout = NULL, 
    defaultTaskList = NULL, defaultTaskPriority = NULL, defaultTaskScheduleToStartTimeout = NULL, 
    defaultTaskScheduleToCloseTimeout = NULL) 
{
    op <- Operation(name = "RegisterActivityType", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- register_activity_type_input(domain = domain, name = name, 
        version = version, description = description, defaultTaskStartToCloseTimeout = defaultTaskStartToCloseTimeout, 
    ...
    output <- register_activity_type_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' 
#' The specified string must not start or end with whitespace. It must not contain a `:` (colon), `/` (slash), `|` (vertical bar), or any control characters (`\u0000-\u001f` \| `\u007f-\u009f`). Also, it must not contain the literal string `arn`.
#' @param workflowExecutionRetentionPeriodInDays The duration (in days) that records and histories of workflow executions on the domain should be kept by the service. After the retention period, the workflow execution isn\'t available in the results of visibility calls.
#' 
...
#'
#' @export
register_domain <- function (name, workflowExecutionRetentionPeriodInDays, 
    description = NULL) 
{
    op <- Operation(name = "RegisterDomain", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- register_domain_input(name = name, workflowExecutionRetentionPeriodInDays = workflowExecutionRetentionPeriodInDays, 
...
#'
#' @export
register_workflow_type <- function (domain, name, version, description = NULL, 
    defaultTaskStartToCloseTimeout = NULL, defaultExecutionStartToCloseTimeout = NULL, 
    defaultTaskList = NULL, defaultTaskPriority = NULL, defaultChildPolicy = NULL, 
    defaultLambdaRole = NULL) 
{
    op <- Operation(name = "RegisterWorkflowType", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- register_workflow_type_input(domain = domain, name = name, 
        version = version, description = description, defaultTaskStartToCloseTimeout = defaultTaskStartToCloseTimeout, 
    ...
    output <- register_workflow_type_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
request_cancel_workflow_execution <- function (domain, workflowId, 
    runId = NULL) 
{
    op <- Operation(name = "RequestCancelWorkflowExecution", 
        http_method = "POST", http_path = "/", paginator = list())
    input <- request_cancel_workflow_execution_input(domain = domain, 
        workflowId = workflowId, runId = runId)
    output <- request_cancel_workflow_execution_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
respond_activity_task_canceled <- function (taskToken, details = NULL) 
{
    op <- Operation(name = "RespondActivityTaskCanceled", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- respond_activity_task_canceled_input(taskToken = taskToken, 
        details = details)
    output <- respond_activity_task_canceled_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
respond_activity_task_completed <- function (taskToken, result = NULL) 
{
    op <- Operation(name = "RespondActivityTaskCompleted", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- respond_activity_task_completed_input(taskToken = taskToken, 
        result = result)
    output <- respond_activity_task_completed_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
respond_activity_task_failed <- function (taskToken, reason = NULL, 
    details = NULL) 
{
    op <- Operation(name = "RespondActivityTaskFailed", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- respond_activity_task_failed_input(taskToken = taskToken, 
        reason = reason, details = details)
    output <- respond_activity_task_failed_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
respond_decision_task_completed <- function (taskToken, decisions = NULL, 
    executionContext = NULL) 
{
    op <- Operation(name = "RespondDecisionTaskCompleted", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- respond_decision_task_completed_input(taskToken = taskToken, 
        decisions = decisions, executionContext = executionContext)
    output <- respond_decision_task_completed_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
signal_workflow_execution <- function (domain, workflowId, signalName, 
    runId = NULL, input = NULL) 
{
    op <- Operation(name = "SignalWorkflowExecution", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- signal_workflow_execution_input(domain = domain, 
        workflowId = workflowId, signalName = signalName, runId = runId, 
        input = input)
    output <- signal_workflow_execution_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
start_workflow_execution <- function (domain, workflowId, workflowType, 
    taskList = NULL, taskPriority = NULL, input = NULL, executionStartToCloseTimeout = NULL, 
    tagList = NULL, taskStartToCloseTimeout = NULL, childPolicy = NULL, 
    lambdaRole = NULL) 
{
    op <- Operation(name = "StartWorkflowExecution", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- start_workflow_execution_input(domain = domain, 
        ...
        tagList = tagList, taskStartToCloseTimeout = taskStartToCloseTimeout, 
        childPolicy = childPolicy, lambdaRole = lambdaRole)
    output <- start_workflow_execution_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
terminate_workflow_execution <- function (domain, workflowId, 
    runId = NULL, reason = NULL, details = NULL, childPolicy = NULL) 
{
    op <- Operation(name = "TerminateWorkflowExecution", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- terminate_workflow_execution_input(domain = domain, 
        workflowId = workflowId, runId = runId, reason = reason, 
        details = details, childPolicy = childPolicy)
    output <- terminate_workflow_execution_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
