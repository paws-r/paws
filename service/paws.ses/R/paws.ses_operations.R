...
#' You can execute this operation no more than once per second.
#'
#' @param Identity The identity that is associated with the policy for which the policies will be listed. You can specify an identity by using its name or by using its Amazon Resource Name (ARN). Examples: `user@example.com`, `example.com`, `arn:aws:ses:us-east-1:123456789012:identity/example.com`.
#' 
#' To successfully call this API, you must own the identity.
#'
#' @examples
...
#' You can execute this operation no more than once per second.
#'
#' @param Identity The identity that the policy will apply to. You can specify an identity by using its name or by using its Amazon Resource Name (ARN). Examples: `user@example.com`, `example.com`, `arn:aws:ses:us-east-1:123456789012:identity/example.com`.
#' 
#' To successfully call this API, you must own the identity.
...
#'
#' @export
send_bounce <- function (OriginalMessageId, BounceSender, BouncedRecipientInfoList, 
    Explanation = NULL, MessageDsn = NULL, BounceSenderArn = NULL) 
{
    op <- Operation(name = "SendBounce", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- send_bounce_input(OriginalMessageId = OriginalMessageId, 
        BounceSender = BounceSender, BouncedRecipientInfoList = BouncedRecipientInfoList, 
        Explanation = Explanation, MessageDsn = MessageDsn, BounceSenderArn = BounceSenderArn)
...
#'
#' @export
send_bulk_templated_email <- function (Source, Template, Destinations, 
    SourceArn = NULL, ReplyToAddresses = NULL, ReturnPath = NULL, 
    ReturnPathArn = NULL, ConfigurationSetName = NULL, DefaultTags = NULL, 
    TemplateArn = NULL, DefaultTemplateData = NULL) 
{
    op <- Operation(name = "SendBulkTemplatedEmail", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- send_bulk_templated_email_input(Source = Source, 
        Template = Template, Destinations = Destinations, SourceArn = SourceArn, 
        ReplyToAddresses = ReplyToAddresses, ReturnPath = ReturnPath, 
        ReturnPathArn = ReturnPathArn, ConfigurationSetName = ConfigurationSetName, 
        DefaultTags = DefaultTags, TemplateArn = TemplateArn, 
...
#'
#' @export
send_raw_email <- function (RawMessage, Source = NULL, Destinations = NULL, 
    FromArn = NULL, SourceArn = NULL, ReturnPathArn = NULL, Tags = NULL, 
    ConfigurationSetName = NULL) 
{
    op <- Operation(name = "SendRawEmail", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- send_raw_email_input(RawMessage = RawMessage, Source = Source, 
        Destinations = Destinations, FromArn = FromArn, SourceArn = SourceArn, 
...
#'
#' @export
send_templated_email <- function (Source, Destination, Template, 
    TemplateData, ReplyToAddresses = NULL, ReturnPath = NULL, 
    SourceArn = NULL, ReturnPathArn = NULL, Tags = NULL, ConfigurationSetName = NULL, 
    TemplateArn = NULL) 
{
    ...
    input <- send_templated_email_input(Source = Source, Destination = Destination, 
        Template = Template, TemplateData = TemplateData, ReplyToAddresses = ReplyToAddresses, 
        ReturnPath = ReturnPath, SourceArn = SourceArn, ReturnPathArn = ReturnPathArn, 
        Tags = Tags, ConfigurationSetName = ConfigurationSetName, 
...
#' For more information about using notifications with Amazon SES, see the [Amazon SES Developer Guide](http://docs.aws.amazon.com/ses/latest/DeveloperGuide/notifications.html).
#'
#' @param Identity The identity for which to set bounce and complaint notification forwarding. Examples: `user@example.com`, `example.com`.
...
#' For more information about using notifications with Amazon SES, see the [Amazon SES Developer Guide](http://docs.aws.amazon.com/ses/latest/DeveloperGuide/notifications.html).
#'
#' @param Identity The identity for which to enable or disable headers in notifications. Examples: `user@example.com`, `example.com`.
