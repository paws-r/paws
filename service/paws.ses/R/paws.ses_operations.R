...
#' # one:
#' \donttest{clone_receipt_rule_set(
...
{
    op <- new_operation(name = "CloneReceiptRuleSet", http_method = "POST", 
...
create_configuration_set_tracking_options <- function (ConfigurationSetName, 
    TrackingOptions) 
{
    op <- new_operation(name = "CreateConfigurationSetTrackingOptions", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateCustomVerificationEmailTemplate", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{create_receipt_filter(
#'   Filter = list(
#'     IpFilter = list(
#'       Cidr = "1.2.3.4/24",
#'       Policy = "Allow"
...
{
    op <- new_operation(name = "CreateReceiptFilter", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateReceiptRule", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{create_receipt_rule_set(
#'   RuleSetName = "MyRuleSet"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "CreateReceiptRuleSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateTemplate", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteConfigurationSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteConfigurationSetTrackingOptions", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteCustomVerificationEmailTemplate", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteIdentity", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # identity:
#' \donttest{delete_identity_policy(
#'   Identity = "user@example.com",
#'   PolicyName = "MyPolicy"
#' )}
#'
...
{
    op <- new_operation(name = "DeleteIdentityPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{delete_receipt_filter(
#'   FilterName = "MyFilter"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "DeleteReceiptFilter", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteReceiptRule", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{delete_receipt_rule_set(
#'   RuleSetName = "MyRuleSet"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "DeleteReceiptRuleSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteTemplate", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{delete_verified_email_address(
...
{
    op <- new_operation(name = "DeleteVerifiedEmailAddress", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeActiveReceiptRuleSet", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeConfigurationSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeReceiptRule", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # receipt rule set:
#' \donttest{describe_receipt_rule_set(
#'   RuleSetName = "MyRuleSet"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "DescribeReceiptRuleSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # enabled. (true / false):
#' \donttest{get_account_sending_enabled()}
#'
#' @export
get_account_sending_enabled <- function () 
{
    op <- new_operation(name = "GetAccountSendingEnabled", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetCustomVerificationEmailTemplate", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{get_identity_dkim_attributes(
#'   Identities = list(
#'     "example.com",
#'     "user@example.com"
#'   )
...
{
    op <- new_operation(name = "GetIdentityDkimAttributes", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # identity:
#' \donttest{get_identity_mail_from_domain_attributes(
#'   Identities = list(
#'     "example.com"
#'   )
#' )}
...
{
    op <- new_operation(name = "GetIdentityMailFromDomainAttributes", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # identity:
#' \donttest{get_identity_notification_attributes(
#'   Identities = list(
#'     "example.com"
#'   )
#' )}
...
{
    op <- new_operation(name = "GetIdentityNotificationAttributes", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # identity:
#' \donttest{get_identity_policies(
...
{
    op <- new_operation(name = "GetIdentityPolicies", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{get_identity_verification_attributes(
#'   Identities = list(
#'     "example.com"
#'   )
#' )}
...
{
    op <- new_operation(name = "GetIdentityVerificationAttributes", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # account:
#' \donttest{get_send_quota()}
#'
#' @export
get_send_quota <- function () 
{
    op <- new_operation(name = "GetSendQuota", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{get_send_statistics()}
#'
#' @export
get_send_statistics <- function () 
{
    op <- new_operation(name = "GetSendStatistics", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListConfigurationSets", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_custom_verification_email_templates <- function (NextToken = NULL, 
    MaxResults = NULL) 
{
    op <- new_operation(name = "ListCustomVerificationEmailTemplates", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{list_identity_policies(
#'   Identity = "example.com"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "ListIdentityPolicies", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # with an AWS account:
#' \donttest{list_receipt_filters()}
#'
#' @export
list_receipt_filters <- function () 
{
    op <- new_operation(name = "ListReceiptFilters", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # AWS account:
#' \donttest{list_receipt_rule_sets(
#'   NextToken = ""
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "ListReceiptRuleSets", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListTemplates", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{list_verified_email_addresses()}
#'
#' @export
list_verified_email_addresses <- function () 
{
    op <- new_operation(name = "ListVerifiedEmailAddresses", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PutIdentityPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # set:
#' \donttest{reorder_receipt_rule_set(
#'   RuleNames = list(
#'     "MyRule",
#'     "MyOtherRule"
#'   ),
...
{
    op <- new_operation(name = "ReorderReceiptRuleSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "SendBounce", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "SendBulkTemplatedEmail", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "SendCustomVerificationEmail", 
        http_method = "POST", http_path = "/", paginator = list())
...
send_raw_email <- function (Source = NULL, Destinations = NULL, 
    ...
    Tags = NULL, ConfigurationSetName = NULL) 
{
    op <- new_operation(name = "SendRawEmail", http_method = "POST", 
        http_path = "/", paginator = list())
...
send_templated_email <- function (Source, Destination, ReplyToAddresses = NULL, 
    ...
    TemplateData) 
{
    op <- new_operation(name = "SendTemplatedEmail", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{set_active_receipt_rule_set(
...
{
    op <- new_operation(name = "SetActiveReceiptRuleSet", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{set_identity_dkim_enabled(
#'   DkimEnabled = TRUE,
#'   Identity = "user@example.com"
#' )}
#'
...
{
    op <- new_operation(name = "SetIdentityDkimEnabled", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{set_identity_feedback_forwarding_enabled(
...
set_identity_feedback_forwarding_enabled <- function (Identity, 
    ForwardingEnabled) 
{
    op <- new_operation(name = "SetIdentityFeedbackForwardingEnabled", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{set_identity_headers_in_notifications_enabled(
#'   Enabled = TRUE,
#'   Identity = "user@example.com",
...
{
    op <- new_operation(name = "SetIdentityHeadersInNotificationsEnabled", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{set_identity_mail_from_domain(
...
{
    op <- new_operation(name = "SetIdentityMailFromDomain", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{set_identity_notification_topic(
#'   Identity = "user@example.com",
#'   NotificationType = "Bounce",
...
set_identity_notification_topic <- function (Identity, NotificationType, 
    SnsTopic = NULL) 
{
    op <- new_operation(name = "SetIdentityNotificationTopic", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # rule set:
#' \donttest{set_receipt_rule_position(
...
set_receipt_rule_position <- function (RuleSetName, RuleName, 
    After = NULL) 
{
    op <- new_operation(name = "SetReceiptRulePosition", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "TestRenderTemplate", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{update_account_sending_enabled(
#'   Enabled = TRUE
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "UpdateAccountSendingEnabled", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{update_configuration_set_reputation_metrics_enabled(
...
update_configuration_set_reputation_metrics_enabled <- function (ConfigurationSetName, 
    Enabled) 
{
    op <- new_operation(name = "UpdateConfigurationSetReputationMetricsEnabled", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{update_configuration_set_sending_enabled(
#'   ConfigurationSetName = "foo",
#'   Enabled = TRUE
#' )}
#'
...
update_configuration_set_sending_enabled <- function (ConfigurationSetName, 
    Enabled) 
{
    op <- new_operation(name = "UpdateConfigurationSetSendingEnabled", 
        http_method = "POST", http_path = "/", paginator = list())
...
update_configuration_set_tracking_options <- function (ConfigurationSetName, 
    TrackingOptions) 
{
    op <- new_operation(name = "UpdateConfigurationSetTrackingOptions", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateCustomVerificationEmailTemplate", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateReceiptRule", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateTemplate", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "VerifyDomainDkim", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "VerifyDomainIdentity", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "VerifyEmailAddress", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # The following example starts the email address verification process with
#' # Amazon SES:
#' \donttest{verify_email_identity(
#'   EmailAddress = "user@example.com"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "VerifyEmailIdentity", http_method = "POST", 
        http_path = "/", paginator = list())
