...
#'
#' @export
get_media <- function (StreamName = NULL, StreamARN = NULL, StartSelector) 
{
    op <- new_operation(name = "GetMedia", http_method = "POST", 
        http_path = "/getMedia", paginator = list())
    input <- get_media_input(StreamName = StreamName, StreamARN = StreamARN, 
