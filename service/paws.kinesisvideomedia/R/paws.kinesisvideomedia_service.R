service <- function () 
{
    cfg <- client_config("kinesisvideo", list(`*` = "kinesisvideo.{region}.amazonaws.com", 
        `cn-*` = "kinesisvideo.{region}.amazonaws.com.cn"))
    client_info <- ClientInfo(service_name = "kinesisvideo", 
        service_id = "Kinesis Video Media", api_version = "2017-09-30", 
