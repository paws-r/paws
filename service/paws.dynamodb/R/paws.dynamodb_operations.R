...
#' )
#'
#' @param RequestItems &#91;required&#93; A map of one or more table names and, for each table, a map that describes one or more items to retrieve from that table. Each table name can be used only once per `BatchGetItem` request.
#' 
...
#' )
#'
#' @param RequestItems &#91;required&#93; A map of one or more table names and, for each table, a list of operations to be performed (`DeleteRequest` or `PutRequest`). Each element in the map consists of the following:
#' 
...
#'   RestoreDateTime = as.POSIXct("2015-01-01")
#' )
#'
...
{
    op <- Operation(name = "TransactGetItems", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "TransactWriteItems", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' )
#'
#' @param ResourceArn &#91;required&#93; The Amazon DyanamoDB resource the tags will be removed from. This value is an Amazon Resource Name (ARN).
#' @param TagKeys &#91;required&#93; A list of tag keys. Existing tags of the resource whose keys are members of this list will be removed from the Amazon DynamoDB resource.
#'
#' @examples
#'
#' @export
