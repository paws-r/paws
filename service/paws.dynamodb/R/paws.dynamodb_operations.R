...
#'
#' @export
batch_get_item <- function (RequestItems, ReturnConsumedCapacity = NULL) 
{
    op <- Operation(name = "BatchGetItem", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- batch_get_item_input(RequestItems = RequestItems, 
        ReturnConsumedCapacity = ReturnConsumedCapacity)
    output <- batch_get_item_output()
    svc <- service()
...
#'
#' @export
batch_write_item <- function (RequestItems, ReturnConsumedCapacity = NULL, 
    ReturnItemCollectionMetrics = NULL) 
{
    op <- Operation(name = "BatchWriteItem", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- batch_write_item_input(RequestItems = RequestItems, 
        ReturnConsumedCapacity = ReturnConsumedCapacity, ReturnItemCollectionMetrics = ReturnItemCollectionMetrics)
    output <- batch_write_item_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' @param BackupName Specified name for the backup.
#'
#' @examples
#'
#' @export
create_backup <- function (TableName, BackupName) 
{
    op <- Operation(name = "CreateBackup", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_backup_input(TableName = TableName, BackupName = BackupName)
...
#'
#' @param GlobalTableName The global table name.
#' @param ReplicationGroup The regions where the global table needs to be created.
#'
#' @examples
#'
#' @export
create_global_table <- function (GlobalTableName, ReplicationGroup) 
{
    op <- Operation(name = "CreateGlobalTable", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_global_table_input(GlobalTableName = GlobalTableName, 
        ReplicationGroup = ReplicationGroup)
    output <- create_global_table_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
create_table <- function (AttributeDefinitions, TableName, KeySchema, 
    ProvisionedThroughput, LocalSecondaryIndexes = NULL, GlobalSecondaryIndexes = NULL, 
    StreamSpecification = NULL, SSESpecification = NULL) 
{
    ...
    input <- create_table_input(AttributeDefinitions = AttributeDefinitions, 
        TableName = TableName, KeySchema = KeySchema, ProvisionedThroughput = ProvisionedThroughput, 
...
#'
#' @param BackupArn The ARN associated with the backup.
#'
#' @examples
#'
#' @export
delete_backup <- function (BackupArn) 
{
    op <- Operation(name = "DeleteBackup", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- delete_backup_input(BackupArn = BackupArn)
...
#' @param Expected This is a legacy parameter. Use `ConditionExpression` instead. For more information, see [Expected](http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.Expected.html) in the *Amazon DynamoDB Developer Guide*.
#' @param ConditionalOperator This is a legacy parameter. Use `ConditionExpression` instead. For more information, see [ConditionalOperator](http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.ConditionalOperator.html) in the *Amazon DynamoDB Developer Guide*.
...
#'
#' @export
delete_item <- function (TableName, Key, Expected = NULL, ConditionalOperator = NULL, 
    ReturnValues = NULL, ReturnConsumedCapacity = NULL, ReturnItemCollectionMetrics = NULL, 
    ConditionExpression = NULL, ExpressionAttributeNames = NULL, 
    ExpressionAttributeValues = NULL) 
{
    op <- Operation(name = "DeleteItem", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- delete_item_input(TableName = TableName, Key = Key, 
        Expected = Expected, ConditionalOperator = ConditionalOperator, 
        ReturnValues = ReturnValues, ReturnConsumedCapacity = ReturnConsumedCapacity, 
        ReturnItemCollectionMetrics = ReturnItemCollectionMetrics, 
        ConditionExpression = ConditionExpression, ExpressionAttributeNames = ExpressionAttributeNames, 
        ExpressionAttributeValues = ExpressionAttributeValues)
    output <- delete_item_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
delete_table <- function (TableName) 
{
    op <- Operation(name = "DeleteTable", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- delete_table_input(TableName = TableName)
...
#'
#' @export
describe_backup <- function (BackupArn) 
{
    op <- Operation(name = "DescribeBackup", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_backup_input(BackupArn = BackupArn)
    output <- describe_backup_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param TableName Name of the table for which the customer wants to check the continuous backups and point in time recovery settings.
#'
#' @examples
#'
#' @export
describe_continuous_backups <- function (TableName) 
{
    op <- Operation(name = "DescribeContinuousBackups", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_continuous_backups_input(TableName = TableName)
    output <- describe_continuous_backups_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
describe_endpoints <- function () 
{
    op <- Operation(name = "DescribeEndpoints", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_endpoints_input()
...
#' Returns information about the specified global table.
#'
#' @param GlobalTableName The name of the global table.
#'
#' @examples
#'
#' @export
describe_global_table <- function (GlobalTableName) 
{
    op <- Operation(name = "DescribeGlobalTable", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_global_table_input(GlobalTableName = GlobalTableName)
    output <- describe_global_table_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' Describes region specific settings for a global table.
#'
#' @param GlobalTableName The name of the global table to describe.
#'
#' @examples
#'
#' @export
describe_global_table_settings <- function (GlobalTableName) 
{
    op <- Operation(name = "DescribeGlobalTableSettings", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_global_table_settings_input(GlobalTableName = GlobalTableName)
    output <- describe_global_table_settings_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
describe_limits <- function () 
{
    op <- Operation(name = "DescribeLimits", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_limits_input()
    output <- describe_limits_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
{
    op <- Operation(name = "DescribeTable", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_table_input(TableName = TableName)
    output <- describe_table_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
describe_time_to_live <- function (TableName) 
{
    op <- Operation(name = "DescribeTimeToLive", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- describe_time_to_live_input(TableName = TableName)
    output <- describe_time_to_live_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' 
#' For the primary key, you must provide all of the attributes. For example, with a simple primary key, you only need to provide a value for the partition key. For a composite primary key, you must provide values for both the partition key and the sort key.
#' @param AttributesToGet This is a legacy parameter. Use `ProjectionExpression` instead. For more information, see [AttributesToGet](http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.AttributesToGet.html) in the *Amazon DynamoDB Developer Guide*.
...
#'
#' @export
get_item <- function (TableName, Key, AttributesToGet = NULL, 
    ConsistentRead = NULL, ReturnConsumedCapacity = NULL, ProjectionExpression = NULL, 
    ExpressionAttributeNames = NULL) 
{
    op <- Operation(name = "GetItem", http_method = "POST", http_path = "/", 
        paginator = list())
    input <- get_item_input(TableName = TableName, Key = Key, 
        AttributesToGet = AttributesToGet, ConsistentRead = ConsistentRead, 
        ReturnConsumedCapacity = ReturnConsumedCapacity, ProjectionExpression = ProjectionExpression, 
        ExpressionAttributeNames = ExpressionAttributeNames)
    output <- get_item_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_backups <- function (TableName = NULL, Limit = NULL, TimeRangeLowerBound = NULL, 
    TimeRangeUpperBound = NULL, ExclusiveStartBackupArn = NULL, 
    BackupType = NULL) 
{
    op <- Operation(name = "ListBackups", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_backups_input(TableName = TableName, Limit = Limit, 
        TimeRangeLowerBound = TimeRangeLowerBound, TimeRangeUpperBound = TimeRangeUpperBound, 
        ExclusiveStartBackupArn = ExclusiveStartBackupArn, BackupType = BackupType)
    output <- list_backups_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_global_tables <- function (ExclusiveStartGlobalTableName = NULL, 
    Limit = NULL, RegionName = NULL) 
{
    op <- Operation(name = "ListGlobalTables", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_global_tables_input(ExclusiveStartGlobalTableName = ExclusiveStartGlobalTableName, 
        Limit = Limit, RegionName = RegionName)
    output <- list_global_tables_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_tables <- function (ExclusiveStartTableName = NULL, Limit = NULL) 
{
    op <- Operation(name = "ListTables", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_tables_input(ExclusiveStartTableName = ExclusiveStartTableName, 
        Limit = Limit)
...
#'
#' @export
list_tags_of_resource <- function (ResourceArn, NextToken = NULL) 
{
    op <- Operation(name = "ListTagsOfResource", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- list_tags_of_resource_input(ResourceArn = ResourceArn, 
        NextToken = NextToken)
    output <- list_tags_of_resource_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
put_item <- function (TableName, Item, Expected = NULL, ReturnValues = NULL, 
    ReturnConsumedCapacity = NULL, ReturnItemCollectionMetrics = NULL, 
    ConditionalOperator = NULL, ConditionExpression = NULL, ExpressionAttributeNames = NULL, 
    ExpressionAttributeValues = NULL) 
{
    op <- Operation(name = "PutItem", http_method = "POST", http_path = "/", 
        paginator = list())
    input <- put_item_input(TableName = TableName, Item = Item, 
        Expected = Expected, ReturnValues = ReturnValues, ReturnConsumedCapacity = ReturnConsumedCapacity, 
        ReturnItemCollectionMetrics = ReturnItemCollectionMetrics, 
        ConditionalOperator = ConditionalOperator, ConditionExpression = ConditionExpression, 
        ExpressionAttributeNames = ExpressionAttributeNames, 
        ExpressionAttributeValues = ExpressionAttributeValues)
    output <- put_item_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' @param KeyConditions This is a legacy parameter. Use `KeyConditionExpression` instead. For more information, see [KeyConditions](http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.KeyConditions.html) in the *Amazon DynamoDB Developer Guide*.
#' @param QueryFilter This is a legacy parameter. Use `FilterExpression` instead. For more information, see [QueryFilter](http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.QueryFilter.html) in the *Amazon DynamoDB Developer Guide*.
#' @param ConditionalOperator This is a legacy parameter. Use `FilterExpression` instead. For more information, see [ConditionalOperator](http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.ConditionalOperator.html) in the *Amazon DynamoDB Developer Guide*.
...
#'
#' @export
query <- function (TableName, IndexName = NULL, Select = NULL, 
    AttributesToGet = NULL, Limit = NULL, ConsistentRead = NULL, 
    KeyConditions = NULL, QueryFilter = NULL, ConditionalOperator = NULL, 
    ScanIndexForward = NULL, ExclusiveStartKey = NULL, ReturnConsumedCapacity = NULL, 
    ProjectionExpression = NULL, FilterExpression = NULL, KeyConditionExpression = NULL, 
    ExpressionAttributeNames = NULL, ExpressionAttributeValues = NULL) 
{
    op <- Operation(name = "Query", http_method = "POST", http_path = "/", 
        paginator = list())
    input <- query_input(TableName = TableName, IndexName = IndexName, 
        Select = Select, AttributesToGet = AttributesToGet, Limit = Limit, 
        ConsistentRead = ConsistentRead, KeyConditions = KeyConditions, 
...
#'
#' @param TargetTableName The name of the new table to which the backup must be restored.
#' @param BackupArn The ARN associated with the backup.
#'
#' @examples
#'
#' @export
restore_table_from_backup <- function (TargetTableName, BackupArn) 
{
    op <- Operation(name = "RestoreTableFromBackup", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- restore_table_from_backup_input(TargetTableName = TargetTableName, 
        BackupArn = BackupArn)
    output <- restore_table_from_backup_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' @param TargetTableName The name of the new table to which it must be restored to.
...
#'
#' @export
restore_table_to_point_in_time <- function (SourceTableName, 
    TargetTableName, UseLatestRestorableTime = NULL, RestoreDateTime = NULL) 
{
    op <- Operation(name = "RestoreTableToPointInTime", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- restore_table_to_point_in_time_input(SourceTableName = SourceTableName, 
        TargetTableName = TargetTableName, UseLatestRestorableTime = UseLatestRestorableTime, 
        RestoreDateTime = RestoreDateTime)
    output <- restore_table_to_point_in_time_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' 
#' If you use the `ProjectionExpression` parameter, then the value for `Select` can only be `SPECIFIC_ATTRIBUTES`. Any other value for `Select` will return an error.
#' @param ScanFilter This is a legacy parameter. Use `FilterExpression` instead. For more information, see [ScanFilter](http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.ScanFilter.html) in the *Amazon DynamoDB Developer Guide*.
#' @param ConditionalOperator This is a legacy parameter. Use `FilterExpression` instead. For more information, see [ConditionalOperator](http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.ConditionalOperator.html) in the *Amazon DynamoDB Developer Guide*.
#' @param ExclusiveStartKey The primary key of the first item that this operation will evaluate. Use the value that was returned for `LastEvaluatedKey` in the previous operation.
#' 
#' The data type for `ExclusiveStartKey` must be String, Number or Binary. No set data types are allowed.
...
#'
#' @export
scan <- function (TableName, IndexName = NULL, AttributesToGet = NULL, 
    Limit = NULL, Select = NULL, ScanFilter = NULL, ConditionalOperator = NULL, 
    ExclusiveStartKey = NULL, ReturnConsumedCapacity = NULL, 
    TotalSegments = NULL, Segment = NULL, ProjectionExpression = NULL, 
    FilterExpression = NULL, ExpressionAttributeNames = NULL, 
    ExpressionAttributeValues = NULL, ConsistentRead = NULL) 
{
    op <- Operation(name = "Scan", http_method = "POST", http_path = "/", 
        paginator = list())
    input <- scan_input(TableName = TableName, IndexName = IndexName, 
        AttributesToGet = AttributesToGet, Limit = Limit, Select = Select, 
        ScanFilter = ScanFilter, ConditionalOperator = ConditionalOperator, 
...
#'
#' @param TableName The name of the table.
#' @param PointInTimeRecoverySpecification Represents the settings used to enable point in time recovery.
#'
#' @examples
#'
#' @export
update_continuous_backups <- function (TableName, PointInTimeRecoverySpecification) 
{
    op <- Operation(name = "UpdateContinuousBackups", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_continuous_backups_input(TableName = TableName, 
        PointInTimeRecoverySpecification = PointInTimeRecoverySpecification)
    output <- update_continuous_backups_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @param GlobalTableName The global table name.
#' @param ReplicaUpdates A list of regions that should be added or removed from the global table.
#'
#' @examples
#'
#' @export
update_global_table <- function (GlobalTableName, ReplicaUpdates) 
{
    op <- Operation(name = "UpdateGlobalTable", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_global_table_input(GlobalTableName = GlobalTableName, 
        ReplicaUpdates = ReplicaUpdates)
    output <- update_global_table_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
{
    op <- Operation(name = "UpdateGlobalTableSettings", http_method = "POST", 
        http_path = "/", paginator = list())
    ...
    output <- update_global_table_settings_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' 
#' For the primary key, you must provide all of the attributes. For example, with a simple primary key, you only need to provide a value for the partition key. For a composite primary key, you must provide values for both the partition key and the sort key.
#' @param AttributeUpdates This is a legacy parameter. Use `UpdateExpression` instead. For more information, see [AttributeUpdates](http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.AttributeUpdates.html) in the *Amazon DynamoDB Developer Guide*.
#' @param Expected This is a legacy parameter. Use `ConditionExpression` instead. For more information, see [Expected](http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.Expected.html) in the *Amazon DynamoDB Developer Guide*.
#' @param ConditionalOperator This is a legacy parameter. Use `ConditionExpression` instead. For more information, see [ConditionalOperator](http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.ConditionalOperator.html) in the *Amazon DynamoDB Developer Guide*.
...
#'
#' @export
update_item <- function (TableName, Key, AttributeUpdates = NULL, 
    Expected = NULL, ConditionalOperator = NULL, ReturnValues = NULL, 
    ReturnConsumedCapacity = NULL, ReturnItemCollectionMetrics = NULL, 
    UpdateExpression = NULL, ConditionExpression = NULL, ExpressionAttributeNames = NULL, 
    ExpressionAttributeValues = NULL) 
{
    op <- Operation(name = "UpdateItem", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_item_input(TableName = TableName, Key = Key, 
...
#'
#' @export
update_table <- function (TableName, AttributeDefinitions = NULL, 
    ProvisionedThroughput = NULL, GlobalSecondaryIndexUpdates = NULL, 
    StreamSpecification = NULL, SSESpecification = NULL) 
{
    op <- Operation(name = "UpdateTable", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_table_input(TableName = TableName, AttributeDefinitions = AttributeDefinitions, 
        ProvisionedThroughput = ProvisionedThroughput, GlobalSecondaryIndexUpdates = GlobalSecondaryIndexUpdates, 
        StreamSpecification = StreamSpecification, SSESpecification = SSESpecification)
...
#'
#' @param TableName The name of the table to be configured.
#' @param TimeToLiveSpecification Represents the settings used to enable or disable Time to Live for the specified table.
#'
#' @examples
#'
#' @export
update_time_to_live <- function (TableName, TimeToLiveSpecification) 
{
    op <- Operation(name = "UpdateTimeToLive", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- update_time_to_live_input(TableName = TableName, 
        TimeToLiveSpecification = TimeToLiveSpecification)
    output <- update_time_to_live_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
