...
#' @param Tags &#91;required&#93; A list of cost allocation tags to be added to this resource. A tag is a key-value pair. A tag key must be accompanied by a tag value.
#'
#' @export
...
#' @param EC2SecurityGroupOwnerId &#91;required&#93; The AWS account number of the Amazon EC2 security group owner. Note that this is not the same thing as an AWS access key ID - you must provide a valid AWS account number for this parameter.
#'
#' @export
authorize_cache_security_group_ingress <- function (CacheSecurityGroupName, 
    EC2SecurityGroupName, EC2SecurityGroupOwnerId) 
{
    op <- new_operation(name = "AuthorizeCacheSecurityGroupIngress", 
...
#' @param TargetSnapshotName &#91;required&#93; A name for the snapshot copy. ElastiCache does not permit overwriting a snapshot, therefore this name must be unique within its context - ElastiCache or an Amazon S3 bucket if exporting.
...
{
    op <- new_operation(name = "CreateCacheCluster", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateCacheParameterGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
create_cache_security_group <- function (CacheSecurityGroupName, 
    Description) 
{
    op <- new_operation(name = "CreateCacheSecurityGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateCacheSubnetGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateReplicationGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
create_snapshot <- function (ReplicationGroupId = NULL, CacheClusterId = NULL, 
    SnapshotName) 
{
    op <- new_operation(name = "CreateSnapshot", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_snapshot_input(ReplicationGroupId = ReplicationGroupId, 
...
#' @param ApplyImmediately &#91;required&#93; If `True`, the number of replica nodes is decreased immediately. If `False`, the number of replica nodes is decreased during the next maintenance window.
#'
#' @export
decrease_replica_count <- function (ReplicationGroupId, NewReplicaCount = NULL, 
    ReplicaConfiguration = NULL, ReplicasToRemove = NULL, ApplyImmediately) 
{
    op <- new_operation(name = "DecreaseReplicaCount", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- decrease_replica_count_input(ReplicationGroupId = ReplicationGroupId, 
        NewReplicaCount = NewReplicaCount, ReplicaConfiguration = ReplicaConfiguration, 
        ReplicasToRemove = ReplicasToRemove, ApplyImmediately = ApplyImmediately)
...
{
    op <- new_operation(name = "DeleteCacheCluster", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteCacheParameterGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteCacheSecurityGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteCacheSubnetGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteReplicationGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeCacheClusters", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_cache_engine_versions <- function (Engine = NULL, EngineVersion = NULL, 
    ...
    DefaultOnly = NULL) 
{
    op <- new_operation(name = "DescribeCacheEngineVersions", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeCacheParameterGroups", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeCacheParameters", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_cache_security_groups <- function (CacheSecurityGroupName = NULL, 
    MaxRecords = NULL, Marker = NULL) 
{
    op <- new_operation(name = "DescribeCacheSecurityGroups", 
        http_method = "POST", http_path = "/", paginator = list())
...
describe_cache_subnet_groups <- function (CacheSubnetGroupName = NULL, 
    MaxRecords = NULL, Marker = NULL) 
{
    op <- new_operation(name = "DescribeCacheSubnetGroups", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_replication_groups <- function (ReplicationGroupId = NULL, 
    MaxRecords = NULL, Marker = NULL) 
{
    op <- new_operation(name = "DescribeReplicationGroups", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_reserved_cache_nodes <- function (ReservedCacheNodeId = NULL, 
    ...
    MaxRecords = NULL, Marker = NULL) 
{
    op <- new_operation(name = "DescribeReservedCacheNodes", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeReservedCacheNodesOfferings", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' @param NewReplicaCount The number of read replica nodes you want at the completion of this operation. For Redis (cluster mode disabled) replication groups, this is the number of replica nodes in the replication group. For Redis (cluster mode enabled) replication groups, this is the number of replica nodes in each of the replication group\'s node groups.
#' @param ReplicaConfiguration A list of `ConfigureShard` objects that can be used to configure each shard in a Redis (cluster mode enabled) replication group. The `ConfigureShard` has three members: `NewReplicaCount`, `NodeGroupId`, and `PreferredAvailabilityZones`.
#' @param ApplyImmediately &#91;required&#93; If `True`, the number of replica nodes is increased immediately. If `False`, the number of replica nodes is increased during the next maintenance window.
#'
#' @export
increase_replica_count <- function (ReplicationGroupId, NewReplicaCount = NULL, 
    ReplicaConfiguration = NULL, ApplyImmediately) 
{
    op <- new_operation(name = "IncreaseReplicaCount", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListAllowedNodeTypeModifications", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyCacheCluster", http_method = "POST", 
        http_path = "/", paginator = list())
...
modify_cache_parameter_group <- function (CacheParameterGroupName, 
    ParameterNameValues) 
{
    op <- new_operation(name = "ModifyCacheParameterGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ModifyCacheSubnetGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
modify_replication_group <- function (ReplicationGroupId, ReplicationGroupDescription = NULL, 
    ...
    NodeGroupId = NULL) 
{
    op <- new_operation(name = "ModifyReplicationGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param ReplicationGroupId &#91;required&#93; The name of the Redis (cluster mode enabled) cluster (replication group) on which the shards are to be configured.
...
{
    op <- new_operation(name = "ModifyReplicationGroupShardConfiguration", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PurchaseReservedCacheNodesOffering", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RebootCacheCluster", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ResetCacheParameterGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
revoke_cache_security_group_ingress <- function (CacheSecurityGroupName, 
    EC2SecurityGroupName, EC2SecurityGroupOwnerId) 
{
    op <- new_operation(name = "RevokeCacheSecurityGroupIngress", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' @param NodeGroupId &#91;required&#93; The name of the node group (called shard in the console) in this replication group on which automatic failover is to be tested. You may test automatic failover on up to 5 node groups in any rolling 24-hour period.
#'
#' @export
test_failover <- function (ReplicationGroupId, NodeGroupId) 
{
    op <- new_operation(name = "TestFailover", http_method = "POST", 
        http_path = "/", paginator = list())
