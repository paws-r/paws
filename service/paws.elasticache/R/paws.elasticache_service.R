service <- function () 
{
    cfg <- client_config("elasticache", list(`*` = "elasticache.{region}.amazonaws.com", 
        `cn-*` = "elasticache.{region}.amazonaws.com.cn"))
    client_info <- ClientInfo(service_name = "elasticache", service_id = "ElastiCache", 
        api_version = "2015-02-02", signing_name = cfg$signing_name, 
