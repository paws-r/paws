service <- function () 
{
    cfg <- client_config("data.iot", list(`*` = "data.iot.{region}.amazonaws.com", 
        `cn-*` = "data.iot.{region}.amazonaws.com.cn"))
    client_info <- ClientInfo(service_name = "data.iot", service_id = "IoT Data Plane", 
        api_version = "2015-05-28", signing_name = "iotdata", 
