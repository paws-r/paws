...
{
    op <- Operation(name = "DescribeStackDriftDetectionStatus", 
...
{
    op <- Operation(name = "DescribeStackResourceDrifts", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DetectStackDrift", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DetectStackResourceDrift", http_method = "POST", 
        http_path = "/", paginator = list())
