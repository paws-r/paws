...
#' ```
#'
#' @param DeliveryStreamName &#91;required&#93; The name of the delivery stream. This name must be unique per AWS account in the same AWS Region. If the delivery streams are in different accounts or different Regions, you can have multiple delivery streams with the same name.
...
{
    op <- new_operation(name = "DeleteDeliveryStream", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeDeliveryStream", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListDeliveryStreams", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListTagsForDeliveryStream", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PutRecord", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PutRecordBatch", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "TagDeliveryStream", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UntagDeliveryStream", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateDestination", http_method = "POST", 
        http_path = "/", paginator = list())
