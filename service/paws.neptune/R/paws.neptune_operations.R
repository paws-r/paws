...
{
    op <- new_operation(name = "AddRoleToDBCluster", http_method = "POST", 
...
add_source_identifier_to_subscription <- function (SubscriptionName, 
    SourceIdentifier) 
{
    op <- new_operation(name = "AddSourceIdentifierToSubscription", 
...
#' ```
#'
#' @param ResourceName &#91;required&#93; The Amazon Neptune resource that the tags are added to. This value is an Amazon Resource Name (ARN). For information about creating an ARN, see [Constructing an Amazon Resource Name (ARN)](http://docs.aws.amazon.com/neptune/latest/UserGuide/tagging.ARN.html#tagging.ARN.Constructing).
...
#' ```
#'
#' @param ResourceIdentifier &#91;required&#93; The Amazon Resource Name (ARN) of the resource that the pending maintenance action applies to. For information about creating an ARN, see [Constructing an Amazon Resource Name (ARN)](http://docs.aws.amazon.com/neptune/latest/UserGuide/tagging.ARN.html#tagging.ARN.Constructing).
...
#' ```
#'
#' @param SourceDBParameterGroupIdentifier &#91;required&#93; The identifier or ARN for the source DB parameter group. For information about creating an ARN, see [Constructing an Amazon Resource Name (ARN)](http://docs.aws.amazon.com/neptune/latest/UserGuide/tagging.ARN.html#tagging.ARN.Constructing).
#' 
#' Constraints:
#' 
...
copy_db_parameter_group <- function (SourceDBParameterGroupIdentifier, 
    ...
    Tags = NULL) 
{
    op <- new_operation(name = "CopyDBParameterGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
create_db_cluster <- function (AvailabilityZones = NULL, BackupRetentionPeriod = NULL, 
    CharacterSetName = NULL, DatabaseName = NULL, DBClusterIdentifier, 
    DBClusterParameterGroupName = NULL, VpcSecurityGroupIds = NULL, 
    DBSubnetGroupName = NULL, Engine, EngineVersion = NULL, Port = NULL, 
    ...
    KmsKeyId = NULL, PreSignedUrl = NULL, EnableIAMDatabaseAuthentication = NULL) 
{
    ...
    input <- create_db_cluster_input(AvailabilityZones = AvailabilityZones, 
        ...
        DatabaseName = DatabaseName, DBClusterIdentifier = DBClusterIdentifier, 
...
#' @param DBInstanceClass &#91;required&#93; The compute and memory capacity of the DB instance, for example, `db.m4.large`. Not all DB instance classes are available in all AWS Regions.
...
#'
#' @export
create_db_instance <- function (DBName = NULL, DBInstanceIdentifier, 
    AllocatedStorage = NULL, DBInstanceClass, Engine, MasterUsername = NULL, 
    ...
    PerformanceInsightsKMSKeyId = NULL, EnableCloudwatchLogsExports = NULL) 
{
    op <- new_operation(name = "CreateDBInstance", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_db_instance_input(DBName = DBName, DBInstanceIdentifier = DBInstanceIdentifier, 
        AllocatedStorage = AllocatedStorage, DBInstanceClass = DBInstanceClass, 
        Engine = Engine, MasterUsername = MasterUsername, MasterUserPassword = MasterUserPassword, 
        DBSecurityGroups = DBSecurityGroups, VpcSecurityGroupIds = VpcSecurityGroupIds, 
        AvailabilityZone = AvailabilityZone, DBSubnetGroupName = DBSubnetGroupName, 
        PreferredMaintenanceWindow = PreferredMaintenanceWindow, 
...
create_db_parameter_group <- function (DBParameterGroupName, 
    DBParameterGroupFamily, Description, Tags = NULL) 
{
    op <- new_operation(name = "CreateDBParameterGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteDBParameterGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_db_parameter_groups <- function (DBParameterGroupName = NULL, 
    Filters = NULL, MaxRecords = NULL, Marker = NULL) 
{
    op <- new_operation(name = "DescribeDBParameterGroups", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_db_parameters <- function (DBParameterGroupName, Source = NULL, 
    Filters = NULL, MaxRecords = NULL, Marker = NULL) 
{
    op <- new_operation(name = "DescribeDBParameters", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_engine_default_parameters <- function (DBParameterGroupFamily, 
    Filters = NULL, MaxRecords = NULL, Marker = NULL) 
{
    op <- new_operation(name = "DescribeEngineDefaultParameters", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeValidDBInstanceModifications", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' ```
#'
#' @param ResourceName &#91;required&#93; The Amazon Neptune resource with tags to be listed. This value is an Amazon Resource Name (ARN). For information about creating an ARN, see [Constructing an Amazon Resource Name (ARN)](http://docs.aws.amazon.com/neptune/latest/UserGuide/tagging.ARN.html#tagging.ARN.Constructing).
#' @param Filters This parameter is not currently supported.
#'
#' @export
...
modify_db_parameter_group <- function (DBParameterGroupName, 
    Parameters) 
{
    op <- new_operation(name = "ModifyDBParameterGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' ```
#'
#' @param DBClusterIdentifier &#91;required&#93; The identifier of the DB cluster Read Replica to promote. This parameter is not case-sensitive.
#' 
#' Constraints:
#' 
...
{
    op <- new_operation(name = "PromoteReadReplicaDBCluster", 
        http_method = "POST", http_path = "/", paginator = list())
...
remove_role_from_db_cluster <- function (DBClusterIdentifier, 
    RoleArn) 
{
    op <- new_operation(name = "RemoveRoleFromDBCluster", http_method = "POST", 
        http_path = "/", paginator = list())
...
remove_source_identifier_from_subscription <- function (SubscriptionName, 
    SourceIdentifier) 
{
    op <- new_operation(name = "RemoveSourceIdentifierFromSubscription", 
        http_method = "POST", http_path = "/", paginator = list())
...
reset_db_parameter_group <- function (DBParameterGroupName, ResetAllParameters = NULL, 
    Parameters = NULL) 
{
    op <- new_operation(name = "ResetDBParameterGroup", http_method = "POST", 
        http_path = "/", paginator = list())
    ...
    KmsKeyId = NULL, EnableIAMDatabaseAuthentication = NULL) 
{
    ...
    input <- restore_db_cluster_from_snapshot_input(AvailabilityZones = AvailabilityZones, 
        ...
        Engine = Engine, EngineVersion = EngineVersion, Port = Port, 
        DBSubnetGroupName = DBSubnetGroupName, DatabaseName = DatabaseName, 
...
restore_db_cluster_to_point_in_time <- function (DBClusterIdentifier, 
    RestoreType = NULL, SourceDBClusterIdentifier, RestoreToTime = NULL, 
    ...
    KmsKeyId = NULL, EnableIAMDatabaseAuthentication = NULL) 
{
    ...
    input <- restore_db_cluster_to_point_in_time_input(DBClusterIdentifier = DBClusterIdentifier, 
        RestoreType = RestoreType, SourceDBClusterIdentifier = SourceDBClusterIdentifier, 
        RestoreToTime = RestoreToTime, UseLatestRestorableTime = UseLatestRestorableTime, 
        Port = Port, DBSubnetGroupName = DBSubnetGroupName, OptionGroupName = OptionGroupName, 
