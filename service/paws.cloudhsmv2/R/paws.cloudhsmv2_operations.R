...
{
    op <- Operation(name = "CopyBackupToRegion", http_method = "POST", 
...
{
    op <- Operation(name = "DeleteBackup", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeBackups", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "InitializeCluster", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "RestoreBackup", http_method = "POST", 
        http_path = "/", paginator = list())
