...
{
    op <- Operation(name = "AbortEnvironmentUpdate", http_method = "POST", 
...
#'
#' @export
apply_environment_managed_action <- function (ActionId, EnvironmentName = NULL, 
    EnvironmentId = NULL) 
{
    op <- Operation(name = "ApplyEnvironmentManagedAction", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- apply_environment_managed_action_input(ActionId = ActionId, 
        EnvironmentName = EnvironmentName, EnvironmentId = EnvironmentId)
...
{
    op <- Operation(name = "CheckDNSAvailability", http_method = "POST", 
        http_path = "/", paginator = list())
...
compose_environments <- function (ApplicationName = NULL, GroupName = NULL, 
    VersionLabels = NULL) 
{
    op <- Operation(name = "ComposeEnvironments", http_method = "POST", 
        http_path = "/", paginator = list())
...
create_application_version <- function (ApplicationName, VersionLabel, 
    ...
    Process = NULL) 
{
    op <- Operation(name = "CreateApplicationVersion", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "CreateConfigurationTemplate", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "CreateEnvironment", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "CreatePlatformVersion", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "CreateStorageLocation", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteApplicationVersion", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteConfigurationTemplate", http_method = "POST", 
        http_path = "/", paginator = list())
...
delete_environment_configuration <- function (ApplicationName, 
    EnvironmentName) 
{
    op <- Operation(name = "DeleteEnvironmentConfiguration", 
...
{
    op <- Operation(name = "DeletePlatformVersion", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeApplicationVersions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeApplications", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeConfigurationOptions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeConfigurationSettings", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeEnvironmentHealth", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeEnvironmentManagedActionHistory", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeEnvironmentManagedActions", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeEnvironmentResources", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeInstancesHealth", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribePlatformVersion", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListAvailableSolutionStacks", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_platform_versions <- function (Filters = NULL, MaxRecords = NULL, 
    NextToken = NULL) 
{
    op <- Operation(name = "ListPlatformVersions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "RebuildEnvironment", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
request_environment_info <- function (InfoType, EnvironmentId = NULL, 
    EnvironmentName = NULL) 
{
    op <- Operation(name = "RequestEnvironmentInfo", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- request_environment_info_input(InfoType = InfoType, 
        EnvironmentId = EnvironmentId, EnvironmentName = EnvironmentName)
...
{
    op <- Operation(name = "RestartAppServer", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @export
retrieve_environment_info <- function (InfoType, EnvironmentId = NULL, 
    EnvironmentName = NULL) 
{
    op <- Operation(name = "RetrieveEnvironmentInfo", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- retrieve_environment_info_input(InfoType = InfoType, 
        EnvironmentId = EnvironmentId, EnvironmentName = EnvironmentName)
...
{
    op <- Operation(name = "SwapEnvironmentCNAMEs", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "TerminateEnvironment", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateApplicationResourceLifecycle", 
        http_method = "POST", http_path = "/", paginator = list())
...
update_application_version <- function (ApplicationName, VersionLabel, 
    Description = NULL) 
{
    op <- Operation(name = "UpdateApplicationVersion", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateConfigurationTemplate", http_method = "POST", 
        http_path = "/", paginator = list())
...
update_tags_for_resource <- function (ResourceArn, TagsToAdd = NULL, 
    TagsToRemove = NULL) 
{
    op <- Operation(name = "UpdateTagsForResource", http_method = "POST", 
        http_path = "/", paginator = list())
...
validate_configuration_settings <- function (ApplicationName, 
    OptionSettings, TemplateName = NULL, EnvironmentName = NULL) 
{
    op <- Operation(name = "ValidateConfigurationSettings", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- validate_configuration_settings_input(ApplicationName = ApplicationName, 
        OptionSettings = OptionSettings, TemplateName = TemplateName, 
        EnvironmentName = EnvironmentName)
