service <- function () 
{
    cfg <- client_config("elasticbeanstalk", list(`*` = "elasticbeanstalk.{region}.amazonaws.com", 
        `cn-*` = "elasticbeanstalk.{region}.amazonaws.com.cn"))
    client_info <- ClientInfo(service_name = "elasticbeanstalk", 
        service_id = "Elastic Beanstalk", api_version = "2010-12-01", 
