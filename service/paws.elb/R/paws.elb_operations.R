...
#' # balancer in a VPC.
#' \donttest{apply_security_groups_to_load_balancer(
...
apply_security_groups_to_load_balancer <- function (LoadBalancerName, 
    SecurityGroups) 
{
    op <- new_operation(name = "ApplySecurityGroupsToLoadBalancer", 
...
#' \donttest{attach_load_balancer_to_subnets(
#'   LoadBalancerName = "my-load-balancer",
#'   Subnets = list(
#'     "subnet-0ecac448"
#'   )
...
attach_load_balancer_to_subnets <- function (LoadBalancerName, 
    Subnets) 
{
    op <- new_operation(name = "AttachLoadBalancerToSubnets", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{configure_health_check(
#'   HealthCheck = list(
#'     HealthyThreshold = 2L,
#'     Interval = 30L,
#'     Target = "HTTP:80/png",
...
{
    op <- new_operation(name = "ConfigureHealthCheck", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{create_app_cookie_stickiness_policy(
...
{
    op <- new_operation(name = "CreateAppCookieStickinessPolicy", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{create_lb_cookie_stickiness_policy(
...
{
    op <- new_operation(name = "CreateLBCookieStickinessPolicy", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # the HTTP protocol.
#' \donttest{create_load_balancer_listeners(
#'   Listeners = list(
#'     list(
#'       InstancePort = 80L,
#'       InstanceProtocol = "HTTP",
...
create_load_balancer_listeners <- function (LoadBalancerName, 
    Listeners) 
{
    op <- new_operation(name = "CreateLoadBalancerListeners", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' @param PolicyTypeName &#91;required&#93; The name of the base policy type. To get the list of policy types, use DescribeLoadBalancerPolicyTypes.
#' @param PolicyAttributes The policy attributes.
#'
#' @examples
#' # This example creates a policy that enables Proxy Protocol on the
#' # specified load balancer.
#' \donttest{create_load_balancer_policy(
#'   LoadBalancerName = "my-load-balancer",
#'   PolicyAttributes = list(
#'     list(
...
{
    op <- new_operation(name = "CreateLoadBalancerPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # specified load balancer.
#' \donttest{delete_load_balancer_listeners(
#'   LoadBalancerName = "my-load-balancer",
#'   LoadBalancerPorts = list(
#'     80L
#'   )
...
delete_load_balancer_listeners <- function (LoadBalancerName, 
    LoadBalancerPorts) 
{
    op <- new_operation(name = "DeleteLoadBalancerListeners", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{delete_load_balancer_policy(
#'   LoadBalancerName = "my-load-balancer",
#'   PolicyName = "my-duration-cookie-policy"
#' )}
#'
...
{
    op <- new_operation(name = "DeleteLoadBalancerPolicy", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # balancer.
#' \donttest{deregister_instances_from_load_balancer(
#'   Instances = list(
#'     list(
...
deregister_instances_from_load_balancer <- function (LoadBalancerName, 
    Instances) 
{
    op <- new_operation(name = "DeregisterInstancesFromLoadBalancer", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # load balancer.
#' \donttest{describe_instance_health(
#'   LoadBalancerName = "my-load-balancer"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "DescribeInstanceHealth", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # specified load balancer.
#' \donttest{describe_load_balancer_policies(
#'   LoadBalancerName = "my-load-balancer",
#'   PolicyNames = list(
...
describe_load_balancer_policies <- function (LoadBalancerName = NULL, 
    PolicyNames = NULL) 
{
    op <- new_operation(name = "DescribeLoadBalancerPolicies", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{describe_load_balancer_policy_types(
#'   PolicyTypeNames = list(
...
{
    op <- new_operation(name = "DescribeLoadBalancerPolicyTypes", 
        http_method = "POST", http_path = "/", paginator = list())
...
detach_load_balancer_from_subnets <- function (LoadBalancerName, 
    Subnets) 
{
    op <- new_operation(name = "DetachLoadBalancerFromSubnets", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{disable_availability_zones_for_load_balancer(
#'   AvailabilityZones = list(
#'     "us-west-2a"
#'   ),
#'   LoadBalancerName = "my-load-balancer"
...
disable_availability_zones_for_load_balancer <- function (LoadBalancerName, 
    AvailabilityZones) 
{
    op <- new_operation(name = "DisableAvailabilityZonesForLoadBalancer", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # balancer.
#' \donttest{enable_availability_zones_for_load_balancer(
#'   AvailabilityZones = list(
#'     "us-west-2b"
#'   ),
#'   LoadBalancerName = "my-load-balancer"
...
enable_availability_zones_for_load_balancer <- function (LoadBalancerName, 
    AvailabilityZones) 
{
    op <- new_operation(name = "EnableAvailabilityZonesForLoadBalancer", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # balancer.
#' \donttest{register_instances_with_load_balancer(
#'   Instances = list(
#'     list(
#'       InstanceId = "i-d6f6fae3"
#'     )
...
register_instances_with_load_balancer <- function (LoadBalancerName, 
    Instances) 
{
    op <- new_operation(name = "RegisterInstancesWithLoadBalancer", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # HTTPS listener.
#' \donttest{set_load_balancer_listener_ssl_certificate(
#'   LoadBalancerName = "my-load-balancer",
#'   LoadBalancerPort = 443L,
...
{
    op <- new_operation(name = "SetLoadBalancerListenerSSLCertificate", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # the specified port.
#' \donttest{set_load_balancer_policies_for_backend_server(
#'   InstancePort = 80L,
#'   LoadBalancerName = "my-load-balancer",
#'   PolicyNames = list(
...
{
    op <- new_operation(name = "SetLoadBalancerPoliciesForBackendServer", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{set_load_balancer_policies_of_listener(
#'   LoadBalancerName = "my-load-balancer",
#'   LoadBalancerPort = 80L,
#'   PolicyNames = list(
...
{
    op <- new_operation(name = "SetLoadBalancerPoliciesOfListener", 
        http_method = "POST", http_path = "/", paginator = list())
