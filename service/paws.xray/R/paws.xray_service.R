service <- function () 
{
    cfg <- client_config("xray", list(`*` = "xray.{region}.amazonaws.com", 
        `cn-*` = "xray.{region}.amazonaws.com.cn"))
    client_info <- ClientInfo(service_name = "xray", service_id = "XRay", 
        api_version = "2016-04-12", signing_name = cfg$signing_name, 
