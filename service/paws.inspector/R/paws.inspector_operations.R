...
#' \donttest{add_attributes_to_findings(
#'   attributes = list(
#'     list(
#'       key = "Example",
#'       value = "example"
...
{
    op <- new_operation(name = "AddAttributesToFindings", http_method = "POST", 
...
#' # account.
#' \donttest{create_assessment_target(
...
{
    op <- new_operation(name = "CreateAssessmentTarget", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{create_assessment_template(
...
{
    op <- new_operation(name = "CreateAssessmentTemplate", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateExclusionsPreview", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{create_resource_group(
#'   resourceGroupTags = list(
#'     list(
#'       key = "Name",
#'       value = "example"
...
{
    op <- new_operation(name = "CreateResourceGroup", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # assessment run.
#' \donttest{delete_assessment_run(
...
{
    op <- new_operation(name = "DeleteAssessmentRun", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteAssessmentTarget", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # assessment template.
#' \donttest{delete_assessment_template(
...
{
    op <- new_operation(name = "DeleteAssessmentTemplate", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # assessment runs.
#' \donttest{describe_assessment_runs(
#'   assessmentRunArns = list(
...
{
    op <- new_operation(name = "DescribeAssessmentRuns", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeAssessmentTargets", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{describe_assessment_templates(
#'   assessmentTemplateArns = list(
...
{
    op <- new_operation(name = "DescribeAssessmentTemplates", 
...
#' # account.
#' \donttest{describe_cross_account_access_role()}
#'
#' @export
describe_cross_account_access_role <- function () 
{
    op <- new_operation(name = "DescribeCrossAccountAccessRole", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeExclusions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeFindings", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # resource groups.
#' \donttest{describe_resource_groups(
#'   resourceGroupArns = list(
...
{
    op <- new_operation(name = "DescribeResourceGroups", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # packages.
#' \donttest{describe_rules_packages(
#'   rulesPackageArns = list(
...
{
    op <- new_operation(name = "DescribeRulesPackages", http_method = "POST", 
        http_path = "/", paginator = list())
...
get_assessment_report <- function (assessmentRunArn, reportFileFormat, 
    reportType) 
{
    op <- new_operation(name = "GetAssessmentReport", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetExclusionsPreview", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # assessment run.
#' \donttest{get_telemetry_metadata(
...
{
    op <- new_operation(name = "GetTelemetryMetadata", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{list_assessment_run_agents(
#'   assessmentRunArn = "arn:aws:inspector:us-west-2:123456789012:target/0-0kFIPusq/template/0-4r1V2mAw/run/0-MKkpXXPE",
#'   maxResults = 123L
#' )}
#'
...
{
    op <- new_operation(name = "ListAssessmentRunAgents", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListAssessmentRuns", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @examples
#' # Lists the ARNs of the assessment targets within this AWS account. 
#' \donttest{list_assessment_targets(
#'   maxResults = 123L
#' )}
#'
#' @export
list_assessment_targets <- function (filter = NULL, nextToken = NULL, 
    maxResults = NULL) 
{
    op <- new_operation(name = "ListAssessmentTargets", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{list_assessment_templates(
#'   assessmentTargetArns = list(
#'     "arn:aws:inspector:us-west-2:123456789012:target/0-0kFIPusq"
#'   ),
#'   maxResults = 123L
...
list_assessment_templates <- function (assessmentTargetArns = NULL, 
    filter = NULL, nextToken = NULL, maxResults = NULL) 
{
    op <- new_operation(name = "ListAssessmentTemplates", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{list_event_subscriptions(
#'   maxResults = 123L,
...
list_event_subscriptions <- function (resourceArn = NULL, nextToken = NULL, 
    maxResults = NULL) 
{
    op <- new_operation(name = "ListEventSubscriptions", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_exclusions <- function (assessmentRunArn, nextToken = NULL, 
    maxResults = NULL) 
{
    op <- new_operation(name = "ListExclusions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListRulesPackages", http_method = "POST", 
        http_path = "/", paginator = list())
...
preview_agents <- function (previewAgentsArn, nextToken = NULL, 
    maxResults = NULL) 
{
    op <- new_operation(name = "PreviewAgents", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' \donttest{register_cross_account_access_role(
...
{
    op <- new_operation(name = "RegisterCrossAccountAccessRole", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' \donttest{remove_attributes_from_findings(
#'   attributeKeys = list(
...
{
    op <- new_operation(name = "RemoveAttributesFromFindings", 
        http_method = "POST", http_path = "/", paginator = list())
...
#' # specified by the ARN of the assessment template.
#' \donttest{set_tags_for_resource(
#'   resourceArn = "arn:aws:inspector:us-west-2:123456789012:target/0-nvgVhaxX/template/0-7sbz2Kz0",
#'   tags = list(
#'     list(
#'       key = "Example",
...
{
    op <- new_operation(name = "SetTagsForResource", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StartAssessmentRun", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StopAssessmentRun", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "SubscribeToEvent", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # notifications about a specified event to a specified SNS topic.
#' \donttest{unsubscribe_from_event(
#'   event = "ASSESSMENT_RUN_COMPLETED",
#'   resourceArn = "arn:aws:inspector:us-west-2:123456789012:target/0-nvgVhaxX/template/0-7sbz2Kz0",
#'   topicArn = "arn:aws:sns:us-west-2:123456789012:exampletopic"
#' )}
...
{
    op <- new_operation(name = "UnsubscribeFromEvent", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' # assessment target.
#' \donttest{update_assessment_target(
#'   assessmentTargetArn = "arn:aws:inspector:us-west-2:123456789012:target/0-nvgVhaxX",
...
{
    op <- new_operation(name = "UpdateAssessmentTarget", http_method = "POST", 
        http_path = "/", paginator = list())
