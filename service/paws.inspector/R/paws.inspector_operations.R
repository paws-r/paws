...
#'
#' @param assessmentTemplateArn The ARN that specifies the assessment template for which you want to create an exclusions preview.
#'
#' @examples
#'
#' @export
...
#' Describes the exclusions that are specified by the exclusions\' ARNs.
#'
#' @param exclusionArns The list of ARNs that specify the exclusions that you want to describe.
...
#' @param reportType Specifies the type of the assessment report that you want to generate. There are two types of assessment reports: a finding report and a full report. For more information, see [Assessment Reports](http://docs.aws.amazon.com/inspector/latest/userguide/inspector_reports.html).
#'
#' @examples
#'
#' @export
...
#'
#' @param assessmentTemplateArn The ARN that specifies the assessment template for which the exclusions preview was requested.
#' @param previewToken The unique identifier associated of the exclusions preview.
...
#' List exclusions that are generated by the assessment run.
#'
#' @param assessmentRunArn The ARN of the assessment run that generated the exclusions that you want to list.
...
#' Registers the IAM role that grants Amazon Inspector access to AWS Services needed to perform security assessments.
#'
#' @param roleArn The ARN of the IAM role that grants Amazon Inspector access to AWS Services needed to perform security assessments.
#'
#' @examples
