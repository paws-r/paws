...
#' ```
#'
#' @param name &#91;required&#93; The name of the bot that you want to create a new version of. The name is case sensitive.
...
{
    op <- new_operation(name = "CreateBotVersion", http_method = "POST", 
...
#' ```
#'
#' @param name &#91;required&#93; The name of the intent that you want to create a new version of. The name is case sensitive.
...
{
    op <- new_operation(name = "CreateIntentVersion", http_method = "POST", 
...
#' ```
#'
#' @param name &#91;required&#93; The name of the slot type that you want to create a new version for. The name is case sensitive.
...
{
    op <- new_operation(name = "CreateSlotTypeVersion", http_method = "POST", 
...
{
    op <- new_operation(name = "DeleteBot", http_method = "DELETE", 
...
{
    op <- new_operation(name = "DeleteBotAlias", http_method = "DELETE", 
...
#' @param botAlias &#91;required&#93; An alias that points to the specific version of the Amazon Lex bot to which this association is being made.
#'
#' @export
delete_bot_channel_association <- function (name, botName, botAlias) 
{
    op <- new_operation(name = "DeleteBotChannelAssociation", 
        http_method = "DELETE", http_path = "/bots/{botName}/aliases/{aliasName}/channels/{name}", 
        paginator = list())
...
#' @param version &#91;required&#93; The version of the bot to delete. You cannot delete the `$LATEST` version of the bot. To delete the `$LATEST` version, use the DeleteBot operation.
#'
#' @export
delete_bot_version <- function (name, version) 
{
    op <- new_operation(name = "DeleteBotVersion", http_method = "DELETE", 
...
{
    op <- new_operation(name = "DeleteIntent", http_method = "DELETE", 
...
#' @param version &#91;required&#93; The version of the intent to delete. You cannot delete the `$LATEST` version of the intent. To delete the `$LATEST` version, use the DeleteIntent operation.
#'
#' @export
delete_intent_version <- function (name, version) 
{
    op <- new_operation(name = "DeleteIntentVersion", http_method = "DELETE", 
...
{
    op <- new_operation(name = "DeleteSlotType", http_method = "DELETE", 
...
#' @param version &#91;required&#93; The version of the slot type to delete. You cannot delete the `$LATEST` version of the slot type. To delete the `$LATEST` version, use the DeleteSlotType operation.
#'
#' @export
delete_slot_type_version <- function (name, version) 
{
    op <- new_operation(name = "DeleteSlotTypeVersion", http_method = "DELETE", 
...
#' @param userId &#91;required&#93; The unique identifier for the user that made the utterances. This is the user ID that was sent in the [PostContent](http://docs.aws.amazon.com/lex/latest/dg/API_runtime_PostContent.html) or [PostText](http://docs.aws.amazon.com/lex/latest/dg/API_runtime_PostText.html) operation request that contained the utterance.
#'
#' @export
delete_utterances <- function (botName, userId) 
{
    op <- new_operation(name = "DeleteUtterances", http_method = "DELETE", 
...
{
    op <- new_operation(name = "GetBot", http_method = "GET", 
...
{
    op <- new_operation(name = "GetBotAlias", http_method = "GET", 
        http_path = "/bots/{botName}/aliases/{name}", paginator = list())
...
get_bot_aliases <- function (botName, nextToken = NULL, maxResults = NULL, 
    nameContains = NULL) 
{
    op <- new_operation(name = "GetBotAliases", http_method = "GET", 
...
#' ```
#'
#' @param name &#91;required&#93; The name of the association between the bot and the channel. The name is case sensitive.
#' @param botName &#91;required&#93; The name of the Amazon Lex bot.
#' @param botAlias &#91;required&#93; An alias pointing to the specific version of the Amazon Lex bot to which this association is being made.
#'
#' @export
get_bot_channel_association <- function (name, botName, botAlias) 
{
    op <- new_operation(name = "GetBotChannelAssociation", http_method = "GET", 
...
{
    op <- new_operation(name = "GetBotChannelAssociations", http_method = "GET", 
...
{
    op <- new_operation(name = "GetBotVersions", http_method = "GET", 
        http_path = "/bots/{name}/versions/", paginator = list())
...
{
    op <- new_operation(name = "GetBots", http_method = "GET", 
        http_path = "/bots/", paginator = list())
...
#' ```
#'
#' @param signature &#91;required&#93; The unique identifier for a built-in intent. To find the signature for an intent, see [Standard Built-in Intents](https://developer.amazon.com/public/solutions/alexa/alexa-skills-kit/docs/built-in-intent-ref/standard-intents) in the *Alexa Skills Kit*.
#'
#' @export
get_builtin_intent <- function (signature) 
{
    op <- new_operation(name = "GetBuiltinIntent", http_method = "GET", 
...
{
    op <- new_operation(name = "GetBuiltinIntents", http_method = "GET", 
...
get_builtin_slot_types <- function (locale = NULL, signatureContains = NULL, 
    nextToken = NULL, maxResults = NULL) 
{
    op <- new_operation(name = "GetBuiltinSlotTypes", http_method = "GET", 
...
{
    op <- new_operation(name = "GetExport", http_method = "GET", 
...
{
    op <- new_operation(name = "GetImport", http_method = "GET", 
...
{
    op <- new_operation(name = "GetIntent", http_method = "GET", 
        http_path = "/intents/{name}/versions/{version}", paginator = list())
...
{
    op <- new_operation(name = "GetIntentVersions", http_method = "GET", 
        http_path = "/intents/{name}/versions/", paginator = list())
...
get_intents <- function (nextToken = NULL, maxResults = NULL, 
    nameContains = NULL) 
{
    op <- new_operation(name = "GetIntents", http_method = "GET", 
...
{
    op <- new_operation(name = "GetSlotType", http_method = "GET", 
...
{
    op <- new_operation(name = "GetSlotTypeVersions", http_method = "GET", 
        http_path = "/slottypes/{name}/versions/", paginator = list())
...
get_slot_types <- function (nextToken = NULL, maxResults = NULL, 
    nameContains = NULL) 
{
    op <- new_operation(name = "GetSlotTypes", http_method = "GET", 
...
#' @param botVersions &#91;required&#93; An array of bot versions for which utterance information should be returned. The limit is 5 versions per request.
#' @param statusType &#91;required&#93; To return utterances that were recognized and handled, use`Detected`. To return utterances that were not recognized, use `Missed`.
#'
#' @export
get_utterances_view <- function (botName, botVersions, statusType) 
{
    op <- new_operation(name = "GetUtterancesView", http_method = "GET", 
...
#' @param locale &#91;required&#93; Specifies the target locale for the bot. Any intent used in the bot must be compatible with the locale of the bot.
#' 
...
#'
#' @export
put_bot <- function (name, description = NULL, intents = NULL, 
    clarificationPrompt = NULL, abortStatement = NULL, idleSessionTTLInSeconds = NULL, 
    voiceId = NULL, checksum = NULL, processBehavior = NULL, 
    locale, childDirected, createVersion = NULL) 
{
    op <- new_operation(name = "PutBot", http_method = "PUT", 
        http_path = "/bots/{name}/versions/$LATEST", paginator = list())
    input <- put_bot_input(name = name, description = description, 
        intents = intents, clarificationPrompt = clarificationPrompt, 
        ...
        locale = locale, childDirected = childDirected, createVersion = createVersion)
...
#'
#' @export
put_bot_alias <- function (name, description = NULL, botVersion, 
    botName, checksum = NULL) 
{
    op <- new_operation(name = "PutBotAlias", http_method = "PUT", 
        http_path = "/bots/{botName}/aliases/{name}", paginator = list())
    input <- put_bot_alias_input(name = name, description = description, 
        botVersion = botVersion, botName = botName, checksum = checksum)
...
{
    op <- new_operation(name = "PutIntent", http_method = "PUT", 
...
{
    op <- new_operation(name = "PutSlotType", http_method = "PUT", 
...
#' ```
#'
#' @param payload &#91;required&#93; A zip archive in binary format. The archive should contain one file, a JSON file containing the resource to import. The resource should match the type specified in the `resourceType` field.
#' @param resourceType &#91;required&#93; Specifies the type of resource to export. Each resource also exports any resources that it depends on.
#' 
#' -   A bot exports dependent intents.
#' 
#' -   An intent exports dependent slot types.
#' @param mergeStrategy &#91;required&#93; Specifies the action that the `StartImport` operation should take when there is an existing resource with the same name.
#' 
...
{
    op <- new_operation(name = "StartImport", http_method = "POST", 
