...
#' This method works, but is considered deprecated
#'
...
#' @param instanceIds &#91;required&#93; The unique IDs of instances of the deployment.
#'
#' @examples
#'
#' @export
...
batch_get_deployment_targets <- function (deploymentId = NULL, 
    targetIds = NULL) 
{
    op <- Operation(name = "BatchGetDeploymentTargets", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param ecsServices The target ECS services in the deployment group. This only applies to deployment groups that use the Amazon ECS compute platform. A target ECS service is specified as an Amazon ECS cluster and service name pair using the format `<clustername>:<servicename>`.
...
#' )
#'
#' @param deploymentId &#91;required&#93; The unique ID of a deployment associated with the applicable IAM user or AWS account.
#'
#' @examples
#'
#' @export
...
{
    op <- Operation(name = "GetDeploymentTarget", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_deployment_targets <- function (deploymentId = NULL, nextToken = NULL, 
    targetFilters = NULL) 
{
    op <- Operation(name = "ListDeploymentTargets", http_method = "POST", 
        http_path = "/", paginator = list())
