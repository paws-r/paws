service <- function () 
{
    cfg <- client_config("elasticfilesystem", list(`*` = "elasticfilesystem.{region}.amazonaws.com", 
        `cn-*` = "elasticfilesystem.{region}.amazonaws.com.cn"))
    client_info <- ClientInfo(service_name = "elasticfilesystem", 
        service_id = "EFS", api_version = "2015-02-01", signing_name = cfg$signing_name, 
