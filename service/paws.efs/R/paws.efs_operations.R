...
#'
#' @export
describe_tags <- function (FileSystemId, MaxItems = NULL, Marker = NULL) 
{
    op <- Operation(name = "DescribeTags", http_method = "GET", 
        http_path = "/2015-02-01/tags/{FileSystemId}/", paginator = list())
    input <- describe_tags_input(FileSystemId = FileSystemId, 
...
#' Updates the throughput mode or the amount of provisioned throughput of an existing file system.
#'
#' @param FileSystemId The ID of the file system that you want to update.
