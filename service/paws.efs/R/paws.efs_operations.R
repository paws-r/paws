...
create_mount_target <- function (FileSystemId, SubnetId, IpAddress = NULL, 
    SecurityGroups = NULL) 
{
    op <- new_operation(name = "CreateMountTarget", http_method = "POST", 
...
{
    op <- new_operation(name = "DeleteFileSystem", http_method = "DELETE", 
...
{
    op <- new_operation(name = "DeleteMountTarget", http_method = "DELETE", 
...
{
    op <- new_operation(name = "DescribeFileSystems", http_method = "GET", 
        http_path = "/2015-02-01/file-systems", paginator = list())
...
#' # mount target.
#' \donttest{describe_mount_target_security_groups(
#'   MountTargetId = "fsmt-12340abc"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "DescribeMountTargetSecurityGroups", 
...
#' \donttest{describe_mount_targets(
#'   FileSystemId = "fs-01234567"
#' )}
#'
#' @export
...
{
    op <- new_operation(name = "DescribeMountTargets", http_method = "GET", 
        http_path = "/2015-02-01/mount-targets", paginator = list())
...
{
    op <- new_operation(name = "DescribeTags", http_method = "GET", 
...
#' \donttest{modify_mount_target_security_groups(
#'   MountTargetId = "fsmt-12340abc",
#'   SecurityGroups = list(
#'     "sg-abcd1234"
#'   )
...
modify_mount_target_security_groups <- function (MountTargetId, 
    SecurityGroups = NULL) 
{
    op <- new_operation(name = "ModifyMountTargetSecurityGroups", 
...
update_file_system <- function (FileSystemId, ThroughputMode = NULL, 
    ProvisionedThroughputInMibps = NULL) 
{
    op <- new_operation(name = "UpdateFileSystem", http_method = "PUT", 
        http_path = "/2015-02-01/file-systems/{FileSystemId}", 
        paginator = list())
