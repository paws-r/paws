...
{
    op <- Operation(name = "ActivateGateway", http_method = "POST", 
...
{
    op <- Operation(name = "AddCache", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "AddUploadBuffer", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "AddWorkingStorage", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "CancelArchival", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "CancelRetrieval", http_method = "POST", 
        http_path = "/", paginator = list())
...
create_cachedi_scsi_volume <- function (GatewayARN, VolumeSizeInBytes, 
    TargetName, NetworkInterfaceId, ClientToken, SnapshotId = NULL, 
    SourceVolumeARN = NULL, KMSEncrypted = NULL, KMSKey = NULL) 
{
    op <- Operation(name = "CreateCachediSCSIVolume", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_cachedi_scsi_volume_input(GatewayARN = GatewayARN, 
        ...
        SnapshotId = SnapshotId, SourceVolumeARN = SourceVolumeARN, 
...
#'
#' @export
create_nfs_file_share <- function (ClientToken, GatewayARN, Role, 
    LocationARN, NFSFileShareDefaults = NULL, KMSEncrypted = NULL, 
    KMSKey = NULL, DefaultStorageClass = NULL, ObjectACL = NULL, 
    ClientList = NULL, Squash = NULL, ReadOnly = NULL, GuessMIMETypeEnabled = NULL, 
    RequesterPays = NULL) 
{
    op <- Operation(name = "CreateNFSFileShare", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_nfs_file_share_input(ClientToken = ClientToken, 
        GatewayARN = GatewayARN, Role = Role, LocationARN = LocationARN, 
        NFSFileShareDefaults = NFSFileShareDefaults, KMSEncrypted = KMSEncrypted, 
        KMSKey = KMSKey, DefaultStorageClass = DefaultStorageClass, 
...
#'
#' @export
create_smb_file_share <- function (ClientToken, GatewayARN, Role, 
    LocationARN, KMSEncrypted = NULL, KMSKey = NULL, DefaultStorageClass = NULL, 
    ObjectACL = NULL, ReadOnly = NULL, GuessMIMETypeEnabled = NULL, 
    RequesterPays = NULL, ValidUserList = NULL, InvalidUserList = NULL, 
    Authentication = NULL) 
{
    op <- Operation(name = "CreateSMBFileShare", http_method = "POST", 
        http_path = "/", paginator = list())
...
create_snapshot_from_volume_recovery_point <- function (VolumeARN, 
    SnapshotDescription) 
{
    op <- Operation(name = "CreateSnapshotFromVolumeRecoveryPoint", 
...
#'
#' @param GatewayARN 
#' @param DiskId The unique identifier for the gateway local disk that is configured as a stored volume. Use [ListLocalDisks](http://docs.aws.amazon.com/storagegateway/latest/userguide/API_ListLocalDisks.html) to list disk IDs for a gateway.
...
#'
#' @export
create_storedi_scsi_volume <- function (GatewayARN, DiskId, PreserveExistingData, 
    TargetName, NetworkInterfaceId, SnapshotId = NULL, KMSEncrypted = NULL, 
    KMSKey = NULL) 
{
    op <- Operation(name = "CreateStorediSCSIVolume", http_method = "POST", 
        http_path = "/", paginator = list())
    input <- create_storedi_scsi_volume_input(GatewayARN = GatewayARN, 
        DiskId = DiskId, PreserveExistingData = PreserveExistingData, 
        TargetName = TargetName, NetworkInterfaceId = NetworkInterfaceId, 
        SnapshotId = SnapshotId, KMSEncrypted = KMSEncrypted, 
        KMSKey = KMSKey)
...
{
    op <- Operation(name = "CreateTapeWithBarcode", http_method = "POST", 
        http_path = "/", paginator = list())
...
create_tapes <- function (GatewayARN, TapeSizeInBytes, ClientToken, 
    ...
    KMSKey = NULL) 
{
    op <- Operation(name = "CreateTapes", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteBandwidthRateLimit", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteChapCredentials", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteFileShare", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteGateway", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteSnapshotSchedule", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteTape", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DeleteTapeArchive", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeBandwidthRateLimit", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeCache", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeCachediSCSIVolumes", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeChapCredentials", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeGatewayInformation", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeMaintenanceStartTime", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeNFSFileShares", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeSMBFileShares", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeSMBSettings", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeSnapshotSchedule", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeStorediSCSIVolumes", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_tape_archives <- function (TapeARNs = NULL, Marker = NULL, 
    Limit = NULL) 
{
    op <- Operation(name = "DescribeTapeArchives", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_tape_recovery_points <- function (GatewayARN, Marker = NULL, 
    Limit = NULL) 
{
    op <- Operation(name = "DescribeTapeRecoveryPoints", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_tapes <- function (GatewayARN, TapeARNs = NULL, Marker = NULL, 
    Limit = NULL) 
{
    op <- Operation(name = "DescribeTapes", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeUploadBuffer", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeVTLDevices", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DescribeWorkingStorage", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "DisableGateway", http_method = "POST", 
        http_path = "/", paginator = list())
...
#'
#' @param GatewayARN The unique Amazon Resource Name (ARN) of the file gateway you want to add to the Active Directory domain.
#' @param DomainName The name of the domain that you want the gateway to join.
#' @param UserName Sets the user name of user who has permission to add the gateway to the Active Directory domain.
...
{
    op <- Operation(name = "JoinDomain", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_file_shares <- function (GatewayARN = NULL, Limit = NULL, 
    Marker = NULL) 
{
    op <- Operation(name = "ListFileShares", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListGateways", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListLocalDisks", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListTapes", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListVolumeInitiators", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListVolumeRecoveryPoints", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ListVolumes", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "NotifyWhenUploaded", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "RefreshCache", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ResetCache", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "RetrieveTapeArchive", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "RetrieveTapeRecoveryPoint", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "SetLocalConsolePassword", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "SetSMBGuestPassword", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "ShutdownGateway", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "StartGateway", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateBandwidthRateLimit", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateChapCredentials", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateGatewayInformation", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateGatewaySoftwareNow", http_method = "POST", 
        http_path = "/", paginator = list())
...
#' @param DayOfWeek The maintenance start time day of the week represented as an ordinal number from 0 to 6, where 0 represents Sunday and 6 Saturday.
#'
#' @examples
...
{
    op <- Operation(name = "UpdateMaintenanceStartTime", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateNFSFileShare", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateSMBFileShare", http_method = "POST", 
        http_path = "/", paginator = list())
...
update_snapshot_schedule <- function (VolumeARN, StartAt, RecurrenceInHours, 
    Description = NULL) 
{
    op <- Operation(name = "UpdateSnapshotSchedule", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- Operation(name = "UpdateVTLDeviceType", http_method = "POST", 
        http_path = "/", paginator = list())
