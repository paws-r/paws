...
{
    op <- new_operation(name = "CreateLicenseConfiguration", 
...
{
    op <- new_operation(name = "DeleteLicenseConfiguration", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetLicenseConfiguration", http_method = "POST", 
...
{
    op <- new_operation(name = "GetServiceSettings", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListAssociationsForLicenseConfiguration", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListLicenseConfigurations", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_license_specifications_for_resource <- function (ResourceArn, 
    MaxResults = NULL, NextToken = NULL) 
{
    op <- new_operation(name = "ListLicenseSpecificationsForResource", 
        http_method = "POST", http_path = "/", paginator = list())
...
list_resource_inventory <- function (MaxResults = NULL, NextToken = NULL, 
    Filters = NULL) 
{
    op <- new_operation(name = "ListResourceInventory", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_usage_for_license_configuration <- function (LicenseConfigurationArn, 
    MaxResults = NULL, NextToken = NULL, Filters = NULL) 
{
    op <- new_operation(name = "ListUsageForLicenseConfiguration", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateLicenseConfiguration", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateLicenseSpecificationsForResource", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateServiceSettings", http_method = "POST", 
        http_path = "/", paginator = list())
