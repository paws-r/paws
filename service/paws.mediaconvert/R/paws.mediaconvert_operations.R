...
{
    op <- new_operation(name = "DeleteJobTemplate", http_method = "DELETE", 
...
{
    op <- new_operation(name = "DeleteQueue", http_method = "DELETE", 
...
{
    op <- new_operation(name = "GetJobTemplate", http_method = "GET", 
        http_path = "/2017-08-29/jobTemplates/{name}", paginator = list())
...
{
    op <- new_operation(name = "GetPreset", http_method = "GET", 
        http_path = "/2017-08-29/presets/{name}", paginator = list())
...
{
    op <- new_operation(name = "GetQueue", http_method = "GET", 
        http_path = "/2017-08-29/queues/{name}", paginator = list())
...
{
    op <- new_operation(name = "ListJobTemplates", http_method = "GET", 
        http_path = "/2017-08-29/jobTemplates", paginator = list())
...
list_queues <- function (ListBy = NULL, MaxResults = NULL, NextToken = NULL, 
    Order = NULL) 
{
    op <- new_operation(name = "ListQueues", http_method = "GET", 
        http_path = "/2017-08-29/queues", paginator = list())
...
update_preset <- function (Category = NULL, Description = NULL, 
    Name, Settings = NULL) 
{
    op <- new_operation(name = "UpdatePreset", http_method = "PUT", 
        http_path = "/2017-08-29/presets/{name}", paginator = list())
...
update_queue <- function (Description = NULL, Name, ReservationPlanSettings = NULL, 
    Status = NULL) 
{
    op <- new_operation(name = "UpdateQueue", http_method = "PUT", 
        http_path = "/2017-08-29/queues/{name}", paginator = list())
