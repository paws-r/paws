...
{
    op <- new_operation(name = "AcceptSharedDirectory", http_method = "POST", 
...
{
    op <- new_operation(name = "AddIpRoutes", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CancelSchemaExtension", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ConnectDirectory", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateComputer", http_method = "POST", 
        http_path = "/", paginator = list())
...
create_conditional_forwarder <- function (DirectoryId, RemoteDomainName, 
    DnsIpAddrs) 
{
    op <- new_operation(name = "CreateConditionalForwarder", 
...
{
    op <- new_operation(name = "CreateDirectory", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateLogSubscription", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreateMicrosoftAD", http_method = "POST", 
        http_path = "/", paginator = list())
...
create_trust <- function (DirectoryId, RemoteDomainName, TrustPassword, 
    ...
    SelectiveAuth = NULL) 
{
    op <- new_operation(name = "CreateTrust", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteConditionalForwarder", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteDirectory", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteLogSubscription", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteSnapshot", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteTrust", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeregisterEventTopic", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeConditionalForwarders", 
        http_method = "POST", http_path = "/", paginator = list())
...
describe_directories <- function (DirectoryIds = NULL, NextToken = NULL, 
    Limit = NULL) 
{
    op <- new_operation(name = "DescribeDirectories", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeDomainControllers", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribeEventTopics", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_shared_directories <- function (OwnerDirectoryId, SharedDirectoryIds = NULL, 
    NextToken = NULL, Limit = NULL) 
{
    op <- new_operation(name = "DescribeSharedDirectories", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_snapshots <- function (DirectoryId = NULL, SnapshotIds = NULL, 
    NextToken = NULL, Limit = NULL) 
{
    op <- new_operation(name = "DescribeSnapshots", http_method = "POST", 
        http_path = "/", paginator = list())
...
describe_trusts <- function (DirectoryId = NULL, TrustIds = NULL, 
    NextToken = NULL, Limit = NULL) 
{
    op <- new_operation(name = "DescribeTrusts", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DisableRadius", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DisableSso", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "EnableRadius", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "EnableSso", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetDirectoryLimits", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetSnapshotLimits", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListIpRoutes", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_log_subscriptions <- function (DirectoryId = NULL, NextToken = NULL, 
    Limit = NULL) 
{
    op <- new_operation(name = "ListLogSubscriptions", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_schema_extensions <- function (DirectoryId, NextToken = NULL, 
    Limit = NULL) 
{
    op <- new_operation(name = "ListSchemaExtensions", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RegisterEventTopic", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RejectSharedDirectory", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RemoveIpRoutes", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ResetUserPassword", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "RestoreFromSnapshot", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ShareDirectory", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "StartSchemaExtension", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UnshareDirectory", http_method = "POST", 
        http_path = "/", paginator = list())
...
update_conditional_forwarder <- function (DirectoryId, RemoteDomainName, 
    DnsIpAddrs) 
{
    op <- new_operation(name = "UpdateConditionalForwarder", 
        http_method = "POST", http_path = "/", paginator = list())
...
update_number_of_domain_controllers <- function (DirectoryId, 
    DesiredNumber) 
{
    op <- new_operation(name = "UpdateNumberOfDomainControllers", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateRadius", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateTrust", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "VerifyTrust", http_method = "POST", 
        http_path = "/", paginator = list())
