...
#' \donttest{associate_vpc_with_hosted_zone(
#'   Comment = "",
...
#'
#' @export
associate_vpc_with_hosted_zone <- function (HostedZoneId, VPC, 
    Comment = NULL) 
{
    op <- new_operation(name = "AssociateVPCWithHostedZone", 
        http_method = "POST", http_path = "/2013-04-01/hostedzone/{Id}/associatevpc", 
        paginator = list())
    input <- associate_vpc_with_hosted_zone_input(HostedZoneId = HostedZoneId, 
        VPC = VPC, Comment = Comment)
    output <- associate_vpc_with_hosted_zone_output()
    svc <- service()
...
#'
#' @export
change_resource_record_sets <- function (HostedZoneId, ChangeBatch) 
{
    op <- new_operation(name = "ChangeResourceRecordSets", http_method = "POST", 
        http_path = "/2013-04-01/hostedzone/{Id}/rrset/", paginator = list())
    input <- change_resource_record_sets_input(HostedZoneId = HostedZoneId, 
        ChangeBatch = ChangeBatch)
    output <- change_resource_record_sets_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' \donttest{change_tags_for_resource(
#'   AddTags = list(
#'     list(
#'       Key = "apex",
#'       Value = "3874"
...
#'
#' @export
change_tags_for_resource <- function (ResourceType, ResourceId, 
    AddTags = NULL, RemoveTagKeys = NULL) 
{
    op <- new_operation(name = "ChangeTagsForResource", http_method = "POST", 
        http_path = "/2013-04-01/tags/{ResourceType}/{ResourceId}", 
        paginator = list())
    input <- change_tags_for_resource_input(ResourceType = ResourceType, 
        ResourceId = ResourceId, AddTags = AddTags, RemoveTagKeys = RemoveTagKeys)
    output <- change_tags_for_resource_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' ```
#'
#' @param CallerReference &#91;required&#93; A unique string that identifies the request and that allows you to retry a failed `CreateHealthCheck` request without the risk of creating two identical health checks:
#' 
...
#'
#' @export
create_health_check <- function (CallerReference, HealthCheckConfig) 
{
    op <- new_operation(name = "CreateHealthCheck", http_method = "POST", 
        http_path = "/2013-04-01/healthcheck", paginator = list())
    input <- create_health_check_input(CallerReference = CallerReference, 
...
#' 
#' -   If your domain is registered with a registrar other than Route 53, you must update the name servers with your registrar to make Route 53 the DNS service for the domain. For more information, see [Migrating DNS Service for an Existing Domain to Amazon Route 53](http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/MigratingDNS.html) in the *Amazon Route 53 Developer Guide*.
#' 
...
#'
#' @export
create_hosted_zone <- function (Name, VPC = NULL, CallerReference, 
    HostedZoneConfig = NULL, DelegationSetId = NULL) 
{
    op <- new_operation(name = "CreateHostedZone", http_method = "POST", 
        http_path = "/2013-04-01/hostedzone", paginator = list())
    input <- create_hosted_zone_input(Name = Name, VPC = VPC, 
        CallerReference = CallerReference, HostedZoneConfig = HostedZoneConfig, 
        DelegationSetId = DelegationSetId)
    output <- create_hosted_zone_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' 
#'             `/aws/route53/hosted zone name hosted zone name `
#' 
...
#' 
#'     ` hosted zone ID/edge location code hosted zone ID/edge location code `
#' 
...
#'
#' @export
create_query_logging_config <- function (HostedZoneId, CloudWatchLogsLogGroupArn) 
{
    op <- new_operation(name = "CreateQueryLoggingConfig", http_method = "POST", 
        http_path = "/2013-04-01/queryloggingconfig", paginator = list())
    input <- create_query_logging_config_input(HostedZoneId = HostedZoneId, 
        CloudWatchLogsLogGroupArn = CloudWatchLogsLogGroupArn)
    output <- create_query_logging_config_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
create_reusable_delegation_set <- function (CallerReference, 
    HostedZoneId = NULL) 
{
    op <- new_operation(name = "CreateReusableDelegationSet", 
        http_method = "POST", http_path = "/2013-04-01/delegationset", 
        paginator = list())
    input <- create_reusable_delegation_set_input(CallerReference = CallerReference, 
        HostedZoneId = HostedZoneId)
    output <- create_reusable_delegation_set_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' @param Document &#91;required&#93; The definition of this traffic policy in JSON format. For more information, see [Traffic Policy Document Format](http://docs.aws.amazon.com/Route53/latest/APIReference/api-policies-traffic-policy-document-format.html).
#' @param Comment (Optional) Any comments that you want to include about the traffic policy.
#'
#' @export
create_traffic_policy <- function (Name, Document, Comment = NULL) 
{
    op <- new_operation(name = "CreateTrafficPolicy", http_method = "POST", 
        http_path = "/2013-04-01/trafficpolicy", paginator = list())
    input <- create_traffic_policy_input(Name = Name, Document = Document, 
        Comment = Comment)
    output <- create_traffic_policy_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
create_traffic_policy_instance <- function (HostedZoneId, Name, 
    TTL, TrafficPolicyId, TrafficPolicyVersion) 
{
    op <- new_operation(name = "CreateTrafficPolicyInstance", 
        http_method = "POST", http_path = "/2013-04-01/trafficpolicyinstance", 
        paginator = list())
    input <- create_traffic_policy_instance_input(HostedZoneId = HostedZoneId, 
        Name = Name, TTL = TTL, TrafficPolicyId = TrafficPolicyId, 
        TrafficPolicyVersion = TrafficPolicyVersion)
    output <- create_traffic_policy_instance_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' @param Document &#91;required&#93; The definition of this version of the traffic policy, in JSON format. You specified the JSON in the `CreateTrafficPolicyVersion` request. For more information about the JSON format, see CreateTrafficPolicy.
#' @param Comment The comment that you specified in the `CreateTrafficPolicyVersion` request, if any.
#'
#' @export
create_traffic_policy_version <- function (Id, Document, Comment = NULL) 
{
    op <- new_operation(name = "CreateTrafficPolicyVersion", 
        http_method = "POST", http_path = "/2013-04-01/trafficpolicy/{Id}", 
        paginator = list())
    input <- create_traffic_policy_version_input(Id = Id, Document = Document, 
        Comment = Comment)
    output <- create_traffic_policy_version_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
create_vpc_association_authorization <- function (HostedZoneId, 
    VPC) 
{
    op <- new_operation(name = "CreateVPCAssociationAuthorization", 
        http_method = "POST", http_path = "/2013-04-01/hostedzone/{Id}/authorizevpcassociation", 
        paginator = list())
    input <- create_vpc_association_authorization_input(HostedZoneId = HostedZoneId, 
        VPC = VPC)
    output <- create_vpc_association_authorization_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
delete_health_check <- function (HealthCheckId) 
{
    op <- new_operation(name = "DeleteHealthCheck", http_method = "DELETE", 
        http_path = "/2013-04-01/healthcheck/{HealthCheckId}", 
        paginator = list())
    input <- delete_health_check_input(HealthCheckId = HealthCheckId)
    output <- delete_health_check_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
delete_hosted_zone <- function (Id) 
{
    op <- new_operation(name = "DeleteHostedZone", http_method = "DELETE", 
        http_path = "/2013-04-01/hostedzone/{Id}", paginator = list())
    input <- delete_hosted_zone_input(Id = Id)
    output <- delete_hosted_zone_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
delete_query_logging_config <- function (Id) 
{
    op <- new_operation(name = "DeleteQueryLoggingConfig", http_method = "DELETE", 
        http_path = "/2013-04-01/queryloggingconfig/{Id}", paginator = list())
    input <- delete_query_logging_config_input(Id = Id)
    output <- delete_query_logging_config_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
delete_reusable_delegation_set <- function (Id) 
{
    op <- new_operation(name = "DeleteReusableDelegationSet", 
        http_method = "DELETE", http_path = "/2013-04-01/delegationset/{Id}", 
        paginator = list())
    input <- delete_reusable_delegation_set_input(Id = Id)
    output <- delete_reusable_delegation_set_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
delete_traffic_policy <- function (Id, Version) 
{
    op <- new_operation(name = "DeleteTrafficPolicy", http_method = "DELETE", 
        http_path = "/2013-04-01/trafficpolicy/{Id}/{Version}", 
        paginator = list())
    input <- delete_traffic_policy_input(Id = Id, Version = Version)
    output <- delete_traffic_policy_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
delete_traffic_policy_instance <- function (Id) 
{
    op <- new_operation(name = "DeleteTrafficPolicyInstance", 
        http_method = "DELETE", http_path = "/2013-04-01/trafficpolicyinstance/{Id}", 
        paginator = list())
    input <- delete_traffic_policy_instance_input(Id = Id)
    output <- delete_traffic_policy_instance_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' ```
#'
#' @param HostedZoneId &#91;required&#93; When removing authorization to associate a VPC that was created by one AWS account with a hosted zone that was created with a different AWS account, the ID of the hosted zone.
#' @param VPC &#91;required&#93; When removing authorization to associate a VPC that was created by one AWS account with a hosted zone that was created with a different AWS account, a complex type that includes the ID and region of the VPC.
#'
#' @export
delete_vpc_association_authorization <- function (HostedZoneId, 
    VPC) 
{
    op <- new_operation(name = "DeleteVPCAssociationAuthorization", 
        http_method = "POST", http_path = "/2013-04-01/hostedzone/{Id}/deauthorizevpcassociation", 
        paginator = list())
    input <- delete_vpc_association_authorization_input(HostedZoneId = HostedZoneId, 
        VPC = VPC)
    output <- delete_vpc_association_authorization_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
disassociate_vpc_from_hosted_zone <- function (HostedZoneId, 
    VPC, Comment = NULL) 
{
    op <- new_operation(name = "DisassociateVPCFromHostedZone", 
        http_method = "POST", http_path = "/2013-04-01/hostedzone/{Id}/disassociatevpc", 
        paginator = list())
    input <- disassociate_vpc_from_hosted_zone_input(HostedZoneId = HostedZoneId, 
        VPC = VPC, Comment = Comment)
    output <- disassociate_vpc_from_hosted_zone_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_account_limit <- function (Type) 
{
    op <- new_operation(name = "GetAccountLimit", http_method = "GET", 
        http_path = "/2013-04-01/accountlimit/{Type}", paginator = list())
    input <- get_account_limit_input(Type = Type)
    output <- get_account_limit_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' ```
#'
#' @param Id &#91;required&#93; The ID of the change batch request. The value that you specify here is the value that `ChangeResourceRecordSets` returned in the `Id` element when you submitted the request.
#'
#' @export
get_change <- function (Id) 
{
    op <- new_operation(name = "GetChange", http_method = "GET", 
        http_path = "/2013-04-01/change/{Id}", paginator = list())
    input <- get_change_input(Id = Id)
    output <- get_change_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_checker_ip_ranges <- function () 
{
    op <- new_operation(name = "GetCheckerIpRanges", http_method = "GET", 
        http_path = "/2013-04-01/checkeripranges", paginator = list())
    input <- get_checker_ip_ranges_input()
    output <- get_checker_ip_ranges_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' 
#' `GET /2013-04-01/geolocation?continentcode=two-letter abbreviation for a continent two-letter abbreviation for a continent `
#' 
#' Use the following syntax to determine whether a country is supported for geolocation:
#' 
#' `GET /2013-04-01/geolocation?countrycode=two-character country code two-character country code `
#' 
#' Use the following syntax to determine whether a subdivision of a country is supported for geolocation:
#' 
#' `GET /2013-04-01/geolocation?countrycode=two-character country code&subdivisioncode=subdivision code two-character country code&subdivisioncode=subdivision code `
#'
#' @section Accepted Parameters:
#' ```
#' get_geo_location(
...
#'
#' @export
get_geo_location <- function (ContinentCode = NULL, CountryCode = NULL, 
    SubdivisionCode = NULL) 
{
    op <- new_operation(name = "GetGeoLocation", http_method = "GET", 
        http_path = "/2013-04-01/geolocation", paginator = list())
    input <- get_geo_location_input(ContinentCode = ContinentCode, 
        CountryCode = CountryCode, SubdivisionCode = SubdivisionCode)
    output <- get_geo_location_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_health_check <- function (HealthCheckId) 
{
    op <- new_operation(name = "GetHealthCheck", http_method = "GET", 
        http_path = "/2013-04-01/healthcheck/{HealthCheckId}", 
        paginator = list())
    input <- get_health_check_input(HealthCheckId = HealthCheckId)
    output <- get_health_check_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_health_check_count <- function () 
{
    op <- new_operation(name = "GetHealthCheckCount", http_method = "GET", 
        http_path = "/2013-04-01/healthcheckcount", paginator = list())
    input <- get_health_check_count_input()
    output <- get_health_check_count_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' ```
#'
#' @param HealthCheckId &#91;required&#93; The ID for the health check for which you want the last failure reason. When you created the health check, `CreateHealthCheck` returned the ID in the response, in the `HealthCheckId` element.
#' 
...
#'
#' @export
get_health_check_last_failure_reason <- function (HealthCheckId) 
{
    op <- new_operation(name = "GetHealthCheckLastFailureReason", 
        http_method = "GET", http_path = "/2013-04-01/healthcheck/{HealthCheckId}/lastfailurereason", 
        paginator = list())
    input <- get_health_check_last_failure_reason_input(HealthCheckId = HealthCheckId)
    output <- get_health_check_last_failure_reason_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' ```
#'
#' @param HealthCheckId &#91;required&#93; The ID for the health check that you want the current status for. When you created the health check, `CreateHealthCheck` returned the ID in the response, in the `HealthCheckId` element.
#' 
...
#'
#' @export
get_health_check_status <- function (HealthCheckId) 
{
    op <- new_operation(name = "GetHealthCheckStatus", http_method = "GET", 
        http_path = "/2013-04-01/healthcheck/{HealthCheckId}/status", 
        paginator = list())
    input <- get_health_check_status_input(HealthCheckId = HealthCheckId)
    output <- get_health_check_status_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' # zone.
#' \donttest{get_hosted_zone(
#'   Id = "Z3M3LMPEXAMPLE"
#' )}
#'
#' @export
get_hosted_zone <- function (Id) 
{
    op <- new_operation(name = "GetHostedZone", http_method = "GET", 
        http_path = "/2013-04-01/hostedzone/{Id}", paginator = list())
    input <- get_hosted_zone_input(Id = Id)
    output <- get_hosted_zone_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_hosted_zone_count <- function () 
{
    op <- new_operation(name = "GetHostedZoneCount", http_method = "GET", 
        http_path = "/2013-04-01/hostedzonecount", paginator = list())
    input <- get_hosted_zone_count_input()
    output <- get_hosted_zone_count_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_hosted_zone_limit <- function (Type, HostedZoneId) 
{
    op <- new_operation(name = "GetHostedZoneLimit", http_method = "GET", 
        http_path = "/2013-04-01/hostedzonelimit/{Id}/{Type}", 
        paginator = list())
    input <- get_hosted_zone_limit_input(Type = Type, HostedZoneId = HostedZoneId)
    output <- get_hosted_zone_limit_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_query_logging_config <- function (Id) 
{
    op <- new_operation(name = "GetQueryLoggingConfig", http_method = "GET", 
        http_path = "/2013-04-01/queryloggingconfig/{Id}", paginator = list())
    input <- get_query_logging_config_input(Id = Id)
    output <- get_query_logging_config_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_reusable_delegation_set <- function (Id) 
{
    op <- new_operation(name = "GetReusableDelegationSet", http_method = "GET", 
        http_path = "/2013-04-01/delegationset/{Id}", paginator = list())
    input <- get_reusable_delegation_set_input(Id = Id)
    output <- get_reusable_delegation_set_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_reusable_delegation_set_limit <- function (Type, DelegationSetId) 
{
    op <- new_operation(name = "GetReusableDelegationSetLimit", 
        http_method = "GET", http_path = "/2013-04-01/reusabledelegationsetlimit/{Id}/{Type}", 
        paginator = list())
    input <- get_reusable_delegation_set_limit_input(Type = Type, 
        DelegationSetId = DelegationSetId)
    output <- get_reusable_delegation_set_limit_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_traffic_policy <- function (Id, Version) 
{
    op <- new_operation(name = "GetTrafficPolicy", http_method = "GET", 
        http_path = "/2013-04-01/trafficpolicy/{Id}/{Version}", 
        paginator = list())
    input <- get_traffic_policy_input(Id = Id, Version = Version)
    output <- get_traffic_policy_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_traffic_policy_instance <- function (Id) 
{
    op <- new_operation(name = "GetTrafficPolicyInstance", http_method = "GET", 
        http_path = "/2013-04-01/trafficpolicyinstance/{Id}", 
        paginator = list())
    input <- get_traffic_policy_instance_input(Id = Id)
    output <- get_traffic_policy_instance_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
get_traffic_policy_instance_count <- function () 
{
    op <- new_operation(name = "GetTrafficPolicyInstanceCount", 
        http_method = "GET", http_path = "/2013-04-01/trafficpolicyinstancecount", 
        paginator = list())
    input <- get_traffic_policy_instance_count_input()
    output <- get_traffic_policy_instance_count_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_geo_locations <- function (StartContinentCode = NULL, StartCountryCode = NULL, 
    StartSubdivisionCode = NULL, MaxItems = NULL) 
{
    op <- new_operation(name = "ListGeoLocations", http_method = "GET", 
        http_path = "/2013-04-01/geolocations", paginator = list())
    input <- list_geo_locations_input(StartContinentCode = StartContinentCode, 
        StartCountryCode = StartCountryCode, StartSubdivisionCode = StartSubdivisionCode, 
        MaxItems = MaxItems)
    output <- list_geo_locations_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_health_checks <- function (Marker = NULL, MaxItems = NULL) 
{
    op <- new_operation(name = "ListHealthChecks", http_method = "GET", 
        http_path = "/2013-04-01/healthcheck", paginator = list())
    input <- list_health_checks_input(Marker = Marker, MaxItems = MaxItems)
    output <- list_health_checks_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_hosted_zones <- function (Marker = NULL, MaxItems = NULL, 
    DelegationSetId = NULL) 
{
    op <- new_operation(name = "ListHostedZones", http_method = "GET", 
        http_path = "/2013-04-01/hostedzone", paginator = list())
    input <- list_hosted_zones_input(Marker = Marker, MaxItems = MaxItems, 
        DelegationSetId = DelegationSetId)
    output <- list_hosted_zones_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_hosted_zones_by_name <- function (DNSName = NULL, HostedZoneId = NULL, 
    MaxItems = NULL) 
{
    op <- new_operation(name = "ListHostedZonesByName", http_method = "GET", 
        http_path = "/2013-04-01/hostedzonesbyname", paginator = list())
    input <- list_hosted_zones_by_name_input(DNSName = DNSName, 
        HostedZoneId = HostedZoneId, MaxItems = MaxItems)
    output <- list_hosted_zones_by_name_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_query_logging_configs <- function (HostedZoneId = NULL, 
    NextToken = NULL, MaxResults = NULL) 
{
    op <- new_operation(name = "ListQueryLoggingConfigs", http_method = "GET", 
        http_path = "/2013-04-01/queryloggingconfig", paginator = list())
    input <- list_query_logging_configs_input(HostedZoneId = HostedZoneId, 
        NextToken = NextToken, MaxResults = MaxResults)
    output <- list_query_logging_configs_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_resource_record_sets <- function (HostedZoneId, StartRecordName = NULL, 
    StartRecordType = NULL, StartRecordIdentifier = NULL, MaxItems = NULL) 
{
    op <- new_operation(name = "ListResourceRecordSets", http_method = "GET", 
        http_path = "/2013-04-01/hostedzone/{Id}/rrset", paginator = list())
    input <- list_resource_record_sets_input(HostedZoneId = HostedZoneId, 
        StartRecordName = StartRecordName, StartRecordType = StartRecordType, 
        StartRecordIdentifier = StartRecordIdentifier, MaxItems = MaxItems)
    output <- list_resource_record_sets_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_reusable_delegation_sets <- function (Marker = NULL, MaxItems = NULL) 
{
    op <- new_operation(name = "ListReusableDelegationSets", 
        http_method = "GET", http_path = "/2013-04-01/delegationset", 
        paginator = list())
    input <- list_reusable_delegation_sets_input(Marker = Marker, 
        MaxItems = MaxItems)
    output <- list_reusable_delegation_sets_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_tags_for_resources <- function (ResourceType, ResourceIds) 
{
    op <- new_operation(name = "ListTagsForResources", http_method = "POST", 
        http_path = "/2013-04-01/tags/{ResourceType}", paginator = list())
    input <- list_tags_for_resources_input(ResourceType = ResourceType, 
        ResourceIds = ResourceIds)
    output <- list_tags_for_resources_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_traffic_policies <- function (TrafficPolicyIdMarker = NULL, 
    MaxItems = NULL) 
{
    op <- new_operation(name = "ListTrafficPolicies", http_method = "GET", 
        http_path = "/2013-04-01/trafficpolicies", paginator = list())
    input <- list_traffic_policies_input(TrafficPolicyIdMarker = TrafficPolicyIdMarker, 
        MaxItems = MaxItems)
    output <- list_traffic_policies_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_traffic_policy_instances <- function (HostedZoneIdMarker = NULL, 
    TrafficPolicyInstanceNameMarker = NULL, TrafficPolicyInstanceTypeMarker = NULL, 
    MaxItems = NULL) 
{
    op <- new_operation(name = "ListTrafficPolicyInstances", 
        http_method = "GET", http_path = "/2013-04-01/trafficpolicyinstances", 
        paginator = list())
    input <- list_traffic_policy_instances_input(HostedZoneIdMarker = HostedZoneIdMarker, 
        ...
        MaxItems = MaxItems)
    output <- list_traffic_policy_instances_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_traffic_policy_instances_by_hosted_zone <- function (HostedZoneId, 
    TrafficPolicyInstanceNameMarker = NULL, TrafficPolicyInstanceTypeMarker = NULL, 
    MaxItems = NULL) 
{
    op <- new_operation(name = "ListTrafficPolicyInstancesByHostedZone", 
        http_method = "GET", http_path = "/2013-04-01/trafficpolicyinstances/hostedzone", 
        paginator = list())
    input <- list_traffic_policy_instances_by_hosted_zone_input(HostedZoneId = HostedZoneId, 
        TrafficPolicyInstanceNameMarker = TrafficPolicyInstanceNameMarker, 
        TrafficPolicyInstanceTypeMarker = TrafficPolicyInstanceTypeMarker, 
        MaxItems = MaxItems)
    output <- list_traffic_policy_instances_by_hosted_zone_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_traffic_policy_instances_by_policy <- function (TrafficPolicyId, 
    TrafficPolicyVersion, HostedZoneIdMarker = NULL, TrafficPolicyInstanceNameMarker = NULL, 
    TrafficPolicyInstanceTypeMarker = NULL, MaxItems = NULL) 
{
    op <- new_operation(name = "ListTrafficPolicyInstancesByPolicy", 
        http_method = "GET", http_path = "/2013-04-01/trafficpolicyinstances/trafficpolicy", 
        paginator = list())
    input <- list_traffic_policy_instances_by_policy_input(TrafficPolicyId = TrafficPolicyId, 
        TrafficPolicyVersion = TrafficPolicyVersion, HostedZoneIdMarker = HostedZoneIdMarker, 
        TrafficPolicyInstanceNameMarker = TrafficPolicyInstanceNameMarker, 
        TrafficPolicyInstanceTypeMarker = TrafficPolicyInstanceTypeMarker, 
        MaxItems = MaxItems)
    output <- list_traffic_policy_instances_by_policy_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_traffic_policy_versions <- function (Id, TrafficPolicyVersionMarker = NULL, 
    MaxItems = NULL) 
{
    op <- new_operation(name = "ListTrafficPolicyVersions", http_method = "GET", 
        http_path = "/2013-04-01/trafficpolicies/{Id}/versions", 
        paginator = list())
    input <- list_traffic_policy_versions_input(Id = Id, TrafficPolicyVersionMarker = TrafficPolicyVersionMarker, 
        MaxItems = MaxItems)
    output <- list_traffic_policy_versions_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
list_vpc_association_authorizations <- function (HostedZoneId, 
    NextToken = NULL, MaxResults = NULL) 
{
    op <- new_operation(name = "ListVPCAssociationAuthorizations", 
        http_method = "GET", http_path = "/2013-04-01/hostedzone/{Id}/authorizevpcassociation", 
        paginator = list())
    input <- list_vpc_association_authorizations_input(HostedZoneId = HostedZoneId, 
        NextToken = NextToken, MaxResults = MaxResults)
    output <- list_vpc_association_authorizations_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
test_dns_answer <- function (HostedZoneId, RecordName, RecordType, 
    ResolverIP = NULL, EDNS0ClientSubnetIP = NULL, EDNS0ClientSubnetMask = NULL) 
{
    op <- new_operation(name = "TestDNSAnswer", http_method = "GET", 
        http_path = "/2013-04-01/testdnsanswer", paginator = list())
    input <- test_dns_answer_input(HostedZoneId = HostedZoneId, 
        RecordName = RecordName, RecordType = RecordType, ResolverIP = ResolverIP, 
        EDNS0ClientSubnetIP = EDNS0ClientSubnetIP, EDNS0ClientSubnetMask = EDNS0ClientSubnetMask)
    output <- test_dns_answer_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#' ```
#'
#' @param HealthCheckId &#91;required&#93; The ID for the health check for which you want detailed information. When you created the health check, `CreateHealthCheck` returned the ID in the response, in the `HealthCheckId` element.
...
#'
#' @export
update_health_check <- function (HealthCheckId, HealthCheckVersion = NULL, 
    IPAddress = NULL, Port = NULL, ResourcePath = NULL, FullyQualifiedDomainName = NULL, 
    SearchString = NULL, FailureThreshold = NULL, Inverted = NULL, 
    Disabled = NULL, HealthThreshold = NULL, ChildHealthChecks = NULL, 
    EnableSNI = NULL, Regions = NULL, AlarmIdentifier = NULL, 
    InsufficientDataHealthStatus = NULL, ResetElements = NULL) 
{
    op <- new_operation(name = "UpdateHealthCheck", http_method = "POST", 
        http_path = "/2013-04-01/healthcheck/{HealthCheckId}", 
        paginator = list())
    input <- update_health_check_input(HealthCheckId = HealthCheckId, 
        HealthCheckVersion = HealthCheckVersion, IPAddress = IPAddress, 
        Port = Port, ResourcePath = ResourcePath, FullyQualifiedDomainName = FullyQualifiedDomainName, 
        SearchString = SearchString, FailureThreshold = FailureThreshold, 
        Inverted = Inverted, Disabled = Disabled, HealthThreshold = HealthThreshold, 
        ChildHealthChecks = ChildHealthChecks, EnableSNI = EnableSNI, 
        Regions = Regions, AlarmIdentifier = AlarmIdentifier, 
        InsufficientDataHealthStatus = InsufficientDataHealthStatus, 
        ResetElements = ResetElements)
    output <- update_health_check_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
update_hosted_zone_comment <- function (Id, Comment = NULL) 
{
    op <- new_operation(name = "UpdateHostedZoneComment", http_method = "POST", 
        http_path = "/2013-04-01/hostedzone/{Id}", paginator = list())
    input <- update_hosted_zone_comment_input(Id = Id, Comment = Comment)
    output <- update_hosted_zone_comment_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
update_traffic_policy_comment <- function (Id, Version, Comment) 
{
    op <- new_operation(name = "UpdateTrafficPolicyComment", 
        http_method = "POST", http_path = "/2013-04-01/trafficpolicy/{Id}/{Version}", 
        paginator = list())
    input <- update_traffic_policy_comment_input(Id = Id, Version = Version, 
        Comment = Comment)
    output <- update_traffic_policy_comment_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
...
#'
#' @export
update_traffic_policy_instance <- function (Id, TTL, TrafficPolicyId, 
    TrafficPolicyVersion) 
{
    op <- new_operation(name = "UpdateTrafficPolicyInstance", 
        http_method = "POST", http_path = "/2013-04-01/trafficpolicyinstance/{Id}", 
        paginator = list())
    input <- update_traffic_policy_instance_input(Id = Id, TTL = TTL, 
        TrafficPolicyId = TrafficPolicyId, TrafficPolicyVersion = TrafficPolicyVersion)
    output <- update_traffic_policy_instance_output()
    svc <- service()
    request <- new_request(svc, op, input, output)
    response <- send_request(request)
    return(response)
