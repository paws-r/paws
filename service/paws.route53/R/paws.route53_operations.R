...
associate_vpc_with_hosted_zone <- function (HostedZoneId, VPC, 
    Comment = NULL) 
{
    op <- Operation(name = "AssociateVPCWithHostedZone", http_method = "POST", 
...
{
    op <- Operation(name = "ChangeResourceRecordSets", http_method = "POST", 
...
{
    op <- Operation(name = "ChangeTagsForResource", http_method = "POST", 
...
{
    op <- Operation(name = "CreateHealthCheck", http_method = "POST", 
...
{
    op <- Operation(name = "CreateHostedZone", http_method = "POST", 
...
{
    op <- Operation(name = "CreateQueryLoggingConfig", http_method = "POST", 
...
create_reusable_delegation_set <- function (CallerReference, 
    HostedZoneId = NULL) 
{
    op <- Operation(name = "CreateReusableDelegationSet", http_method = "POST", 
        http_path = "/2013-04-01/delegationset", paginator = list())
...
{
    op <- Operation(name = "CreateTrafficPolicy", http_method = "POST", 
...
{
    op <- Operation(name = "CreateTrafficPolicyInstance", http_method = "POST", 
        http_path = "/2013-04-01/trafficpolicyinstance", paginator = list())
...
{
    op <- Operation(name = "CreateTrafficPolicyVersion", http_method = "POST", 
        http_path = "/2013-04-01/trafficpolicy/{Id}", paginator = list())
...
create_vpc_association_authorization <- function (HostedZoneId, 
    VPC) 
{
    op <- Operation(name = "CreateVPCAssociationAuthorization", 
...
{
    op <- Operation(name = "DeleteHealthCheck", http_method = "DELETE", 
...
{
    op <- Operation(name = "DeleteHostedZone", http_method = "DELETE", 
...
{
    op <- Operation(name = "DeleteQueryLoggingConfig", http_method = "DELETE", 
...
{
    op <- Operation(name = "DeleteReusableDelegationSet", http_method = "DELETE", 
...
{
    op <- Operation(name = "DeleteTrafficPolicy", http_method = "DELETE", 
...
{
    op <- Operation(name = "DeleteTrafficPolicyInstance", http_method = "DELETE", 
...
delete_vpc_association_authorization <- function (HostedZoneId, 
    VPC) 
{
    op <- Operation(name = "DeleteVPCAssociationAuthorization", 
...
disassociate_vpc_from_hosted_zone <- function (HostedZoneId, 
    VPC, Comment = NULL) 
{
    op <- Operation(name = "DisassociateVPCFromHostedZone", http_method = "POST", 
...
{
    op <- Operation(name = "GetAccountLimit", http_method = "GET", 
...
{
    op <- Operation(name = "GetChange", http_method = "GET", 
...
{
    op <- Operation(name = "GetCheckerIpRanges", http_method = "GET", 
...
{
    op <- Operation(name = "GetGeoLocation", http_method = "GET", 
...
{
    op <- Operation(name = "GetHealthCheck", http_method = "GET", 
        http_path = "/2013-04-01/healthcheck/{HealthCheckId}", 
        paginator = list())
...
{
    op <- Operation(name = "GetHealthCheckCount", http_method = "GET", 
...
{
    op <- Operation(name = "GetHealthCheckLastFailureReason", 
...
{
    op <- Operation(name = "GetHealthCheckStatus", http_method = "GET", 
...
{
    op <- Operation(name = "GetHostedZone", http_method = "GET", 
        http_path = "/2013-04-01/hostedzone/{Id}", paginator = list())
...
{
    op <- Operation(name = "GetHostedZoneCount", http_method = "GET", 
...
{
    op <- Operation(name = "GetHostedZoneLimit", http_method = "GET", 
...
{
    op <- Operation(name = "GetQueryLoggingConfig", http_method = "GET", 
        http_path = "/2013-04-01/queryloggingconfig/{Id}", paginator = list())
...
{
    op <- Operation(name = "GetReusableDelegationSet", http_method = "GET", 
        http_path = "/2013-04-01/delegationset/{Id}", paginator = list())
...
{
    op <- Operation(name = "GetReusableDelegationSetLimit", http_method = "GET", 
...
{
    op <- Operation(name = "GetTrafficPolicy", http_method = "GET", 
        http_path = "/2013-04-01/trafficpolicy/{Id}/{Version}", 
        paginator = list())
...
{
    op <- Operation(name = "GetTrafficPolicyInstance", http_method = "GET", 
        http_path = "/2013-04-01/trafficpolicyinstance/{Id}", 
        paginator = list())
...
{
    op <- Operation(name = "GetTrafficPolicyInstanceCount", http_method = "GET", 
...
{
    op <- Operation(name = "ListGeoLocations", http_method = "GET", 
...
{
    op <- Operation(name = "ListHealthChecks", http_method = "GET", 
        http_path = "/2013-04-01/healthcheck", paginator = list())
...
{
    op <- Operation(name = "ListHostedZones", http_method = "GET", 
        http_path = "/2013-04-01/hostedzone", paginator = list())
...
#' 
#' If the domain name includes escape characters or Punycode, `ListHostedZonesByName` alphabetizes the domain name using the escaped or Punycoded value, which is the format that Amazon Route 53 saves in its database. For example, to create a hosted zone for exÃ¤mple.com, you specify ex\\344mple.com for the domain name. `ListHostedZonesByName` alphabetizes it as:
#' 
#' `com.ex\344mple.`
#' 
...
list_hosted_zones_by_name <- function (DNSName = NULL, HostedZoneId = NULL, 
    MaxItems = NULL) 
{
    op <- Operation(name = "ListHostedZonesByName", http_method = "GET", 
...
{
    op <- Operation(name = "ListQueryLoggingConfigs", http_method = "GET", 
        http_path = "/2013-04-01/queryloggingconfig", paginator = list())
...
{
    op <- Operation(name = "ListResourceRecordSets", http_method = "GET", 
        http_path = "/2013-04-01/hostedzone/{Id}/rrset", paginator = list())
...
{
    op <- Operation(name = "ListReusableDelegationSets", http_method = "GET", 
        http_path = "/2013-04-01/delegationset", paginator = list())
...
{
    op <- Operation(name = "ListTagsForResources", http_method = "POST", 
...
list_traffic_policies <- function (TrafficPolicyIdMarker = NULL, 
    MaxItems = NULL) 
{
    op <- Operation(name = "ListTrafficPolicies", http_method = "GET", 
...
list_traffic_policy_instances <- function (HostedZoneIdMarker = NULL, 
    ...
    MaxItems = NULL) 
{
    op <- Operation(name = "ListTrafficPolicyInstances", http_method = "GET", 
        http_path = "/2013-04-01/trafficpolicyinstances", paginator = list())
...
list_traffic_policy_instances_by_hosted_zone <- function (HostedZoneId, 
    ...
    MaxItems = NULL) 
{
    op <- Operation(name = "ListTrafficPolicyInstancesByHostedZone", 
...
{
    op <- Operation(name = "ListTrafficPolicyInstancesByPolicy", 
...
list_traffic_policy_versions <- function (Id, TrafficPolicyVersionMarker = NULL, 
    MaxItems = NULL) 
{
    op <- Operation(name = "ListTrafficPolicyVersions", http_method = "GET", 
...
list_vpc_association_authorizations <- function (HostedZoneId, 
    NextToken = NULL, MaxResults = NULL) 
{
    op <- Operation(name = "ListVPCAssociationAuthorizations", 
...
{
    op <- Operation(name = "TestDNSAnswer", http_method = "GET", 
...
{
    op <- Operation(name = "UpdateHealthCheck", http_method = "POST", 
        http_path = "/2013-04-01/healthcheck/{HealthCheckId}", 
        paginator = list())
...
{
    op <- Operation(name = "UpdateHostedZoneComment", http_method = "POST", 
        http_path = "/2013-04-01/hostedzone/{Id}", paginator = list())
...
{
    op <- Operation(name = "UpdateTrafficPolicyComment", http_method = "POST", 
        http_path = "/2013-04-01/trafficpolicy/{Id}/{Version}", 
        paginator = list())
...
{
    op <- Operation(name = "UpdateTrafficPolicyInstance", http_method = "POST", 
        http_path = "/2013-04-01/trafficpolicyinstance/{Id}", 
        paginator = list())
