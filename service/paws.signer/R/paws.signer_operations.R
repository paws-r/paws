...
{
    op <- new_operation(name = "CancelSigningProfile", http_method = "DELETE", 
...
{
    op <- new_operation(name = "DescribeSigningJob", http_method = "GET", 
...
{
    op <- new_operation(name = "GetSigningPlatform", http_method = "GET", 
...
{
    op <- new_operation(name = "GetSigningProfile", http_method = "GET", 
        http_path = "/signing-profiles/{profileName}", paginator = list())
...
{
    op <- new_operation(name = "ListSigningJobs", http_method = "GET", 
...
{
    op <- new_operation(name = "ListSigningPlatforms", http_method = "GET", 
...
list_signing_profiles <- function (includeCanceled = NULL, maxResults = NULL, 
    nextToken = NULL) 
{
    op <- new_operation(name = "ListSigningProfiles", http_method = "GET", 
...
{
    op <- new_operation(name = "PutSigningProfile", http_method = "PUT", 
        http_path = "/signing-profiles/{profileName}", paginator = list())
...
start_signing_job <- function (source, destination, profileName = NULL, 
    clientRequestToken) 
{
    op <- new_operation(name = "StartSigningJob", http_method = "POST", 
        http_path = "/signing-jobs", paginator = list())
