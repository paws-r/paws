...
{
    op <- new_operation(name = "BatchGetRepositories", http_method = "POST", 
...
{
    op <- new_operation(name = "CreateBranch", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "CreatePullRequest", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteBranch", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteCommentContent", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DeleteFile", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "DescribePullRequestEvents", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetBlob", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetBranch", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetComment", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetCommentsForComparedCommit", 
...
get_comments_for_pull_request <- function (pullRequestId, repositoryName = NULL, 
    ...
    maxResults = NULL) 
{
    op <- new_operation(name = "GetCommentsForPullRequest", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetCommit", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetDifferences", http_method = "POST", 
        http_path = "/", paginator = list())
...
get_file <- function (repositoryName, commitSpecifier = NULL, 
    filePath) 
{
    op <- new_operation(name = "GetFile", http_method = "POST", 
        http_path = "/", paginator = list())
...
get_folder <- function (repositoryName, commitSpecifier = NULL, 
    folderPath) 
{
    op <- new_operation(name = "GetFolder", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetMergeConflicts", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetPullRequest", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetRepository", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "GetRepositoryTriggers", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListBranches", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "ListPullRequests", http_method = "POST", 
        http_path = "/", paginator = list())
...
list_repositories <- function (nextToken = NULL, sortBy = NULL, 
    order = NULL) 
{
    op <- new_operation(name = "ListRepositories", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "MergePullRequestByFastForward", 
        http_method = "POST", http_path = "/", paginator = list())
...
post_comment_for_compared_commit <- function (repositoryName, 
    ...
    clientRequestToken = NULL) 
{
    op <- new_operation(name = "PostCommentForComparedCommit", 
        http_method = "POST", http_path = "/", paginator = list())
...
post_comment_for_pull_request <- function (pullRequestId, repositoryName, 
    ...
    clientRequestToken = NULL) 
{
    op <- new_operation(name = "PostCommentForPullRequest", http_method = "POST", 
        http_path = "/", paginator = list())
...
post_comment_reply <- function (inReplyTo, clientRequestToken = NULL, 
    content) 
{
    op <- new_operation(name = "PostCommentReply", http_method = "POST", 
        http_path = "/", paginator = list())
...
put_file <- function (repositoryName, branchName, fileContent, 
    ...
    name = NULL, email = NULL) 
{
    op <- new_operation(name = "PutFile", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "PutRepositoryTriggers", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "TestRepositoryTriggers", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateComment", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateDefaultBranch", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdatePullRequestDescription", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdatePullRequestStatus", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdatePullRequestTitle", http_method = "POST", 
        http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateRepositoryDescription", 
        http_method = "POST", http_path = "/", paginator = list())
...
{
    op <- new_operation(name = "UpdateRepositoryName", http_method = "POST", 
        http_path = "/", paginator = list())
