...
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/5ydtgd9dc4v9fnw3/branch/master?svg=true)](https://ci.appveyor.com/project/davidkretch/paws/branch/master)
...
Disclaimer: We are not affiliated with Amazon Web Services, and this package is
