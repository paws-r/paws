...
Disclaimer: We are not affiliated with Amazon or Amazon Web Services, and this
...
By default, the Paws will use the `default` profile. If you would
...
However, you may want to use another profile, which you can choose it in the 
following ways:
