...
// populate
SEXP populate(SEXP input, SEXP interface, SEXP parent);
RcppExport SEXP _paws_common_populate(SEXP inputSEXP, SEXP interfaceSEXP, SEXP parentSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(populate(input, interface, parent));
    return rcpp_result_gen;
END_RCPP
}
// check_global
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_paws_common_populate", (DL_FUNC) &_paws_common_populate, 3},
