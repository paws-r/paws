...
test_that("resolver_endpoint boto", {
  ...
  expect_equal(actual, list(endpoint = "https://s3.amazonaws.com", signing_region = "us-east-1"))

  actual <- resolver_endpoint("s3", "us-isof-east-1", s3_endpoints_boto)
  expect_equal(actual, list(endpoint = "https://s3.us-isof-east-1.csp.hci.ic.gov", signing_region = "us-isof-east-1"))
})
...
test_that("resolver_endpoint js", {
  ...
  expect_equal(actual, list(endpoint = "https://s3.us-isob-east-1.sc2s.sgov.gov", signing_region = "us-isob-east-1"))
})
