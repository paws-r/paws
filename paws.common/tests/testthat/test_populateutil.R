test_that("Structure", {
  ...
  expect_equivalent(foo, list(a = 1, b = 2))
...
test_that("List", {
  ...
  bar <- List(1, 2)
  expect_equivalent(bar, list(1, 2))
...
test_that("Map", {
  ...
  expect_equivalent(bar, list(list(Name = "foo", Value = 1), list(Name = "bar", Value = 2)))
