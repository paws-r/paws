...
.ssm$describe_instance_properties_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(InstanceProperties = structure(list(structure(list(Name = structure(logical(0), tags = list(type = "string")), InstanceId = structure(logical(0), tags = list(type = "string")), InstanceType = structure(logical(0), tags = list(type = "string")), InstanceRole = structure(logical(0), tags = list(type = "string")), KeyName = structure(logical(0), tags = list(type = "string")), InstanceState = structure(logical(0), tags = list(type = "string")), Architecture = structure(logical(0), tags = list(type = "string")), IPAddress = structure(logical(0), tags = list(type = "string")), LaunchTime = structure(logical(0), tags = list(type = "timestamp")), PingStatus = structure(logical(0), tags = list(type = "string")), LastPingDateTime = structure(logical(0), tags = list(type = "timestamp")), AgentVersion = structure(logical(0), tags = list(type = "string")), PlatformType = structure(logical(0), tags = list(type = "string")), PlatformName = structure(logical(0), tags = list(type = "string")), PlatformVersion = structure(logical(0), tags = list(type = "string")), ActivationId = structure(logical(0), tags = list(type = "string")), IamRole = structure(logical(0), tags = list(type = "string")), RegistrationDate = structure(logical(0), tags = list(type = "timestamp")), ResourceType = structure(logical(0), tags = list(type = "string")), ComputerName = structure(logical(0), tags = list(type = "string")), AssociationStatus = structure(logical(0), tags = list(type = "string")), LastAssociationExecutionDate = structure(logical(0), tags = list(type = "timestamp")), LastSuccessfulAssociationExecutionDate = structure(logical(0), tags = list(type = "timestamp")), AssociationOverview = structure(list(DetailedStatus = structure(logical(0), tags = list(type = "string")), InstanceAssociationStatusAggregatedCount = structure(list(structure(logical(0), tags = list(type = "integer"))), tags = list(type = "map"))), tags = list(type = "structure")), SourceId = structure(logical(0), tags = list(type = "string")), SourceType = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), NextToken = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
