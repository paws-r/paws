...
.organizations$metadata <- list(
  ...
  endpoints = list("aws-global" = list(endpoint = "organizations.us-east-1.amazonaws.com", global = TRUE, signing_region = "us-east-1"), "^(us|eu|ap|sa|ca|me|af|il|mx)\\-\\w+\\-\\d+$" = list(endpoint = "organizations.us-east-1.amazonaws.com", global = FALSE, signing_region = "us-east-1"), "aws-cn-global" = list(endpoint = "organizations.cn-northwest-1.amazonaws.com.cn", global = TRUE, signing_region = "cn-northwest-1"), "^cn\\-\\w+\\-\\d+$" = list(endpoint = "organizations.cn-northwest-1.amazonaws.com.cn", global = FALSE, signing_region = "cn-northwest-1"), "aws-us-gov-global" = list(endpoint = "organizations.us-gov-west-1.amazonaws.com", global = TRUE, signing_region = "us-gov-west-1"), "^us\\-gov\\-\\w+\\-\\d+$" = list(endpoint = "organizations.us-gov-west-1.amazonaws.com", global = FALSE, signing_region = "us-gov-west-1"), "aws-iso-global" = list(endpoint = "organizations.us-iso-east-1.c2s.ic.gov", global = TRUE, signing_region = "us-iso-east-1"), "^us\\-iso\\-\\w+\\-\\d+$" = list(endpoint = "organizations.us-iso-east-1.c2s.ic.gov", global = FALSE, signing_region = "us-iso-east-1"), "aws-iso-b-global" = list(endpoint = "organizations.us-isob-east-1.sc2s.sgov.gov", global = TRUE, signing_region = "us-isob-east-1"), "^us\\-isob\\-\\w+\\-\\d+$" = list(endpoint = "organizations.us-isob-east-1.sc2s.sgov.gov", global = FALSE, signing_region = "us-isob-east-1"), "^eu\\-isoe\\-\\w+\\-\\d+$" = list(endpoint = "organizations.{region}.cloud.adc-e.uk", global = FALSE), "aws-iso-f-global" = list(endpoint = "organizations.us-isof-south-1.csp.hci.ic.gov", global = TRUE, signing_region = "us-isof-south-1"), "^us\\-isof\\-\\w+\\-\\d+$" = list(endpoint = "organizations.us-isof-south-1.csp.hci.ic.gov", global = FALSE, signing_region = "us-isof-south-1")),
