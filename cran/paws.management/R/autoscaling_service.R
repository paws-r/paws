...
#'  \link[=autoscaling_describe_load_balancers]{describe_load_balancers} \tab Gets information about the load balancers for the specified Auto Scaling group\cr
#'  \link[=autoscaling_describe_load_balancer_target_groups]{describe_load_balancer_target_groups} \tab Gets information about the Elastic Load Balancing target groups for the specified Auto Scaling group\cr
...
#'  \link[=autoscaling_start_instance_refresh]{start_instance_refresh} \tab Starts a new instance refresh operation\cr
