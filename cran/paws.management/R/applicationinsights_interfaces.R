...
.applicationinsights$create_application_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(ResourceGroupName = structure(logical(0), tags = list(type = "string")), OpsCenterEnabled = structure(logical(0), tags = list(type = "boolean")), CWEMonitorEnabled = structure(logical(0), tags = list(type = "boolean")), OpsItemSNSTopicArn = structure(logical(0), tags = list(type = "string")), SNSNotificationArn = structure(logical(0), tags = list(type = "string")), Tags = structure(list(structure(list(Key = structure(logical(0), tags = list(type = "string")), Value = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), AutoConfigEnabled = structure(logical(0), tags = list(type = "boolean")), AutoCreate = structure(logical(0), tags = list(type = "boolean")), GroupingType = structure(logical(0), tags = list(type = "string")), AttachMissingPermission = structure(logical(0), tags = list(type = "boolean"))), tags = list(type = "structure"))
  return(populate(args, shape))
}

.applicationinsights$create_application_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(ApplicationInfo = structure(list(AccountId = structure(logical(0), tags = list(type = "string")), ResourceGroupName = structure(logical(0), tags = list(type = "string")), LifeCycle = structure(logical(0), tags = list(type = "string")), OpsItemSNSTopicArn = structure(logical(0), tags = list(type = "string")), SNSNotificationArn = structure(logical(0), tags = list(type = "string")), OpsCenterEnabled = structure(logical(0), tags = list(type = "boolean")), CWEMonitorEnabled = structure(logical(0), tags = list(type = "boolean")), Remarks = structure(logical(0), tags = list(type = "string")), AutoConfigEnabled = structure(logical(0), tags = list(type = "boolean")), DiscoveryType = structure(logical(0), tags = list(type = "string")), AttachMissingPermission = structure(logical(0), tags = list(type = "boolean"))), tags = list(type = "structure"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.applicationinsights$list_problems_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(ProblemList = structure(list(structure(list(Id = structure(logical(0), tags = list(type = "string")), Title = structure(logical(0), tags = list(type = "string")), ShortName = structure(logical(0), tags = list(type = "string")), Insights = structure(logical(0), tags = list(type = "string")), Status = structure(logical(0), tags = list(type = "string")), AffectedResource = structure(logical(0), tags = list(type = "string")), StartTime = structure(logical(0), tags = list(type = "timestamp")), EndTime = structure(logical(0), tags = list(type = "timestamp")), SeverityLevel = structure(logical(0), tags = list(type = "string")), AccountId = structure(logical(0), tags = list(type = "string")), ResourceGroupName = structure(logical(0), tags = list(type = "string")), Feedback = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "map")), RecurringCount = structure(logical(0), tags = list(type = "long")), LastRecurrenceTime = structure(logical(0), tags = list(type = "timestamp")), Visibility = structure(logical(0), tags = list(type = "string")), ResolutionMethod = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), NextToken = structure(logical(0), tags = list(type = "string")), ResourceGroupName = structure(logical(0), tags = list(type = "string")), AccountId = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.applicationinsights$list_workloads_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(WorkloadList = structure(list(structure(list(WorkloadId = structure(logical(0), tags = list(type = "string")), ComponentName = structure(logical(0), tags = list(type = "string")), WorkloadName = structure(logical(0), tags = list(type = "string")), Tier = structure(logical(0), tags = list(type = "string")), WorkloadRemarks = structure(logical(0), tags = list(type = "string")), MissingWorkloadConfig = structure(logical(0), tags = list(type = "boolean"))), tags = list(type = "structure"))), tags = list(type = "list")), NextToken = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.applicationinsights$update_application_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(ResourceGroupName = structure(logical(0), tags = list(type = "string")), OpsCenterEnabled = structure(logical(0), tags = list(type = "boolean")), CWEMonitorEnabled = structure(logical(0), tags = list(type = "boolean")), OpsItemSNSTopicArn = structure(logical(0), tags = list(type = "string")), SNSNotificationArn = structure(logical(0), tags = list(type = "string")), RemoveSNSTopic = structure(logical(0), tags = list(type = "boolean")), AutoConfigEnabled = structure(logical(0), tags = list(type = "boolean")), AttachMissingPermission = structure(logical(0), tags = list(type = "boolean"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
