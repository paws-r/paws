...
#' @section Operations:
#' \tabular{ll}{
#'  \link[=cloudwatchapplicationsignals_batch_delete_instrumentation_configurations]{batch_delete_instrumentation_configurations} \tab Deletes multiple instrumentation configurations in a single request\cr
...
#'  \link[=cloudwatchapplicationsignals_create_instrumentation_configuration]{create_instrumentation_configuration} \tab Creates a dynamic instrumentation configuration for a specific code or endpoint location within a service and environment\cr
...
#'  \link[=cloudwatchapplicationsignals_delete_instrumentation_configuration]{delete_instrumentation_configuration} \tab Deletes the specified instrumentation configuration\cr
...
#'  \link[=cloudwatchapplicationsignals_get_instrumentation_configuration]{get_instrumentation_configuration} \tab Returns the details of a single instrumentation configuration identified by service, environment, signal type, and location\cr
#'  \link[=cloudwatchapplicationsignals_get_instrumentation_configuration_status]{get_instrumentation_configuration_status} \tab Retrieves the status history for a single instrumentation configuration during a specified time range\cr
...
#'  \link[=cloudwatchapplicationsignals_list_instrumentation_configurations]{list_instrumentation_configurations} \tab Returns all active instrumentation configurations for a service and environment\cr
...
#'  \link[=cloudwatchapplicationsignals_report_instrumentation_configuration_status]{report_instrumentation_configuration_status} \tab Reports the status of one or more instrumentation configurations from SDK instances\cr
