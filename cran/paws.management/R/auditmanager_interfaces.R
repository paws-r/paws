...
.auditmanager$update_settings_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(snsTopic = structure(logical(0), tags = list(type = "string")), defaultAssessmentReportsDestination = structure(list(destinationType = structure(logical(0), tags = list(type = "string")), destination = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), defaultProcessOwners = structure(list(structure(list(roleType = structure(logical(0), tags = list(type = "string")), roleArn = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), kmsKey = structure(logical(0), tags = list(type = "string")), evidenceFinderEnabled = structure(logical(0), tags = list(type = "boolean")), deregistrationPolicy = structure(list(deleteResources = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
