...
.auditmanager$batch_import_evidence_to_assessment_control_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(assessmentId = structure(logical(0), tags = list(location = "uri", locationName = "assessmentId", type = "string")), controlSetId = structure(logical(0), tags = list(location = "uri", locationName = "controlSetId", type = "string")), controlId = structure(logical(0), tags = list(location = "uri", locationName = "controlId", type = "string")), manualEvidence = structure(list(structure(list(s3ResourcePath = structure(logical(0), tags = list(type = "string")), textResponse = structure(logical(0), tags = list(type = "string")), evidenceFileName = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list"))), tags = list(type = "structure"))
  return(populate(args, shape))
}

.auditmanager$batch_import_evidence_to_assessment_control_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(errors = structure(list(structure(list(manualEvidence = structure(list(s3ResourcePath = structure(logical(0), tags = list(type = "string")), textResponse = structure(logical(0), tags = list(type = "string")), evidenceFileName = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), errorCode = structure(logical(0), tags = list(type = "string")), errorMessage = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.auditmanager$create_assessment_report_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(name = structure(logical(0), tags = list(type = "string")), description = structure(logical(0), tags = list(type = "string")), assessmentId = structure(logical(0), tags = list(location = "uri", locationName = "assessmentId", type = "string")), queryStatement = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.auditmanager$get_evidence_file_upload_url_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(fileName = structure(logical(0), tags = list(location = "querystring", locationName = "fileName", type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}

.auditmanager$get_evidence_file_upload_url_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(evidenceFileName = structure(logical(0), tags = list(type = "string")), uploadUrl = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.auditmanager$update_settings_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(snsTopic = structure(logical(0), tags = list(type = "string")), defaultAssessmentReportsDestination = structure(list(destinationType = structure(logical(0), tags = list(type = "string")), destination = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), defaultProcessOwners = structure(list(structure(list(roleType = structure(logical(0), tags = list(type = "string")), roleArn = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), kmsKey = structure(logical(0), tags = list(type = "string")), evidenceFinderEnabled = structure(logical(0), tags = list(type = "boolean")), deregistrationPolicy = structure(list(deleteResources = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), defaultExportDestination = structure(list(destinationType = structure(logical(0), tags = list(type = "string")), destination = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
