...
.auditmanager$update_assessment_control_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(control = structure(list(id = structure(logical(0), tags = list(type = "string")), name = structure(logical(0), tags = list(type = "string")), description = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), status = structure(logical(0), tags = list(type = "string")), response = structure(logical(0), tags = list(type = "string")), comments = structure(list(structure(list(authorName = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), commentBody = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), postedDate = structure(logical(0), tags = list(type = "timestamp"))), tags = list(type = "structure"))), tags = list(type = "list")), evidenceSources = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "list")), evidenceCount = structure(logical(0), tags = list(type = "integer")), assessmentReportEvidenceCount = structure(logical(0), tags = list(type = "integer"))), tags = list(type = "structure"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
