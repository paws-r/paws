...
.health$metadata <- list(
  service_name = "health",
  endpoints = list("aws-global" = list(endpoint = "global.health.amazonaws.com", global = TRUE), "us-east-1" = list(endpoint = "global.health.amazonaws.com", global = TRUE), "^(us|eu|ap|sa|ca|me|af|il|mx)\\-\\w+\\-\\d+$" = list(endpoint = "global.health.amazonaws.com", global = FALSE), "aws-cn-global" = list(endpoint = "global.health.amazonaws.com.cn", global = TRUE), "cn-northwest-1" = list(endpoint = "global.health.amazonaws.com.cn", global = TRUE), "^cn\\-\\w+\\-\\d+$" = list(endpoint = "global.health.amazonaws.com.cn", global = FALSE), "^us\\-gov\\-\\w+\\-\\d+$" = list(endpoint = "health.{region}.amazonaws.com", global = FALSE), "^us\\-iso\\-\\w+\\-\\d+$" = list(endpoint = "health.{region}.c2s.ic.gov", global = FALSE), "^us\\-isob\\-\\w+\\-\\d+$" = list(endpoint = "health.{region}.sc2s.sgov.gov", global = FALSE), "^eu\\-isoe\\-\\w+\\-\\d+$" = list(endpoint = "health.{region}.cloud.adc-e.uk", global = FALSE), "^us\\-isof\\-\\w+\\-\\d+$" = list(endpoint = "health.{region}.csp.hci.ic.gov", global = FALSE)),
  service_id = "Health",
