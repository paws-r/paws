...
.pi$metadata <- list(
  service_name = "pi",
  endpoints = list("*" = list(endpoint = "pi.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "pi.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "pi.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "pi.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "pi.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "pi.{region}.csp.hci.ic.gov", global = FALSE)),
  service_id = "PI",
