...
#' @section Operations:
#' \tabular{ll}{
#'  \link[=auditmanager_associate_assessment_report_evidence_folder]{associate_assessment_report_evidence_folder} \tab Associates an evidence folder to an assessment report in a Audit Manager assessment\cr
...
#'  \link[=auditmanager_get_evidence_folders_by_assessment_control]{get_evidence_folders_by_assessment_control} \tab Returns a list of evidence folders that are associated with a specified control of an assessment in Audit Manager\cr
...
#'  \link[=auditmanager_get_services_in_scope]{get_services_in_scope} \tab Returns a list of the in-scope Amazon Web Services for the specified assessment\cr
...
#'  \link[=auditmanager_update_settings]{update_settings} \tab Updates Audit Manager settings for the current user account\cr
