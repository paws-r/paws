...
#'  \link[=wellarchitected_create_agent_context]{create_agent_context} \tab Creates a context associated with an optimization profile\cr
#'  \link[=wellarchitected_create_agent_goal]{create_agent_goal} \tab Creates an optimization goal associated with a profile\cr
#'  \link[=wellarchitected_create_agent_profile]{create_agent_profile} \tab Creates an optimization profile that defines the scope and configuration for generating recommendations\cr
...
#'  \link[=wellarchitected_delete_agent_context]{delete_agent_context} \tab Deletes a context associated with a profile\cr
#'  \link[=wellarchitected_delete_agent_goal]{delete_agent_goal} \tab Deletes an optimization goal from a profile\cr
#'  \link[=wellarchitected_delete_agent_profile]{delete_agent_profile} \tab Deletes an optimization profile and its associated configuration\cr
...
#'  \link[=wellarchitected_get_agent_context]{get_agent_context} \tab Retrieves detailed information about a specific context associated with a profile\cr
#'  \link[=wellarchitected_get_agent_goal]{get_agent_goal} \tab Retrieves detailed information about a specific optimization goal\cr
#'  \link[=wellarchitected_get_agent_profile]{get_agent_profile} \tab Retrieves detailed information about an optimization profile, including its configuration and metadata\cr
#'  \link[=wellarchitected_get_agent_recommendation]{get_agent_recommendation} \tab Retrieves detailed information about a specific optimization recommendation, including its impact analysis, content, and implementation guidance\cr
#'  \link[=wellarchitected_get_agent_recommendation_generation]{get_agent_recommendation_generation} \tab Retrieves information about a recommendation generation process, including its status, progress, and results\cr
...
#'  \link[=wellarchitected_list_agent_contexts]{list_agent_contexts} \tab Lists contexts associated with a profile\cr
#'  \link[=wellarchitected_list_agent_goals]{list_agent_goals} \tab Lists optimization goals associated with a specified profile\cr
#'  \link[=wellarchitected_list_agent_profiles]{list_agent_profiles} \tab Lists optimization profiles in your account\cr
#'  \link[=wellarchitected_list_agent_recommendation_generations]{list_agent_recommendation_generations} \tab Lists recommendation generation processes for a specified profile\cr
#'  \link[=wellarchitected_list_agent_recommendation_items]{list_agent_recommendation_items} \tab Lists recommendation items for a specific recommendation\cr
#'  \link[=wellarchitected_list_agent_recommendations]{list_agent_recommendations} \tab Lists active optimization recommendations for a specified profile with optional filtering by state\cr
...
#'  \link[=wellarchitected_put_agent_recommendation_feedback]{put_agent_recommendation_feedback} \tab Submits user feedback on a recommendation to help improve future optimization suggestions and track implementation outcomes\cr
#'  \link[=wellarchitected_start_agent_recommendation_generation]{start_agent_recommendation_generation} \tab Initiates a new recommendation generation process for the specified optimization profile\cr
...
#'  \link[=wellarchitected_update_agent_context]{update_agent_context} \tab Updates an existing context associated with a profile\cr
#'  \link[=wellarchitected_update_agent_goal]{update_agent_goal} \tab Updates the pillars and title of an existing goal associated with a profile\cr
#'  \link[=wellarchitected_update_agent_profile]{update_agent_profile} \tab Updates an existing optimization profile's configuration, including its pillars, execution role, and aggregation settings\cr
#'  \link[=wellarchitected_update_agent_recommendation_status]{update_agent_recommendation_status} \tab Updates the status of a recommendation to track its progress through the implementation lifecycle\cr
