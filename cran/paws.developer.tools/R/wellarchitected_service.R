...
#'  \link[=wellarchitected_import_lens]{import_lens} \tab Import a new lens\cr
...
#'  \link[=wellarchitected_update_global_settings]{update_global_settings} \tab Updates whether the Amazon Web Services account is opted into organization sharing features\cr
