...
.drs$create_launch_configuration_template_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(launchConfigurationTemplate = structure(list(arn = structure(logical(0), tags = list(type = "string")), copyPrivateIp = structure(logical(0), tags = list(type = "boolean", box = TRUE)), copyTags = structure(logical(0), tags = list(type = "boolean", box = TRUE)), launchConfigurationTemplateID = structure(logical(0), tags = list(type = "string")), launchDisposition = structure(logical(0), tags = list(type = "string")), licensing = structure(list(osByol = structure(logical(0), tags = list(type = "boolean", box = TRUE))), tags = list(type = "structure")), tags = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "map", sensitive = TRUE)), targetInstanceTypeRightSizingMethod = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.drs$describe_launch_configuration_templates_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(items = structure(list(structure(list(arn = structure(logical(0), tags = list(type = "string")), copyPrivateIp = structure(logical(0), tags = list(type = "boolean", box = TRUE)), copyTags = structure(logical(0), tags = list(type = "boolean", box = TRUE)), launchConfigurationTemplateID = structure(logical(0), tags = list(type = "string")), launchDisposition = structure(logical(0), tags = list(type = "string")), licensing = structure(list(osByol = structure(logical(0), tags = list(type = "boolean", box = TRUE))), tags = list(type = "structure")), tags = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "map", sensitive = TRUE)), targetInstanceTypeRightSizingMethod = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), nextToken = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.drs$update_launch_configuration_template_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(copyPrivateIp = structure(logical(0), tags = list(type = "boolean", box = TRUE)), copyTags = structure(logical(0), tags = list(type = "boolean", box = TRUE)), launchConfigurationTemplateID = structure(logical(0), tags = list(type = "string")), launchDisposition = structure(logical(0), tags = list(type = "string")), licensing = structure(list(osByol = structure(logical(0), tags = list(type = "boolean", box = TRUE))), tags = list(type = "structure")), targetInstanceTypeRightSizingMethod = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
