...
.codedeploy$create_deployment_config_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(deploymentConfigName = structure(logical(0), tags = list(type = "string")), minimumHealthyHosts = structure(list(type = structure(logical(0), tags = list(type = "string")), value = structure(logical(0), tags = list(type = "integer"))), tags = list(type = "structure")), trafficRoutingConfig = structure(list(type = structure(logical(0), tags = list(type = "string")), timeBasedCanary = structure(list(canaryPercentage = structure(logical(0), tags = list(type = "integer")), canaryInterval = structure(logical(0), tags = list(type = "integer"))), tags = list(type = "structure")), timeBasedLinear = structure(list(linearPercentage = structure(logical(0), tags = list(type = "integer")), linearInterval = structure(logical(0), tags = list(type = "integer"))), tags = list(type = "structure"))), tags = list(type = "structure")), computePlatform = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.codedeploy$get_deployment_config_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(deploymentConfigInfo = structure(list(deploymentConfigId = structure(logical(0), tags = list(type = "string")), deploymentConfigName = structure(logical(0), tags = list(type = "string")), minimumHealthyHosts = structure(list(type = structure(logical(0), tags = list(type = "string")), value = structure(logical(0), tags = list(type = "integer"))), tags = list(type = "structure")), createTime = structure(logical(0), tags = list(type = "timestamp")), computePlatform = structure(logical(0), tags = list(type = "string")), trafficRoutingConfig = structure(list(type = structure(logical(0), tags = list(type = "string")), timeBasedCanary = structure(list(canaryPercentage = structure(logical(0), tags = list(type = "integer")), canaryInterval = structure(logical(0), tags = list(type = "integer"))), tags = list(type = "structure")), timeBasedLinear = structure(list(linearPercentage = structure(logical(0), tags = list(type = "integer")), linearInterval = structure(logical(0), tags = list(type = "integer"))), tags = list(type = "structure"))), tags = list(type = "structure"))), tags = list(type = "structure"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
