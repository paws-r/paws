...
#' @section Operations:
#' \tabular{ll}{
#'  \link[=codegurusecurity_batch_get_findings]{batch_get_findings} \tab Returns a list of all requested findings\cr
#'  \link[=codegurusecurity_create_scan]{create_scan} \tab Use to create a scan using code uploaded to an S3 bucket\cr
#'  \link[=codegurusecurity_create_upload_url]{create_upload_url} \tab Generates a pre-signed URL and request headers used to upload a code resource\cr
#'  \link[=codegurusecurity_get_account_configuration]{get_account_configuration} \tab Use to get account level configuration\cr
#'  \link[=codegurusecurity_get_findings]{get_findings} \tab Returns a list of all findings generated by a particular scan\cr
#'  \link[=codegurusecurity_get_metrics_summary]{get_metrics_summary} \tab Returns top level metrics about an account from a specified date, including number of open findings, the categories with most findings, the scans with most open findings, and scans with most open critical findings\cr
...
#'  \link[=codegurusecurity_list_scans]{list_scans} \tab Returns a list of all the standard scans in an account\cr
...
#'  \link[=codegurusecurity_update_account_configuration]{update_account_configuration} \tab Use to update account-level configuration with an encryption key
#' }
#'
#' @return
...
.codegurusecurity$service <- function(config = list()) {
  handlers <- new_handlers("restjson", "v4")
  new_service(.codegurusecurity$metadata, handlers, config)
}
