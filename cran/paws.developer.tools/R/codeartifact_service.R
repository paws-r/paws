...
#' 
#' - [`copy_package_versions`][codeartifact_copy_package_versions]: Copies
...
#' 
#' - [`create_package_group`][codeartifact_create_package_group]: Creates a
#'   package group.
#' 
...
#' 
#' - [`delete_package`][codeartifact_delete_package]: Deletes a package and
#'   all associated package versions.
#' 
#' - [`delete_package_group`][codeartifact_delete_package_group]: Deletes a
...
#' 
#' - [`list_packages`][codeartifact_list_packages]: Lists the packages in a
#'   repository.
#' 
...
#' 
#' - [`list_package_versions`][codeartifact_list_package_versions]: Returns
#'   a list of package versions for a specified package in a repository.
#' 
#' - [`list_repositories`][codeartifact_list_repositories]: Returns a list
...
#'   access it.
#' 
#' - [`update_package_group`][codeartifact_update_package_group]: Updates a
