...
.macie2$update_findings_filter_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(action = structure(logical(0), tags = list(locationName = "action", type = "string")), description = structure(logical(0), tags = list(locationName = "description", type = "string")), findingCriteria = structure(list(criterion = structure(list(structure(list(eq = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "eq", type = "list")), eqExactMatch = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "eqExactMatch", type = "list")), gt = structure(logical(0), tags = list(locationName = "gt", type = "long")), gte = structure(logical(0), tags = list(locationName = "gte", type = "long")), lt = structure(logical(0), tags = list(locationName = "lt", type = "long")), lte = structure(logical(0), tags = list(locationName = "lte", type = "long")), neq = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "neq", type = "list"))), tags = list(type = "structure"))), tags = list(locationName = "criterion", type = "map"))), tags = list(locationName = "findingCriteria", type = "structure")), id = structure(logical(0), tags = list(location = "uri", locationName = "id", type = "string")), name = structure(logical(0), tags = list(locationName = "name", type = "string")), position = structure(logical(0), tags = list(locationName = "position", type = "integer"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
