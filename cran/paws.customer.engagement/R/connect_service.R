...
#'  \link[=connect_associate_email_address_alias]{associate_email_address_alias} \tab Associates an email address alias with an existing email address in an Amazon Connect instance\cr
...
#'  \link[=connect_create_agent_status]{create_agent_status} \tab Creates an agent status for the specified Amazon Connect instance\cr
...
#'  \link[=connect_describe_attached_files_configuration]{describe_attached_files_configuration} \tab Describes the attached files configuration for the specified Amazon Connect instance and attachment scope\cr
...
#'  \link[=connect_disassociate_email_address_alias]{disassociate_email_address_alias} \tab Removes the alias association between two email addresses in an Amazon Connect instance\cr
...
#'  \link[=connect_list_attached_files_configurations]{list_attached_files_configurations} \tab Provides summary information about the attached files configurations for the specified Amazon Connect instance\cr
...
#'  \link[=connect_search_contact_evaluations]{search_contact_evaluations} \tab Searches contact evaluations in an Amazon Connect instance, with optional filtering\cr
...
#'  \link[=connect_search_evaluation_forms]{search_evaluation_forms} \tab Searches evaluation forms in an Amazon Connect instance, with optional filtering\cr
...
#'  \link[=connect_update_attached_files_configuration]{update_attached_files_configuration} \tab Updates the attached files configuration for the specified Amazon Connect instance and attachment scope\cr
