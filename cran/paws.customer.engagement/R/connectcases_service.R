...
.connectcases$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "cases.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "cases.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "cases.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "cases.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "cases.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "cases.{region}.csp.hci.ic.gov", global = FALSE)),
