...
#'  \link[=pinpointsmsvoicev2_list_available_phone_numbers]{list_available_phone_numbers} \tab Search available phone numbers from aggregator inventory, optionally filtered by pattern\cr
