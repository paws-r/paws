...
.connectcampaignservicev2$put_profile_outbound_request_batch_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(id = structure(logical(0), tags = list(location = "uri", locationName = "id", type = "string")), profileOutboundRequests = structure(list(structure(list(clientToken = structure(logical(0), tags = list(type = "string")), profileId = structure(logical(0), tags = list(type = "string")), expirationTime = structure(logical(0), tags = list(type = "timestamp", timestampFormat = "iso8601")), eventTriggerContext = structure(list(sourceEvent = structure(logical(0), tags = list(type = "string")), channelContext = structure(list(webNotificationContext = structure(list(sessionId = structure(logical(0), tags = list(type = "string")), browserId = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure"))), tags = list(type = "structure"))), tags = list(type = "structure"))), tags = list(type = "list"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
