...
#'  \link[=account_get_primary_email_update_status]{get_primary_email_update_status} \tab Retrieves the status of the most recent primary email update for the specified account\cr
