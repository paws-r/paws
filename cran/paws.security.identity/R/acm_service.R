...
.acm$metadata <- list(
  service_name = "acm",
  endpoints = list("*" = list(endpoint = "acm.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "acm.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "acm.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "acm.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "acm.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "acm.{region}.csp.hci.ic.gov", global = FALSE)),
  service_id = "ACM",
