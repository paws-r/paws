...
.iam$metadata <- list(
  service_name = "iam",
  endpoints = list("aws-global" = list(endpoint = "iam.amazonaws.com", global = TRUE, signing_region = "us-east-1"), "^(us|eu|ap|sa|ca|me|af|il|mx)\\-\\w+\\-\\d+$" = list(endpoint = "iam.amazonaws.com", global = FALSE, signing_region = "us-east-1"), "aws-cn-global" = list(endpoint = "iam.cn-north-1.amazonaws.com.cn", global = TRUE, signing_region = "cn-north-1"), "^cn\\-\\w+\\-\\d+$" = list(endpoint = "iam.cn-north-1.amazonaws.com.cn", global = FALSE, signing_region = "cn-north-1"), "aws-us-gov-global" = list(endpoint = "iam.us-gov.amazonaws.com", global = TRUE, signing_region = "us-gov-west-1"), "^us\\-gov\\-\\w+\\-\\d+$" = list(endpoint = "iam.us-gov.amazonaws.com", global = FALSE, signing_region = "us-gov-west-1"), "aws-iso-global" = list(endpoint = "iam.us-iso-east-1.c2s.ic.gov", global = TRUE, signing_region = "us-iso-east-1"), "^us\\-iso\\-\\w+\\-\\d+$" = list(endpoint = "iam.us-iso-east-1.c2s.ic.gov", global = FALSE, signing_region = "us-iso-east-1"), "aws-iso-b-global" = list(endpoint = "iam.us-isob-east-1.sc2s.sgov.gov", global = TRUE, signing_region = "us-isob-east-1"), "^us\\-isob\\-\\w+\\-\\d+$" = list(endpoint = "iam.us-isob-east-1.sc2s.sgov.gov", global = FALSE, signing_region = "us-isob-east-1"), "^eu\\-isoe\\-\\w+\\-\\d+$" = list(endpoint = "iam.{region}.cloud.adc-e.uk", global = FALSE), "aws-iso-f-global" = list(endpoint = "iam.us-isof-south-1.csp.hci.ic.gov", global = TRUE, signing_region = "us-isof-south-1"), "^us\\-isof\\-\\w+\\-\\d+$" = list(endpoint = "iam.us-isof-south-1.csp.hci.ic.gov", global = FALSE, signing_region = "us-isof-south-1")),
  service_id = "IAM",
