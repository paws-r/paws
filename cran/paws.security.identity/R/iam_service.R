...
.iam$metadata <- list(
  service_name = "iam",
  endpoints = list("aws-global" = list(endpoint = "iam.amazonaws.com", global = TRUE), "us-east-1" = list(endpoint = "iam.amazonaws.com", global = TRUE), "^(us|eu|ap|sa|ca|me|af|il|mx)\\-\\w+\\-\\d+$" = list(endpoint = "iam.amazonaws.com", global = FALSE), "aws-cn-global" = list(endpoint = "iam.cn-north-1.amazonaws.com.cn", global = TRUE), "cn-north-1" = list(endpoint = "iam.cn-north-1.amazonaws.com.cn", global = TRUE), "^cn\\-\\w+\\-\\d+$" = list(endpoint = "iam.cn-north-1.amazonaws.com.cn", global = FALSE), "aws-us-gov-global" = list(endpoint = "iam.us-gov.amazonaws.com", global = TRUE), "us-gov-west-1" = list(endpoint = "iam.us-gov.amazonaws.com", global = TRUE), "^us\\-gov\\-\\w+\\-\\d+$" = list(endpoint = "iam.us-gov.amazonaws.com", global = FALSE), "aws-iso-global" = list(endpoint = "iam.us-iso-east-1.c2s.ic.gov", global = TRUE), "us-iso-east-1" = list(endpoint = "iam.us-iso-east-1.c2s.ic.gov", global = TRUE), "^us\\-iso\\-\\w+\\-\\d+$" = list(endpoint = "iam.us-iso-east-1.c2s.ic.gov", global = FALSE), "aws-iso-b-global" = list(endpoint = "iam.us-isob-east-1.sc2s.sgov.gov", global = TRUE), "us-isob-east-1" = list(endpoint = "iam.us-isob-east-1.sc2s.sgov.gov", global = TRUE), "^us\\-isob\\-\\w+\\-\\d+$" = list(endpoint = "iam.us-isob-east-1.sc2s.sgov.gov", global = FALSE), "^eu\\-isoe\\-\\w+\\-\\d+$" = list(endpoint = "iam.{region}.cloud.adc-e.uk", global = FALSE), "aws-iso-f-global" = list(endpoint = "iam.us-isof-south-1.csp.hci.ic.gov", global = TRUE), "us-isof-south-1" = list(endpoint = "iam.us-isof-south-1.csp.hci.ic.gov", global = TRUE), "^us\\-isof\\-\\w+\\-\\d+$" = list(endpoint = "iam.us-isof-south-1.csp.hci.ic.gov", global = FALSE)),
  service_id = "IAM",
