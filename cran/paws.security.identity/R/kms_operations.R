...
#'   have its own private DNS name. The `XksProxyUriEndpoint` value for
#'   external key stores with `VPC_ENDPOINT_SERVICE` connectivity (private
#'   DNS name) must be unique in the Amazon Web Services account and
#'   Region.
...
#'   When you create a new Amazon Web Services principal, you might need to
...
#' 
#' - Printable ASCII characters from the space character (``U+0020``) through
