...
#' KMS](https://aws.amazon.com/kms/features/) use symmetric CMKs to protect
#' your data. These services do not support asymmetric CMKs. For help
#' determining whether a CMK is symmetric or asymmetric, see [Identifying
#' Symmetric and Asymmetric
...
#' trusted accounts. For details, see [Best practices for IAM
...
#'     a different CMK, the `ReEncrypt` operation fails. This practice
#'     ensures that you use the CMK that you intend.
#' 
