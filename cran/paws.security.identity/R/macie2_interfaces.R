...
.macie2$search_resources_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(matchingResources = structure(list(structure(list(matchingBucket = structure(list(accountId = structure(logical(0), tags = list(locationName = "accountId", type = "string")), bucketName = structure(logical(0), tags = list(locationName = "bucketName", type = "string")), classifiableObjectCount = structure(logical(0), tags = list(locationName = "classifiableObjectCount", type = "long")), classifiableSizeInBytes = structure(logical(0), tags = list(locationName = "classifiableSizeInBytes", type = "long")), errorCode = structure(logical(0), tags = list(locationName = "errorCode", type = "string")), errorMessage = structure(logical(0), tags = list(locationName = "errorMessage", type = "string")), jobDetails = structure(list(isDefinedInJob = structure(logical(0), tags = list(locationName = "isDefinedInJob", type = "string")), isMonitoredByJob = structure(logical(0), tags = list(locationName = "isMonitoredByJob", type = "string")), lastJobId = structure(logical(0), tags = list(locationName = "lastJobId", type = "string")), lastJobRunTime = structure(logical(0), tags = list(locationName = "lastJobRunTime", type = "timestamp", timestampFormat = "iso8601"))), tags = list(locationName = "jobDetails", type = "structure")), objectCount = structure(logical(0), tags = list(locationName = "objectCount", type = "long")), objectCountByEncryptionType = structure(list(customerManaged = structure(logical(0), tags = list(locationName = "customerManaged", type = "long")), kmsManaged = structure(logical(0), tags = list(locationName = "kmsManaged", type = "long")), s3Managed = structure(logical(0), tags = list(locationName = "s3Managed", type = "long")), unencrypted = structure(logical(0), tags = list(locationName = "unencrypted", type = "long")), unknown = structure(logical(0), tags = list(locationName = "unknown", type = "long"))), tags = list(locationName = "objectCountByEncryptionType", type = "structure")), sizeInBytes = structure(logical(0), tags = list(locationName = "sizeInBytes", type = "long")), sizeInBytesCompressed = structure(logical(0), tags = list(locationName = "sizeInBytesCompressed", type = "long")), unclassifiableObjectCount = structure(list(fileType = structure(logical(0), tags = list(locationName = "fileType", type = "long")), storageClass = structure(logical(0), tags = list(locationName = "storageClass", type = "long")), total = structure(logical(0), tags = list(locationName = "total", type = "long"))), tags = list(locationName = "unclassifiableObjectCount", type = "structure")), unclassifiableObjectSizeInBytes = structure(list(fileType = structure(logical(0), tags = list(locationName = "fileType", type = "long")), storageClass = structure(logical(0), tags = list(locationName = "storageClass", type = "long")), total = structure(logical(0), tags = list(locationName = "total", type = "long"))), tags = list(locationName = "unclassifiableObjectSizeInBytes", type = "structure"))), tags = list(locationName = "matchingBucket", type = "structure"))), tags = list(type = "structure"))), tags = list(locationName = "matchingResources", type = "list")), nextToken = structure(logical(0), tags = list(locationName = "nextToken", type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.macie2$update_findings_filter_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(action = structure(logical(0), tags = list(locationName = "action", type = "string")), description = structure(logical(0), tags = list(locationName = "description", type = "string")), findingCriteria = structure(list(criterion = structure(list(structure(list(eq = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "eq", type = "list")), eqExactMatch = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "eqExactMatch", type = "list")), gt = structure(logical(0), tags = list(locationName = "gt", type = "long")), gte = structure(logical(0), tags = list(locationName = "gte", type = "long")), lt = structure(logical(0), tags = list(locationName = "lt", type = "long")), lte = structure(logical(0), tags = list(locationName = "lte", type = "long")), neq = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "neq", type = "list"))), tags = list(type = "structure"))), tags = list(locationName = "criterion", type = "map"))), tags = list(locationName = "findingCriteria", type = "structure")), id = structure(logical(0), tags = list(location = "uri", locationName = "id", type = "string")), name = structure(logical(0), tags = list(locationName = "name", type = "string")), position = structure(logical(0), tags = list(locationName = "position", type = "integer")), clientToken = structure(logical(0), tags = list(locationName = "clientToken", idempotencyToken = TRUE, type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
