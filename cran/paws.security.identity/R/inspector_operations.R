...
#' Creates a new assessment target using the ARN of the resource group that
#' is generated by
#' [`create_resource_group`][inspector_create_resource_group]. If
...
#' information, see
#' [`create_assessment_target`][inspector_create_assessment_target].
#'
#' @usage
...
#' see [`subscribe_to_event`][inspector_subscribe_to_event] and
#' [`unsubscribe_from_event`][inspector_unsubscribe_from_event].
#'
#' @usage
