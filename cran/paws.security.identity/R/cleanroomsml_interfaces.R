...
.cleanroomsml$create_ml_input_channel_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(membershipIdentifier = structure(logical(0), tags = list(location = "uri", locationName = "membershipIdentifier", type = "string")), configuredModelAlgorithmAssociations = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "list")), inputChannel = structure(list(dataSource = structure(list(protectedQueryInputParameters = structure(list(sqlParameters = structure(list(queryString = structure(logical(0), tags = list(type = "string")), analysisTemplateArn = structure(logical(0), tags = list(type = "string")), parameters = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "map"))), tags = list(type = "structure", sensitive = TRUE)), computeConfiguration = structure(list(worker = structure(list(type = structure(logical(0), tags = list(type = "string")), number = structure(logical(0), tags = list(type = "integer", box = TRUE)), properties = structure(list(spark = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "map"))), tags = list(type = "structure", union = TRUE))), tags = list(type = "structure"))), tags = list(type = "structure", union = TRUE)), resultFormat = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure", union = TRUE)), roleArn = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), name = structure(logical(0), tags = list(type = "string")), retentionInDays = structure(logical(0), tags = list(type = "integer", box = TRUE)), description = structure(logical(0), tags = list(type = "string")), kmsKeyArn = structure(logical(0), tags = list(type = "string")), tags = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "map"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
