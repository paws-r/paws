...
#'  \link[=macie2_batch_update_automated_discovery_accounts]{batch_update_automated_discovery_accounts} \tab Changes the status of automated sensitive data discovery for one or more accounts\cr
...
#'  \link[=macie2_get_automated_discovery_configuration]{get_automated_discovery_configuration} \tab Retrieves the configuration settings and status of automated sensitive data discovery for an organization or standalone account\cr
...
#'  \link[=macie2_list_resource_profile_artifacts]{list_resource_profile_artifacts} \tab Retrieves information about objects that Amazon Macie selected from an S3 bucket for automated sensitive data discovery\cr
...
#'  \link[=macie2_update_automated_discovery_configuration]{update_automated_discovery_configuration} \tab Changes the configuration settings and status of automated sensitive data discovery for an organization or standalone account\cr
...
.macie2$service <- function(config = list(), op = NULL) {
  handlers <- new_handlers("restjson", "v4")
  new_service(.macie2$metadata, handlers, config, op)
}
