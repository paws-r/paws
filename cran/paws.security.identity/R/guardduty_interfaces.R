...
.guardduty$describe_organization_configuration_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(AutoEnable = structure(logical(0), tags = list(locationName = "autoEnable", type = "boolean")), MemberAccountLimitReached = structure(logical(0), tags = list(locationName = "memberAccountLimitReached", type = "boolean"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.guardduty$update_organization_configuration_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(DetectorId = structure(logical(0), tags = list(location = "uri", locationName = "detectorId", type = "string")), AutoEnable = structure(logical(0), tags = list(locationName = "autoEnable", type = "boolean"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
