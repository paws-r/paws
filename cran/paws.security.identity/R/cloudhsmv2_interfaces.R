...
.cloudhsmv2$create_hsm_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(Hsm = structure(list(AvailabilityZone = structure(logical(0), tags = list(type = "string")), ClusterId = structure(logical(0), tags = list(type = "string")), SubnetId = structure(logical(0), tags = list(type = "string")), EniId = structure(logical(0), tags = list(type = "string")), EniIp = structure(logical(0), tags = list(type = "string")), EniIpV6 = structure(logical(0), tags = list(type = "string")), HsmId = structure(logical(0), tags = list(type = "string")), State = structure(logical(0), tags = list(type = "string")), StateMessage = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
