...
#'
#' @param dataSetType &#91;required&#93; *This target has been deprecated.* Specifies the data set type to be
...
#' @param roleNameArn &#91;required&#93; *This target has been deprecated.* The Amazon Resource Name (ARN) of the
#' Role with an attached permissions policy to interact with the provided
#' AWS services.
#' @param destinationS3BucketName &#91;required&#93; *This target has been deprecated.* The name (friendly name, not ARN) of
#' the destination S3 bucket.
#' @param destinationS3Prefix *This target has been deprecated.* (Optional) The desired S3 prefix for
...
#' "myprefix/mydatasets", the output file "outputfile" would be published
#' to "s3://mybucket/myprefix/mydatasets/outputfile". If the prefix
...
#' @param snsTopicArn &#91;required&#93; *This target has been deprecated.* Amazon Resource Name (ARN) for the
#' SNS Topic that will be notified when the data set has been published or
#' if an error has occurred.
#' @param customerDefinedValues *This target has been deprecated.* (Optional) Key-value pairs which will
