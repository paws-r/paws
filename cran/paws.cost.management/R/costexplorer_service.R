...
.costexplorer$metadata <- list(
  service_name = "ce",
  endpoints = list("*" = list(endpoint = "ce.us-east-1.amazonaws.com", global = TRUE), "cn-*" = list(endpoint = "ce.cn-northwest-1.amazonaws.com.cn", global = TRUE), "eu-isoe-*" = list(endpoint = "ce.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "ce.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "ce.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "ce.{region}.csp.hci.ic.gov", global = FALSE)),
