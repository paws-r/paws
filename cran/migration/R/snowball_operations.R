...
#' \donttest{snowball$cancel_cluster(
...
#' \donttest{snowball$create_address(
#'   Address = list(
#'     City = "Seattle",
...
#' # CreateJob action separately to create the jobs for each of these nodes.
#' # The cluster does not ship until these five node jobs have been created.
#' \donttest{snowball$create_cluster(
...
#' \donttest{snowball$describe_address(
#'   AddressId = "ADID1234ab12-3eec-4eb3-9be6-9374c10eb51b"
#' )}
#'
#' @keywords internal
...
#' # all US regions.
#' \donttest{snowball$describe_addresses()}
#'
#' @keywords internal
#'
...
#' # Returns information about a specific cluster including shipping
#' # information, cluster status, and other important metadata.
#' \donttest{snowball$describe_cluster(
#'   ClusterId = "CID123e4567-e89b-12d3-a456-426655440000"
#' )}
#'
#' @keywords internal
...
#' \donttest{snowball$describe_job(
#'   JobId = "JID123e4567-e89b-12d3-a456-426655440000"
#' )}
#'
#' @keywords internal
...
#' \donttest{snowball$get_job_manifest(
#'   JobId = "JID123e4567-e89b-12d3-a456-426655440000"
#' )}
#'
#' @keywords internal
...
#' # job. Saving these separately helps prevent unauthorized parties from
#' # gaining access to the Snowball associated with that job.
#' \donttest{snowball$get_job_unlock_code(
#'   JobId = "JID123e4567-e89b-12d3-a456-426655440000"
#' )}
#'
#' @keywords internal
...
#' \donttest{snowball$get_snowball_usage()}
#'
#' @keywords internal
#'
...
#' \donttest{snowball$list_cluster_jobs(
#'   ClusterId = "CID123e4567-e89b-12d3-a456-426655440000"
#' )}
#'
#' @keywords internal
...
#' \donttest{snowball$list_clusters()}
#'
#' @keywords internal
#'
...
#' @section Request syntax:
#' ```
#' snowball$list_compatible_images(
#'   MaxResults = 123,
#'   NextToken = "string"
#' )
#' ```
...
#' \donttest{snowball$update_cluster(
#'   AddressId = "ADID1234ab12-3eec-4eb3-9be6-9374c10eb51b",
#'   ClusterId = "CID123e4567-e89b-12d3-a456-426655440000",
