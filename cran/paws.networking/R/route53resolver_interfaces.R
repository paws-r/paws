...
.route53resolver$delete_firewall_rule_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(FirewallRuleGroupId = structure(logical(0), tags = list(type = "string")), FirewallDomainListId = structure(logical(0), tags = list(type = "string")), Qtype = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
