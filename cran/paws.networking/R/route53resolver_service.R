...
#'  \link[=route53resolver_list_firewall_rule_types]{list_firewall_rule_types} \tab Retrieves the available rule types that can be used in DNS Firewall rules\cr
