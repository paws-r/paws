...
.networkmanager$update_vpc_attachment_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(AttachmentId = structure(logical(0), tags = list(location = "uri", locationName = "attachmentId", type = "string")), AddSubnetArns = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "list")), RemoveSubnetArns = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "list")), Options = structure(list(Ipv6Support = structure(logical(0), tags = list(type = "boolean"))), tags = list(type = "structure"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
