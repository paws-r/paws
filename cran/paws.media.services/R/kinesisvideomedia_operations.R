...
#' send the [`get_media`][kinesisvideomedia_get_media] requests to this
...
#' The [`get_media`][kinesisvideomedia_get_media] API returns a stream of
...
kinesisvideomedia_get_media <- function(StreamName = NULL, StreamARN = NULL, StartSelector) {
  ...
  config <- get_config()
  svc <- .kinesisvideomedia$service(config)
