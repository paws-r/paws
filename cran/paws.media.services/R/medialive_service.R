...
#'  \link[=medialive_create_partner_input]{create_partner_input} \tab Create a partner input\cr
...
#'  \link[=medialive_update_input_device]{update_input_device} \tab Updates the parameters for the input device\cr
...
.medialive$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "medialive.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "medialive.{region}.amazonaws.com.cn", global = FALSE), "us-iso-*" = list(endpoint = "medialive.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "medialive.{region}.sc2s.sgov.gov", global = FALSE)),
