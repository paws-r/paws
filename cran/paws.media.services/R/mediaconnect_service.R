...
.mediaconnect$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "mediaconnect.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "mediaconnect.{region}.amazonaws.com.cn", global = FALSE), "us-iso-*" = list(endpoint = "mediaconnect.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "mediaconnect.{region}.sc2s.sgov.gov", global = FALSE)),
