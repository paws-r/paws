...
.panorama$create_job_for_devices_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(DeviceIds = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "list")), DeviceJobConfig = structure(list(OTAJobConfig = structure(list(ImageVersion = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure")), JobType = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.panorama$describe_device_job_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(CreatedTime = structure(logical(0), tags = list(type = "timestamp")), DeviceArn = structure(logical(0), tags = list(type = "string")), DeviceId = structure(logical(0), tags = list(type = "string")), DeviceName = structure(logical(0), tags = list(type = "string")), DeviceType = structure(logical(0), tags = list(type = "string")), ImageVersion = structure(logical(0), tags = list(type = "string")), JobId = structure(logical(0), tags = list(type = "string")), Status = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.panorama$list_application_instances_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(ApplicationInstances = structure(list(structure(list(ApplicationInstanceId = structure(logical(0), tags = list(type = "string")), Arn = structure(logical(0), tags = list(type = "string")), CreatedTime = structure(logical(0), tags = list(type = "timestamp")), DefaultRuntimeContextDevice = structure(logical(0), tags = list(type = "string")), DefaultRuntimeContextDeviceName = structure(logical(0), tags = list(type = "string")), Description = structure(logical(0), tags = list(type = "string")), HealthStatus = structure(logical(0), tags = list(type = "string")), Name = structure(logical(0), tags = list(type = "string")), Status = structure(logical(0), tags = list(type = "string")), StatusDescription = structure(logical(0), tags = list(type = "string")), Tags = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "map"))), tags = list(type = "structure"))), tags = list(type = "list")), NextToken = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.panorama$list_devices_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(Devices = structure(list(structure(list(Brand = structure(logical(0), tags = list(type = "string")), CreatedTime = structure(logical(0), tags = list(type = "timestamp")), DeviceId = structure(logical(0), tags = list(type = "string")), LastUpdatedTime = structure(logical(0), tags = list(type = "timestamp")), LeaseExpirationTime = structure(logical(0), tags = list(type = "timestamp")), Name = structure(logical(0), tags = list(type = "string")), ProvisioningStatus = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), NextToken = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.panorama$list_devices_jobs_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(DeviceJobs = structure(list(structure(list(CreatedTime = structure(logical(0), tags = list(type = "timestamp")), DeviceId = structure(logical(0), tags = list(type = "string")), DeviceName = structure(logical(0), tags = list(type = "string")), JobId = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), NextToken = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
