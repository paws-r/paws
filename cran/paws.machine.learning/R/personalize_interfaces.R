...
.personalize$create_batch_inference_job_input <- function(...) {
  ...
  shape <- structure(list(jobName = structure(logical(0), tags = list(type = "string")), solutionVersionArn = structure(logical(0), tags = list(type = "string")), filterArn = structure(logical(0), tags = list(type = "string")), numResults = structure(logical(0), tags = list(type = "integer")), jobInput = structure(list(s3DataSource = structure(list(path = structure(logical(0), tags = list(type = "string")), kmsKeyArn = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure")), jobOutput = structure(list(s3DataDestination = structure(list(path = structure(logical(0), tags = list(type = "string")), kmsKeyArn = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure")), roleArn = structure(logical(0), tags = list(type = "string")), batchInferenceJobConfig = structure(list(itemExplorationConfig = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "map"))), tags = list(type = "structure")), tags = structure(list(structure(list(tagKey = structure(logical(0), tags = list(type = "string")), tagValue = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), batchInferenceJobMode = structure(logical(0), tags = list(type = "string")), themeGenerationConfig = structure(list(fieldsForThemeGeneration = structure(list(itemName = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure"))), tags = list(type = "structure"))
