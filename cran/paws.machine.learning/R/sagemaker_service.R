...
#'  \link[=sagemaker_create_monitoring_schedule]{create_monitoring_schedule} \tab Creates a schedule that regularly starts Amazon SageMaker Processing Jobs to monitor the data captured for an Amazon SageMaker Endpoint\cr
...
#'  \link[=sagemaker_describe_hub]{describe_hub} \tab Describe a hub\cr
