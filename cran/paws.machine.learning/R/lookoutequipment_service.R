...
#'  \link[=lookoutequipment_describe_model]{describe_model} \tab Provides a JSON containing the overall information about a specific ML model, including model name and ARN, dataset, training and evaluation information, status, and so on\cr
...
#'  \link[=lookoutequipment_update_label_group]{update_label_group} \tab Updates the label group
#' }
#'
#' @return
