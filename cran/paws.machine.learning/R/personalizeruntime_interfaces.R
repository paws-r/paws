...
.personalizeruntime$get_action_recommendations_input <- function(...) {
  ...
  shape <- structure(list(campaignArn = structure(logical(0), tags = list(type = "string")), userId = structure(logical(0), tags = list(type = "string")), numResults = structure(logical(0), tags = list(type = "integer")), filterArn = structure(logical(0), tags = list(type = "string")), filterValues = structure(list(structure(logical(0), tags = list(type = "string", sensitive = TRUE))), tags = list(type = "map"))), tags = list(type = "structure"))
  return(populate(args, shape))
}

.personalizeruntime$get_action_recommendations_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(actionList = structure(list(structure(list(actionId = structure(logical(0), tags = list(type = "string")), score = structure(logical(0), tags = list(type = "double"))), tags = list(type = "structure"))), tags = list(type = "list")), recommendationId = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}

.personalizeruntime$get_personalized_ranking_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(campaignArn = structure(logical(0), tags = list(type = "string")), inputList = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "list")), userId = structure(logical(0), tags = list(type = "string")), context = structure(list(structure(logical(0), tags = list(type = "string", sensitive = TRUE))), tags = list(type = "map")), filterArn = structure(logical(0), tags = list(type = "string")), filterValues = structure(list(structure(logical(0), tags = list(type = "string", sensitive = TRUE))), tags = list(type = "map")), metadataColumns = structure(list(structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "list"))), tags = list(type = "map"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
