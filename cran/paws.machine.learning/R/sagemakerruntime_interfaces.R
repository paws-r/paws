...
.sagemakerruntime$invoke_endpoint_input <- function(...) {
  ...
  shape <- structure(list(EndpointName = structure(logical(0), tags = list(location = "uri", locationName = "EndpointName", type = "string")), Body = structure(logical(0), tags = list(type = "blob", sensitive = TRUE)), ContentType = structure(logical(0), tags = list(location = "header", locationName = "Content-Type", type = "string")), Accept = structure(logical(0), tags = list(location = "header", locationName = "Accept", type = "string")), CustomAttributes = structure(logical(0), tags = list(location = "header", locationName = "X-Amzn-SageMaker-Custom-Attributes", type = "string", sensitive = TRUE)), TargetModel = structure(logical(0), tags = list(location = "header", locationName = "X-Amzn-SageMaker-Target-Model", type = "string")), TargetVariant = structure(logical(0), tags = list(location = "header", locationName = "X-Amzn-SageMaker-Target-Variant", type = "string")), TargetContainerHostname = structure(logical(0), tags = list(location = "header", locationName = "X-Amzn-SageMaker-Target-Container-Hostname", type = "string")), InferenceId = structure(logical(0), tags = list(location = "header", locationName = "X-Amzn-SageMaker-Inference-Id", type = "string")), EnableExplanations = structure(logical(0), tags = list(location = "header", locationName = "X-Amzn-SageMaker-Enable-Explanations", type = "string"))), tags = list(type = "structure", payload = "Body"))
...
.sagemakerruntime$invoke_endpoint_async_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(EndpointName = structure(logical(0), tags = list(location = "uri", locationName = "EndpointName", type = "string")), ContentType = structure(logical(0), tags = list(location = "header", locationName = "X-Amzn-SageMaker-Content-Type", type = "string")), Accept = structure(logical(0), tags = list(location = "header", locationName = "X-Amzn-SageMaker-Accept", type = "string")), CustomAttributes = structure(logical(0), tags = list(location = "header", locationName = "X-Amzn-SageMaker-Custom-Attributes", type = "string", sensitive = TRUE)), InferenceId = structure(logical(0), tags = list(location = "header", locationName = "X-Amzn-SageMaker-Inference-Id", type = "string")), InputLocation = structure(logical(0), tags = list(location = "header", locationName = "X-Amzn-SageMaker-InputLocation", type = "string")), RequestTTLSeconds = structure(logical(0), tags = list(location = "header", locationName = "X-Amzn-SageMaker-RequestTTLSeconds", type = "integer")), InvocationTimeoutSeconds = structure(logical(0), tags = list(location = "header", locationName = "X-Amzn-SageMaker-InvocationTimeoutSeconds", type = "integer"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
