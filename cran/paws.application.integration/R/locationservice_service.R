...
#'  \link[=locationservice_create_place_index]{create_place_index} \tab Creates a place index resource in your AWS account\cr
#'  \link[=locationservice_create_route_calculator]{create_route_calculator} \tab Creates a route calculator resource in your AWS account\cr
...
#'  \link[=locationservice_delete_route_calculator]{delete_route_calculator} \tab Deletes a route calculator resource from your AWS account\cr
...
#'  \link[=locationservice_list_route_calculators]{list_route_calculators} \tab Lists route calculator resources in your AWS account\cr
