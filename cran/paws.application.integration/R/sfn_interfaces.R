...
.sfn$test_state_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(definition = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), roleArn = structure(logical(0), tags = list(type = "string")), input = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), inspectionLevel = structure(logical(0), tags = list(type = "string")), revealSecrets = structure(logical(0), tags = list(type = "boolean"))), tags = list(type = "structure"))
  return(populate(args, shape))
}

.sfn$test_state_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(output = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), error = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), cause = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), inspectionData = structure(list(input = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), afterInputPath = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), afterParameters = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), result = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), afterResultSelector = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), afterResultPath = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), request = structure(list(protocol = structure(logical(0), tags = list(type = "string")), method = structure(logical(0), tags = list(type = "string")), url = structure(logical(0), tags = list(type = "string")), headers = structure(logical(0), tags = list(type = "string")), body = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), response = structure(list(protocol = structure(logical(0), tags = list(type = "string")), statusCode = structure(logical(0), tags = list(type = "string")), statusMessage = structure(logical(0), tags = list(type = "string")), headers = structure(logical(0), tags = list(type = "string")), body = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure", sensitive = TRUE)), nextState = structure(logical(0), tags = list(type = "string")), status = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.sfn$validate_state_machine_definition_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(result = structure(logical(0), tags = list(type = "string")), diagnostics = structure(list(structure(list(severity = structure(logical(0), tags = list(type = "string")), code = structure(logical(0), tags = list(type = "string")), message = structure(logical(0), tags = list(type = "string")), location = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), truncated = structure(logical(0), tags = list(type = "boolean", box = TRUE))), tags = list(type = "structure"))
  return(populate(args, shape))
}
