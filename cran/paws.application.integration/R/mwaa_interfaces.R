...
.mwaa$update_environment_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(Name = structure(logical(0), tags = list(location = "uri", locationName = "Name", type = "string")), ExecutionRoleArn = structure(logical(0), tags = list(type = "string")), AirflowVersion = structure(logical(0), tags = list(type = "string")), SourceBucketArn = structure(logical(0), tags = list(type = "string")), DagS3Path = structure(logical(0), tags = list(type = "string")), PluginsS3Path = structure(logical(0), tags = list(type = "string")), PluginsS3ObjectVersion = structure(logical(0), tags = list(type = "string")), RequirementsS3Path = structure(logical(0), tags = list(type = "string")), RequirementsS3ObjectVersion = structure(logical(0), tags = list(type = "string")), StartupScriptS3Path = structure(logical(0), tags = list(type = "string")), StartupScriptS3ObjectVersion = structure(logical(0), tags = list(type = "string")), AirflowConfigurationOptions = structure(list(structure(logical(0), tags = list(type = "string", sensitive = TRUE))), tags = list(type = "map", sensitive = TRUE)), EnvironmentClass = structure(logical(0), tags = list(type = "string")), MaxWorkers = structure(logical(0), tags = list(type = "integer", box = TRUE)), NetworkConfiguration = structure(list(SecurityGroupIds = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "list"))), tags = list(type = "structure")), LoggingConfiguration = structure(list(DagProcessingLogs = structure(list(Enabled = structure(logical(0), tags = list(type = "boolean", box = TRUE)), LogLevel = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), SchedulerLogs = structure(list(Enabled = structure(logical(0), tags = list(type = "boolean", box = TRUE)), LogLevel = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), WebserverLogs = structure(list(Enabled = structure(logical(0), tags = list(type = "boolean", box = TRUE)), LogLevel = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), WorkerLogs = structure(list(Enabled = structure(logical(0), tags = list(type = "boolean", box = TRUE)), LogLevel = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), TaskLogs = structure(list(Enabled = structure(logical(0), tags = list(type = "boolean", box = TRUE)), LogLevel = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure")), WeeklyMaintenanceWindowStart = structure(logical(0), tags = list(type = "string")), WebserverAccessMode = structure(logical(0), tags = list(type = "string")), MinWorkers = structure(logical(0), tags = list(type = "integer", box = TRUE)), Schedulers = structure(logical(0), tags = list(type = "integer", box = TRUE)), MinWebservers = structure(logical(0), tags = list(type = "integer", box = TRUE)), MaxWebservers = structure(logical(0), tags = list(type = "integer", box = TRUE))), tags = list(type = "structure"))
  return(populate(args, shape))
}
