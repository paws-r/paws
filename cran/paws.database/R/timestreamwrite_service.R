...
.timestreamwrite$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "ingest.timestream.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "ingest.timestream.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "ingest.timestream.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "ingest.timestream.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "ingest.timestream.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "ingest.timestream.{region}.csp.hci.ic.gov", global = FALSE)),
