...
.redshiftdataapiservice$execute_statement_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(Sql = structure(logical(0), tags = list(type = "string")), ClusterIdentifier = structure(logical(0), tags = list(type = "string")), SecretArn = structure(logical(0), tags = list(type = "string")), DbUser = structure(logical(0), tags = list(type = "string")), Database = structure(logical(0), tags = list(type = "string")), WithEvent = structure(logical(0), tags = list(type = "boolean", box = TRUE)), StatementName = structure(logical(0), tags = list(type = "string")), Parameters = structure(list(structure(list(name = structure(logical(0), tags = list(type = "string")), value = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), WorkgroupName = structure(logical(0), tags = list(type = "string")), ClientToken = structure(logical(0), tags = list(idempotencyToken = TRUE, type = "string")), ResultFormat = structure(logical(0), tags = list(type = "string")), SessionKeepAliveSeconds = structure(logical(0), tags = list(type = "integer", box = TRUE)), SessionId = structure(logical(0), tags = list(type = "string")), WaitTimeSeconds = structure(logical(0), tags = list(type = "integer", box = TRUE))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.redshiftdataapiservice$get_statement_result_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(Id = structure(logical(0), tags = list(type = "string")), NextToken = structure(logical(0), tags = list(type = "string")), WaitTimeSeconds = structure(logical(0), tags = list(type = "integer", box = TRUE))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.redshiftdataapiservice$list_sessions_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(NextToken = structure(logical(0), tags = list(type = "string")), MaxResults = structure(logical(0), tags = list(type = "integer")), SessionId = structure(logical(0), tags = list(type = "string")), Status = structure(logical(0), tags = list(type = "string")), RoleLevel = structure(logical(0), tags = list(type = "boolean", box = TRUE)), ClusterIdentifier = structure(logical(0), tags = list(type = "string")), WorkgroupName = structure(logical(0), tags = list(type = "string")), Database = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}

.redshiftdataapiservice$list_sessions_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(Sessions = structure(list(structure(list(SessionId = structure(logical(0), tags = list(type = "string")), Status = structure(logical(0), tags = list(type = "string")), CreatedAt = structure(logical(0), tags = list(type = "timestamp")), UpdatedAt = structure(logical(0), tags = list(type = "timestamp")), Database = structure(logical(0), tags = list(type = "string")), DbUser = structure(logical(0), tags = list(type = "string")), ClusterIdentifier = structure(logical(0), tags = list(type = "string")), WorkgroupName = structure(logical(0), tags = list(type = "string")), SessionAliveSeconds = structure(logical(0), tags = list(type = "integer", box = TRUE)), SessionTtl = structure(logical(0), tags = list(type = "timestamp")), CurrentStatementId = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), NextToken = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
