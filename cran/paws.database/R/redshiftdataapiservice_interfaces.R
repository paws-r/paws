...
.redshiftdataapiservice$execute_statement_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(ClientToken = structure(logical(0), tags = list(idempotencyToken = TRUE, type = "string")), ClusterIdentifier = structure(logical(0), tags = list(type = "string")), Database = structure(logical(0), tags = list(type = "string")), DbUser = structure(logical(0), tags = list(type = "string")), Parameters = structure(list(structure(list(name = structure(logical(0), tags = list(type = "string")), value = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), ResultFormat = structure(logical(0), tags = list(type = "string")), SecretArn = structure(logical(0), tags = list(type = "string")), SessionId = structure(logical(0), tags = list(type = "string")), SessionKeepAliveSeconds = structure(logical(0), tags = list(type = "integer", box = TRUE)), Sql = structure(logical(0), tags = list(type = "string")), StatementName = structure(logical(0), tags = list(type = "string")), WithEvent = structure(logical(0), tags = list(type = "boolean", box = TRUE)), WorkgroupName = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.redshiftdataapiservice$get_statement_result_v2_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(ColumnMetadata = structure(list(structure(list(columnDefault = structure(logical(0), tags = list(type = "string")), isCaseSensitive = structure(logical(0), tags = list(type = "boolean")), isCurrency = structure(logical(0), tags = list(type = "boolean")), isSigned = structure(logical(0), tags = list(type = "boolean")), label = structure(logical(0), tags = list(type = "string")), length = structure(logical(0), tags = list(type = "integer")), name = structure(logical(0), tags = list(type = "string")), nullable = structure(logical(0), tags = list(type = "integer")), precision = structure(logical(0), tags = list(type = "integer")), scale = structure(logical(0), tags = list(type = "integer")), schemaName = structure(logical(0), tags = list(type = "string")), tableName = structure(logical(0), tags = list(type = "string")), typeName = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), NextToken = structure(logical(0), tags = list(type = "string")), Records = structure(list(structure(list(CSVRecords = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure", union = TRUE))), tags = list(type = "list")), ResultFormat = structure(logical(0), tags = list(type = "string")), TotalNumRows = structure(logical(0), tags = list(type = "long"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.redshiftdataapiservice$list_statements_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(NextToken = structure(logical(0), tags = list(type = "string")), Statements = structure(list(structure(list(CreatedAt = structure(logical(0), tags = list(type = "timestamp")), Id = structure(logical(0), tags = list(type = "string")), IsBatchStatement = structure(logical(0), tags = list(type = "boolean", box = TRUE)), QueryParameters = structure(list(structure(list(name = structure(logical(0), tags = list(type = "string")), value = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list")), QueryString = structure(logical(0), tags = list(type = "string")), QueryStrings = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "list")), ResultFormat = structure(logical(0), tags = list(type = "string")), SecretArn = structure(logical(0), tags = list(type = "string")), SessionId = structure(logical(0), tags = list(type = "string")), StatementName = structure(logical(0), tags = list(type = "string")), Status = structure(logical(0), tags = list(type = "string")), UpdatedAt = structure(logical(0), tags = list(type = "timestamp"))), tags = list(type = "structure"))), tags = list(type = "list"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
