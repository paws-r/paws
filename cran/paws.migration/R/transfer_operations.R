...
#'
#' @param EndpointDetails The virtual private cloud (VPC) endpoint settings that you want to
#' configure for your SFTP server.
#' @param EndpointType The type of VPC endpoint that you want your SFTP server connect to. If
...
transfer_create_server <- function(EndpointDetails = NULL, EndpointType = NULL, HostKey = NULL, IdentityProviderDetails = NULL, IdentityProviderType = NULL, LoggingRole = NULL, Tags = NULL) {
  op <- new_operation(
    name = "CreateServer",
    http_method = "POST",
    http_path = "/",
  ...
  input <- .transfer$create_server_input(EndpointDetails = EndpointDetails, EndpointType = EndpointType, HostKey = HostKey, IdentityProviderDetails = IdentityProviderDetails, IdentityProviderType = IdentityProviderType, LoggingRole = LoggingRole, Tags = Tags)
...
#' and a maximum of 32 characters long. The following are valid characters:
...
#' @param EndpointType The type of endpoint that you want your SFTP server to connect to. You
...
#' @param LoggingRole A value that changes the AWS Identity and Access Management (IAM) role
...
transfer_update_server <- function(EndpointDetails = NULL, EndpointType = NULL, HostKey = NULL, IdentityProviderDetails = NULL, LoggingRole = NULL, ServerId) {
  op <- new_operation(
    name = "UpdateServer",
    http_method = "POST",
    http_path = "/",
  ...
  input <- .transfer$update_server_input(EndpointDetails = EndpointDetails, EndpointType = EndpointType, HostKey = HostKey, IdentityProviderDetails = IdentityProviderDetails, LoggingRole = LoggingRole, ServerId = ServerId)
