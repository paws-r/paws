...
#'  \link[=datasync_list_locations]{list_locations} \tab Returns a lists of source and destination locations \cr
#'  \link[=datasync_list_tags_for_resource]{list_tags_for_resource} \tab Returns all the tags associated with a specified resources \cr
...
#'  \link[=datasync_update_task]{update_task} \tab Updates the metadata associated with a task 
#' }
#'
#' @rdname datasync
#' @export
