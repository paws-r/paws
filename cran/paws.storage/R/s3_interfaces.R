...
.s3$list_buckets_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(Buckets = structure(list(structure(list(Name = structure(logical(0), tags = list(type = "string")), CreationDate = structure(logical(0), tags = list(type = "timestamp")), BucketRegion = structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "Bucket", type = "structure"))), tags = list(locationNameList = "Bucket", type = "list")), Owner = structure(list(DisplayName = structure(logical(0), tags = list(type = "string")), ID = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure")), ContinuationToken = structure(logical(0), tags = list(type = "string")), Prefix = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.s3$list_directory_buckets_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(Buckets = structure(list(structure(list(Name = structure(logical(0), tags = list(type = "string")), CreationDate = structure(logical(0), tags = list(type = "timestamp")), BucketRegion = structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "Bucket", type = "structure"))), tags = list(locationNameList = "Bucket", type = "list")), ContinuationToken = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
