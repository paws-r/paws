...
#' and generate insights from genomics and other biological data. It
#' simplifies and accelerates the process of storing and analyzing genomic
#' information for Amazon Web Services.
#' 
#' For an introduction to the service, see [What is Amazon Web Services
#' HealthOmics?](https://docs.aws.amazon.com/omics/latest/dev/what-is-healthomics.html)
...
#'  \link[=omics_cancel_annotation_import_job]{cancel_annotation_import_job} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
...
#'  \link[=omics_cancel_variant_import_job]{cancel_variant_import_job} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
...
#'  \link[=omics_create_annotation_store]{create_annotation_store} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
...
#'  \link[=omics_create_variant_store]{create_variant_store} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
...
#'  \link[=omics_delete_annotation_store]{delete_annotation_store} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
...
#'  \link[=omics_delete_variant_store]{delete_variant_store} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
...
#'  \link[=omics_get_annotation_import_job]{get_annotation_import_job} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
#'  \link[=omics_get_annotation_store]{get_annotation_store} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
...
#'  \link[=omics_get_variant_import_job]{get_variant_import_job} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
#'  \link[=omics_get_variant_store]{get_variant_store} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
...
#'  \link[=omics_list_annotation_import_jobs]{list_annotation_import_jobs} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
#'  \link[=omics_list_annotation_stores]{list_annotation_stores} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
...
#'  \link[=omics_list_variant_import_jobs]{list_variant_import_jobs} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
#'  \link[=omics_list_variant_stores]{list_variant_stores} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
...
#'  \link[=omics_start_annotation_import_job]{start_annotation_import_job} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
...
#'  \link[=omics_start_variant_import_job]{start_variant_import_job} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
...
#'  \link[=omics_update_annotation_store]{update_annotation_store} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
...
#'  \link[=omics_update_variant_store]{update_variant_store} \tab Amazon Web Services HealthOmics variant stores and annotation stores will no longer be open to new customers starting November 7, 2025\cr
