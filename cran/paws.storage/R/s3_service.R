...
#'  \link[=s3_create_bucket_metadata_configuration]{create_bucket_metadata_configuration} \tab Creates an S3 Metadata V2 metadata configuration for a general purpose bucket\cr
#'  \link[=s3_create_bucket_metadata_table_configuration]{create_bucket_metadata_table_configuration} \tab We recommend that you create your S3 Metadata configurations by using the V2 CreateBucketMetadataConfiguration API operation\cr
#'  \link[=s3_create_multipart_upload]{create_multipart_upload} \tab End of support notice: As of October 1, 2025, Amazon S3 has discontinued support for Email Grantee Access Control Lists (ACLs)\cr
#'  \link[=s3_create_session]{create_session} \tab Creates a session that establishes temporary security credentials to support fast authentication and authorization for the Zonal endpoint API operations on directory buckets\cr
#'  \link[=s3_delete_bucket]{delete_bucket} \tab Deletes the S3 bucket\cr
#'  \link[=s3_delete_bucket_analytics_configuration]{delete_bucket_analytics_configuration} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_delete_bucket_cors]{delete_bucket_cors} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_delete_bucket_encryption]{delete_bucket_encryption} \tab This implementation of the DELETE action resets the default encryption for the bucket as server-side encryption with Amazon S3 managed keys (SSE-S3)\cr
#'  \link[=s3_delete_bucket_intelligent_tiering_configuration]{delete_bucket_intelligent_tiering_configuration} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_delete_bucket_inventory_configuration]{delete_bucket_inventory_configuration} \tab This operation is not supported for directory buckets\cr
...
#'  \link[=s3_delete_bucket_metadata_configuration]{delete_bucket_metadata_configuration} \tab Deletes an S3 Metadata configuration from a general purpose bucket\cr
#'  \link[=s3_delete_bucket_metadata_table_configuration]{delete_bucket_metadata_table_configuration} \tab We recommend that you delete your S3 Metadata configurations by using the V2 DeleteBucketMetadataTableConfiguration API operation\cr
#'  \link[=s3_delete_bucket_metrics_configuration]{delete_bucket_metrics_configuration} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_delete_bucket_ownership_controls]{delete_bucket_ownership_controls} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_delete_bucket_policy]{delete_bucket_policy} \tab Deletes the policy of a specified bucket\cr
#'  \link[=s3_delete_bucket_replication]{delete_bucket_replication} \tab This operation is not supported for directory buckets\cr
...
#'  \link[=s3_get_bucket_acl]{get_bucket_acl} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_get_bucket_analytics_configuration]{get_bucket_analytics_configuration} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_get_bucket_cors]{get_bucket_cors} \tab This operation is not supported for directory buckets\cr
...
#'  \link[=s3_get_bucket_intelligent_tiering_configuration]{get_bucket_intelligent_tiering_configuration} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_get_bucket_inventory_configuration]{get_bucket_inventory_configuration} \tab This operation is not supported for directory buckets\cr
...
#'  \link[=s3_get_bucket_location]{get_bucket_location} \tab Using the GetBucketLocation operation is no longer a best practice\cr
#'  \link[=s3_get_bucket_logging]{get_bucket_logging} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_get_bucket_metadata_configuration]{get_bucket_metadata_configuration} \tab Retrieves the S3 Metadata configuration for a general purpose bucket\cr
#'  \link[=s3_get_bucket_metadata_table_configuration]{get_bucket_metadata_table_configuration} \tab We recommend that you retrieve your S3 Metadata configurations by using the V2 GetBucketMetadataTableConfiguration API operation\cr
#'  \link[=s3_get_bucket_metrics_configuration]{get_bucket_metrics_configuration} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_get_bucket_notification]{get_bucket_notification} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_get_bucket_notification_configuration]{get_bucket_notification_configuration} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_get_bucket_ownership_controls]{get_bucket_ownership_controls} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_get_bucket_policy]{get_bucket_policy} \tab Returns the policy of a specified bucket\cr
#'  \link[=s3_get_bucket_policy_status]{get_bucket_policy_status} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_get_bucket_replication]{get_bucket_replication} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_get_bucket_request_payment]{get_bucket_request_payment} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_get_bucket_tagging]{get_bucket_tagging} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_get_bucket_versioning]{get_bucket_versioning} \tab This operation is not supported for directory buckets\cr
...
#'  \link[=s3_get_object_retention]{get_object_retention} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_get_object_tagging]{get_object_tagging} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_get_object_torrent]{get_object_torrent} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_get_public_access_block]{get_public_access_block} \tab This operation is not supported for directory buckets\cr
...
#'  \link[=s3_list_bucket_analytics_configurations]{list_bucket_analytics_configurations} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_list_bucket_intelligent_tiering_configurations]{list_bucket_intelligent_tiering_configurations} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_list_bucket_inventory_configurations]{list_bucket_inventory_configurations} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_list_bucket_metrics_configurations]{list_bucket_metrics_configurations} \tab This operation is not supported for directory buckets\cr
...
#'  \link[=s3_put_bucket_abac]{put_bucket_abac} \tab Sets the attribute-based access control (ABAC) property of the general purpose bucket\cr
#'  \link[=s3_put_bucket_accelerate_configuration]{put_bucket_accelerate_configuration} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_put_bucket_acl]{put_bucket_acl} \tab End of support notice: As of October 1, 2025, Amazon S3 has discontinued support for Email Grantee Access Control Lists (ACLs)\cr
#'  \link[=s3_put_bucket_analytics_configuration]{put_bucket_analytics_configuration} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_put_bucket_cors]{put_bucket_cors} \tab This operation is not supported for directory buckets\cr
...
#'  \link[=s3_put_bucket_logging]{put_bucket_logging} \tab End of support notice: As of October 1, 2025, Amazon S3 has discontinued support for Email Grantee Access Control Lists (ACLs)\cr
...
#'  \link[=s3_put_bucket_notification]{put_bucket_notification} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_put_bucket_notification_configuration]{put_bucket_notification_configuration} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_put_bucket_ownership_controls]{put_bucket_ownership_controls} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_put_bucket_policy]{put_bucket_policy} \tab Applies an Amazon S3 bucket policy to an Amazon S3 bucket\cr
#'  \link[=s3_put_bucket_replication]{put_bucket_replication} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_put_bucket_request_payment]{put_bucket_request_payment} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_put_bucket_tagging]{put_bucket_tagging} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_put_bucket_versioning]{put_bucket_versioning} \tab This operation is not supported for directory buckets\cr
...
#'  \link[=s3_put_object_tagging]{put_object_tagging} \tab This operation is not supported for directory buckets\cr
#'  \link[=s3_put_public_access_block]{put_public_access_block} \tab This operation is not supported for directory buckets\cr
...
#'  \link[=s3_write_get_object_response]{write_get_object_response} \tab This operation is not supported for directory buckets
#' }
#'
#' @return
