...
.glacier$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "glacier.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "glacier.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "glacier.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "glacier.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "glacier.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "glacier.{region}.csp.hci.ic.gov", global = FALSE)),
  service_id = "Glacier",
