...
.omics$update_workflow_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(id = structure(logical(0), tags = list(location = "uri", locationName = "id", type = "string")), name = structure(logical(0), tags = list(type = "string")), description = structure(logical(0), tags = list(type = "string")), storageType = structure(logical(0), tags = list(type = "string")), storageCapacity = structure(logical(0), tags = list(type = "integer", box = TRUE))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.omics$update_workflow_version_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(workflowId = structure(logical(0), tags = list(location = "uri", locationName = "workflowId", type = "string")), versionName = structure(logical(0), tags = list(location = "uri", locationName = "versionName", type = "string")), description = structure(logical(0), tags = list(type = "string")), storageType = structure(logical(0), tags = list(type = "string")), storageCapacity = structure(logical(0), tags = list(type = "integer", box = TRUE))), tags = list(type = "structure"))
  return(populate(args, shape))
}
