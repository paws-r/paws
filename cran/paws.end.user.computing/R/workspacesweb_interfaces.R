...
.workspacesweb$list_user_settings_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(nextToken = structure(logical(0), tags = list(type = "string")), userSettings = structure(list(structure(list(cookieSynchronizationConfiguration = structure(list(allowlist = structure(list(structure(list(domain = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), name = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), path = structure(logical(0), tags = list(type = "string", sensitive = TRUE))), tags = list(type = "structure"))), tags = list(type = "list")), blocklist = structure(list(structure(list(domain = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), name = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), path = structure(logical(0), tags = list(type = "string", sensitive = TRUE))), tags = list(type = "structure"))), tags = list(type = "list"))), tags = list(type = "structure", sensitive = TRUE)), copyAllowed = structure(logical(0), tags = list(type = "string")), disconnectTimeoutInMinutes = structure(logical(0), tags = list(type = "integer", box = TRUE)), downloadAllowed = structure(logical(0), tags = list(type = "string")), idleDisconnectTimeoutInMinutes = structure(logical(0), tags = list(type = "integer", box = TRUE)), pasteAllowed = structure(logical(0), tags = list(type = "string")), printAllowed = structure(logical(0), tags = list(type = "string")), uploadAllowed = structure(logical(0), tags = list(type = "string")), userSettingsArn = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "list"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.workspacesweb$update_user_settings_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(clientToken = structure(logical(0), tags = list(idempotencyToken = TRUE, type = "string")), cookieSynchronizationConfiguration = structure(list(allowlist = structure(list(structure(list(domain = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), name = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), path = structure(logical(0), tags = list(type = "string", sensitive = TRUE))), tags = list(type = "structure"))), tags = list(type = "list")), blocklist = structure(list(structure(list(domain = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), name = structure(logical(0), tags = list(type = "string", sensitive = TRUE)), path = structure(logical(0), tags = list(type = "string", sensitive = TRUE))), tags = list(type = "structure"))), tags = list(type = "list"))), tags = list(type = "structure", sensitive = TRUE)), copyAllowed = structure(logical(0), tags = list(type = "string")), disconnectTimeoutInMinutes = structure(logical(0), tags = list(type = "integer", box = TRUE)), downloadAllowed = structure(logical(0), tags = list(type = "string")), idleDisconnectTimeoutInMinutes = structure(logical(0), tags = list(type = "integer", box = TRUE)), pasteAllowed = structure(logical(0), tags = list(type = "string")), printAllowed = structure(logical(0), tags = list(type = "string")), uploadAllowed = structure(logical(0), tags = list(type = "string")), userSettingsArn = structure(logical(0), tags = list(location = "uri", locationName = "userSettingsArn", type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
