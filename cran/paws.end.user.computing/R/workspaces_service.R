...
#'  \link[=workspaces_create_tags]{create_tags} \tab Creates the specified tags for the specified WorkSpace \cr
...
#'  \link[=workspaces_delete_tags]{delete_tags} \tab Deletes the specified tags from the specified WorkSpace \cr
...
#'  \link[=workspaces_describe_tags]{describe_tags} \tab Describes the specified tags for the specified WorkSpace \cr
...
#'  \link[=workspaces_describe_workspace_directories]{describe_workspace_directories} \tab Describes the available AWS Directory Service directories that are registered with Amazon WorkSpaces \cr
...
#'  \link[=workspaces_update_rules_of_ip_group]{update_rules_of_ip_group} \tab Replaces the current rules of the specified IP access control group with the specified rules 
#' }
#'
#' @rdname workspaces
#' @export
