...
#'  \link[=workmail_deregister_mail_domain]{deregister_mail_domain} \tab Removes a domain from Amazon WorkMail, stops email routing to WorkMail, and removes the authorization allowing WorkMail use\cr
...
#'  \link[=workmail_list_mail_domains]{list_mail_domains} \tab Lists the mail domains in a given Amazon WorkMail organization\cr
...
#'  \link[=workmail_list_tags_for_resource]{list_tags_for_resource} \tab Lists the tags applied to an Amazon WorkMail organization resource\cr
...
#'  \link[=workmail_register_mail_domain]{register_mail_domain} \tab Registers a new domain in Amazon WorkMail and SES, and configures it for use by WorkMail\cr
