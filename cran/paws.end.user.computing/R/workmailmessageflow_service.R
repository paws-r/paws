...
.workmailmessageflow$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "workmailmessageflow.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "workmailmessageflow.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "workmailmessageflow.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "workmailmessageflow.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "workmailmessageflow.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "workmailmessageflow.{region}.csp.hci.ic.gov", global = FALSE)),
