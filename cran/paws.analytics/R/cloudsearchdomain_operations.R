...
#' 
#' For more information, see [Paginating Results](https://docs.aws.amazon.com/cloudsearch/latest/developerguide/paginating-results.html) in the *Amazon CloudSearch Developer Guide*.
...
#' 
#' For information about the variables, operators, and functions you can use in expressions, see [Writing Expressions](https://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-expressions.html#writing-expressions) in the *Amazon CloudSearch Developer Guide*.
...
#' ` {"year":{"sort":"bucket"}} `
#' 
#' For more information, see [Getting and Using Facet Information](https://docs.aws.amazon.com/cloudsearch/latest/developerguide/faceting.html) in the *Amazon CloudSearch Developer Guide*.
...
#' 
#' For more information about using filters, see [Filtering Matching Documents](https://docs.aws.amazon.com/cloudsearch/latest/developerguide/filtering-results.html) in the *Amazon CloudSearch Developer Guide*.
...
#' @param query &#91;required&#93; Specifies the search criteria for the request. How you specify the search criteria depends on the query parser used for the request and the parser options specified in the `queryOptions` parameter. By default, the `simple` query parser is used to process requests. To use the `structured`, `lucene`, or `dismax` query parser, you must also specify the `queryParser` parameter.
#' 
#' For more information about specifying search criteria, see [Searching Your Data](https://docs.aws.amazon.com/cloudsearch/latest/developerguide/searching.html) in the *Amazon CloudSearch Developer Guide*.
...
#' 
#' For more information, see [Sorting Results](https://docs.aws.amazon.com/cloudsearch/latest/developerguide/sorting-results.html) in the *Amazon CloudSearch Developer Guide*.
...
#' @param contentType &#91;required&#93; The format of the batch you are uploading. Amazon CloudSearch supports two document batch formats:
#' 
#' -   application/json
#' -   application/xml
#'
