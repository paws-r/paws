...
#'     Syntax](https://lucene.apache.org/core/4_6_0/queryparser/org/apache/lucene/queryparser/classic/package-summary.html).
...
#'     Syntax](https://cwiki.apache.org/confluence/display/solr/DisMaxQParserPlugin).
