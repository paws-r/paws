...
#'  \link[=quicksight_create_template]{create_template} \tab Creates a template from an existing Amazon QuickSight analysis or template\cr
...
#'  \link[=quicksight_delete_user]{delete_user} \tab Deletes the Amazon QuickSight user that is associated with the identity of the Identity and Access Management (IAM) user or role that's making the call\cr
...
#'  \link[=quicksight_describe_account_subscription]{describe_account_subscription} \tab Use the DescribeAccountSubscription operation to receive a description of a Amazon QuickSight account's subscription\cr
...
#'  \link[=quicksight_generate_embed_url_for_anonymous_user]{generate_embed_url_for_anonymous_user} \tab Generates an embed URL that you can use to embed an Amazon QuickSight dashboard in your website, without having to register any reader users\cr
