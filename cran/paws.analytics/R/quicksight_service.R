...
.quicksight$metadata <- list(
  ...
  endpoints = list("*" = list(endpoint = "quicksight.{region}.amazonaws.com", global = FALSE), "cn-*" = list(endpoint = "quicksight.{region}.amazonaws.com.cn", global = FALSE), "eu-isoe-*" = list(endpoint = "quicksight.{region}.cloud.adc-e.uk", global = FALSE), "us-iso-*" = list(endpoint = "quicksight.{region}.c2s.ic.gov", global = FALSE), "us-isob-*" = list(endpoint = "quicksight.{region}.sc2s.sgov.gov", global = FALSE), "us-isof-*" = list(endpoint = "quicksight.{region}.csp.hci.ic.gov", global = FALSE)),
