...
.healthlake$describe_fhir_datastore_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(DatastoreProperties = structure(list(DatastoreId = structure(logical(0), tags = list(type = "string")), DatastoreArn = structure(logical(0), tags = list(type = "string")), DatastoreName = structure(logical(0), tags = list(type = "string")), DatastoreStatus = structure(logical(0), tags = list(type = "string")), CreatedAt = structure(logical(0), tags = list(type = "timestamp")), DatastoreTypeVersion = structure(logical(0), tags = list(type = "string")), DatastoreEndpoint = structure(logical(0), tags = list(type = "string")), SseConfiguration = structure(list(KmsEncryptionConfig = structure(list(CmkType = structure(logical(0), tags = list(type = "string")), KmsKeyId = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure")), PreloadDataConfig = structure(list(PreloadDataType = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.healthlake$list_fhir_datastores_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(DatastorePropertiesList = structure(list(structure(list(DatastoreId = structure(logical(0), tags = list(type = "string")), DatastoreArn = structure(logical(0), tags = list(type = "string")), DatastoreName = structure(logical(0), tags = list(type = "string")), DatastoreStatus = structure(logical(0), tags = list(type = "string")), CreatedAt = structure(logical(0), tags = list(type = "timestamp")), DatastoreTypeVersion = structure(logical(0), tags = list(type = "string")), DatastoreEndpoint = structure(logical(0), tags = list(type = "string")), SseConfiguration = structure(list(KmsEncryptionConfig = structure(list(CmkType = structure(logical(0), tags = list(type = "string")), KmsKeyId = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure")), PreloadDataConfig = structure(list(PreloadDataType = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))), tags = list(type = "structure"))), tags = list(type = "list")), NextToken = structure(logical(0), tags = list(type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
