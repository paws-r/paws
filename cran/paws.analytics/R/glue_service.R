...
#'  \link[=glue_get_unfiltered_table_metadata]{get_unfiltered_table_metadata} \tab Retrieves table metadata from the Data Catalog that contains unfiltered metadata\cr
