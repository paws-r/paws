...
Disclaimer: We are not affiliated with Amazon or Amazon Web Services,
and this package is not a product of or supported by Amazon Web
Services.
...
By default, the Paws will use the `default` profile. If you would rather
use the credentials from a different profile, you can set the preferred
...
However, you may want to use another profile, which you can choose it in
the following ways:
